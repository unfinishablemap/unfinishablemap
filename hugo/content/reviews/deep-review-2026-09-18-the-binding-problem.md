...
**Date**: 2026-09-18
**Article**: [Varieties of the Binding Problem](/topics/the-binding-problem/) (topics/ variant)
**Previous review**: [2026-07-18](/reviews/deep-review-2026-07-18-the-binding-problem/)
...
> … This is the [hard-problem-of-consciousness](/topics/hard-problem-of-consciousness/) applied to unity.
...
is the Map's, and the companion [binding-problem](/concepts/binding-problem/) already states it correctly (subsumption
...
- Two of four duplicate "see [binding-problem](/concepts/binding-problem/)" pointers (two retained).
- Nine Further Reading entries **whose targets are still wikilinked in the body** — verified
  ...
  ([unity-of-consciousness](/concepts/unity-of-consciousness/), [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/),
  [dualist-perception](/topics/dualist-perception/), [lucid-dreaming-and-dualist-rendering](/topics/lucid-dreaming-and-dualist-rendering/)) were retained, as were the
