...
articles ([topics/eliminative-materialism.md](/topics/eliminative-materialism/), [concepts/illusionism.md](/concepts/illusionism/), [concepts/many-worlds.md](/concepts/many-worlds/),
[concepts/materialism.md](/concepts/materialism/), [concepts/epiphenomenalism.md](/concepts/epiphenomenalism/)) each carry a proper "Relation to Site
...
- **Quote**: "The Map's [No Many Worlds](/tenets/#no-many-worlds) tenet rejects this for ontological extravagance, the indexical problem, the probability problem, and for eliminating any role for consciousness."
- **Recommendation**: Reorder so the indexical objection leads and ontological extravagance is marked subsidiary, matching the canonical tenet phrasing. Optional/cosmetic — no reader is misled about the Map's position; this is corpus self-consistency hygiene. ([concepts/many-worlds.md](/concepts/many-worlds/) and [concepts/conservation-laws-and-mental-causation.md](/concepts/conservation-laws-and-mental-causation/) already lead with the indexical objection and are clean; [topics/vertiginous-question.md](/topics/vertiginous-question/) correctly frames it as "the strongest connection… explicitly cites the indexical problem".)
