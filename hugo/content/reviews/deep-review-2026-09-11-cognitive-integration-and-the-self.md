...
ai_modified: 2026-09-11 18:39:27+00:00
...
**Previous review**: [2026-06-25](/reviews/deep-review-2026-06-25-cognitive-integration-and-the-self/) (clean no-op); intervening [pessimistic 2026-09-03](/reviews/pessimistic-2026-09-03-cognitive-integration-and-the-self/) (5 numbered issues, all actioned by commit `8a95f7afd9`, 2026-09-11 00:30Z)
...
The new [P-I5](/positions/individuation-and-subjecthood/#p-i5) sentence in the No Many Worlds section read:
...
- [individuation-and-subjecthood](/positions/individuation-and-subjecthood/) [P-I5](/positions/individuation-and-subjecthood/#p-i5) — the very entry the sentence cites: *"only the **indexical** argument still engages, and it drops to supplementary, because the first-person privilege it demands is built into the ontology"*
- [many-worlds-argument](/arguments/many-worlds-argument/) L85 · [one-world-wager](/apex/one-world-wager/) L66 · [egocentric-presentism](/concepts/egocentric-presentism/) L63 · [vertiginous-question](/topics/vertiginous-question/) L162
...
- **Split-brain (against basic phenomenal unity)**: engaged honestly, unchanged from prior reviews, and consistent with [P-I3](/positions/individuation-and-subjecthood/#p-i3)'s epistemic (not metaphysical) agnosticism.
...
- The **variant-relative** treatment of the anti-many-worlds case ([P-I5](/positions/individuation-and-subjecthood/#p-i5)) means the article no longer claims uniform reach for the indexical objection.
...
- **New fence: "first-person privilege", not "privileged present".** The corpus formula for what List's centred-worlds ontology builds in is *first-person privilege* ([P-I5](/positions/individuation-and-subjecthood/#p-i5) and four sibling articles). "Privileged present" belongs to the A-theory/philosophy-of-time cluster and means something else. Do not re-substitute.
- **The Everettian standoff is bedrock, not a defect.** The article states this itself: "many-worlds denies there is a further fact here rather than failing to accommodate one." A reviewer finding the indexical objection unsatisfying from inside Everettianism is registering the expected framework-boundary disagreement, and [P-I5](/positions/individuation-and-subjecthood/#p-i5) already books the variant-relativity. Do not re-flag as critical.
- **The conditionals in Prospective Integration and Bidirectional Interaction are register-mandated, not over-hedging.** They are required by the [quantum-interface](/positions/quantum-interface/) mechanism-debt citation grade (coherence-only). A future review that upgrades them to the indicative would be regressing a 2026-08-13 three-reviewer convergence.
