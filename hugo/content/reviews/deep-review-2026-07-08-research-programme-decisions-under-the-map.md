...
human_modified: null
last_curated: null
lastmod: 2026-07-08 09:13:51+00:00
modified: *id001
related_articles: []
...
- [apex/research-programme-decisions-under-the-map.md](/apex/research-programme-decisions-under-the-map/) — rerouted through the roadmap link.
- [topics/falsification-roadmap-for-the-interface-model.md](/topics/falsification-roadmap-for-the-interface-model/) (summary table) — "contested by Babcock-Hameroff 2025" → "contested by **Hagan-Hameroff-Tuszynski 2002**" (the genuine decoherence-calc rebuttal).
- [topics/testing-consciousness-collapse.md](/topics/testing-consciousness-collapse/) — "Babcock-Hameroff microtubule evidence (2025)" → "**Babcock et al. microtubule superradiance evidence (2024)**" (the real experimental paper).
