...
**Previous review**: [2026-06-26](/reviews/deep-review-2026-06-26-phenomenology-of-memory-and-the-self/) (sixth review; no-op, verification carried forward)
...
**Family resolution**: swept the live corpus for each corrected cite. No propagation — [topics/memory-channel-interface-evidence.md](/topics/memory-channel-interface-evidence/) cites a **different** real Klein 2014 (*The Two Selves*, OUP), not *Sameness and the Self*, so no conflict. Matthen and Gentry appear nowhere else in live content.
