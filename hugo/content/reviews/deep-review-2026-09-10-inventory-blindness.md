...
**Previous review**: [2026-07-14](/reviews/deep-review-2026-07-14-inventory-blindness/) (sixth review; fifth was the publisher-of-record verify pass)
...
- **The body still ran the inference the new section disavows, in the Tenet 5 paragraph.**
  ...
  Note that this passage is the one the [two-tier discount](/project/architecture-vs-significance-two-tier-discount/)
...
- **[meta-epistemology-of-limits](/voids/meta-epistemology-of-limits/)** — the one flagged for scrutiny, because it uses
...
- **[mysterianism](/concepts/mysterianism/)** — stops one clause short of the fallacy and stops deliberately:
...
- **[recognition-void](/voids/recognition-void/)** — the sharpest of the citers on this point, and worth quoting
  ...
  Sound.
- **[closure-types-void](/voids/closure-types-void/)**, **[three-kinds-of-void](/voids/three-kinds-of-void/)**, **[self-opacity](/voids/self-opacity/)**,
  **[biological-cognitive-closure](/voids/biological-cognitive-closure/)**, **[capgras-delusion-and-the-affective-recognition-channel](/topics/capgras-delusion-and-the-affective-recognition-channel/)**,
  **[anti-correlated-metacognitive-signal](/concepts/anti-correlated-metacognitive-signal/)** — all descriptive or definitional uses
...
- **[architecture-vs-significance-two-tier-discount](/project/architecture-vs-significance-two-tier-discount/)** — its architecture/
...
**[epistemology-of-limit-knowledge](/concepts/epistemology-of-limit-knowledge/)**, in the "Phenomenally constituted and reliable"
option: *"developmental no-trace as recognition-via-inference (no phenomenal signal at
all, so the limit is known only indirectly, through [inventory-blindness](/concepts/inventory-blindness/))."* Read
