...
ai_modified: 2026-07-18 14:12:20+00:00
...
human_modified: null
last_curated: null
lastmod: 2026-07-18 14:12:20+00:00
modified: *id001
related_articles: []
title: 'Deep Review - The Measurement Problem (12th pass: verify Consistent Histories
  section + web-verify 2 new citations)'
topics: []
---

**Date**: 2026-07-18
**Article**: [The Measurement Problem](/concepts/measurement-problem/)
**Previous review**: [2026-06-20](/reviews/deep-review-2026-06-20-measurement-problem/) (11th pass)
...
- **Reasoning-mode classification (editor-internal)**: **Mode Three — framework-boundary marking.** The section states the Map's residual "why this outcome?" demand "is not a neutral test CH fails but a metaphysical standard it rejects … The disagreement is a framework boundary, honestly noted as such." No boundary-substitution (does not dress tenet-incompatibility as an in-framework refutation), no label leakage in prose. Correct per [direct-refutation-discipline](/project/direct-refutation-discipline/).
...
Bohm "pilot wave" plain-text → [pilot wave](/concepts/bohm-implicate-order-and-active-information/) wikilink (target exists); structural-parallel bullet reworded ("as set out above") with no semantic change; Further Reading list pruned of three entries ([coupling-modes](/concepts/coupling-modes/) still linked in body line 133, so not orphaned; [delegation-meets-quantum-selection](/topics/delegation-meets-quantum-selection/) and [the-reverse-inference](/topics/the-reverse-inference/) de-listed, no body dependency).
