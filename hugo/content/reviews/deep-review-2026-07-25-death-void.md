...
human_modified: null
last_curated: null
lastmod: 2026-07-25 03:16:59+00:00
modified: *id001
related_articles: []
...
**Previous review**: [2026-06-20](/reviews/deep-review-2026-06-20-death-void/) (deep); [2026-07-23](/reviews/pessimistic-2026-07-23-death-void/) (pessimistic)
...
`find_superlative_claims` returned empty. No superlative empirical claims. The article routes all empirical phenomenology of dying to [death-and-consciousness](/topics/death-and-consciousness/), so no contested-evidence tier exists here to mishandle — the structural/empirical division of labour is itself a calibration safeguard.
...
### Cross-links Added
None. `related_articles`, Further Reading, and the [haecceity](/concepts/haecceity/) tenet-section link all resolve (verified).
...
5. **No NDE/terminal-lucidity evidence here** — delegated to [death-and-consciousness](/topics/death-and-consciousness/).
