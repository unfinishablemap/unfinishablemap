...
- **"phenomenal consciousness is an illusion" (illusionism)** — ~30 files matched; every
  ...
  presentation"). No file endorses the position. [concepts/witness-consciousness.md](/concepts/witness-consciousness/) and
  [concepts/buddhism-and-dualism.md](/concepts/buddhism-and-dualism/) explicitly distinguish the Buddhist no-self claim
  from eliminativism.
- **"consciousness is epiphenomenal"** — matches in
  [topics/dopamine-and-the-unified-interface.md](/topics/dopamine-and-the-unified-interface/), [concepts/mental-imagery.md](/concepts/mental-imagery/),
  [concepts/attentional-economics.md](/concepts/attentional-economics/), [concepts/baseline-cognition.md](/concepts/baseline-cognition/), etc. are all
...
- **MWI endorsement** ("many-worlds is true/correct/we adopt MWI") — zero matches. The
  four "If MWI is true" hits ([topics/delegatory-dualism.md](/topics/delegatory-dualism/), [concepts/many-worlds.md](/concepts/many-worlds/),
  [concepts/conservation-laws-and-mental-causation.md](/concepts/conservation-laws-and-mental-causation/),
  [concepts/quantum-indeterminacy-free-will.md](/concepts/quantum-indeterminacy-free-will/)) all state the conditional precisely to
  explain why the Map *rejects* MWI per Tenet 4.
- **Occam-against-dualism** — the single apparent match
  ([concepts/philosophy-of-science-under-dualism.md](/concepts/philosophy-of-science-under-dualism/) line 64) presents
...
[concepts/illusionism.md](/concepts/illusionism/), [concepts/many-worlds.md](/concepts/many-worlds/), [concepts/materialism.md](/concepts/materialism/),
[concepts/epiphenomenalism.md](/concepts/epiphenomenalism/), [concepts/functional-seeming.md](/concepts/functional-seeming/).