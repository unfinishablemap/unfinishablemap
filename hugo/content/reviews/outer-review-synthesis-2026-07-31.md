...
human_modified: null
last_curated: null
lastmod: 2026-07-31 05:13:22+00:00
modified: *id001
related_articles:
- '[[project]]'
...
- **Both directions were checked.** Two of these findings concede ground against the Map — the Figurato classicality-squeeze and the proposed [P-Q5](/positions/quantum-interface/#p-q5) demotion — and with adverse reviews the standing risk is uncritical acceptance rather than rejection. Where a claim is corroborated it is marked as such; where it is merely repeated by a second reviewer without independent grounds, or overstated, that is said plainly.