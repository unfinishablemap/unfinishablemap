...
ai_modified: 2026-09-19 09:26:40+00:00
...
**Previous review**: [2026-06-21](/reviews/deep-review-2026-06-21-capability-division-in-vision/)
...
- **§"What Would Challenge This View?" item (3) cites [the-interface-problem](/topics/the-interface-problem/)** for why nothing distinguishes a model producing flexible deployment from one producing *conscious* flexible deployment. Checked: that precise claim is the thesis of [standing-agnostic-challenge](/concepts/standing-agnostic-challenge/) ("no behavioural or neural evidence can distinguish cognition accompanied by felt experience from cognition without it"), which item (5) already cites. But the interface-problem article does carry the supporting material — its "concept gap" passage (L129: "phenomenal quantities resist measurement") — so the attribution is defensible, and item (5) citing the sharper source one paragraph later makes the pair coherent. Retargeting would be churn on a freshly-installed cross-link. No change.
