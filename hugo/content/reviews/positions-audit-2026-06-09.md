...
- `quantum-interface.md` — [P-Q1](/positions/quantum-interface/#p-q1) … [P-Q10](/positions/quantum-interface/#p-q10) (10)
- `agency-and-will.md` — [P-A1](/positions/agency-and-will/#p-a1) … [P-A5](/positions/agency-and-will/#p-a5) (5)
- `voids-as-evidence.md` — [P-V1](/positions/voids-as-evidence/#p-v1) … [P-V3](/positions/voids-as-evidence/#p-v3) (3)
...
- **[P-Q1](/positions/quantum-interface/#p-q1) (prefers post-decoherence selection) vs [P-Q4](/positions/quantum-interface/#p-q4)/[P-Q5](/positions/quantum-interface/#p-q5) (demote Stapp-Zeno / Orch-OR).**
  This is a *ranking*, not a contradiction — [P-Q4](/positions/quantum-interface/#p-q4)/[P-Q5](/positions/quantum-interface/#p-q5) explicitly keep both candidates in
  the live set, not retired. Consistent.
- **[P-Q2](/positions/quantum-interface/#p-q2) (Born statistics preserved exactly) vs [P-Q3](/positions/quantum-interface/#p-q3) (bias-without-deviation challenge).**
  [P-Q3](/positions/quantum-interface/#p-q3) is the named tension *inside* [P-Q2](/positions/quantum-interface/#p-q2)'s reading, registered deliberately. Consistent.
- **[P-A3](/positions/agency-and-will/#p-a3) (invokes an atemporal-selection reading to dissolve the Libet timing puzzle) vs
  [P-Q1](/positions/quantum-interface/#p-q1) (prefers *forward-in-time* post-decoherence selection).** FLAGGED as a soft
  ...
  Models May Be Preferable"), while [P-A3](/positions/agency-and-will/#p-a3) leans (weakly, flagged as a hypothesis) on an atemporal
  reading. [P-A3](/positions/agency-and-will/#p-a3) already hedges the atemporal reading well below its empirical-critique content,
...
- **Illusionism cluster edits (2026-06-09).** The only illusionism reference in the register is a
  *paraphrase* inside [P-V1](/positions/voids-as-evidence/#p-v1)'s Asserts ("illusionism predicts the introspection-architecture
...
actually argues the claim: [P-A1](/positions/agency-and-will/#p-a1) in `topics/free-will`, [P-V3](/positions/voids-as-evidence/#p-v3) in `voids/what-voids-reveal`, [P-Q8](/positions/quantum-interface/#p-q8) and
[P-Q4](/positions/quantum-interface/#p-q4) in their cited topics — all confirmed).
...
- **[P-Q7](/positions/quantum-interface/#p-q7) uses an off-vocabulary band: `moderate-to-high`.** The canonical vocabulary
...
- High-confidence entries ([P-Q2](/positions/quantum-interface/#p-q2), [P-Q6](/positions/quantum-interface/#p-q6), [P-Q10](/positions/quantum-interface/#p-q10), [P-A4](/positions/agency-and-will/#p-a4)) audited for over-assertion: all four are
  either definitional/structural ([P-Q2](/positions/quantum-interface/#p-q2) "structural to the default reading"; [P-A4](/positions/agency-and-will/#p-a4) the verification
  limit), an accepted empirical result ([P-Q6](/positions/quantum-interface/#p-q6) Donadi falsification), or a meta-claim about corpus
  state ([P-Q10](/positions/quantum-interface/#p-q10)). Assertive wording matches the band. No drift.
- Low entry ([P-V3](/positions/voids-as-evidence/#p-v3)) audited for over-hedging-the-other-way: wording ("holds, provisionally",
...
- **Item (d) — does the 2026-06-09 convergence warrant band changes to the voids positions?**
  ...
  void-convergence-as-evidence. [P-V1](/positions/voids-as-evidence/#p-v1) (moderate) / [P-V3](/positions/voids-as-evidence/#p-v3) (low) already encode the
  convergence-independence discipline correctly: [P-V3](/positions/voids-as-evidence/#p-v3)'s confidence is explicitly gated on an
...
- **T1 (P3, integrate-orphan):** Add inbound ID references / paraphrase-anchors from body
  articles to the new agency ([P-A1](/positions/agency-and-will/#p-a1)..A5) and voids ([P-V1](/positions/voids-as-evidence/#p-v1)..V3) positions so the register is
  cross-cited from the corpus it summarizes.
- **T2 (P3, positions-evolve update [P-Q7](/positions/quantum-interface/#p-q7)):** Normalize the `moderate-to-high` band to a canonical
  band (low/moderate/high), or amend the vocabulary in `positions.md` if an intermediate band is
  intended. Human calibration call.
- **T3 (P3, positions-evolve audit / human note):** Review the [P-A3](/positions/agency-and-will/#p-a3) (atemporal) vs [P-Q1](/positions/quantum-interface/#p-q1)
  (forward-in-time-preferred) soft tension; decide whether [P-A3](/positions/agency-and-will/#p-a3)'s atemporal fallback should be
