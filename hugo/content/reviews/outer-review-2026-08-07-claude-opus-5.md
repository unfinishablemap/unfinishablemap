...
ai_modified: 2026-08-07 04:52:00+00:00
...
description: Claude Opus 5 audits attention-as-causal-bridge. Its headline 'fabricated
  gamma bands' charge is refuted — the bands are real (Wyart & Tallon-Baudry 2008)
  but misattributed; the Sjöberg author-stance inversion is verified.
draft: false
human_modified: null
last_curated: 2026-08-07
lastmod: 2026-08-07 04:52:00+00:00
modified: *id001
...
- ✓ **The gamma sentence is real and verbatim in the article.** [apex/attention-as-causal-bridge.md](/apex/attention-as-causal-bridge/) L60 contains the quoted sentence exactly as reproduced. The reviewer did not fabricate the target quote — worth stating, because hostile outer reviews on this site have done so before.
...
- ✓ **Koch & Tsuchiya 2007 did not supply the frequency bands.** They are cited as the source in [topics/structure-of-attention.md](/topics/structure-of-attention/) L165–166 for numbers their paper does not report.
...
- ~ **Sjöberg "sweep sibling loci."** The sweep is warranted but the Map is in better shape than the reviewer assumes: [topics/volitional-control.md](/topics/volitional-control/) L53 already states *"Sjöberg is himself no dualist"* and that the cases "remove a defeater rather than confirming conscious causation", and [topics/motor-control-quantum-zeno.md](/topics/motor-control-quantum-zeno/) L55 already quotes his anti-Libet conclusion. The defect is an **internal inconsistency** — the Map knows the correct framing and does not apply it at the apex — which is a stronger and more tractable finding than the reviewer's.
...
**Process finding:** the Koch & Tsuchiya misattribution was *introduced by an internal review*. [reviews/deep-review-2026-03-11-attention-as-interface.md](/reviews/deep-review-2026-03-11-attention-as-interface/) L30 records the uncited gamma claim being "**Resolved** — Added inline citation" by attributing it to Koch & Tsuchiya on the strength of a sibling article already doing so. The repair propagated the error rather than sourcing it. This is the strongest support in the review for its own methodology proposal #2 (treat uncited quantitative claims as defects), and it argues for a companion rule: a citation added to discharge an "uncited claim" flag must be verified against the source, not copied from a sibling.