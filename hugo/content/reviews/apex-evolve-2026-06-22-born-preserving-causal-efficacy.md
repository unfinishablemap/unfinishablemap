...
date: '2026-06-22'
draft: false
lastmod: 2026-06-22 09:00:29+00:00
related_articles: []
title: 'Apex Evolve Review: The Born-Preserving Causal-Efficacy Problem (create)'
---

# Apex Evolve Review — Create

**Article**: [The Born-Preserving Causal-Efficacy Problem](/apex/born-preserving-causal-efficacy/)
**Mode**: create (new synthesis apex, #34)
**Date**: 2026-06-22
**Trigger**: outer-review 2026-06-22 ChatGPT 5.5 Pro §1 + §4.3 + improvement #7 — named "the site's deepest issue."

## Extend-vs-Create Decision

The brief required checking whether an existing apex already covers the Born-preserving causal-efficacy problem before creating a new one, preferring extension where substantial overlap exists, but forbidding growth of already-over-ceiling apexes.

Surveyed the corpus:

- **`post-decoherence-selection-programme`** (4,510w, soft_warning) — contains a "The Bias-Without-Deviation Dilemma [Open]" subsection, but treats the dilemma as *one of five mechanism components* in a decoherence-timing programme. Already 510w over soft; growing it to foreground the dilemma would push it further over. Different value (mechanism survey, not efficacy-problem synthesis).
...
Target 2500–4000. Result: **3,624 body words** (canonical `analyze_length`), status `ok`, well under soft 4,000. No condensation needed.
...
- Frontmatter timestamps stamped at actual current UTC (2026-06-22T09:00:29+00:00), not future-dated.
- All citations reuse the cluster's already-verified set; Torres Alegre 2025 carried with its not-yet-peer-reviewed-preprint qualifier. No new unverified citations.

## Summary of Changes

- Created `obsidian/apex/born-preserving-causal-efficacy.md` (3,624 words, synthesis apex #34).
- Registered as entry #34 in `obsidian/apex/apex-articles.md`.
- This review archive.
- Changelog entry.