...
**Previous review**: [2026-08-03](/reviews/deep-review-2026-08-03-hemispherectomy-and-the-resilience-of-unified-consciousness/)
...
`[[interface-heterogeneity]]` was **retained** in `concepts:` frontmatter and in the body, because its other use — "on the Map's own [heterogeneous-interface](/concepts/interface-heterogeneity/) picture there is no reason to expect that answer to fall out of gross anatomy," in the islands-of-awareness paragraph — is a correct invocation of the mechanism-diversity claim. Only the misapplied use was changed.
...
- [neurological-dissociations-as-interface-architecture](/topics/neurological-dissociations-as-interface-architecture/) promoted from Further Reading into load-bearing body prose. It was already in `related_articles`, so no frontmatter change was needed.
...
- **New, and worth carrying**: this article's `interface-heterogeneity` link is now split by role. The islands-of-awareness use is correct (mechanism diversity, gross anatomy). Any future attempt to invoke heterogeneity for *intra-subject* channel failure is a re-introduction of the defect fixed this pass — that domain belongs to [coupling-modes](/concepts/coupling-modes/) (within-organism modal flexibility) or to [neurological-dissociations-as-interface-architecture](/topics/neurological-dissociations-as-interface-architecture/) (independently failable channels), per interface-heterogeneity's own within-vs-between division.
