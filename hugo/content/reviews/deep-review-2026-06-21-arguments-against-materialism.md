...
human_modified: null
last_curated: null
lastmod: 2026-06-21 04:01:52+00:00
modified: *id001
related_articles: []
...
**Previous review**: [2026-06-01](/reviews/deep-review-2026-06-01-arguments-against-materialism/)
...
1. Narrow: simplicity argument "not a conclusive argument for materialism" / "neither dualism nor materialism can yet explain all the phenomena" — used in [arguments/epistemological-limits-of-occams-razor.md](/arguments/epistemological-limits-of-occams-razor/).
...
## Remaining Items
None for this article. One sibling-file follow-up recorded above (Smart "severely criticized" SEP→Wikipedia mis-attribution in `parsimony-epistemology.md` L110 and [arguments/epistemological-limits-of-occams-razor.md](/arguments/epistemological-limits-of-occams-razor/) L84) — to be handled when those files are next reviewed; not actioned here to stay in scope.
