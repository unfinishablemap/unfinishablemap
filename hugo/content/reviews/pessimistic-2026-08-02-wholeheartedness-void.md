...
- **Location**: "The Map declines this move from outside the framework, not refutes it inside it (per [direct-refutation-discipline](/project/direct-refutation-discipline/))."
...
|---------|-------|-----------|
| "(per [direct-refutation-discipline](/project/direct-refutation-discipline/))" (L90) | Editor-vocabulary in article prose | Delete; sentence stands unaided |
