...
ai_modified: 2026-08-23 00:15:20+00:00
...
human_modified: null
last_curated: null
lastmod: 2026-08-23 00:15:20+00:00
modified: *id001
related_articles: []
...
**Previous review**: [2026-07-17](/reviews/deep-review-2026-07-17-cognitive-science-of-dualism/) (pre-merge)
...
| Tallis inline↔References orphan | 2026-06-24 | **N/A, correctly** — the merge delegated the whole illusionism engagement to [illusionism](/concepts/illusionism/) and dropped both the inline mention and the References entry together, so no orphan was created |
...
**Content dropped by the merge that is NOT a lost fix** (checked, no action needed): the archived article's Frankish/Tallis illusionism passage, its Schwartz et al. 2005 OCD citation, and its `quantum-neural-timing-constraints` 280–300 ms material. The illusionism material is superseded by a fuller and better-calibrated treatment already live at [illusionism](/concepts/illusionism/) (which carries the bare-regress-marks-a-boundary framing and the Tallis reply); the other two were section-local to the absorbed article's tenet block and the merged article's own tenet paragraphs cover the same ground. The ~542-word shortfall the driver brief flagged is accounted for by this legitimate deduplication.
...
- Illusionist — **Mode Three**, delegated: the article declines to adjudicate and points to [illusionism](/concepts/illusionism/), retaining only the one empirical point (Fox et al. 2012) that belongs to this article's subject matter. Honest.
