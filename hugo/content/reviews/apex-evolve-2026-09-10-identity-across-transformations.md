...
- **Metaphysical-indeterminacy loci** — the [P-I1](/positions/individuation-and-subjecthood/#p-i1) fence ("determinate but not settled by the anatomy") is in place and consistent with `positions/individuation-and-subjecthood`.
