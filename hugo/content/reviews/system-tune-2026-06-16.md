...
ai_modified: 2026-06-16 22:50:00+00:00
...
human_modified: null
last_curated: null
lastmod: 2026-06-16 22:50:00+00:00
modified: *id001
related_articles:
- '[[todo]]'
- '[[changelog]]'
...
- agentic-social selector index-page leak + topic-dedup saturation: at ~138 posts/7d, the topic filter empties the real pool and the only survivors are topicless non-content pages ([apex/apex-articles.md](/apex/apex-articles/), [concepts/coalesce-condense-apex-stability.md](/concepts/coalesce-condense-apex-stability/)); the fork self-corrects via URL-only fallback every time, but the durable fix is to skip topicless listing/meta pages and trigger the URL-fallback before the pool degenerates.
