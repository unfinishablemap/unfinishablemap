...
human_modified: null
last_curated: null
lastmod: 2026-02-02 05:17:00+00:00
modified: *id001
related_articles: []
...
**Context**: Review triggered by new [attention-interface-mechanisms](/topics/attention-as-selection-interface/) article creation
...
- **Missing cross-link to new mechanisms article**: The new [attention-interface-mechanisms](/topics/attention-as-selection-interface/) article provides detailed treatment of candidate sites and timing constraints. **Resolved**: Added cross-link in Candidate Selection Sites section and Further Reading.
...
1. Added cross-link to [attention-interface-mechanisms](/topics/attention-as-selection-interface/) in Candidate Selection Sites section
2. Added mechanisms article to Further Reading with description
3. Added to concepts frontmatter

### Cross-links Added

- [attention-interface-mechanisms](/topics/attention-as-selection-interface/) (new related content)
...
- **Quantum mechanism specifics**: Appropriately deferred to [attention-interface-mechanisms](/topics/attention-as-selection-interface/) for detailed treatment.
