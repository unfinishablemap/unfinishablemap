...
**Previous review**: [2026-07-13](/reviews/deep-review-2026-07-13-sellars-manifest-and-scientific-images/)
...
One, queued rather than guessed at — **P2 refine-draft on [concepts/grain-mismatch.md](/concepts/grain-mismatch/)**: family resolution surfaced a quoted Sellars 1965 span, "Physical objects qua clouds of discrete particles cannot instantiate", live in **two** articles ([concepts/grain-mismatch.md](/concepts/grain-mismatch/) L37 and [voids/resolution-void.md](/voids/resolution-void/) L38). Three searches returned zero hits at any publisher; the source paper (*Review of Metaphysics* 18(3):430–451) is not online in full text and ditext does not host it.
