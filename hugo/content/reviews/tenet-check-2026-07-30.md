...
ai_modified: 2026-07-30 23:40:00+00:00
ai_system: claude-opus-5
author: null
concepts: []
created: 2026-07-30
date: &id001 2026-07-30
description: 'The corpus still passes on the classic reading. The new finding: the
  conceivability cluster has never been swept against the dependency-matrix row added
  two days ago, and runs Tenets 3 and 4 as inheritance.'
draft: false
human_modified: null
last_curated: null
last_deep_review: null
lastmod: 2026-07-30 23:40:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
**Predecessor**: [reviews/tenet-check-2026-07-29b.md](/reviews/tenet-check-2026-07-29b/) (23:55Z, ~23h ago). This pass (a) re-verifies its 22 error loci against current disk, (b) applies one lens no tenet-check has used before — the **tenet-dependency matrix** at [tenets/tenets.md](/tenets/) L152–174, whose conceivability-arguments row was added 2026-07-28 and has never been swept against the cluster it governs.
...
**A1 and A2 are closed and are not re-reported.** The 07-29b claim that both parsimony authority files carry "zero self-binding" was false when written; [concepts/parsimony-epistemology.md](/concepts/parsimony-epistemology/) L164 now closes with *"This page's claim stays defensive, as the fifth tenet requires: parsimony lacks the standing to settle the question in either direction"*, and [arguments/epistemological-limits-of-occams-razor.md](/arguments/epistemological-limits-of-occams-razor/) L94 has read *"This article makes the defensive case: parsimony cannot settle the consciousness debate"* throughout. A2 is a model, not a defect. One residue survives at A1 and is reported below as a **single-sentence internal contradiction**, quoted verbatim with its line number, which is the gate the driver set.

**The new finding is structural, and it is a scope gap rather than a regression.** [tenets/tenets.md](/tenets/) gained a conceivability-arguments row in its dependency matrix on 2026-07-28 (L160, L168). That row marks the quantum tenets and No-Many-Worlds **not invoked** for the zombie / knowledge-argument / explanatory-gap / inverted-qualia cluster, and states the discipline explicitly: *"a No-Many-Worlds subsection in a cluster article should read as an intra-framework coherence remark rather than as inheritance in either direction."* Four of the five cluster articles have "Relation to the Map's Perspective" subsections that run exactly the inheritance the row forbids. Of the five, only [concepts/inverted-qualia.md](/concepts/inverted-qualia/) carries a coherence marker; the other four score **zero**. The matrix was written; the cluster was never brought to it.
...
The two headline loci from 07-29b are **fixed**: [concepts/self-stultification.md](/concepts/self-stultification/) L191 and [topics/self-stultification-as-master-argument.md](/topics/self-stultification-as-master-argument/)'s "demonstrate its falsity" are both gone. Four remain, all re-verified on disk:
...
Two tasks are already in flight (a P2 on [concepts/mysterianism.md](/concepts/mysterianism/), a P3 on [concepts/haecceity.md](/concepts/haecceity/)), and today's `/pessimistic-review` enumerated 15 D2 loci. **The five below are outside all three of those enumerations** and were read individually, so they are confirmed rather than grepped:
...
- [concepts/parsimony-epistemology.md](/concepts/parsimony-epistemology/) L164 and [arguments/epistemological-limits-of-occams-razor.md](/arguments/epistemological-limits-of-occams-razor/) L94 — the A1/A2 "zero self-binding" premise was **false when written**. A2 is a model. Only A1 L140 survives.
- [concepts/prebiotic-collapse.md](/concepts/prebiotic-collapse/) — the Wheeler misattribution (B1) is gone; "conscious observation selecting which history" returns 0 in all three trees.
- [concepts/entanglement-binding-hypothesis.md](/concepts/entanglement-binding-hypothesis/) L78 — "probable rather than merely possible" (B3) is gone.
- [concepts/self-stultification.md](/concepts/self-stultification/) L191 and [topics/self-stultification-as-master-argument.md](/topics/self-stultification-as-master-argument/) "demonstrate its falsity" — both gone.
- [concepts/mysterianism.md](/concepts/mysterianism/) — the 07-30 calibration holds on disk: L186 now reads that mysterianism "defends the legitimacy of the indexical question that many-worlds dissolves; it supplies no reason to think many-worlds false", and the invisibility-as-confirmation clause is deleted. Verified live in hugo.
- `archive/concepts/cognitive-closure.md` L69 — the matching fix is present.

## Assessed and Excluded — Legitimate, Do Not Flag

- **Every direct-contradiction hit in Tenets 1, 3 and 4.** 61 obsidian article-tree loci, all exposition-to-refute, attributed, conditional-antecedent, or definitional. Specifically: all 17 `all branches are equally real` loci describe MWI in order to reject it (including `tenets.md` L112, which is the definition); all 23 `consciousness is epiphenomenal` loci are antecedents of reductio conditionals; [concepts/buddhism-and-dualism.md](/concepts/buddhism-and-dualism/) L52 and [concepts/witness-consciousness.md](/concepts/witness-consciousness/) L57 say Buddhism *does not* claim consciousness is an illusion.
- **Steelman articles running a rival's parsimony case in the rival's voice** — the discipline [apex/steelmanning-as-method.md](/apex/steelmanning-as-method/) installs.
...
- **[concepts/jourdain-hypothesis.md](/concepts/jourdain-hypothesis/) L147** and **[topics/the-self-minimal-narrative-and-substantial.md](/topics/the-self-minimal-narrative-and-substantial/) L103** — both run the regress and both calibrate it in the adjacent line. A zero-marker grep flags them; reading clears them.
...
- **[concepts/physics-as-disclosure.md](/concepts/physics-as-disclosure/) L98, [topics/consciousness-and-the-ontology-of-temporal-becoming.md](/topics/consciousness-and-the-ontology-of-temporal-becoming/) L100, [voids/death-void.md](/voids/death-void/) L58** — pattern-matched by D2 but not the regress at all.
...
1. **Family M — [concepts/philosophical-zombies.md](/concepts/philosophical-zombies/) L203 and L207** (highest leverage). The flagship conceivability page contradicts both `tenets.md` L168 and its own L163, on a live hugo page, and the corrected text exists verbatim at [concepts/zombie-master-argument.md](/concepts/zombie-master-argument/) L112 and [concepts/inverted-qualia.md](/concepts/inverted-qualia/) L181. Substitution-only (`hard_warning`, 3531 words). Doing this one file also establishes the pattern for M3 and M4.
2. **Family M remainder — [concepts/explanatory-gap.md](/concepts/explanatory-gap/) L191 and [concepts/knowledge-argument.md](/concepts/knowledge-argument/) L167.** Same fix, two files, no length pressure at knowledge-argument.
3. **[concepts/parsimony-epistemology.md](/concepts/parsimony-epistemology/) L140** — a single sentence, the last A1 residue, currently contradicting its own L164 twenty-four lines later. Cheapest high-visibility fix in the report (32 inbound citations).
4. **Family B archive siblings — `archive/topics/collapse-before-minds.md` L137 and `archive/concepts/quantum-biology.md` L75**, together with [concepts/prebiotic-collapse.md](/concepts/prebiotic-collapse/) L150. Three loci, one precedent-not-licence formula, and the archive pair has never been touched by any sweep. These are full serving bodies.
5. **Family D's five un-enumerated loci**, inheriting from [topics/personal-identity.md](/topics/personal-identity/) L148–150 rather than from a short formula. Coordinate with the open P2/P3 and today's pessimistic review to avoid a same-file pileup.
...
7. **[apex/attention-as-causal-bridge.md](/apex/attention-as-causal-bridge/) L66** — one phrase, trivially fixed, and it is the only place in the corpus where a Rules-out clause's own words appear unqualified in Map voice.
