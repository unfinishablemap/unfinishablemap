...
- **Verification**: clean. Both navigation surfaces grep-confirmed verbatim (`description:` L3, lead L53), as is the article's own contrary concession at L135 and [P-CS4](/positions/consciousness-scope/#p-cs4)'s "compatible with — not forced by" at [positions/consciousness-scope.md](/positions/consciousness-scope/) L79.
- **Quotes**:
