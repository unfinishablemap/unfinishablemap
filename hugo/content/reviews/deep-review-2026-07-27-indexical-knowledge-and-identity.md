...
**Previous review**: [2026-07-11](/reviews/deep-review-2026-07-11-indexical-knowledge-and-identity/)
...
- [topics/qm-interpretations-beyond-many-worlds.md](/topics/qm-interpretations-beyond-many-worlds/) (inline + ref 24)
- [topics/quantum-immortality-and-the-quantum-suicide-survival-argument.md](/topics/quantum-immortality-and-the-quantum-suicide-survival-argument/) (inline + ref 16; also `206:221` → `206(5), Article 221`)
- [topics/probability-problem-in-many-worlds.md](/topics/probability-problem-in-many-worlds/) (3 inline + ref; ref list is alphabetical, so the entry was moved from position 6 to 4 and 4–6 renumbered)
- [topics/indexical-identity-quantum-measurement.md](/topics/indexical-identity-quantum-measurement/) (inline + ref 6)
...
### Cross-links Added
- [probability-problem-in-many-worlds](/topics/probability-problem-in-many-worlds/) added to Further Reading — the article invokes the Sebens–Carroll / Dawid–Friederich dispute but previously had no route to the Map's full-resolution treatment of it.
...
- [topics/quantum-immortality-and-the-quantum-suicide-survival-argument.md](/topics/quantum-immortality-and-the-quantum-suicide-survival-argument/) describes O'Brien twice as a "survey" (lines 44, 68). Accurate enough in context and not corrected here to avoid scope creep, but a future pass on that article should replace "survey" with "taxonomy" or "paper".
