...
**Date**: 2026-06-26
**Article**: [Outer-Review Empirical vs. Methodological Freshness](/project/outer-review-empirical-vs-methodological-freshness/)
**Previous review**: Never

## Pessimistic Analysis Summary

### Critical Issues Found
- **Wrong-section path on a named integration target**: the article listed the Duch integration as appearing at [concepts/comparing-quantum-consciousness-mechanisms.md](/topics/comparing-quantum-consciousness-mechanisms/). That path does not exist; the live file is [topics/comparing-quantum-consciousness-mechanisms.md](/topics/comparing-quantum-consciousness-mechanisms/) (7 Duch mentions, last deep-reviewed 2026-06-20). No deletion record in `concepts/` — it was always a wrong-section reference, not an archive casualty. **Resolution**: corrected path `concepts/` → `topics/` in the body.
...
- research dossier [research/wlodzislaw-duch-consciousness-2026-05-02.md](/research/wlodzislaw-duch-consciousness-2026-05-02/) — exists — state: real-correct
