...
**Previous review**: [2026-07-06](/reviews/deep-review-2026-07-06-selection-criterion-problem/) (also 2026-06-06, 2026-05-25)
...
claim with the parallel 'no fourth option' cross-link to [trilemma-of-selection](/topics/trilemma-of-selection/)." That parallel was
...
### Cross-links Added
- [born-preserving-causal-efficacy](/apex/born-preserving-causal-efficacy/) (body ×2, `related_articles`, Further Reading)
- [agent-causation](/concepts/agent-causation/) (body)
...
scoped to [P-Q2](/positions/quantum-interface/#p-q2)'s *exact* marginal preservation and are fine. This review verified only the one file it
