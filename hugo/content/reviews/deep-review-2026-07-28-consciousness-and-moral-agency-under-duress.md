...
- The residual-variance calibration is now aligned with [P-A3](/positions/agency-and-will/#p-a3). If a future pass finds itself wanting to restore "the residual is evidence," that is register drift, not an improvement.
