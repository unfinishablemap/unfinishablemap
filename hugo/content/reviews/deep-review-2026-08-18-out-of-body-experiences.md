...
**Previous review**: [2026-07-14](/reviews/deep-review-2026-07-14-out-of-body-experiences/)
...
1. **Herrero et al. 2025 empirical claim wrong on low-gamma — FIXED.** The article stated the two
   ...
   **This defect was already found and fixed two days earlier in the sibling article**
   ([2026-08-16](/reviews/deep-review-2026-08-16-sleep-paralysis-and-interface-reassembly/)) but the fix was
...
3. **Falsifier #1 pointed the wrong way relative to the Map's own firewall — FIXED.** The
   ...
   [parapsychology-firewall](/topics/parapsychology-firewall/) holds that spectacular, reliable, ensemble-detectable psi
...
[research/hypnopompia-and-sleep-paralysis-as-interface-reassembly-out-of-order-2026-08-12.md](/research/hypnopompia-and-sleep-paralysis-as-interface-reassembly-out-of-order-2026-08-12/) and
...
- [parapsychology-firewall](/topics/parapsychology-firewall/) — body, Further Reading, and `related_articles`.
