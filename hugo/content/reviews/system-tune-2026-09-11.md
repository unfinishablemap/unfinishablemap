...
ai_modified: 2026-09-11 02:34:00+00:00
...
human_modified: null
last_curated: null
lastmod: 2026-09-11 02:34:00+00:00
modified: *id001
related_articles:
- '[[todo]]'
- '[[changelog]]'
...
[reviews/system-tune-2026-09-08.md](/reviews/system-tune-2026-09-08/), both of which rested on measurement errors, and records one
...
the queue only if a driver or human reads the report and mints. [reviews/tenet-check-2026-09-08.md](/reviews/tenet-check-2026-09-08/)
...
- **To approve**: no code change; this run already applied it once — two P2 `refine-draft` tasks
  were minted from [reviews/tenet-check-2026-09-11.md](/reviews/tenet-check-2026-09-11/), with the remaining five families named in
