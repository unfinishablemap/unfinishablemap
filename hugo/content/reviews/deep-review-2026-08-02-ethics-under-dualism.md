...
**Previous review**: [2026-07-14](/reviews/deep-review-2026-07-14-ethics-under-dualism/)
...
- `2ea81dc7d` (expand-topic creating [concepts/sentientism.md](/concepts/sentientism/)) rewired the Suffering section's sentientism mention into a live wikilink.
...
**Position understated against its own new hub — FIXED.** The Suffering section said the Map "aligns with a sophisticated valence-based sentientism." The new [concepts/sentientism.md](/concepts/sentientism/) states flatly that "The Unfinishable Map **holds** sentientism, but in a specific and contestable form: **phenomenal sentientism**," and that the phenomenal-vs-functional distinction "is the one the Map's position turns on." The bare label "valence-based" is exactly ambiguous across that distinction. Changed to name the variety held and mark the distinction, retaining the pluralist qualifier.
