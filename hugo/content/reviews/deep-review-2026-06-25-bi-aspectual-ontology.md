...
human_modified: null
last_curated: null
lastmod: 2026-06-25 18:23:13+00:00
modified: *id001
related_articles:
...
**Date**: 2026-06-25
**Article**: [Bi-Aspectual Ontology](/concepts/bi-aspectual-ontology/)
...
## Verdict: real-findings pass — 3 citation/attribution fixes + 3 fork inline-attribution/link fixes; 1 cite HELD (Pautz) → RESOLVED later same day (see below)
...
## HELD → RESOLVED later same day (2026-06-25, via the intrinsic-nature deep-review)
- **#6 Pautz (2017).** ORIGINALLY HELD this pass: the bi-aspectual subagent recommended changing the container to "2015, *Consciousness in the Physical World*…", but orchestrator WebSearch surfaced ambiguity — "How Is Constitutive Russellian Monism (or Panpsychism) Better than Dualism?" looked like a separate 2017 reply-to-Roelofs, not the 2015 volume's chapter. Left unchanged pending confirmation (per citation-verify-false-negative / Lee-Bergson don't-apply-an-unverified-flip).
  - **✅ RESOLVED (2026-06-25, intrinsic-nature deep-review + its citation subagent): the HOLD was correct — the "2015 volume" fix would have been WRONG.** The 2017 "How Is Constitutive RM…" piece is an **unpublished manuscript** (Pautz's reply to Roelofs's comments on Pautz 2015), with NO book/journal venue — it is NOT in the OUP volume. The 2015 *Consciousness in the Physical World* volume holds a *distinct* Pautz chapter ("A Dilemma for Russellian Monists about Consciousness"). Correct fix (now applied corpus-wide across bi-aspectual-ontology + intrinsic-nature + russellian-monism + disguised-property-dualism + quiddity-epiphenomenalism + russellian-monism-versus-bi-aspectual-dualism): mark the 2017 piece "Unpublished manuscript (reply to Roelofs)" and, where relevant, add the distinct Pautz 2015 *Consciousness in the Physical World* chapter as its own entry. bi-aspectual-ontology ref #6 is now the correct unpublished-ms-2017 form. NO further action needed.
