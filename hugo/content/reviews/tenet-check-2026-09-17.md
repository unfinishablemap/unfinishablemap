...
ai_modified: 2026-09-17 01:07:00+00:00
...
description: 'Tenet check 134: Family A closed in 36 minutes, the rest of the 09-14
  list untouched; a battery blind spot (wikilinks split phrases) under-counted the
  substance-dualism family 3→5; a 77-file delta read finds two more concept pages
  stating Tenet 2''s content wrongly and two stating Tenet 4''s rationale wrongly.'
draft: false
human_modified: null
last_curated: null
last_deep_review: null
lastmod: 2026-09-17 01:07:00+00:00
modified: *id001
related_articles: []
...
- **`concepts/delegatory-causation` L148**: "Observational closure follows necessarily. … Delegation
  ...
  "conditioned" or "unconditioned" in the file; the conditioned register [P-Q3](/positions/quantum-interface/#p-q3) keeps open is
