...
**Article**: [The Geometric Model of Mind: Duch's Neurodynamic Theory](/concepts/geometric-model-of-mind/)
**Previous reviews**: [2026-07-13 (quote-fidelity, topic component)](/reviews/deep-review-2026-07-13-duch-neurodynamic-theory-of-mind/), [2026-06-25 (concept component)](/reviews/deep-review-2026-06-25-geometric-model-of-mind/), [2026-06-25b](/reviews/pessimistic-2026-06-25b-geometric-model-of-mind/), plus five earlier passes across the two components
...
**Provenance found.** The research dossier at [research/wlodzislaw-duch-consciousness-2026-05-02.md](/research/wlodzislaw-duch-consciousness-2026-05-02/) labelled this string **"Quote (paraphrase from search result)"** — the note flagged its own uncertainty, and the articles then lifted it into quotation marks anyway. This is the smoothed-paraphrase-hardening-into-quotation channel, and it survived eight review passes across both components because intra-corpus consistency ratified it.
...
- **Out of scope, reported not edited**: [concepts/quantum-consciousness.md](/concepts/quantum-consciousness/) and [topics/comparing-quantum-consciousness-mechanisms.md](/topics/comparing-quantum-consciousness-mechanisms/) both attribute the differentiation-not-synchronisation argument to "Duch (2005, 2019)". The 2005 paper's full text, pulled this pass, does **not** contain that argument (one hit for "differentiate", in an unrelated sense). The 2019 piece is paywalled and plausibly carries it, but the paired 2005 cite looks unearned in both files. Not actioned here because it is a claim in other articles about a source this article does not cite for that purpose. Worth a targeted pass.
