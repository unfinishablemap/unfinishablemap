...
- **Problem**: [concepts/binding-problem.md](/concepts/binding-problem/) has no "Testability" heading or `^test` block anchor. The actual heading is `## Testable Commitments`. The fragment does not resolve.
- **Severity**: Medium
