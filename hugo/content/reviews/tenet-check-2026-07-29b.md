...
ai_modified: 2026-07-29 23:55:08+00:00
ai_system: claude-opus-5
author: null
concepts: []
created: 2026-07-29
date: &id001 2026-07-29
description: 'Second 07-29 pass: the day''s calibration reached the leaves but not
  the roots. Two uncalibrated parsimony authority files, a stranded Wheeler sibling,
  and research/ never swept.'
draft: false
human_modified: null
last_curated: null
last_deep_review: null
lastmod: 2026-07-29 23:55:08+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
**Scope**: All five tenets. Complements [reviews/tenet-check-2026-07-29.md](/reviews/tenet-check-2026-07-29/) (01:20Z, Tenets 1/2/3/5) and [reviews/tenet-check-2026-07-28.md](/reviews/tenet-check-2026-07-28/) (Tenet 4). This pass audits (a) whether the 01:20Z findings were executed, (b) the ~90 content files changed in the 22 hours since, and (c) two surfaces no tenet-check has ever covered.
...
**The 01:20Z report was almost entirely executed.** All 7 errors are fixed, 10 of 11 warnings, and 7 of 8 notes. [concepts/many-worlds.md](/concepts/many-worlds/) now leads with the indexical objection and demotes extravagance to "a registered cost of MWI rather than a refutation of it"; [concepts/quantum-interpretations.md](/concepts/quantum-interpretations/) L48 now reads "Ontological extravagance is the fifth and the weakest"; [apex/phenomenology-mechanism-bridge.md](/apex/phenomenology-mechanism-bridge/) L87 now distinguishes the irreducibility claim (which does follow from Tenet 1) from the persisting-substance claim (downstream of agent causation). That is a genuinely large day of calibration and this report does not disturb any of it.
...
1. **The parsimony roots are uncalibrated while their dependants were fixed.** [concepts/parsimony-epistemology.md](/concepts/parsimony-epistemology/) (32 inbound citations) and [arguments/epistemological-limits-of-occams-razor.md](/arguments/epistemological-limits-of-occams-razor/) (14 inbound) are the two files every calibrated leaf cites as its authority. Both contain **zero** self-binding language — `grep -cniE "veto|run forward|symmetr|binds the Map|does not license"` returns 0 for each — and both close with a forward-running parsimony verdict. Meanwhile [topics/parsimony-case-for-interactionist-dualism.md](/topics/parsimony-case-for-interactionist-dualism/), [concepts/concession-convergence.md](/concepts/concession-convergence/), [topics/death-and-consciousness.md](/topics/death-and-consciousness/), [arguments/materialism-argument.md](/arguments/materialism-argument/) and [topics/brain-specialness-boundary.md](/topics/brain-specialness-boundary/) all now carry the settled formula. The leaves inherit from two sources that do not hold the discipline.

2. **Same-family siblings were stranded by query-scoped sweeps.** Today's Wheeler calibration fixed [topics/wheelers-participatory-universe-and-it-from-bit.md](/topics/wheelers-participatory-universe-and-it-from-bit/) and its archived predecessor, but [concepts/prebiotic-collapse.md](/concepts/prebiotic-collapse/) still asserts twice what Wheeler explicitly denied, with no disclaimer anywhere in the file. Today's illusionist-regress calibration fixed three hub articles but left six near-verbatim satellite "Illusionist Challenge" sections, plus two more the changed-file scope never reached. Today's self-stultification calibration fixed the concept-definition and scope-limit loci but not the closing-synthesis loci.
...
The governing text is [tenets/tenets.md](/tenets/) L144, whose Rules-out clause is explicitly reflexive: "and—internally—any Map argument that leans on parsimony as if this tenet did not apply to it." L142: "parsimony cannot decide for or against a framework." The settled corpus formula is "That tenet does not license the posit; it only refuses to let parsimony *veto* it."

**A1. `obsidian/concepts/parsimony-epistemology.md` L140** — the corpus's most-cited Tenet 5 authority (32 inbound).
> "Ontological parsimony still favours physicalism, but on explanatory adequacy — the dimension most relevant to consciousness — dualism has the advantage; the [positive parsimony case](/topics/parsimony-case-for-interactionist-dualism/) develops this systematically."
...
> "The [positive case](/topics/parsimony-case-for-interactionist-dualism/) goes further, arguing that when all dimensions of simplicity are counted — not just substance types but theoretical proliferation, brute facts, and explanatory directness — interactionist dualism emerges as the more parsimonious position."

The target article refuses simpler-therefore-truer in terms; this gloss strips the bracketing. L99's Further Reading label repeats it. **Disambiguation hazard**: the near-identically-named [voids/epistemological-limits-occams-razor.md](/voids/epistemological-limits-occams-razor/) is **exemplary** — L91 concedes the ecumenical symmetry ("the void does not establish dualism"), L99 says "clearing space for Tenet 1, not as establishing it", L101 carries the Tenet 2 minimality calibration. Do not confuse the two files. Length: 1857 words — ample room.
...
> "Moreover, ontological parsimony favours physicalism, but explanatory parsimony favours dualism—a key distinction from [parsimony-epistemology](/concepts/parsimony-epistemology/)."
...
This is the same claim the 01:20Z report flagged at [concepts/concession-convergence.md](/concepts/concession-convergence/) L153 and which was fixed today to read "reads it as an internal critique of the objection rather than positive evidence for dualism." The cited source [topics/parsimony-case-for-interactionist-dualism.md](/topics/parsimony-case-for-interactionist-dualism/) L138 says "not as positive evidence for dualism but as an internal critique of the objection" and L145 "without ever conceding that the simpler theory is, for that reason, the truer one." This file drops all of it. Last touched 2026-06-24, so today's sweep never reached it. Notably, its Tenet 3 and Tenet 4 sections (L96, L98) are models of calibration — only the Tenet 5 section lapsed.
...
The calibrated register was installed today at [concepts/illusionism.md](/concepts/illusionism/) L91, [concepts/explanatory-gap.md](/concepts/explanatory-gap/) L115 ("Taken bare it proves nothing"), [concepts/mind-brain-separation.md](/concepts/mind-brain-separation/) L96 ("does not settle the matter, and the Map does not run it as though it") and [concepts/mental-effort.md](/concepts/mental-effort/) L126. Eight satellites still run it flat. The six the changed-file scan found:
...
- **`obsidian/topics/self-stultification-as-master-argument.md` L155, L167, L79** — "Any theory that violates this constraint is rationally unendorsable"; "not merely counterintuitive but rationally untenable"; illusionism "inherits the same self-stultification", where [concepts/illusionism.md](/concepts/illusionism/) L151 concedes the convergence "assumes rather than establishes".
...
- **`obsidian/concepts/interactionist-dualism.md` L179** — heading "### Where the Map's Tenets Take a Substance-Leaning Sub-Reading" sources the lean to the tenets; its own body at L181 and `tenets.md` L56/L180 place it downstream of agent causation. Retitle to the form used at [concepts/substance-property-dualism.md](/concepts/substance-property-dualism/) L159. **This is the run's only Tenet 1 finding.**
...
- **`obsidian/research/voids-anesthesia-void-2026-04-17.md` L164** — "**The interface-disruption reading is more parsimonious**". *Good news*: the live [voids/anesthesia-void.md](/voids/anesthesia-void/) did **not** inherit it — L124 reads "a parsimony move that outruns the evidence… Simpler is not safer when the evidence is this layered" and L137 concedes cessation-physicalism "would become the more parsimonious reading". The live article is a model; the research note is the residue.
...
Correctly calibrated and **not** to be flagged: [research/cosmopsychism-2026-07-13.md](/research/cosmopsychism-2026-07-13/) L201 (uses Tenet 5 defensively against cosmopsychism's own parsimony marketing) and [research/steelman-for-value-blind-selection-2026-06-18.md](/research/steelman-for-value-blind-selection-2026-06-18/) (steelmans the parsimonious rival as an explicit discipline).
...
- Self-stultification "presses hard against" / "threatens" rather than "defeats" — `tenets.md` L98 forbids the stronger inference and L100 concedes the phenomenal-concept strategy survives. The canonical statements at [concepts/bidirectional-interaction.md](/concepts/bidirectional-interaction/) L59, [arguments/materialism-argument.md](/arguments/materialism-argument/) L86 and L142, and [concepts/self-stultification.md](/concepts/self-stultification/) L201 are **models**, not defects.
- Illusionism as a spectrum rather than a Hard/Soft binary ([concepts/illusionism.md](/concepts/illusionism/) L71–79, using Graziano's own "subtle" contrast term); the bare regress proving nothing.
- The Wheeler disclaimer at [topics/wheelers-participatory-universe-and-it-from-bit.md](/topics/wheelers-participatory-universe-and-it-from-bit/) L154/L158 — required honesty, not a Tenet 3 shortfall.
- "Empirically indistinguishable from chance" as a by-construction framework boundary rather than a sensitivity limit — [topics/testing-consciousness-collapse.md](/topics/testing-consciousness-collapse/) L230 is now exemplary on exactly this.
...
- Exposition-to-refute and attributed claims throughout: [topics/eliminative-materialism.md](/topics/eliminative-materialism/), [concepts/materialism.md](/concepts/materialism/), [concepts/illusionism.md](/concepts/illusionism/), [concepts/objections-to-interactionism.md](/concepts/objections-to-interactionism/) L65, [topics/delegatory-dualism.md](/topics/delegatory-dualism/) L52 (attributed to Saad), [concepts/indexical-identity-quantum-measurement.md](/topics/indexical-identity-quantum-measurement/) L97 and [concepts/parfit-reductionism.md](/concepts/parfit-reductionism/) L63 (both describing MWI, not endorsing it), and every `Bösch 2006` / `Maier 2018` citation of the negative psi record.
- [apex/phenomenology-of-consciousness-doing-work.md](/apex/phenomenology-of-consciousness-doing-work/) L155 — "The profile establishes that consciousness does cognitive work" sits inside a paragraph that explicitly disclaims decisiveness and layers the claim honestly. Judged calibrated.
- The two "establishes that consciousness" loci at [topics/argument-from-reason.md](/topics/argument-from-reason/) L152 and [concepts/measurement-problem.md](/concepts/measurement-problem/) L189 are **already queued** as a P3 whose notes state a no-op is a legitimate outcome. Do not re-mint.
...
2. **[concepts/prebiotic-collapse.md](/concepts/prebiotic-collapse/)** (B1, B2, plus the L146 note) — three loci, one file, one pass. Contradicts today's own Wheeler calibration on a published page. Substitution-only: 3520 words, `hard_warning`.
