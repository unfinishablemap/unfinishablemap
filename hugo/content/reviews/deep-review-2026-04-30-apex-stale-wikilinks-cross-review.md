...
modified: *id001
related_articles: []
title: Deep Review - Apex stale-wikilink cross-review (numerosity-void / quantitative-intuition-void
  / mathematical-void retargets)
topics: []
---

**Date**: 2026-04-30 03:11 UTC
**Articles reviewed**: [taxonomy-of-voids](/apex/taxonomy-of-voids/), [medium-status-voids-in-cognition](/apex/medium-status-voids-in-cognition/), [conjunction-coalesce](/apex/conjunction-coalesce/)
**Trigger**: P2 task — cross-review apex articles for stale wikilinks to `numerosity-void` / `quantitative-intuition-void` / `mathematical-void` slugs after their 2026-04-30 00:40 UTC coalesce into [the quantitative comprehension void](/voids/the-quantitative-comprehension-void/).
...
- `voids/numerosity-void` → archived; replaced by [the cardinality floor face](/voids/the-quantitative-comprehension-void/#the-cardinality-floor)
- `voids/quantitative-intuition-void` → archived; replaced by [the magnitude-and-probability domain face](/voids/the-quantitative-comprehension-void/#the-magnitude-and-probability-domain)
...
All issues were the same shape: stale wikilinks pointing at `[numerosity-void](/voids/the-quantitative-comprehension-void/)`, `[quantitative-intuition-void](/voids/the-quantitative-comprehension-void/)`, or `[mathematical-void](/voids/the-quantitative-comprehension-void/)` slugs that no longer exist in `obsidian/voids/`.

**Article: taxonomy-of-voids.md**
- frontmatter line 33: `"[numerosity-void](/voids/the-quantitative-comprehension-void/)"` in related_articles — **retargeted** to `"[the-quantitative-comprehension-void](/voids/the-quantitative-comprehension-void/)"`
- §"Phenomenological Cluster" (line 109): "The [numerosity void](/voids/the-quantitative-comprehension-void/) specialises onto cardinal perception itself..." — **retargeted** to `[cardinality floor face](/voids/the-quantitative-comprehension-void/#the-cardinality-floor) of [the quantitative comprehension void](/voids/the-quantitative-comprehension-void/)`. The body text (architectural ceiling at four items, serial counting / magnitude estimation, output-without-operation, Trick & Pylyshyn / Cowan citations) remains accurate as a description of the cardinality floor face.
- §"How Thought Fails" (line 149): "the [numerosity void](/voids/the-quantitative-comprehension-void/) (cap + transition + mechanism)" in conjoint-voids list — **retargeted** to `[cardinality floor](/voids/the-quantitative-comprehension-void/#the-cardinality-floor) face of [the quantitative comprehension void](/voids/the-quantitative-comprehension-void/)`. The cap/transition/mechanism three-face structure remains accurate at the section level within the larger void.

**Article: medium-status-voids-in-cognition.md**
- §"Content-Status, Capacity-Status, Medium-Status" (line 59): "the [incompleteness phenomena](/voids/the-quantitative-comprehension-void/)" — **retargeted** to `[incompleteness phenomena](/voids/formal-cognitive-limits/)`. The text references "incompleteness phenomena" specifically (Gödel/Turing/Rice/Chaitin); the canonical home for these is `formal-cognitive-limits.md`, not the new the-quantitative-comprehension-void (which covers phenomenal grasp of mathematical structures, a different aspect that was part of the old mathematical-void's scope but is now shed from the merged article). This is the analytically correct retarget rather than the lexically simpler one.

**Article: conjunction-coalesce.md** (substantive revision)
- frontmatter line 20: `"[numerosity-void](/voids/the-quantitative-comprehension-void/)"` in related_articles → `"[the-quantitative-comprehension-void](/voids/the-quantitative-comprehension-void/)"`
...
- §"Two Coalesces and Two Cognates" (line 81, the "second cognate" paragraph) — **substantive revision applied**:
  ...
  - opening: `[The numerosity void](/voids/the-quantitative-comprehension-void/) is a three-face creation-time cognate...` → `The [cardinality floor face](/voids/the-quantitative-comprehension-void/#the-cardinality-floor) of [the quantitative comprehension void](/voids/the-quantitative-comprehension-void/)—formerly the standalone numerosity void, coalesced into the larger article on 2026-04-30—is a three-face creation-time cognate...`
...
Spot-checked the new prose in conjunction-coalesce.md against [the-quantitative-comprehension-void](/voids/the-quantitative-comprehension-void/):
