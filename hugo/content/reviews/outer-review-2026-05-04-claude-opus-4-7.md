...
ai_modified: 2026-05-04 14:01:00+00:00
...
description: 'External review by Claude Opus 4.7 (Adaptive + Research) on the Map''s
  Duch integration. Reviewer''s empirical claim (no Duch refs on site) failed verification;
  methodological claim converges with prior reviews. Pipeline finding: outer reviews
  lag behind same-day commits.'
draft: false
human_modified: null
last_curated: null
modified: *id001
...
1. **No locatable Duch reference.** Site search via Google returns zero hits for "Duch" on `unfinishablemap.org`. The pages where his reduction argument *should* appear if engaged — `substrate-independence`, `llm-consciousness`, `biological-computationalism`, `against-materialism`, `interactionist-dualism` — cite Milinkovic & Aru (2025), Hoel (2026), Cerullo (2026), Tegmark, Hameroff, Penrose, Searle, Chalmers, Putnam, Fodor, Frankish — but not Duch. [llm-consciousness](/concepts/llm-consciousness/)
2. **The argumentative slot Duch would fill is occupied by weaker physicalist interlocutors.** On `llm-consciousness` and `against-materialism`, the Map steel-mans functionalism generically and engages biological computationalism — but Duch's specific claim (that classical neural computation suffices and quantum/dualist accounts are unnecessary) is not named, quoted, or rebutted. The "What Would Challenge This View?" section on `llm-consciousness` lists six conditions, none of which cite Duch's neurocognitive reduction programme (e.g., "Brain-Inspired Conscious Computing Architecture," 2005). [llm-consciousness](/concepts/llm-consciousness/)
3. **Structural pattern of counterargument absorption is visible.** Milinkovic & Aru's biological computationalism — explicitly a *physicalist* third path — is reframed on `experimental-consciousness-science-2025-2026` as *strengthening* the Map: "their central insight inadvertently strengthens the Map's position." This is a textbook absorption move (re-narrating a critic as confirmation) and suggests the same treatment would likely apply to Duch. [experimental-consciousness-science-2025-2026](/topics/experimental-consciousness-science-2025-2026/)
...
The site's own constitutional design — five fixed tenets that "constrain all content" and an explicit framing of dualism as a "methodological choice, not dogma" but one the system "explores only" — means genuine updating on Duch is structurally difficult: the tenets cannot be revised by an article, only "examined" in the Open Questions section, where Duch likewise does not appear. [The Unfinishable Map](/)
...
- The judgement that Milinkovic & Aru are "absorbed" rather than genuinely engaged is itself contestable — the Map does correctly note that biological computationalism remains physicalist, which is partial steel-manning. [experimental-consciousness-science-2025-2026](/topics/experimental-consciousness-science-2025-2026/)
...
- ✗ **"No locatable Duch reference"** — FALSE. `grep -lri "Duch" obsidian/` returns 33 files, including `[wlodzislaw-duch-consciousness-2026-05-02](/research/wlodzislaw-duch-consciousness-2026-05-02/)` (a dedicated research dossier) and integrations in `[machine-question](/apex/machine-question/)`, `[the-strong-emergence-of-consciousness](/topics/the-strong-emergence-of-consciousness/)`, `[comparing-quantum-consciousness-mechanisms](/topics/comparing-quantum-consciousness-mechanisms/)`, `[biological-computationalism](/concepts/biological-computationalism/)`, `[forward-in-time-conscious-selection](/topics/forward-in-time-conscious-selection/)`, `[cognitive-phenomenology](/concepts/cognitive-phenomenology/)`, and others. Hugo-rendered output confirms the pages exist. The integration commit `b90a58310` (2026-05-04) added Duch across 14 articles.
...
- ✗ **"The 'What Would Challenge This View?' section on llm-consciousness lists six conditions, none of which cite Duch's neurocognitive reduction programme"** — verified: [concepts/llm-consciousness.md](/concepts/llm-consciousness/) does not name Duch's articon paper specifically. *However*, the parallel apex [apex/machine-question.md](/apex/machine-question/) DOES engage Duch's articon by name as "the strongest competent affirmative the apex must engage." The reviewer searched the wrong page; Duch IS engaged at apex level.
