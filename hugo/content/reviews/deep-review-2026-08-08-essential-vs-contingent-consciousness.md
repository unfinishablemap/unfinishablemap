...
**Previous reviews**: [2026-07-16](/reviews/deep-review-2026-07-16-essential-vs-contingent-consciousness/), [2026-06-06](/reviews/deep-review-2026-06-06-essential-vs-contingent-consciousness/), [2026-05-27](/reviews/deep-review-2026-05-27-essential-vs-contingent-consciousness/)
...
- [topics/contentless-awareness-evidence.md](/topics/contentless-awareness-evidence/) L39: "The *Mandukya Upanishad* analyses consciousness into **four**: waking, dream, dreamless sleep (*sushupti*), and *turiya*, the witnessing awareness said to underlie all three."
- [voids/sleep-consciousness-void.md](/voids/sleep-consciousness-void/) L93: "Turiya is not a fourth state alongside the others but the witnessing background underlying all three. The Mandukya Upanishad identifies this **fourth** state."
...
Fixed by adding two explicit qualifications — that his contingency claim concerns selfhood rather than consciousness, and that he writes under naturalistic assumptions the Map declines while drawing on the phenomenology. The Map's sibling [voids/edge-states-and-void-probes.md](/voids/edge-states-and-void-probes/) L102 already models exactly this discipline ("This is a disagreement *within* Metzinger's framing, not support drawn from it"); this article now matches it.
