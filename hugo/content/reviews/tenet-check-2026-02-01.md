...
date: '2026-02-01'
draft: false
lastmod: 2026-02-01 00:00:00+00:00
related_articles: []
title: Tenet Alignment Check - 2026-02-01
---
...
All materialist positions (reductive physicalism, eliminativism, functionalism) are explicitly presented as views the Map rejects. Key files like `materialism.md`, `epiphenomenalism.md`, and `reductionism.md` develop thorough critiques. The explanatory gap argument, knowledge argument, and conceivability arguments are consistently deployed.

No files endorse eliminative materialism or reductive physicalism as the Map's position.

### Tenet 2: Minimal Quantum Interaction

**Status**: Aligned with appropriate caution

The quantum consciousness files (`quantum-consciousness.md`, `stapp-quantum-mind.md`, `causal-closure.md`) present mechanisms as hypotheses, not established facts. The decoherence objection is honestly addressed with acknowledgment of ongoing debate.

No files endorse quantum woo, uncontrolled psychokinesis, or empirically detectable mind-matter violations.

### Tenet 3: Bidirectional Interaction

**Status**: Strong alignment

`epiphenomenalism.md` develops a robust critique showing epiphenomenalism is self-undermining. The consciousness and attentional economics articles explicitly affirm bidirectional interaction. `causal-closure.md` defends against closure-based objections.

No files treat consciousness as causally inert or "along for the ride."

### Tenet 4: No Many Worlds

**Status**: Strong alignment—extensively developed

`many-worlds.md` provides a comprehensive five-argument case against MWI. `haecceity.md` and `indexical-facts.md` develop the philosophical basis for why indexical identity matters. The rejection is principled (identity, probability, consciousness-role arguments), not dogmatic.

All files discussing MWI explicitly reject it while acknowledging its mathematical elegance.

### Tenet 5: Occam's Razor Has Limits

**Status**: Aligned

Multiple files explicitly apply this tenet (`many-worlds.md`, `reductionism.md`, `materialism.md`). The content appropriately resists appeals to parsimony as decisive when evidence demands complexity.

No files use simplicity as a decisive argument against dualism.

## Cross-Cutting Observations

### Presenting Opposing Views Appropriately

Several files discuss positions the Map rejects. This is handled correctly with:
- Explicit framing (e.g., "the Map rejects this")
- Fair development of why the view is attractive
- Substantive objections, not strawmen
- Acknowledgment of internal debates within opposing camps

Examples of excellent engagement:
- `illusionism.md`: Presents illusionism as "strongest physicalist response" while explaining its self-undermining structure
