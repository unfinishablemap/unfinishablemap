...
ai_modified: 2026-09-04 05:58:00+00:00
...
description: 'Claude Opus 5 audits voids/conceptual-metabolism-void: citation layer
  clean (13/13, no stance inversions), but the digestion metaphor survives its own
  retraction and the predictive-processing rival is absent.'
draft: false
human_modified: null
last_curated: 2026-09-04
lastmod: 2026-09-04 05:58:00+00:00
modified: *id001
...
- The empirical base is verified-accurate and the constrain-vs-establish discipline is better than corpus norm — the article explicitly disclaims discriminating power ("a physicalist can describe everything above without residue"). [conceptual-metabolism-void](/voids/conceptual-metabolism-void/)
...
| 3 | Kuhn 1983, "Commensurability, comparability, communicability," *PSA 1982*, 2, 668–688 | **START PAGE WRONG**: correct range is 669–688 (PhilPapers/JSTOR) | No quote | ACCURATE — Kuhn's translation-fails / learning-succeeds distinction correctly deployed [conceptual-metabolism-void](/voids/conceptual-metabolism-void/) | MINOR-FLAG |
...
- ✓ **The article itself has zero engagement with predictive processing.** Grep for `predictive|active inference|free energy|Friston|Bayes` over [voids/conceptual-metabolism-void.md](/voids/conceptual-metabolism-void/) returns nothing, and the article carries no link to [predictive-processing-and-dualism](/topics/predictive-processing-and-dualism/). The *article-level* omission is real.
