...
- **Out of scope this pass**: `apex/`, `voids/`, `arguments/`, `reviews/`, `research/`, `workflow/`, `project/`. Spot-checking surfaced no obvious issues in those directories during scanning (the one match in [voids/conceptual-scheme-void.md](/voids/conceptual-scheme-void/) characterises MWI as ruled out, not endorsed), but a dedicated pass would be needed to claim alignment for them.
