...
**Date**: 2026-09-06
**Article**: [Representation Adequacy and Irreversible Intervention](/topics/representation-adequacy-and-irreversible-intervention/)
...
- [born-preserving-causal-efficacy](/apex/born-preserving-causal-efficacy/) (mechanism-debt paragraph)
...
- The sibling [dualism-as-ai-risk-mitigation](/topics/dualism-as-ai-risk-mitigation/) still carries its three open verified defects and an open P1 refine-draft task. Nothing was harmonised toward it, by design.
...
- **The mechanism debt is inherited, not dischargeable here.** [P-Q3](/positions/quantum-interface/#p-q3) and [P-Q10](/positions/quantum-interface/#p-q10) are open upstream. This article correctly reads no more confidently than the register does, and cites the causal-selection thesis at coherence-only grade. Do not ask this article to pay a debt the positions register holds.
