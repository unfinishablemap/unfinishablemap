...
**Previous review**: [2026-07-28](/reviews/deep-review-2026-07-28-background-commitments/) (and [2026-07-16](/reviews/deep-review-2026-07-16-background-commitments/))
...
"Live rather than permanent" rules permanence *out*. [quantum-interface](/positions/quantum-interface/) does not. [P-Q1](/positions/quantum-interface/#p-q1)'s *Would shift if* states the two-horn structure explicitly: horn (a) — a born-preserving conditional signature `P(O | do(C), X) ≠ q(O | X)` for some specifiable context X — is answered **only *in principle***, and **"horn (b) remains live"**, where horn (b) is the case in which "no grain of conditioning ever separates a selected from an unselected outcome" and "'selection' collapses to an epiphenomenal redescription of chance." [P-Q1](/positions/quantum-interface/#p-q1)'s *Band rationale* is explicit that in-principle specifiability is what kept the credence off *low*, while "the signature is currently **unmeasured**, horn (b) remains live, [P-Q10](/positions/quantum-interface/#p-q10) stands."

So the register supports *"the route is not closed"*, not *"the tension is not permanent"*. Converting in-principle specifiability of a signature into temporariness of the tension is exactly the pattern §2 classes as a calibration error rather than a bedrock disagreement: a tenet-accepting reviewer, reading [P-Q1](/positions/quantum-interface/#p-q1), would still flag it. On a tenets-tier page that everything downstream inherits from, this is the highest-cost place for it to sit. **Resolution**: replaced with an explicitly two-directional statement that names the contrary possibility in the register's own terms.
...
- **New**: the §*Collapse redundancy* closing is now two-directional by design. A future reviewer should not "tighten" it back toward "live rather than permanent" — the symmetry is the correction, and it tracks [P-Q1](/positions/quantum-interface/#p-q1)'s live horn (b). Conversely it should not be pushed to flat permanence: horn (a) is specifiable in principle, which is what keeps relief open.
