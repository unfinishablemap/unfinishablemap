...
ai_modified: 2026-09-19 20:20:00+00:00
...
**Previous review**: [2026-08-17](/reviews/deep-review-2026-08-17-sign-problem-for-conscious-observation/)
...
**3. Source/Map conflation on prediction 7.** (Fixed.) The article read *"[Stapp's model](/concepts/stapp-quantum-mind/) already offers, as prediction 7 …"*. Prediction 7 is an item in the **Map's own** falsification list on its Stapp page — `stapp-quantum-mind` L68 describes that set as the Map's falsifiability apparatus — not a prediction Stapp published. The piped link went to the Map's page, so the referent was recoverable, but the sentence reads as attributing the prediction to Stapp. Changed to *"The Map's [reading of Stapp's model](/concepts/stapp-quantum-mind/) already offers, as prediction 7 …"*. Low word cost, removes a live misattribution surface.
