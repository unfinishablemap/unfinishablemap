...
**Previous review**: [2026-08-06](/reviews/deep-review-2026-08-06-kripke-a-posteriori-necessity-argument/) (and [2026-07-13](/reviews/deep-review-2026-07-13-kripke-a-posteriori-necessity-argument/))
...
anti-materialist case to be strong" with a [P-D1](/positions/arguments-for-dualism/#p-d1)-calibrated version that names which
...
Lenses run this pass: (1) fidelity of the new [P-D1](/positions/arguments-for-dualism/#p-d1) paragraph against the position it
...
None. The new [P-D1](/positions/arguments-for-dualism/#p-d1) paragraph is accurate: [the-convergence-argument-for-dualism](/topics/the-convergence-argument-for-dualism/)
...
the explanatory gap), which is exactly the assignment the paragraph gives. [P-D1](/positions/arguments-for-dualism/#p-d1)'s own
...
- **Smart 1959 (Sensations and Brain Processes)** — **real-correct**, verified at Crossref
  ...
  *The Philosophical Review* 68(2), start page 141, issued 1959-04. Page range 141–156
  matches the corpus canonical form already used in [type-identity-theory](/concepts/type-identity-theory/) (ref 3).
...
- Position strength / Source-Map separation / Self-contradiction: unchanged from
  2026-08-06 (all passing). The new [P-D1](/positions/arguments-for-dualism/#p-d1) paragraph adds a Map-internal calibration and
...
- The three-part machinery exposition before deployment; the heat-manoeuvre / pain-failure
  contrast; the disciplined delegation to [phenomenal-concepts-strategy](/concepts/phenomenal-concepts-strategy/) and
  [conceivability-possibility-inference](/concepts/conceivability-possibility-inference/); the "What Kripke Does Not Conclude"
  subsection; and the [P-D1](/positions/arguments-for-dualism/#p-d1)-calibrated Tenet 1 paragraph installed on 2026-09-10, which
...
- **New**: the Tenet 1 paragraph's cluster assignment (knowledge argument in Cluster 1;
  ...
  [the-convergence-argument-for-dualism](/topics/the-convergence-argument-for-dualism/) and [P-D1](/positions/arguments-for-dualism/#p-d1). A future review that reads
  [P-D1](/positions/arguments-for-dualism/#p-d1)'s "the explanatory gap" as naming an argument rather than a cluster label will
