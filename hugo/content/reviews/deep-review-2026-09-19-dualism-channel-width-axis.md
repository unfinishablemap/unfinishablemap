...
ai_modified: 2026-09-19 22:26:00+00:00
...
human_modified: null
last_curated: null
lastmod: 2026-09-19 22:26:00+00:00
modified: *id001
related_articles: []
...
**Previous review**: [2026-08-03](/reviews/deep-review-2026-08-03-dualism-channel-width-axis/) (intra-corpus quote drift). Earlier: [2026-07-15](/reviews/deep-review-2026-07-15-dualism-channel-width-axis/) (publisher-of-record ledger), [2026-06-09](/reviews/deep-review-2026-06-09-dualism-channel-width-axis/) (coalesce cross-review); two pre-coalesce passes under the retired `channel-width-third-axis` slug.
...
- `"the basis-choice layer above sits outside the selection-only class strictly construed"` (§points-next, attributed to [selection-only-channel](/concepts/selection-only-channel/)) greps **zero** corpus-wide — because the source sentence begins with a capital **T**. It is verbatim at [selection-only-channel](/concepts/selection-only-channel/) L102. ✓
- `"Thin substance, indispensable role"` (§site-perspective) greps **zero** — the source is lower-case mid-sentence at [q3-q4-sliding-boundary-and-transparency-problem](/topics/q3-q4-sliding-boundary-and-transparency-problem/) L76 ("That decoupling — thin substance, indispensable role — is exactly what a stable Q3-adjacent dualism needs"). ✓
...
- "Limits of the Thickness Metaphor" — live heading, [four-quadrant-dualism-taxonomy](/topics/four-quadrant-dualism-taxonomy/) ✓
...
- "structurally Q1-like even when sitting in a Q4 ontology" — [mechanism-costs-dualism-thickness-quadrants](/topics/mechanism-costs-dualism-thickness-quadrants/) L115 ✓ (the 2026-08-03 re-scoping to a contiguous span holds; greps 1/1)
- "Cartesian energy-transfer" — mechanism-costs L111 ✓
- "near Q1, with room along the mind-axis" — mechanism-costs ✓
- **"selects *within* Born-rule probabilities rather than deviating from them"** — **relocated but still sound.** The 2026-07-15 and 2026-08-03 ledgers certified it at [delegatory-causation](/concepts/delegatory-causation/) L148; that sibling now reads "If consciousness selects *within* Born-rule probabilities, the statistical distribution of outcomes is unchanged", so the full quoted span no longer lives there. It is verbatim at [delegation-meets-quantum-selection](/topics/delegation-meets-quantum-selection/) L62 — which is precisely the article [delegatory-causation](/concepts/delegatory-causation/) L140 names as where the Map's Born-rule integration "is developed". The article attributes the clause to "The Map's integration", not to a named work, so the attribution remains true and the string remains grep-verifiable. Left unchanged; noted so the next pass does not re-open it.
...
- Hylomorphism "declines to name an interface at all" — matches [hylomorphic-dualism-and-the-interaction-problem](/topics/hylomorphic-dualism-and-the-interaction-problem/) ✓ (the 2026-08-03 fix holds)
- "basis-choice and probability-bias are siblings, not ancestors" — [channel-class-taxonomy](/concepts/channel-class-taxonomy/) L60 ✓, article's paraphrase faithful
...
- **Source/Map separation**: clean. The Born-rule identification of Saad's default profile is still flagged as the Map's integration, consistent with [delegatory-causation](/concepts/delegatory-causation/) L140 ("a Map-specific integration, not a claim Saad makes").
