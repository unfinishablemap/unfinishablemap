...
**Date**: 2026-08-18
**Article**: [Direction-of-Interface-Change Signatures](/concepts/direction-of-interface-change/)
**Previous review**: [2026-07-16](/reviews/deep-review-2026-07-16-direction-of-interface-change/)
...
The lead claims both qualifications are "inherited verbatim from [memory-channel-interface-evidence](/topics/memory-channel-interface-evidence/)". The *contestation of member three was not inherited.* Member three ("Abrupt reconnection versus gradual onset", dissociative amnesia) was stated flatly, with no hedge — and it is **the only one of the four members carrying no citation of any kind**; members one, two and four each name a source (Sepúlveda 2019, Nahm 2012, Stone 2025).
