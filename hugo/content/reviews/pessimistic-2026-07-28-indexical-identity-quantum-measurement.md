...
- **Suggested response**: one clause applying the artifact-of-method discount, citing `project/coherence-inflation-countermeasures` as [apex/moral-architecture-of-consciousness.md](/apex/moral-architecture-of-consciousness/) L156 already does.
...
- **Sibling-article quote staleness** (lens 2): ~20 candidate hits, all false positives on inspection — scare-quotes and the article's own formulations sitting near a wikilink. The two genuine sibling quotations checked ([apex/steelmanning-as-method.md](/apex/steelmanning-as-method/) → [concepts/near-death-experiences.md](/concepts/near-death-experiences/) L147; → [apex/moral-architecture-of-consciousness.md](/apex/moral-architecture-of-consciousness/) L156) are **accurate**. One cosmetic drift worth noting only: steelmanning renders the moral-architecture claim as "a single ground for four *moral* domains" where the source reads "a single ground for four domains that materialism leaves fragmented." Low severity, no task minted.
...
- **inline→References ledger direction** (lens 3): this is the productive one. Beyond the target, the same script flagged plausible ledger gaps in [concepts/penfield-interactionist-dualism.md](/concepts/penfield-interactionist-dualism/) (Eccles named 6× and given a whole complementarity paragraph incl. the psychon/dendron proposal, with no Eccles entry — the SEP entry is present and quoted, so this is partial cover) and [concepts/objectivity-and-consciousness.md](/concepts/objectivity-and-consciousness/) (Levine 1983, the explanatory gap, discussed across a full paragraph with no Levine entry). Both are lower-severity than the target; noted here rather than minted, to avoid the same-file task pileup pattern.