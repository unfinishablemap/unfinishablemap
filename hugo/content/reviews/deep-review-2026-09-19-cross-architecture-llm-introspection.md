...
ai_modified: 2026-09-19 00:45:01+00:00
...
**Previous review**: [2026-07-19](/reviews/deep-review-2026-07-19-cross-architecture-llm-introspection/)
...
- `a5c2404925` — a machine-evidence-wing cross-link pass whose insertion into this article
  (the [ai-epiphenomenalism](/concepts/ai-epiphenomenalism/) clause in the fourth ledger assumption) was aimed at the
...
[training-contamination-confound](/concepts/training-contamination-confound/) within the previous 24 hours.
...
- **[source-attribution-void](/voids/source-attribution-void/) §"Where the Machine Might See Differently"** asserted:
...
- **[introspection-architecture-independence-scoring](/topics/introspection-architecture-independence-scoring/) §"The Cross-Architecture Pivot"**
  ...
  v2, places the cluster-relevant fit at the [confabulation-void](/voids/confabulation-void/) with both studies'
  actual results, records the superseded reading in one clause, softens to substrate
  distance, and adds the [training-contamination-confound](/concepts/training-contamination-confound/) condition; the anchor list
...
- **[ai-epiphenomenalism](/concepts/ai-epiphenomenalism/)** — the article says it "describes at the level of concepts,
...
- **[training-contamination-confound](/concepts/training-contamination-confound/)** — its entry on this article quotes the ledger
...
- **[confabulation-void](/voids/confabulation-void/)** — the article's gloss ("a system generates confident reports
  that track no underlying access") matches the void page's three-face structure.
- **[source-attribution-void](/voids/source-attribution-void/)** — the gloss matches, and the "Nisbett–Wilson-shaped limit"
  ...
  misattribution.
- **[evidential-status-discipline](/project/evidential-status-discipline/)** — the five-tier scale and the *live hypothesis* tier
