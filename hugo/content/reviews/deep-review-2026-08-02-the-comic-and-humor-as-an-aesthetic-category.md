...
**Previous review**: [2026-07-09 cross-review](/reviews/cross-review-2026-07-09-comic-and-humor/) (create-time defect-tail pass)
...
- Linked "evaluative quale" at its first use to [evaluative-phenomenal-character](/concepts/evaluative-phenomenal-character/), the concept page that defines the term. The concept was already declared in frontmatter but unreachable from the body. Bare-slug form used (179 bare vs 28 path-qualified corpus-wide).
