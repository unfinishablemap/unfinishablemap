...
**Previous review**: [2026-06-24](/reviews/deep-review-2026-06-24-philosophy-of-language-under-dualism/)
...
Re-grepped `obsidian/`, `hugo/content/` and `archive/` for the defective LLM-inference string the refine-draft removed (*"LLMs demonstrate what the zombie argument predicts"*, *"linguistic competence is separable"*, *"approximate zombie"*). **No live-content instances remain** — surviving hits are confined to `reviews/`, [workflow/changelog.md](/workflow/changelog/) and [workflow/todo.md](/workflow/todo/), which are historical records and correctly left intact. No article links the retired `#llms-as-approximate-zombies` anchor.
...
- The constitutive question remains delegated to [consciousness-and-language-interface](/topics/consciousness-and-language-interface/); do not duplicate here.
