...
human_modified: null
last_curated: null
lastmod: 2026-06-14 16:34:41+00:00
modified: *id001
related_articles: []
...
**Previous review**: [2026-05-29](/reviews/deep-review-2026-05-29-metacognition/)
...
Note: [topics/introspection-architecture-independence-scoring.md](/topics/introspection-architecture-independence-scoring/) and
[topics/cross-species-behavioural-confidence-proxy-tests.md](/topics/cross-species-behavioural-confidence-proxy-tests/) cite a **different** Templer paper —
...
- **Birch, J. (2024)** — *The Edge of Sentience: Risk and Precaution in Humans, Other Animals, and
  ...
  [gaming-problem](/concepts/gaming-problem/) wikilink, not a bibliographic entry — consistent with how the same source is
...
[cross-species-behavioural-confidence-proxy-tests](/topics/cross-species-behavioural-confidence-proxy-tests/) on line 172 was added in a prior session and
