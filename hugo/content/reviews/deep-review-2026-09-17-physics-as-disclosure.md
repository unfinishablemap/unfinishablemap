...
**Previous review**: [2026-07-17](/reviews/deep-review-2026-07-17-physics-as-disclosure/)
**Context**: Selector top pick (score 50). Sixth pass, but NOT a converged no-op: the article was substantively rewritten by the 2026-09-02 refine-draft (commit ec849a18 — decoherence section de-escalated to "removes a defeater", duration argument downgraded, [P-M1](/positions/methodology-and-calibration/#p-m1)/[P-M2](/positions/methodology-and-calibration/#p-m2) links installed). The 2026-07-17 stability note ("do not re-verify citations") lapsed on that change, and per the register's review-discipline convention an empirical-support claim (Barrett) stays reviewable every pass.
...
- **Misapplied position citation ([P-M1](/positions/methodology-and-calibration/#p-m1))**. "A rival's fall would remove a competitor, not add support ([P-M1](/positions/methodology-and-calibration/#p-m1))" — [P-M1](/positions/methodology-and-calibration/#p-m1) concerns tenets removing defeaters; and eliminating an empirically testable rival does move credence, just not toward disclosure specifically. Rewritten: collapse theories' fall "would redistribute credence across every surviving Born-exact reading … rather than favour disclosure over them". The decoherence-section [P-M1](/positions/methodology-and-calibration/#p-m1) sentence was re-scoped to the separation [P-M1](/positions/methodology-and-calibration/#p-m1) actually asserts ("the absence of a principled barrier is not the presence of support") and notes every rival survives the same test.
...
### Cross-links Added
- [quantum-interface](/positions/quantum-interface/#mechanism-debt)
