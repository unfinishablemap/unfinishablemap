...
**Previous review**: [2026-07-25](/reviews/deep-review-2026-07-25-hylomorphic-dualism-and-the-interaction-problem/) (and [2026-07-18](/reviews/deep-review-2026-07-18-hylomorphic-dualism-and-the-interaction-problem/), [2026-07-06](/reviews/deep-review-2026-07-06-hylomorphic-dualism-and-the-interaction-problem/))
...
- **Stranded dependent of the tenets-page scoping fix (Relation to Site Perspective, L75).** The article said the Map's interface is, "on the corridor reading, empirically indistinguishable from chance" — flat. [tenets/tenets.md](/tenets/) L75/L81 (commit `cb47816154`, 2026-08-27) and L107 (commit `71a78a577b`, 2026-09-04) now scope that claim to *unconditioned aggregate* tests and say a deviation *conditioned* on intention, task or subject remains live, after [P-Q3](/positions/quantum-interface/#mechanism-debt) was re-rated `indirect` on 2026-08-24. The article calibrated against the old standard and so over-conceded relative to its own tenets page — the over-concession direction, which every "does it claim too much for the Map" lens ratifies as honesty. **Resolution**: the sentence now mirrors the tenets L107 form ("under any *unconditioned aggregate* test, though a deviation *conditioned* on intention, task or subject remains a live way of testing it") with a deep link to [P-Q3](/positions/quantum-interface/#p-q3). Read forward to the end of the section: no later sentence presupposed flat undetectability.
...
### Cross-links Added
- [P-Q3](/positions/quantum-interface/#mechanism-debt) (deep link into the register at the sentence that needed it).
