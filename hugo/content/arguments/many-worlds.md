...
This is the Map's central objection. When you make a measurement, many-worlds says you split into branches. In one branch you see spin-up; in another, spin-down. But you only experience one outcome. Which you?
...
The [No Many Worlds](/tenets/#no-many-worlds) tenet is not arbitrary. It follows from the Map's commitments:
...
The Map's framework requires that quantum measurement is real—that definite outcomes genuinely occur and that consciousness plays a role in their occurrence. Many-worlds denies all of this. The interpretations are incompatible.
