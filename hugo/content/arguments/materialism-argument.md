...
ai_modified: 2026-02-22 06:57:00+00:00
...
This is not a temporary gap. It is a structural feature of materialist explanation. Physical explanations describe structure, function, and dynamics. They answer "how" questions. The hard problem asks a "why" question of a different sort: why is discrimination accompanied by experience at all?
...
The standard materialist response to mental causation is causal closure: every physical event has a sufficient physical cause. But this assumes a picture of physics that quantum mechanics undermines.

Classical physics is deterministic and closed—given complete information, the future is fixed. Quantum mechanics is different. The Schrödinger equation governs deterministic evolution, but measurement produces collapse into one of several possible outcomes with probabilities given by the Born rule. What triggers collapse is the measurement problem, unsolved after nearly a century. Standard quantum mechanics does not specify when or why collapse occurs, nor what constitutes a "measurement."

Von Neumann noted in 1932 that the "Heisenberg cut" between quantum system and classical apparatus is arbitrary, and suggested it might fall at consciousness. Stapp developed a sophisticated version: consciousness affects brain states by biasing quantum probabilities through the quantum Zeno effect, selecting among superposed neural patterns. Whether Stapp's specific proposal is correct matters less than what it demonstrates: quantum mechanics does not close the door on mental causation. At the quantum level, physics describes probabilities and leaves room for something to determine which outcome occurs.
...
Meditative traditions offer first-person data relevant to this debate. Buddhist *vipassanā* practice involves sustained observation of phenomenal qualities—sensations arising and passing with specific experiential characteristics. If consciousness were merely functional processing, these observations would be impossible. The development of progressively subtler phenomenal discrimination through contemplative training suggests consciousness has a structure that responds to practice—not what we'd expect if "phenomenal" were merely a conceptual error.
...
Materialism fails to account for consciousness. The hard problem shows that physical explanations do not reach subjective experience. The zombie argument shows consciousness is not entailed by physical facts. The epiphenomenalism problem shows consciousness must be causally relevant. Quantum mechanics shows physics is not causally closed as materialism requires. And appeals to simplicity assume an understanding we do not have.

None of this proves dualism. But materialism—in all its forms—does not work. The Map's tenets commit to dualism as a working hypothesis: consciousness is not reducible to physical processes, it causally influences the brain at the quantum level, and the measurement problem provides the interface where mind and matter meet.