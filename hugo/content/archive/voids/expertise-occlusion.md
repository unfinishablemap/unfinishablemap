...
archive_reason: Coalesced into The Expertise Void, combining transformation and active
  occlusion
archived: true
archived_date: 2026-04-22 10:43:00+00:00
author: null
concepts:
- '[[phenomenology]]'
- '[[introspection]]'
...
description: Human+AI exploration of how mastery actively defends its own opacity—consciousness
  builds expert skill, then is structurally excluded from inspecting what it built.
draft: false
human_modified: null
last_curated: null
...
The [Map's taxonomy](/voids/three-kinds-of-void/) classifies voids as unexplored, unexplorable, or occluded. The expertise occlusion is primarily occluded with an unexplorable core.
...
- [voids](/voids/) — The voids framework
