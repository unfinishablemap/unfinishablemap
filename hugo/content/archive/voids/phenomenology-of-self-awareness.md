...
The answer turns on the **process/content distinction** from the [introspective-opacity](/voids/self-opacity/) literature. Process reports—claims about *why* we decided—are demonstrably confabulated. Content reports—claims about *what* we currently experience—have different epistemic status. The claims here are content claims: "self-reference produces a felt inversion" reports phenomenal character, not causal mechanism.
