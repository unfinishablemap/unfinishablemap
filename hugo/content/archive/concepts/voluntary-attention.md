...
Voluntary attention exemplifies [bidirectional interaction](/tenets/#bidirectional-interaction). Consciousness selects where attention goes; attention determines what consciousness experiences. The bidirectional frontoparietal coherence during willed attention may be the neural signature of this two-way causal flow.

Jeffrey Schwartz's [OCD research](/concepts/mental-effort/) provides empirical grounding: patients who learn to voluntarily redirect attention produce measurable brain changes. Whatever the mechanism, voluntary attention has physical consequences.

### Minimal Quantum Interaction

If the Stapp mechanism is correct, voluntary attention is *how* consciousness operates at quantum indeterminacies. Each act of attention constitutes an "observation" that biases which neural patterns actualize. The [minimal quantum interaction](/tenets/#minimal-quantum-interaction) tenet is implemented through the voluntary attention interface—consciousness acts where physics leaves outcomes undetermined.

### No Many Worlds

The selection model presupposes real collapse. Voluntary attention selects among possibilities, actualizing one outcome rather than branching into all. If [many-worlds](/tenets/#no-many-worlds) were true, there would be nothing to select—every possibility would occur in some branch.

The strongest MWI response appeals to decision theory: rational agents should act *as if* selection occurs because their subjective weights track Born probabilities. But this dissolves rather than explains the phenomenology of willing. When I decide where to attend, I experience selecting one option—not a probability distribution over branches. Decision theory can't account for the [haecceity](/concepts/haecceity/) of choice: that *this* choice happens, not merely that some copy of me makes it.
...
The [Occam's Razor Has Limits](/tenets/#occams-limits) tenet responds: simplicity is unreliable when knowledge is incomplete. The neural signatures of willed attention—frontal theta, bidirectional coherence, additional frontal recruitment—mark *something* that distinguishes willed from instructed attention. If that something were merely "more neural processing," we'd need to explain why this particular kind of processing feels like willing rather than like anything else (or nothing at all). The hard problem remains. The apparently simpler physicalist account may be simpler only because it ignores what needs explaining.
...
- [attention-motor-quantum-interface](/attention-motor-quantum-interface/) — How PMTA unifies attention and motor selection
