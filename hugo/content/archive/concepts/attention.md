...
Working memory and attention are deeply interlinked, strengthening the [interface hypothesis](/concepts/attention-as-interface/). The Map's [coupling law research](/concepts/psychophysical-laws/) notes a ~10 bits/second limit on conscious throughput—matching working memory capacity remarkably well.
...
- [attention-created-voids](/voids/attention-and-consciousness/) — How attention creates structural voids as a byproduct of selection
