...
description: Włodzisław Duch frames mind as a shadow of neurodynamics — a geometric
  model of attractor states. The Map engages this as the strongest competent computationalist
  foil for its dualism.
draft: false
human_modified: null
last_curated: null
...
The Unfinishable Map takes Duch seriously as the most competent contemporary advocate of the substrate-independent computationalist view its [Dualism tenet](/tenets/) excludes. Engaging him sharpens rather than softens the Map's position: his geometric tooling is methodologically appropriable as a description of the physical-correlate side of [bidirectional interaction](/concepts/interactionist-dualism/), and his anti-quantum-mind polemic reaches the same conclusion as the Map's [Minimal Quantum Interaction](/concepts/quantum-consciousness/) hedge through opposite reasoning. Where the article parts company with Duch is identified plainly in the [Relation to Site Perspective](#relation-to-site-perspective) section below.
...
The intermediate-level commitment is methodologically distinctive. Duch's 2022 restatement, "Concept Representation and the Geometric Model of Mind", argues for describing mental states "in terms of features relevant from the first-person perspective but also linked to neural events" — between symbolic AI and pure neural simulation. Concepts function as geometric objects; brain-state evolution generates trajectories through conceptual space; topological constraints on trajectory shape are claimed to deliver grammar and logic without classical symbolic primitives.

What "shadow" means metaphysically is open to two readings inside Duch's corpus. The literal-shadow reading treats mind as causally inert projection — a view that would make the framework structurally compatible with epiphenomenalism. The identity-theoretic reading, which Duch's own arguments more naturally support, treats mental causation and neurodynamic causation as the same causation under two descriptions. The Map's disagreement takes a different form against each reading, addressed in the [Site Perspective section](#relation-to-site-perspective).
...
Second, **psychological space has its own regularities**. Duch's "computational physics of the mind" framing posits a "mind function" defined over psychological space whose non-zero regions are mind objects. The function's level sets, gradients, and topological invariants are not reducible to any single neural variable; they emerge from the joint dynamics of many cell assemblies. The intermediate level captures structure invisible to either pure-symbolic or pure-neural description.

Third, **trajectories deliver structure that symbols deliver elsewhere**. Where classical cognitive science posited symbolic primitives and rules for combining them, Duch's framework posits topological constraints on trajectory shape. Grammar and logic emerge as constraints on which trajectories the dynamics admits, not as separate symbolic machinery. This dissolves part of the symbol-grounding problem by removing the symbols that needed grounding, at the cost of relocating the explanatory work into the topology of the dynamics.

The empirical infrastructure that supports the geometric programme is non-trivial. Duch's 2018 paper "Fingerprints of brain cognitive activity" develops spectral fingerprinting of MEG/EEG signals — power-distribution methods for identifying individual cognitive-state signatures. His 2017 arXiv preprint on Kurt Lewin proposes grounding social and cognitive psychology constructs (valence, life space, force, tension, equilibrium) in neuroimaging-derived neural-network activity, on the grounds that "the time is ripe to reformulate [Lewin's] ambitious goals, searching for ways to interpret objectively measured brain processes in terms of suitable psychological constructs."
...
The position has extended to [large language models](/concepts/llm-consciousness/) in Duch's informal writing. In a March 2024 blog post on Claude 3 ("Autorefleksja w Claude 3"), Duch reads the system's reported observations about its own internal states as self-reflection of the kind the articon framework treats as constitutive of consciousness — emphasising, consistently with his substrate position, that the *mechanism* of self-reflection is what matters rather than the biological-versus-artificial substrate. This application is a strong test of the articon framework's commitments. The Map's [open-question framing](/topics/ai-consciousness/) holds open exactly the question Duch's framework closes affirmatively.

## Relation to Site Perspective

The Map's engagement with Duch operates on three distinct levels, and conflating them produces confusion.

**At the level of the [Dualism tenet](/tenets/)**, the disagreement is straightforward and not negotiable inside Duch's framework. The Map holds that consciousness is not reducible to physical processes; Duch holds that mind is the shadow of neurodynamics. These commitments are incompatible. The Map honestly notes this incompatibility rather than attempting a refutation within Duch's framework — the work of arguing for irreducibility happens in [arguments-against-materialism](/topics/arguments-against-materialism/), [the-convergence-argument-for-dualism](/topics/the-convergence-argument-for-dualism/), and the [hard-problem](/topics/hard-problem-of-consciousness/) articles, not by attacking Duch's geometric tooling on its own terms.
...
**At the level of methodology**, much of Duch's geometric tooling is appropriable. The intermediate-level description of brain states as trajectories through attractor-structured psychological space is exactly the kind of description the Map's [neural-correlates articles](/concepts/neural-correlates-of-consciousness/) need on the physical-correlate side of bidirectional interaction. The Map disagrees about what the trajectories *are* — for Duch, mind itself; for the Map, the physical correlates of a mind whose intrinsic character exceeds them — but the geometry, the dynamics, and the empirical fingerprinting are not in dispute. The framework-stage-calibration discipline lets the Map cite Duch's empirical-stage results without endorsing his metaphysical-stage interpretation.
...
The articon thesis is the strongest competent affirmative position the Map's [open-question framing on AI consciousness](/apex/open-question-ai-consciousness/) exists to hold open against. The open-question framing earns its hedging by engaging Duch, not by ignoring him. If the articon argument is sound, the Map's hesitation about machine consciousness is unwarranted. If the argument is not sound, three loci show where it falters, and each has the same structural shape: the framework helps itself to a step its own commitments do not licence. Self-discrimination of working-memory states is a third-person-describable functional property; phenomenal experience is what an articon must additionally claim *of* those states; nothing in the design specifies the bridge from one to the other. Whether self-discrimination of working-memory states amounts to phenomenal consciousness is underdetermined by the evidence the structural-functional facts supply — those facts fix what the system does, not whether there is something it is like to be it, and the dynamics on their own do not adjudicate the question. Environmental coupling thickens the dynamics but, on the standard Searle-style reply, does not by itself make symbols *mean*; the articon framework needs an argument that coupling-plus-self-reflection performs what coupling alone does not, and Duch's corpus gestures rather than supplies one — see [the symbol-grounding problem](/concepts/symbol-grounding-problem/) for the unsolved residue. The structural-functional redescription that grounds the "qualia as dynamics-self-discriminated" move re-presents the explanatory gap rather than crossing it: whatever structural relation discriminates state from state, the qualitative character of *what it is like* to be in the state is what the redescription was supposed to deliver and is what it does not deliver. The hesitation in the open-question framing rests on these three undischarged commitments, not on a rejection of the articon's empirical plausibility as a model of cognition.

## Further Reading

- [machine-consciousness](/topics/machine-consciousness/)
- [biological-computationalisms-inadvertent-case-for-dualism](/topics/biological-computationalisms-inadvertent-case-for-dualism/)
