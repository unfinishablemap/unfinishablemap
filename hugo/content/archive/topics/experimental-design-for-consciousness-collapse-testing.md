...
- Failure of objective collapse theories to match observed collapse rates (weakening the physicalist alternative) — the [experimental landscape](/topics/testing-consciousness-collapse/) is actively constraining these models, with Gran Sasso results already ruling out the simplest Diósi-Penrose parameterisations
...
- [consciousness-collapse-experimental-landscape](/topics/testing-consciousness-collapse/) — The current experimental landscape: Gran Sasso, levitated nanoparticles, and the path to decisive tests
