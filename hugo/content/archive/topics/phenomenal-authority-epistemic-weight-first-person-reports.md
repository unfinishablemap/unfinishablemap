...
description: First-person reports carry layered epistemic authority—from near-incorrigible
  at existence level to fallible at structural detail—grounding dualism's evidential
  base through acquaintance.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-03-29 19:36:00+00:00
modified: *id001
...
Dennett's [heterophenomenology](/concepts/heterophenomenology/) and Schwitzgebel's introspective scepticism both deflate phenomenal authority, but the deflation faces a structural problem: it cannot be applied consistently.

The heterophenomenologist who treats first-person reports as mere texts—data about dispositions to make claims rather than windows into phenomenal reality—must rely on their own phenomenal access to evaluate those texts. Dennett's theoretical conclusions depend on how the evidence *seems to him*—on his introspective judgement that the theoretical landscape supports heterophenomenology over its rivals. If phenomenal access is unreliable as a window into reality, it is equally unreliable as a window into the evidential landscape. The position is [self-stultifying](/concepts/self-stultification/): it uses the very capacity it downgrades to justify the downgrading.
