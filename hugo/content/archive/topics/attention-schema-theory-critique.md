...
Attention feels effortful. Sustaining focus against distraction involves a distinctive sense of work—a phenomenal cost that fatigue compounds. This is the [phenomenology of effort](/concepts/mental-effort/), and it poses a specific problem for AST.
...
The Map's alternative: effort feels real because it *is* real work. On the [attention-as-interface](/concepts/attention-as-interface/) hypothesis, consciousness engages with matter through attention, and sustained attention involves genuine causal engagement—possibly via [quantum Zeno effects](/concepts/quantum-consciousness/) holding desired neural patterns stable. The phenomenology of effort corresponds to the actual engagement. AST must dismiss this correspondence as coincidence; the Map explains it.
...
[Witness consciousness](/concepts/witness-consciousness/)—a mode of awareness that observes mental contents without identifying with them—is reported across traditions. Practitioners describe this witness as distinct from the contents it observes, including attention itself. You can watch yourself attending.
...
AST has direct implications for [AI consciousness](/topics/ai-consciousness/). If consciousness is attention modeling, and AI systems can model their own attention (as Graziano's ASTOUND project demonstrates), then sufficiently sophisticated AI should be conscious.
...
[Haecceity](/concepts/haecceity/)—being *this* particular thing—poses a problem AST cannot address.
...
**Attention and consciousness are intimately connected.** AST is right that understanding attention is crucial for understanding consciousness. The Map agrees—attention is the [interface](/concepts/attention-as-interface/) where consciousness engages with matter.
...
AST directly conflicts with the Map's [tenets](/tenets/):

**[Dualism](/tenets/#dualism)**: AST is explicitly anti-dualist—consciousness reduces to attention modeling. The Map holds consciousness is irreducible. The regress problem supports the Map's position: seeming presupposes a subject, and subjects are not models.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: AST has no place for quantum mechanisms—attention schemas are entirely physical. The Map proposes attention as the [interface](/concepts/attention-as-interface/) where consciousness influences quantum outcomes. Both can be true in limited senses (attention schemas exist; consciousness uses them), but AST's eliminativism is incompatible with the Map's interactionism.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: AST is compatible with epiphenomenalism about consciousness (even if attention schemas are causally efficacious). The Map rejects this. The phenomenology of effort—feeling that attention costs something—supports bidirectional interaction. If effort were mere representation, evolution would have no reason to produce the misleading sense that we're working.
...
- [attention-schema-theory](/concepts/attention-schema-theory/) — Concept article introducing Graziano's theory
...
- [structure-of-attention](/topics/structure-of-attention/) — The willed-instructed distinction and its implications
- [mental-effort](/concepts/mental-effort/) — The phenomenology AST must explain away
- [witness-consciousness](/concepts/witness-consciousness/) — Contemplative evidence challenging AST
