...
These results reinforce the philosophical point: simple identification of consciousness with any single mechanism fails. The phenomenon resists reduction. This aligns with the Map's [Occam's Razor Has Limits](/tenets/#occams-limits) tenet: simplicity is not a reliable guide when our conceptual tools may be inadequate.

## Attention as Interface

If attention and consciousness are distinct, how do they relate?

The Unfinishable Map's [attention-as-interface](/concepts/attention-as-interface/) hypothesis proposes: attention is how consciousness *engages* with matter, not what consciousness *is*. Consciousness is the subject; attention is the mechanism through which that subject influences neural systems.
...
[Illusionism](/concepts/illusionism/) argues there's nothing it's like to have experiences—the "seeming" of phenomenal consciousness is itself just more functional processing. On Dennett's [heterophenomenological](/concepts/heterophenomenology/) approach, we should treat consciousness reports as data without assuming they accurately describe inner states.
...
One phenomenon particularly resists deflationary analysis: the [felt effort of attention](/concepts/mental-effort/).
...
- [attention-disorders-and-consciousness](/topics/attention-and-the-consciousness-interface/) — Void: what attention disorders reveal about consciousness
