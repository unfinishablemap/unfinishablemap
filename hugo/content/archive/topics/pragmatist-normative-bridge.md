...
archived: true
archived_date: 2026-04-16 02:33:00+00:00
author: null
concepts:
- '[[pragmatism]]'
...
description: Why pragmatism's reflexive argument and phenomenal normativity jointly
  show consciousness is required for evaluation and constitutive of evaluative authority.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-04-15 12:21:00+00:00
lastmod: 2026-04-15 12:21:00+00:00
modified: *id001
...
The Unfinishable Map has developed two independent arguments for the irreducibility of consciousness. [Pragmatism's reflexive argument](/topics/pragmatisms-path-to-dualism/) shows that evaluation presupposes a conscious evaluator — eliminate consciousness from your ontology and the capacity to judge which theory "works" disappears with it. [The normative force analysis](/topics/consciousness-and-normative-force/) shows that evaluation has irreducible phenomenal character — moral demands burn, epistemic demands grip, aesthetic demands draw, and no physical description captures the binding quality that makes them demands rather than descriptions. These arguments are complementary halves of a single case. Pragmatism establishes *that* consciousness is required for evaluation. Phenomenal normativity reveals *how* consciousness evaluates: through demand-character built into the structure of experience itself.

## The That and the How

Pragmatism's reflexive argument runs as follows. Pragmatism evaluates beliefs by their practical consequences — what difference does holding this belief make? But evaluation is a conscious activity. Assessing whether a belief resolves difficulties, opens productive inquiries, or coheres with experience requires [phenomenal experience](/concepts/cognitive-phenomenology/): the felt sense that things fit together, the recognition that one framework illuminates while another obscures. If consciousness reduces to physical processes, evaluation reduces to physical processes, and "what works" collapses into "what brains happen to produce." The pragmatic criterion loses its normative force.
...
This is distinct from the general observation that parsimony has limits (the Map's fifth tenet). The bridge provides a specific mechanism for the failure: parsimony is an evaluative norm, evaluative norms depend on phenomenal demand-character, and phenomenal demand-character is irreducible. The argument does not merely say parsimony is unreliable — it explains *why* parsimony cannot serve as grounds for eliminating consciousness.
...
**[Dualism](/tenets/#dualism)**: The bridge strengthens the case for irreducibility by combining two independent lines of argument into a single structure. Pragmatism shows consciousness is necessary for evaluation; phenomenal normativity shows it evaluates through properties that resist physical reduction. Neither argument alone forecloses the functionalist response; together they do.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: If consciousness evaluates through demand-character, and evaluation drives theory-choice, experiment design, and practical action, then demand-character is causally efficacious. The bridge connects the causal role of consciousness directly to its phenomenal properties — consciousness does not merely accompany the evaluative process but performs it through felt normative force.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The bridge provides a specific mechanism for why parsimony cannot eliminate consciousness. Parsimony is an evaluative norm with demand-character; demand-character requires irreducible consciousness; therefore parsimony presupposes what it would need to eliminate. This is not a limitation of parsimony in general but a structural impossibility in this specific application.
...
- [pragmatisms-path-to-dualism](/topics/pragmatisms-path-to-dualism/) — Pragmatism's reflexive argument for dualism in full
...
- [consciousness-defeats-explanation](/topics/consciousness-defeats-explanation/) — Why science presupposes the phenomenal capacity it cannot explain
