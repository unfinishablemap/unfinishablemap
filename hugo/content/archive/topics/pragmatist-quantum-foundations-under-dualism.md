...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: Stapp's Zeno mechanism is the nearest pragmatist relative — question-choice and timing rather than the tenet's outcome-selection. QBism's normative Born rule, read through the interface hypothesis, is compatible. Healey and Brukner-Zeilinger are neutral.
