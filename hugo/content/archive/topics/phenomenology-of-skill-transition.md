...
lastmod: 2026-02-19 04:19:00+00:00
modified: *id001
...
The Map's model of consciousness as an [interface](/concepts/attention-as-interface/) between the non-physical and the physical makes specific predictions about what transition should feel like. If consciousness normally operates by biasing neural selection among available patterns, then transition is a period when the available patterns are in flux—old attractors weakening, new ones not yet stable.
...
Eventually, transition resolves. The new pattern consolidates, automaticity returns, and consciousness withdraws again from direct motor control. But the phenomenology of *arriving* at the new consolidation differs from the original achievement of automaticity.

There is, first, a period of fragile automaticity—the new pattern executes smoothly under favourable conditions but breaks down under stress, reverting to the old pattern. This is the period where the choking phenomenon is most likely: conscious attention, drawn back to the skill by anxiety, finds the new pattern not yet robust enough to withstand scrutiny. Practitioners describe this as a stage where they must "trust the new pattern"—a conscious act of relinquishing control before the new automaticity has fully proven itself.

When consolidation succeeds, there is a characteristic moment of recognition: the new pattern feels natural. The old pattern, which dominated for so long, now feels foreign. This reversal in familiarity is phenomenologically striking. It suggests that what feels "natural" in skilled performance is not determined by duration of practice alone but by the current configuration of the procedural system. The sense of naturalness is a phenomenal marker of successful consolidation, not a property of the skill itself.
...
The [minimal interaction](/tenets/#minimal-quantum-interaction) tenet illuminates the phenomenology of the transition valley. The performance degradation during restructuring can be understood as a period when the conscious interface must operate at a finer grain than usual, biasing outcomes at points that were previously handled automatically. This increased demand on the interface explains the heightened effort and the characteristic fatigue of restructuring practice.
