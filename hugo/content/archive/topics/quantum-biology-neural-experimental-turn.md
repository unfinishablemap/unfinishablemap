...
The gap between observed effects and the theoretical frameworks built on them defines the field's research programme for the coming years. NV-diamond quantum sensors may bridge several of these gaps by enabling direct measurement of quantum effects in living neural tissue. For how these evidence lines—biological precedent, pharmacological correlation, direct measurement, and computational modelling—converge into a cumulative case, see [the convergence analysis](/topics/quantum-biology-and-neural-consciousness/).
