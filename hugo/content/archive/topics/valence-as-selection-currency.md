...
**The valence-attention boundary.** If valence modulates attention (the conservative strategy), is it truly a selection currency or merely an input to the real currency (attention)? The distinction matters: if valence acts only through attention, the selection law is fundamentally attentional, and valence is upstream infrastructure rather than the operative criterion. The currency metaphor would be misleading—valence would be more like the preferences that guide spending than the money used to pay. Whether this distinction makes a substantive difference to the Map's claims about value's causal efficacy is an [open question](/topics/valence-and-conscious-selection/).
...
- [value-blind-vs-value-sensitive-selection](/topics/valence-and-conscious-selection/) — The fork this article develops
