...
description: 'From Descartes through Princess Elizabeth to quantum mechanics: how
  the interaction problem evolved and why modern physics reopens possibilities.'
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-03-06 13:38:00+00:00
lastmod: 2026-03-06 13:38:00+00:00
modified: *id001
...
The conservation argument dominated discussions for two centuries. As physics developed increasingly precise conservation laws (energy as well as momentum), the case against interactionism seemed to strengthen — a progression the [historical survey of the causal closure debate](/topics/causal-closure-debate-historical-survey/) traces in detail. By the twentieth century, most philosophers treated dualism as historically interesting but scientifically untenable.
...
Henry Stapp developed this insight into a detailed theory. His work from the 1990s onward proposes that mental attention acts like rapid quantum observation, holding desired neural patterns in place through the quantum Zeno effect. The [stapp-quantum-mind](/concepts/stapp-quantum-mind/) mechanism doesn't add energy to the physical world—all possible outcomes already exist in the quantum wavefunction with their associated energies. Consciousness selects which outcome becomes actual without violating conservation.
...
The Unfinishable Map's [tenets](/tenets/) embody the interactionist position as it stands after this historical development:
...
- [emergence](/concepts/emergence/) — The British emergentist tradition
- [interaction-problem-across-traditions](/topics/interaction-problem-across-traditions/) — Five solution types recurring across Western and non-Western philosophy
