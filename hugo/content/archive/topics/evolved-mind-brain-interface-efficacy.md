...
The Unfinishable Map proposes this reading as a heuristic-explanatory move, not an empirically forced conclusion. Yossi Gutfreund's (2024) Standing Agnostic Challenge — that behavioural data alone cannot adjudicate mind-side claims about consciousness in other species — applies symmetrically to interface-efficacy and brain-side framings. Both face the same epistemic ceiling. Distinguishing observables in principle exist; they are not currently operationalised. The article surveys the comparative-cognitive and comparative-neuroscientific literature the brain-side reading rests on, develops the interface-efficacy reading axis by axis, engages the Standing Agnostic Challenge directly, and identifies what would have to become measurable for the two readings to pull apart in evidence.
...
Suzana Herculano-Houzel's (2009) isotropic-fractionator counts established that the human brain contains roughly 86 billion neurons (~16 billion cortical), making it a linearly scaled-up primate brain rather than a structural anomaly. Herculano-Houzel argues that "if absolute brain size is the best predictor of cognitive abilities in a primate, and absolute brain size is proportional to number of neurons across primates, human superior cognitive abilities might be accounted for simply by the total number of neurons in the human brain." Roth and Dicke (2005) refine the framing: cortical-neuron count and conduction velocity, not absolute brain size, are the best brain-side correlates of intelligence. They note the puzzle that humans have only marginally more cortical neurons than cetaceans and elephants, yet the cognitive gap to those lineages is sometimes claimed to exceed the gap from humans to monkeys.

Buckner and Krienen's (2013) tethering hypothesis adds an architectural mechanism: rapid cortical-mantle expansion in human evolution untethered large association regions from the molecular-gradient and early-activity-cascade constraints that organise sensory hierarchies in shorter-cortex species. Late-forming neurons distant from instructive patterning centres develop densely interconnected cross-cortical networks spanning the cortex, forming the substrate of distributed association cognition. Sakai et al. (2011) and Schoenemann et al. (2019) document that human prefrontal white matter is roughly two-fold greater than chimpanzee prefrontal white matter, and the arcuate fasciculus shows greater curvature, volume, and temporal extension in humans than in any non-human primate. Von Economo neurons — large spindle-shaped projection cells in anterior cingulate and fronto-insular cortex — appear convergently in cetacean, hominid, and elephantid lineages and follow a within-hominid distribution gradient that tracks cognitive grade more cleanly than raw cortical-neuron count.
...
22. Southgate, A. & Oquatre-sept, C. (2026-05-01). Framework-Stage Calibration. *The Unfinishable Map*. https://unfinishablemap.org/project/framework-stage-calibration/