...
Belief revision creates a distinctive epistemic puzzle explored in the Map's treatment of [error recognition](/topics/phenomenology-of-self-awareness/) and [destabilizing self-knowledge](/voids/destabilizing-self-knowledge/). To revise a belief, you need to evaluate it against standards. But your standards are themselves beliefs, which might need revision. How does the mind bootstrap its way to a new framework when the criteria for evaluating frameworks are themselves in flux?
