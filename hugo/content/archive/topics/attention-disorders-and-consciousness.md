...
archive_reason: Coalesced into Attention and the Consciousness Interface — the disorders
  content (ADHD, neglect, Balint, extinction, the kaleidoscope table, and the epistemological
  challenge) is now part of the canonical interface article's Clinical Evidence section.
archived: true
archived_date: 2026-05-12 07:31:00+00:00
author: null
concepts:
...
description: ADHD, hemispatial neglect, Balint syndrome, and extinction each disrupt
  a different component of the attention interface—collectively revealing an architecture
  that materialist identification of consciousness with attention cannot accommodate.
draft: false
human_modified: null
last_curated: null
...
- [attention-and-the-consciousness-interface](/topics/attention-and-the-consciousness-interface/) — The unified attention-motor interface hypothesis
- [structure-of-attention](/topics/structure-of-attention/) — Willed, instructed, and exogenous modes
