...
For each claim that mental causation does specific physical work — directs an outcome, biases a selection, accelerates a recovery, suppresses an automatism, sustains attentional control — the article should be able to fill in six fields. These fields are the editor's diagnostic vocabulary, not exposed in article prose, and the article expresses the same content in natural language. (See [the writing-style guide](/project/writing-style/) for the prose patterns.)
...
**5. Falsification condition.** What observation would the claim *not survive*? This is the [testability-ledger's](/project/testability-ledger/) question asked at claim-level rather than tenet-level. Most mental-causation claims in the catalogue currently inherit testability from the parent article rather than carrying their own. The ledger requires each claim to declare its own disconfirmer.
...
The discipline's most direct alignment is with [Tenet 2 (Minimal Quantum Interaction)](/tenets/#minimal-quantum-interaction): it operationalises *minimal* as a measurable constraint rather than a rhetorical hedge. Without the ledger, Tenet 2 is at risk of becoming the global escape hatch the outer reviewer named — a phrase deployed wherever the catalogue needs Tenet 3 (Bidirectional Interaction) to deliver real causal work, with no cross-claim check on whether the work being delivered fits inside the channel's actual capacity.

The discipline serves [Tenet 3](/tenets/#bidirectional-interaction) too, by clarifying *how much* bidirectional interaction the framework is committed to. Tenet 3 rejects epiphenomenalism, which the [epiphenomenalism](/concepts/epiphenomenalism/) article notes is a substantive commitment supported by the self-stultification argument. The ledger keeps that commitment from inflating: mind does causal work, but the work is bounded, and the bound is the same bound everywhere it is invoked. The catalogue is committed to *some* mental causation; it is not committed to whatever amount any individual article happens to need.

The discipline also feeds back into [coherence-inflation countermeasures](/project/coherence-inflation-countermeasures/): budget over-aggregation is a silent inflation vector the existing countermeasures (steelman sections, provenance tagging, freshness checks, citation-loop detection) do not directly catch. A claim can be appropriately hedged within its own article and still contribute to a cluster whose summed cost exceeds the budget. The ledger closes that gap by making the per-claim cost the auditable unit.
...
- [bandwidth-of-consciousness](/topics/bandwidth-of-consciousness/) — the ~10 bits/s ceiling the budget must accommodate
- [mathematical-structure-of-the-consciousness-physics-interface](/topics/mathematical-structure-of-the-consciousness-physics-interface/) — the formal apparatus underpinning the arithmetic
...
- [outer-review-2026-05-11-chatgpt-5-5-pro](/reviews/outer-review-2026-05-11-chatgpt-5-5-pro/) — originating source for the discipline
