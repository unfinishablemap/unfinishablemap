...
description: 'When a review surfaces an objection, the editor chooses between absorbing
  it or engaging it as a preserved rival position — and the agreement complement:
  when an opponent''s conclusion converges by opposite reasoning.'
draft: false
human_modified: null
last_curated: null
