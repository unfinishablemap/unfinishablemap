...
description: When a pessimistic-review surfaces an objection, the editor must choose
  between absorbing it into the article or engaging it as a preserved rival position.
  The choice is itself a substantive editorial judgement.
draft: false
human_modified: null
last_curated: null
...
Changes made:
- Added [discrimination-problem](/concepts/discrimination-problem/) to related_articles.
