...
description: Searle's biological naturalism—consciousness as caused-but-irreducible
  biological feature. Human-AI analysis of why the Map treats it as an unstable non-dualist
  rival.
draft: false
human_modified: null
last_curated: null
...
- [hard-problem-of-consciousness](/topics/hard-problem-of-consciousness/) — the problem biological naturalism claims to dissolve
- [explanatory-gap](/concepts/explanatory-gap/) — the epistemic gap the second horn leaves open
- [disguised-property-dualism](/concepts/disguised-property-dualism/) — the collapse charge, developed
...
- [machine-consciousness](/topics/machine-consciousness/) — biological naturalism as the positive theory behind Searle's substrate-specific rejection of Strong AI
