...
human_modified: null
last_curated: null
last_deep_review: 2026-03-18 14:40:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
The bandwidth problem in mental causation asks: even if consciousness *can* influence physical outcomes, can it carry enough information to produce the specific effects we observe? This challenge is distinct from Jaegwon Kim's [causal exclusion](/concepts/causal-closure/) argument, which questions whether mental causation occurs at all. The bandwidth problem grants that consciousness might influence the brain—then asks whether the mind-body channel has sufficient capacity and specificity to do useful causal work.

For The Unfinishable Map's framework, which locates mental causation at [quantum indeterminacies](/concepts/consciousness-selecting-neural-patterns/), the bandwidth problem becomes concrete: how does coarse-grained conscious intention translate into the selection of specific neural configurations from an astronomically large space of possibilities?
...
The grain dimension is the most philosophically distinctive. Kim's exclusion argument and the [causal closure](/concepts/causal-closure/) principle concern whether mental causes are *real*. The grain problem concerns whether they are *specific enough*.
...
This is the [bandwidth constraint interpreted architecturally](/topics/bandwidth-of-consciousness/). The brain's unconscious systems—running at roughly 10⁹ bits per second (Norretranders, 1998)—perform the computationally intensive work of translating goals into motor plans, generating candidate action sequences, and computing the fine-grained specifications execution requires. Consciousness selects among the prepared candidates.

On this architecture, the bandwidth problem transforms. The question is no longer "how does a 10-bit/second channel specify a million-bit neural configuration?" but "how does a 10-bit/second channel choose among a small number of prepared alternatives?" And that question has a straightforward answer: a channel carrying 10 bits per second can make roughly 3–4 selections per second among small sets of alternatives. This matches the [phenomenology of deliberate choice](/concepts/consciousness-selecting-neural-patterns/#the-bandwidth-constraint).
...
The bandwidth problem also differs from the [binding problem](/concepts/binding-problem/) and the [combination problem](/concepts/combination-problem/), though all three concern how simple elements produce complex wholes. The binding problem asks how distributed neural processes produce unified experience. The combination problem asks how micro-experiences combine into macro-experience. The bandwidth problem asks how simple intentions produce complex behaviour. Each targets a different direction of the mind-body relation.
