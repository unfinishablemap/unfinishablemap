...
Philosophers distinguish two related but distinct challenges (Revonsuo 2006):

**BP1: The Segregation Problem** — How does the brain correctly assign features to objects? When viewing a blue square and yellow circle simultaneously, what prevents "illusory conjunctions" like perceiving a blue circle? This is a computational problem that neuroscience might solve.

**BP2: The Combination Problem** — How do correctly segregated features combine into *phenomenal* unity? Even if the brain tags features correctly, why is there *one* experience rather than many parallel processes? This touches the [hard problem](/topics/hard-problem-of-consciousness/) directly.
...
The dominant neuroscientific proposal holds that features belonging to the same object are bound through synchronized neural oscillations, particularly gamma-band activity (30-100 Hz). Neurons in different cortical regions firing synchronously are "tagged" as representing the same object.

**Evidence supporting synchrony:**
- Gamma oscillations correlate with conscious perception
- Attention increases neural synchrony across brain regions
...
Anne Treisman's influential theory proposes that attention acts as the "glue" binding features. Basic features are processed in parallel across separate feature maps; attention directed to a location integrates all features at that location.
...
**Implications for consciousness:** Attention is necessary but perhaps not sufficient for binding. This connects to the Map's interest in [mental-effort](/concepts/mental-effort/)—if attention is effortful and effortful attention is how consciousness interfaces with matter, then attention's role in binding is no coincidence.
...
[IIT](/concepts/integrated-information-theory/) claims consciousness *is* integration. A system is conscious to the degree it integrates information (measured as Φ). The phenomenal unity of experience just is information integration; the binding problem dissolves into measuring what generates high Φ.
...
[Split-brain patients](/topics/split-brain-consciousness/)—those whose corpus callosum has been severed—offer a natural experiment on binding. When the 250 million fibers connecting hemispheres are cut, what happens to unity?
...
This convergence supports the Map's framework: consciousness isn't an add-on to neural computation but participates constitutively in both perception and memory through the binding that makes experience unified.
...
The dissociation supports the Map's position that phenomenal unity isn't *produced by* binding operations but *added to them* by consciousness:
...
Classical binding mechanisms face a structural problem: they combine separate things, but combination doesn't produce unity. Synchronized firing is still firing in separate neurons. Workspace broadcasting is still information in distinct processors.
...
The Map maintains that current evidence favors the quantum position while acknowledging that the debate remains live. Scientific humility requires specifying what would count against one's view.
...
- [varieties-of-unity](/concepts/varieties-of-unity/) — Distinguishing synchronic, diachronic, and subject unity
