...
Brian Loar argued that phenomenal concepts are *direct recognitional concepts*. When having an experience, we immediately recognize it as "that type of experience" without needing any descriptive intermediary. This directness explains why phenomenal concepts seem unconnected to physical concepts—there's no descriptive link we can point to.

On Loar's view, this is exactly what physicalism should predict. If experiences are brain states, and we have direct recognitional access to those states from the inside, we'd expect our concepts to seem disconnected from physical descriptions.

### Papineau's Quotational Account

David Papineau suggested that phenomenal concepts literally *contain* experiences as constituents. When you think about the experience of red, the experience itself is part of your concept—like quoting rather than merely referring. This "quotational" structure explains the peculiar intimacy of phenomenal concepts.
...
David Chalmers presented a dilemmatic argument against all versions of PCS:

Let C be whatever features make phenomenal concepts "special"—the features PCS invokes to explain the gap.

**Horn 1:** If physical duplicates lacking C are conceivable, then C is not physically explicable. There would be an explanatory gap between physics and C itself. PCS would just relocate the [hard problem](/topics/hard-problem-of-consciousness/) from consciousness to phenomenal concepts.

**Horn 2:** If physical duplicates lacking C are inconceivable, then C cannot explain our epistemic situation. If C is entailed by physics, [zombies](/concepts/philosophical-zombies/) would have C too. Zombies would have the same concepts, the same apparent gap. So C doesn't explain why *we* find consciousness puzzling—the zombie finds it equally puzzling for purely physical reasons.
...
This makes PCS the test case for whether physicalism can accommodate the intuitions driving dualism. If PCS succeeds, the [explanatory-gap](/concepts/explanatory-gap/) becomes merely epistemic—a feature of our concepts, not a feature of reality. The arguments from [qualia](/concepts/qualia/), Mary's Room, and zombies would lose their force.
...
Some philosophers (Dennett, Frankish) suggest there are no phenomenal properties—only representations *as if* there were. The explanatory gap is between physics and an *illusion* of consciousness, not consciousness itself. This is [illusionism](/concepts/illusionism/)—the most radical physicalist response.

This trades the hard problem for the "illusion problem": why do we *seem* to have phenomenal consciousness? Even illusions are experiences. If it seems to me that I have [qualia](/concepts/qualia/), something is going on—the seeming itself requires explanation.

### The Ability Hypothesis

David Lewis and Laurence Nemirow argued that Mary gains an *ability*—knowing how to recognize and imagine red—rather than *information* about a new fact. Phenomenal concepts are know-how, not propositional knowledge.
...
Several findings would strengthen PCS and weaken the dualist interpretation:

1. **Neural correlates of conceptual specialness.** If neuroscience identified exactly what makes phenomenal concepts "direct" or "quotational" in purely structural terms, and this explanation satisfied intuitions about why consciousness seems puzzling, PCS would gain significant support.

2. **Dissolution of the gap through understanding.** If philosophical analysis or scientific discovery genuinely made the gap disappear—not by denying it or relocating it, but by showing why physical processes necessarily involve phenomenal properties—PCS-style approaches would be vindicated.

3. **Successful engineering of phenomenal concepts.** If we could build an AI system that demonstrably deploys phenomenal concepts (not just reports that sound phenomenal), and we could fully explain how this works physically, the gap would close.

4. **Contemplative confirmation.** If advanced meditators consistently reported that deep investigation of experience reveals it to be *empty* of intrinsic phenomenal character (some Buddhist traditions suggest this), the gap might be revealed as conceptual construction.

5. **Empirical failure of dualist predictions.** If consciousness research consistently found no evidence for any non-physical contribution—if the bidirectional interaction predicted by dualism never manifested—physicalist explanations including PCS would become more attractive.

## Relation to Site Perspective

**[Dualism](/tenets/#dualism)**: This project takes the explanatory gap as evidence that consciousness involves something beyond the physical. PCS is the strongest challenge to this position, and engaging it honestly strengthens the case for dualism. Chalmers's master argument suggests that PCS relocates rather than dissolves the problem. If phenomenal concepts are special in a way that explains the gap, that specialness must either (a) create a new gap or (b) apply equally to zombies, in which case it doesn't explain why *we* find consciousness puzzling. The persistence of the debate after decades of sophisticated work suggests the gap reflects something real about consciousness, not merely our conceptual limitations.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: If PCS fails and the gap is ontological rather than conceptual, consciousness must interact with the physical world somehow. The project's framework proposes quantum-level selection as this interaction point—consciousness biases quantum outcomes rather than violating energy conservation. PCS's failure supports the need for such an interface: if phenomenal concepts can't be explained purely physically, something non-physical must enter the picture, and quantum indeterminacy provides the cleanest entry point. See [decoherence](/concepts/decoherence/) for the challenges this faces.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: PCS assumes that phenomenal concepts merely *represent* brain states without affecting them. But the deployment of phenomenal concepts itself requires causal work—the brain must do something to generate these "direct" or "quotational" concepts. If phenomenal concepts involve consciousness directly grasping its own states (as Loar suggests), this grasping may constitute the kind of downward causation the project affirms. The concept doesn't just passively represent; consciousness actively apprehends. This active element resists purely bottom-up explanation.

**[No Many Worlds](/tenets/#no-many-worlds)**: The [zombie](/concepts/philosophical-zombies/) thought experiment central to Chalmers's master argument presupposes indexical identity—*I* could have been a zombie, or *this* world could have lacked consciousness. [Haecceity](/concepts/haecceity/)—the irreducible thisness of individual perspective—underlies the conceivability intuition. Many-worlds interpretations dissolve such indexicality by treating all outcomes as equally real. If the project's rejection of many-worlds is correct, the zombie conceivability intuition retains its force, and PCS cannot escape by denying that zombies raise genuine questions.
...
- [materialism](/arguments/materialism/) — The view PCS defends
