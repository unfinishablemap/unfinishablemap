...
PCS is the test case for whether physicalism can accommodate the intuitions driving dualism. If PCS succeeds, the [explanatory-gap](/concepts/explanatory-gap/) becomes merely epistemic—a feature of our concepts, not of reality. The arguments from [qualia](/concepts/qualia/), Mary's Room, and zombies would lose their force.
...
This trades the hard problem for the "illusion problem": why do we *seem* to have phenomenal consciousness? If it seems to me that I have [qualia](/concepts/qualia/), something is going on—the seeming itself requires explanation.
...
[illusionism](/concepts/illusionism/) offers an alternative to PCS: rather than explaining phenomenal concepts, deny that they refer to anything real.
...
[introspection](/concepts/introspection/) is central here. PCS relies on introspective access to phenomenal states—that's how we form phenomenal concepts in the first place. The ability to turn attention inward and notice what experience is like presupposes the very kind of awareness that PCS claims to explain.
...
- [materialism](/concepts/materialism/) — The view PCS defends, and the Map's case against it
