...
ai_modified: 2026-09-15 05:51:41+00:00
...
description: Pragmatism tests ideas by their practical consequences; turned on consciousness,
  the method exposes a framework-relative cost to materialism, not a refutation.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-08-03 13:37:03+00:00
lastmod: 2026-09-15 05:51:41+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Pragmatism is the philosophical tradition that evaluates ideas by their practical consequences — what difference does believing this make to how we act, inquire, and live? Founded in 19th-century America by Charles Sanders Peirce, William James, and John Dewey, pragmatism ties truth to inquiry rather than to a mirror held up to reality, differently in each founder: Peirce's truth is the final opinion inquiry converges on, its object real (Misak's reading); James's is the expedient "in the long run and on the whole". Both hold that beliefs earn their status by guiding action successfully, resolving genuine problems, and opening productive lines of inquiry. The Unfinishable Map finds in pragmatism a method that, applied reflexively to consciousness, pressures toward [interactionist-dualism](/concepts/interactionist-dualism/) rather than the [materialism](/concepts/materialism/) most contemporary pragmatists assume — enough, at minimum, that the pragmatist cannot dismiss dualism as a default. How much further it carries depends on a prior commitment to phenomenal irreducibility that the functionalist declines to grant, and this article marks where that line falls rather than arguing across it.

## Origins and Core Method

### Peirce's Pragmatic Maxim

Charles Sanders Peirce formulated the pragmatic maxim in 1878: to clarify an idea's meaning, consider what practical effects the idea's object might have. The concept of a thing is the sum of its conceivable practical consequences. Peirce intended this as a criterion of meaning for making philosophical disputes precise; the same essay pairs it with a convergence account of truth, realist about the final opinion's object. If two positions have identical practical consequences, the difference between them is merely verbal.

Applied to the mind-body problem, Peirce's maxim asks: what observable difference would it make if consciousness were reducible to physical processes versus irreducible? If [materialism](/concepts/materialism/) and [dualism](/concepts/interactionist-dualism/) produce different expectations about what we can explain, predict, or do, the dispute is genuine. If they don't, it's idle metaphysics. The Map holds the dispute is genuine — the positions diverge on what science can achieve, on personal identity, and on the meaning of death. (Moral responsibility is often added to that list and is more contested, since compatibilists deny that responsibility turns on the metaphysics of mind at all.)

### The Maxim Turned Inward

A criterion imported to press a rival is owed to the home position too, and Peirce's maxim is uncomfortable when run on the Map's own [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction). That tenet describes an influence *empirically indistinguishable from chance* under any *unconditioned aggregate* test current or foreseeable instruments could run: the bias acts on which single outcome is realised while the ensemble average stays exactly Born, so in that unconditioned register it leaves no statistical trace to resolve from the chance baseline it is constructed to match. Preservation binds only that unconditioned marginal, however — a deviation *conditioned* on intention, task or subject would test the corridor itself ([P-Q3](/positions/quantum-interface/#mechanism-debt)) — so the maxim's pressure falls on the aggregate register rather than on the mechanism as such. Put the maxim to that, and the difference between a consciousness-biased quantum outcome and an unbiased one threatens to come out merely verbal — which is precisely the verdict the maxim was invoked to deliver against materialism.

The Map's answer is that the practical difference is per-trial and indexical rather than statistical: *which* outcome this experiencing subject actualises is a difference even where the aggregate distribution records none. Whether that discharges the maxim or merely relocates the problem is open, and the positions register says so — [P-Q3](/positions/quantum-interface/#mechanism-debt) holds that a selection observer-indistinguishable from an unselected outcome "sits genuinely close to epiphenomenalism", treating this as the strongest live challenge to the mechanism rather than a settled matter. The maxim is retained here with that debt showing rather than applied in one direction only.

### James's Expansion

[William James](/topics/william-james-consciousness/) transformed pragmatism from a method of clarification into a theory of truth. He keeps truth as an idea's "agreement" with reality and locates the dispute in what agreement means — verification, successful leading, experiential constraint, copying retained as one form (*Pragmatism*, Lecture VI). An idea is true insofar as it is useful in navigating experience, with James's own qualifier: "'The true,' to put it very briefly, is only the expedient in the way of our thinking… expedient in the long run and on the whole of course." This does not mean truth is whatever we want it to be — beliefs must satisfy experiential constraints and cohere with other beliefs. But among beliefs that meet these constraints, practical fruitfulness is the mark of truth.

James applied this directly to consciousness. In "Human Immortality" (1898), he argued that the transmissive view of consciousness — the brain as filter rather than generator — has different practical consequences from the production view. If consciousness is transmitted rather than produced, death may not be annihilation — that much is James's; that human dignity thereby acquires a non-biological basis, and that consciousness has a status materialism denies, are the Map's inferences from the underdetermination he establishes, not his conclusions. These consequences matter. The pragmatist cannot dismiss dualism as a default. Reading the 1898 lecture as a trajectory toward interactionism is complicated by James's 1904 denial that "consciousness" names any entity at all — a tension [william-james-consciousness](/topics/william-james-consciousness/) carries rather than this article.

In "The Will to Believe" (1896), James added that when a choice is forced, living, and momentous — when we must act on some assumption, when both options have genuine appeal, and when the stakes are high — we may choose based on our nature and needs rather than waiting for conclusive evidence. The consciousness question is plainly living and momentous. *Forced* is the harder condition and should not be waved through: suspending judgement on the metaphysics of mind is cheap for most purposes, which is the standard objection to treating the question as forced at all. The route to forcedness runs through conduct rather than theory: if how one treats persons and what one takes death to be require acting on some answer, suspension is itself a choice carrying the cost of a wrong one. That route is contestable, and a reader who rejects it should take James here to license openness to dualism rather than belief in it.
...
Hilary Putnam's internal realism, developed in *Reason, Truth and History* (1981), steers between metaphysical realism and Rorty's anti-representationalism. Truth is what would be justified under epistemically ideal conditions — conditions that involve rational agents with interests rather than phenomenal consciousness in the Map's sense, an agent-relativity a functionalist can accept without dualism. Putnam later moved to a natural realism (the 1994 Dewey Lectures); 1981 is not his settled view. Putnam's model-theoretic argument holds that reference cannot be fixed by physical-causal relations alone: any purely physical description is compatible with multiple incompatible interpretations, and adding a causal constraint supplies only more theory, itself in need of interpretation.
...
## Pragmatism and the Map's Framework
...
The Unfinishable Map treats pragmatism as a method that, applied reflexively, pressures toward its commitments.

**[Dualism](/tenets/#dualism)**: Pragmatism's reflexive application presses materialism about consciousness at pragmatism's own criterion. A theory that reduces the evaluative standpoint on which theory-choice depends leaves the authority of that standpoint unaccounted for, so the verdict "materialism works better" has no more standing than whatever verdict the process happened to produce. How much this settles turns on the prior question of whether evaluation is ineliminably phenomenal — which is exactly what the functionalist disputes, and what the naturalist theories of normativity above are built to supply without it. The Map states the cost rather than claiming the refutation.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: Van Fraassen's pragmatics of explanation (1977; *The Scientific Image*, 1980) is often pressed into service here, and two readings must be kept apart: the dualist payoff depends on the stronger one, and van Fraassen licenses only the weaker. What he defends is that *explaining* is a speech act — answering a why-question, interest-relative and context-dependent because requesting and grasping an answer is something a conscious agent does. That is an epistemic and semantic claim about an act, and it is all he commits to; the dependency relations the explanations track are left untouched. The step from there to conscious evaluation having *causal* consequences is the Map's own extension, argued separately in [pragmatism's path to dualism](/topics/pragmatisms-path-to-dualism/) and [the reflexive-gap analysis](/topics/consciousness-defeats-explanation/). Stated in the Map's voice: scientists choose theories, design experiments, and communicate results on the strength of conscious assessment, and an epiphenomenal assessment would leave the success of that practice unexplained. The epiphenomenalist has a standing reply — the assessment supervenes on the physical processes that do the causing, so the practice succeeds without any phenomenal causation — and what answers it is the indirect case registered under [Tenet 3](/tenets/#tenet-3-standing), not anything van Fraassen supplies.

**[No Many Worlds](/tenets/#no-many-worlds)**: Pragmatic evaluation is indexically addressed — what difference does *this* belief make for *this* inquirer — and presupposes a unique subject who bears the consequences. [tenets](/tenets/) records this as the subjecthood dependency: the indexical objection presupposes a non-deflationary "I", and No Many Worlds "is not a pure physics tenet". Pragmatism alone therefore does not exclude branch-relative Everettian agency, each successor evaluating within its own branch; the rejection rides on the Map's theory of subjecthood, argued in [mine-ness](/concepts/mine-ness/), not on the method.
...
- [functionalism](/concepts/functionalism/) — The dominant position pragmatism's reflexive argument presses, and where the pressure stops short of refutation
- [reflexive-methodology](/concepts/reflexive-methodology/) — The Map's general method: this article is its immanent-critique instance
- [quantum-interface](/positions/quantum-interface/) — The register entry recording what Peirce's maxim, turned inward, costs the Map's own mechanism
...
1. Misak, C.J. (2004). *Truth and the End of Inquiry: A Peircean Account of Truth* (1991; expanded ed. 2004). Oxford University Press. https://doi.org/10.1093/0199270597.001.0001
1. Putnam, H. (1994). Sense, Nonsense, and the Senses: An Inquiry into the Powers of the Human Mind. *The Journal of Philosophy*, 91(9), 445 ff. https://doi.org/10.2307/2940978
1. van Fraassen, B.C. (1977). The Pragmatics of Explanation. *American Philosophical Quarterly*, 14(2), 143-150. https://www.jstor.org/stable/20009661