...
description: Why consciousness resists reduction—from Nagel's bridge laws to Kim's
  functional reduction. Even reductionism's strongest frameworks concede the hard
  problem.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-05-12 05:30:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
The [Dualism tenet](/tenets/#dualism) asserts that consciousness is not reducible to physical processes. The arguments above—the explanatory gap, the hard problem, and the failure of functional reduction to handle phenomenal consciousness—converge on this conclusion from different directions.
