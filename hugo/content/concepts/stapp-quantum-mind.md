...
description: 'Mental effort operates through the quantum Zeno effect: rapid attention
  holds neural patterns against decay, providing a mechanism for mind-matter interaction.'
draft: false
human_modified: null
last_curated: null
...
The model has several notable features. It explains why controlling attention feels effortful (rapid observation requires continuous engagement). It aims to satisfy conservation laws by selecting among outcomes rather than injecting energy—an accounting that is exact for idealised measurement of an isolated system but faces an open thermodynamic challenge for the warm, bath-coupled brain ([the measurement back-action objection below](#the-measurement-back-action-objection)). It addresses the exclusion problem (consciousness operates where physics leaves outcomes undetermined). Schwartz and Stapp read Jeffrey Schwartz's OCD neuroplasticity research as consistent with it, but that small, unreplicated study fits a materialist explanation equally well and cannot count as support for the quantum mechanism ([caveats below](#empirical-support-neuroplasticity)). For the candidate neural sites and timing constraints relevant to this mechanism, see [quantum-neural-timing-constraints](/topics/quantum-neural-timing-constraints/).
...
- [wheelers-participatory-universe-and-it-from-bit](/topics/wheelers-participatory-universe-and-it-from-bit/) — Wheeler's participatory vision that Stapp concretises
...
- [bohm-implicate-order-and-active-information](/concepts/bohm-implicate-order-and-active-information/) — A pilot-wave rival where guidance is deterministic; the Map borrows its form-directs-energy channel rather than its selection story
