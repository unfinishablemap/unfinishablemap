...
- **Forced-choice success**: Patients discriminate between alternatives (left vs right, horizontal vs vertical) with 70-90% accuracy in blind field regions.
...
- **Emotional processing**: Some patients show above-chance discrimination of facial expressions in blind regions, suggesting unconscious affective processing pathways.
...
**1. Total absence of visual consciousness**
...
Maniscalco and Lau (2012) propose that blindsight might involve some preserved visual consciousness but with metacognitive failure—the inability to form reliable confidence judgments about internal visual states. Patients might have faint, degraded visual qualia that their metacognitive systems cannot access or evaluate. The "guessing" experience reflects genuine uncertainty about internal states, not proof of absent consciousness.

Evidence: Some Type 2 blindsight patients report vague "feelings" or "awareness of something" without clear visual experience. Stimuli in blind regions sometimes trigger surprise or attention shifts, suggesting some form of detection that doesn't reach explicit awareness. The line between absent consciousness and present-but-inaccessible consciousness blurs.
...
- Feature detection (orientation, color, motion direction)
- Rapid, automatic, and consistent performance on procedural tasks
- Action guidance (reaching, grasping)
- Affective response to emotional stimuli (without knowing why)

**What unconscious vision cannot do:**
- Detection (reporting that something appeared vs nothing)
- Flexible reasoning about visual content ("what did you see and why?")
- Metacognitive confidence ("how sure are you?")
...
Blindsight shows system 1 without 2 or 3. Blind insight shows system 3 without clear 1 or 2. Normal vision integrates all three. The separability implies consciousness is not reducible to either processing or metacognition.
...
**Response 1: Qualia are present but undetectable**

Perhaps blindsight patients have visual qualia but cannot introspect or report them. The damage disrupts metacognitive access to phenomenal states without eliminating the states themselves.

Problem: This requires positing invisible qualia—conscious experiences that leave no trace in introspection, report, memory, or confidence judgments. If qualia have no functional role whatsoever, how do we know normal vision includes them either? The move threatens to make consciousness epiphenomenal and undetectable in principle.

**Response 2: Residual V1 explains all cases**

All apparent blindsight reflects spared V1 tissue mediating weak conscious vision, not unconscious vision.

Problem: Cases exist with complete V1 removal. Alternative pathways (superior colliculus route) preserve discrimination without V1, and lesion studies show these pathways don't generate conscious vision even when intact.

**Response 3: Consciousness requires specific pathways, not processing type**
...
- Do blindsight patients have any visual qualia—degraded, minimal, or qualitatively different—or truly none?
- Can metacognitive training improve blindsight patients' confidence judgments without improving detection reports?
- What functional role does phenomenal consciousness serve if unconscious processing handles discrimination so effectively?
- Do alternative visual pathways (superior colliculus) support minimal consciousness, or are they purely unconscious?
- Can AI vision systems replicate blindsight-style discrimination without phenomenal awareness, or does successful discrimination require consciousness?

Blindsight demonstrates that sophisticated visual processing can occur without conscious experience—or at least without the metacognitive access that makes experience reportable. Whether the dissociation proves consciousness is non-physical depends on interpreting what's absent: qualia themselves, metacognitive access to qualia, or merely verbal report mechanisms. The first interpretation supports dualism; the latter two weaken it. The debate continues.
...
- [visual-consciousness](/visual-consciousness/) — How we consciously see
