...
**It preserves the causal efficacy of consciousness.** If consciousness causes collapse, it is not [epiphenomenal](/concepts/epiphenomenalism/)—it does real work in the world. This avoids the [self-stultification](/concepts/self-stultification/) problem: an epiphenomenal consciousness could not reliably report on its own states.
...
The von Neumann–Wigner interpretation is an ancestor of the Map's framework, not its final form. The Map inherits three commitments from it:
