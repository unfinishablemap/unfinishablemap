...
description: 'The Map uses strong-emergence vocabulary as a comparative register for
  its bi-aspectual dualism: consciousness co-fundamental with physical structure,
  not arising from it.'
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-07-25 21:24:36+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Weak emergence is compatible with [physicalism](/concepts/materialism/) and [causal closure](/concepts/causal-closure/). The emergent property [supervenes](/concepts/supervenience/) on the physical base with *metaphysical necessity*: any world with the same microphysics has the same temperatures.
...
On the strong-emergence framing, consciousness counts as strongly emergent: no arrangement of neurons logically entails the presence of experience. This is the [hard problem](/topics/hard-problem-of-consciousness/)—the seeming impossibility of deriving phenomenal facts from physical facts. The Map endorses the irreducibility this framing captures, but its canonical reading is comparative rather than committal: as the closing sections set out, its own ontology is [bi-aspectual co-fundamentality](/concepts/bi-aspectual-ontology/) (consciousness does not *arise from* a physical base), and strong-emergence vocabulary is used here to locate the Map against rival positions, not to endorse a from-below derivation.
...
For strong emergentists—and dualists—this forces a choice: deny that consciousness has causal powers ([epiphenomenalism](/concepts/epiphenomenalism/)), or deny that physics is causally closed. A third option is [causal delegation](/concepts/delegatory-causation/): the physical state delegates its causal work to the experience via [preemption](/concepts/delegatory-causation/), avoiding overdetermination while preserving mental causation.
...
The Map resolves this by denying causal closure—not everywhere, but at the specific points where physics is genuinely incomplete. The [measurement problem](/concepts/measurement-problem/) exposes this incompleteness most precisely: quantum mechanics requires definite outcomes but cannot specify what causes them, creating a [causal closure loophole](/concepts/measurement-problem/#the-causal-closure-loophole) where Born-rule probabilities constrain but do not determine results. The [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) tenet identifies this opening as consciousness's point of entry.

## Downward Causation

Strong emergence requires [downward causation](/concepts/mental-causation-and-downward-causation/)—higher-level features genuinely influencing lower-level processes. Critics argue this violates physical laws; defenders reply that consciousness exercises powers not reducible to component-level causation.
...
Each of these features—unity, qualitative character, agency—is what the strong-emergence framing would predict and what weak emergence cannot explain. (On the Map's own bi-aspectual reading these are not *predictions from below* but marks of the co-fundamental aspect; the strong-emergence gloss is the comparative register.)

## The Map's Position: Bi-Aspectual Dualism at the Quantum Opening
...
The Map's [bi-aspectual ontology](/concepts/bi-aspectual-ontology/) departs from strong emergentism's "from-below" picture: consciousness does not arise from physical organisation but is a co-fundamental aspect of reality that engages with physical structure at quantum indeterminacies. Strong emergentism's commitments to irreducibility and downward causation survive the reframing; what changes is the directionality. The Map advances beyond British emergentism—but honestly, not as far as one might wish. The [quantum framework](/concepts/interactionist-dualism/) identifies *where* non-physical causation operates without violating conservation laws: at quantum indeterminacies, where physics specifies probabilities but not which outcome actualizes. The Minimal Quantum Interaction tenet locates consciousness's influence here—biasing probabilities rather than injecting energy.

This identifies a *locus* (quantum indeterminacy) and a *mode* (probability bias), not a fully specified mechanism. The choice of locus is not arbitrary—the [measurement problem as philosophical problem](/topics/quantum-measurement-and-consciousness/) reveals that measurement is where consciousness and physics have always been entangled, where the observer's role becomes formally unavoidable. A complete mechanism would specify which physical variable consciousness couples to, how coupling strength is determined, and what testable predictions follow. The [psychophysical laws](/concepts/psychophysical-laws/) article surveys several candidate coupling mechanisms—the developed ones being attention as observation rate (Stapp) and intention as probability weighting (Eccles), while noting that no quantum-level mechanism has been proposed for valence, qualia, or unity—but the Map does not yet endorse one. The coupling problem remains open.
...
| Site's bi-aspectual dualism | Adjacent to strong (aspects co-fundamental) | Locus and mode, not full mechanism | No (at quantum level) |
...
The difference: O'Connor and Wong acknowledge that strongly emergent properties require something outside the purely physical domain—their emergentism explicitly denies causal closure—but leave the locus abstract. The Map identifies where that something operates—quantum indeterminacies—and surveys candidate [coupling mechanisms](/concepts/psychophysical-laws/), even though the specific coupling law remains open.
...
**Neural correlates that track phenomenal properties.** If specific neural patterns correlate with specific qualia across subjects, substrates, and conditions, this supports the emergence claim—consciousness depends on physical organization. The [binding problem research](/concepts/binding-problem/#testable-commitments) provides one domain: if phenomenal unity correlates with quantum coherence signatures rather than classical neural synchrony, this would support the quantum locus for strong emergence.
...
Emergence language provides vocabulary for articulating the Map's position to philosophically sophisticated audiences:
...
This vocabulary serves comparison rather than canonical self-description: the Map's actual ontology is [bi-aspectual dualism](/concepts/bi-aspectual-ontology/), on which consciousness and structure are co-fundamental aspects rather than higher-level consciousness arising from a lower-level physical base.

## Relation to the Map's Perspective

**Dualism:** Consciousness has properties and powers not deducible from physics—what the Dualism tenet affirms. The Map's canonical framing is [bi-aspectual dualism](/concepts/bi-aspectual-ontology/) rather than strong emergentism: both aspects are co-fundamental, not consciousness arising from physical organisation.
