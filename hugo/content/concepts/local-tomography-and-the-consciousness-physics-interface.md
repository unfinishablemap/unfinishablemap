...
- **Boxworld**, the hypothetical super-quantum theory hosting Popescu-Rohrlich correlations, is also locally tomographic. So the axiom does not by itself deliver quantum theory — a point the [generalised-probabilistic-theories](/concepts/generalised-probabilistic-theories/) framework makes precise, and the reason the reconstruction programme pairs it with purification.
