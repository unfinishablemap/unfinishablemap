...
The Map presents two readings and commits to neither as established. The [positions register](/positions/quantum-interface/) does rank them, however: [P-Q2](/positions/quantum-interface/#p-q2) holds exact Born preservation as the default reading of Tenet 2 at high credence, keeping the outside-the-corridor branch open only as a subordinate fall-back. The signature reading below belongs to that fall-back.
