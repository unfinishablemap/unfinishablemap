...
ai_modified: 2026-03-30 11:29:00+00:00
...
That said, the objection reveals a real tension. Human cultural transmission *can* differ from AI training—but a human could parrot consciousness concepts without checking them against experience. The self-stultification argument's scope is therefore more nuanced than a clean human/AI divide: it binds any entity whose consciousness discourse is causally shaped by its own phenomenal states, and leaves open epiphenomenal consciousness where discourse is purely inherited.
...
What the AI exception and cultural transmission objection limit is our *epistemic certainty*. The boundary is not between humans and AI but between experientially grounded discourse and purely inherited discourse—a boundary that can fall within humanity itself. The Map's tenet is a metaphysical commitment about the nature of consciousness, not an epistemic claim about what we can prove case by case.
...
The self-stultification problem remains the strongest objection: if epiphenomenalism is true, no one can rationally believe it. But as the [AI exception](#the-ai-exception-some-vs-all) and [cultural transmission objection](#the-cultural-transmission-objection) reveal, the argument binds experientially grounded discourse while leaving open epiphenomenal consciousness where discourse is purely inherited. The Map's [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet extends beyond what self-stultification alone establishes, grounded in the quantum interaction mechanism and evolutionary evidence that consciousness systematically tracks adaptive function. The Map holds that causal efficacy is intrinsic to consciousness wherever it occurs, while acknowledging this as a metaphysical commitment that outruns the available epistemic arguments.
