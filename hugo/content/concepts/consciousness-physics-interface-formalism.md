...
Each major proposal specifies different subsets of the three components. This theoretical diversity raises the question of [interface-heterogeneity](/concepts/interface-heterogeneity/)—whether different conscious systems instantiate different versions of the coupling map C, rather than all sharing a single universal mechanism.
