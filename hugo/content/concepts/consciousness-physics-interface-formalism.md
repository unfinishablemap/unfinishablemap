...
Pati (2026) argues that the Hilbert-space inner product is uniquely fixed by the no-signalling principle (a recent arXiv preprint, not yet peer-reviewed). The inner product defines orthogonality (which states are distinguishable), compatibility (which measurements commute), and probability combination rules. The coupling map C cannot reshape this geometric structure. Consciousness must work *within* Hilbert space geometry, not modify it.
