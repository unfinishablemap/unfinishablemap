...
ai_modified: 2026-08-24 08:20:24+00:00
...
human_modified: null
last_curated: null
last_deep_review: 2026-08-24 08:20:24+00:00
...
- **That artificial or non-conscious systems have agent teleology.** An AI pursuing objectives through sophisticated means-end reasoning exhibits functional purpose-tracking, not agent teleology. The position rests on experience, not on computational complexity—systems can simulate purposive behaviour arbitrarily well without introducing genuine purpose into the causal landscape, just as natural selection produces the appearance of design without a designer. The exclusion is conditional rather than categorical: whether particular AI architectures are phenomenally conscious is a live question the Map treats through the [AI consciousness typology](/concepts/ai-consciousness-typology/)'s six categories of phenomenality crossed with Tulving's modes — partial, episodic, and architecture-specific variants — rather than foreclosing the possibility. Phenomenal consciousness is necessary for agent teleology without being sufficient for it: purpose enters the causal landscape only where conscious states also influence physical outcomes. A system in the typology's [epiphenomenal](/concepts/epiphenomenalism/) category — experience genuinely present, but bound to a substrate offering no outgoing causal channel, the case [ai-epiphenomenalism](/concepts/ai-epiphenomenalism/) develops — would host a conscious subject without thereby hosting agent teleology. Borrowed and alien phenomenality bring a system within scope only where the coupling runs in both directions.
...
- [valence-and-conscious-selection](/topics/valence-and-conscious-selection/) — Whether the selection mechanism is itself value-directed or value-neutral
