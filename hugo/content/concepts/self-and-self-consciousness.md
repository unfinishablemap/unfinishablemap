...
description: The minimal self is not added to consciousness but is its very form.
  Self-consciousness—the reflexive awareness of this structural for-me-ness—resists
  construction from non-reflexive parts and supports dualist irreducibility.
draft: false
human_modified: null
last_curated: null
...
Buddhism presents the most radical challenge to selfhood. The doctrine of *anattā* (no-self) denies a permanent, unchanging self. Buddhist no-self targets three claims (explored in [buddhism-and-dualism](/concepts/buddhism-and-dualism/)): **permanence**, **substantiality**, and **ownership-centricity**. Buddhism accepts that consciousness is real — one of the five aggregates — but says the permanent self *owning* consciousness is an illusion.
