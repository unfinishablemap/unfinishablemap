...
A serious objection arises: if voluntary attention interfaces with quantum processes, how can this work given [decoherence](/concepts/decoherence/)? Tegmark (2000) calculated that quantum coherence in neural microtubules decays in femtoseconds (10⁻¹³ to 10⁻²⁰ seconds)—far shorter than the 300ms voluntary attention deployment time.
