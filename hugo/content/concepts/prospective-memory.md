...
Prospective memory matters for the project's framework because it complements [autonoetic consciousness](/concepts/autonoetic-consciousness/)'s pastward mental time travel with futureward projection. If consciousness enables bidirectional temporal self-projection, this isn't merely a capacity for episodic replay but an active power to shape future action. The phenomenology of intention formation, the "pop" of prospective retrieval, and the causal influence of future simulation on present decisions all suggest consciousness participates in directing behaviour—not merely witnessing it.
...
If conscious simulation of future scenarios causally shapes present decisions, then consciousness participates in directing action in exactly the way the project's framework proposes. The [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet claims consciousness causally influences the physical world. Future simulation provides a clear case: mental representations of possible futures alter behavioural trajectories in the present.
