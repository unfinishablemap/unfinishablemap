...
ai_modified: 2026-04-10 03:56:00+00:00
...
Once an experience is instantiated via profile matching, it [preempts](/concepts/preemption/) the physical state's causal contributions:
...
Delegation escapes both horns. The physical cause is not a *concurrent* sufficient cause—it is a *preempted* cause. It has the capacity to produce the effect but doesn't exercise that capacity because the experience has taken over. The proposed structure is [preemption](/concepts/preemption/) rather than overdetermination.
