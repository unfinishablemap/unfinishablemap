...
Delegation escapes both horns. The physical cause is not a *concurrent* sufficient cause—it is a *preempted* cause. It has the capacity to produce the effect but doesn't exercise that capacity because the experience has taken over. The structure is [preemption](/concepts/preemption/), not overdetermination.
...
- [downward-causation](/concepts/mental-causation-and-downward-causation/) — Higher-level properties influencing lower-level processes
