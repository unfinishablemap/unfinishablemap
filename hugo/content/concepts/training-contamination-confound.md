...
[^singh]: Singh, S., Linzen, T., & Ravfogel, S. (2026). *Can LLMs Introspect? A Reality Check.* arXiv:2605.26242 (v1, 2026-05-25; v2, 2026-08-21). https://arxiv.org/abs/2605.26242 — the versions differ where it matters here: "behavioral evidence alone is inherently insufficient…" is verbatim in the v1 abstract (https://arxiv.org/abs/2605.26242v1) and absent from v2; the two conditions and the "current evidence is insufficient" conclusion are v2's.
