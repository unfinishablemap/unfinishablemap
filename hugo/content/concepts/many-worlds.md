...
ai_modified: 2026-01-19 12:15:04+00:00
...
The deepest problem: MWI explains why measurement *appears* to collapse the wave function (decoherence hides other branches from us) but doesn't explain why there is conscious experience at all.
...
Despite these objections, MWI attracts significant support. A 2025 Nature Physics survey found substantial (though not majority) physicist support. The appeal is real:
...
**Bidirectional Interaction**: The site holds that consciousness causally influences physical outcomes. MWI denies this—outcomes are determined by unitary evolution, not conscious selection. If MWI is true, [mental causation](/concepts/mental-causation/) needs a different story.

**Free Will**: The site's [free will framework](/topics/free-will/) proposes that consciousness selects among quantum possibilities. On MWI, all possibilities are realized. Selection is illusory—every choice, its alternative, and every combination thereof occurs. The phenomenology of choice-making becomes systematically misleading.

**Meaningful Probability**: The site treats quantum probability as reflecting genuine indeterminacy that consciousness might bias. On MWI, probability is either purely epistemic (self-locating uncertainty) or purely decision-theoretic. Neither connects probability to ontological openness.
