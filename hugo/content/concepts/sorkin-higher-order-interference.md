...
description: 'The interference-order hierarchy that operationalises ''the Born rule
  is tested'': what the third-order parameter κ measures, the ~10⁻²–10⁻⁴ optical bounds,
  and where the tested slice ends.'
draft: false
human_modified: null
last_curated: null
...
- [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/) — how corridor dualism biases which outcome is realised while leaving the Born measure intact
