...
This matters for The Unfinishable Map because illusionism is the most direct challenge to taking consciousness seriously. If illusionists are right, there is no [explanatory-gap](/concepts/explanatory-gap/)—nothing non-physical to explain—and the [Dualism](/tenets/#dualism) tenet would be defending something that doesn't exist.

Illusionism is the eliminativist strand of physicalism targeting phenomenal consciousness. Where the Churchlands' classical [eliminativism](/topics/eliminative-materialism/) denies the reality of propositional attitudes, illusionism denies the reality of qualia. The two strands are independent, but Frankish (2016) grants that we might call illusionism "eliminativism about phenomenal consciousness," adding only that "the term is not ideal." Placing it in that tradition matters: illusionism inherits eliminativism's dialectical history, including the [self-refutation](/concepts/self-stultification/) arguments that arise whenever a theory denies the reality of its own categories of assertion.

## The Core Claim

Keith Frankish and Daniel Dennett, illusionism's leading defenders, hold that we *seem* to have experiences with special qualitative properties ([qualia](/concepts/qualia/)), but this seeming is itself a misrepresentation. Dennett's [heterophenomenology](/concepts/heterophenomenology/)—treating consciousness reports as third-person data rather than privileged first-person access—provides the methodological foundation.
...
The strongest form of the illusionist programme does not rest on the bare denial that seeming is phenomenal. In the 2016 *Journal of Consciousness Studies* symposium that introduced "Illusionism as a Theory of Consciousness," Frankish sets the positive explanatory target precisely: an illusionist theory must specify the meta-representational machinery that generates the *impression* of a unified phenomenal field—experiences presented to a single subject, all at once, with felt qualitative character—and explain why that machinery produces the misrepresentation *there is something it is like* rather than nothing or a different impression. Frankish's wager is that this bridge, from meta-representational structure to felt unity, need not be regress-vulnerable: a self-monitoring system can represent its own first-order states as unified and qualitative without any of the representing being itself phenomenal, so the demand "but what experiences the unity?" never arises. The seeming-of-unity is a structural property of how the system models itself, not a further phenomenal fact about the modelling.

This is a more demanding move than the regress reply, and engaging it on its own terms is what the dialectic requires. The bare regress—"to be under an illusion something must experience the illusion"—assumes the conclusion illusionists deny, and Frankish is right that a representational system need not instantiate what it represents: a map represents terrain without being mountainous. The illusionist's claim is that introspective self-models stand to phenomenal character as the map stands to the mountain. If that analogy holds, the regress dissolves at its first step and felt unity is explained as a representational artefact rather than presupposed.

The 2020s illusionist programme is alive on this question, not stalled. Frankish, Dennett, Graziano, Kammerer, Pereboom, and Shabasson have continued to develop the meta-representational account, mounting specific replies to the regress and self-representation objections rather than restating the position—Kammerer (2025) sharpening the dialectic from the definitional side, arguing that supposedly innocent definitions of phenomenal consciousness are implicitly loaded. Dennett's late work—from *Consciousness Explained* (1991) through *From Bacteria to Bach and Back* (2017)—supplies the most-developed version: the "user-illusion" of a unified Cartesian Theatre is generated by competitive neural processes issuing self-reports, with no felt presence beyond the contents the system commits to. The Map's verdict that the account falls short is a verdict on a live programme, not a defeated one.

### Where the Functional Account Falls Short

The functional-seeming move, in its meta-representational form, is the best version of illusionism available and deserves engagement on its own terms. Even so, it faces problems that the access/interpretation distinction does not resolve—problems that trace to the gap the Map's [Dualism tenet](/tenets/#dualism) identifies between what experience *does* (its functional role) and what experience *is* (its intrinsic character). The five objections operate in different registers and it is worth keeping them distinct: vantage-point, zombie convergence, self-representation, and seeming/processing all press Frankish using commitments his own framework endorses (mechanism, evidence, representational structure)—the self-representation objection in particular meets the meta-representational bridge where it is weakest—while the intrinsic-quality objection runs through dualism and is honestly noted as framework-boundary disagreement rather than dressed as refutation inside materialism. The [functional-seeming](/concepts/functional-seeming/) article develops the first three in detail; the following summarises all five.
...
Illusionism and [epiphenomenalism](/concepts/epiphenomenalism/) present themselves as opposites—one denies phenomenal consciousness exists, the other grants it but denies it causes anything—yet both converge: phenomenal properties play no causal role in producing our reports about them. Under epiphenomenalism the brain state causes both experience and report, leaving the experience idle; under illusionism it causes a quasi-phenomenal representation plus the report. Either way the "what it's like" is causally excluded. Frankish would object that quasi-phenomenal properties *do* causal work, but that work is what physical processes were already doing—relabelling an existing causal contributor, not adding one.

The [self-stultification argument](/topics/self-stultification-as-master-argument/) aimed at epiphenomenalism applies equally: the illusionist cannot claim their position is *informed by* careful attention to the character of experience, since on their view experience has no character beyond what physical processes produce. Whether consciousness exists but is inert or doesn't exist as conceived, the causal picture is the same—illusionism has renamed the hard problem rather than dissolving it.

## Structural Parallel with Content Irrealism

Illusionism shares a deep structural feature with eliminativism about propositional attitudes: both are *content-irrealist* programmes, denying the reality of a class of contentful states their critics take to be obviously real. The eliminativist tradition has accumulated arguments that bear on illusionism's prospects even though they target propositional content rather than phenomenal character. Hutto and Myin's [Hard Problem of Content](/concepts/hard-problem-of-content/) argues that no naturalistic theory delivers genuine semantic content for basic minds—covariational and teleosemantic resources yield causal and statistical facts but never the normative dimension content requires. Boghossian's [self-refutation argument](/concepts/status-of-content/) presses from the other side: arguments for content irrealism cannot be coherently asserted, because the assertion presupposes contentful states. Together they form a pincer: content irrealism cannot be coherently asserted; content realism cannot be naturalised.

Illusionism extends the irrealism move from *propositional* content to *phenomenal* character, and the explanatory debt scales accordingly. The illusionist must explain everything the belief-eliminativist owes—why folk psychology succeeds, why we reliably *seem* to have the disputed states—*plus* why phenomenal seeming is so vivid, so resistant to dissolution, and so universal. Quasi-phenomenal properties and the distortion thesis attempt to discharge this debt, and face an analogue of the worry Hutto and Myin press against teleosemantics: a story specifying *when* a state is tokened does not deliver what the state *says*. The Boghossian-style pressure transposes too: if asserting content irrealism presupposes contentful states, the analogous worry is that *theoretical conviction itself* is plausibly partly phenomenal—the felt obviousness of a Moorean intuition. Strawson's "Consciousness Deniers" charge and Tallis's regress (above) read as the phenomenal-state counterpart of Boghossian's diagnosis.

**Honest limitation**: the parallel is structural, not an identity of position. Hutto and Myin do not endorse illusionism, and Boghossian targets eliminativism about propositional attitudes specifically. Frankish holds that phenomenal-realism is separable from content-realism, and that quasi-phenomenal properties are not what Boghossian's argument was built to eliminate. The Map's claim is the weaker structural one: illusionism inherits the dialectical history content-irrealism has accumulated, and the debt grows when irrealism reaches phenomenal character. Whether it is dischargeable is what the [functional-seeming](/concepts/functional-seeming/) objections (above) press.

## Relation to Site Perspective

Illusionism directly challenges the Map's [tenets](/tenets/):

**[Dualism](/tenets/#dualism)**: If there are no phenomenal properties, there's nothing non-physical to explain. Frankish's functional-seeming response is the strongest version of this challenge, arguing that what dualists call "intrinsic qualities" are mischaracterisations of functional states. The Map's response is that functional roles underdetermine experience: the gap between what a state *does* and what it *is like* is not a failure of introspection but the very phenomenon dualism exists to explain. The self-representation and intrinsic-quality objections above show the functional account cannot close this gap without presupposing what it denies—and where the residue is bedrock (the intrinsic-quality dispute), it is named as a framework boundary rather than substituted for argument.
