...
**The self-representation problem.** This is where the meta-representational bridge does its real work and where, on illusionism's own standard, it has not yet been built. Frankish's analogy holds for externally directed representation: a map represents a mountain without being mountainous, and a self-monitoring system can represent its first-order states without instantiating what it represents. But "I am phenomenally conscious" targets the representing state itself, and at that point the analogy's load-bearing gap closes. The state representing itself as experiential *is* the candidate for being experiential—unlike combustion, indifferent to being called "phlogiston." So the bridge owes a mechanism the map analogy cannot supply: an account of how a meta-representation of unified qualitative presence is generated *and* why that produces a misrepresentation rather than the very presence it represents, where the represented and the representing coincide. Frankish (2016) names this explanandum and replies that the coincidence is no obstacle—the self-model is still a model—but the reply asserts the disanalogy rather than deriving it, and mechanistic specification is precisely the standard illusionism presses against its rivals. The account identifies the bridge it needs and does not yet build it. (The Map names this the [constitutive vs referring](/concepts/constitutive-vs-referring-observation/) distinction: illusionism needs introspection to be *referring*—seeming and being come apart—rather than *constitutive*, which the realist denies. The meta-representational programme attempts this; the unbuilt bridge is what it leaves owing.)

**The seeming/processing gap.** Kammerer's illusion meta-problem—why illusionism seems so absurd—is meant to *explain away* our resistance. But the persistence of phenomenal seeming under full intellectual acceptance of illusionism is equally well explained by phenomenal seeming being veridical: the "rich illusion" and "real experience" hypotheses predict identical phenomenology, and neither can appeal to the evidence to rule out the other. If the functional account strips all experiential character from "seeming," what distinguishes a functional disposition to judge pain from mere information processing? By driving a wedge between representing and experiencing, Frankish explains our *reports*—but reports are not what makes the hard problem hard. Experience itself remains untouched rather than dissolved.
...
**Honest limitation**: the parallel is structural, not an identity of position. Hutto and Myin do not endorse illusionism, and Boghossian targets eliminativism about propositional attitudes specifically; Frankish holds phenomenal-realism is separable from content-realism. The Map's claim is the weaker structural one: illusionism inherits the dialectical history content-irrealism has accumulated, and the debt grows when irrealism reaches phenomenal character. Whether it is dischargeable is what the [functional-seeming](/concepts/functional-seeming/) objections press.
