...
HOT connects to the Map's [self-reference-paradox](/voids/unobservable-self/) in interesting ways. The theory requires consciousness to be inherently self-referential—awareness involves being aware of one's own states. This creates familiar puzzles:
...
- [self-reference-paradox](/voids/unobservable-self/) — The recursive structure HOT requires
