...
ai_modified: 2026-03-29 11:57:00+00:00
...
**Objective collapse** (GRW, Penrose–Diósi). New physics—spontaneous localization or gravitational self-energy—causes collapse without observers. The rate scales with system mass, explaining why macroscopic objects behave classically. These proposals are empirically testable through large-molecule interferometry, though no confirmation has been obtained.

**Hidden variables** (de Broglie–Bohm). Particles always have definite positions guided by the wave function. There is no selection event—one branch was always occupied. Decoherence merely ensures the unoccupied branches stop interfering.
...
**History selection** (consistent histories, transactional interpretation). Probabilities are assigned to complete histories rather than instantaneous collapses. In consistent histories, the "set selection problem"—which family of consistent histories describes reality—replaces the measurement problem. In the transactional interpretation, emitter-absorber handshakes across time select individual outcomes.
...
The [Dualism](/tenets/#dualism) tenet holds that consciousness is irreducible to physics. Post-decoherence selection reinforces this: the physical formalism terminates at an improper mixture, and something non-physical actualizes the outcome. The [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) tenet requires the smallest possible non-physical influence on physical outcomes. Selecting among already-decohered alternatives—where the physical dynamics have done all the work of preparing distinguishable options—represents a minimal intervention. The [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet demands that consciousness causally influence the physical world. Post-decoherence selection provides the mechanism: consciousness determines which of the physically prepared alternatives becomes actual.
...
Among the five families, only consciousness-mediated collapse is compatible with all five tenets. Objective collapse (GRW, Penrose–Diósi) eliminates the role for consciousness, conflicting with Bidirectional Interaction. Hidden variables (Bohm) are fully deterministic, leaving no indeterminacy for consciousness to exploit. Many worlds is explicitly ruled out. History selection frameworks are physically self-contained—though the set selection problem in consistent histories represents an intriguing secondary opening for consciousness.
