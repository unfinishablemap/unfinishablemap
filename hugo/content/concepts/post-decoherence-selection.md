...
Among the five families, only consciousness-mediated selection is compatible with all five tenets. This compatibility claim is a consistency check against commitments the Map has already made—the tenets are built around consciousness-mediated outcome selection—not independent evidence that this family is correct. It shows the Map's position is internally coherent and rules out the rivals *given* the tenets; it does not, on its own, establish the tenets. The comparative case is systematic: objective collapse (GRW, Penrose–Diósi, CSL) eliminates consciousness from the selection process entirely, conflicting with both Dualism's insistence on irreducibility and Bidirectional Interaction's demand for causal efficacy. Hidden variables (Bohm) are fully deterministic—initial conditions fix all outcomes, leaving no indeterminacy for consciousness to exploit and no gap for Minimal Quantum Interaction to occupy. Many worlds is explicitly ruled out by the No Many Worlds tenet. History selection frameworks are physically self-contained: consistent histories dissolves selection into probability assignments over history sets, while the transactional interpretation's handshakes occur between physical emitters and absorbers without requiring a non-physical selector. The set selection problem in consistent histories sits at a different locus—framework selection, not outcome selection—so it should not be read as a second place where the Map's outcome-selecting consciousness operates; conflating the two loci is exactly the slippage the glossary above guards against. The framework's architects (Griffiths, Gell-Mann, Hartle) in any case treat set choice as descriptive rather than a gap awaiting a selector, so the Map does not lean on it.
