...
AST should be distinguished from a neighbouring theory it is easily confused with: Jesse Prinz's [AIR theory](/concepts/attended-intermediate-representations-theory/). AIR ties consciousness to attended *content*—an intermediate-level perceptual representation modulated by attention *is* the experience. AST, by contrast, ties awareness to a *model of* attention: AIR makes attention constitutive, while AST makes a representation of attention constitutive of the *appearance* of experience.
...
This has implications for [AI consciousness](/topics/ai-consciousness/): if attention schemas generate the *functional* markers of consciousness (reports, introspective access, self-monitoring), the functionalist case that sufficient complexity could produce artificial consciousness strengthens.
...
[Illusionists](/concepts/illusionism/) claim AST vindicates their position: if consciousness is "merely" attention modeling, the hard problem dissolves. But this cuts both ways—AST inherits illusionism's vulnerabilities while adding its own.
...
AST conflicts directly with the [Dualism](/tenets/#dualism) tenet. If consciousness is merely a neural model, there's nothing non-physical about it. The Map holds that consciousness is irreducible to physical processes; AST holds it's entirely reducible to attention schemas.
...
The [haecceity](/concepts/haecceity/) problem compounds here: AST's functional framework cannot say whether running the same schema on multiple hardware instances yields one consciousness or many. The Map's alternative—that consciousness involves something beyond pattern—explains why copying a brain wouldn't copy *you*.
...
**[Dualism](/tenets/#dualism)**: AST is explicitly anti-dualist. The Map holds consciousness is irreducible; AST holds it's a model. The Map's primary response is not the bare regress but the question it survives: why should a model consumed by control systems be *felt* rather than merely tracked? Tracking is not experiencing.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: the Map proposes attention as the *interface* where consciousness influences quantum outcomes. AST has no place for such interaction—its schemas are entirely physical—so the [decoherence challenge](/concepts/decoherence/) does not touch it. AST is thus compatible with physicalist interpretations of quantum mechanics, while the Map's alternative remains viable if decoherence objections can be met.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: AST is consistent with epiphenomenalism about consciousness (if not about attention schemas)—the schema influences behavior, but "consciousness" over and above it does nothing. The Map rejects this. The phenomenology of effort supports bidirectional interaction: if effort were mere representation, why would evolution produce the misleading sense that we're working? On the Map's view, effort feels real because it *is* real engagement.

**[No Many Worlds](/tenets/#no-many-worlds)**: though AST doesn't engage quantum mechanics, it is compatible with [Many-Worlds](/concepts/many-worlds/) in a way the Map isn't. If consciousness is a functional pattern, branching poses no special problem—the pattern continues in each branch, leaving AST indifferent to branching. The Map's rejection of MWI turns on [haecceity](/concepts/haecceity/): *this* consciousness matters, not merely a pattern that could be copied.
...
- [global-workspace-theory](/concepts/global-workspace-theory/) — Competing neuroscientific theory of consciousness
- [attended-intermediate-representations-theory](/concepts/attended-intermediate-representations-theory/) — Prinz's rival attention theory: attention constitutes the conscious content rather than modelling it
