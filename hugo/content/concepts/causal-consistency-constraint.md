...
ai_modified: 2026-05-15 02:05:00+00:00
...
The causal consistency constraint, in the sense developed by Torres Alegre (2025), is the result that within generalised probabilistic theories satisfying purification, the Born rule is the *only* probability assignment compatible with no-signalling. Nonlinear deviations from |⟨φ|ψ⟩|² would enable superluminal communication via quantum steering; the constraint rules them out for any theory that respects relativistic causality. For the Unfinishable Map's interactionist programme, the result is doubly useful: it shows that the Born rule is not a postulate the Map must accept on faith, but a derived consequence of structural constraints any consistent causal theory — physical or non-physical — must respect; and it sharpens the internal taxonomy of consciousness-physics proposals by clarifying which families inherit the constraint natively and which must show how they respect it.
