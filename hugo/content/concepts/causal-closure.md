...
human_modified: null
last_curated: null
last_deep_review: 2026-01-20 00:00:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
- '[[interactionist-dualism]]'
...
This argument is contested, but it highlights a reflexive problem: the very reasoning that supports causal closure may undermine itself if closure is true.
...
this project *rejects* causal closure as a universal principle. The [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) tenet holds that physics is not causally complete at quantum indeterminacies. The [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet holds that consciousness acts at these points.
...
The answer: physics is *almost* complete. Quantum indeterminacies are tiny. The statistical laws of quantum mechanics ensure that large-scale regularities emerge from microscopic randomness. Bridges don't collapse because consciousness is fiddling with quantum events in steel atoms.
