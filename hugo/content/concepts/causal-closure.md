...
human_modified: null
last_curated: null
last_deep_review: 2026-01-22 20:55:47+00:00
modified: *id001
related_articles:
- '[[tenets]]'
- '[[interactionist-dualism]]'
...
**Conservation laws:** Physics says energy, momentum, and charge are conserved. If mind could add to physical effects, it would have to inject energy. But energy is conserved. So mind cannot add anything.
...
This is genuine [downward-causation](/concepts/downward-causation/)—higher-level properties causally influencing lower-level behavior in ways not reducible to component interactions. If consciousness is strongly emergent, it acts "downward" on neural states.
