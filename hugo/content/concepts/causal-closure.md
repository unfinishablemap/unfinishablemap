...
ai_modified: 2026-09-25 13:46:10+00:00
...
description: 'Causal closure claims every physical event has sufficient physical cause.
  The Map rejects this: quantum indeterminacy leaves room for consciousness to act.'
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-07-20 03:24:48+00:00
lastmod: 2026-09-25 13:46:10+00:00
modified: *id001
related_articles:
- '[[tenets]]'
- '[[interactionist-dualism]]'
...
The thesis admits several formulations of varying strength:

**Strong version (Kim):** No physical event has a cause outside the physical domain. Physical causes are not just sufficient but *exclusive*.

**Moderate version:** Every physical effect that has a sufficient cause has a sufficient *physical* cause. Weaker forms allow that physical events might also have non-physical causes—they just require that physical causes are always available.

**Completeness version (Montero):** Every physical event has a physical cause. This doesn't exclude other causes but ensures the physical story is always self-contained.

The differences matter. Strong closure rules out mental causation directly; moderate versions create overdetermination problems (two sufficient causes for one effect); completeness alone might allow room for consciousness to act.

As Karl Popper noted, causal closure "is of decisive importance and I take it as the characteristic principle of physicalism or materialism." Accept it, and interactionist dualism becomes impossible.
...
These considerations are powerful but not decisive.
...
**Universal closure**: Every physical event has a sufficient physical cause. No exceptions anywhere. This is the metaphysical thesis that [interactionist-dualism](/concepts/interactionist-dualism/) denies.

**Observational closure**: There are no *observable* violations of closure—no violations detectable by experiment. This is the empirical regularity that science has established.
...
This argument appears in formal premise-conclusion form in the [argument for interactionist dualism](/concepts/interactionist-dualism/). The [connection between the measurement problem and the hard problem](/topics/quantum-measurement-and-consciousness/) develops it further: both share a structure where third-person descriptions fail to capture first-person facts.
...
- [reflexive-methodology](/concepts/reflexive-methodology/) — The Map's method: the closure argument judged by its own demand for a non-circular formulation
...
- [completeness-in-physics-under-dualism](/topics/completeness-in-physics-under-dualism/) — The reversal: structural completeness supports dualism rather than undermining it
- [the-reverse-inference](/topics/the-reverse-inference/) — The epistemic asymmetry: consciousness is a more secure datum than quantum interpretation, so it should constrain physics
...
1. Maier, M. A., Dechamps, M. C., & Pflitsch, M. (2018). "Intentional Observer Effects on Quantum Randomness: A Bayesian Analysis Reveals Evidence Against Micro-Psychokinesis." *Frontiers in Psychology*, 9, 379. https://doi.org/10.3389/fpsyg.2018.00379
