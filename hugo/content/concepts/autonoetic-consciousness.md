...
description: Autonoetic consciousness—self-knowing awareness enabling mental time
  travel—raises the hard problem in miniature. The debate over its irreducibility
  illuminates dualist commitments.
draft: false
human_modified: null
last_curated: null
...
Autonoetic consciousness is the self-knowing awareness that enables mental time travel—the felt sense of re-experiencing past events and projecting oneself into imagined futures. Introduced by Endel Tulving in 1985 as the highest level of his [anoetic-noetic-autonoetic hierarchy](/concepts/anoetic-noetic-autonoetic-consciousness/), the concept has become a focal point in philosophy of memory. The central philosophical question is whether autonoetic awareness is *constitutive* of [episodic memory](/concepts/episodic-memory/)—its defining phenomenological feature—or merely a contingent accompaniment of retrieval. This debate is the [hard problem](/topics/hard-problem-of-consciousness/) in miniature: it asks whether the felt quality of re-experiencing can be explained away functionally, or whether it points to something irreducible about consciousness.

## The Constitutive-Contingent Debate

### Autonoesis as Constitutive

The orthodox position, defended by Tulving and developed by Stanley Klein, holds that autonoetic consciousness is not merely correlated with episodic memory but *defines* it. Strip away the felt sense of re-experiencing, and what remains is factual knowledge about the past—semantic memory wearing a biographical costume. As Tulving put it, autonoetic consciousness is "the unique ability to not only know that an event happened, but also to mentally travel back in time to re-experience that event in one's mind" (Tulving, 1985).

Klein (2016) sharpened the argument by separating *content* from *manner of experiencing*. The same propositional information ("I visited Rome in 2019") can be accompanied by autonoetic re-experiencing or by bare noetic recognition. The phenomenal difference between these modes does not reduce to an informational difference. Klein argues that the autonoetic component—not episodic memory content—is "the causally determinative factor" enabling future self-projection and planning.

This constitutive view has direct implications for The Unfinishable Map's commitments. If autonoesis is constitutive, then any functional duplicate of episodic memory that lacks the felt quality of re-experiencing is not episodic memory at all. The phenomenology is not an optional add-on; it is the thing itself.

### Autonoesis as Contingent
...
Sant'Anna, Michaelian, and Andonovski (2024) mapped the philosophical landscape by identifying three frameworks for understanding what autonoesis *is*:

**Representational accounts** ground autonoesis in the nature of episodic memory representations themselves. On this view, what makes a memory autonoetic is something about its representational content or format—perhaps a self-referential temporal index built into the representation. These accounts explain the *immediacy* of autonoetic experience (why it feels direct rather than inferred) but struggle to explain its *source* (why these particular representations generate felt re-experiencing while others do not).

**Metacognitive accounts** explain autonoesis through monitoring processes during retrieval. Dokic's (2014) "episodic feeling of knowing"—the sense that a memory originates in one's own experience—exemplifies this approach. These accounts explain the *source* of autonoetic experience (it arises from metacognitive assessment) but may miss its *immediacy* (re-experiencing feels intrinsic to the memory, not like a judgement layered on top).

**Epistemic accounts** treat episodic memory as a retained epistemic state—a persisting relation to a past event. Autonoesis, on this view, is the felt character of that epistemic relation. Like representational accounts, epistemic frameworks capture immediacy but leave the source of phenomenal character unexplained.

The incompleteness of each framework is philosophically telling. No purely functional or representational approach fully captures what autonoetic experience *is like*. The immediacy-source tension—where each framework explains one dimension but fails on the other—mirrors the broader [explanatory-gap](/concepts/explanatory-gap/) between functional description and [phenomenal character](/concepts/phenomenal-consciousness/).
...
## Autonoesis and the Hard Problem

The autonoesis debate is a case study in the hard problem of consciousness. Consider what each side must explain:
...
- [anoetic-noetic-autonoetic-consciousness](/concepts/anoetic-noetic-autonoetic-consciousness/) — Tulving's full tripartite hierarchy, including clinical dissociations and the semanticisation problem
