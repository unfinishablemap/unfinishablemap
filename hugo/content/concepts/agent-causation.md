...
ai_modified: 2026-05-25 13:06:51+00:00
...
This article deploys a substance-leaning reading of dualism, and the scope of that commitment deserves marking before the argument begins. The [Dualism tenet](/tenets/#dualism) is neutral between [substance and property dualism](/concepts/substance-property-dualism/)—it requires only that consciousness is irreducible to physical processes. The substance-leaning reading enters at the agent-causal level, not the tenet level: agent causation needs a persisting subject that exercises causal powers in its own right, and a property-only reading on which mental properties supervene without a substance-bearing subject struggles to ground that exercise. The commitment is downstream of the further claim that agents are irreducible causal sources, made here and across the agency cluster ([free-will](/topics/free-will/), [interactionist-dualism](/concepts/interactionist-dualism/), [moral-implications-of-genuine-agency](/topics/moral-implications-of-genuine-agency/)); the [tenets page's agency-cluster paragraph](/tenets/#dualism) registers the same scoping so it is not silently inherited from the tenet. Articles outside the cluster—the [binding problem](/topics/the-binding-problem/), the [qualia arguments](/concepts/knowledge-argument/), much of the [voids catalogue](/apex/taxonomy-of-voids/)—neither require nor exclude the substance-bearing reading; irreducibility alone does the work there. Readers who accept the Dualism tenet but reject substance-bearing agents would find the *agent-as-source* claim contestable, and that contestation belongs at the agent-causal layer, not the tenet.
...
Kane emphasizes *sourcehood*: the agent must be the ultimate source, not merely a link. Agent causation provides this directly. The Map satisfies both free-will conditions: **sourcehood** (consciousness selects which quantum outcome becomes actual) and **alternative possibilities** (multiple outcomes were genuinely possible until selection). The second condition is where the [No Many Worlds](/tenets/#no-many-worlds) tenet does identity work rather than merely quantum-interpretation work: alternative possibilities are genuine only if the unchosen ones genuinely did not happen. A branching ontology grants the agent a branch-local history of having chosen but distributes every rejected option to a counterpart in a parallel branch, so authorship dissolves into counterparts none of whom did anything the others failed to do. Sourcehood needs the counterfactual exclusion branching withholds—which is why No-MWI here is a tenet about personhood and responsibility, connected across the agency, death, selection, and personal-identity clusters.
...
Agent causation faces a structural limit any account of mental causation inherits: consciousness cannot verify its own causal efficacy from inside. Every check is performed by the faculty under investigation. If consciousness is causally inert, the evidence-gathering is done *for* it by physical processes it merely observes; if it *is* causal, the evidence is produced by the very faculty whose causal status is in question. There is no external reference point against which to certify the result. The [agency-void](/voids/agency-void/) develops the symmetry: [epiphenomenalism](/concepts/epiphenomenalism/) cannot verify itself either, since on that view the belief "consciousness is causally inert" was not caused by consciousness. Both positions hit first-person verification failure for structural reasons, which suggests the failure inheres in the question's architecture rather than in particular arguments. [free-will](/topics/free-will/) flags the same limit—interactionism faces a structurally parallel circularity—and the [consciousness-and-agency apex](/apex/consciousness-and-agency/) frames it as the discipline the framework must keep: its strength lies not in first-person certainty but in its capacity to unify independently grounded claims into a coherent account of authorship.
...
- **The [argument-from-reason](/topics/argument-from-reason/).** Rational inference requires tracking normative relationships, which physical causation alone cannot instantiate. The self-defeat of physicalism delivers mental causation without phenomenological premises and without any specific physics—a route that survives even if the quantum mechanism is wrong.
- **Clinical neuroplasticity.** Meta-analyses show CBT and pharmacological interventions achieve comparable outcomes through *different neural pathways*—top-down cortical-to-limbic versus bottom-up neurochemical. Pathway divergence is what mental causation predicts and what pure redescription cannot easily explain ([clinical-neuroplasticity-evidence-for-bidirectional-causation](/topics/clinical-neuroplasticity-evidence-for-bidirectional-causation/)).
- **Cross-cultural convergence.** Indian (Nyāya), African (Akan), and Western traditions independently arrived at substance-causal accounts of persons, providing evidential weight that agent-causal thinking is not a parochial Western ontology ([cross-cultural-convergence-on-mental-causation](/concepts/cross-cultural-convergence-on-mental-causation/)).
...
- **[Many-worlds](/concepts/many-worlds/), if the indexical objection failed**: It is tempting to state this falsifier as "if MWI were confirmed there would be no collapse for the agent to influence," but that rests the case in the wrong register. An Everettian can supply a branch-local restatement of agent causation's data: within a decohered branch there is a determinate macroscopic past, an agent who exercised causal power among options, and a remembered history of having chosen. The phenomenology of authorship is reproduced inside each branch, not refuted by it. What branching cannot supply is the *counterfactual exclusion* agency requires—a fact of the matter that *this* subject actualised *this* outcome and not the alternatives, since every option the agent "rejects" is taken by a counterpart in a parallel branch with equal claim to being the source. Agent causation would therefore be challenged not by MWI passing an empirical test but by the indexical objection failing: by a demonstration that authorship can be grounded without a fact of the matter that the unchosen alternatives genuinely did not happen. This is the identity-side, not the quantum-foundational, register of the [No Many Worlds](/tenets/#no-many-worlds) tenet (see the MWI checklist in [the evidential-status discipline](/project/evidential-status-discipline/)).
...
The [Dualism](/tenets/#dualism) tenet is essential—agent causation requires the agent to be ontologically distinct from physical events, or it collapses into event causation—but the tenet does not select between substance and property dualism. As the opening scope note records, the substance-leaning is a commitment of this article's agent-causal framework rather than of the tenet, and a property dualist who accepted the tenet could reject the agent-causal reading without contradiction.

The [No Many Worlds](/tenets/#no-many-worlds) tenet does identity work for agent causation, not merely quantum-interpretation work. A branching ontology can restate the deliberative data—a branch-local agent who exercises causal power and remembers choosing—without difficulty; what it cannot supply is the counterfactual exclusion sourcehood requires, since every rejected option is actualised by a counterpart elsewhere. The rejection of MWI therefore rests on this indexical-identity argument rather than on the weaker claim that selection "requires real collapse," and it ties agent causation to the broader personhood-and-responsibility role No-MWI plays across the death, selection, and personal-identity clusters. See [free-will](/topics/free-will/) and [moral-responsibility](/concepts/moral-responsibility/) for the parallel statements, and the [cumulative case against MWI](/arguments/many-worlds-argument/) for the full treatment.
...
- [clinical-neuroplasticity-evidence-for-bidirectional-causation](/topics/clinical-neuroplasticity-evidence-for-bidirectional-causation/) — Pathway divergence as evidence for mental causation
