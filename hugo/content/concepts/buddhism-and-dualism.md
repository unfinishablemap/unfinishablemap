...
Not all interpreters will accept this compatibility. Some Buddhist philosophers extend the no-self analysis to consciousness itself—arguing that *vijñāna* is as empty of inherent existence as the self it supposedly constitutes. The [emptiness challenge](//#emptiness-challenge) (addressed below) takes this objection seriously. The compatibility thesis offered here represents one coherent reading, not the only Buddhist position. For a detailed treatment of how Buddhist no-self relates to the Map's commitment to [indexical identity](/concepts/haecceity/), see [The Eastern Philosophy–Haecceity Tension](/archive/topics/eastern-philosophy-haecceity-tension/).
...
**the Map does not require a unified self**: The tenet is compatible with consciousness being fragmented, multiple, or constantly reconstructed. [phenomenal-unity](/concepts/phenomenal-unity/) is addressed separately.
