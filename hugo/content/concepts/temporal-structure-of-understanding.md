...
The Unfinishable Map proposes that the temporal structure of understanding provides evidence for [cognitive-phenomenology](/concepts/cognitive-phenomenology/)—the view that thinking itself has irreducible phenomenal character. The phenomenology of understanding is inherently temporal: we experience understanding *happening*, unfolding across the [specious present](/concepts/specious-present/) in ways that mere information processing cannot capture.
...
Understanding requires holding elements together across time. The [specious present](/concepts/specious-present/)—the 100-750ms window within which we experience succession as unified—provides the temporal workspace for binding.
...
- [specious-present](/concepts/specious-present/) — The temporal window within which binding occurs
...
- [consciousness-and-semantic-understanding](/topics/consciousness-and-semantic-understanding/) — Related argument that meaning is constitutively phenomenal
