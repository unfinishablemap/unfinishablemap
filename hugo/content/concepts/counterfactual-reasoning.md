...
A review by Van Hoeck, Watson, and Barbey (2015) characterises counterfactual thinking as depending on an integrative network of systems for affective processing, mental simulation, and cognitive control, organised across activation, inference, and adaptation stages. The activation stage concerns whether a counterfactual thought is generated and entertained at all—a gating function that, in the conscious case, determines whether the alternative is held in awareness for explicit comparison against the actual situation. This dual-representation demand suggests counterfactual reasoning is explicitly conscious rather than merely accessible to consciousness.

### Working Memory Demands

Counterfactual reasoning places substantial demands on [working memory](/concepts/working-memory/). You must simultaneously hold:
- The actual situation
- The counterfactual premise (what's being imagined different)
...
## Counterfactual Reasoning and Learning
...
The problem: if counterfactual content is generated unconsciously, what explains its phenomenology? Why does imagining a scenario feel like something? The illusionist must either deny the phenomenology (eliminativism) or explain how unconscious processes generate it—which reinstates the original puzzle at a higher level.

Moreover, the baseline cognition evidence presents a pattern problem. If counterfactual reasoning were really unconscious pattern matching, great apes should show it—they excel at pattern recognition. Their systematic limitation precisely where counterfactual reasoning would be required suggests something more than pattern matching is involved.
...
- [prospective-memory](/concepts/prospective-memory/) — Future-directed thinking and planning
- [mental-imagery](/concepts/mental-imagery/) — The representational medium for counterfactual scenarios
...
1. Van Hoeck, N., Watson, P.D., & Barbey, A.K. (2015). Cognitive neuroscience of human counterfactual reasoning. *Frontiers in Human Neuroscience*, 9, 420.