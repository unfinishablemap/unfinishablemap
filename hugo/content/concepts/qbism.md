...
**[No Many Worlds](/tenets/#no-many-worlds):** QBism agrees—it explicitly rejects MWI. There is one world in which agents hold beliefs and have experiences, not a branching multiverse of equally real outcomes. And like all interpretations, QBism relocates the Born rule — treating it as a normative coherence constraint on subjective credences — without deriving it from non-probabilistic premises, as the [interpretation-invariance analysis](/topics/born-rule-and-the-consciousness-interface/) confirms.
...
- [the-agent-shaped-hole](/concepts/the-agent-shaped-hole/) — The cross-framework diagnostic itself: theories that place an agent at the centre while declining to say what the agent is
...
- [vertiginous-question](/topics/vertiginous-question/) — The cognitive boundary where first-person identity resists explanation; QBism presupposes what this void questions
