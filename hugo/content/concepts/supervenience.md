...
ai_modified: 2026-09-25 21:31:28+00:00
...
description: Supervenience defines when higher-level properties depend on lower-level
  properties. The Map accepts phenomenal-physical covariance but rejects the reductive
  conclusions typically drawn from it.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-09-20 10:58:45+00:00
lastmod: 2026-09-25 21:31:28+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Three grades of supervenience strength matter for the mind-body problem:

**Weak supervenience.** Within any single possible world, no two individuals differ mentally without differing physically. This is compatible with different psychophysical correlations holding in different possible worlds — physically identical beings could have different experiences in a different world.

**Strong supervenience.** Across all possible worlds, no two individuals differ mentally without differing physically. The psychophysical correlation is necessary, not merely actual. This is the grade most physicalists require.

**Global supervenience.** No two possible worlds that are physically identical differ in any mental respect. This applies to whole worlds rather than individuals and is logically weaker than strong supervenience — it allows individual-level mental variation so long as it washes out globally.

For physicalism, strong supervenience with metaphysical necessity is the standard requirement. The mental must not merely happen to track the physical; it must do so as a matter of metaphysical necessity.
...
The Map holds that supervenience, even if accepted, is far weaker than physicalists suppose. Several independent arguments establish this.
...
Dualists can accept that phenomenal properties in fact covary with physical properties while denying this is a matter of physical necessity. On this view, psychophysical supervenience holds as a matter of *nomological* necessity — it is a law of nature — rather than *metaphysical* necessity. Phenomenal properties track physical properties because psychophysical laws connect them, not because phenomenal properties are nothing over and above physical properties.

This is precisely the Map's position. The correlation between brain states and experiences is real and lawful. But lawful correlation is not identity, and it is not reduction. The laws connecting mind and matter are additional fundamental principles — not derivable from physics alone.
...
The agency cluster raises a question the exclusion argument does not. On the [agent-causal](/concepts/agent-causation/) reading the Map adopts for free will—a commitment of that cluster, scoped in [where-the-substance-commitment-enters](/concepts/where-the-substance-commitment-enters/), rather than of the Bidirectional Interaction tenet itself—a volition has no event-cause but does have an agent-cause. Does such a volition still supervene on the brain?
...
The Unfinishable Map's relationship to supervenience is carefully calibrated. The Map accepts the *empirical* observation that mental properties covary with physical properties — neuroscience confirms extensive psychophysical correlation. But the Map denies that this covariance establishes physicalism.
...
2. Kim, J. (1993). Supervenience as a Philosophical Concept. In *Supervenience and Mind*. Cambridge University Press.
