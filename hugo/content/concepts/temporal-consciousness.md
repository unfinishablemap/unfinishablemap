...
For the project's framework, prospective memory strengthens the case for [Bidirectional Interaction](/tenets/#bidirectional-interaction). Research shows that vividly imagining future consequences reduces temporal discounting and improves goal-directed behaviour—conscious simulation of possible futures causally shapes present decisions. If mental representations of futures alter behavioural trajectories, consciousness participates in directing action rather than merely witnessing it.
...
A deeper question lurks behind the phenomenology: why does time flow at all? the project's [analysis of collapse and the arrow of time](/concepts/collapse-and-time/) suggests consciousness may be implicated not just in experiencing temporal flow but in constituting it.
...
- [philosophy-of-time](/concepts/philosophy-of-time/) — McTaggart's A/B series, presentism, eternalism, and the project's growing block position
