...
The articulability of Q1 is the sharpest unresolved problem the Map's dualism-positioning cluster shares: **can a non-stipulative authority-selecting psychophysical law actually be specified?** Q1 — the minimal-mind / minimal-physical quadrant of the [thickness taxonomy](/topics/four-quadrant-dualism-taxonomy/), where the Map's own default reading sits — buys its cheapness by leaving the physical base counterfactually sufficient and the mental side thin. The price is a single debt: an account of what makes a *mental* rule the authoritative cause of an effect a *physical* state would have produced anyway. The [trumping](/concepts/trumping-preemption/) template shows the *shape* such a law would have; Bradford Saad's [delegatory dualism](/topics/delegatory-dualism/) is the current best candidate for its *content*. Neither has discharged the debt: the law has not been written down in a form that survives the objection it is built to answer, and whether one *can be* is open. This article consolidates that open problem as an object of study — its formal structure, the non-stipulativity criterion, the fiction-to-nature gap blocking the obvious candidates, the leading proposal, and what progress would look like. It does not claim the problem is solved; the point is to state precisely what remains unpaid.
...
Reading Saad's framework as closing the gap would overstate what it delivers; reading the gap's persistence as a *refutation* of Saad, or of Q1 dualism generally, would equally overstate. An unpaid bill is a cost, not a disproof — the [cost-overlay reading](/topics/mechanism-costs-dualism-thickness-quadrants/) is explicit that a debt a cell owes is "the price of the Map's own location," not evidence against it.

## Articulability versus Formalizability

The articulability problem is adjacent to but distinct from the [interface formalization void](/voids/interface-formalization-void/), and keeping them separate matters because they can come apart.

The formalization void asks: can the consciousness–physics interface be captured in *mathematics*? Its obstacle is that mathematics describes structure while the interface (on the Map's [Dualism](/tenets/#dualism)) is where structure meets non-structural actuality — so any formalism produces more structure and falls silent at the actualisation event.
...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)** sets the difficulty's exact shape. Committing to the *smallest* non-physical influence, the Map cannot pay the authority debt by inflating either pole — the obvious closure moves are precisely what MQI forecloses. It is therefore committed to the *hardest* version of the problem: a non-stipulative authority law that keeps both axes minimal. The Map [does not claim to have met that commitment](/project/evidential-status-discipline/); it registers it as the central outstanding bill of its preferred [Q1 region](/topics/four-quadrant-dualism-taxonomy/).
...
- [four-quadrant-dualism-taxonomy](/topics/four-quadrant-dualism-taxonomy/) — Where Q1 sits, and why its articulability is the taxonomy's sharpest open question
- [trumping-preemption](/concepts/trumping-preemption/) — The authority-without-sufficiency template the law would instantiate, and the fiction-to-nature gap it inherits
- [delegatory-causation](/concepts/delegatory-causation/) — Saad's two laws: the candidate's selection relation, specified in detail
- [delegatory-dualism](/topics/delegatory-dualism/) — Saad's full theory, the current best candidate for the law's content
- [interface-formalization-void](/voids/interface-formalization-void/) — The adjacent and deeper question of whether the interface can be captured in mathematics at all
- [the-interface-problem](/topics/the-interface-problem/) — The interface's location-and-specification frontier, source of the "pre-Keplerian" calibration borrowed here
- [psychophysical-laws](/concepts/psychophysical-laws/) — The kind of fundamental regularity a non-stipulative authority law would have to be
- [dualism-cartography](/apex/dualism-cartography/) — The cluster's atlas, which marks this problem as the territory's shared frontier
