...
The dissociation between intention (parietal) and execution (premotor) supports the site's [Dualism](/tenets/#dualism) tenet. If consciousness were identical to neural processing, there would be no principled distinction between experiencing intention and executing movement—both would be "just neurons." The double dissociation suggests something contributes to intention that is not identical to motor execution machinery.
