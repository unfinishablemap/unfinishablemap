...
Four families of coupling laws emerge, operating through different [coupling-modes](/concepts/coupling-modes/)—basis control, timing control, or probability control. These are variable-focused trajectory-altering laws; the structurally orthogonal authority-selecting alternative is developed in [delegatory-causation](/concepts/delegatory-causation/) via [trumping](/concepts/trumping-preemption/).
