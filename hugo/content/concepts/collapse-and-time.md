...
A third approach preserves fundamental [time-symmetry](/concepts/time-symmetric-physics/). Aharonov's Two-State Vector Formalism (TSVF), Cramer's transactional interpretation, and related frameworks describe quantum systems with boundary conditions at both past and future. Complete specification of a quantum state requires both a forward-evolving and backward-evolving wave.
