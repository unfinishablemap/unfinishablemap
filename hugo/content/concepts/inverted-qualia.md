...
Inverted qualia and [philosophical-zombies](/concepts/philosophical-zombies/) are structurally similar anti-physicalist arguments:
...
[Illusionism](/concepts/illusionism/) represents the most radical response to inverted qualia arguments. If qualia don't exist—if what seems like irreducible qualitative character is merely a representational artifact—then inverted qualia scenarios are incoherent. There's nothing to invert.

Keith Frankish argues that [introspection](/concepts/introspection/) systematically misrepresents our internal states. What feels like "phenomenal redness" is actually a higher-order representation that *seems* to have intrinsic qualitative character without actually having it. The apparent conceivability of spectrum inversion reflects this misrepresentation, not a genuine metaphysical possibility.
...
The inverted qualia argument provides crucial support for multiple [foundational commitments](/tenets/) of this project.

### Dualism

The inverted qualia argument directly supports the project's commitment to [dualism](/tenets/#dualism). If functionally identical beings can differ in phenomenal character, then phenomenal properties aren't constituted by physical-functional facts. Something beyond physics determines qualia.
...
The argument connects to [Occam's Razor Has Limits](/tenets/#occams-limits). The conceivability of spectrum inversion has persisted despite sophisticated functionalist theories. This persistence suggests the explanatory gap is not merely apparent but reflects something deep about consciousness's nature.
...
- [haecceity](/concepts/haecceity/) — The "thisness" of individual experience
- [decoherence](/concepts/decoherence/) — Why quantum mechanics doesn't eliminate the role for consciousness
- [epiphenomenalism](/arguments/epiphenomenalism/) — The view that qualia are causally inert
