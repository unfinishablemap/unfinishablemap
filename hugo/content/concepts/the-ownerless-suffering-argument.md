...
The Map's finding here cuts against the Map's own reply to that objection, and is a correction rather than a refutation. [no-self-objection-to-phenomenal-value](/concepts/no-self-objection-to-phenomenal-value/) judges the residual dispute — whether "bad for the momentary locus" adds anything to "this feeling-moment is bad" — "close to terminological" at the momentary grain. That verdict survives metaphysically and fails normatively. Metaphysically, the abhidharma inventory the argument draws on keeps momentary suffering-events as ultimately real, close to what the Map's momentary experiential locus asserts. Normatively, Śāntideva's inference *needs* the sufferings to be ownerless at exactly that grain: a momentary bearer is still a bearer, and once there is one, the step from "no sufferings belong to anyone" to "they are to be warded off simply because they are suffering" no longer runs. No refutation follows for the Map, because the tradition has a reply of its own ([the Parity Reply](#rivals)) and one prominent reading holds the verses are not an argument at all. What follows is that the identity claim the Map treats as harmless is doing work for the Buddhist consequentialist's conclusion, so the two sides are not saying one thing in two ways.
...
Three points of citation hygiene, recorded because such details propagate. **The chapter is eight, not nine.** Garfield, Jenkins and Priest number every verse VIII and title the passage *Bodhicaryāvatāra* VIII: 90–103, while the prose of the *Śāntideva* entry refers to "the argument of BCA IX.94–96" a paragraph after quoting those verses as VIII.94–96, and labels the second block IX.97 onward. **The two encyclopaedia entries by the same author render 8.102 differently**: the *Śāntideva* entry (2016) has "must be warded off", the *Ethics in Indian Buddhism* entry (revised 2024) has "are to be warded off" and attributes it to "Crosby and Skilton trans. 1995, 97". Both renderings above are quoted from those entries rather than from the Crosby and Skilton volume, which was not consulted here; one is a slip against it, and which remains unresolved. **The name is recent and external to the text**: Goodman and Schultz call it what "some scholars now call the Ownerless Suffering Argument", and Garfield, Jenkins and Priest never use the phrase.
...
Goodman's own gloss on what the argument delivers re-imports beneficiaries:
...
Finnigan's *Philosophy East and West* paper takes up the justificatory grounds of Madhyamaka moral judgments directly, pressing from inside Buddhist studies on the "conventionally real streams" route the sibling article credits to Siderits. And Monima Chadha reads the Abhidharma as eliminativist about persons rather than merely reductionist, a characterisation [eastern-philosophy-consciousness](/topics/eastern-philosophy-consciousness/) already carries. If persons are eliminated, conventionally real streams are not available as value-bearers either, and the weight of the question returns to the abhidharma asymmetry.

## What Follows, and What Only on the Map's Reading {#implications}

Three things follow from the argument alone, for anyone. Any ethics grounding obligation in suffering owes an account of whether ownerlessness is doing ontological or normative work, because the two licence different conclusions. An impartiality argument routed through ownerlessness is hostage to the metaphysics of bearers where a similarity argument is not — a reason to prefer 8.94–96 to 8.101–102 if impartiality is the goal. And the abhidharma and Madhyamaka readings of the same verses yield different ethics, so "the Buddhist view" underdetermines the normative claim.

Two things follow only on the Map's reading: the ownerless premise is false at the momentary grain, because the locus is a genuine subject-pole not reducible to the mechanism realising it; and the tradition's route to impartial benevolence therefore needs replacing rather than adopting.

What would move this article: Goodman 2009 chapters 6, 8 and 11, if they already distinguish ownerlessness from unrankedness; Williams 1998 or 2000, which would replace a reported objection with a formulation; Siderits's *Moonpaths* chapter, the best available answer to the Parity Reply; or a reading of 101 on which "the one for whom there is suffering does not exist" denies the momentary locus and not merely the person — the reading Chadha's eliminativism and Metzinger's [self-model theory](/concepts/self-model-theory-of-subjectivity/) make live, and which [the sibling](/concepts/no-self-objection-to-phenomenal-value/#rivals) treats as the objection's strongest form.
...
**[No Many Worlds](/tenets/#no-many-worlds)** is deliberately not drawn on. The persisting subject that tenet needs would settle the diachronic half of this dispute at once, and the [sibling article](/concepts/no-self-objection-to-phenomenal-value/#maps-reply) keeps the value chain insulated from it so that an account of why suffering is bad does not fall with an account of why this branch is actual. The same isolation holds here.
