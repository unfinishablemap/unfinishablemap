...
ai_modified: 2026-09-03 01:55:27+00:00
...
description: 'Zurek''s envariance derives the Born rule from entangled-state symmetry.
  The Map''s audit: contested, not refuted—it fixes the measure''s form, never actuality.'
draft: false
human_modified: null
last_curated: null
lastmod: 2026-09-03 01:55:27+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
**[No Many Worlds](/tenets/#no-many-worlds).** Envariance has become the Everettian programme's best probability story—directly, and through Wallace's absorption of it. Barnum's observation that the argument is most compelling under a relative-state reading is the sharpest lever in the literature for the Map's position: a derivation whose persuasiveness peaks inside the interpretation the Map rejects cannot be borrowed as if it were interpretation-free. The Map's rejection of many-worlds is adjudicated elsewhere ([the one-world case](/arguments/many-worlds-argument/), [the probability problem](/topics/probability-problem-in-many-worlds/)); this page records that envariance does not settle that dispute in either direction.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction), and the terms of the Map's borrow.** The Map's [post-decoherence selection programme](/apex/post-decoherence-selection-programme/) uses envariance as part of the answer to "what constrains conscious selection?" The honest form of that borrow, stated here so the corpus's other phrasings can be read against it: envariance fixes the form of the probability measure *given* that outcomes carry probabilities at all—and on the Map's framework, that given is supplied by the actualisation postulate, the posit of genuine single-case openness that [post-decoherence-selection](/concepts/post-decoherence-selection/) adds to unitary quantum mechanics. The Map puts probability in deliberately, as a framework commitment; envariance, together with Gleason's theorem and the causal-consistency result, then forces the |ψ_k|² form. Read this way the borrow is framework-internal and immune to the circularity dispute: the critics' charge is that Zurek assumed what he should have derived, and the Map does not claim the derivation succeeds unaided—it claims the form-fixing theorem, which no critic disputes. Where the corpus says envariance "grounds" the probabilities, it should be read in this form-fixing sense; where it says the derivations "remain contested," it means the noncircularity claim, not the theorem. The outcome gap itself—why any single result obtains—is owned by the [improper-mixtures analysis](/concepts/improper-vs-proper-mixtures/), which covers the state-ontology side of the same post-decoherence territory.

**[Occam's Razor Has Limits](/tenets/#occams-limits).** Envariance is elegant enough that rival programmes keep adopting it, and elegance of exactly this kind is what Tenet 5 warns against treating as truth-tracking. A symmetry argument that fixes a measure's form remains silent on the thing it presupposes—that there are single outcomes for probabilities to be probabilities *of*. Simplicity favours forgetting the presupposition; the Map declines to.

## Further Reading

- [quantum-darwinism-and-consciousness](/topics/quantum-darwinism-and-consciousness/) — the measure/actuality verdict
- [improper-vs-proper-mixtures](/concepts/improper-vs-proper-mixtures/) — the outcome-gap side
- [probability-problem-in-many-worlds](/topics/probability-problem-in-many-worlds/) — envariance among Everettian recovery strategies
- [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/) — the underivability pattern across interpretations
- [post-decoherence-selection-programme](/apex/post-decoherence-selection-programme/) — the apex that borrows the measure
- [causal-consistency-constraint](/concepts/causal-consistency-constraint/) — the no-signalling route to Born form-fixing
- [one-world-wager](/apex/one-world-wager/) — the calibrated adjudication
