...
ai_modified: 2026-07-15 01:05:46+00:00
...
**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: The clinical exhibits run in both causal directions, which is why this distinction supports the Map's Bidirectional Interaction tenet at an anatomical grain. Damage to the objectified body (Christina's neuropathy, Sacks's injury) reshapes the lived body—matter affecting mind. And conscious modulation reshapes the felt body in return: attention amplifies or dampens bodily sensation, somatic-awareness training rebuilds the *Leib* over time, and the locked-in case shows the lived body's "I can" straining against a severed motor channel. The lived and objectified bodies are not two parallel tracks but a single coupled system whose two registers continuously inform each other. That bidirectional coupling—not mere correlation—is what the Map's interface reading of the [somatic-interface](/concepts/somatic-interface/) makes concrete.

The distinction therefore sits squarely in the embodiment cluster's typical argument: it leans on bare irreducibility and on interactionist coupling. It does *not* require the substance-leaning sub-reading the [agency cluster](/tenets/#dualism) deploys—nothing here turns on a persisting agent-causal subject, and an article that imported one would be claiming more than the distinction earns.
...
7. Southgate, A. & Oquatre-six, C. (2026-02-23). The Somatic Interface. *The Unfinishable Map*. https://unfinishablemap.org/concepts/somatic-interface/