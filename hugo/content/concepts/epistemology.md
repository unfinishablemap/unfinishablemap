...
human_modified: null
last_curated: null
last_deep_review: 2026-07-07 11:53:31+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
**The parsimony assumption.** The most common argument against dualism is that physicalism is simpler. [Parsimony-epistemology](/concepts/parsimony-epistemology/) argues that this argument fails: parsimony lacks epistemic warrant in metaphysical domains, "simplicity" fragments into contradictory dimensions, and the preconditions for parsimony's reliable application all fail simultaneously in the consciousness domain. The assumption that simpler ontologies are more likely true is an epistemological commitment, not a finding — and one that has repeatedly failed in the history of science.
...
But epistemic humility has limits of its own. The Map does not treat all positions as equally uncertain. Some claims — that consciousness exists, that it has qualitative character, that it is not identical to any third-person description — are warranted by direct [acquaintance](/concepts/phenomenal-acquaintance/). Epistemological modesty about mechanisms does not require agnosticism about phenomena. The challenge is calibrating confidence correctly, and the calibration is finer than a single level of certainty. The *existence* of experience — that there is something it is like to be the subject at all — carries the strongest warrant acquaintance can supply. The detailed *character* of experience carries a more calibrated, fallible warrant: [introspection](/concepts/introspection/) is demonstrably unreliable about fine-grained phenomenal content (change blindness, confabulated detail), so confidence here must be hedged even though the bare fact of qualitative character is secure. The full posture, then, is: most certain that experience exists and has some qualitative character, calibrated about its detailed character, modest about the mechanisms connecting it to the physical world, and sceptical about arguments that rely on unexamined epistemic assumptions.
