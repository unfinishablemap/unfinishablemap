...
**The parsimony assumption.** The most common argument against dualism is that physicalism is simpler. [Parsimony-epistemology](/concepts/parsimony-epistemology/) demonstrates that this argument fails: parsimony lacks epistemic warrant in metaphysical domains, "simplicity" fragments into contradictory dimensions, and the preconditions for parsimony's reliable application all fail simultaneously in the consciousness domain. The assumption that simpler ontologies are more likely true is an epistemological commitment, not a finding — and one that has repeatedly failed in the history of science.
