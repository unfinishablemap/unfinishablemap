...
description: Advanced social cognition requires consciousness for recursive mindreading
  and shared intentionality. Great apes track behaviour; humans represent minds as
  minds.
draft: false
human_modified: null
last_curated: null
...
[Working-memory](/concepts/working-memory/) research suggests that manipulating information—not just maintaining it—requires conscious access. The nested structure of recursive mindreading demands exactly this: holding representations while actively working with them, comparing them, and computing their relationships.
