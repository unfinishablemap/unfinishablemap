...
The Map's framework emphasizes consciousness as *selector*—choosing among options the brain presents through the [attention interface](/concepts/attention-as-interface/). The witness concept raises a question: if consciousness is fundamentally a selector, how can it also be a passive observer?
