...
description: 'A calibration move developed through human-AI refinement: the content-talk
  in predictive processing and computationalism is empirically indispensable yet metaphysically
  derivative—it summarises the dynamics rather than grounding them.'
draft: false
human_modified: null
last_curated: null
...
Two cautions keep this honest, both following [direct-refutation-discipline](/project/direct-refutation-discipline/) and [evidential-status-discipline](/project/evidential-status-discipline/). First, the move *locates* a boundary rather than *crossing* it: the framework's available reply (aboutness as a further derived feature) is not refuted, so the Map presents the calibration as a sharpening, not a proof of dualism. Second, the inference from "the framework has not paid for phenomenal aboutness" to "dualism is therefore supported here" must respect evidential status—the gap is a *place to look*, a constraint on what a complete account must explain, not by itself a win for the Map's metaphysics. The dualist reading and the framework's all-the-way-up reply remain live alternatives at the framework's current stage; what the move secures is that the debt is real and the vocabulary is borrowing, not that only the Map can settle the account.

## Current Deployments

The move recurs across the corpus, which is why it warrants a shared anchor rather than independent restatement:

- [predictive-processing](/concepts/predictive-processing/) develops the canonical form: predictive processing "describes neural dynamics in content-involving vocabulary that is predictively useful but metaphysically derivative," with phenomenal consciousness supplying the aboutness.
- [biological-computationalism](/concepts/biological-computationalism/) and [biological-computationalisms-inadvertent-case-for-dualism](/topics/biological-computationalisms-inadvertent-case-for-dualism/) press a sibling calibration—that substrate-dependent computationalism's specifications increasingly resemble the dualist's "something more"—where the content-vocabulary move supplies the semantic half: the computational description summarises without grounding the felt content.
- [phantom-limb-phenomena](/topics/phantom-limb-phenomena/) is the worked exhibit, where the felt aboutness of a missing limb is the content the predictive model presupposes rather than produces.
- [the-naturalisation-failure-for-content](/topics/the-naturalisation-failure-for-content/) and [intentionality](/concepts/intentionality/) mark the stronger theses this move stays calibrated *beneath* (general naturalisation failure) and the positive source it points *toward* (phenomenal grounding of original aboutness).

## Further Reading

- [predictive-processing](/concepts/predictive-processing/) — The framework whose content-vocabulary the move calibrates
- [the-naturalisation-failure-for-content](/topics/the-naturalisation-failure-for-content/) — The stronger naturalisation-failure thesis this move stays beneath
- [intentionality](/concepts/intentionality/) — Phenomenal intentionality theory and the source of original aboutness
