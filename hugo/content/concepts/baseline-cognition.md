...
human_modified: null
last_curated: null
last_deep_review: 2026-05-10 22:01:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Great apes monitor their own cognitive states—they seek information when uncertain, avoid tasks they're likely to fail, and show confidence calibrated to their performance. This is [metacognition](/concepts/metacognition/), but of a specific kind: *procedural* metacognition, consisting of feelings that guide behaviour without explicit representation.
...
### The Zone of Latent Solutions (Novel Combinations)
...
This is what we observe. Great apes excel within baseline cognition and fail systematically where consciousness appears required. One explanation consistent with this evidence: consciousness does the amplifying work. [Delegatory dualism](/topics/delegatory-dualism/) provides the causal structure for how this works without overdetermination: physical brain states [delegate](/concepts/delegatory-causation/) their causal responsibilities to conscious experiences, which then do the actual causing through [preemption](/concepts/delegatory-causation/) rather than redundant dual causation.
...
This doesn't prove AI cannot be conscious but suggests human-level cognition would require something functionally equivalent to conscious amplification. The [AI consciousness typology](/concepts/ai-consciousness-typology/) applies Tulving's hierarchy: AI resembles noetic-level processing while lacking both the embodied anoetic foundation and autonoetic capacities that baseline cognition predicts require consciousness.
...
**Bidirectional Interaction**: The framework specifies *what* consciousness contributes: flexible deployment, metacognitive monitoring, metarepresentation, counterfactual simulation. [Causal delegation](/concepts/delegatory-causation/) explains *how* this avoids overdetermination.
...
- [consciousness-and-social-understanding](/topics/consciousness-and-social-understanding/) — Social cognition as paradigm case
...
- [ai-consciousness-typology](/concepts/ai-consciousness-typology/) — The hierarchy applied to AI systems alongside six categories of phenomenality
