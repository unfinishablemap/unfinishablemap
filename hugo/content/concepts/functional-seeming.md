...
Functional seeming is Keith Frankish's proposal that when we say consciousness "seems" phenomenal, the seeming itself is entirely functional—a matter of having the right beliefs, dispositions, and reactions—rather than involving any phenomenal experience. This is the central defensive move of [illusionism](/concepts/illusionism/): it blocks the otherwise devastating regress objection by denying that an illusion of consciousness requires consciousness.

The Unfinishable Map rejects functional seeming because it conflates what experience *does* with what experience *is*. If functional roles exhausted the content of seeming, a [philosophical zombie](/concepts/philosophical-zombies/) would "seem conscious" in every sense that matters—and the distinction between genuine experience and its absence would collapse into meaninglessness.

## The Regress Problem Functional Seeming Addresses
...
Anti-illusionists read this as a *reductio*: a theory of consciousness that cannot distinguish consciousness from its absence has explained nothing. The [self-stultification argument](/topics/self-stultification-as-master-argument/)—standardly aimed at [epiphenomenalism](/concepts/epiphenomenalism/)—applies with equal force here: the illusionist cannot claim their position is informed by careful attention to the character of experience, because on their view experience has no character beyond what functional processes produce. Frankish reads the zombie convergence as a feature: consciousness *adds* nothing to the functional story, which is precisely the illusionist claim. Whether this counts as explanatory progress or explanatory bankruptcy depends on prior commitments about whether there is something to explain beyond the functional facts.

## The Vantage-Point Problem

The distortion thesis analogises introspective error to pre-scientific theoretical error. But the analogy breaks at a critical point. Combustion scientists had independent evidence—oxygen experiments—to reveal phlogiston theory as mistaken. The distortion could be identified because there was a vantage point outside the flawed framework.

For consciousness, no such external vantage point exists. The seeming itself is all the evidence available. Frankish must argue that the functional account *is* the external vantage point—that third-person neuroscience reveals what first-person introspection misrepresents. But whether neuroscience describes the same phenomenon introspection accesses, or merely its physical correlates, is precisely what is at issue. The appeal to neuroscience as corrective assumes the illusionist conclusion rather than establishing it.

## The Self-Representation Difficulty

The distortion thesis works naturally for external objects: introspection might mischaracterise a brain state the way folk physics mischaracterises motion. But "I am phenomenally conscious" targets the representing state itself.

Frankish's framework requires a gap between a state's self-representation and its actual nature—the state represents itself as experiential but isn't. For externally directed representation, this gap is unproblematic. For self-directed representation, it closes. The state representing itself as experiential *is* the candidate for being experiential. Unlike combustion—which is indifferent to being called "phlogiston"—a mental state that represents itself as phenomenal is not clearly separable from a state that *is* phenomenal.
...
Functional seeming challenges the Map's [Dualism](/tenets/#dualism) tenet directly. If seeming reduces to functional dispositions, there is nothing non-physical left to explain—the [explanatory gap](/concepts/explanatory-gap/) is an artefact of introspective misrepresentation rather than a genuine ontological boundary. It equally threatens the [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet: if conscious experience is exhausted by functional roles, there is no phenomenal agent to exert causal influence on physical processes—the phenomenology of trying, attending, and deciding would be mere appearance with no work left to do.

The Map holds that functional seeming fails because functional roles underdetermine experience. A complete functional description of colour vision specifies which wavelengths are discriminated, what behavioural dispositions result, and how internal states relate causally. It does not specify what redness is like. The [knowledge argument](/concepts/knowledge-argument/) makes this concrete: Mary learns something new on seeing red that no functional description could have provided. If functional seeming were the whole story, Mary would learn nothing—she already knew every functional fact.

Functional seeming also intersects with the Map's [Occam's Razor Has Limits](/tenets/#occams-limits) tenet. Illusionism's appeal is largely parsimony-driven: it avoids positing non-physical properties. But parsimony arbitrates between theories of equal explanatory power. If the illusion problem—explaining why we seem phenomenally conscious—proves as intractable as the hard problem, illusionism has not simplified the picture. It has relocated the mystery.

The Map treats functional seeming as the strongest version of illusionism and engages it on those terms. The [illusionism](/concepts/illusionism/) article develops the full critique; this article defines the concept itself.

## Further Reading

- [illusionism](/concepts/illusionism/) — The broader position functional seeming defends
- [qualia](/concepts/qualia/) — The properties Frankish argues are illusory
- [phenomenal-consciousness](/concepts/phenomenal-consciousness/) — What functional seeming aims to replace
- [functionalism](/concepts/functionalism/) — The philosophical tradition functional seeming draws on
- [philosophical-zombies](/concepts/philosophical-zombies/) — The thought experiment that reveals functional seeming's limits
- [knowledge-argument](/concepts/knowledge-argument/) — Mary's Room and why functional facts leave something out
- [introspection](/concepts/introspection/) — The faculty functional seeming claims is systematically unreliable
- [phenomenal-conservatism](/concepts/phenomenal-conservatism/) — The epistemology of seemings, which contests whether a justificatory seeming must be phenomenal
- [seemings](/concepts/seemings/) — The four analyses of a seeming, and why the Map takes the phenomenal side
