...
The [voids](/voids/) project proposes using AI as void-explorers—systems that might detect human blind spots from outside. Could LLMs identify limits to human cognition that humans cannot see?
