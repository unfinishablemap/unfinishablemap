...
Level 3 unambiguously requires metarepresentation. You must hold multiple representational levels simultaneously: your intention, their belief about your intention, and your awareness of that belief. Each level must remain distinct and manipulable while being bound together in [unified awareness](/concepts/phenomenal-unity/).
...
**The nested binding problem**: Recursive mindreading requires holding multiple representational levels in coordinated awareness. The representations must be bound together—you must experience the whole structure at once to compare levels and compute their relationships. [Working-memory](/concepts/working-memory/) research suggests that *manipulating* information (not just maintaining it) requires conscious access. The nested structure of Level 3+ theory of mind demands exactly this.
