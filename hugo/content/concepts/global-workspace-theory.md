...
ai_modified: 2026-09-09 20:38:58+00:00
...
lastmod: 2026-09-09 20:38:58+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
GWT shares territory with several neuroscientific theories. [Higher-Order Theories](/concepts/higher-order-theories/) require a higher-order *representation* of the mental state rather than mere broadcast—GWT says broadcast suffices, HOT says consciousness requires representation *as* one's own mental state. [Predictive processing](/concepts/predictive-processing/) can integrate with GWT (the workspace might broadcast *prediction errors*) but doesn't explain why minimizing surprise feels like anything. [Attention Schema Theory](/concepts/attention-schema-theory/) complements GWT by proposing a mechanism for *which* information enters the workspace, but faces the same hard problem objection (see [the Map's engagement with AST](/topics/attention-and-the-consciousness-interface/)).
...
For the Map, the decisive feature is what the authors decline to claim. They state plainly that "access consciousness is a purely functional notion; the relationship that it has with subjective experience (sometimes called phenomenal consciousness) is widely debated. In this paper, we take no position on this issue, and instead focus on the functional role played by consciously accessible information." J-space is therefore a vivid demonstration that the workspace-like functional signatures of the *access* side of the [access/phenomenal distinction](/concepts/access-consciousness/)—global availability and verbal self-report—can be instantiated computationally without settling the phenomenal question its authors set aside. GWT gains an artificial instance of its central mechanism, and the [hard problem](/topics/hard-problem-of-consciousness/) is left open rather than answered. See [access-consciousness](/concepts/access-consciousness/#distinction) for how this worked example bears on Block's distinction.

The GNW originators draw the opposite conclusion from the same result, in the very commentary this section relies on. Dehaene and Naccache anticipate the objection that "none of this work touches upon phenomenal consciousness" and reject its premise: the hard problem, they argue, will "dissipate once we clarify in sufficient detail the supposedly 'easy problem' of how conscious information is processed," and intuitions about "qualia" and "what it is like," pushed hard, "often disclose a residual crypto-dualism or vitalism." The Map accepts their reading of the architecture and declines the diagnosis: a forecast dissolution is not a result, and the J-space work does not show how a fuller account of access would discharge the phenomenal question—which is why the [absent qualia objection](/concepts/functionalism/) above applies to a system with a complete functional workspace.
...
Global broadcast may also enable [metarepresentation](/concepts/metacognition/)—what Gruber et al. (2015) call the Jourdain Hypothesis. Great apes have culture but may not *know* they have culture; cumulative culture requires treating knowledge *as* knowledge that can be improved. When information achieves workspace ignition, it becomes available to reasoning systems that take representations as their objects, enabling the "thinking about thinking" metarepresentation requires. DeWall et al. (2008) supported this: cognitive load impairs rule-based logical reasoning while leaving pattern recognition intact.
...
|-------------|----------------|---------------|
| [Implicit](/concepts/implicit-memory/) | Bypasses workspace | [Anoetic](/concepts/anoetic-noetic-autonoetic-consciousness/)—unreflective action |
| [Semantic](/concepts/semantic-memory/) | Retrieval to workspace | Noetic—aware of knowing |
| [Episodic](/concepts/episodic-memory/) | Full binding + broadcast | Autonoetic—re-experiencing |
