...
the project's [attention article](/concepts/attention/) notes that attention serves as the "gateway" to the workspace. This connects with Stapp's proposal that attention is where consciousness influences physics through the quantum Zeno effect. GWT provides mainstream neuroscience context for this idea.
...
- [attention-as-interface](/concepts/attention-as-interface/) — Attention as the project's proposed mind-matter interface
