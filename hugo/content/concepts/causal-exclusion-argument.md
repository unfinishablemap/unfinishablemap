...
description: 'Jaegwon Kim''s causal exclusion argument stated canonically: the inconsistent
  set, the compatibilist and interventionist replies, and dualism''s three routes
  out.'
draft: false
human_modified: null
last_curated: null
...
2. **Physical causal closure.** Every physical event that has a cause has a *sufficient* physical cause. The physical domain is causally self-contained; see [causal-closure](/concepts/causal-closure/).
...
**[Bidirectional Interaction](/tenets/#bidirectional-interaction)** (Tenet 3) is what the argument threatens. If Kim is right, consciousness either *is* its physical realizer or does nothing — both incompatible with the Map's claim that consciousness genuinely influences the physical. The dedicated defense lives in [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/).

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)** (Tenet 2) supplies the Map's positive answer to premise 2. The exclusion argument's closure premise is exactly where the Map's minimal-interface proposal bites: closure holds only *probabilistically* at the quantum joint, so mental selection among physically-undetermined outcomes competes with no sufficient physical cause and injects no energy in the degenerate case. The structural version — why selection-only architecture *dissolves* rather than answers the overdetermination premise, and what empirical price that carries — is in [overdetermination-dissolution-under-selection-only-interactionism](/topics/overdetermination-dissolution-under-selection-only-interactionism/).

**[Dualism](/tenets/#dualism)** (Tenet 1) is what makes the argument bite: Kim's non-identity premise just is the dualist's commitment, so the dualist cannot escape via the reductionist horn Kim himself takes.
...
- [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/) — The Map's developed defense of mental causation against exclusion
- [objections-to-interactionism](/concepts/objections-to-interactionism/) — Survey placing exclusion among the objections dualism faces
- [overdetermination-dissolution-under-selection-only-interactionism](/topics/overdetermination-dissolution-under-selection-only-interactionism/) — The Map's deepest move on premise 5
- [causal-closure](/concepts/causal-closure/) — The closure premise as a standalone concept
- [completeness-in-physics-under-dualism](/topics/completeness-in-physics-under-dualism/) — Whether physics is complete, and in what sense
- [causal-closure-debate-historical-survey](/topics/causal-closure-debate-historical-survey/) — How the closure premise evolved into Kim's argument
- [supervenience](/concepts/supervenience/) — The dependence relation the supervenience argument exploits
- [epiphenomenalism](/concepts/epiphenomenalism/) — The horn the argument tries to force
- [reductionism](/concepts/reductionism/) — The other horn, which Kim himself takes
- [delegatory-causation](/concepts/delegatory-causation/) — The quantum-independent preemption reply
- [galilean-exclusion](/concepts/galilean-exclusion/) — A different "exclusion" (Galileo on secondary qualities), not to be conflated
