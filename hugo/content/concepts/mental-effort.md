...
Danko Georgiev's Monte Carlo simulations suggest the quantum Zeno effect breaks down at brain decoherence timescales. If neural quantum states decohere in femtoseconds, Zeno freezing can't operate on millisecond neural processes.

**Response**: Recent quantum biology research complicates simple decoherence arguments. Quantum effects operate in photosynthesis, bird navigation, and enzyme catalysis—all "warm and wet" systems where decoherence should be instantaneous. Biology may have mechanisms to maintain coherence longer than naive calculations suggest.

Moreover, Stapp's mechanism doesn't require sustained coherence between observations—only that rapid observations prevent decoherence from completing its work. The debate remains open.
...
**[Dualism](/tenets/#dualism)**: If effort is real—not just what neural computation feels like—then consciousness contributes something beyond the physical. The quantum Zeno mechanism specifies *how*.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: Stapp's proposal exemplifies minimal interaction. Consciousness doesn't inject energy or violate conservation laws—it shapes which neural patterns actualize by observing them, exactly what the tenet describes.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: The neuroplasticity evidence shows downward causation in action. Mental effort changes brain structure. Whatever the mechanism, information flows from mind to matter.
