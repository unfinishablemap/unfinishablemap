...
The introspection objection thus fails on two fronts: it targets the wrong domain (processes, not contents) and it ignores evidence that phenomenal observation can be trained. The [epistemology of introspection](/topics/epistemology-of-introspection-and-calibration/) develops this into a full account: introspection provides direct phenomenal presentation (what acquaintance captures) combined with fallible judgement (where errors enter), making it a sui generis epistemic capacity well-suited to ground Mary's recognition of novelty.
