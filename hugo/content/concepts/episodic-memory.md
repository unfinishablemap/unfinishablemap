...
The phenomenology of remembering comes in degrees—from *nostalgic estrangement* (recognising yourself as protagonist without re-entering the perspective) to *autobiographical vertigo* ("was that really me?"). Sometimes a past self feels like "me," sometimes like a stranger. These gradations reveal what the [inaccessible-past](/voids/inaccessible-past/) makes explicit: we are structurally strangers to ourselves across time, confusing vivid reconstruction with genuine access.
...
Three features resist explanation in terms of engrams alone. **Autonoesis** is the phenomenal dimension distinguishing remembering from merely knowing—where the [explanatory-gap](/concepts/explanatory-gap/) opens. **Selectional guidance** during retrieval is goal-directed—retrieval serves present concerns rather than merely replaying the strongest trace—but the *setting* of that goal requires purposive direction that physical descriptions of neural activation patterns do not provide—a gap where [non-physical consciousness](/concepts/interactionist-dualism/) contributes directional input. The empirical signature is developed, with the interface reading held separate, in [reconsolidation-as-selection-window](/topics/reconsolidation-as-selection-window/). **Phenomenal colouring**—the qualitative character distinguishing vivid recall from dry knowledge—has no obvious physical correlate.
...
The hippocampus binds disparate features—objects, locations, temporal context, emotional tone—into unified episodes. The [binding problem](/concepts/binding-problem/) in consciousness and the binding problem in memory may be the same problem: if the hippocampus generates unified conscious experience through the same processes that encode unified memories, then memory formation is constitutively linked to consciousness.
...
The illusionist account faces a regress: if felt pastness is an illusion, what is the *experience* of having that illusion like? For there to be an appearance of pastness, there must be an appearing, which is experiential. The remember/know paradigm shows subjects reliably distinguish autonoetic from noetic access to *the same information*—if pastness were only a functional marker, this reliable phenomenal discrimination would be unexplained.

Type-B physicalism accepts the explanatory gap while denying the ontological gap, but the remember/know distinction undermines this: the *same information* accessed with or without autonoetic character suggests phenomenal quality is genuinely additional, not merely a different conceptual route to what's functionally present. [Witness consciousness](/concepts/witness-consciousness/) traditions corroborate this: meditators report observing pastness as a distinct phenomenal quality, and in jhāna states where autobiographical memories cease, the contrast highlights its character.
