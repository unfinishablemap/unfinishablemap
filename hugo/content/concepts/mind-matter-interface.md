...
Stapp's [quantum Zeno mechanism](/concepts/quantum-consciousness/#quantum-zeno-effect-stapp) provides the details: attention corresponds to repeated quantum observations that hold neural patterns in place. What you focus on becomes actual because attention is observation and observation constrains quantum evolution. The [detailed selection mechanism article](/questions/consciousness-selecting-neural-patterns/) covers candidate sites (microtubules, ion channels, attention networks) and constraints (bandwidth, brain boundary, selection vs. randomness).
...
**Free will**: How can choices be both undetermined (by prior physical states) and determined (by the agent)? Quantum indeterminacy provides the openness; consciousness provides the determination. Selection is free because it's not physically determined; it's willed because consciousness selects for reasons. See [free-will](/topics/free-will/) for detailed treatment.
...
**Why are some brain processes accessible and others not?** The interface has structure. Consciousness shapes what reaches the [attention](/concepts/attention/) system; it can only select among options that reach awareness. Unconscious processing doesn't present alternatives to select among.
...
A critical objection to Layer 2: [decoherence](/concepts/decoherence/) destroys quantum coherence in warm biological systems within femtoseconds. If superpositions cannot persist long enough for consciousness to select among them, the quantum Zeno mechanism fails.
...
The two-layer model finds unexpected support from contemplative traditions. The distinction between consciousness-as-source (Layer 1) and consciousness-as-selector (Layer 2) maps onto the phenomenology of [witness consciousness](/concepts/witness-consciousness/) (*sakshi*):
...
**Effort supports Layer 2**: The phenomenology of [mental effort](/concepts/mental-effort/)—the felt sense that sustaining attention is *work*—aligns with the quantum Zeno mechanism. If attention were passive reception, why would it feel effortful? The experience of effort suggests genuine selection, not mere registration.
...
**[No Many Worlds](/tenets/#no-many-worlds)**: Layer 2 requires collapse to be real. If all outcomes occur (MWI), selection is illusory. The model assumes genuine selection among alternatives.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The two-layer model is admittedly complex. But if consciousness is irreducible *and* causally efficacious, something like this structure is required. Simplicity shouldn't trump explanatory adequacy.
