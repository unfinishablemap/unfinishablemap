...
Roger Penrose and Stuart Hameroff propose that quantum computation occurs in neural microtubules:

- **Location**: Tubulin proteins within microtubules (part of the cytoskeleton)
- **Mechanism**: Quantum superpositions of tubulin conformational states
- **Orchestration**: Synaptic inputs and gap junctions coordinate quantum states across neurons
...
A newer competing proposal suggests spintronic coherence in microtubules:

- **Mechanism**: Microtubules as nanoscale spintronic oscillators
- **Location**: Concentrated at the axon initial segment (AIS)
- **Advantage**: Spin coherence is more stable at physiological temperatures than electronic or vibrational coherence
- **Claim**: Spontaneous coherence emergence generates qualia
...
## Implications for this project's Framework

### Strengthening Minimal Quantum Interaction

The [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) tenet proposes that consciousness influences quantum outcomes without injecting energy. Critics object that quantum effects cannot persist in warm biological tissue. Quantum biology undermines this objection:

1. **Biological precedent**: Avian magnetoreception proves evolution can harness quantum coherence for function. If quantum effects serve navigation, the burden shifts to explaining why they cannot serve consciousness.
...
3. **Measurement, not coherence**: the project's framework requires only that consciousness bias outcomes at the moment of measurement—not that it maintain long-lived superpositions. As the [decoherence](/concepts/decoherence/) article explains, decoherence doesn't solve the [measurement-problem](/concepts/measurement-problem/)—it merely selects preferred bases. Something must still determine which outcome becomes actual.
...
Standard physics provides probabilities for outcomes but doesn't determine which outcome occurs. Quantum biology demonstrates that outcome selection happens constantly in biological systems. Whether consciousness plays any role in neural outcome selection remains the project's central hypothesis.

### What Quantum Biology Does Not Show

1. **Proof of consciousness causing collapse**: None of these biological examples require consciousness. They work within standard quantum mechanics.
...
3. **The specific mechanism**: Neither Orch OR nor QBIT has been confirmed. the project doesn't commit to a specific quantum consciousness mechanism.

### What Quantum Biology Does Show

1. **Quantum effects operate in warm, wet biology**: The categorical "warm, wet, and noisy" objection has been refuted.

2. **Evolution optimises quantum effects**: Natural selection can exploit quantum phenomena for biological advantage.

3. **The measurement problem is biologically relevant**: Outcome selection occurs constantly in biological systems.

## Relation to Site Perspective

the project's position on quantum biology connects to all five tenets:

**[Dualism](/tenets/#dualism)**: Quantum biology doesn't prove dualism, but it removes a major objection. If consciousness interfaces with physics at quantum indeterminacies—as the project holds—critics often claim such effects couldn't occur in warm biological systems. The evidence surveyed here shows that claim is empirically false.
...
the project's position on quantum biology would face serious difficulty if:
...
- [many-worlds](/arguments/many-worlds/) — Why the project rejects Many-Worlds
- [tenets](/tenets/) — the project's foundational commitments including Minimal Quantum Interaction
