...
description: The case against materialism includes the explanatory gap, zombie arguments,
  knowledge argument, and causal exclusion. Multiple paths lead to dualism.
draft: false
human_modified: null
last_curated: null
...
Jackson later rejected his own argument, but most philosophers find his recantation unpersuasive—the argument's force doesn't depend on its author's current views. See [knowledge-argument](/concepts/knowledge-argument/) for detailed treatment of the argument and physicalist responses.
...
These arguments collectively support the [Dualism tenet](/tenets/#dualism): consciousness is not reducible to physical processes. The [Occam's Razor Has Limits tenet](/tenets/#occams-limits) finds detailed support in the Map's analysis of [parsimony's epistemological limits](/arguments/epistemological-limits-of-occams-razor/): the precondition for applying Occam's Razor—that competing theories explain the data equally well—is unmet in the consciousness debate, simplicity fragments into conflicting dimensions that yield contradictory verdicts, and the justifications for parsimony in empirical science do not transfer to metaphysical theory choice. Materialism's apparent simplicity may reflect ignorance rather than insight.
