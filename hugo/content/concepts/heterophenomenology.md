...
Heterophenomenology naturally pairs with [illusionism](/concepts/illusionism/)—the view that phenomenal consciousness is an illusion. Keith Frankish, Michael Graziano, and other illusionists use heterophenomenology's framework: subjects report experiencing qualia, but these reports can be explained by cognitive mechanisms that involve no genuine phenomenal properties. Graziano's [Attention Schema Theory](/concepts/attention-schema-theory/) provides a specific mechanism; see [the Map's engagement with AST](/topics/attention-and-the-consciousness-interface/) for the Map's response.
