...
This void differs from the [self-reference paradox](/concepts/self-reference-paradox/), which concerns formal limitations (Gödel's incompleteness, the calibration problem). It also differs from [introspective opacity](/voids/introspective-opacity/) (we cannot observe cognitive processes) and [the unobservable self](/concepts/self-reference-paradox/) (the observer cannot become its own object). The recursion void focuses specifically on *iterative depth*—how many levels of "thinking about thinking about thinking..." remain accessible before the structure fails.
