...
- **[The Insight Void](/research/voids-insight-void-2026-05-14/)** — *Absorbed* (calibration face 2026-08-26 into [the noetic feelings void](/voids/noetic-feelings-void/)'s altered-states section; operation-void parallel 2026-09-17 into [the decision void](/voids/decision-void/)'s "Distinguishing Sibling Voids"). Three-face structural opacity around the *restructuring operation* of impasse-breaking: consciousness witnesses stuck-state and aha-state but never the operation bridging them. Restructuring (Knoblich-Ohlsson 1999's representational-change theory: constraint relaxation and chunk decomposition run sub-personally). Antecedent-blindness (Jung-Beeman et al. 2004: a right posterior alpha burst, read by the authors as gating of visual input, from ~1.4 s to ~0.4 s before insight solutions, and a right anterior temporal gamma burst from ~0.3 s). Calibration (Danek-Wiley 2017: false insights share the pleasure, suddenness and certainty of true ones, weaker on average; Topolinski-Reber 2010 ground felt rightness in fluency; Laukkonen et al. 2020 show induced aha moments raise judged truth of unrelated claims). **Still pending**: the restructuring face has no host; [transit-void](/voids/transit-void/) is the candidate.
