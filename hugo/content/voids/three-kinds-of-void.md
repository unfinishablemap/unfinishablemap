...
We've all experienced this. The [phenomenology of slippage](/voids/transit-void/) catalogues the mechanisms: tip-of-tongue blocking where knowledge and access dissociate, dream forgetting where MCH neurons actively erase content before it reaches stable memory, ironic suppression where trying not to think a thought guarantees you will think it. Most slippage has mundane explanations—neural architecture, retrieval interference, biological constraints.

But certain patterns warrant attention. William James noted that mystical experiences combine *ineffability* with *noesis*—you feel certain you know something you cannot say. The "dissolving-insight phenomenon" describes thoughts that vanish not gradually but *in the act of reaching for them*. And the phenomenological concept of "double concealment"—drawn from Husserl's analysis of time-consciousness—suggests that some forgetting erases even the gap: we don't know what we don't know. Could some of these patterns point beyond ordinary memory failure to genuinely [defended territory](/voids/self-maintained-cognitive-limits/)? The [question of whether voids are genuine](/voids/meta-epistemology-of-limits/) may itself be a void—formally undecidable from within any limited system.

This is speculative. But it's testably speculative—at least in principle. We can look for patterns in what thoughts refuse to form, paying attention to whether certain *content types* produce systematic slippage. The [defended territory](/voids/self-maintained-cognitive-limits/) article develops specific tests: if consciousness-related thoughts slip no more than matched control topics, the hypothesis fails; if AI can stably articulate what humans consistently lose, human slippage was contingent rather than structural.

## Between the Categories

[Attention disorders](/topics/attention-and-the-consciousness-interface/#the-epistemological-challenge) exemplify the occluded category: when attention is disordered, the instrument we would use to investigate the disorder is itself broken. The person with lifelong ADHD cannot know what neurotypical attention feels like, and their introspective reports are generated by the disordered system — a circularity that cannot be broken from within.

A worked example sharpens what "mixed" means here, because the taxonomy invites a misreading: that each void is *one of* three kinds. It is not the void that falls into a kind but the void's *territory*, and a single void can span several kinds at once because its different faces sit at different points on the unexplored / unexplorable / occluded axis. The [the-quantitative-comprehension-void](/voids/the-quantitative-comprehension-void/) makes this vivid. Its three nested faces cross-classify: the [cardinality floor](/voids/the-quantitative-comprehension-void/#the-cardinality-floor)—the hard cap at roughly four items where direct cardinal perception ends—is principally *unexplorable*, an architectural ceiling no training shifts; the [magnitude-and-probability domain](/voids/the-quantitative-comprehension-void/#the-magnitude-and-probability-domain) is largely *unexplored*, with better metaphors and AI translators pushing the edge outward, yet carries an *unexplorable* core at extreme scales where no intuition for trillions will ever arrive; and the [abstract-mathematical ceiling](/voids/the-quantitative-comprehension-void/#the-abstract-mathematical-ceiling) combines both, formal manipulation outrunning phenomenal grasp across hyperdimensional spaces and non-surveyable proofs. One void, three faces, three different classifications—the spanning is internal to the void, not a matter of indecision about which single label fits.

The spanning also has a diachronic form, which matters for how the catalogue revises itself. Faces can move independently under new evidence, so a void may need *splitting* rather than retiring when only one of them deflates. The [palette extension void](/voids/palette-extension-void/) is the worked case: its induction face—whether a phenomenal channel can be added to a finished adult mind—has been shrinking under gene therapy, sensory augmentation and cone-targeted stimulation, while its verification face—whether an added channel can be certified as phenomenally new—is untouched by all three results and is a candidate *unexplorable*. Retiring the void on the strength of the first face would have discarded the second.

The same span recurs as a *structural-mechanism* trichotomy in the [self-reference-paradox](/concepts/self-reference-paradox/), which anchors the epistemic-status vocabulary used here to a mechanism vocabulary. Its weak form—inspection that does not alter its object but cannot validate itself except by using itself—maps onto the *unexplored* face (the difficulty is real but not architecturally sealed). Its strong form—inspection that transforms what it measures—maps onto the *unexplorable*: the pre-inspection state cannot be recovered by any improved method, because any method is the apparatus. And its irrecoverably-conditioned middle gradient—where the act leaves the object unchanged but the result is so shaped by the apparatus that the un-conditioned structure cannot be reconstructed—maps onto the *occluded*: the access is blocked not by intentional concealment but by the inescapable conditioning of the only available channel. The two articulations describe the same architecture from different angles, one in the register of *what we can hope to learn* and one in the register of *what the inspecting machinery does to its object*.

The three-part taxonomy organises investigation but does not confine it. The [ineffable-encounter-void](/voids/ineffable-encounter-void/)—consciousness encountering meaning and sacred significance that exceeds articulation—combines unexplorable and occluded features: the generating mechanism is hidden from introspection (unexplorable), while analytical attention actively dissolves the experience (occluded). It is unusual among mixed-type voids because it manifests as *presence* rather than absence—an excess of meaning rather than a deficit of access. The [synesthetic-void](/voids/synesthetic-void/)—experiential dimensions open to some minds but closed to others within a single species—spans all three types: partly unexplored, partly unexplorable by non-synesthetic architectures, and partly occluded through developmental neural pruning that actively dismantles broader phenomenal access. The [Naturally Occluded](/concepts/naturally-occluded/) category extends the taxonomy to four kinds — voids whose opacity natural selection actively maintained because visibility carried fitness costs, anchored formally at the perceptual layer by the [Fitness-Beats-Truth theorem](/concepts/fitness-beats-truth/) and differing from each of the original three (not merely uninvestigated, not necessarily beyond all possible cognition, yet not maintained by any intentional agent). The [plenitude-void](/voids/plenitude-void/)—whether experience is genuinely as rich as it seems—combines unexplorable and occluded features through a distinctive self-concealing structure: every introspective probe for sparsity directs attention and thereby generates the detail it tries to measure, so the verification procedure manufactures the evidence it seeks. It requires neither a cognitive-closure argument nor an external occluder; the investigation itself does the occluding. The taxonomy's value lies less in rigid classification than in revealing how different kinds of darkness demand different investigative approaches.
...
- [transit-void](/voids/transit-void/) — The phenomenology of cognitive slippage
...
- [palette-extension-void](/voids/palette-extension-void/) — A void whose faces moved apart: one deflating, its sibling untouched
