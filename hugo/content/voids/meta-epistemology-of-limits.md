...
**The assessment requires the faculties under assessment.** To determine whether our cognitive architecture has limits, we must use that very architecture—a self-referential bind that [cognitive closure](/concepts/cognitive-closure/) makes precise. If the architecture is limited in relevant ways, our determination may be systematically wrong. There is no neutral vantage point, and [introspective-opacity](/voids/introspective-opacity/) ensures we cannot simply look inward to check.
