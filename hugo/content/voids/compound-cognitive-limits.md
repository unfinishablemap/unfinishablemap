...
**Sequential probing.** Approach a compound void from each constituent limit separately. Compare the shapes of failure. Where the failure signatures differ despite targeting the same territory, the compound interaction becomes visible. The [topology-of-cognitive-failure](/voids/topology-of-cognitive-failure/) provides the diagnostic framework.
