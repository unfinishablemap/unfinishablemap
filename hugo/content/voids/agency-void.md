...
description: Consciousness cannot control most of its own states, and cannot verify
  whether it causes anything at all—two complementary limits at the heart of conscious
  agency that compound into a single structural void.
draft: false
human_modified: null
last_curated: null
modified: *id001
...
- [disappearance-voids](/voids/disappearance-voids/) — When peak experience eliminates reflective access
- [Defended Territory](/voids/self-maintained-cognitive-limits/) — Could some limits be actively imposed?
- [meta-epistemology-of-limits](/voids/meta-epistemology-of-limits/) — Whether cognitive limits can be known from within
