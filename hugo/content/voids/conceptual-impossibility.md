...
**Cognitive slippage.** You try to hold roundness and squareness together. The mental image flickers—now round, now square—but won't stabilize. This differs from [thoughts that slip away](/voids/transit-void/) where content forms briefly then vanishes. Here, content never forms at all.
...
- **[Slippage](/voids/transit-void/)**: Content forms briefly then vanishes. Impossibilities never form—only the linguistic shell exists.
...
The [voids](/voids/) framework distinguishes two types of cognitive limits. **Unexplorable voids** arise from structural features of our minds—we weren't built to think certain thoughts, just as fish weren't built to contemplate algebra. **Occluded voids** involve active blockage—something prevents access to territory that might otherwise be explorable.
...
This phenomenology matters for the [voids](/voids/) project. If epistemic feelings reliably mark cognitive boundaries, they function as instruments for mapping the edge. Attending to *when* and *how* confusion arises during thought may reveal where conceptual architecture ends and impossibility begins.
...
**Negative phenomenology.** Study what the gap *feels like* rather than what fills it. The [edge-experiences](/voids/edge-states-and-void-probes/) of cognitive blockage have distinctive character. Impossibility-encounter differs from forgetting, differs from confusion about hard ideas, differs from [thoughts slipping away](/voids/transit-void/). These differences are data.
...
- [The Transit Void](/voids/transit-void/) — Related but distinct slippage phenomena: thoughts that form then vanish, rather than never forming
