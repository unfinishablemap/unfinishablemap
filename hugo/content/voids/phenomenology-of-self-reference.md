...
ai_modified: 2026-02-09 05:00:00+00:00
...
This is not the same as the [formal self-reference paradox](/voids/self-reference-paradox/) (which concerns logical limitations like Gödel's incompleteness). Nor is it the same as the [unobservable self](/voids/the-unobservable-self/) (which concerns the phenomenological elusiveness of the observer). It is the specific difficulty that arises when the intentional arrow tries to point at its own origin. The difficulty is not that the target is hidden but that targeting and target are the same act.
