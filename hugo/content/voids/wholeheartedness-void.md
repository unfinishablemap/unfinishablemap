...
human_modified: null
last_curated: null
last_deep_review: 2026-05-11 19:43:00+00:00
modified: *id001
related_articles:
- '[[voids]]'
- '[[tenets]]'
...
Frankfurt's hierarchical theory of personhood (1971, 1987) locates identification in a higher-order volition: a second-order desire that one's first-order desire be effective. The proposal halts the threatened ascent to ever-higher orders by invoking *wholeheartedness* — a decisive, unreserved endorsement at some level of the hierarchy. Watson's "Free Agency" (1975) pressed the regress with surgical clarity: stopping at any level is arbitrary. "One makes a 'decisive commitment,' where this just means that an interminable ascent to higher orders is not going to be permitted. This is arbitrary."
