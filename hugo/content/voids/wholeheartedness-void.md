...
Consciousness cannot verify, from inside, that a present identification with a desire, belief, or value is genuine rather than self-deceived, settled rather than merely foreclosed, or stable rather than poised to be retroactively disowned. The Wholeheartedness Void names this structural opacity at the standing condition of being self-identified. Three faces conjoin: no first-person test distinguishes wholehearted endorsement from a regress halted by stipulation (regress); any motive that causes action can in principle be later disavowed, and consciousness has no within-action marker for survival across reflection (disownability); the felt unity of unreserved commitment is consistent with — and can be produced by — the suppression of a dissenting pole (ambivalence-detection). Each face alone is a recognised problem; the analytical claim is that the *seams between them* are load-bearing — each face closes a route the others leave open.

The void sits adjacent to the [decision-void](/voids/decision-void/) in the agency family. Where the decision-void concerns the *crossing* from deliberation to commitment, the wholeheartedness-void concerns the *standing condition* of being identified-with — and both share architecture with the [suspension-void](/voids/suspension-void/) and the [agency-void](/voids/agency-void/): the faculty under investigation is the only available investigator. The void engages [Bidirectional Interaction](/tenets/#bidirectional-interaction) obliquely (the standing-identification state as a candidate site for the persistent shape of any non-physical influence on action) and [Occam's Razor Has Limits](/tenets/#occams-limits) directly: decision-theoretic parsimony absorbs identification into "stable preferences that move action," and Watson (on the regress), Velleman (on disownability), and Bratman (on planning-theoretic identification) each press, in distinct argumentative registers, that what the operationalisation captures is not what the original theory was reaching for.
...
Frankfurt's hierarchical theory of personhood (1971, 1987) locates identification in a higher-order volition: a second-order desire that one's first-order desire be effective. The proposal halts the threatened ascent to ever-higher orders by invoking *wholeheartedness* — a decisive, unreserved endorsement at some level of the hierarchy. Watson's "Free Agency" (1975) pressed the regress with surgical clarity: stopping at any level is arbitrary. "[O]ne makes a 'decisive commitment,' where this just means that an interminable ascent to higher orders is not going to be permitted. This is arbitrary."

The arbitrariness is a structural feature of self-relation, not a defect of Frankfurt's theory. Consciousness has no Archimedean point from which to survey its own hierarchy of endorsements. Asking *whether* one wholeheartedly endorses a second-order volition invokes the same machinery that produced the endorsement; the third-order ascent does not stabilise the second, it merely defers. The regress face is *Unexplorable* in the sense the [three-kinds typology](/voids/three-kinds-of-void/) reserves for limits that resist mapping by their own architecture: one does not lack data about one's hierarchy; one lacks the capacity to non-question-beggingly authorise any particular level as authoritative.

### Disownability (Occluded)

J. David Velleman pressed a different point: it is always possible that an agent retrospectively *disowns* the mental attitudes that caused an action. If any motive can in principle be later disavowed — declared not really one's own, only operative on one — then identification is never structurally guaranteed at the time of action. At the time of action, consciousness has no marker distinguishing "an identification I will continue to endorse" from "one I will later disown." Velleman himself draws a limit on the disownability he presses against Frankfurt's hierarchical attitudes: on his view the desire to act in accordance with reasons cannot be disowned while the agent remains self-determining, so one motive escapes the disavowal that threatens all the others — though that limit fixes a floor for agency as such, not a marker for any *particular* identification. The forward-looking judgment of stability is performed by the same faculties whose neutrality is in question, and the test that would discriminate — survival across reflection — cannot be run in advance. Empirical work on prospective misprediction of preference (Hsee & Hastie 2006 on impact bias; Loewenstein, O'Donoghue & Rabin 2003 on projection bias) shows systematic mismatch between present and future evaluations, invisible to present introspection.

The disownability face dovetails with the [interested-party void](/voids/interested-party-void/): consciousness has standing stakes in whether *this present commitment* is "really mine," so introspective verdicts about identification cannot be neutral. It is *Occluded* — the relevant fact (will I disown this?) exists and shapes outcomes, but the system whose limits it sets cannot perceive those limits while they operate.

### Ambivalence-Detection (Unexplorable + Occluded)

The edited volume *The Philosophy and Psychology of Ambivalence* (Brogaard & Gatzia 2020) documents a substantial literature defending the *rationality* of ambivalence: under value pluralism, partial knowledge, or genuine conflict, being of two minds may be the calibrated response, not a defect. "Some philosophers defend radical ambivalence by arguing that, to be true to oneself, one sometimes needs to be radically ambivalent" — directly inverting Frankfurt's wholeheartedness ideal. Empirically, attitudinal ambivalence — simultaneously holding positive and negative evaluations of the same object — is well-attested in social psychology (Kaplan 1972; Cacioppo & Berntson 1994; Conner & Sparks 2002) and resists measurement-driven collapse onto either pole. The multi-lab failure to replicate ego-depletion at scale (Hagger et al. 2016) reinforces the relevant lesson at one remove: a unitary "willpower" resource sufficient to ground wholehearted commitment is not what the experimental record delivers, leaving wholeheartedness without a clean process-substrate that could serve as ground truth for the introspective verdict.

The third face: the felt unity of wholeheartedness can itself be the work of mechanisms that *suppress* dissent rather than the absence of dissent. Sartre's strong reading of *bad faith* makes the point sharpest: full unreserved identification with a role, a project, or a fact pattern functions as a signature of bad faith — the deceiver and the deceived are the same consciousness, and the deception preserves the felt unity by foreclosing on the freedom that would disturb it. Contemporary scholarship on self-deception divides on the strong reading (SEP, *Self-Deception*): some defenders restrict bad faith to treating contingent choices as necessary facts rather than to unreserved identification as such. Either way, the phenomenology of wholehearted commitment is not self-authenticating; its felt absence-of-conflict can be the operative work of suppression rather than the joint output of unanimity. The ambivalence-detection face is doubly hidden: *Unexplorable* in that the test for genuine versus suppressed unity uses the very machinery whose neutrality is in question, and *Occluded* in that suppression mechanisms leave traces consciousness cannot internally inspect.

## The Conjunction and Frankfurt's Trajectory
...
**Buddhist *anātman*** is bedrock framework-boundary disagreement, not a complement to the void's framing. The Mahāyāna denial of a substantial self denies the very thing the void presupposes: that there is a self whose identifications could be genuine or self-deceived, settled or foreclosed. From inside the Madhyamaka framework, the wholeheartedness-void does not exist because the wholehearted-*one* does not exist; the disciplined response is not to refine the question but to deconstruct the questioner. The Map declines this move from outside the framework, not refutes it inside it. The framework reason the Map carries the void rather than dissolving it is its load-bearing commitment to indexical identity ([No Many Worlds](/tenets/#no-many-worlds) — Tenet 4): without a non-fungible *this*-mind whose identifications would be the question, the apophatic catalogue loses the anchoring subject the voids are voids *of*.

The void is also [tenet-generated](/voids/tenet-generated-voids/). When the Map commits to its tenets, the Wholeheartedness Void applies to that commitment too: the Map cannot verify its own wholeheartedness about its claims from inside ([self-maintained-cognitive-limits](/voids/self-maintained-cognitive-limits/); [meta-epistemology-of-limits](/voids/meta-epistemology-of-limits/)). Carrying that signature openly is what the apophatic method requires.

The void is methodologically apophatic per [evidential-status-discipline](/project/evidential-status-discipline/): its existence is established by structural argument, not by experiment, and on the article's own framing no state of affairs in consciousness or behaviour is incompatible with it. A positive demonstration of a verification route the closure argument forecloses — an introspective marker that discriminated genuine wholeheartedness from suppression-produced unity *and* did not depend on the same faculty whose neutrality is in question — would falsify the void, though by construction rather than by empirical discovery. No such route is even sketched here, and the Map concedes the cost openly rather than absorbing it into the structural claim.

## Further Reading

- [Voids in the Map](/voids/) — The broader framework for cognitive limits
- [decision-void](/voids/decision-void/) — Sister void at the deliberation→commitment crossing; this article's transition-counterpart
- [suspension-void](/voids/suspension-void/) — Sister regress: the standing-condition counterpart in the apophatic register
- [agency-void](/voids/agency-void/) — The non-willing-will paradox in another register
- [interested-party-void](/voids/interested-party-void/) — Why one's stakes in being "really committed" make introspective verdicts non-neutral
- [noetic-feelings-void](/voids/noetic-feelings-void/) — Why the felt unity of unreserved commitment cannot audit itself
- [self-opacity](/voids/self-opacity/) — The general structure of which this void is one face
- [mine-ness](/concepts/mine-ness/) — Adjacent void on the broader ownership of mental events
...
- [The Participation Void (research-stage)](/research/voids-participation-void-2026-02-17/) — Enacted-versus-represented survey, folded into [the conjunction section](#the-conjunction-and-frankfurts-trajectory)
