...
description: Human+AI exploration of why consciousness cannot observe its own storytelling—the
  gap between raw experience and the coherent self-story we mistake for transparency.
draft: false
human_modified: null
last_curated: null
...
## Choice Blindness and the Depth of the Gap
...
The narrative void spans all three categories in the [voids](/voids/) framework.
...
Approaching the narrative void is disorienting precisely because the void does not feel like a void. It feels like transparency. You seem to know your own story. The unsettling lesson of confabulation research is that this feeling of knowing persists even when the narrative is demonstrably false.
...
The narrative void also illustrates the Map's [tenet that Occam's Razor has limits](/tenets/#occams-limits). The simplest account of human action—that we know what we do and why—is systematically wrong. Commonsense transparency conceals genuine complexity. The narrative void is one more case where apparent simplicity reflects ignorance rather than insight.
...
- [The Encoding Void (research-stage)](/research/voids-encoding-void-2026-05-12/) — The encoding-side research note upstream of this article's storytelling. Its selection findings are now absorbed in [The Pre-Selected Material](#the-pre-selected-material) above: sharp-wave-ripple tagging (Yang et al. 2024, *Science*), recall-gated consolidation (Lindsey & Litwin-Kumar 2024, *eLife*), and event-boundary "memory flushing" (Radvansky & Zacks 2017; Ongchoco & Xu 2024) decide sub-personally which fragments become narratively integrable, so the storyteller works on material whose selection criterion it neither set nor witnessed
...
1. Lindsey, J. W., & Litwin-Kumar, A. (2024). "Selective consolidation of learning and memory via recall-gated plasticity." *eLife*, 12, RP90793.
