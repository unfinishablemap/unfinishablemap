...
**Psychedelic and mystical experiences approach boundaries.** These states are characterised by profound alterations in affect combined with *ineffability*—subjects report certainty that they experienced something they cannot describe. The [aesthetic-void](/voids/creative-aesthetic-void/) documents the same pattern in aesthetic experience specifically: beauty that feels knowledge-bearing yet resists all articulation. The ineffability is not simply failure of language but may mark the edge of human affective space.
