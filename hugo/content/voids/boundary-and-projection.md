...
human_modified: null
last_curated: null
last_deep_review: 2026-04-17 21:12:00+00:00
modified: *id001
related_articles:
- '[[voids]]'
- '[[tenets]]'
...
The three projection forms share a structural explanation with the static boundary. Metzinger's [phenomenal transparency](/concepts/phenomenal-transparency-opacity-spectrum/) provides the key: a well-functioning mental representation is not experienced as a representation. The medium becomes invisible; only content remains.
...
The void is **mixed** in the [voids taxonomy](/voids/three-kinds-of-void/): primarily Unexplorable, significantly Unexplored, possibly Occluded.
...
This void connects to the Map's [tenets](/tenets/) with unusual directness.
...
**[Occam's Razor Has Limits](/tenets/#occams-limits)** applies directly. Tool use feels simple—you just use the hammer. The underlying process involves dynamic peripersonal remapping, multisensory integration, and body schema modification, while the static perimeter problem remains theoretically intractable after decades. The apparent simplicity is the void at work, hiding complexity behind a transparent interface.
