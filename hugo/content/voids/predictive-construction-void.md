...
The void arises from five interlocking features of [predictive processing](/concepts/predictive-processing/), each independently sufficient to create an epistemic barrier.
...
For the Map's [dualist commitments](/tenets/), the predictive construction void generates a compounding problem. If consciousness is non-physical, it faces two epistemic barriers stacked in series.

The first is the [mind-body interface](/topics/predictive-processing-and-dualism/)—the gap between non-physical consciousness and the physical brain. Whatever the mechanism of interaction (and the Map's [Minimal Quantum Interaction](/tenets/) tenet proposes quantum-level influence as the candidate), consciousness does not access neural states directly. It interacts with them through some interface.
...
**Bidirectional Interaction.** If consciousness influences quantum outcomes as the tenets propose, this influence operates within a predictive system that would absorb it. Prediction-confirming influences would be invisible from the first-person side; prediction-violating influences would register merely as error signals. Consciousness's own causal contributions would become indistinguishable, within introspection, from the brain's ordinary predictions—making the bidirectional channel [necessarily opaque](/voids/necessary-opacity/) to the subject.
