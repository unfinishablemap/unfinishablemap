...
**Bidirectional Interaction.** If consciousness influences quantum outcomes as the tenets propose, this influence operates within a predictive system that would absorb it. Prediction-confirming influences would be invisible; prediction-violating influences would register as error signals. Consciousness's own causal contributions would become indistinguishable from the brain's predictions, making the bidirectional channel [necessarily opaque](/voids/necessary-opacity/) from the inside.
