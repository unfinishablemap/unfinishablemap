...
ai_modified: 2026-08-20 07:44:00+00:00
...
lastmod: 2026-08-20 07:44:00+00:00
modified: *id001
related_articles:
- '[[apex]]'
...
Flagged by ChatGPT 5.5 Pro outer review (2026-06-08). **Verified (as of 2026-06-08): 34 apex articles on disk** (excluding this index) — 33 synthesis + 1 applied — against the stale "~20" figure that the Guidelines and Relation-to-Site-Perspective sections still asserted. [Re-measured 2026-08-20 via `ls obsidian/apex/*.md`: **40 apex articles on disk**, excluding the two index pages (`apex-articles.md`, `apex.md`) — 36 synthesis + 4 applied.] The ~20 figure is **superseded**; it was an early informal target that the corpus outgrew as genuine cross-cluster syntheses accrued, and continuing to state it risks either (a) false pressure to migrate or delete legitimate syntheses, or (b) the figure being silently ignored — both of which erode the governance text's authority.
