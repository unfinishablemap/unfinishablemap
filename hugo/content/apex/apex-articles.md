...
Target count: 8–15 applied pieces across the corpus. Each one should answer a question a reader would actually ask of the Map. **A reader looking for "what does the Map tell me to *do*?" should start here.** Four are live — A1 (assessing AI-consciousness claims) and A5 (prioritising a research programme) are reciprocally linked, A6 (the causal status of felt embodiment), and A7 (judging the Map as science); A2–A4 are proposed.
