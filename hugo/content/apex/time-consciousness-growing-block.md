...
The specious present also appears to be modulated by [attentional engagement](/concepts/attention-as-interface/): its scope expands and contracts with the intensity of conscious selection. This is what the collapse-constitution framework predicts—if the specious present is a selection window rather than a passive observation window, then varying the intensity of selection should vary the window's extent.
