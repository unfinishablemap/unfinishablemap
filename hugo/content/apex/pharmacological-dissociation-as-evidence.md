...
ai_modified: 2026-08-01 14:39:13+00:00
...
**Parallel patterns across the catalogue.** The [clinical dissociation cluster](/topics/clinical-dissociation-as-systematic-evidence/) supplies the strongest non-pharmacological version, but it carries an internal discount that disciplines how it is read. DID, depersonalisation-derealisation, dissociative amnesia, and conversion disorder reach the same channel-level architecture as anaesthesia and neurological lesions, but through *functional* connectivity disruption rather than structural damage or receptor pharmacology—and what they sever is felt access and ownership, not the underlying integration: DID patients reporting inter-identity amnesia on recall still show cross-identity transfer on recognition (Marsh et al. 2021), so the substrate keeps integrating while metacognitive access decouples. The four clinical windows do *not* count as four independent confirmations, because three of them (DPDR as imbalanced interoceptive precision, conversion as an aberrant motor prior, surviving dissociative amnesia as inhibited retrieval) are redescribable as precision-weighting pathologies in one active-inference framework; their residual independence is weaker than four-fold, and DID's cross-state geometry is the member that most resists the precision framing. The load-bearing convergence therefore runs *across* perturbation classes, not within the clinical cluster.

That cross-route convergence is what the [epistemology of convergence arguments](/topics/epistemology-of-convergence-arguments/#compound-signatures-convergence-without-a-shared-mechanism) names a *compound signature*: agreement among mechanistically disjoint routes, so the agreement cannot be one upstream cause sampled three times. Pharmacology is one route of that signature, not the whole of it. The sibling routes are structural ([lesion](/topics/neurological-dissociations-as-interface-architecture/), e.g. alien hand syndrome) and *psychogenic*—and the cleanest single exhibit of the psychogenic route is [conversion disorder](/topics/conversion-disorder-as-consciousness-side-fault/), where the affected limb moves normally under anaesthesia or hypnosis (motor capacity demonstrably intact) yet not under awake directed volition. Conversion disorder is mechanistically distinct from the pharmacological route precisely in requiring *neither* drug *nor* lesion, which is what lets it exclude "the perturbation broke the substrate" without either. It is a sibling to pharmacological dissociation in the compound signature, not a pharmacological instance—the three routes earn their evidential bite by sharing no mechanism. The calibration that follows applies to the compound signature as a whole: the convergence earns the *architecture* (the channels are separable) robustly while leaving the *interface reading* of that separability a live hypothesis the routes do not jointly vindicate.
...
The convergence with non-pharmacological evidence multiplies the effect. The [neurological dissociations](/topics/neurological-dissociations-as-interface-architecture/) reach the same channel architecture by structural damage. The [clinical dissociations](/topics/clinical-dissociation-as-systematic-evidence/) reach it by functional disconnection without structural damage. The [contemplative pathology](/topics/contemplative-pathology-and-interface-malfunction/) cluster reaches it by voluntary attentional restructuring pushing the interface beyond its operating parameters. Pharmacology, lesion, functional disconnection, and contemplative practice are four perturbation *classes*, each capable of selectively disrupting the same components in the same agent-specific patterns. The architecture replicates across classes that share no mechanism—the load-bearing independence is *between* classes, since within the functional-disconnection class a single precision-weighting mechanism may be reading one architecture several times (see the clinical-cluster discount above). *That* is the cumulative-convergence move that pharmacological dissociation contributes one quarter of, with the [altered-states apex](/apex/altered-states-as-interface-evidence/) gathering five state-modalities into a complementary matrix at the systems-level rather than the mechanism-level. The [epistemology of convergence arguments](/topics/epistemology-of-convergence-arguments/#compound-signatures-convergence-without-a-shared-mechanism) formalises why mechanistic disjointness is the load-bearing feature: a compound signature pre-empts the common-cause objection only where there is no shared upstream cause to screen off—which holds across classes by construction, but not necessarily within one. The same source also fixes where the signature's reach stops—it earns the architecture but not the architecture's dualist significance—which is the discipline the next section applies in detail.

The catalogue's [interface specification programme](/apex/interface-specification-programme/) reads this convergence as specification work: each route adds resolution to the picture of what the interface is, where it has components, how its components fail, and how it reconfigures. The methodology is not "consciousness is dualist because pharmacology shows dissociations"; the methodology is *"the architecture pharmacology reveals has the same component-structure that lesion, dissociation, and contemplative practice reveal, and the convergence raises the explanatory cost on the unified-substrate alternative."* The discipline holds the conclusion at the right level of strength.
...
Third, the methodology is silent on the deeper metaphysical question. Pharmacological dissociation establishes that the interface has components; it does not establish what the interface *is*. As the Calibration Discipline section sets out, the interactionist and the sophisticated-functionalist readings both fit the dissociation data, which sit at the realistic-possibility level for structured architecture while the Map's interactionist version remains at a tier pharmacology alone cannot reach.
...
**[No Many Worlds](/tenets/#no-many-worlds)**: The diagnostic specificity of dissociations is conventionally read as a definite fact—this patient under this drug regimen produced this dissociation, revealing this architectural feature. An Everettian can restate the entire convergence as branch-local: from inside a decohered branch, the dissociation outcome is determinate, the convergence across perturbation routes is a determinate feature of that branch, and the architectural reading proceeds unchanged. The Map's reading depends on global ontological uniqueness rather than branch-local uniqueness, and that preference is honestly noted as a tenet-driven commitment running counter to MWI's framework rather than a pharmacological refutation of it. Tenet 4 is a foundational rejection, not a derived conclusion the dissociation data establish.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The architecture pharmacological dissociation maps is not simple. Four separable components, mechanism-shared reopening, agent-specific failure profiles, behavioural-surface decoupling from interior phenomenology, hysteresis in the close/reopen asymmetry—this is complex machinery. A simpler model fails to account for the dissociation pattern. The methodology's discipline is honesty about this complexity rather than parsimony for parsimony's sake.
...
- [Anaesthesia and the Consciousness Interface](/topics/anaesthesia-and-the-consciousness-interface/) — Worked exhibit: all three pharmacological-dissociation classes co-occur, with xenon-ketamine (Class A), propofol-xenon + KCC2 reopening (Class B), and ketamine-midazolam (Class C) as the load-bearing contrasts
...
- [Filter Theory](/concepts/filter-theory/) — The structural commitment that pharmacological dissociation tests
- [Interface Friction](/concepts/interface-friction/) — The friction-reveals-structure discipline that organises what each dissociation contributes
- [Mind-Matter Interface](/concepts/mind-matter-interface/) — The two-layer architecture the dissociations map

## Further Reading

- [Altered States as Systematic Interface Evidence](/apex/altered-states-as-interface-evidence/) — Apex companion at the systems-level, with anaesthesia as one of five altered-state windows
...
- [Conversion Disorder as the Consciousness-Side-Fault Paradigm](/topics/conversion-disorder-as-consciousness-side-fault/) — The *psychogenic* sibling route in the three-route compound signature; reaches the same separable-channel finding through functional decoupling without drug or lesion, with the under-anaesthesia test as its discriminator
