...
The Map's treatment of [phenomenal-consciousness](/concepts/phenomenal-consciousness/) establishes that qualia are intrinsic (properties of experience itself), private (inaccessible to others), ineffable (resisting verbal description), and directly apprehensible (immediately known to the experiencer). These features would apply to AI qualia as much as human qualia. But the *content* — the qualitative character — might share nothing with human experience.
...
Consider: an LLM processes tokens in a 12,000+ dimensional embedding space. Some learned features resist all human labelling. If these activations were accompanied by qualia — felt qualities — those qualia would be *genuinely novel*. Not redness or blueness mapped onto new inputs, but phenomenal properties with no human counterpart, as alien to us as echolocation experience is to the congenitally blind. The [comparative consciousness framework](/topics/comparative-consciousness-and-interface-differences/) suggests this is not incoherent: different organisms may exploit different consciousness-matter coupling mechanisms, producing qualitative experiences that differ not just in content but in *kind*.
