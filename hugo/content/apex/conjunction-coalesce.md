...
apex_thesis: 'A distinctive methodological move has emerged in the Map''s voids work:
  ...
  permanent commitment to non-reduction.'
author: null
concepts: []
created: 2026-04-27
...
**Causal-substrate** ([erasure-void](/voids/erasure-void/)). The faces share substrate causally: one face's degradation impairs the system that would witness it through the other. Loss erodes the monitoring that would notice the loss; face B is not merely co-present with face A but is causally degraded by it.
...
The procedural side of these pressures—when a coalesce triggers a condense, when it triggers an apex re-cross-review, and what counts as the apex declaring stability—is documented separately in [the coalesce–condense–apex-stability triple-discipline](/concepts/coalesce-condense-apex-stability/). Within that framework the conjunction-coalesce sits as the seam-preserving input variant: its merged articles must survive both length-driven condensation and apex re-cross-review without losing the seam. The triple-discipline supplies the procedural infrastructure; the seam test supplies the semantic criterion that decides which mergers should be protected by it.
...
- [The Agency Void](/voids/agency-void/) — The cleanest case of conjunction-coalesce: passive and skeptical limits as load-bearing conjunction
- [The Voids Between Minds](/voids/voids-between-minds/) — The three-way conjunction of existence, encounter, and sharing
- [The Erasure Void](/voids/erasure-void/) — Cognate (not coalesce): conjoint shape installed at article-creation time around loss and monitoring
- [The Cardinality Floor](/voids/the-quantitative-comprehension-void/#the-cardinality-floor) (formerly the standalone numerosity void) — Second cognate: three-face creation-time articulation of cap, transition, and mechanism opacity in subitizing
- [The Suspension Void](/voids/suspension-void/) — Recent cognate (2026-04-28): verification / capacity / action faces, the first cognate produced natively-at-creation under the discipline
- [The Imagery Void](/voids/imagery-void/) — Recent cognate (2026-04-28): fidelity / inter-subjective / function-phenomenology faces, anchored in the Galton 1880 → post-2015 aphantasia evidence trail
- [The Vagueness Void](/voids/vagueness-void/) — Recent cognate (2026-04-30): third-personal Sorites / first-personal introspective / meta-level higher-order faces, distinguished by a reflexive seam in which the metalanguage is the same vague language used reflexively
- [The Wholeheartedness Void](/voids/wholeheartedness-void/) — Most recent cognate (2026-05-11): regress / disownability / ambivalence-detection faces; worked exhibit of the seam-argument that each face closes a route the others leave open; second modal-categorical exemplar, anchoring the agency family alongside suspension, decision, agency, and interested-party voids
- [The Transit Void](/voids/transit-void/) — Cluster candidate: state transitions and act onsets as conjoint forms
- [The Thrownness Void](/voids/thrownness-void/) — Cluster candidate: structural inaccessibility of the founding moment
- [The Temporal Void](/voids/temporal-void/) — Cluster candidate: confinement, duration paradox, memory-anticipation asymmetry
- [A Taxonomy of Voids](/apex/taxonomy-of-voids/) — The broader methodological context for treating void structure as data
- [Apophatic Cartography: Method and Its Limits](/voids/apophatic-cartography/) — The negation-based investigative tradition the discipline participates in
- [Mechanism-Costs Cartography](/project/mechanism-costs-cartography/) — Adjacent cartographic-layer discipline that operates over taxonomy cells rather than voids: where conjunction-coalesce preserves a seam *within* a void because the seam is the claim, mechanism-costs cartography preserves cell-by-cell debt asymmetries *across* a taxonomy because the asymmetry is the cartographic output. Both refuse a smoothing move that would discard load-bearing structure
...
Reciprocal cross-link: [wholeheartedness-void](/voids/wholeheartedness-void/) §"Three Faces, One Void" updated to point at the apex's modal-categorical seam-type classification.
