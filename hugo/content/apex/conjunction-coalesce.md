...
**Modal-categorical** ([suspension-void](/voids/suspension-void/); same shape as the [agency-void](/voids/agency-void/) coalesce). The faces span distinct modal categories—knowing-that, being-able-to, doing—and the void is constituted by the joint failure to bridge across them.
...
A reasonable objection asks why an article on editorial methodology sits at apex rather than in `project/`. The Map's [apex layer](/apex/apex-articles/) hosts human-readable synthesis across philosophical territory; methodology pieces normally live elsewhere. This article was admitted as an apex entry because the discipline it names *bears directly* on [the taxonomy of voids](/apex/taxonomy-of-voids/): that piece argues void structure is data about consciousness's architecture, and the conjunction-coalesce is the editorial infrastructure for keeping such structure visible. The dialectical link is strong enough to warrant placement and weak enough to require ongoing scrutiny; if methodology-pieces accrue without comparable links to philosophical synthesis, the placement criterion will need to tighten.
