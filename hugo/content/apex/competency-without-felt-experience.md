...
apex_last_synthesis: 2026-09-02 12:08:49+00:00
apex_sources:
...
apex_thesis: Genuine cognitive-grade competency is realised across the whole tree
  of life without, on the Map's framework, felt experience—and the same decoupling
  that blocks reading experience into a bacterium also blocks reading it out of a
  fish, because no third-person fact, of richness or of architecture, settles the
  phenomenal question.
apex_type: synthesis
author: null
concepts:
...
description: Across the tree of life—single cells to engineered cortex—cognitive-grade
  competency is realised without, on the Map's framework, felt experience. The cumulative
  case that the interface is tied to neural machinery, not functional sophistication.
draft: false
human_modified: null
last_curated: null
...
The whole ladder pointing one way is suggestive; treating it as more than suggestive would repeat, at the apex level, the exact over-inference the cluster warns against. [Three calibrations](/project/evidential-status-discipline/) set the ceiling.

First, the convergence is partly **framework-generated**. The rungs are not fully independent witnesses: each reaches its verdict by applying the same underlying commitment—experience is tied to a neural interface—so their agreement is in part the framework consulting itself. This is the [common-cause-null](/project/common-cause-null/) applied to the Map's own synthesis. The abductive support is real but discounted, in the same way the [taxonomy of voids](/apex/taxonomy-of-voids/) discounts its own convergence for a selection effect. What survives the discount is modest and worth stating precisely: the cluster shows that behavioural and functional markers, however rich, *do not settle* the phenomenal question—a claim about the limits of a kind of evidence, which even a committed materialist can grant.

Second, each marker is **defeasible and substrate-sensitive**, decisive nowhere on its own. Weighting toward phenomenal markers over bare competency markers cannot mean discarding behavioural evidence altogether, because there are no non-behavioural third-person markers of consciousness to fall back on—that very absence *is* the explanatory gap. This is why the Map's practice across the ladder stays graded rather than eliminative: the fish rung can still treat its markers as suggestive, and [edge-of-sentience frameworks](/topics/birch-edge-of-sentience-and-the-five-tier-scale/) can still grade credence by behavioural criteria, without contradicting the sub-personal rungs.
...
- [Bacterial Chemotaxis and Minimal Biogenic Cognition](/topics/bacterial-chemotaxis-and-minimal-biogenic-cognition/) — the prokaryotic floor
- [Neuron-Less Animals: Sponges, Placozoans, and the Lower Bound of Cognition](/topics/neuron-less-animals-sponges-placozoans-and-the-lower-bound-of-cognition/) — behaviour with zero neural substrate
- [Plant Cognition and the Plant-Neurobiology Debate](/topics/plant-cognition-and-the-plant-neurobiology-debate/) — processing without a nervous system
- [The Cognitive Immune System and Immunological Selfhood](/topics/the-cognitive-immune-system-and-immunological-selfhood/) — a functional self with no neurons
- [The Enteric Nervous System and the Gut-Brain Distributed-Interface Question](/topics/the-enteric-nervous-system-and-the-gut-brain-distributed-interface-question/) — a "second brain" and the open question of where the interface localises
- [Basal and Bioelectric Cognition](/topics/basal-and-bioelectric-cognition/) — Levin's agency-without-asserted-experience decoupling
- [Fish Sentience and the Teleost Pain Debate](/topics/fish-sentience-and-the-teleost-pain-debate/) — the architecture-varying rung where the discipline runs in reverse
- [Brain Organoids and the Organoid-Intelligence Question](/topics/brain-organoids-and-the-organoid-intelligence-question/) — the engineered edge: substrate without world
- [Consciousness in Simple Organisms](/topics/consciousness-in-simple-organisms/) — the eukaryotic rungs between bacteria and the animals
- [The Engineered Decoupling: Synthetic Minimal Agents as Built Competency Tests](/topics/synthetic-minimal-agents-and-the-engineered-decoupling/) — the built flank: anthrobots, minimal synthetic cells, self-modelling robots
