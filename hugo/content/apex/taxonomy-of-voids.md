...
human_modified: null
last_curated: null
last_deep_review: 2026-04-29 12:19:00+00:00
modified: *id001
related_articles:
- '[[voids]]'
- '[[tenets]]'
...
Some pairs prove *conjoint* rather than merely interacting: the [agency void](/voids/agency-void/) (passive + skeptical), [voids between minds](/voids/voids-between-minds/) (existence + encounter + sharing), [erasure void](/voids/erasure-void/) (loss + monitoring), and the [common-knowledge void](/voids/common-knowledge-void/) (verification + approximation discontinuity + operational fiction) are two- and three-face voids whose joint structure does work no single face could. The [conjunction-coalesce](/apex/conjunction-coalesce/) discipline preserves these as single entries with the seam between faces visible, because the seam itself encodes the claim.
