...
human_modified: null
last_curated: null
last_deep_review: 2026-03-24 15:07:00+00:00
modified: *id001
related_articles:
- '[[voids]]'
- '[[tenets]]'
...
The densest cluster surrounds the mind's attempt to examine itself. The [unobservable self](/concepts/self-reference-paradox/)—the subject that cannot become its own object—anchors this domain. Surrounding it: [introspective opacity](/voids/introspective-opacity/) (the mechanisms of experience hidden from the experiencer), the [calibration void](/voids/measurement-void/) (introspection cannot be verified against any independent standard), the [observation void](/voids/observation-void/) (every method of studying consciousness transforms what it studies), and the [self-reference paradox](/concepts/self-reference-paradox/) (where consciousness cannot map because it is the mapper).
