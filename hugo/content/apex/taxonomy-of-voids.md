...
The densest cluster surrounds the mind's attempt to examine itself. The [unobservable self](/concepts/self-reference-paradox/)—the subject that cannot become its own object—anchors this domain. Surrounding it: [introspective opacity](/voids/self-opacity/) (the mechanisms of experience hidden from the experiencer), the [calibration void](/voids/measurement-void/) (introspection cannot be verified against any independent standard), the [observation void](/voids/observation-void/) (every method of studying consciousness transforms what it studies), and the [self-reference paradox](/concepts/self-reference-paradox/) (where consciousness cannot map because it is the mapper).
