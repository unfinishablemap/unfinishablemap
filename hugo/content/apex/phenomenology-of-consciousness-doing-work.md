...
Effort phenomenology has a specific structure. It scales with difficulty, can be voluntarily intensified (you can try harder, and the increase is phenomenologically accessible), and feels categorically different from physical exertion. The familiar "it depletes" claim requires qualification: Hagger and colleagues' preregistered 23-laboratory replication (2016, N=2,141) put the ego-depletion effect at d=0.04, straddling zero, and the strength-resource model that explanation rested on collapsed under preregistration. The felt-drained sense survives; its supposed referent — a unitary depleting fuel — appears not to exist as advertised. What that leaves intact is the moment-by-moment phenomenology of effort tracking difficulty, not a longer-arc resource metaphor.

The felt sense is also not a transparent window onto the operation it ostensibly reports on. Three converging lines of evidence in the [mental effort](/concepts/mental-effort/) article establish the dissociation: Naccache and colleagues (2005) report an anterior-cingulate-lesion patient with normal Stroop performance, residual ACC activity, but no felt effort and no skin-conductance coupling — calibration is dissociable. Kurzban (2013) and Inzlicht (2012; 2021) reframe felt effort as an opportunity-cost signal rather than a fuel-gauge readout, and Westbrook and colleagues (2020) show methylphenidate-induced dopamine elevation shifts the felt sense without the introspector noticing the manipulation. These dissociations *constrain* the simplest identity reading without *establishing* the Map's reading — the [constrain-vs-establish](/project/evidential-status-discipline/) discipline the catalogue holds itself to. What survives on the dualist side is the autonomic coupling Naccache found in normals and absent in the patient: felt effort is wired into the regulatory chain, doing causal work even where it does not transparently report on its own machinery.

A physicalist can respond that the brain's resource-monitoring systems generate the feeling of effort regardless of whether a separate non-physical entity is involved. An identity theorist or functionalist can go further: if consciousness just *is* the relevant neural processing, then of course the phenomenology tracks the demand. The most developed version of this reply is active inference, which does not merely assert the coupling but derives it: on Friston's free-energy framework, effort scales with the computational cost of resolving an uncertain policy distribution, so a control theory built on precision-weighting predicts effort tracking cognitive demand as a positive consequence of its formalism (Parr, Pezzulo & Friston 2022). Friston and colleagues build these models on explicitly physicalist foundations and would not endorse the interactionist reading; the point is that identity theory, functional control theory, and predictive processing alike already expect effort and agency phenomenology to track physical demand, so that tracking is not by itself evidence for the Map's account against them. What each of these replies does only by stipulation is bridge the computational cost to the *felt* quality of effort — absorbing phenomenology into physics at the cost of the [hard problem](/topics/hard-problem-of-consciousness/) rather than discharging it. The tracking argument therefore targets epiphenomenalism specifically, not these live physicalist rivals: if consciousness is a byproduct that does nothing, the correlation between felt effort and the autonomic-regulatory pathway it couples to is a brute regularity, whereas identity, functional, and active-inference readings all give it a physical rationale. The Map's framework offers a more direct account: the feeling tracks the load because consciousness is doing some of the work that generates the load. The [type-token distinction](/concepts/type-token-causation/) specifies how this is compatible with physics: felt effort's causal work occurs at the token grain without altering type-level Born-rule statistics, so the tracking is real even though no statistical anomaly would detect it. In practice, [contemplative training](/concepts/meditation-and-consciousness-modes/) *refines* the effort distinction rather than dissolving it — experienced meditators report clearer discrimination between effortful and effortless states (Lutz et al., 2008).
...
The [expanded treatment of introspective opacity](/voids/self-opacity/) distinguishes four dimensions: *temporal opacity* (the act of willing has passed by the time introspection arrives — James compared it to "seizing a spinning top to catch its motion"), *process opacity* (we access products of cognition but never the production), *mechanism opacity* (metacognitive reflection yields descriptions, not mechanisms), and *ontological opacity* (consciousness cannot objectify its own willing without transforming it — Sartre's *pour-soi* applies with particular force to volitional acts).
...
[Voluntary mental imagery](/concepts/mental-imagery/) provides a concrete demonstration of consciousness doing measurable work. Meta-analyses find motor imagery practice produces performance improvements with effect sizes (Cohen's *d*) typically between 0.4 and 0.7 (Driskell et al., 1994; Feltz & Landers, 1983). The improvement depends on the *content* of what is consciously imagined — rehearsing a piano passage improves that passage, not unrelated ones. All four features are present: effort, selection, holding, and opacity (you cannot observe how imagining produces motor improvement). Voluntary imagery is mediated by the lateral prefrontal cortex; involuntary imagery — dreams, flashbacks, earworms — operates independently, and LPFC damage impairs the voluntary system while leaving dreaming intact.

The case admits three positions rather than two. Epiphenomenalism predicts the voluntary/involuntary distinction should be phenomenological decoration on functionally identical processes — and the distinction is plainly more than decoration. Identity theory predicts different effects because voluntary imagery is a distinct neural process, with phenomenology coming along because conscious experience just *is* that neural process. A third option developed in the [imagery article](/concepts/mental-imagery/) — a *trumping* or authority-selecting reading — preserves the neural rehearsal's counterfactual sufficiency while relocating causal authority to the conscious imagining. What needs explaining is whose authority the improvement tracks, not which trajectory it rides, and motor imagery fits that template unusually well. Aphantasics with intact LPFC function offer a potential discriminating test: identity theory predicts unimpaired benefits where neural circuits are preserved; a distinct-causal-property view predicts reduced benefits despite intact circuits. Preliminary self-reports suggest weaker benefits (Dawes et al., 2020), though controlled within-subject studies of both activation and performance do not yet exist. The prediction marks where the dispute could be settled empirically. A further finding extends the profile beyond imagery: aphantasics report having conscious thoughts without sensory accompaniments, evidence for purely [cognitive phenomenology](/concepts/cognitive-phenomenology/) in which effort, selection, holding, and opacity persist without sensory modality.

[Phantom-limb mirror therapy](/topics/phantom-limb-phenomena/) extends the imagery template into clinical territory. Patients imagine moving a limb that does not exist, paired with mirror-supplied visual feedback, and the [pain](/topics/pain-consciousness-and-causal-power/) referred to that limb is modulated. With no peripheral generator at the felt site, the causal pathway runs through what the patient sees and engages with: conscious imagery doing measurable work on nociceptive processing.

### Flow: Work Without Felt Effort

Flow states — total absorption in challenging activity — create an apparent exception to the effort feature. The agent is highly engaged and performing at peak capacity, yet the experience feels effortless. This has led some to argue that effort is not essential to conscious work.
...
Flow thus reveals that the four features are partially dissociable. Selection and holding continue; effort diminishes; opacity persists (the flow practitioner cannot explain how they perform so well). The partial dissociation is informative — it shows that effort phenomenology is not simply "what selecting feels like" but a separate signal tracking the difficulty of maintaining selection under challenging conditions.
