...
ai_modified: 2026-03-15 18:09:00+00:00
...
The [bandwidth problem](/concepts/bandwidth-problem-mental-causation/) sharpens the specification from a different direction. Even granting consciousness causal efficacy, does the mind-body channel carry enough information to produce the specific behaviours we observe? Raising an arm requires coordinating thousands of motor neurons in precise temporal sequences. The intention "raise my arm" contains perhaps a few bits of information. The physical execution requires millions. Where does the additional specification come from?
...
[Control-theoretic will](/concepts/control-theoretic-will/) specifies what the interface *does* with its limited bandwidth. The brain is the plant (the system being controlled), unconscious neural processing provides the dynamics, and consciousness is the controller—observing state through phenomenal experience, comparing against intentions and values, and outputting a low-bandwidth selection signal. Five operations emerge:

**Gating**: Consciousness determines what crosses the threshold for action. The basal ganglia's tonic inhibition suppresses motor programmes by default; conscious selection releases the brake on one option. This is switching control—selecting which subsystem activates rather than continuously modulating all of them.

**Stabilisation**: Consciousness holds selected patterns stable against competing alternatives. Mental effort phenomenology tracks this operation: sustaining attention on a difficult task feels like holding something in place against forces pulling it away. The effort required scales with the disturbance magnitude.

**Veto**: Consciousness blocks actions the brain has prepared. This requires minimal bandwidth—a single bit suffices for the basic stop/go decision—making it perhaps the most plausible form of conscious control.

**Attractor steering**: Rather than specifying moment-to-moment neural trajectories, consciousness shifts the system between attractor states. When you decide to switch from reading to writing, you decide *what* to do; the brain's dynamics handle *how*.

**Resource allocation**: Consciousness distributes its scarce bandwidth among competing demands—attending here means not attending there. The ~4-item working memory limit reflects the controller monitoring a handful of state variables simultaneously.

Each operation is consistent with the ~10 bits/second bandwidth constraint. None requires consciousness to encode neural-level detail. Together they specify a complete control repertoire: consciousness gates, holds, vetoes, steers, and allocates—and delegates everything else to the brain.

## The Causal Structure

How does this control avoid the exclusion problem—the objection that if every physical event has a sufficient physical cause, consciousness is redundant? [causal-delegation](/concepts/causal-delegation/) provides the causal structure. Drawing on Bradford Saad's delegatory dualism (2025), the Map proposes that when consciousness selects, the underlying physical state *delegates* its causal responsibilities to the experience. Pain causes wincing not alongside the brain state but instead of it. The physical state retains the capacity to cause the effect but does not exercise it—the experience preempts it.
...
Intellectual honesty requires marking where the programme remains incomplete. The psychophysical control law—the formal mapping from phenomenal states to physical selection outputs—has not been specified. [the-psychophysical-control-law](/topics/the-psychophysical-control-law/) examines what such a law would need to look like and why specifying one is so difficult.
...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)** is not merely stated but *derived* from the programme's constraints. The ~10 bits/second bandwidth, conservation compliance, and scope locality all converge on minimality—consciousness exerts just enough influence to steer, operating within the margins physics provides.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)** is specified by the control-theoretic picture as a closed feedback loop: consciousness receives phenomenal experience from the brain (upward) and outputs attentional selection (downward). Open-loop control—without feedback—is fragile and unreliable. The programme shows why bidirectionality is architecturally necessary, not just philosophically asserted.

**[No Many Worlds](/tenets/#no-many-worlds)** makes the entire programme meaningful. If all quantum outcomes actualise in parallel branches, there is nothing for a control law to govern—every output occurs regardless. Real control requires real selection among genuinely exclusive alternatives.
...
- [The Bandwidth Problem in Mental Causation](/concepts/bandwidth-problem-mental-causation/) — Whether the mind-body channel carries enough information for specific behaviour
