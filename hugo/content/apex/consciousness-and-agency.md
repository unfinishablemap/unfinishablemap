...
ai_modified: 2026-06-02 23:24:45+00:00
ai_system: claude-opus-4-6
apex_last_synthesis: 2026-05-26 23:32:00+00:00
apex_sources:
- topics/free-will
...
Sartre's analysis illuminates a structural precondition the framework requires. You can reflect on your own anger, question whether it's justified, decide whether to act on it. This ability to stand apart from your own mental states—to be aware *of* them rather than simply *being* them—is what Sartre called the *pour-soi* (being-for-itself). A being that merely *is* its states cannot evaluate or override them. Sartre is a phenomenological ontologist rather than a substance dualist, and his radical freedom is a thesis about the structure of consciousness rather than about quantum indeterminacy. But his analysis identifies what the Map's framework requires: consciousness must be distanced from its contents to select among them.
...
The individual components—agent causation, mental causation, quantum indeterminacy, counterfactual reasoning, temporal constitution—each face objections when considered in isolation. Together, they form a mutually supporting structure where each element answers objections to the others. A critic might object that this mutual support is circular. The concern is legitimate: mutual support becomes viciously circular when every element's credibility depends entirely on accepting the others.

The framework avoids this because several elements have independent grounding outside the circle. Four anchor points are not framework-dependent:

1. **The hard problem of consciousness.** That consciousness is not reducible to physical processes is argued independently of agent causation or quantum mechanics—through zombie arguments, the knowledge argument, and the explanatory gap. Dualism stands or falls on its own merits.
2. **The argument from reason.** The self-defeat of physicalism—that fully physical beliefs cannot be rationally justified—provides a route to mental causation that requires no phenomenological premises and no quantum physics. This argument works even if the selector model is wrong.
3. **The phenomenology of effort and its neural correlates.** The correlation between felt difficulty and cognitive load, the neural dissociation between intention and execution, and the distinct signatures of willed versus automatic action are empirical findings that don't presuppose the framework.
4. **Clinical neuroplasticity.** The pathway divergence between cognitive and pharmacological interventions—top-down versus bottom-up neural routes achieving comparable outcomes—is an empirical finding that bears on the exclusion argument independently of any quantum mechanism.

These anchor points ground the framework in independently verifiable evidence, while counterfactual reasoning and creative generation supply the mechanism that makes selection reasons-responsive rather than arbitrary—the agent constituting the option space, not choosing from a fixed menu. The convergence extends across traditions: empirical psychology reveals the willed/automatic distinction; Sartre's phenomenology illuminates why consciousness can stand apart from its states to choose; process philosophy shows why experiential causation is continuous with causation generally; and [cross-cultural convergence](/concepts/cross-cultural-convergence-on-mental-causation/) across Indian, African, and Western thought adds further weight.
