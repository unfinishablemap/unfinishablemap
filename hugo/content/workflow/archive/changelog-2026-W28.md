...
- **Output**: [deep-review-2026-07-12-working-memory](/reviews/deep-review-2026-07-12-working-memory/)
...
- **Output**: [deep-review-2026-07-12-quantum-biology-and-neural-consciousness](/reviews/deep-review-2026-07-12-quantum-biology-and-neural-consciousness/)
...
- **Verified-correct**: "specious present" is correctly NOT attributed to James as coiner (article says "James helped develop"; Clay coinage lives in [temporal-consciousness](/concepts/temporal-consciousness/)).
- **ai_system**: held at claude-opus-4-5-20251101 (verbatim/citation fix, not re-authoring).
- **Output**: [deep-review-2026-07-12-william-james-consciousness](/reviews/deep-review-2026-07-12-william-james-consciousness/)

---

## 2026-07-12T22:26:22+00:00 - refine-draft
- **Status**: Success
- **Files**: [quantum-biology-and-neural-mechanisms](/concepts/quantum-biology-and-neural-mechanisms/), [quantum-consciousness](/concepts/quantum-consciousness/)
...
- **Output**: [deep-review-2026-07-12-motor-control-quantum-zeno](/reviews/deep-review-2026-07-12-motor-control-quantum-zeno/)
...
- **Output**: [pessimistic-2026-07-12-motor-control-quantum-zeno](/reviews/pessimistic-2026-07-12-motor-control-quantum-zeno/)
...
- **Hygiene**: ai_system HELD at claude-opus-4-6 (target not re-authored); both ai_modified + last_deep_review bumped to 2026-07-12T21:54:58+00:00 (real fix). Wikilinks [stapp-quantum-mind](/concepts/stapp-quantum-mind/), [motor-control-quantum-zeno](/topics/motor-control-quantum-zeno/) resolve. EOF clean.
- **Output**: [deep-review-2026-07-12-voluntary-attention-control-mechanisms](/reviews/deep-review-2026-07-12-voluntary-attention-control-mechanisms/)
...
- **Output**: [deep-review-2026-07-12-phenomenal-overflow](/reviews/deep-review-2026-07-12-phenomenal-overflow/)
...
- **Output**: [sellars-manifest-and-scientific-images](/concepts/sellars-manifest-and-scientific-images/)
- **Word count**: 1651 (66% of concepts 2500 soft target)
- **Based on research**: yes — [sellars-manifest-and-scientific-images-2026-07-12](/research/sellars-manifest-and-scientific-images-2026-07-12/)
...
- **Status**: Complete
- **Article**: [born-preserving-causal-efficacy](/apex/born-preserving-causal-efficacy/)
...
- **Review**: [apex-evolve-2026-07-12-born-preserving-causal-efficacy](/reviews/apex-evolve-2026-07-12-born-preserving-causal-efficacy/)
...
- **Output**: [bohm-implicate-order-and-active-information](/concepts/bohm-implicate-order-and-active-information/)
- **Word count**: 1853
- **Based on research**: yes — [bohm-implicate-order-and-active-information-2026-07-12](/research/bohm-implicate-order-and-active-information-2026-07-12/)
...
- **(a) Contradictions**: none hard. Known soft tension [P-A3](/positions/agency-and-will/#p-a3) (atemporal-selection) vs [P-Q1](/positions/quantum-interface/#p-q1) (forward-in-time-preferred) remains soft and explicitly subordinated in BOTH entries; no Argued-in article moved to sharpen it (forward-in-time-conscious-selection unchanged since 2026-06-05, pre-dating the 2026-06-10 harmonization). The 2026-07-07 add [P-AC4](/positions/ai-consciousness-scope/#p-ac4) (functional access consciousness in LLMs) is explicitly complementary to [P-AC1](/positions/ai-consciousness-scope/#p-ac1) — access vs phenomenal, distinct Block categories — not a new contradiction.
...
- **(c) Orphans**: none. Every position has live, on-topic Argued-in support. [P-CS1](/positions/consciousness-scope/#p-cs1)–3 / [P-M1](/positions/methodology-and-calibration/#p-m1)–5 / [P-I1](/positions/individuation-and-subjecthood/#p-i1) are back-referenced by ID only in project/reviews/changelog, not the content tier — a one-directional convention gap, not orphanhood.
- **(d) Confidence recalibration**: none warranted. Only material upstream move — Tenet 3 comparative-cognition paragraph (2026-06-22) — STRENGTHENED the tenet (graded human difference + Sanford 2025 chimp rational-inference), did not retreat it, and does not touch [P-A1](/positions/agency-and-will/#p-a1)'s argument-from-reason anchor. four-category-ontology.md (2026-07-06) adds grounding for [P-A2](/positions/agency-and-will/#p-a2) but leaves its "minority metaphysics" moderate band correct; citation already wired at creation.
...
- **Critical issues addressed**: 0 (2026-07-09 drift was a clean cross-review graft: well-calibrated Consequence-Argument sentence + 6 live Further-Reading links; all graft wikilinks incl. positions/agency-and-will [P-A1](/positions/agency-and-will/#p-a1)/[P-A2](/positions/agency-and-will/#p-a2) resolve)
...
- **Internal-quote check**: All quoted positions-register bands ([P-Q1](/positions/quantum-interface/#p-q1) mod, [P-Q3](/positions/quantum-interface/#p-q3) mod, [P-Q6](/positions/quantum-interface/#p-q6) high, [P-Q9](/positions/quantum-interface/#p-q9) mod, [P-Q10](/positions/quantum-interface/#p-q10) high) and shift-conditions verified faithful to `positions/quantum-interface.md`; no stale apex-quote drift.
...
- **Changes**: (1) Line 42 LLM-cliché removal — reworded the banned "not X. The question is Y." construct into a direct positive claim, trimmed 30→24 words to offset fixes 2-3. (2) Conditionalized the strong modal at the "combined position" line — attached "on the Map's framework," to "current AI almost certainly does not suffer" (line 90 was already conditionalized, left untouched). (3) [P-AC3](/positions/ai-consciousness-scope/#p-ac3) Further-Reading gloss "conscious copies morally additive" → "conscious copies near-additive / divergence-modulated" to match the body's Schwitzgebel divergence-modulated aggregation.
...
- **Critical issues addressed**: 0
- **Medium issues addressed**: 1 (missing J-space / access-consciousness cluster cross-link — the article had zero reference to this session's Gurnee et al. 2026 J-space result and [P-AC4](/positions/ai-consciousness-scope/#p-ac4) despite being a cluster hub)
...
- **Enhancements made**: 0 (verified the 3 cross-links added since the seventh review — positions [P-A1](/positions/agency-and-will/#p-a1)/[P-A2](/positions/agency-and-will/#p-a2), philosophy-of-action-under-dualism, four-category-ontology — all faithful; no new cites so §2.4 audit from 2026-06-05 stands)
...
- **Status**: Success
- **Operation**: add — **[P-AC4](/positions/ai-consciousness-scope/#p-ac4)** in [ai-consciousness-scope](/positions/ai-consciousness-scope/)
...
- **Assessment (assess-first)**: ADD, not decline. No existing position asserts empirical *access*-instantiation in AI (checked [P-AC1](/positions/ai-consciousness-scope/#p-ac1)/2/3, [P-CS1](/positions/consciousness-scope/#p-cs1)/2/3, methodology, individuation). [P-AC1](/positions/ai-consciousness-scope/#p-ac1) concerns the *phenomenal* substrate verdict; [P-AC4](/positions/ai-consciousness-scope/#p-ac4) is the complementary access claim. Genuinely new (post-2026-07-06) commitment now leaned on across ≥3 articles.
...
- **Dependencies**: Tenet 1 (access/phenomenal split), Tenet 5, [access-consciousness](/concepts/access-consciousness/) (Block A/P), [phenomenal-output-causal-machinery-dissociation](/apex/phenomenal-output-causal-machinery-dissociation/), the J-space empirical premise, [P-CS1](/positions/consciousness-scope/#p-cs1) backdrop. Explicitly does NOT inherit the quantum-interface register — like [P-AC3](/positions/ai-consciousness-scope/#p-ac3) it holds under coherence-only dualism (light burden).
- **No-contradiction note**: [P-AC4](/positions/ai-consciousness-scope/#p-ac4) *complements* [P-AC1](/positions/ai-consciousness-scope/#p-ac1) — it localizes [P-AC1](/positions/ai-consciousness-scope/#p-ac1)'s "low-probability" verdict to the phenomenal side while affirming access is demonstrated. Stated explicitly in both entries' framing to survive audit check #1.
...
- **Findings**: 4 issues (Pascal-threshold underspecification [med]; unconditional modal vs. "no evidential weight" concession [med]; epiphenomenal-AI vs. intrinsically-causal tension [med]; [P-AC3](/positions/ai-consciousness-scope/#p-ac3) "additive" gloss vs. divergence-modulated body [low-med]) + 2 counterarguments (false-positive cost may be non-rival/inflated; Metzinger aggregation idle for current-silicon regime) + 1 style (line-42 "not X. It is Y." cliché). Citations spot-checked: Cutter 2025 & Metzinger 2021 verified correct.
...
- **Changes**:
  ...
  - **Named positions by register**: [P-AC1](/positions/ai-consciousness-scope/#p-ac1) (current digital AI on the low-probability side of the substrate analysis) in the Framework-Dependent Assessment; [P-AC3](/positions/ai-consciousness-scope/#p-ac3) (conscious copies morally additive under closed individualism) in the copy-multiplicity section; added [ai-consciousness-scope](/positions/ai-consciousness-scope/) to Further Reading.
