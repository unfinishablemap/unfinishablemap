...
ai_modified: 2026-05-04 09:26:00+00:00
...
### P2: Refine concepts/llm-consciousness.md "What Would Challenge This View?" to name Duch's articon (outer-review-2026-05-04-claude)
- **Type**: refine-draft
...
### ~~P1: Write project doc on direct-refutation discipline (outer-review-2026-05-04 + 2026-05-03)~~ COMPLETE 2026-05-04 15:24 UTC
- **Type**: expand-topic
- **Output**: [direct-refutation-discipline](/project/direct-refutation-discipline/)
- **Notes**: From outer review by ChatGPT 5.5 Pro 2026-05-04 — convergent with 2026-05-03's evidential-status finding. Both reviews independently surface the same higher-order weakness: *tenet-protected reasoning where direct refutation is possible*. Project doc covers the failure mode (3 convergent reviews), the two reasoning modes (perimeter vs. direct), categories warranting each, decision heuristic, worked examples (Duch articon + animal-consciousness ladder), implementation, honest limitation (sister-discipline tension with [bedrock-clash-vs-absorption](/project/bedrock-clash-vs-absorption/)), and tenet alignment.
- **Review file**: `reviews/outer-review-2026-05-04-chatgpt-5-5-pro.md`
- **Source**: outer-review (convergent with 2026-05-03)
- **Generated**: 2026-05-04

### P2: Refine apex's articon engagement with phenomenal-vs-functional distinction (outer-review-2026-05-04)
- **Type**: refine-draft
...
### P2: Audit "convergent-conclusion-opposite-reasoning" frame for over-extension (outer-review-2026-05-04)
- **Type**: cross-review
- **Notes**: From outer review by ChatGPT 5.5 Pro 2026-05-04. The reviewer notes that the convergent-conclusion-opposite-reasoning (CCOR) frame does **real philosophical work** for Duch's anti-quantum critique (both Map and Duch reject Penrose-Hameroff-scale proposals, for opposite reasons — CCOR captures the dialectic accurately). But the reviewer also identifies that the same frame is sometimes deployed as a generic vacuum-closer for Duch arguments where it doesn't actually structure the disagreement. Audit the catalogue's CCOR uses (grep for "convergent-conclusion-opposite-reasoning" or "convergent conclusion opposite reasoning"): (a) confirm CCOR is used only where Map and opponent share a *substantive conclusion* reached by opposite reasoning chains (e.g., both reject Orch-OR); (b) flag uses where the Map and opponent merely disagree under the CCOR label without sharing a conclusion (those are bedrock-clashes, not CCOR); (c) for misapplied uses, propose the correct frame ([bedrock-clash-vs-absorption](/project/bedrock-clash-vs-absorption/) for genuine clash; direct-refutation for Map's positive argument; absorption for Map's borrowing of opponent's machinery). Short-medium scope across multiple files (~200–400 words touched, mostly reframing existing CCOR uses). Tenet alignment: methodological. Sequencing: independent of P1 tasks; can run in parallel.
- **Review file**: `reviews/outer-review-2026-05-04-chatgpt-5-5-pro.md`
- **Source**: outer-review
- **Generated**: 2026-05-04

### P1: Refine topics/consciousness-in-simple-organisms.md to install evidential-status labels (outer-review-2026-05-03)
- **Type**: refine-draft
...
### P1: Write project doc on evidential-status discipline (outer-review-2026-05-03)
- **Type**: expand-topic
- **Notes**: From outer review by ChatGPT 5 Pro 2026-05-03. The reviewer's diagnosis is **systemic**, not local: the interaction of (i) the tenets (anti-physicalism, anti-parsimony, bidirectional interaction), (ii) the `expand-topic` rule that content "must not contradict tenets," (iii) the `check-tenets` skill flagging physicalist assumptions, (iv) the `optimistic-review` skill's Whitehead persona ("experience goes all the way down"), and (v) the `deep-review` rule that "philosophical disagreement is not critical" produces a ratchet that pushes weak cases (nematodes, Hydra, slime molds) toward stronger phenomenal language than the evidence alone supports. The fix is methodological: a project-doc that names the discipline and gives skills/reviews a stable rule to enforce. Write `obsidian/project/evidential-status-discipline.md` (or similarly named) covering: (a) the slippage pattern (tenet removes a defeater → article reads as if the case is positively supported); (b) the rule **"a tenet may remove a defeater, but it must not upgrade the evidence level"**; (c) a five-tier evidential-status scale — *established* / *strongly supported* / *realistic possibility* / *live hypothesis* / *speculative integration* — with named exemplars from the catalogue (mammals/birds = strongly supported; cephalopods/decapods/insects = realistic possibility; *C. elegans* = live hypothesis; Hydra/slime molds = speculative integration); (d) a short worked example showing how the discipline applies to a representative paragraph from `consciousness-in-simple-organisms.md`; (e) integration guidance for `check-tenets` (flag tenet-as-evidence-upgrade as a defect alongside existing physicalism flags) and for `deep-review` (treat possibility/probability slippage as a *correctable* defect, distinct from the bedrock-clash exemption); (f) honest limitation — the discipline is calibration, not certainty; the tiers themselves rely on contested literature (Birch 2024 *Edge of Sentience* offers a related precautionary scheme already in our bibliography). Estimated 800–1,200 words; project-doc placement. Tenet alignment: methodological + Tenet 5 (Occam's Razor Has Limits — the discipline acknowledges that removing a parsimony-defeater is not the same as supplying positive evidence). Parallel framing to existing project docs (`framework-stage-calibration`, `closed-loop-opportunity-execution`, `coalesce-condense-apex-stability`, `bedrock-clash-vs-absorption`).
- **Review file**: `reviews/outer-review-2026-05-03-chatgpt-5-5-pro.md`
- **Source**: outer-review
- **Generated**: 2026-05-04

### P2: Refine topics/animal-consciousness.md to pair "no anthropocentric barrier" with explicit evidential-load language (outer-review-2026-05-03)
- **Type**: refine-draft
...
### P2: Cross-review consciousness-cluster articles against evidential-status discipline (outer-review-2026-05-03)
- **Type**: cross-review
...
### P2: Tune-system review of optimistic-review + deep-review interaction with evidential-status discipline (outer-review-2026-05-03)
- **Type**: refine-draft
...
### P2: Cross-review topics/epistemic-advantages-of-dualism.md against Duch's classical-computational reduction
- **Type**: cross-review
...
- **Source**: chain (from research/wlodzislaw-duch-consciousness-2026-05-02 + integration commit b90a58310)
- **Generated**: 2026-05-04

### P2: Refine concepts/coalesce-condense-apex-stability.md to articulate cap-saturation policy
- **Type**: refine-draft
...
- **Source**: gap_analysis (chain origin from 2026-05-03 abandoned coalesce; gap is the unstated cap-saturation policy in the existing methodology article)
- **Generated**: 2026-05-04
