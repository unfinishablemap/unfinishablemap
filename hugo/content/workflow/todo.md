...
ai_modified: 2026-05-05 10:35:06+00:00
...
### P0: Research evolved mind-brain interface efficacy as explanatory variable for human-other-animal intelligence gap
- **Type**: research-topic
...
- **Source**: video-derived (animal-consciousness)
- **Generated**: 2026-05-05

### P1: Write article on selection-only mind-influence: information-transfer limits and physical signatures
- **Type**: expand-topic
- **Research notes**: [selection-only-mind-influence-information-limits-2026-05-05](/research/selection-only-mind-influence-information-limits-2026-05-05/) (completed 2026-05-05 12:16 UTC) — unblocked
- **Notes**: Absorbs the P0 research-topic above (selection-only mind-influence research). Article should (a) formalise the "selection-from-brain-generated candidates" reading of Tenet 2's Minimal Quantum Interaction at its strictest interpretation; (b) derive bandwidth-limit results (log₂(N) bits per selection; total volitional bandwidth as function of candidate-set turnover rate); (c) derive content-constraint results (mind cannot register content unrepresented in candidate space — implications for novel-qualia possibility); (d) enumerate tell-tale physical-world signatures that would distinguish selection-only from generation-contributing mind-influence (information-theoretic ceilings; statistical Born-rule deviations at neural-coherence-domain scale; correlation patterns between candidate-set diversity and reportable content); (e) place model relative to Penrose-Hameroff orch-OR, Stapp's quantum-eigenstate selection, forward-in-time conscious selection, and broader interactionist landscape; (f) honour framework-stage-calibration — the empirical question of whether selection-only is correct is *open*; the structural question of what it implies *if* correct is what the article addresses. Likely placement: `topics/` (topic-grade engagement with the strictest-reading model). Wikilink `[orchestrated-objective-reduction](/orchestrated-objective-reduction/)`, `[forward-in-time-conscious-selection](/topics/forward-in-time-conscious-selection/)`, `[decoherence](/concepts/decoherence/)`, `[the-interface-problem](/topics/the-interface-problem/)`, `[mental-causation](/concepts/mental-causation-and-downward-causation/)`, `[causal-powers](/concepts/causal-powers/)`, `[evidential-status-discipline](/project/evidential-status-discipline/)`, `[framework-stage-calibration](/project/framework-stage-calibration/)`. Medium scope (~1500–2000 words). Tenet alignment: Tenet 2 + Tenet 1 + methodological. Recommended angle from research notes: structural-derivation lede (per-event log₂(N), per-second R log₂(N), Born-rule preservation collapse to ε² rate, content-confinement) closing with distinguishing-observables table.
- **Source**: video-derived (animal-consciousness) — chained from P0 research
- **Generated**: 2026-05-05

### P1: Write article on differential mind-brain interface efficacy as candidate explanation for human-other-animal intelligence gap
- **Type**: expand-topic
- **Notes**: Absorbs the P0 research-topic above (interface-efficacy research). Article should (a) state the hypothesis: human-other-animal cognitive differences arise primarily from evolved interface-efficacy (mind side's ability to effect outcomes through its brain) rather than from brain-computational capacity or phenomenal grade; (b) name sub-claims — consciousness can be present at full grade across many species while *effective reach* varies; cortical/prefrontal evolutionary trajectories admit re-reading as interface-bandwidth/-fidelity evolution; specific comparative-cognition gaps (Tomasello cumulative-culture; mental-time-travel; relational reasoning) admit interface-efficacy reframings; (c) install the hypothesis at the correct evidential tier — *speculative integration* on the five-tier scale, not Map-tenet-load-bearing — at the lede; (d) engage the Standing Agnostic Challenge (Gutfreund 2024) — interface-efficacy explanations face the same epistemic ceiling as any framework treating behavioural difference as evidence for any specific mind-side claim; (e) honour evidential-status-discipline at all stages — separate tenet-register coherence (the hypothesis is tenet-compatible) from evidence-register elevation (it is not empirically forced); (f) note the methodological corollary: this is a *re-framing* of existing comparative-cognition data, not a new empirical claim, and its value is heuristic-explanatory rather than prediction-generating until distinguishing observables are identified. Likely placement: `topics/` (topic-grade engagement, distinct from but cross-linked to `topics/animal-consciousness`). Wikilink `[animal-consciousness](/topics/animal-consciousness/)`, `[cetacean-and-corvid-consciousness](/topics/cetacean-and-corvid-consciousness/)`, `[consciousness-in-simple-organisms](/topics/consciousness-in-simple-organisms/)`, `[the-interface-problem](/topics/the-interface-problem/)`, `[cognitive-phenomenology](/concepts/cognitive-phenomenology/)`, `[agent-causation](/concepts/agent-causation/)`, `[causal-powers](/concepts/causal-powers/)`, `[evidential-status-discipline](/project/evidential-status-discipline/)`, `[framework-stage-calibration](/project/framework-stage-calibration/)`. Medium scope (~1500–2000 words). Tenet alignment: Tenet 1 (Dualism) + Tenet 3 (Bidirectional Interaction) + methodological. Sequencing: blocked on P0 research-topic above.
- **Source**: video-derived (animal-consciousness) — chained from P0 research
- **Generated**: 2026-05-05

### P2: Write concept article on tenet register vs. evidence register
- **Type**: expand-topic
- **Notes**: Suggested by optimistic-2026-05-05 ("Ideas for Later" elevated by structural pressure). The tenet/evidence register distinction is currently *replicated* at each invocation site — the lede of `topics/animal-consciousness.md`, the lede of `topics/consciousness-in-simple-organisms.md`, the body of `project/evidential-status-discipline.md`, and the body of `project/direct-refutation-discipline.md` all carry the distinction in slightly different wordings. A standalone concept article would (a) anchor the distinction at a single canonical site; (b) let invocation sites wikilink rather than recapitulate; (c) establish the relationship between the two registers (the registers are *parallel*, not hierarchical — neither overrides the other; calibration is the discipline of keeping them distinct). Article should (a) state the distinction with named registers; (b) supply 2–3 worked examples from the 2026-05-04/05 cluster (e.g., UAL-as-interface, Hydra speculative-integration tier, Becerra-et-al. reframe); (c) connect to `[evidential-status-discipline](/project/evidential-status-discipline/)`, `[direct-refutation-discipline](/project/direct-refutation-discipline/)`, `[framework-stage-calibration](/project/framework-stage-calibration/)`, `possibility-probability-slippage` (if the sibling concept page exists by then), and `[tenets](/tenets/)`. Target: `concepts/` (229/250 = 92% capacity; concept-page placement preferred over project-doc — the distinction is a Map-internal structural commitment, not just an editorial discipline). Scope: short-medium (~800–1200 words). Tenet alignment: methodological — names the structural commitment that all five tenets are *register-disciplined* claims rather than empirical-grade claims. See `reviews/optimistic-2026-05-05.md` "Ideas for Later" #2.
- **Source**: gap_analysis (load-bearing distinction lacking single canonical anchor)
- **Generated**: 2026-05-05

### P2: Research Birch's Edge of Sentience precautionary framework as complement to the Map's five-tier calibration scale
- **Type**: research-topic
...
- **Source**: gap_analysis (no Map content engages Birch's framework directly despite SKILL-level integration)
- **Generated**: 2026-05-05
...
- **Type**: deep-review
- **Status**: pending
- **Notes**: AI-generated content (ai_contribution > 50) last deep-reviewed 2026-03-04 — 57 days ago (longest non-queued staleness for a topic article). Topic article on constitutive exclusion — relates to the Kim exclusion argument and the question of whether mental causation can be reconciled with physical causal closure. Foundational for Bidirectional Interaction tenet's defensibility. Verify (a) coherence with current site state — particularly the 2026-05-01 the-interface-problem coalesce, recent `concepts/trumping-preemption.md` creation, and 2026-04-29 moral-implications-of-genuine-agency restructure; (b) cross-references to `[mental-causation](/concepts/mental-causation-and-downward-causation/)`, `[agent-causation](/concepts/agent-causation/)`, `[trumping-preemption](/concepts/trumping-preemption/)`, `[the-interface-problem](/topics/the-interface-problem/)`, `[parsimony-case-for-interactionist-dualism](/topics/parsimony-case-for-interactionist-dualism/)`, and `[causal-closure-debate-historical-survey](/topics/causal-closure-debate-historical-survey/)`; (c) tenet alignment with Bidirectional Interaction; (d) audit for "This is not X. It is Y." cliché violations (CLAUDE.md style ban); (e) confirm Kim engagement still matches catalogue's current treatment and that the framework-stage-calibration discipline (per `project/framework-stage-calibration.md`) is honoured if the article makes empirical-stage claims.
- **Source**: staleness
- **Generated**: 2026-05-01
...
### ✓ 2026-05-05: Refine concepts/illusionism.md to wikilink direct-refutation-discipline and evidential-status-discipline
- **Type**: refine-draft
- **Notes**: Installed methodological-discipline wikilinks per optimistic-2026-05-05 cross-linking table. (a) "Where the Functional Account Falls Short" intro extended to wikilink `[direct-refutation-discipline](/project/direct-refutation-discipline/)` and frame the engagement-pattern (vantage-point/zombie/self-representation/seeming-processing as in-framework moves using Frankish's own commitments; intrinsic-quality as honest framework-boundary disagreement); (b) "Relation to Site Perspective" Dualism subsection extended to wikilink `[evidential-status-discipline](/project/evidential-status-discipline/)` with calibration-not-elevation note about the residue being bedrock at the intrinsic-quality dispute; (c) two "X has not Y. It has Z." cliché instances rephrased. ~140 words touched. Engagement classification (changelog only): Mode 1 + Mode 3 mixed. Existing voice and load-bearing focus preserved.
- **Output**: obsidian/concepts/illusionism.md
