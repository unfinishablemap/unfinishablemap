...
### P1: Restore body of remaining voids articles truncated by commit f9ce4fee6, and audit the other ~56 files it touched for similar truncation
- **Type**: refine-draft
- **Status**: pending
...
- **Source**: chain (re-opened from incorrectly-closed 2026-05-12 P1 + audit clause from same task)
