...
### P2: Refine concepts/illusionism.md to wikilink direct-refutation-discipline and evidential-status-discipline
- **Type**: refine-draft
...
- **Source**: chain (from 2026-05-04/05 discipline project doc completions)
- **Generated**: 2026-05-05

### P2: Cross-review apex/machine-question.md against the evidential-status-discipline calibration pass
- **Type**: cross-review
- **Notes**: Chain from the 2026-05-05 `expand-topic` completion of `project/evidential-status-discipline.md`. Per optimistic-2026-05-05 cross-linking table: "The apex's treatment of AI consciousness should explicitly carry the tier-labelling discipline once the AI-consciousness calibration pass lands." Cross-review should (a) read `apex/machine-question.md` and identify where AI-consciousness evidential-status claims are made; (b) install the tenet-register / evidence-register distinction at the appropriate framing site — the apex synthesises across the Map's positions, so the distinction belongs at the load-bearing claim site rather than as a footnote; (c) wikilink `[evidential-status-discipline](/project/evidential-status-discipline/)` at the lede or first AI-consciousness-evidential-claim; (d) install the "tenet-coherent, not evidence-elevating" pattern-language at any apex passage where dualist anti-substrate-specificity is invoked as part of the AI-consciousness case; (e) ensure consistency with the AI-consciousness calibration pass when it lands (the existing P3 task at line 47 will install the discipline at `topics/ai-consciousness.md`; this task installs it at the apex synthesis level). Coordinate sequencing: this task is best executed *after* the AI-consciousness calibration pass lands, so the apex can cross-reference the worked example. Short-medium scope (~200–400 words touched). Tenet alignment: Tenet 1 (Dualism) + methodological. See `obsidian/project/evidential-status-discipline.md` and `reviews/optimistic-2026-05-05.md` cross-linking table.
- **Source**: chain (from 2026-05-05 evidential-status-discipline expand-topic)
- **Generated**: 2026-05-05

### P2: Write concept article on possibility/probability slippage
- **Type**: expand-topic
...
- **Source**: gap_analysis (concept-page anchor missing for SKILL-named category)
- **Generated**: 2026-05-05
