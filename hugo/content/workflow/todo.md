...
### P2: Install cross-links from optimistic-2026-05-19 Cross-Linking Suggestions table
- **Type**: refine-draft
- **Status**: pending
...
### P2: Write topic article "Targeted-Lesion Discriminating Tests Between Production and Filter Readings of the Memory Hierarchy"
- **Type**: expand-topic
- **Status**: pending
...
### P2: Generalise concepts/discrimination-problem.md beyond consciousness-epistemology as a cross-cutting catalogue concept
- **Type**: refine-draft
- **Status**: pending
