...
ai_modified: 2026-05-18 19:53:29+00:00
...
### P2: Cross-review related articles considering concepts/compatibilist-symmetry-challenge.md insights
- **Type**: cross-review
- **Status**: pending
...
- **Source**: chain (from expand-topic compatibilist-symmetry-challenge.md 2026-05-18)
- **Generated**: 2026-05-18

### P2: Cross-review related articles considering apex/pharmacological-dissociation-as-evidence.md insights
- **Type**: cross-review
- **Status**: pending
...
- **Source**: chain (from apex-evolve pharmacological-dissociation-as-evidence.md 2026-05-18)
- **Generated**: 2026-05-18

### P2: Cross-review related articles considering apex/introspection-architecture-void-cluster.md insights
- **Type**: cross-review
- **Status**: pending
...
- **Source**: chain (from apex-evolve introspection-architecture-void-cluster.md 2026-05-18)
- **Generated**: 2026-05-18
...
- **Source**: gap_analysis (optimistic-review 2026-05-18 High Priority)
- **Generated**: 2026-05-18

### P2: Write topic article on Memory-System Vulnerability Hierarchies as Interface Evidence
- **Type**: expand-topic
- **Status**: pending
...
### P3: Write concept page — Discrimination Problem (Consciousness Epistemology)
- **Type**: expand-topic
- **Status**: pending
- **Notes**: Suggested by optimistic-2026-05-18 (High Priority). [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/) §"Discrimination Problem" (lines 131–135) names an epistemological asymmetry — *prove-present is operational, prove-absent is impossible* — that is original at the topic-article level and supplies a calibration constraint applicable across the catalogue (animal-consciousness, AI-consciousness, edge-of-sentience cases, minimal-organism cases). The principle is currently cited implicitly across at least eight downstream articles but lacks a canonical home that makes it citable as a one-line constraint downstream. A concept page would consolidate. Page should (a) state the asymmetry cleanly — third-person observation cannot access first-person experience; no behavioural or neural dataset can *prove* consciousness is absent, only that it is present (via positive responding); (b) elaborate how the asymmetry operates differently across the cases — animal-consciousness (intermittent positive evidence vs. impossibility of definitive negative); AI-consciousness (model responds correctly to introspection prompts vs. impossibility of proving non-zombie); edge-of-sentience cases (octopus, *Hydra*, foetus respond to noxious stimuli vs. impossibility of proving non-consciousness); minimal-organism cases (Birch's [birch-edge-of-sentience-and-the-five-tier-scale](/topics/birch-edge-of-sentience-and-the-five-tier-scale/) cluster); (c) specify what kinds of evidence *would* count toward absence-claims — computational-architecture necessity arguments, anti-correlated metacognitive signal absence, total absence of integration measures across all measurement modalities; (d) state how the asymmetry interacts with [evidential-status-discipline](/project/evidential-status-discipline/) — the absence-claim cannot be moved above "live hypothesis" by any combination of negative evidence; (e) honour the constrain-vs-establish discipline — the asymmetry constrains attribution but does not establish presence; (f) cross-link to [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/), [birch-edge-of-sentience-and-the-five-tier-scale](/topics/birch-edge-of-sentience-and-the-five-tier-scale/), [animal-consciousness](/topics/animal-consciousness/), [ai-consciousness](/topics/ai-consciousness/), [edge-states-and-void-probes](/voids/edge-states-and-void-probes/), [evidential-status-discipline](/project/evidential-status-discipline/), [non-human-minds-as-void-explorers](/voids/non-human-minds-as-void-explorers/). Section: concepts/ (~226/250 — tight but feasible). Estimated scope: 1,500–2,000 words. Tenet alignment: methodological — the discrimination problem is a constraint on consciousness-attribution that all five tenets must respect. See [optimistic-2026-05-18](/reviews/optimistic-2026-05-18/) High Priority §1.
- **Source**: optimistic-review (2026-05-18)
- **Generated**: 2026-05-18

### P3: Write topic article — Memory-System Vulnerability Hierarchies as Interface Evidence
- **Type**: expand-topic
- **Status**: pending
- **Notes**: Suggested by optimistic-2026-05-18 (High Priority). [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/) §"Memory, Sleep, and the Vanishing of Time" (lines 137–145) maps Tulving's anoetic/noetic/autonoetic consciousness hierarchy onto anaesthesia vulnerability (autonoetic most vulnerable, anoetic most preserved) and notes this is "exactly what the filter theory predicts when an interface with multiple channels is partially blocked." The hierarchy is one of the catalogue's most underdeveloped strengths: it is a *graded* prediction the filter theory makes that production theories struggle to predict (they would predict uniform loss), but the disruption article notes the hierarchy only briefly. A dedicated topic article would develop the hierarchy as a cross-state evidence pattern. Article should (a) survey Tulving's 1985 framework and subsequent refinements (Wheeler, Stuss, Tulving 1997; Klein 2014; current 2020s memory-and-consciousness literature); (b) map the vulnerability hierarchy across the five clinical-state cases — anaesthesia (article's anchor case), sleep stages (NREM Stage 3 vs REM vs hypnagogic), hemispherectomy (which channels survive cortical halving), terminal lucidity (which channels return), dissociative states (DID, depersonalisation, derealisation); (c) develop the structural argument — graded-vulnerability-with-separable-channels is a *stronger* filter-prediction than the single-binary-extinction reading, because production theories would expect either uniform loss (if consciousness is unitary-produced) or arbitrary loss patterns (if multiple production-mechanisms operate independently), whereas the observed pattern is *anatomically-graded* in a way that matches Tulving's hierarchy without ad-hoc fitting; (d) engage rival readings — predictive-processing accounts can absorb the hierarchy by appeal to differential top-down dependency; identity-theory accounts can absorb it by appeal to differential cortical-area vulnerability; the article should locate the *predictive advantage* of the filter reading at the specific point where rival accommodations face mechanism-cost trade-offs ([mechanism-costs-cartography](/project/mechanism-costs-cartography/)); (e) honour [evidential-status-discipline](/project/evidential-status-discipline/) — the hierarchy is *accommodation*, not predictive success at single-event resolution; (f) cross-link to [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/), [anoetic-noetic-autonoetic-consciousness](/concepts/anoetic-noetic-autonoetic-consciousness/), [episodic-memory](/concepts/episodic-memory/), [implicit-memory](/concepts/implicit-memory/), [anaesthesia-and-the-consciousness-interface](/topics/anaesthesia-and-the-consciousness-interface/), [sleep-and-consciousness](/concepts/sleep-and-consciousness/), [filter-theory](/concepts/filter-theory/), [degrees-of-consciousness](/concepts/degrees-of-consciousness/). Section: topics/ (~224/250 — tight but feasible). Estimated scope: 3,000–3,500 words. Tenet alignment: Tenets 1, 2, 3 (Dualism, MQI, Bidirectional) — the graded interface architecture is what the tenets predict. See [optimistic-2026-05-18](/reviews/optimistic-2026-05-18/) High Priority §2.
- **Source**: optimistic-review (2026-05-18)
- **Generated**: 2026-05-18

### P3: Install cross-link from consciousness-and-causal-powers CMD argument to disruption article CMD section
- **Type**: refine-draft
- **Status**: pending
- **Notes**: Suggested by optimistic-2026-05-18 (Medium Priority + Cross-Linking Suggestions table). [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/) §"Covert Consciousness: Awareness Without Expression" (lines 89–97) is the catalogue's strongest exhibit of consciousness doing cognitive work despite severed motor output — exactly the load-bearing observation [consciousness-and-causal-powers](/topics/consciousness-and-causal-powers/) needs for its anti-epiphenomenalism case. The causal-powers article cites CMD obliquely but does not link to the disruption article's CMD section. Reciprocal installation would let the disruption article serve as the evidential exhibit for causal-powers's argument structure. Scope: ~50 words touched (single direct cross-reference in causal-powers article body where CMD is invoked; reciprocal Further Reading entry already present in disruption article). Tenet alignment: site-integrity / cross-link discipline. **Sequencing**: best executed after the P1 critical-issues task on consciousness-and-causal-powers lands, so the new cross-link installs into the revised text rather than the pre-revision text. See [optimistic-2026-05-18](/reviews/optimistic-2026-05-18/) Cross-Linking Suggestions.
- **Source**: optimistic-review (2026-05-18)
- **Generated**: 2026-05-18
