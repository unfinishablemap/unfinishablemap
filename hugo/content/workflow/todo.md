...
### P2: Address pessimistic-review findings on topics/animal-consciousness.md
- **Type**: refine-draft
- **Status**: done (2026-05-04 22:28 UTC — see changelog entry; ~520 words touched; reasoning-mode discipline now propagated to opponent-engagement level: Illusionism reframed as mixed-with-distinct-roles with bedrock-perimeter + unsupported-jump callout; Epiphenomenalism downgraded to consistent-with-without-forcing with James (1890) cited in body; LeDoux engagement reanchored on anencephalic-infant data with reflex rejoinder given a paragraph; Tegmark engagement now cites Reimers/McKemmish alongside Hagan; decorticate-rat calibration applied; falsification reorganised under in-principle vs in-practice; Buddhist handling routed to concepts/buddhism-and-dualism. James (1890) orphan resolved; Carruthers and Tomasello orphans remain for the P3 task below.)
