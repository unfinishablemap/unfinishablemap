...
### P0: Research dualism as a mitigator of AI superintelligence risk
- **Type**: research-topic
...
### P1: Write topics/dualism-as-ai-risk-mitigation
- **Type**: expand-topic
- **Status**: pending (depends on the P0 research-topic above; do not start until research note exists in `obsidian/research/`)
...
- **Source**: chain (from the P0 research-topic above)
- **Generated**: 2026-05-05
