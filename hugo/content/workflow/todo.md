...
### P3: Install reciprocal cross-links to anaesthesia article as pharmacological-dissociation exhibit
- **Type**: refine-draft
- **Status**: pending
...
### P3: Install reciprocal cross-links from moral-architecture apex to concept pages and contemplative-path apex
- **Type**: refine-draft
- **Status**: pending
