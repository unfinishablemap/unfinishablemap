...
### P1: Write voids/inference-void article #completed
- **Type**: expand-topic
- **Status**: completed
- **Completed**: 2026-04-26
- **Output**: [inference-void](/voids/inference-void/) (2321 words)
- **Notes**: Research synthesised from `obsidian/research/voids-inference-void-2026-04-26.md`. Article positions the inference void as the fifth member of the second-order voids cluster, with Carroll's 1895 regress giving it a formally-demonstrable profile distinguishing it from purely apophatic or empirical voids. Two-channel structure preserved: source exposition (Carroll, Wittgenstein, Polanyi) kept separate from Map interpretation. AI/LLM interpretability framed as substrate-neutrality evidence. Connection to formal-cognitive-limits established as the 1895 predecessor of the Gödel-Turing-Chaitin lineage. Inheritance Problem section acknowledges the article reasons about inference using inferences. Tenet alignment: Occam's Razor Has Limits (load-bearing); Dualism (conditional, weaker form — Carroll/Wittgenstein/Polanyi did not defend dualism); Bidirectional Interaction (speculative).
- **Source**: unconsumed_research
- **Generated**: 2026-04-26

### P2: Research eliminative materialism for dedicated topic article
- **Type**: research-topic
- **Status**: pending
...
### P2: Add Carroll's regress / tacit-inference connection to formal-cognitive-limits.md
- **Type**: refine-draft
- **Status**: pending
- **Notes**: Surfaced by `obsidian/research/voids-inference-void-2026-04-26.md` "Gaps in Research": "Connection to formal-cognitive-limits (Gödel, Turing, Chaitin) deserves examination — Carroll's regress predates Gödel by 36 years and shares structural features (regress, self-application, formal incompleteness)." The current `concepts/formal-cognitive-limits.md` treats Gödel-Turing-Chaitin as the canonical formal limits but does not cite Carroll's 1895 "What the Tortoise Said to Achilles" as a *predecessor* formal limit on the rule-augmentation strategy itself. Adding the connection (a) sharpens the article by widening the formal-limits lineage, (b) prepares the ground for the queued inference-void article to draw on this concept page without rewriting the formal-limits material, (c) gives Polanyi's tacit-inference work a natural anchor on the site (the "rules cannot ground rule-following" insight is the same insight as "explicit rules cannot force a conclusion"). Refine-draft should (i) add a brief paragraph on Carroll's regress as a 1895 demonstration that explicit rule-citation cannot suffice for inference, (ii) frame Carroll-Wittgenstein-Polanyi as a structurally adjacent line to Gödel-Turing-Chaitin (both pointing to non-formal grounds for formal operations), (iii) add wikilinks to the inference-void article (will be created shortly) and Polanyi-related concepts where appropriate, (iv) preserve the article's existing scope; do not relocate the Gödel-Turing-Chaitin treatment. Light-to-medium scope. Tenet alignment: Occam's Razor Has Limits.
- **Source**: unconsumed_research
- **Generated**: 2026-04-26
