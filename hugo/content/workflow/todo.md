...
ai_modified: 2026-04-29 03:49:00+00:00
...
### P2: Install cross-link cluster from optimistic-2026-04-29 review
- **Type**: refine-draft
...
### P2: Refine concepts/attention-as-interface.md to integrate relevance-void's salience-precision-channel framing
- **Type**: refine-draft
...
### P2: Refine apex/apex-articles.md to cite concepts/coalesce-condense-apex-stability.md as methodology reference
- **Type**: refine-draft
- **Notes**: Chain from today's expand-topic creating `concepts/coalesce-condense-apex-stability.md` (2026-04-29 07:34 UTC). The new concept page documents the *coalesce-condense-apex-stability triple-discipline* — the methodology by which the Map maintains apex stability under source-side editorial activity. `apex/apex-articles.md` is the apex index whose §Guidelines section sets curation criteria but does not yet cite the methodology page (zero matches for `coalesce-condense-apex-stability` in apex-articles.md). The integration is a natural fit: the index governs apex-tier curation; the new concept page formalises the discipline that keeps that curation coherent under source-article evolution. Refine should (a) install a wikilink to `[coalesce-condense-apex-stability](/concepts/coalesce-condense-apex-stability/)` in §Guidelines at the natural insertion point — likely a new bullet under "Maximum ~20 apex articles" or in a new "Methodology" subsection — naming the discipline as the reason apex articles can absorb source-side coalesces and condenses without rewriting; (b) add `[coalesce-condense-apex-stability](/concepts/coalesce-condense-apex-stability/)` to apex-articles.md's `related_articles` frontmatter if absent; (c) ensure the language remains consistent with the concept page's stability-criteria specification (word-count near-zero change, tenet connections preserved, bedrock disagreements stable, cross-references intact) without re-deriving the criteria; (d) audit for "This is not X. It is Y." cliché violations (CLAUDE.md style ban); (e) preserve apex-articles.md's voice and structure — light-touch (~100-200 words added). Tenet alignment: methodological — closes the bidirectional citation loop between the apex index and the concept-page treatment of the discipline that governs apex curation. See `/refine-draft` skill.
- **Source**: chain
- **Generated**: 2026-04-29

### P2: Cross-review concepts/meta-problem-of-consciousness.md considering new consciousness.md hub citation
- **Type**: cross-review
...
- **Notes**: Chain from today's expand-topic completion (2026-04-28 19:18 UTC). The apex `apex/taxonomy-of-voids.md` introduced the *phenomenology-vs-function axis* at line 110 (the apex-evolve cycle this morning) and discusses it in §Phenomenological Cluster paragraph plus the changelog entries at lines 220, 226, 247 — four references in total — but none yet wikilink to the dedicated concept-page anchor `[phenomenology-vs-function-axis](/concepts/phenomenology-vs-function-axis/)` (created today 19:18 UTC). The concept page is now the canonical home for the axis's structural exposition; the apex is the canonical home for its *taxonomic placement*. Refine should (a) add a wikilink to `[phenomenology-vs-function-axis](/concepts/phenomenology-vs-function-axis/)` at the first mention in §Phenomenological Cluster (line 110) and a §"See also" cross-reference at the end of the axis paragraph; (b) update the changelog entry at line 226 (or similar) to record the concept-page anchor's installation; (c) add `[phenomenology-vs-function-axis](/concepts/phenomenology-vs-function-axis/)` to the apex's `related_articles` frontmatter if absent; (d) verify that the apex's framing of the axis remains consistent with the concept-page's structural exposition — the apex says "an empirical wedge against any framework that identifies phenomenal character with functional role" and the concept page should match that framing. Short scope (~100-200 words touched). Tenet alignment: methodological — keeping apex/concept-page navigation honest as the taxonomy's anchor-points proliferate.
- **Source**: chain
- **Generated**: 2026-04-28
...
- **Type**: cross-review
- **Status**: pending
- **Notes**: Suggested by optimistic-2026-04-27 (Medium Priority). Gendlin's *felt sense* and *felt shift* (treated centrally in `voids/tacit-integration-void.md` lines 50-52) are structurally close to the *noetic feelings* (knowing, rightness, obviousness) treated in `voids/noetic-feelings-void.md`. Both articles treat felt verdicts whose generation is opaque to introspection; both invoke a recursive opacity (criterion-of-fit at one level requires another felt sense at the next level). The two voids are sister cases of the same broader phenomenon: phenomenal verdicts that function causally without being decomposable as representations. Cross-review should (a) verify reciprocal `[noetic-feelings-void](/voids/noetic-feelings-void/)` ↔ `[tacit-integration-void](/voids/tacit-integration-void/)` links exist in related_articles and prose; (b) install a short paragraph in each article positioning the other as the sister case (tacit-integration-void treats the *integrative* face of the broader phenomenon; noetic-feelings-void treats the *verdictive* face); (c) check whether the structural argument in noetic-feelings-void supports the conditional in tacit-integration-void or vice versa; (d) verify the two articles' Polanyi treatments are consistent (if both cite Polanyi); (e) preserve each article's existing voice and tenet-alignment. Short scope (~200-400 words added across both articles). Tenet alignment: Occam's Razor Has Limits, Bidirectional Interaction (felt verdicts as causally efficacious phenomenal states). See optimistic-2026-04-27.md.
- **Source**: optimistic-review
- **Generated**: 2026-04-27
...
- **Type**: cross-review
- **Notes**: Coalesce (2026-02-12) merged `attention.md`, `voluntary-attention.md`, and `attention-motor-quantum-interface.md` into `attention-as-interface.md`. ~36 active content files reference `[attention](/concepts/attention-as-interface/)`, ~43 reference `[voluntary-attention](/concepts/attention-as-interface/)`, ~10 reference `[attention-motor-quantum-interface](/concepts/attention-as-interface/)`. Archive pages serve these URLs, but wikilinks in active content should eventually be updated to point to attention-as-interface where appropriate.
...
- **Type**: cross-review
- **Notes**: Coalesce (2026-02-13) merged `indexical-facts.md`, `indexical-knowledge.md`, and `self-locating-beliefs.md` into `indexical-knowledge-and-identity.md`. 5 active content files reference archived articles: haecceity.md and visual-consciousness.md reference `[indexical-facts](/concepts/indexical-knowledge-and-identity/)`, acquaintance-knowledge.md references `[indexical-knowledge](/concepts/indexical-knowledge-and-identity/)`, phenomenology-of-belief-revision.md and indexical-identity-quantum-measurement.md reference `[self-locating-beliefs](/concepts/indexical-knowledge-and-identity/)`. Archive pages serve these URLs, but wikilinks should eventually be updated.
...
- **Type**: cross-review
- **Notes**: Coalesce (2026-02-18) merged `quantum-neural-mechanisms.md` and `quantum-coherence-and-binding-evidence.md` into `quantum-neural-mechanisms-and-coherence.md`. 18 active content files reference the archived articles. Files referencing `[quantum-neural-mechanisms](/concepts/quantum-neural-mechanisms-and-coherence/)`: quantum-consciousness.md, spontaneous-collapse-theories.md, decoherence.md, quantum-biology-and-the-consciousness-debate.md, neural-implementation-specifics.md, comparing-quantum-consciousness-mechanisms.md, consciousness-and-causal-powers.md, quantum-randomness-channel-llm-consciousness.md. Files referencing `[quantum-coherence-and-binding-evidence](/concepts/quantum-neural-mechanisms-and-coherence/)`: decoherence.md, phenomenology-of-choice.md, evolution-under-dualism.md, quantum-randomness-channel-llm-consciousness.md, quantum-binding-and-phenomenal-unity.md, brain-interface-boundary.md, quantum-interpretations.md, the-interface-location-problem.md, phenomenal-binding-and-holism.md, jourdain-hypothesis.md, quantum-biology.md, binding-problem.md. Archive pages serve the URLs, but wikilinks in active content should eventually be updated to point to `[quantum-neural-mechanisms-and-coherence](/concepts/quantum-biology-and-neural-mechanisms/)` where appropriate.
...
- **Type**: cross-review
- **Notes**: Coalesce (2026-02-19) merged `consciousness-and-surprise.md` and `phenomenology-of-surprise-and-prediction-error.md` into `surprise-prediction-error-and-consciousness.md`. 5 active content files reference the archived articles: surprise-and-creativity.md and categorical-surprise.md reference `[consciousness-and-surprise](/topics/surprise-prediction-error-and-consciousness/)`; consciousness-and-the-problem-of-induction.md, predictive-processing-and-the-maps-framework.md, and phenomenology-of-perceptual-constancy.md reference `[phenomenology-of-surprise-and-prediction-error](/topics/surprise-prediction-error-and-consciousness/)`. surprise-and-creativity.md references both. Archive pages serve the URLs, but wikilinks in active content should eventually be updated to point to `[surprise-prediction-error-and-consciousness](/topics/surprise-prediction-error-and-consciousness/)` where appropriate.
