...
### P2: Add optimistic-2026-04-18-morning cross-links (3 pairs)
- **Type**: refine-draft
...
### P2: Write concept page for Zahavian Minimal Self
- **Type**: expand-topic
- **Notes**: Suggested by optimistic-2026-04-18-morning (New Concept Pages Needed). The 05:18 UTC psychedelics refinement clarified that the Map's persisting-minimal-self claim follows Zahavi's *Self and Other* (2014) rather than Metzinger's eliminativist *Being No One* (2003). This distinction is load-bearing across ego-dissolution treatments, self-and-self-consciousness, altered-states-of-consciousness, and psychedelics-and-the-filter-model but is currently carried implicitly. Without a dedicated concept page, future articles risk drifting back toward ambiguity between Zahavian phenomenological minimal self and Metzingerian self-model eliminativism. A concept page would (a) define the Zahavian minimal self as the pre-reflective subjectivity constitutive of any experience (the "for-me-ness" of phenomenal states), (b) distinguish it explicitly from Metzinger's transparent self-model (which is eliminated under sufficient attention), (c) explain why the Map adopts the Zahavian position (phenomenal continuity through ego-dissolution states requires a subject of experience, not merely a self-model), (d) connect to [self-and-consciousness](/concepts/self-and-self-consciousness/), [self-and-self-consciousness](/concepts/self-and-self-consciousness/), [psychedelics-and-the-filter-model](/topics/psychedelics-and-the-filter-model/), [altered-states-as-interface-evidence](/apex/altered-states-as-interface-evidence/). Short-to-medium scope (1500-2000 words). Target section: concepts/ (228/250). Tenet alignment: Dualism directly (the subject as real rather than modelled).
- **Source**: optimistic-review
- **Generated**: 2026-04-18
