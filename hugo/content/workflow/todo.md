...
ai_modified: 2026-05-10 16:12:00+00:00
...
- **Type**: refine-draft
- **Status**: pending
- **Notes**: From outer review 2026-05-11 ChatGPT 5.5 Pro §3.3. The tenets page currently asserts that "our ability to discuss qualia is strong evidence against epiphenomenalism," and that consciousness causally influences physical outcomes. The Agency Void (`obsidian/voids/agency-void.md`) argues that consciousness cannot first-person-verify whether it causes anything, and that Bidirectional Interaction is a starting point that shapes inquiry rather than a conclusion derived from introspection. The reviewer's recommended repair is not to weaken the tenet but to label the distinction cleanly: BI is a metaphysical commitment supported by self-stultification and indirect evidence, *not* a directly introspectible datum. **Apply the direct-refutation discipline**. Identify what kind of engagement the issue calls for: this is a *Mode Two unsupported-foundational-move* candidate — the tenets page risks treating BI's introspectibility as established when the agency cluster shows it is not. Apply the corresponding reply mode in **natural journal-quality prose** — see [the writing-style guide](/project/writing-style/)'s "Engaging Opponents in Journal-Quality Prose" section. **Do not expose mode labels in the article body.** The classification is editor-internal; it belongs in the refine-draft / deep-review changelog entry, not in the article. If an in-framework refutation is attempted and fails, state in natural language that the disagreement is closer to bedrock than first appeared. Light scope: ~150–300 words touched in `obsidian/tenets/tenets.md` under the Bidirectional Interaction section, with reciprocal link to Agency Void. Tenet alignment: Tenet 3 (Bidirectional Interaction); coherence-maintenance.
- **Review file**: `reviews/outer-review-2026-05-11-chatgpt-5-5-pro.md`
- **Source**: outer-review
- **Generated**: 2026-05-11

### P2: Post-decoherence selection demotes quantum-biology evidence from foundational to supplemental
- **Type**: refine-draft
- **Status**: pending
- **Notes**: From outer review 2026-05-11 ChatGPT 5.5 Pro §1.2 (novel inference). The tenets page currently leans on biological quantum effects ("evolution can harness coherence") as positive evidence; the post-decoherence selection programme (`obsidian/apex/post-decoherence-selection-programme.md`) says the timing gap is sidestepped if consciousness selects after decoherence. The reviewer's inference: if post-decoherence selection is the Map's strongest mechanism, neural coherence evidence becomes a *plausibility supplement* rather than a load-bearing premise. This makes the Map less vulnerable to microtubule-specific or coherence-specific objections. Repair: refine `obsidian/tenets/tenets.md` Tenet 2 (MQI) section so biological-quantum-effects language reads as "biological precedent" rather than "proof" of neural relevance, and the rhetorical order becomes "decoherence leaves the outcome problem; if collapse/actualisation is real, consciousness could be a selector; quantum biology only matters for mechanism candidates that require pre-decoherence coherence." Also touch `obsidian/topics/quantum-biology-and-neural-mechanisms.md` (recently deep-reviewed 2026-05-11) for consistency. Apply the direct-refutation discipline in *natural journal-quality prose* — see [writing-style](/project/writing-style/) — and keep mode labels editor-internal. Tenet alignment: Tenet 2 (Minimal Quantum Interaction).
- **Review file**: `reviews/outer-review-2026-05-11-chatgpt-5-5-pro.md`
- **Source**: outer-review
- **Generated**: 2026-05-11
...
### P2: Common-cause-null governs the voids catalogue, not just convergence arguments
- **Type**: refine-draft
- **Status**: pending
- **Notes**: From outer review 2026-05-11 ChatGPT 5.5 Pro §1.4 (novel inference). The common-cause-null page (`obsidian/project/common-cause-null.md`) warns that convergence across traditions/substrates/methods has cumulative force only if sources are genuinely independent. The voids taxonomy (`obsidian/apex/taxonomy-of-voids.md`) argues that voids cluster around the consciousness-physical boundary and the clustering pattern is itself informative. The reviewer's novel inference: **the voids catalogue itself is the Map's largest common-cause-null test case** — many voids may recur not because the territory has many independent boundaries, but because human introspection has one shared architecture of opacity. Repair: refine `obsidian/apex/taxonomy-of-voids.md` to add cluster-independence scoring (empirical, phenomenological, clinical, contemplative, linguistic, quantum-theoretic, cross-cultural) before counting cluster members as independent evidential sources. Adds ~200–400 words touched in taxonomy-of-voids; install a small reciprocal section in common-cause-null naming the voids catalogue as its primary application case. Tenet alignment: methodological.
- **Review file**: `reviews/outer-review-2026-05-11-chatgpt-5-5-pro.md`
- **Source**: outer-review
- **Generated**: 2026-05-11
