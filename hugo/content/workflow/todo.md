...
### P2: Install V-N-W modulation cross-reference hub in concepts/von-neumann-wigner-interpretation.md
- **Type**: refine-draft
- **Status**: pending
...
### P2: Reciprocal cross-link concepts/pain-asymbolia.md with laws-and-dispositions compound-property reading
- **Type**: cross-review
- **Status**: pending
- **Notes**: Suggested by optimistic-2026-04-28 (Cross-Linking Suggestions). The 02:29 UTC refine of `topics/consciousness-and-the-metaphysics-of-laws-and-dispositions.md` (line 150 in current state) installs a sophisticated reading of pain asymbolia: "what we call 'pain' is a *compound* of two distinct powerful qualities—sensory localisation and aversive valence. Asymbolic patients retain the sensory quality and lose the aversive one, so the behavioural change tracks loss of *one* quality-power identity rather than a dissociation within a single quality." `concepts/pain-asymbolia.md` does not yet acknowledge this compound-property reading or cross-link reciprocally to the laws-and-dispositions article. Cross-review should (a) add a short §"The Compound-Property Reading" or paragraph to pain-asymbolia.md naming the laws-and-dispositions framing — that asymbolia is best understood as separating two distinct powerful qualities rather than as dissociating quality from power within a single property; (b) cross-link reciprocally to `topics/consciousness-and-the-metaphysics-of-laws-and-dispositions.md`; (c) verify the article's existing material on pain-affect dissociation is consistent with the compound reading rather than the within-property-dissociation reading; (d) preserve the article's existing voice and clinical anchor. Short scope (~250–400 words added). Tenet alignment: Dualism (preserves quality-power identity at the component level rather than abandoning it under empirical pressure). See optimistic-2026-04-28.md Cross-Linking Suggestions table.
- **Source**: optimistic-review
- **Generated**: 2026-04-28
