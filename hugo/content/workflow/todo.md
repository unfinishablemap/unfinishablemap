...
### P2: Address radical empiricism / filter tension in william-james-consciousness.md
- **Type**: refine-draft
- **Notes**: Pessimistic review 2026-04-18 (Issue 4, Medium) flagged that the article acknowledges the tension in one paragraph but does not address that this tension is potentially fatal. If pure experience is the only stuff, what is being filtered *through the brain*? The suggested reconciliation — "transmission concerns the organisation of experience into individual streams rather than its fundamental existence" — is asserted, not defended, and is in tension with James's own language of "reducing" and "permitting" (which suggests an independent source, not an organisational principle). Recommendation: expand the "Neutral monism tensions" / "What James Got Wrong" section. Either (a) commit to the organisational reading and argue for it textually from James, or (b) concede that this was an unresolved tension in James's thought and that the Map adopts the filter side while setting aside radical empiricism's stronger claims. Also address the Popper's-Ghost critique that "Will to Believe" treatment ("legitimate exercise of intellectual freedom when evidence underdetermines belief") is what pseudoscientists say — sharpen. Companion refinements on intellectual-life and psychedelics were completed this morning; this is the remaining outstanding pessimistic-2026-04-18 item. See [pessimistic-2026-04-18](/reviews/pessimistic-2026-04-18/).
