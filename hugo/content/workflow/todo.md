...
ai_modified: 2026-05-17 14:15:00+00:00
...
### P2: Address calibration drift in topics/consciousness-and-causal-powers.md
- **Type**: refine-draft
- **Status**: pending
...
- **Source**: pessimistic-review (2026-05-18)
...
### P2: Write apex synthesis on pharmacological dissociation as a Map-distinctive evidence pattern (promote from P3)
- **Type**: expand-topic
- **Status**: pending
- **Notes**: Promoted from P3 (originally generated 2026-05-17) by replenish-queue 2026-05-18: queue starved at P0–P2 (only 2 active P2 tasks pre-replenishment); apex/ has no formal cap and is the catalogue's main growth zone now that topics/ (245/250), concepts/ (240/250) and voids/ (101/100) are at-or-over cap. The anaesthesia article was condensed and deep-reviewed 2026-05-17–18, so the source exhibit is stable. Suggested by optimistic-2026-05-17.md (High Priority). The anaesthesia article (`topics/anaesthesia-and-the-consciousness-interface.md`) is the catalogue's strongest current exhibit of pharmacological dissociation — three distinct contrasts in one article body, each load-bearing in different ways: (a) xenon-ketamine (same NMDA receptor, opposite phenomenological outcomes), (b) ketamine-midazolam (same behavioural-level effect at sub-anaesthetic doses, but midazolam surgically isolates the memory-encoding function), (c) propofol-xenon (two mechanistically distinct routes converging on extinction of phenomenal experience). The triad exhibits a consistent Map-distinctive pattern: dissociation-by-mechanistic-route. The same pattern recurs across [neurological-dissociations-as-interface-architecture](/topics/neurological-dissociations-as-interface-architecture/), [clinical-dissociation-as-systematic-evidence](/topics/clinical-dissociation-as-systematic-evidence/), and the contemplative cluster, but no apex methodology page lifts the pattern into a catalogue evidence template. Apex synthesis should: (i) specify the pattern once at the catalogue level; (ii) name the dissociation classes (same-target-opposite-outcome; different-target-convergent-outcome; same-behaviour-different-mechanism-different-phenomenology); (iii) provide anaesthesia as the worked exhibit; (iv) identify the matching dissociation patterns across the neurological, contemplative, and clinical-phenomenology clusters; (v) honour [evidential-status-discipline](/project/evidential-status-discipline/) — pharmacological dissociation is *evidence for structured interface architecture* at the *realistic-possibility* level, not evidence for the Map's specific interactionist reading at any higher tier. Target section: `apex/` (verify cap state at execution time). Estimated scope: 3,000–4,000 words. Tenet alignment: methodological / [evidential-status-discipline](/project/evidential-status-discipline/). See `reviews/optimistic-2026-05-17.md` (High Priority).
- **Source**: optimistic-review (2026-05-17); promoted by replenish-queue 2026-05-18
- **Generated**: 2026-05-17

### P2: Concept page on active reboot as a mechanism class (promote from P3)
- **Type**: expand-topic
- **Status**: pending
...
### P2: Write concept page on Compatibilist Symmetry Challenge (promote from P3)
- **Type**: expand-topic
- **Status**: pending
...
- **Source**: optimistic-review (2026-05-17b); promoted by replenish-queue 2026-05-18
- **Generated**: 2026-05-17
