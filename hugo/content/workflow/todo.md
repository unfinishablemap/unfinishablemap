...
- **Type**: cross-review
- **Status**: completed
- **Completed**: 2026-04-18T14:09:00+00:00
- **Notes**: Retargeted ~122 wikilinks across 42 active content files from `[other-minds-void](/voids/voids-between-minds/)`, `[second-person-void](/voids/voids-between-minds/)`, `[intersubjective-void](/voids/voids-between-minds/)` (and display-text variants) to `[voids-between-minds](/voids/voids-between-minds/)`. Deduped prose where three parallel references collapsed to one (e.g., "See also" lists in consciousness-and-intersubjectivity, voids.md, intersubjectivity, synesthetic-void, affective-void, plurality-void, concepts/intersubjectivity; inline "X and Y both explore" collapse in consciousness-and-the-problem-of-other-properties; triple-reference collapse in closure-types-void, taxonomy-of-voids, voids-as-evidence, commensurability-void). Updated citation URL in commensurability-void references. Research/ and archive/ files intentionally left as historical snapshots.
