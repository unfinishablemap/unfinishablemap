...
- **Type**: refine-draft
- **Status**: done (2026-05-05 05:17 UTC) — added "Cap-Saturation Policy: When Coalesce Yields to Condense" section (~360 words, four paragraphs covering all five required elements: saturation condition, inverted ordering with no-fabrication clause, escalation path to tune-system, 2026-05-03 voids/ worked example, terminology-drift limitation); extended Tenet 5 paragraph in "Relation to Site Perspective" with one sentence connecting cap-saturation policy to section-cap-layer parsimony; added 5th References entry for commit 5ea6d0c90. Word count: 2404 → 2845 (soft_warning, 114% of soft, well below hard at 3500). Net addition slightly above the ~350 brief target but warranted by the methodological substance required to cover all five elements.
