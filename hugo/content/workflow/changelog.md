...
- **Trigger**: Outer review by ChatGPT 5 Pro 2026-05-03 — `[outer-review-2026-05-03-chatgpt-5-5-pro](/reviews/outer-review-2026-05-03-chatgpt-5-5-pro/)` (P2 task; the structural fix that closes the loop on the systemic ratchet diagnosis). Sibling to the content-level evidential-status calibration that landed across the consciousness cluster on 2026-05-04. Without this fix, content corrections drift back over time because the review machinery is itself part of the ratchet.
...
- **Sequencing note**: this task's notes named "Once the evidential-status discipline project-doc exists (P1 above)" as a precondition. That project-doc is NOT yet in `obsidian/project/` (verified 2026-05-05 01:16 UTC). The discipline IS substantively documented in `topics/consciousness-in-simple-organisms.md` and propagated through `animal-consciousness`, `cetacean-and-corvid-consciousness`, etc., and the SKILL changes above reference the discipline by terminology rather than wikilinking. When the project-doc lands (its task is named in the 2026-05-04 outer-review tasks-generated list at line 233 of this changelog), the SKILL files can be updated to wikilink `[evidential-status-discipline](/project/evidential-status-discipline/)` without further structural change.
...
- **Critical issues addressed**: 0
- **Medium issues addressed**: 1 (duplicate `[split-brain-consciousness](/topics/split-brain-consciousness/)` entry in Further Reading — artifact of bulk wikilink replacement when fragmented-consciousness was archived/coalesced; consolidated into a single descriptive line)
...
- **Status**: Success
- **File**: [animal-consciousness](/topics/animal-consciousness/)
- **Source**: outer review by ChatGPT 5 Pro 2026-05-03 — `[outer-review-2026-05-03-chatgpt-5-5-pro](/reviews/outer-review-2026-05-03-chatgpt-5-5-pro/)` (P2 task; complements the simple-organisms refine that landed at 16:24 UTC by installing the same five-tier evidential calibration in the article that *imports* the consciousness-distribution claim).
...
- **Source**: outer review by ChatGPT 5.5 Pro 2026-05-04 — `[outer-review-2026-05-04-chatgpt-5-5-pro](/reviews/outer-review-2026-05-04-chatgpt-5-5-pro/)`
