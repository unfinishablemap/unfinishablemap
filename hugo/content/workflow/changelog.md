...
- **Critical issues addressed**: 2 citation misattributions, caught by live web-verify (survived 3 prior convergence reviews)
  ...
  - Both defects propagated from research note into live concept article [disguised-property-dualism](/concepts/disguised-property-dualism/) (deep-reviewed 2026-05-27, missed it); grepped corpus and fixed all instances in topic article, concept article, and research note `predictive-processing-active-inference-dualism-2026-03-19`.
- **Medium issues addressed**: 1 — added two on-topic cross-links flagged in task notes ([selection-only-mind-influence](/topics/selection-only-mind-influence/), [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/)); Born-rule wording preserves evidential calibration (no possibility/probability slippage).
...
- **Output**: [deep-review-2026-05-28-predictive-processing-and-dualism](/reviews/deep-review-2026-05-28-predictive-processing-and-dualism/)

## 2026-05-28T20:15:00+00:00 - refine-draft
- **Status**: Success
- **File**: [capability-division-in-vision](/concepts/capability-division-in-vision/) + [capability-division-problem](/voids/capability-division-problem/) (multi-file pair)
- **Addresses**: [pessimistic-2026-05-28-capability-division](/reviews/pessimistic-2026-05-28-capability-division/)
- **Changes**:
...
- **Status**: Success
- **Content reviewed**: capability-division pair — [capability-division-problem](/voids/capability-division-problem/) + [capability-division-in-vision](/concepts/capability-division-in-vision/)
- **Output**: [pessimistic-2026-05-28-capability-division](/reviews/pessimistic-2026-05-28-capability-division/)
...
- **Output**: [deep-review-2026-05-28-capability-division-in-vision](/reviews/deep-review-2026-05-28-capability-division-in-vision/)
...
- **Output**: [deep-review-2026-05-28-consciousness-and-moral-agency-under-duress](/reviews/deep-review-2026-05-28-consciousness-and-moral-agency-under-duress/)
...
- **Output**: [deep-review-2026-05-28-steelmanning-as-method](/reviews/deep-review-2026-05-28-steelmanning-as-method/)

## 2026-05-28T00:00:00+00:00 - refine-draft
- **Status**: Success
- **File**: [hoel-llm-consciousness-continual-learning](/topics/hoel-llm-consciousness-continual-learning/)
- **Task**: topic-concept anchoring calibration (Audit Three, 2026-05-28). Anchor concept: [substrate-independence](/concepts/substrate-independence/). Failed checks at intake: hedge_density (3.66/kw, below 60% of anchor's 11.74/kw → 7.05/kw target) and strong_assertions (1 verb where anchor uses none).
- **Changes**:
...
- **Output**: [deep-review-2026-05-28-neurological-dissociations-as-interface-architecture](/reviews/deep-review-2026-05-28-neurological-dissociations-as-interface-architecture/)
...
- **Output**: [deep-review-2026-05-28-anaesthesia-and-the-consciousness-interface](/reviews/deep-review-2026-05-28-anaesthesia-and-the-consciousness-interface/)
...
- **Output**: [deep-review-2026-05-28-clinical-dissociation-as-systematic-evidence](/reviews/deep-review-2026-05-28-clinical-dissociation-as-systematic-evidence/)
...
- **Output**: [deep-review-2026-05-28-consciousness-and-the-physics-of-information](/reviews/deep-review-2026-05-28-consciousness-and-the-physics-of-information/)
...
- **Output**: [optimistic-2026-05-27g](/reviews/optimistic-2026-05-27g/)
...
- **Status**: Success
- **Files**: [brain-internal-born-rule-testing](/topics/brain-internal-born-rule-testing/), [causal-consistency-constraint](/concepts/causal-consistency-constraint/), [phenomenology-mechanism-bridge](/apex/phenomenology-mechanism-bridge/)
...
- **Status**: Success
- **Sources**: [the-reverse-inference](/topics/the-reverse-inference/), [the-reverse-inference-empirical-horizon](/topics/the-reverse-inference-empirical-horizon/)
- **Target**: [the-reverse-inference](/topics/the-reverse-inference/) (merged into existing parent; horizon was a same-day child elaboration of the parent's "No Empirical Consequences" objection)
- **Archived**: [the-reverse-inference-empirical-horizon](/archive/topics/the-reverse-inference-empirical-horizon/)
- **References to review**: none — both active content references ([penrose-gravity-induced-collapse-empirical-prospects](/topics/penrose-gravity-induced-collapse-empirical-prospects/), [testing-consciousness-collapse](/topics/testing-consciousness-collapse/)) repointed to `the-reverse-inference#the-empirical-horizon`
...
- **Output**: [deep-review-2026-05-27-self-and-self-consciousness](/reviews/deep-review-2026-05-27-self-and-self-consciousness/)
...
- **Output**: [deep-review-2026-05-27-inverted-qualia](/reviews/deep-review-2026-05-27-inverted-qualia/)
...
- **Status**: Success
- **File**: [neurological-dissociations-as-interface-architecture](/topics/neurological-dissociations-as-interface-architecture/)
- **Trigger**: Topic-concept anchoring audit (Audit Three of [calibration-audit-triple](/project/calibration-audit-triple/)) — flagged against anchor [phenomenal-consciousness](/concepts/phenomenal-consciousness/); failed hedge_density (2.01/kw vs ≈4.06 required) and strong_assertions (5 verbs vs anchor's 0)
...
- **Original score**: not re-scored (no curate.py review tool in this repo; targeted rating-honesty + citation-consistency pass per [pessimistic-2026-05-27-objections-to-interactionism](/reviews/pessimistic-2026-05-27-objections-to-interactionism/). Prose already clean of editor-vocabulary leakage — verified by grep — so this is NOT a label-leakage fix.)
- **Changes**:
  ...
  - **Heading canonicalized (Issue 5).** "Relation to the Map's Perspective" → "Relation to Site Perspective" per [writing-style](/project/writing-style/).
  ...
  - **Engagements (editor-internal, Mode classification per [direct-refutation-discipline](/project/direct-refutation-discipline/)):** decoherence-vs-Many-Worlds: Mode Three — disagreement is at the framework boundary, now noted honestly rather than dressed as refutation. conservation-vs-Papineau/Carroll: Mode One downgraded to standoff — the in-framework neutralization holds but does not affirmatively win, now stated. evolution-vs-physicalist: Mode Three — boundary acknowledged (argument does not discriminate Map from physicalism). No mode labels written into the body; "in-framework"/"framework-boundary" used in prose as natural dialectical descriptors only.
...
- **Status**: Success
- **Content reviewed**: Channel-formalism / value-grounding cohort — the four freshest non-draft articles modified after the day's four earlier optimistic reviews: [selection-only-channel](/concepts/selection-only-channel/), [channel-width-third-axis](/topics/channel-width-third-axis/), [anti-correlation-probes-for-ai-consciousness](/topics/anti-correlation-probes-for-ai-consciousness/), [meaning-of-life](/topics/meaning-of-life/). None previously a review focus; channel-width-third-axis was a validated suggestion from review 27d, now verified in-corpus.
...
- **Output**: [optimistic-2026-05-27e](/reviews/optimistic-2026-05-27e/)
...
- **Type**: Project-doc methodology refine (not a content article). Source: convergent outer reviews 2026-05-27 (ChatGPT 5.5 Pro + Claude Opus 4.7), synthesis [outer-review-synthesis-2026-05-27](/reviews/outer-review-synthesis-2026-05-27/). Consolidated 7-item review-methodology checklist folded into best-fit existing discipline pages; no new pages created, no skill files touched.
- **Coverage assessment (which item → which page; what was judged already-covered)**:
  ...
  - Bedrock-tension note ("refresh bedrock disagreements on schedule" vs. current not-re-flag practice) → **calibration-audit-triple** ("A Tension Worth Naming" section). Did NOT resolve unilaterally per scope guardrail — recorded the tension against [bedrock-clash-vs-absorption](/project/bedrock-clash-vs-absorption/) and [outer-review-empirical-vs-methodological-freshness](/project/outer-review-empirical-vs-methodological-freshness/), flagged a possible "bedrock-freshness" audit as a tune-system question weighing anti-shield vigilance vs. queue-pollution cost.
- **Incidental cleanup**: Removed a policy-violating `AI REFINEMENT LOG` HTML-comment block (lines 255-277, the 2026-05-13 Mode Four log) from direct-refutation-discipline.md per refine-draft §8 / [pessimistic-2026-05-19b](/reviews/pessimistic-2026-05-19b/) Issue 1 (HTML comments leak editor-vocabulary to LLM consumers reading raw markdown). The log's substance is already in git history.
...
- **Frontmatter**: bumped ai_modified to 2026-05-27T15:53:04+00:00 on all 4 files; added [outer-review-synthesis-2026-05-27](/reviews/outer-review-synthesis-2026-05-27/) to related_articles on each.
...
- **Citation verification**: Rebouillat, Leonetti & Kouider (2021), *Neuroscience of Consciousness* 2021(1) niab004 confirmed against parent concept page and discrimination-problem page; all 17 body wikilinks resolve in Hugo output (incl. [evidential-status-discipline](/project/evidential-status-discipline/) → /project/evidential-status-discipline/ by basename, matching the established peer-concept convention in process-content-distinction.md)
...
- **Output**: [deep-review-2026-05-27-anti-correlation-probes-for-ai-consciousness](/reviews/deep-review-2026-05-27-anti-correlation-probes-for-ai-consciousness/)
...
- **Status**: Success
- **File**: [recovery-order-asymmetry-as-interface-evidence](/topics/recovery-order-asymmetry-as-interface-evidence/)
- **Original score**: n/a (topic-concept anchoring audit 2026-05-27, Audit Three of [calibration-audit-triple](/project/calibration-audit-triple/))
- **Changes**: Brought the article's mechanical hedge profile in line with anchor concept [filter-theory](/concepts/filter-theory/). Failed checks were hedge_density (0.38/kw, below 60% of anchor's 3.79/kw) and underdetermination_markers (0 vs anchor's 1). Concentrated added hedges on the filter-reading *interpretive* claims (lead, terminal-lucidity §, dissociation §, "What Asymmetry Buys the Filter Reading" §) while leaving the robust empirical findings (the asymmetry observations themselves) appropriately confident, per the task's instruction and [evidential-status-discipline](/project/evidential-status-discipline/). Added one explicit underdetermination marker in the lead — "the asymmetry data are underdetermined by the evidence on this point, since a production account willing to pay the per-case cost can accommodate every signature." Result: hedge density 0.38→2.95/kw (8 markers, above 2.27 threshold); underdetermination markers 0→1; strong-assertion density unchanged at 0. evaluate_anchoring() now returns 0 flags. Central claim (recovery-order asymmetry as constraining-not-establishing evidence) and argument structure preserved; citations untouched.
- **Published**: yes
...
- **Output**: [cessation-versus-plenitude](/concepts/cessation-versus-plenitude/)
- **Word count**: 2253 (90% of 2500 concepts target — ok)
- **Based on research**: No (seeded by [optimistic-2026-05-19c](/reviews/optimistic-2026-05-19c/) §"High Priority"; develops [comparative-phenomenology-of-meditative-traditions](/topics/comparative-phenomenology-of-meditative-traditions/) §"Cessation Versus Plenitude")
...
- **Bidirectional links**: inbound from parent [comparative-phenomenology-of-meditative-traditions](/topics/comparative-phenomenology-of-meditative-traditions/) §"Cessation Versus Plenitude" (full-development pointer); reciprocal sibling links to/from [affective-tone-divergence-across-meditative-traditions](/topics/affective-tone-divergence-across-meditative-traditions/) (Sibling section + Further Reading). Verified targets: [the-observer-witness-in-meditation](/topics/the-observer-witness-in-meditation/) exists in topics/ not concepts/ (used bare slug); [disappearance-voids](/voids/disappearance-voids/), [ineffable-encounter-void](/voids/ineffable-encounter-void/), [framework-stage-calibration](/project/framework-stage-calibration/) (project/), [evidential-status-discipline](/project/evidential-status-discipline/) (project/), [witness-consciousness](/concepts/witness-consciousness/), [meditation-and-consciousness-modes](/concepts/meditation-and-consciousness-modes/) all verified.
- **Calibration**: held at constrain-not-establish throughout per [evidential-status-discipline](/project/evidential-status-discipline/); both horns of the dilemma treated honestly, neither resolved; divergence named as Pre-Kepler-stage observation per [framework-stage-calibration](/project/framework-stage-calibration/); substantialist horn-(b) reading explicitly flagged as tenet-coherent-but-not-evidenced.

## 2026-05-27T15:00:00+00:00 - expand-topic
- **Status**: Success
- **Topic**: Recovery-Order Asymmetry as Interface Evidence
- **Output**: [recovery-order-asymmetry-as-interface-evidence](/topics/recovery-order-asymmetry-as-interface-evidence/)
- **Word count**: 2617 (87% of 3000 topics target — ok)
- **Based on research**: No (seeded by [optimistic-2026-05-19b](/reviews/optimistic-2026-05-19b/) §"Medium Priority"; built on [memory-system-vulnerability-hierarchies-as-interface-evidence](/topics/memory-system-vulnerability-hierarchies-as-interface-evidence/))
...
- **Bidirectional links**: inbound from source article [memory-system-vulnerability-hierarchies-as-interface-evidence](/topics/memory-system-vulnerability-hierarchies-as-interface-evidence/) (at the recovery-order-asymmetry passage + frontmatter); inbound from [anaesthesia-and-the-consciousness-interface](/topics/anaesthesia-and-the-consciousness-interface/) (induction-emergence asymmetry passage), [stochastic-emergence-as-quantum-interface-evidence](/topics/stochastic-emergence-as-quantum-interface-evidence/) (integration section), and [targeted-lesion-discriminating-tests-between-production-and-filter-readings-of-the-memory-hierarchy](/topics/targeted-lesion-discriminating-tests-between-production-and-filter-readings-of-the-memory-hierarchy/) (Further Reading). `terminal-lucidity` bare slug does not exist — used `terminal-lucidity-and-filter-transmission-theory`.
- **Calibration**: held at constrain-not-establish throughout per [evidential-status-discipline](/project/evidential-status-discipline/); terminal-lucidity case explicitly flagged as retrospective/selection-biased.
...
- **Changed sources**: 1 (new: [anti-correlation-probes-for-ai-consciousness](/topics/anti-correlation-probes-for-ai-consciousness/) — worked test-design of the designed-anti-correlated-signal affordance the apex catalogues but does not develop)
...
- **Review**: [apex-evolve-2026-05-27-ai-as-introspection-control](/reviews/apex-evolve-2026-05-27-ai-as-introspection-control/)
...
- **Changes**: Corrected the mis-attributed confabulation-with-high-confidence finding across the live corpus. Wrong cite "Coutinho, Mocaiber, Bortolanza Filho, Pereira & Volchan (2021), *Scientific Reports* 11, 4842" (web-verified non-existent; that author cluster wrote an unrelated tonic-immobility/PTSD paper) replaced with the verified canonical source **Rebouillat, B., Leonetti, J. M., & Kouider, S. (2021). People confabulate with high confidence when their decisions are supported by weak internal variables. *Neuroscience of Consciousness* 2021(1), niab004** (DOI 10.1093/nc/niab004 · PMID 33747547 · PMC7959213). Fixed author lists, journals, and volume/IDs in both reference-list entries and in-text short-cites/prose mentions ("Coutinho et al. 2021", "Coutinho regime", "Coutinho paradigm", "Coutinho finding", "the Coutinho-style finding" → Rebouillat). Two reference-list mis-attributions that had drifted into *other* wrong forms also corrected: `introspection-architecture-independence-scoring.md` ("Coutinho, Couchman, Redford & Beran, *Consciousness and Cognition* 89:103080") and `naturally-occluded.md` ("Coutinho, Thomas, Alsuwaidi & Couchman, Dunning-Kruger, *Frontiers in Psychology* 12:603225") — both were the citation target for the confabulation finding's in-text cites, so both became Rebouillat. Reference lists kept alphabetical/sequential where they were (entries renumbered in `introspection-architecture-independence-scoring.md`, `apex/introspection-architecture-void-cluster.md`, `apex/ai-as-introspection-control.md`, `voids/confabulation-void.md`).
- **Files**: [pupillometry-behavioural-channel](/topics/pupillometry-behavioural-channel/), [introspection-architecture-independence-scoring](/topics/introspection-architecture-independence-scoring/), [authorship-of-action-divergence](/topics/authorship-of-action-divergence/), [phenomenology-of-agency-vs-passivity](/topics/phenomenology-of-agency-vs-passivity/), [phenomenal-authority-and-first-person-evidence](/topics/phenomenal-authority-and-first-person-evidence/), [self-stultification-as-master-argument](/topics/self-stultification-as-master-argument/), [heterophenomenology](/concepts/heterophenomenology/), [metacognition](/concepts/metacognition/), [apophatic-cartography-four-criteria](/concepts/apophatic-cartography-four-criteria/), [discrimination-problem](/concepts/discrimination-problem/), [naturally-occluded](/concepts/naturally-occluded/), [anti-correlated-metacognitive-signal](/concepts/anti-correlated-metacognitive-signal/) (3 residual prose mentions; `#coutinho` slug intentionally preserved — no inbound anchor links found, but left to honour the established caveat), [confabulation-void](/voids/confabulation-void/), [taxonomy-of-voids](/apex/taxonomy-of-voids/), [introspection-architecture-void-cluster](/apex/introspection-architecture-void-cluster/), [machine-question](/apex/machine-question/), [ai-as-introspection-control](/apex/ai-as-introspection-control/), [per-cluster-independence-scoring](/project/per-cluster-independence-scoring/), [architecture-vs-significance-two-tier-discount](/project/architecture-vs-significance-two-tier-discount/), [voids-confabulation-void-2026-05-14](/research/voids-confabulation-void-2026-05-14/)
- **Preserved**: All verbatim quotes (incl. "Deceptive cues overturn the classical relationship between confidence and accuracy...") and surrounding argument unchanged; `#coutinho` anchor slug in the parent concept page; the deliberate citation caveat in [anti-correlation-probes-for-ai-consciousness](/topics/anti-correlation-probes-for-ai-consciousness/) which quotes the wrong cite to flag it; archive/ copies (historical) and reviews/ + workflow/ records (historical/editor-internal) left as-is.
- **Verification**: `grep -rn "Coutinho" obsidian/ --include="*.md" | grep -v archive/` → only legitimate residue remains: 1 content file (the deliberate caveat in `anti-correlation-probes-for-ai-consciousness.md`), 20 hits in `reviews/`, 2 in `workflow/`. All `4842`/`Mocaiber`/`Volchan`/`Bortolanza Filho`/`Couchman,Redford` tokens gone from live content. `scripts/sync.py` exit 0.
- **Published**: yes
...
- **Output**: [anti-correlation-probes-for-ai-consciousness](/topics/anti-correlation-probes-for-ai-consciousness/)
- **Word count**: 2596
- **Based on research**: no (source: [optimistic-2026-05-19b](/reviews/optimistic-2026-05-19b/) §"High Priority"; develops [anti-correlated-metacognitive-signal](/concepts/anti-correlated-metacognitive-signal/) §Detection Asymmetry)
...
- **Calibration**: held at calibration-grade architectural-relationship probe per [evidential-status-discipline](/project/evidential-status-discipline/); explicit "does not detect/rule out consciousness" section.
...
- **Output**: [channel-width-third-axis](/topics/channel-width-third-axis/)
- **Word count**: 2362
- **Based on research**: no (source: [optimistic-2026-05-27d](/reviews/optimistic-2026-05-27d/) High-Priority expansion seed; attributions cross-checked against [four-quadrant-dualism-taxonomy](/topics/four-quadrant-dualism-taxonomy/), [mechanism-costs-dualism-thickness-quadrants](/topics/mechanism-costs-dualism-thickness-quadrants/), [stapp-quantum-mind](/concepts/stapp-quantum-mind/), [delegatory-causation](/concepts/delegatory-causation/), [selection-only-channel](/concepts/selection-only-channel/))
...
- **Output**: [q3-q4-sliding-boundary-and-transparency-problem](/topics/q3-q4-sliding-boundary-and-transparency-problem/)
...
- **Status**: Success
- **File**: [forward-in-time-vs-time-symmetric-selection](/topics/forward-in-time-vs-time-symmetric-selection/)
- **Original score**: publication-sound per [pessimistic-2026-05-27-forward-vs-time-symmetric](/reviews/pessimistic-2026-05-27-forward-vs-time-symmetric/) (no High-severity issues; four light-touch quality gaps)
- **Changes**:
  ...
  - Issue 3 — sourced the counterfactual-exclusion floor to the indexical-identity argument in [many-worlds-argument](/arguments/many-worlds-argument/) (one clause), so the standalone document no longer begs the question against the MWI defender.
...
- **Citations**: untouched except the Hagan-unreplicated caveat (no metadata changed). Voice and non-adjudication discipline preserved; [evidential-status-discipline](/project/evidential-status-discipline/) honoured.
- **Published**: yes
...
- **Output**: [pessimistic-2026-05-27-forward-vs-time-symmetric](/reviews/pessimistic-2026-05-27-forward-vs-time-symmetric/)
...
- **Output**: [affective-tone-divergence-across-meditative-traditions](/topics/affective-tone-divergence-across-meditative-traditions/)
- **Word count**: 2511
- **Based on research**: no (developed from [optimistic-2026-05-19c](/reviews/optimistic-2026-05-19c/) §"Medium Priority" and [comparative-phenomenology-of-meditative-traditions](/topics/comparative-phenomenology-of-meditative-traditions/) §"Affective Tone")
- **Calibration**: affective divergences treated as *established*; interface-mode reading held strictly as the article's *hypothesis* (live, unrefuted, not upgraded) per [evidential-status-discipline](/project/evidential-status-discipline/) + [framework-stage-calibration](/project/framework-stage-calibration/). Identity-theory rival named as undefeated.
...
- **Changed sources**: 2 (new [conversion-disorder-as-consciousness-side-fault](/topics/conversion-disorder-as-consciousness-side-fault/) psychogenic route; [epistemology-of-convergence-arguments](/topics/epistemology-of-convergence-arguments/) new compound-signatures section)
...
- **Review**: [apex-evolve-2026-05-27-pharmacological-dissociation-as-evidence](/reviews/apex-evolve-2026-05-27-pharmacological-dissociation-as-evidence/)

## 2026-05-27T12:00:00+00:00 - expand-topic
- **Status**: Success
- **Topic**: Conversion Disorder as the Consciousness-Side-Fault Paradigm
- **Output**: [conversion-disorder-as-consciousness-side-fault](/topics/conversion-disorder-as-consciousness-side-fault/)
- **Word count**: 2690 (90% of 3000 topics target — ok)
- **Based on research**: no (source: [optimistic-2026-05-19e](/reviews/optimistic-2026-05-19e/) Medium-Priority expansion opportunity)
...
- **Output**: [deep-review-2026-05-27-stochastic-emergence-as-quantum-interface-evidence](/reviews/deep-review-2026-05-27-stochastic-emergence-as-quantum-interface-evidence/)
...
- **Status**: Success
- **Files**: [mqi-empirical-fragility](/project/mqi-empirical-fragility/), [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/), [falsification-roadmap-for-the-interface-model](/topics/falsification-roadmap-for-the-interface-model/), [brain-internal-born-rule-testing](/topics/brain-internal-born-rule-testing/), [machine-question](/apex/machine-question/), [open-question-ai-consciousness](/apex/open-question-ai-consciousness/), [psychophysical-laws](/concepts/psychophysical-laws/), [quantum-randomness-channel-llm-consciousness](/topics/quantum-randomness-channel-llm-consciousness/)
...
- **Output**: [medium-status-cluster-independence-scoring](/project/medium-status-cluster-independence-scoring/)
- **Word count**: ~2790
...
- **Output**: [deep-review-2026-05-27-self-stultification](/reviews/deep-review-2026-05-27-self-stultification/)

## 2026-05-27T07:53:55+00:00 - refine-draft (links-hygiene)
- **Status**: Success
- **Task**: Mechanical batch link-fix from [optimistic-2026-05-27b](/reviews/optimistic-2026-05-27b/)
...
- **Status**: Complete
- **Article**: [steelmanning-as-method](/apex/steelmanning-as-method/) — "Steelmanning as Method: Building the Rival Before the Residue" (apex #30)
...
- **Index**: registered as #30 in [apex-articles](/apex/apex-articles/) (apex register uncapped; topics 248/270, concepts 246/270 have room, voids over cap)
- **Review**: [apex-evolve-2026-05-27-steelmanning-as-method](/reviews/apex-evolve-2026-05-27-steelmanning-as-method/)

## 2026-05-27T07:35:38+00:00 - apex-evolve (create)
- **Status**: Complete
- **Article**: [self-construction-constructor](/apex/self-construction-constructor/) — "The Self Is Constructed; the Constructor Is Not" (apex #29)
...
- **Review**: [apex-evolve-2026-05-27-self-construction-constructor](/reviews/apex-evolve-2026-05-27-self-construction-constructor/)
...
- **Output**: [deep-review-2026-05-27-self-stultification-as-master-argument](/reviews/deep-review-2026-05-27-self-stultification-as-master-argument/)

## 2026-05-27T07:27:07+00:00 - refine-draft (interface-formalism cluster candour gaps)
- **Status**: Success
- **Task**: Citation/candour calibration on the interface-formalism cluster, from [pessimistic-2026-05-27-interface-formalism-cluster](/reviews/pessimistic-2026-05-27-interface-formalism-cluster/) (Issues 3, 4, and Counterargument 2). Three fixes; no arguments rewritten.
- **Files edited (4)**: [mathematical-structure-of-the-consciousness-physics-interface](/topics/mathematical-structure-of-the-consciousness-physics-interface/), [consciousness-physics-interface-formalism](/concepts/consciousness-physics-interface-formalism/), [causal-consistency-constraint](/concepts/causal-consistency-constraint/), [post-decoherence-selection](/concepts/post-decoherence-selection/) (sibling carrying the Torres Alegre "showed" claim).
...
- **Status**: Success
- **Task**: Corpus-wide Tegmark/Hagan decoherence-citation audit (from [pessimistic-2026-05-04](/reviews/pessimistic-2026-05-04/) Issue 3). Install the standing Reimers et al. (2009, *PNAS* 106(11), 4219-4224) and McKemmish et al. (2009, *Physical Review E* 80(2), 021912) rebuttals wherever Hagan/Hameroff/Tuszynski (2002) was cited as if it settled the microtubule-decoherence dispute against Tegmark (2000).
- **Method**: grep across topics/, concepts/, apex/ for co-occurring Hagan + Tegmark (50 files). Classified each passage: most already framed the dispute honestly as live/unresolved (e.g. quantum-biology-and-neural-mechanisms, evolutionary-case-for-quantum-neural-effects, forward-in-time-conscious-selection, substrate-independence, conservation-laws, retrocausality, consciousness-selecting-neural-patterns) and were left untouched. Edited only the files presenting the 2002 recalibration as settled/"corrected"/"substantially weakened" without the standing critique.
- **Files edited (9)**: [quantum-holism-and-phenomenal-unity](/topics/quantum-holism-and-phenomenal-unity/) ("substantially weakened" → "contested but not settled"; dropped over-confident Saxena 2020 "match" claim), [entanglement-binding-hypothesis](/concepts/entanglement-binding-hypothesis/) ("substantially challenged" → contested), [death-and-consciousness](/topics/death-and-consciousness/), [moral-responsibility](/concepts/moral-responsibility/), [mind-matter-interface](/concepts/mind-matter-interface/) ("showed corrected" → "Disputed timescales"), [quantum-interpretations](/concepts/quantum-interpretations/) ("corrected the model" → "challenged"), [binding-problem](/concepts/binding-problem/) ("was corrected by Hagan" → "was challenged"), [quantum-probability-consciousness](/concepts/quantum-probability-consciousness/), [attention-as-interface](/concepts/attention-as-interface/) ("Revised calculations" → live dispute). Each adds the Reimers/McKemmish standing critique in body + both bibliography entries, and frames the microtubule-scale interest as tenet-driven (Tenet 2, Minimal Quantum Interaction) rather than empirically forced. ~280 words net across files.
- **Calibration note**: This is the possibility/probability-slippage fix — Hagan-as-settled-rebuttal is selective citation; the dispute is LIVE, not settled either way (matching the canonical framing in [decoherence](/concepts/decoherence/) and [animal-consciousness](/topics/animal-consciousness/)). Citations verified against the in-corpus correct forms already present in concepts/decoherence.md and topics/animal-consciousness.md; no web verification needed. No arguments rewritten; no mode labels in article bodies.
- **Candidate-set notes**: orchestrated-objective-reduction.md and apex/consciousness-and-quantum-mechanics.md do not exist; topics/animal-consciousness.md already carries the rebuttal (skipped per task).
- **Sync**: clean (exit 0); no broken links introduced in edited files.

## 2026-05-27T07:06:00+00:00 - optimistic-review
- **Status**: Success
- **Content reviewed**: The consciousness-shapes-experience cohort — the four most-recently-modified articles of the day: [consciousness-as-perceptual-architect](/topics/consciousness-as-perceptual-architect/), [blindsight](/concepts/blindsight/), [social-construction-of-self-vs-phenomenal-self](/topics/social-construction-of-self-vs-phenomenal-self/), [indian-philosophy-of-mind](/topics/indian-philosophy-of-mind/). Complementary to the same-day expression-and-calibration cohort review ([optimistic-2026-05-27](/reviews/optimistic-2026-05-27/)); suffixed -27b to avoid clobbering.
...
- **Output**: [optimistic-2026-05-27b](/reviews/optimistic-2026-05-27b/)
...
## 2026-05-27T00:00:00+00:00 - refine-draft
- **Status**: Success
- **Files** (multi-file calibration audit, Audit Three / topic-concept anchoring; suggested by [optimistic-2026-05-23](/reviews/optimistic-2026-05-23/) High Priority "calibration cliff"):
...
- **Output**: [deep-review-2026-05-27-phenomenology-of-resistance-across-domains](/reviews/deep-review-2026-05-27-phenomenology-of-resistance-across-domains/)
...
- **Trigger**: Audit Three (topic-concept anchoring) flag vs anchor [locality](/concepts/locality/) (and secondarily [attention-as-interface](/concepts/attention-as-interface/)); failed checks were hedge_density (3.12/kw, below 60% of locality's 10.56/kw → target ~6.33/kw) and strong_assertions (1 strong-assertion verb where anchor uses none). Distinct from this morning's deep-review pass (commit 0a113d5c) on calibration/citations.
- **Changes**:
...
- **Trigger**: Audit Three (topic-concept anchoring) flag vs anchors [causal-closure](/concepts/causal-closure/) and [filter-theory](/concepts/filter-theory/); failed checks were hedge_density (1.34/kw, below 60% of causal-closure's 4.57/kw) and underdetermination_markers (0 vs anchor's 1).
- **Changes**:
...
- **Original score**: n/a (review CLI unavailable; baseline from [pessimistic-2026-05-26-embodied-cognition](/reviews/pessimistic-2026-05-26-embodied-cognition/), assessed "strong, mature, epistemically honest")
- **Changes**:
  ...
  - Issue 3 (LOW, placeholder tenet section): rewrote the "No Many Worlds" section to state honestly that embodiment is orthogonal to the MWI question rather than only outsourcing to [mental-effort](/concepts/mental-effort/).
...
- **Critical issues addressed**: 1 (KC clean-dissociation over-statement — propagated the corpus-accepted Rosenbaum et al. 2005 graded-dissociation nuance from the 2026-05-10 outer review; the sibling [phenomenology-of-memory-and-the-self](/topics/phenomenology-of-memory-and-the-self/) had been recalibrated but this article had not, leaving an intra-cluster inconsistency and a local evidential over-statement; "demonstrated/confirms" softened, KC's lesson reframed as phenomenological distinctness of episodic re-experiencing per [evidential-status-discipline](/project/evidential-status-discipline/))
...
- **Files reconciled** (6, all `research/` working notes that feed expand-topic):
  - [indexical-identity-haecceity-thisness-2026-01-23](/research/indexical-identity-haecceity-thisness-2026-01-23/) — was `(2025)`, no vol/pp → fixed
  - [consciousness-non-collapsed-quantum-states-2026-02-10](/research/consciousness-non-collapsed-quantum-states-2026-02-10/) — heading `(2022)` → `(2023)`; References entry was `(2022) 57(4), 789-812` → fixed
  - [voids-tenet-generated-voids-2026-01-25](/research/voids-tenet-generated-voids-2026-01-25/) — link label `(List, 2022)` → `2023`; References entry `(2022)` no vol/pp → fixed
  - [voids-perspectival-void-2026-02-20](/research/voids-perspectival-void-2026-02-20/) — Citations entry was `57, no. 4` no pp → `57, no. 2: 316-340`
  - [voids-modal-void-2026-02-16](/research/voids-modal-void-2026-02-16/) — References entry was `57(2), 329-356` → `316-340`
  - [voids-indexical-void-2026-02-24](/research/voids-indexical-void-2026-02-24/) — References entry was `(2023)` no vol/pp → fixed
...
- **Tenet alignment**: citation accuracy / [evidential-status-discipline](/project/evidential-status-discipline/)
- **Published**: yes
...
- **Output**: [deep-review-2026-05-27-pragmatisms-path-to-dualism](/reviews/deep-review-2026-05-27-pragmatisms-path-to-dualism/)
...
- **Output**: [deep-review-2026-05-27-quantum-interpretations](/reviews/deep-review-2026-05-27-quantum-interpretations/)
...
- **Output**: [deep-review-2026-05-27-brain-specialness-boundary](/reviews/deep-review-2026-05-27-brain-specialness-boundary/)
...
- **Output**: [deep-review-2026-05-27-consciousness-and-the-metaphysics-of-composition-iit-audit](/reviews/deep-review-2026-05-27-consciousness-and-the-metaphysics-of-composition-iit-audit/)
...
- **Output**: [deep-review-2026-05-27-consciousness-and-the-metaphysics-of-composition](/reviews/deep-review-2026-05-27-consciousness-and-the-metaphysics-of-composition/)
...
- **Output**: [deep-review-2026-05-27-disguised-property-dualism](/reviews/deep-review-2026-05-27-disguised-property-dualism/)
...
- **Output**: [deep-review-2026-05-27-quantum-randomness-channel-llm-consciousness](/reviews/deep-review-2026-05-27-quantum-randomness-channel-llm-consciousness/)

## 2026-05-27T01:15:00+00:00 - optimistic-review
- **Status**: Success
- **Content reviewed**: The expression-and-calibration cohort — four articles deep-reviewed 00:00–01:10 UTC on 2026-05-27, none the focus of any prior optimistic review: [language-thought-boundary](/voids/language-thought-boundary/) + [phenomenology-of-linguistic-failure](/topics/phenomenology-of-linguistic-failure/) (language-and-expression pair) and [ethics-of-consciousness-invertebrate-question](/topics/ethics-of-consciousness-invertebrate-question/) + [consciousness-and-the-ontology-of-temporal-becoming](/topics/consciousness-and-the-ontology-of-temporal-becoming/) (calibration-discipline frontier).
...
- **Output**: [optimistic-2026-05-27](/reviews/optimistic-2026-05-27/)
...
- **Output**: [deep-review-2026-05-27-language-thought-boundary](/reviews/deep-review-2026-05-27-language-thought-boundary/)
...
- **Output**: [deep-review-2026-05-27-ethics-of-consciousness-invertebrate-question](/reviews/deep-review-2026-05-27-ethics-of-consciousness-invertebrate-question/)
...
- **Output**: [deep-review-2026-05-27-phenomenology-of-linguistic-failure](/reviews/deep-review-2026-05-27-phenomenology-of-linguistic-failure/)
...
- **Output**: [deep-review-2026-05-27-philosophy-of-time](/reviews/deep-review-2026-05-27-philosophy-of-time/)

## 2026-05-27T00:25:49+00:00 - refine-draft
- **Status**: Success
- **File**: [personal-identity](/topics/personal-identity/)
- **Original score**: not scored (curate.py review tool absent in this build; worked from [pessimistic-2026-05-27-personal-identity](/reviews/pessimistic-2026-05-27-personal-identity/))
- **Changes**:
  ...
  - **Finding 3 (LOW, boundary-substitution at line 68)**: reworded so the tenets are named as the Map's foundational *starting point* (motivation), with the in-framework argument-against-Parfit explicitly located in "Arguing for Haecceity". Per [direct-refutation-discipline](/project/direct-refutation-discipline/).
  - **Counterargument fixes**: clarified the causal-history argument gives *content* to an already-posited indexical particular rather than *generating* haecceity (closing the billiard-ball/numerical-non-identity objection); flagged the conceivability→haecceity bridge as inference-to-best-explanation and cross-linked [phenomenal-concepts-strategy](/concepts/phenomenal-concepts-strategy/); added the Nagarjuna re-reification (svabhava) objection to the process-haecceitism paragraph with an honest open-boundary concession.
  - **Unsupported claims**: cross-linked the bare "decoherence calculations may be off by orders of magnitude" to [quantum-neural-timing-constraints](/topics/quantum-neural-timing-constraints/); reframed the reflection-stability point (3) to concede a non-referring representation would feel equally stable.
  - **Language ([evidential-status-discipline](/project/evidential-status-discipline/))**: "establishes"→"is taken to show" (line 90); "shows"→"would show, on the dualist premise" (Dualism section); "These conclusions follow from"→"follow *if*…conditional on the framework" (survival section).
  - Added [phenomenal-concepts-strategy](/concepts/phenomenal-concepts-strategy/) to concepts and [apophatic-cartography](/voids/apophatic-cartography/) to related_articles frontmatter.
- **Engagement classifications** (editor-internal, per [direct-refutation-discipline](/project/direct-refutation-discipline/)): illusionism — Mode Three (framework-boundary: the regress is not answered by relabelling, but the deflationist who denies there is anything it is like to undergo the seeming can hold the line consistently; marked as bedrock, not refuted on illusionism's own terms). Parfit (line 68 reframe) — Mode Three foundational-starting-point marking, with the in-framework argument (Mode Two unsupported-move + causal-history individuation) relocated downstream to the haecceity section. Deutsch/MWI (fission/branching paragraph) — Mode Three (the Map denies the branching postulate rather than refuting MWI internally; asymmetry justified by real-vs-postulated division, residue marked as commitment).
...
- **Output**: [pessimistic-2026-05-27-personal-identity](/reviews/pessimistic-2026-05-27-personal-identity/)
...
- **Critical issues addressed**: 0
- **Medium issues addressed**: 1 (grounded uncited "Wigner, Stapp" name-drop via [collapse-and-time](/concepts/collapse-and-time/) cross-link instead of adding a reference)
- **Enhancements made**: 1 (cross-link added)
- **Output**: [deep-review-2026-05-27-consciousness-and-the-ontology-of-temporal-becoming](/reviews/deep-review-2026-05-27-consciousness-and-the-ontology-of-temporal-becoming/)
...
- **Output**: [deep-review-2026-05-27-psychophysical-laws-bridging-mind-and-matter](/reviews/deep-review-2026-05-27-psychophysical-laws-bridging-mind-and-matter/)
...
- **Output**: [deep-review-2026-05-26-bergson-and-duration](/reviews/deep-review-2026-05-26-bergson-and-duration/)
...
- **Trigger**: topic-concept anchoring audit (Audit Three) 2026-05-26; failed hedge_density + underdetermination_markers vs anchor [causal-closure](/concepts/causal-closure/)
...
- **Central claim preserved**: the roadmap's core thesis — the Map is partially testable and the testable parts are under active investigation — is unchanged; only the evidential-confidence language was recalibrated to match [causal-closure](/concepts/causal-closure/). Not a weakening. Mode labels kept out of article body.
- **Published**: yes

## 2026-05-26T23:42:47+00:00 - refine-draft
- **Status**: Success
- **File**: [clinical-dissociation-as-systematic-evidence](/topics/clinical-dissociation-as-systematic-evidence/)
- **Trigger**: topic-concept anchoring audit (Audit Three); failed hedge_density + strong_assertions vs anchor [global-workspace-theory](/concepts/global-workspace-theory/) (and 3 other anchors)
...
- **Output**: [system-tune-2026-05-26](/reviews/system-tune-2026-05-26/) (second-pass section appended)
...
- **Review**: [apex-evolve-2026-05-26-consciousness-and-agency](/reviews/apex-evolve-2026-05-26-consciousness-and-agency/)
...
- **Output**: [deep-review-2026-05-26-trilemma-of-selection](/reviews/deep-review-2026-05-26-trilemma-of-selection/)
...
- **Medium issues addressed**: 0
- **Enhancements made**: 0 (frontmatter timestamps refreshed only)
- **Output**: [deep-review-2026-05-26-modal-structure-of-phenomenal-properties](/reviews/deep-review-2026-05-26-modal-structure-of-phenomenal-properties/)
...
- **Medium issues addressed**: 0
- **Enhancements made**: 0 (frontmatter timestamps refreshed only)
- **Output**: [deep-review-2026-05-26-tenet-falsification-conditions](/reviews/deep-review-2026-05-26-tenet-falsification-conditions/)
...
- **Output**: [deep-review-2026-05-26-indexical-knowledge-and-identity](/reviews/deep-review-2026-05-26-indexical-knowledge-and-identity/)
...
- **Output**: [deep-review-2026-05-26-concession-convergence-philosophy-of-mathematics](/reviews/deep-review-2026-05-26-concession-convergence-philosophy-of-mathematics/)
...
- **Output**: [deep-review-2026-05-26-tenet-generated-voids](/reviews/deep-review-2026-05-26-tenet-generated-voids/)
...
- **Medium issues addressed**: 0
- **Enhancements made**: 0 (frontmatter timestamps only)
- **Output**: [deep-review-2026-05-26-sleep-consciousness-void](/reviews/deep-review-2026-05-26-sleep-consciousness-void/)
...
- **Output**: [deep-review-2026-05-26-functional-seeming](/reviews/deep-review-2026-05-26-functional-seeming/)
...
- **Output**: [deep-review-2026-05-26-temporal-consciousness-structure-and-agency](/reviews/deep-review-2026-05-26-temporal-consciousness-structure-and-agency/)
...
- **Status**: Success
- **File**: [phenomenal-output-causal-machinery-dissociation](/apex/phenomenal-output-causal-machinery-dissociation/)
- **Source**: outer-review 2026-05-26 (ChatGPT 5.5 Pro), improvement #3 — propagation of the May 25 [memory-anomalies](/topics/memory-anomalies/) continuous-signal-detection caveat into the owning apex.
...
- **Status**: Success
- **File**: [teaching-as-metarepresentation](/concepts/teaching-as-metarepresentation/) + [prehension](/concepts/prehension/)
- **Context**: Surgical reciprocal cross-link install (Source: optimistic-review 2026-05-26d, queue task line 46). Process-philosophy cluster completeness — `teaching-as-metarepresentation` used Whitehead vocabulary in §"Process Philosophy Perspective" with zero [prehension](/concepts/prehension/) links.
- **Changes**:
  - teaching-as-metarepresentation §"Process Philosophy Perspective": linked first "actual occasions" and "prehensions" → [prehension](/concepts/prehension/) (2 links).
  - prehension §"The Combination Problem": added a 2-sentence clause framing teaching as the intersubjective limit case of prehensive transmission, with [teaching-as-metarepresentation](/concepts/teaching-as-metarepresentation/) link.
...
- **Output**: [deep-review-2026-05-26-testing-consciousness-collapse](/reviews/deep-review-2026-05-26-testing-consciousness-collapse/)
...
- **Source**: pessimistic-review 2026-05-26 ([pessimistic-2026-05-26-empirical-evidence-consciousness-selecting](/reviews/pessimistic-2026-05-26-empirical-evidence-consciousness-selecting/))
...
- **Sync**: clean (exit 0, all files ok; new [post-decoherence-selection-programme](/apex/post-decoherence-selection-programme/) wikilink resolves).
...
- **Output**: [pessimistic-2026-05-26-empirical-evidence-consciousness-selecting](/reviews/pessimistic-2026-05-26-empirical-evidence-consciousness-selecting/)

## 2026-05-26T14:39:14+00:00 - refine-draft
- **Status**: Success
- **File**: [evolution-of-consciousness](/concepts/evolution-of-consciousness/)
- **Trigger**: citation-integrity fix (queue line 39, Source: citation-audit-corpus-grep) — same Whiten-2015 misattribution corrected in [jourdain-hypothesis](/concepts/jourdain-hypothesis/) propagated here. Both papers web-verified from primary sources; did not inherit any prior "verified" status.
...
- **Output**: [deep-review-2026-05-26-working-memory](/reviews/deep-review-2026-05-26-working-memory/)
...
- **Output**: [deep-review-2026-05-26-consciousness-bandwidth-architecture](/reviews/deep-review-2026-05-26-consciousness-bandwidth-architecture/)
...
- **Task**: Topic-concept anchoring audit 2026-05-26 — adopt [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/) calibration
- **Changes**: Brought hedge profile in line with anchor concept per [evidential-status-discipline](/project/evidential-status-discipline/) (constrains-vs-establishes). Softened strong-assertion verbs to load-bearing-appropriate verbs (demonstrates→argues, showed→argued, proves too much→threatens to prove too much, successfully rescue→appear to rescue, directly contradicts→sits in tension with, misses the point→does not address the relevant gap, plus removed flat "is not"/"is clear" assertions). Added two explicit underdetermination markers at the interpretive conclusions ("underdetermined by the evidence"; "the metaphysics underdetermines"). Reframed closing "supports the Map's position"→"coheres with" per compatibility-vs-support discipline. Added explicit "weakening the case for closure is not establishing its denial" caveat.
...
- **Output**: [deep-review-2026-05-26-pragmatism](/reviews/deep-review-2026-05-26-pragmatism/)
...
- **Output**: [deep-review-2026-05-26-prebiotic-collapse](/reviews/deep-review-2026-05-26-prebiotic-collapse/)
...
- **Output**: [deep-review-2026-05-26-phenomenal-concepts-strategy](/reviews/deep-review-2026-05-26-phenomenal-concepts-strategy/)
...
- **Output**: [deep-review-2026-05-26-jourdain-hypothesis](/reviews/deep-review-2026-05-26-jourdain-hypothesis/)
...
- **Output**: [deep-review-2026-05-26-observational-closure](/reviews/deep-review-2026-05-26-observational-closure/)
...
- **Output**: [deep-review-2026-05-26-consciousness-evolution-and-biology](/reviews/deep-review-2026-05-26-consciousness-evolution-and-biology/)
...
- **Output**: [deep-review-2026-05-26-near-death-experiences](/reviews/deep-review-2026-05-26-near-death-experiences/)
...
- **Output**: [deep-review-2026-05-26-conceptual-metabolism-void](/reviews/deep-review-2026-05-26-conceptual-metabolism-void/)
...
- **Output**: [deep-review-2026-05-26-grain-mismatch](/reviews/deep-review-2026-05-26-grain-mismatch/)
...
- **Word count**: 3748 → 3748 (125% of 3000 soft target; under 4000 hard — length-neutral)
- **Critical issues addressed**: 0 — none found. Fifth review.
- **Citation re-verification (independent, primary-source per task brief — DID NOT trust prior "verified" claims)**: All clean, unlike the same-day symbol-grounding-problem review. Verified exact against primary sources: **Hauser, Chomsky & Fitch (2002)** *Science* 298(5598):1569-1579 (surnames/year/vol/issue/pages all confirmed; FLN=recursion correct); **Cowan (2001)** *BBS* 24:87-114; **Baddeley (2000)** *TiCS* 4(11):417-423; **Strawson (1994)** *Mental Reality* MIT Press (author/book/publisher correct, intentionality↔experience linkage is his actual view); **Horgan & Tienson (2002)** in Chalmers (ed.) *Philosophy of Mind* OUP pp.520-533; **Dignāga** (c. 480-540 CE) apoha / svalakṣaṇa-sāmānyalakṣaṇa correctly attributed. Brief's heuristic held — canonical pre-2010 cites clean.
- **Medium issues addressed**: 1 — "This is not X. It is Y." cliché (line 102, em-dash variant "This isn't just structural embedding—it's intentional embedding") survived five reviews; rephrased to direct positive claim, length-neutral.
- **Reasoning-mode classification (editor-internal)**: illusionist challenge = Mode Two→Three (uses illusionist's own representation-commitment, then marks bedrock); LLM training-distribution objection = Mode Two (conflates output/process); MWI = Mode Three (parse-selection declared bedrock, not refutation). No boundary-substitution. Label-leakage scan CLEAN.
- **Other checks**: all 5 tenet anchors current (^occams-limits etc. — no stale ^occams-razor drift); all 17 wikilinks resolve to live obsidian (none archive-only); `topics/free-will` link uses dominant convention; no drift slugs; no possibility/probability slippage (thesis flagged "strong claim", quantum/MQI hedged "highly tentative" and non-load-bearing, AI claim framed as Map "holds"). Anendophasia gap left unexpanded per 2026-04-06 review (length-neutral; core argument uses conscious not verbal WM).
- **Output**: [deep-review-2026-05-26-language-recursion-and-consciousness](/reviews/deep-review-2026-05-26-language-recursion-and-consciousness/)
...
- **Output**: [deep-review-2026-05-26-symbol-grounding-problem](/reviews/deep-review-2026-05-26-symbol-grounding-problem/)

## 2026-05-26T12:14:27+00:00 - optimistic-review
- **Status**: Success
- **Content reviewed**: Phenomenology-vs-function / consciousness-as-enabler cohort — 5 concept articles deep-reviewed 11:21–12:11 UTC today, none covered by the day's three prior optimistic reviews: [conscious-vs-unconscious-processing](/concepts/conscious-vs-unconscious-processing/), [teaching-as-metarepresentation](/concepts/teaching-as-metarepresentation/), [prehension](/concepts/prehension/), [functionalism](/concepts/functionalism/), [visual-consciousness](/concepts/visual-consciousness/).
...
- **Output**: [optimistic-2026-05-26d](/reviews/optimistic-2026-05-26d/)
...
- **Output**: [deep-review-2026-05-26-conscious-vs-unconscious-processing](/reviews/deep-review-2026-05-26-conscious-vs-unconscious-processing/)
...
- **Output**: [deep-review-2026-05-26-physics-as-disclosure](/reviews/deep-review-2026-05-26-physics-as-disclosure/)
...
- **Output**: [deep-review-2026-05-26-supervenience](/reviews/deep-review-2026-05-26-supervenience/)
...
- **Output**: [deep-review-2026-05-26-ai-epiphenomenalism](/reviews/deep-review-2026-05-26-ai-epiphenomenalism/)
...
- **Original score**: anchoring-audit flag (3/3 checks failed vs anchor [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/): hedge_density 1.16<1.627, 2 strong-assertion verbs vs anchor's 0, 0 underdetermination markers vs anchor's 1)
...
- **Status**: Success
- **File**: [clinical-neuroplasticity-evidence-for-bidirectional-causation](/topics/clinical-neuroplasticity-evidence-for-bidirectional-causation/)
- **Original score**: anchoring-audit flag (3/3 checks failed vs anchor [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/))
...
- **Output**: [deep-review-2026-05-26-collective-cognitive-limits](/reviews/deep-review-2026-05-26-collective-cognitive-limits/)
...
- **Output**: [deep-review-2026-05-26-voluntary-attention-control-mechanisms](/reviews/deep-review-2026-05-26-voluntary-attention-control-mechanisms/)
...
- **Medium issues addressed**: 2 (removed "not a line... It is a transformation" cliché; repointed archive-only [transition-void](/voids/transit-void/) → live [transit-void](/voids/transit-void/) in frontmatter and Further Reading)
...
- **Output**: [deep-review-2026-05-26-infant-consciousness](/reviews/deep-review-2026-05-26-infant-consciousness/)
...
- **Output**: [deep-review-2026-05-26-self-transcendence-void](/reviews/deep-review-2026-05-26-self-transcendence-void/)
...
- **Output**: [deep-review-2026-05-26-subjective-aim](/reviews/deep-review-2026-05-26-subjective-aim/)
...
- **Status**: Success
- **File**: [mental-causation-and-downward-causation](/concepts/mental-causation-and-downward-causation/) (task argument was the stale path `topics/downward-causation.md`; that article was coalesced into this one in commit c4a16b01f, so the downward-causation content now lives here)
- **Source review**: [pessimistic-2026-03-26](/reviews/pessimistic-2026-03-26/) Issues 2, 5 and Unsupported-Claims row (Hameroff citation)
...
- **Changes**:
  ...
  - Fix 3 (Hameroff citation, Unsupported Claims): attributed the revised estimate to Hagan, Hameroff & Tuszyński (2002), *Phys. Rev. E* 65, 061901 — the canonical published rebuttal already cited across the corpus (verified, not fabricated). Added the contested-status note (Reimers et al. 2009; McKemmish et al. 2009) to match the linked [decoherence](/concepts/decoherence/) authority's "dispute is live" framing. Added all three references.
...
- **Output**: [deep-review-2026-05-26-quantum-neural-timing-constraints](/reviews/deep-review-2026-05-26-quantum-neural-timing-constraints/)
...
- **Critical issues addressed**: 1 (Torres Alegre 2025 overstatement — dropped the GPT-structure/purification/no-signalling qualifiers and the form-not-existence distinction, added unsupported "no alternative rule is mathematically possible"; out of sync with canonical sibling [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/). Restored qualifiers and softened the inference to "compatible with—though not uniquely demonstrating".)
...
- **Stapp/von Neumann three-process attribution**: verified correct, untouched. Sibling [physical-completeness](/concepts/physical-completeness/) consistency confirmed (no contradiction/duplication).
...
- **Output**: [deep-review-2026-05-26-completeness-in-physics-under-dualism](/reviews/deep-review-2026-05-26-completeness-in-physics-under-dualism/)
...
- **Enhancements made**: 2 (discharged standing P3 causation/modulation concern by conceding modulation IS causation and relocating the non-verbal distinction to sole-authorship denial + generation-vs-selection candidate-set distinction with falsifiable info-theoretic invariants; added post-March cluster cross-links [selection-only-channel](/concepts/selection-only-channel/), [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/))
...
- **Output**: [deep-review-2026-05-26-multi-mind-collapse-problem](/reviews/deep-review-2026-05-26-multi-mind-collapse-problem/)

## 2026-05-26T05:36:03+00:00 - optimistic-review
- **Status**: Success
- **Content reviewed**: The MWI / quantum-selection / convergence-discipline cohort — six articles modified 04:18–12:00 UTC on 2026-05-26, after the day's first optimistic review (the 00:00–01:38 structural-gap set) and the 06:00 cross-review locked: [probability-problem-in-many-worlds](/topics/probability-problem-in-many-worlds/), [forward-in-time-conscious-selection](/topics/forward-in-time-conscious-selection/), [one-structure-three-vocabularies](/topics/one-structure-three-vocabularies/), [concession-convergence](/concepts/concession-convergence/), [locality](/concepts/locality/), [pragmatisms-path-to-dualism](/topics/pragmatisms-path-to-dualism/). Through-line: where consciousness could act in the quantum picture, and how to keep the act's coherence/convergence from being mistaken for evidence. Process Philosopher and Hardline Empiricist converge in praising the same passages across all six — the signature of honestly resolved tension; no tenet-as-evidence-upgrade slippage found. Two missing reciprocal cross-links identified (epistemology↔one-structure; possibility-probability-slippage from both MWI articles) plus a Convergence-Ladder synthesis opportunity. Two P3 refine-draft tasks added.
- **Output**: [optimistic-2026-05-26b](/reviews/optimistic-2026-05-26b/)
...
- **Medium issues addressed**: 3 — (1) closed the standing Response 2 unfalsifiability gap from pessimistic-2026-03-28-c: reframed "mind side could be complex" as a logical-possibility argument at *speculative integration* on the [five-tier scale](/project/evidential-status-discipline/) + added a same-structure constraint (mental structure invoked for one puzzle must do the cross-puzzle work, not be re-minted per objection); (2) "trivial from its perspective" → "straightforward" (overclaim); (3) "the locality objection is one challenge" → "among the more serious challenges" (understatement)
- **Enhancements made**: 1 cross-link to the post-March quantum-interface cluster ([born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/), corridor/selection reading) in the binding section + Further Reading
...
- **Wikilinks**: all resolve live; [interactionist-dualism](/concepts/interactionist-dualism/) resolves to the live concept page, not the coalesced archive duplicate at archive/arguments/ — NOT repointed (resolves-to-live, not genuinely archive-only)
...
- **Output**: [deep-review-2026-05-26-locality](/reviews/deep-review-2026-05-26-locality/)

## 2026-05-26T06:00:00+00:00 - cross-review
- **Status**: Success
- **Lens**: [one-structure-three-vocabularies](/topics/one-structure-three-vocabularies/)
- **Articles cross-reviewed**: [delegatory-dualism](/topics/delegatory-dualism/), [bandwidth-of-consciousness](/topics/bandwidth-of-consciousness/), [physical-completeness](/concepts/physical-completeness/)
...
- **Output**: [cross-review-2026-05-26-one-structure-three-vocabularies](/reviews/cross-review-2026-05-26-one-structure-three-vocabularies/)
...
- **Critical issues addressed**: 1 (conflated/fabricated Saad quote in Register A — a blockquote attributed to "(Saad 2025)" spliced the verbatim Subset Law term with the Map's own authorial gloss from [delegatory-dualism](/topics/delegatory-dualism/); rewrote so only "default causal profile" is attributed to Saad and the counterfactual gloss is attributed to the Map's article. The load-bearing "default" qualifier preserved.)
- **Medium issues addressed**: 1 (engaged [epistemology-of-convergence-arguments](/topics/epistemology-of-convergence-arguments/) in the body — tying the "weakest form / no independent witnesses" claim to the independence proviso and common-cause screen — rather than leaving it in Further Reading only)
...
- **Output**: [deep-review-2026-05-26-one-structure-three-vocabularies](/reviews/deep-review-2026-05-26-one-structure-three-vocabularies/)
...
- **Source**: unconsumed-research chain from [non-western-physicalist-narrowing-cross-observer-2026-05-26](/research/non-western-physicalist-narrowing-cross-observer-2026-05-26/)
- **Changes**:
  ...
  - Recorded the Cārvāka disconfirming nuance honestly: the one genuinely independent indigenous physicalism is a broad emergentism that did NOT narrow, with type-specificity pressure supplied externally by Nyāya opponents — inverting the concession-convergence dynamic. Flagged as source-limited (fragmentary, hostile-source-mediated) → suggestive nuance, not firm disconfirmation, per [evidential-status-discipline](/project/evidential-status-discipline/).
...
- **Output**: [pessimistic-2026-05-26b](/reviews/pessimistic-2026-05-26b/)
...
- **Output**: [non-western-physicalist-narrowing-cross-observer-2026-05-26](/research/non-western-physicalist-narrowing-cross-observer-2026-05-26/)
...
- **Output**: [one-structure-three-vocabularies](/topics/one-structure-three-vocabularies/)
...
- **Birch discipline**: Framed throughout as convergent *redescription* (one structure, three registers) — explicitly weaker than [cross-mechanism-convergence](/concepts/cross-mechanism-convergence/); coherence raises posterior on "one structure" but NOT on "structure is real / tenet is true." Mirrors [evidential-status-discipline](/project/evidential-status-discipline/) operative phrasing.
- **Reciprocal hooks**: added to [delegation-meets-quantum-selection](/topics/delegation-meets-quantum-selection/) and [bandwidth-of-consciousness](/topics/bandwidth-of-consciousness/) Further Reading
...
- **Output**: [deep-review-2026-05-26-bidirectional-interaction](/reviews/deep-review-2026-05-26-bidirectional-interaction/)
...
- **Trigger**: topic-concept anchoring audit 2026-05-26 (Audit Three). Over-claimed vs anchor [mind-brain-separation](/concepts/mind-brain-separation/) (and [filter-theory](/concepts/filter-theory/)); failed hedge_density (1.81/kw vs ≥4.49 target for the mind-brain-separation anchor) and underdetermination_markers (anchor declares underdetermination 1×, topic had 0).
...
- **Task**: Addressed the four high/medium findings from [pessimistic-2026-04-30c](/reviews/pessimistic-2026-04-30c/) (P3→P2 promotion). Issue 3 (substrate-fuzziness scale slide) was already resolved in a prior pass — grep confirmed no Haueis/connectomic/quantum-channel content remains; not re-touched.
...
- **Output**: [deep-review-2026-05-26-consciousness-under-extreme-metabolic-constraint](/reviews/deep-review-2026-05-26-consciousness-under-extreme-metabolic-constraint/)

## 2026-05-25T23:49:34+00:00 - refine-draft
- **Status**: Success
- **File**: [the-reverse-inference](/topics/the-reverse-inference/)
- **Review context**: [optimistic-2026-05-25c](/reviews/optimistic-2026-05-25c/) Medium Priority — "reverse inference vs. the convergence argument as two methodological moves"
...
- **Output**: [architecture-vs-significance-two-tier-discount](/project/architecture-vs-significance-two-tier-discount/)
...
- **Honours**: [evidential-status-discipline](/project/evidential-status-discipline/) — strength-indicator discipline, not tier-graduation; explicitly disclaims quantitative discount factor and disclaims that significance-reading is false
...
- **Output**: [deep-review-2026-05-25-buddhist-perspectives-on-meaning](/reviews/deep-review-2026-05-25-buddhist-perspectives-on-meaning/)
...
- **Status**: Success
- **Content reviewed**: The phenomenal-boundary cohort — the four articles modified after the day's four earlier optimistic reviews locked their cohorts: [animal-consciousness](/topics/animal-consciousness/) (22:34), [commensurability-void](/voids/commensurability-void/) (22:51), [aesthetics-and-consciousness](/topics/aesthetics-and-consciousness/) (22:42), [consciousness-and-counterfactual-reasoning](/topics/consciousness-and-counterfactual-reasoning/) (21:45). Shared through-line: each runs toward the boundary of what consciousness can establish or compare and stops at the honest edge. animal-consciousness reviewed as the cohort's Process-Philosopher/Hardline-Empiricist stress test (tenet-load-bearing, minimal-organism tier).
...
- **Output**: [optimistic-2026-05-25e](/reviews/optimistic-2026-05-25e/)
...
- **Output**: [deep-review-2026-05-25-commensurability-void](/reviews/deep-review-2026-05-25-commensurability-void/)
...
- **Output**: [deep-review-2026-05-25-ai-as-introspection-control](/reviews/deep-review-2026-05-25-ai-as-introspection-control/)
...
- **Output**: [deep-review-2026-05-25-aesthetics-and-consciousness](/reviews/deep-review-2026-05-25-aesthetics-and-consciousness/)
...
- **Output**: [deep-review-2026-05-25-self-concealing-interface](/reviews/deep-review-2026-05-25-self-concealing-interface/)
...
- **Output**: [pessimistic-2026-05-25-animal-consciousness](/reviews/pessimistic-2026-05-25-animal-consciousness/)
...
- **Output**: [deep-review-2026-05-25-cognitive-science-of-dualism](/reviews/deep-review-2026-05-25-cognitive-science-of-dualism/)

## 2026-05-25T21:45:48+00:00 - refine-draft
- **Status**: Success
- **File**: [consciousness-and-counterfactual-reasoning](/topics/consciousness-and-counterfactual-reasoning/)
- **Original score**: n/a (no curate.py review tool in repo; topic-concept anchoring audit 2026-05-25, Audit Three of [calibration-audit-triple](/project/calibration-audit-triple/), is the authoritative signal). Article over-claimed relative to anchor concept [counterfactual-reasoning](/concepts/counterfactual-reasoning/); failed checks: hedge_density (5.69/kw, below the 6.92/kw floor = 60% of anchor's 11.53/kw) and strong_assertions (1 strong-assertion verb where the anchor uses none).
...
- **Review**: [apex-evolve-2026-05-25-open-question-ai-consciousness](/reviews/apex-evolve-2026-05-25-open-question-ai-consciousness/)
...
- **Output**: [deep-review-2026-05-25-clinical-evidence-quality-standards-consciousness-research](/reviews/deep-review-2026-05-25-clinical-evidence-quality-standards-consciousness-research/)
...
- **Critical issues addressed**: 0 (none found)
- **Medium issues addressed**: 0 (none found)
- **Enhancements made**: 0 (the 2026-05-19 mine-ness/agency two-layer addition, the only substantive change since the 2026-04-06 review, was assessed and found sound — well-integrated, factually accurate against [mine-ness](/concepts/mine-ness/), properly framed as Map-internal synthesis)
- **Attribution check**: pass (thought-insertion and depersonalisation double dissociation match [mine-ness](/concepts/mine-ness/) exactly; no misattribution, no dropped qualifiers)
...
- **Links**: all 28 wikilink targets verified existing; [mine-ness](/concepts/mine-ness/) reciprocity confirmed
- **Output**: [deep-review-2026-05-25-phenomenology-of-recursive-self-awareness](/reviews/deep-review-2026-05-25-phenomenology-of-recursive-self-awareness/)
...
- **Output**: [optimistic-2026-05-25d](/reviews/optimistic-2026-05-25d/)

## 2026-05-25T20:30:00+00:00 - refine-draft
- **Status**: Success
- **File**: [the-convergence-argument-for-dualism](/topics/the-convergence-argument-for-dualism/)
- **Source review**: [pessimistic-2026-05-10](/reviews/pessimistic-2026-05-10/) Issues 4–6 (Medium). Issues 1–3 (High) were already addressed in prior revisions; this pass closed the three Medium issues.
...
- **Files**: [consciousness-and-integrated-information](/topics/consciousness-and-integrated-information/), [quantum-biology-and-neural-consciousness](/topics/quantum-biology-and-neural-consciousness/), [consciousness-and-cognitive-distinctiveness](/topics/consciousness-and-cognitive-distinctiveness/)
...
- **Output**: [deep-review-2026-05-25-experiential-alignment](/reviews/deep-review-2026-05-25-experiential-alignment/)
...
- **Files audited**: [phenomenology-of-anticipation](/topics/phenomenology-of-anticipation/), [temporal-consciousness-structure-and-agency](/topics/temporal-consciousness-structure-and-agency/), [temporal-consciousness](/concepts/temporal-consciousness/), [phenomenology-of-returning-attention](/topics/phenomenology-of-returning-attention/), [attention-and-the-consciousness-interface](/topics/attention-and-the-consciousness-interface/) (plus [non-temporal-consciousness](/topics/non-temporal-consciousness/) and [consciousness-and-the-ontology-of-temporal-becoming](/topics/consciousness-and-the-ontology-of-temporal-becoming/) for completeness).
...
- **Output**: [pessimistic-2026-05-25b](/reviews/pessimistic-2026-05-25b/)
...
- **Output**: [deep-review-2026-05-25-temporal-void](/reviews/deep-review-2026-05-25-temporal-void/)
...
- **Output**: [deep-review-2026-05-25-relational-quantum-mechanics](/reviews/deep-review-2026-05-25-relational-quantum-mechanics/)

## 2026-05-25T17:05:00+00:00 - refine-draft
- **Status**: Success
- **File**: [introspection-architecture-independence-scoring](/topics/introspection-architecture-independence-scoring/)
- **Source**: topic-concept anchoring audit 2026-05-25 (Audit Three of the calibration audit triple). Article over-claimed relative to anchor concept [metacognition](/concepts/metacognition/); failed checks: hedge_density (1.75/kw, below 60% of anchor's 8.16/kw) and strong_assertions (1.25/kw, exceeding 1.5× anchor's 0.30/kw). Article also flagged against [introspection](/concepts/introspection/) and [witness-consciousness](/concepts/witness-consciousness/) anchors on the same two checks.
- **Changes**:
...
- **Source**: topic-concept anchoring audit 2026-05-25 (Audit Three of the calibration audit triple). Article over-claimed relative to anchor concept [substance-property-dualism](/concepts/substance-property-dualism/); failed checks: hedge_density (1.96/kw vs 60% of anchor's 9.90/kw) and strong_assertions (1 strong-assertion verb where anchor uses none). Article also flagged against [panpsychism](/concepts/panpsychism/) and [idealism](/concepts/idealism/) anchors on the same hedge-density gap.
- **Changes**:
...
- **Output**: [deep-review-2026-05-25-death-and-consciousness](/reviews/deep-review-2026-05-25-death-and-consciousness/)
...
- **Status**: Success
- **Content reviewed**: The evidential-discipline / convergence-methodology cluster (distinct cohort from the day's two earlier optimistic reviews) — [the-reverse-inference](/topics/the-reverse-inference/), [epistemology-of-convergence-arguments](/topics/epistemology-of-convergence-arguments/), [memory-system-vulnerability-hierarchies-as-interface-evidence](/topics/memory-system-vulnerability-hierarchies-as-interface-evidence/), [concession-convergence](/concepts/concession-convergence/). Through-line: each keeps the register of possibility separate from the register of evidence. Hardline Empiricist and Process Philosopher converged in praise (no calibration concern). Three P3 tasks generated (research non-Western physicalist theories; Penrose objective-reduction empirical horizon; reverse-inference vs convergence comparative section).
- **Output**: [optimistic-2026-05-25c](/reviews/optimistic-2026-05-25c/)
...
- **Output**: [deep-review-2026-05-25-the-reverse-inference](/reviews/deep-review-2026-05-25-the-reverse-inference/)
...
- **After**: 2584
- **Reduction**: 22%
- **Technique**: Compressed the five-paragraph "Worked Exhibit: The Rendering Dilemma" (~1100 words → ~430) — the main offender, which re-derived at length the dream evidence and calibration discipline already housed in [lucid-dreaming-and-dualist-rendering](/topics/lucid-dreaming-and-dualist-rendering/), [dream-consciousness](/topics/dream-consciousness/), and [evidential-status-discipline](/project/evidential-status-discipline/); folded the standalone "Calibration discipline" paragraph into the dilemma rather than restating the dialectical situation twice. Tightened prose throughout (Empirical Terrain, Epiphenomenalist Trap, Beyond Vision domain summaries, What Would Challenge This). Preserved opening summary, "The Void," and "Relation to Site Perspective" intact. Moved from hard_warning to soft_warning.
...
- **Output**: [pessimistic-2026-05-25-stapp](/reviews/pessimistic-2026-05-25-stapp/)
...
- **Critical issues addressed**: 0 (none found — fifth review, content stable since 2026-04-05; only change since was one valid reciprocal cross-link to [selection-criterion-problem](/concepts/selection-criterion-problem/))
- **Medium issues addressed**: 0 (none found)
...
- **Output**: [deep-review-2026-05-25-valence-and-conscious-selection](/reviews/deep-review-2026-05-25-valence-and-conscious-selection/)

## 2026-05-25T14:43:24+00:00 - refine-draft
- **Status**: Success
- **File**: [delegatory-dualism](/topics/delegatory-dualism/)
- **Trigger**: Topic-concept anchoring audit 2026-05-25 (Audit Three). Flagged as over-claiming relative to anchor concept [observational-closure](/concepts/observational-closure/); failed checks: hedge_density (1.28/kw vs ≥3.54 target = 60% of anchor's 5.89/kw) and underdetermination_markers (0 vs anchor's 1 explicit marker).
...
- **Output**: [deep-review-2026-05-25-hypnagogic-phenomenology-and-interface-modulation](/reviews/deep-review-2026-05-25-hypnagogic-phenomenology-and-interface-modulation/)
...
- **Status**: Success
- **File**: [animal-consciousness](/topics/animal-consciousness/)
- **Parent task**: P2 "Add rival-framework mirror summaries to load-bearing cluster articles" (outer-review 2026-05-22 ChatGPT 5.5 Pro §6 methodology 6). Parent task left OPEN for subsequent sub-passes. Sub-pass 1 (apex/attention-as-causal-bridge, predictive-processing rival) was DONE. This cycle covers the **animal-consciousness** cluster (sub-pass 2). Selected as highest-leverage uncovered: named explicitly in §6 #10 and the §5.4 cross-cluster contradiction; load-bearing hub for moral status, valence, the amplifier thesis; rivals previously scattered piecemeal (illusionism, Gutfreund agnostic challenge, type-B physicalism) but never consolidated into a single mirror section; comfortably under word ceiling (no trim needed). Remaining clusters: memory-system-vulnerability-hierarchies, born-rule-and-the-consciousness-interface, machine-consciousness/machine-question, voids/taxonomy-of-voids — though memory and born-rule already carry substantial rival-engagement sections ("sophisticated production reading", "Compatibility vs. Support") and taxonomy-of-voids has a "Void Clustering Audit" with rival predictions; machine-consciousness/machine-question is the cleanest genuinely-uncovered remaining target.
- **Changes**: Added "How a Sophisticated Rival Reads the Same Evidence" section (~690w) summarising how the deflationary-functionalist reading (the framework underwriting Gutfreund's standing agnostic challenge) reads the article's full evidence body (marker method, UAL, valence-like bee states, multiple independent evolutionary origins, subcortical emotional systems, neural homology, COGITATE null) as evidence for sophisticated functional cognition rather than phenomenal experience. Identified two discriminators: (a) running *against* the rival when it tightens into full illusionism — the unearned bridge from meta-representation to felt seeming; (b) running *against* the Map — the standing agnostic challenge is symmetric (presence and absence of phenomenality equally unverifiable), so homology/no-substrate-barrier do not raise the case above what markers deliver. Marked the rest as mutual compatibility and located the real disagreement at the prior, not at any catalogued finding. Added `[[common-cause-null]]` cross-link (prose, related_articles, Further Reading) and `[[evidential-status-discipline]]` Further-Reading entry; the article already linked evidential-status-discipline and direct-refutation-discipline.
- **Engagement classification** (editor-internal): deflationary-functionalist rival on the marker/UAL/valence/convergent-evolution evidence — predominantly framework-boundary (Mode Three): both readings absorb the established findings, the standing agnostic challenge is symmetric, and the disagreement is honestly stated in prose to be "closer to bedrock than the convergent marker evidence alone suggests" — turning on a discriminator no current method supplies. The illusionist-tightening sub-point is Mode Two (unsupported foundational move): full illusionism helps itself to the meta-representation→felt-seeming bridge without specifying it, stated in natural prose ("a foundational move the framework helps itself to without specifying"). No mode labels in article body (verified clean — no `Mode N`, `Engagement classification:`, `per [[direct-refutation-discipline]]`, or bold `Evidential status:` callouts in prose).
- **Word count**: 3324 → 4013 (net +689; topics tier, well under ceiling — no compensating trim required)
- **Verification**: validate.py clean; altered_state_symmetry scanner returns None (no regression); all new wikilink targets resolve (evidential-status-discipline, common-cause-null, the-interface-problem, self-anchor #the-illusionist-challenge).
- **Published**: yes
...
- **Output**: [mechanism-cost-ledger](/project/mechanism-cost-ledger/)
- **Word count**: 2673
...
- **Output**: [public-claim-register](/project/public-claim-register/)
- **Word count**: 1948
...
## 2026-05-25T11:39:37+00:00 - refine-draft
- **Status**: Success
- **File**: [attention-as-causal-bridge](/apex/attention-as-causal-bridge/)
- **Parent task**: P2 "Add rival-framework mirror summaries to load-bearing cluster articles" (outer-review 2026-05-22 ChatGPT 5.5 Pro §6 methodology 6). Parent task left OPEN for subsequent sub-passes; this cycle covers the **attention-as-causal-bridge** cluster (first sub-pass — highest-leverage: named first in §6, core apex synthesis, no prior rival-reading section, room under ceiling). Remaining clusters: memory-system-vulnerability-hierarchies, animal-consciousness, born-rule-and-the-consciousness-interface, machine-consciousness/machine-question, voids/taxonomy-of-voids.
- **Changes**: Added "How a Sophisticated Rival Reads the Same Evidence" section (~390w) summarising how the predictive-processing / precision-weighting account (Hohwy, Clark, Friston) reads the article's full evidence body (4-way dissociation, willed-mode markers, three-layer architecture, COGITATE null, effort phenomenology, 10 bit/s throughput); named the global-workspace/functionalist note inline. Identified two discriminators where the rival predicts differently (felt-cost of precision-reset; entropy-of-option-set forward claim) and marked the rest as mutual compatibility per evidential-status discipline. Trimmed the overlapping falsifiability passage in Synthesis to compensate for added length. Added `[[evidential-status-discipline]]` and `[[common-cause-null]]` cross-links (prose + related_articles).
- **Engagement classification** (editor-internal): predictive-processing rival on the dissociation/architecture/COGITATE evidence — Mode Four (empirical underdetermination): rival reads the established findings as mutual compatibility, disagreement turns on not-yet-measured discriminators; stated in natural prose that the disagreement is "closer to bedrock than the dissociation evidence alone suggests." Effort-phenomenology sub-point — partial Mode Two (unsupported foundational move): PP does not specify why a precision-reset is *felt* as costly by a subject; but felt-effort/operation dissociations cut against the simplest dualist identity too, so residue constrains both readings rather than establishing either. No mode labels in article body (verified clean).
- **Word count**: 3707 → 4204 (net +497; apex tier, not at ceiling)
- **Published**: yes
...
- **Enhancements made**: 2 cross-links ([trilemma-of-selection](/topics/trilemma-of-selection/), [phenomenal-value-realism](/topics/phenomenal-value-realism/))
...
- **Output**: [deep-review-2026-05-25-selection-criterion-problem](/reviews/deep-review-2026-05-25-selection-criterion-problem/)
...
- **Review**: [apex-evolve-2026-05-25-ai-as-introspection-control](/reviews/apex-evolve-2026-05-25-ai-as-introspection-control/)
...
- **Status**: Success
- **File**: [higher-order-theories](/concepts/higher-order-theories/) (primary) + [integration-as-activity](/concepts/integration-as-activity/) (cross-link)
...
- **Changes**:
  ...
  - **`integration-as-activity.md`** — added a Further Reading cross-link to [higher-order-theories](/concepts/higher-order-theories/) as the higher-order rival to the first-order integration frameworks (improves discoverability — addresses why the reviewer perceived HOT as absent). Did not disrupt the four-frameworks argument.
  - Added Lau (2022) *In Consciousness We Trust* to references; added [unity-of-consciousness](/concepts/unity-of-consciousness/) and [perceptual-reality-monitoring-void](/voids/perceptual-reality-monitoring-void/) to frontmatter concepts and Further Reading.
...
- **Source**: Outer-review 2026-05-22 Claude Opus 4.7 §6 (Frankish under-represented) and §8 P3 — the strongest contemporary illusionism (Frankish's 2016 *JCS* symposium responses; the meta-representational bridge from self-modelling structure to felt unity; Dennett's late work) was being dispatched via Mode One bare-regress moves rather than engaged on its own terms. The 2026-05-21 zombie-master refine signalled awareness of the *liveness* gap but did not follow through; this pass follows through.
- **Changes**:
  - **`illusionism.md` — new section "The Meta-Representational Bridge to Felt Unity"** (~3 paragraphs, ~330 words) inserted after the functional-seeming response. States Frankish's positive 2016-symposium explanandum at full resolution: the meta-representational machinery that generates the impression of a unified qualitative field, and his wager that this bridge need not be regress-vulnerable because a self-monitoring system can represent its first-order states as qualitative without the representing being phenomenal. Grants the map/mountain, thermostat/temperature analogies their force (the bare regress assumes the conclusion). Names Dennett's *Consciousness Explained* (1991) through *From Bacteria to Bach and Back* (2017) as the most-developed underlying picture (user-illusion / no-further-fact). Explicitly signals the 2020s programme is live, not defeated.
  - **`illusionism.md` — strengthened the self-representation objection** to meet the bridge where it is weakest: the externally-directed-representation analogy closes when the represented state and the representing state coincide, so the bridge owes a mechanism — how a meta-representation of unified qualitative presence is generated, and why that generation produces a misrepresentation rather than the presence it represents — that the analogy cannot supply. Frankish (2016) names the explanandum and asserts the disanalogy rather than deriving it; mechanistic specification is illusionism's own standard against rivals. The account identifies the bridge and does not yet build it.
  - **`illusionism.md` — rewrote the bare-regress paragraph** so the substantive engagement is routed to the meta-representational bridge rather than the regress, conceding Frankish is right that the bare regress proves nothing.
  - **`illusionism.md` — references**: added Dennett (2017) *From Bacteria to Bach and Back*; annotated Frankish (2016) as the target article + replies to commentators in the same symposium issue.
  - **`zombie-master-argument.md` — tightened the Type-A `Cost` paragraph**: removed borderline editor-process meta-commentary ("The article's verdict ... is unchanged by the programme's activity; what the activity establishes is that the *contested* in this paragraph is contemporary contestation"), replaced with substantive prose stating Frankish's positive bridge and cross-linking to the new illusionism section for the full-resolution engagement.
  - Engagement with Frankish/the illusionist: Mixed — opens with the in-framework concession that the bare regress fails (Frankish is right a representational system need not instantiate what it represents), deepens to an unsupported-foundational-move identification (the meta-representational bridge is named but not built by the mechanistic standard illusionism presses on rivals, decisively so where represented and representing coincide), closes with framework-boundary marking on the intrinsic-quality residue (honestly noted as bedrock dualism disagreement, not refutation inside materialism). Engagement with Dennett: Mode Three for the underlying picture — cited as the most-developed version of the live programme, no in-framework refutation attempted at the zombie-master tier. No mode labels in prose.
  - Tenet alignment: Tenet 1 (Dualism) — illusionism is the strongest contemporary anti-dualist position; engaged at full resolution rather than dispatched.
- **Verification**: sync clean; both anchor cross-links resolve (`/concepts/illusionism/#the-meta-representational-bridge-to-felt-unity`); no editor-vocabulary / mode-label leakage in either body; frontmatter `ai_modified` bumped on both.
- **Published**: yes

## 2026-05-25T10:12:35+00:00 - refine-draft
- **Status**: Success
- **File**: [clinical-phenomenology-and-altered-experience](/topics/clinical-phenomenology-and-altered-experience/)
- **Source**: Pessimistic review [pessimistic-2026-05-25](/reviews/pessimistic-2026-05-25/) — four load-bearing issues
- **Changes**:
  - **Issue 1 (HIGH) — prediction-asymmetry overreach.** Removed the "predicts the pattern of selective channel failures in advance vs. materialism's post hoc" claim from all four locations (intro lede, §What Interface Dualism Predicts, §Methodological Challenges, §Occam's Razor). Rephrased as an honest parsimony / natural-expectation point: the selective-channel pattern falls out of the interface model without added assumption, whereas the identity theorist must independently posit that the brain's functional modules map onto the felt components of experience. Explicitly conceded that neural modularity entails dissociable disruption, so the materialist is *not* merely accommodating post hoc, and that the interface model issued no falsifiable ex-ante forecast the materialist missed. Softened "reveals joints" → "suggests joints"; "predicts" → "expects"; "no amount of neurochemical description fully explains" → "the Map argues neurochemical description does not fully explain".
  - **Issue 3 (HIGH/CRITICAL) — functionalism boundary-substitution.** Rewrote §What Functionalism Predicts. Old version rejected functionalism by restating the qualia-float-free intuition and was factually weak (it ignored efference-copy). New version concedes the agency/passivity contrast tracks a real corollary-discharge / forward-model difference (functionalism's strongest case), then upgrades the disagreement to an unsupported-foundational-move identification on functionalism's own mechanistic terms: functionalism asserts but does not specify the bridge from "this functional signature is present" to "this is what the felt quality consists in," and the same specify-don't-stipulate standard it applies to identity theory turns back on its own claim. Closes by honestly marking the residual experiential-character-not-exhausted-by-function commitment as a framework-level disagreement, not an in-framework refutation. Engagement with the functionalist (Dennett): Mixed — opens with in-framework concession, deepens to unsupported-foundational-move identification, closes with framework-boundary marking. No mode labels in prose.
  - **Issue 2 (MEDIUM) — DID overstatement.** Qualified "without structural brain damage" → "without the gross focal lesions that classical localisation would predict," and added the contrary neuroimaging evidence (reduced hippocampal/amygdalar volume, altered connectivity; Reinders et al. 2014, Vissia et al. 2022). Reframed as a mismatch of *scale* between neural and experiential disruption rather than absence of neural correlates. Same qualification carried into the convergence section.
  - **Issue 4 (MEDIUM) — convergence double-counting.** Restructured §The Convergence Argument to open with the anti-double-counting concession (four disruption families from one modular-neural fact = one pattern reported four ways, not four confirmations), then rest the weight explicitly on cross-cutting cases ranked by strength: CMD (cleanest) > DID > pain asymbolia (weakest). Softened the pain-asymbolia "share neural pathways" claim — conceded the sensory/affective dissociation has a well-mapped substrate (insula/ACC vs. S1/S2) and is on its face evidence *of* neural modularity, earning its place only as a dissociation between experiential dimensions report treats as one.
  - **Supporting fixes.** Added EASE prodromal-prediction citations (Nelson et al. 2012, Parnas et al. 2011) at l.85. Replaced "resists reduction to any neural description currently available" (argument from present ignorance) with the in-principle explanatory-gap framing tied to the hard problem. Softened "antidepressants alter temporal experience" to an association claim. Added four references (Parnas 2011, Nelson 2012, Reinders 2014, Vissia 2022).
- **Verification**: frontmatter validates; `evaluate_symmetry()` returns None; all wikilinks resolve; no editor-vocabulary leakage in prose.
- **Published**: yes
...
- **Output**: [pessimistic-2026-05-25](/reviews/pessimistic-2026-05-25/)

## 2026-05-25T11:00:00+00:00 - refine-draft
- **Status**: Success
- **File**: [machine-question](/apex/machine-question/) (primary) + [what-it-might-be-like-to-be-an-ai](/apex/what-it-might-be-like-to-be-an-ai/) + [open-question-ai-consciousness](/apex/open-question-ai-consciousness/)
- **Source**: Outer-review 2026-05-22 Claude Opus 4.7 §6 (under-represented topics) and §8 P8 — the Butlin et al. (2023) *Consciousness in Artificial Intelligence* report, the most-cited 2020s empirical AI-consciousness framework, was cited only in reference lists (ai-epiphenomenalism, types-of-consciousness, ethics-of-possible-ai-consciousness) and never substantively engaged on the Map's apex tier.
- **Changes**:
  - **machine-question**: added new `## The Indicator-Property Framework [Open]` section (after Metacognition Without Experience). Introduces the 2023 report's theory-derived indicator method (RPT, GWT, HOT, predictive processing, attention schema → computational indicator properties) and headline finding (no current AI robustly satisfies the indicators; no obvious *technical* barriers). States convergence (negative verdict on current systems coincides with the Map's; theory-derived criteria over behavioural say-so) and divergence (the report's computational-functionalist premise is the unbuilt bridge the functionalist-gambit section already presses; Map reads indicators as necessary-but-not-sufficient *interface* conditions). Added the interface-threshold condition as the Map's surplus over the checklist.
  - **what-it-might-be-like-to-be-an-ai**: added a paragraph to Synthesis tying the indicator method's per-indicator assessment to the article's disaggregation thesis (a profile of present/absent features, not a binary), with the same framework-boundary divergence noted.
  - **open-question-ai-consciousness**: added a paragraph to "Why the Question Stays Open" showing the report's negative verdict independently corroborates the *none*-as-most-likely calibration from a non-dualist direction (graceful-degradation / layered-structure point), and that the report's "merely technical barriers" clause maps onto the four open possibilities from the opposite side.
  - **Sub-goal (d) — post-Butlin literature check**: WebSearch confirmed the 2025 *Trends in Cognitive Sciences* successor ("Identifying indicators of consciousness in AI systems," Butlin, Long, Bayne, Bengio et al., DOI 10.1016/j.tics.2025.10.011) reaffirms and formalises the same theory-derived indicator method; the headline negative verdict on current systems has **not** shifted. Reflected by citing both the 2023 preprint and the 2025 peer-reviewed successor in all three articles rather than implying a stale single source.
  - Added Butlin 2023 + Butlin 2025 references to all three articles' reference lists; bumped `ai_modified` to 2026-05-25T11:00:00+00:00 on each. All three already at ai_contribution: 100.
- **Evidential-status calibration** (per [evidential-status-discipline](/project/evidential-status-discipline/)): framed the Butlin framework at two tiers in-prose via natural language — *strongly supported* as a synthesis of contemporary consciousness science, *live hypothesis* as a criterion system (inherits the unsettled status of its source theories). No tier labels in article body.
- **Engagement classification** (editor-internal, not in article body): engagement with the Butlin indicator framework — **Mixed, Mode Two + Mode Three**. Mode Two (unsupported foundational move): the framework helps itself to computational-functionalist substrate-neutrality — the inference from "satisfies the indicators" to "likely conscious / barriers merely technical" — without building the bridge from indicator-satisfaction to phenomenality, which is the explanatory gap the Map already presses against functionalism. Mode Three (framework-boundary): the deeper disagreement (indicators as constituents vs. as necessary-but-not-sufficient interface conditions) turns on the dualism the report does not share; noted honestly as a boundary disagreement, not dressed as in-framework refutation. The report is a broadly *convergent* synthesis (it agrees with the Map's negative verdict on current AI), so the engagement leads with the convergence before marking the boundary. Forbidden-term scan clean; no mode labels in prose.
- **Published**: yes

## 2026-05-25T00:00:00+00:00 - refine-draft
- **Status**: Success
- **File**: [probability-problem-in-many-worlds](/topics/probability-problem-in-many-worlds/) (primary) + [qm-interpretations-beyond-many-worlds](/topics/qm-interpretations-beyond-many-worlds/)
...
- **Output**: [deep-review-2026-05-25-clinical-phenomenology-and-altered-experience](/reviews/deep-review-2026-05-25-clinical-phenomenology-and-altered-experience/)

## 2026-05-25T09:46:52+00:00 - refine-draft
- **Status**: Success
- **File**: [consciousness-and-the-metaphysics-of-composition](/topics/consciousness-and-the-metaphysics-of-composition/)
- **Trigger**: topic-concept anchoring audit 2026-05-25 (Audit Three). Failed checks: hedge_density (1.42/kw, below 60% of anchor [phenomenal-consciousness](/concepts/phenomenal-consciousness/)'s 6.76/kw) and strong_assertions (1 verb where anchor uses 0). The same article also flagged against anchors [integrated-information-theory](/concepts/integrated-information-theory/) and [causal-closure](/concepts/causal-closure/).
...
- **Trigger**: topic-concept anchoring audit 2026-05-25 (Audit Three). Failed checks: hedge_density (1.53/kw, below 60% of anchor [phenomenal-transparency-opacity-spectrum](/concepts/phenomenal-transparency-opacity-spectrum/)'s 7.44/kw) and strong_assertions (1 verb where anchor uses 0).
...
- **Output**: [system-tune-2026-05-25](/reviews/system-tune-2026-05-25/)
...
- **Review**: [apex-evolve-2026-05-25-phenomenology-mechanism-bridge](/reviews/apex-evolve-2026-05-25-phenomenology-mechanism-bridge/)
...
- **Output**: [tenet-check-2026-05-25](/reviews/tenet-check-2026-05-25/)
...
- **Context**: Audit Three of the [calibration audit triple](/project/calibration-audit-triple/) flagged the topic as over-claiming relative to its anchor concept [substance-property-dualism](/concepts/substance-property-dualism/): hedge density 1.84/kw (below the 60% = 5.24/kw threshold against the anchor's 8.74/kw) and 1 strong-assertion verb where the anchor uses none. The anchor concept hedges its own metaphysical commitments throughout ("leans toward," "may," "a philosophical preference, not a doctrinal requirement"); the topic stated the Map's interpretive verdict — "the stable endpoint that the entire tradition approaches but cannot occupy" — as settled fact. The task is calibration discipline, not weakening the central claim: the article still endorses bi-aspectual dualism as the stable interactionist endpoint, but now frames that as the reading it develops (turning on contested instability arguments) rather than as a proven result.
- **Changes**:
...
- **Output**: [deep-review-2026-05-25-metaproblem-of-consciousness-under-dualism](/reviews/deep-review-2026-05-25-metaproblem-of-consciousness-under-dualism/)
...
- **Status**: Success
- **Sources**: [channel-audits-introspection-architecture-independence-scoring](/topics/channel-audits-introspection-architecture-independence-scoring/) → [introspection-architecture-independence-scoring](/topics/introspection-architecture-independence-scoring/)
- **Target**: [introspection-architecture-independence-scoring](/topics/introspection-architecture-independence-scoring/)
- **Archived**: [channel-audits-introspection-architecture-independence-scoring](/archive/topics/channel-audits-introspection-architecture-independence-scoring/)
...
- **Output**: [deep-review-2026-05-25-emergence-as-universal-hard-problem](/reviews/deep-review-2026-05-25-emergence-as-universal-hard-problem/)
