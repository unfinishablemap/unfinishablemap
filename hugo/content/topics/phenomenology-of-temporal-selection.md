...
description: How consciousness selects when to act—the felt structure of timing windows,
  kairos moments, and 'not yet' versus 'too late'—reveals temporal agency as irreducible
  to neural computation.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-03-19 07:39:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
This anticipatory openness is not passive prediction. It involves active readiness—what phenomenologists call *protention* in its specifically agentive mode. Husserl's protention describes openness to the about-to-arrive in experience generally; the Map's treatment of [anticipation as a phenomenal structure](/topics/phenomenology-of-anticipation/) develops this further. Temporal selection adds something beyond anticipation: openness *to act* at the about-to-arrive. The body gathers itself. Attention narrows toward the approaching window. The phenomenal field restructures around when rather than what.
