...
description: Mathematical insight—grasping why proofs work, inventing new frameworks,
  and experiencing felt necessity—provides the strongest domain-specific evidence
  that consciousness does causal work beyond computation.
draft: false
human_modified: null
last_curated: null
...
**[Occam's Razor Has Limits](/tenets/#occams-limits):** The temptation to reduce mathematical cognition to "the brain computing" exemplifies parsimony misleading when knowledge is incomplete. The apparent simplicity of computational accounts hides what remains unexplained: how computation gives rise to felt necessity, how aesthetic experience reliably tracks mathematical truth, how finite minds access infinite mathematical structures. The apparently "simpler" computational account may be simpler only because it ignores data that doesn't fit.
