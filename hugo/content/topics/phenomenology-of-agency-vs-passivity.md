...
- **Effort**: Active states feel like work. Sustaining focus on a difficult text, resisting distraction, or holding a decision open all involve phenomenal cost. The [phenomenology of effort](/concepts/mental-effort/) tracks real cognitive demand. On the Map's reading, hard tasks feel hard because consciousness is doing more, though a common neural cause of demand and feeling predicts the same fit. [Volitional control research](/topics/volitional-control/) identifies effort as one of four distinguishable components of willing, alongside initiation, sustained control, and veto. Schwartz et al. (1996) reported a result consistent with that reading: OCD patients who exert sustained mental effort to reframe intrusive thoughts show measurable decreases in caudate nucleus activity on PET scans. A small single-group study, it is equally predicted by therapy-induced plasticity on a physicalist account, so it fits effort as causal engagement without establishing it.
...
Flow suggests the agency-passivity axis is not a single dimension but involves at least two: *causal contribution* (whether consciousness is shaping outcomes) and *phenomenal effort* (whether the contribution feels like work). In flow, causal contribution may remain high while phenomenal effort drops. The [attention interface](/concepts/attention-as-interface/) operates smoothly, without the friction that generates effort phenomenology.
...
**[Dualism](/tenets/#dualism)**: The agency-passivity contrast resists reduction to neural terms. Third-person descriptions of brain activity during willed vs. automatic action capture statistical differences in activation patterns, but they do not capture what it is like to be the agent rather than the patient of experience. The phenomenal difference between choosing and observing is as vivid as the difference between colour and silence—and equally irreducible to physical description.
...
**[Occam's Razor Has Limits](/tenets/#occams-limits)**: A parsimony-based argument would dismiss the agency-passivity distinction as "just" a functional representation—the brain tracking its own motor-control modes—and deny any need for non-physical explanation. Tenet 5 holds that simplicity is unreliable where the phenomenon in question (phenomenal character) is precisely what physical description leaves out, so the Map can decline to treat the reductive account's economy as decisive. The concession runs symmetrically: this blocks the parsimony objection from being a refutation; it does not convert the Map's reading of the felt contrast into a demonstration.
