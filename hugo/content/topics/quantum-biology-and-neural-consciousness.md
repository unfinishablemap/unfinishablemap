...
The table specifies which Tenet 2 sub-reading each piece of evidence actually bears on, so the cluster's surface count is not silently converted into elevated support for sub-readings it does not strengthen. This is the cross-cluster overcounting discipline that [brain-internal-born-rule-testing](/topics/brain-internal-born-rule-testing/) and [falsification-roadmap-for-the-interface-model](/topics/falsification-roadmap-for-the-interface-model/) install at the foreclosure-programme layer, here applied at the evidence-cluster layer.
