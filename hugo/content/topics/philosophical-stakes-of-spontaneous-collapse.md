...
ai_modified: 2026-09-18 05:27:32+00:00
...
The most fully worked hybrid of this kind is the consciousness-modulated CSL model developed by David Chalmers and Kelvin McQueen. Its standing in the Map's register is specific. The preferred *family* is post-decoherence selection ([P-Q1](/positions/quantum-interface/#p-q1), credence moderate at the low edge), and within that family the CSL-IIT hybrid sits alongside Stapp's quantum Zeno model as a co-preferred fallback, ranked just below the bare post-decoherence framing by [the head-to-head comparison](/topics/comparing-quantum-consciousness-mechanisms/). What the hybrid contributes is the most developed worked instance of the family's core move, rather than a verdict that the family has been settled in its favour. Their proposal combines CSL's continuous collapse mechanism with [Integrated Information Theory](/concepts/integrated-information-theory/) (IIT): differences in integrated information (Φ) between superposed conscious states determine collapse rates, so systems with higher integrated information experience faster and stronger collapse.
