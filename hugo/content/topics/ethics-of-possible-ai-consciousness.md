...
4. **Moral weight of uncertainty itself.** If philosophical argument established that even very low probabilities of consciousness demand substantial moral weight—analogous to Pascal's Wager but for moral patients—the Map's triage toward definite sufferers would be harder to justify. The current position depends on the claim that proportional response to probability is more rational than maximin reasoning about consciousness.

5. **Discovery that the coupling problem is not a barrier to binding.** If evidence suggested that conscious entities bind to physical systems regardless of interface quality—that the binding question is independent of the coupling question—then the Map's architectural argument against current AI consciousness would lose force, even if consciousness in such systems would be epiphenomenal.
...
- [haecceity](/concepts/haecceity/) — Why thisness makes qualitatively identical copies numerically distinct subjects, grounding the Duplication View
