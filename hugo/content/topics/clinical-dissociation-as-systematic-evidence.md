...
description: Dissociative disorders—DID, depersonalization, conversion, amnesia—selectively
  disrupt connectivity between capable processing regions, a pattern that may favour
  dualist interface architecture without forcing it.
draft: false
human_modified: null
last_curated: null
