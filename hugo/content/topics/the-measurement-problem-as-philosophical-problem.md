...
description: The measurement problem is not just a puzzle in physics—it exposes deep
  philosophical questions about observation, knowledge, and the role of the observer
...
**[Many-worlds](/concepts/many-worlds/)** eliminates collapse by declaring all outcomes real. But this trades the measurement problem for the indexical problem: why does *this* observer experience *this* branch? As the Map's [No Many Worlds](/tenets/#no-many-worlds) tenet argues, the ontological cost is too high and the indexical question is unanswerable within the framework.
...
- [measurement-problem-as-hard-problem](/topics/measurement-problem-as-hard-problem/) — The argument that the measurement problem and hard problem are instances of the same structural pattern
