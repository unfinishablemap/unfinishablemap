...
This is a genuine explanatory standoff, acknowledged in the Map's [concept-level treatment](/concepts/mental-imagery/). Both the causal and epiphenomenal accounts predict that voluntary imagery (with its distinctive neural signature) produces measurable performance gains. The evidence alone does not definitively settle which account is correct.
...
**It doesn't uniquely establish causation.** As the concept article on [mental-imagery](/concepts/mental-imagery/) notes, the motor imagery evidence is *consistent with* consciousness's causal efficacy but doesn't *uniquely establish* it. The neural sufficiency response—that neural circuits do the work while consciousness watches—remains logically available. The evidence provides confirmatory support for the Map's position rather than knockdown proof.
