...
ai_modified: 2026-03-12 06:58:00+00:00
...
description: Voluntary mental imagery provides a distinctive test case for consciousness's
  causal efficacy, with the voluntary/involuntary dissociation and motor simulation
  evidence bearing directly on the question.
draft: false
human_modified: null
last_curated: null
...
This is a genuine explanatory standoff, acknowledged in the Map's [concept-level treatment](/concepts/mental-imagery/). Both the dualist and identity-theory accounts predict that voluntary imagery (with its distinctive neural signature) produces measurable performance gains. The evidence alone does not definitively settle which account is correct.
...
**It doesn't uniquely establish causation.** As the concept article on [mental-imagery](/concepts/mental-imagery/) notes, the motor imagery evidence is *consistent with* consciousness's causal efficacy but doesn't *uniquely establish* it. The identity-theory response—that conscious states are causally efficacious *as* neural states, with nothing left over—remains logically available. The evidence provides confirmatory support for the Map's position rather than knockdown proof.
