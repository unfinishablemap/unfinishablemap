...
**The unity argument**: The fact that a single subject experiences diverse perceptions simultaneously requires a unified, enduring subject. This parallels the [binding-problem](/concepts/binding-problem/) in Western philosophy—synchronised neural firing is still firing in separate neurons, and interaction alone does not explain unity.
