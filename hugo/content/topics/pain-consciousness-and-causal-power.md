...
**[Global workspace theory](/concepts/global-workspace-theory/)** can model asymbolia as a partial broadcasting failure: sensory pain reaches the global workspace while affective pain does not. This is descriptively adequate but reveals a limitation. Two pieces of information might be equally available to the global workspace while differing radically in phenomenal quality. The theory predicts that asymbolia patients lose access to affective information, but it cannot explain why affective information, when accessed, *hurts*.

**[Integrated Information Theory](/concepts/integrated-information-theory/)** predicts that *any* loss of integration reduces consciousness in a general, undifferentiated way — phi is a single scalar measure. Yet asymbolia is domain-specific: patients lose affective pain experience while retaining full sensory awareness, visual consciousness, and general cognitive function. The deficit is not a global dimming but a targeted excision of one phenomenal quality.
...
The pattern across these theories is revealing. Each can redescribe asymbolia within its framework — as partial functional disruption, missing higher-order states, reduced global broadcast, diminished integration, or absent representational content. None explains the core phenomenon: why the presence or absence of a particular neural connection determines whether nociceptive processing *hurts*. This is not a failure of scientific detail. It is the [explanatory-gap](/concepts/explanatory-gap/) in clinical focus.
...
The [placebo effect](/topics/empirical-phenomena-mental-causation/) appears to make the complementary point. Expecting pain relief — a conscious belief about future phenomenal states — can produce measurable opioid release and genuine analgesia. The *expectation of how things will feel* causally influences physiology. This closed loop between phenomenal expectation and phenomenal outcome is what interactionist dualism predicts, though an access-level reading, on which the expectation's functional role does the work, predicts it equally; the loop is compatible with rather than compels the interactionist reading.
...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction).** If consciousness biases physical outcomes through the smallest possible influence on quantum indeterminacies, pain's motivational urgency and suffering's sustained behavioural restructuring might represent two modes of that influence — acute and chronic, respectively. The mechanism remains speculative, but the phenomenology may suggest different temporal profiles of consciousness-body interaction operating through the same interface — a reading the phenomenology is compatible with rather than one it compels.
...
- [placebo effect](/topics/empirical-phenomena-mental-causation/) — Content-specific beliefs causing physiological change
...
- [clinical-phenomenology-and-altered-experience](/topics/clinical-phenomenology-and-altered-experience/) — Asymbolia within the broader framework of clinical evidence for dualism
