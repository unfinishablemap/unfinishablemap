...
description: 'Bradford Saad''s 2025 theory explains how consciousness causes behavior
  without overdetermination: physical states delegate causal responsibilities to experiences.'
draft: false
human_modified: null
last_curated: null
...
This article first presents Saad's theory on its own terms, then explores how the Map integrates it with our quantum interactionist framework.

---

# Part I: Saad's Theory
...
Saad argues any adequate dualist theory must satisfy five constraints:

### 1. Efficacy

Experiences must cause physical effects. Pain causes wincing; visual experience causes reaching. This constraint rules out epiphenomenalism directly.

### 2. Non-Overdetermination

Physical effects caused by experience should not *also* have concurrent sufficient physical causes. One cause should be doing the work. Systematic overdetermination is theoretically unsatisfying—if physical causes suffice, why are mental causes there?

### 3. Observational Closure

Experiences should not cause *observable* violations of physical causal patterns. This is weaker than strict causal closure. Saad's key distinction: dualists need not accept that physics is complete everywhere—only that mental causation doesn't produce empirically detectable anomalies in laboratory experiments. The [observational-closure](/concepts/observational-closure/) concept page develops this distinction in depth.
...
Delegatory dualism works through two laws that together define [causal delegation](/concepts/delegatory-causation/):
...
This has a candour cost worth stating plainly. The default causal profile is the load-bearing primitive of the whole theory, yet its only access route—the zombie functional-duplicate—depends on a contested metaphysical possibility, and the profile is in principle never directly observed wherever the theory applies. The Subset Law* is therefore best read as a *postulate* of the framework rather than an independently-motivated law: the assumption that does the explanatory work, not a generalisation read off antecedently-available evidence. It earns its keep by the coherence it buys, not by independent observation of the entity it quantifies over.
...
One standing gap deserves flagging here rather than resolution. The "subset" relation presupposes that the experiential profile and the physical profile are individuated at a shared grain, and that the folk relatum—"pain"—is determinate enough to bear a single causal profile. An eliminativist (after Churchland) would object that "pain" decomposes into a dozen dissociable nociceptive-affective-motor processes with no clean folk counterpart, so it is left open *which* experiential property is the subset-bearer. The formalism inherits the determinacy of its folk relata, and that determinacy is contested. The Map does not resolve this here; it is recorded as an open question the framework owes work on.

### The Delegatory Law

The central mechanism: when an experience is instantiated via profile-matching, the experience *[preempts](/concepts/delegatory-causation/)* the physical state's causal contributions. The physical state "delegates" its causal responsibilities to the experience:
...
## What Saad Claims Delegation Explains

### Why We Report Our Experiences
...
Neural correlates of consciousness (NCCs) are tight correlations between brain states and experiences. Materialists cite NCCs as evidence that consciousness is neural activity. Dualists agree correlations exist but deny identity.
...
These need netting out explicitly. The report-tracking and function-tracking advantages hold *only* against epiphenomenalism, not against physicalism, which explains introspective reliability through self-modelling and function-tracking through state-identity—without the extra ontology, as conceded above. So both advantages presuppose rather than support the choice of dualism: they tell someone who has already adopted dualism which dualist option keeps mental causation cleanest, but give no one a reason to adopt dualism in the first place.
...
If experiences have causal profiles that match physical profiles, what determines the experience's profile in the first place?

**Response**: The psychophysical laws are fundamental. Just as physics doesn't explain *why* electrons have their charge, psychophysical laws don't explain *why* pain has its causal profile. The laws specify the correlations; metaphysics need not explain them further. Delegation requires systematicity (Upward Systematicity constraint), not reduction.

### Objection: Doesn't preemption still involve two causes?

Preemption involves backup causation—both causes exist, one just operates first. Isn't this still explanatorily problematic?

**Response**: Preemption is a familiar causal structure with well-understood logic. We accept it everywhere in ordinary causation. The question isn't whether preemption involves two potential causes (it does), but whether it involves overdetermination (it doesn't). Only one cause does the actual work.

### Objection: How can non-physical experiences preempt physical states?

What metaphysical mechanism allows a non-physical cause to preempt a physical one?

**Response**: This is the general interaction problem for dualism, not specific to delegation. Delegatory dualism answers the *structure* question (how mental causation avoids overdetermination); the *mechanism* question (how non-physical causes affect physical systems) remains for any interactionist view.

### Objection: Does this framework require a specific quantum interpretation?

**Response**: Saad does not discuss Many-Worlds or commit to any particular quantum interpretation. Delegatory dualism is a framework about causal structure—how mental causation avoids overdetermination—not about the physical mechanism of mind-body interaction. Quantum mechanics is treated as one possible mechanism route, not a presupposition.
...
How does delegatory dualism relate to the Map's [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) framework?

The frameworks are compatible but operate at different levels:

**Quantum interactionism** specifies *where* consciousness interfaces with physics: at quantum indeterminacies, where physics leaves outcomes undetermined. This is a claim about mechanism—the physical substrate of mental causation.
...
The frameworks could integrate: quantum indeterminacy might provide the physical mechanism while delegation provides the causal structure. On this picture consciousness biases quantum outcomes (the mechanism), and this biasing would constitute the physical state delegating its causal role to the experience (the structure). The integration is a proposal, not a result; each framework must stand on its own before the combination carries weight. [Delegation Meets Quantum Selection](/topics/delegation-meets-quantum-selection/) develops this integration, arguing that Saad's "default causal profile" corresponds to the Born-rule probability distribution — making delegation the causal structure and quantum selection the physical implementation of a single event. [One Structure, Three Vocabularies](/topics/one-structure-three-vocabularies/) adds a third register — the bandwidth literature's "prepared options" — and argues the three may be one structure described three ways; crucially, that convergence is a coherence fact about the Map's vocabulary, raising no independent evidence that the default causal profile is real.

The [entanglement-binding-hypothesis](/concepts/entanglement-binding-hypothesis/) may cohere with this integration—without thereby lending it independent support. An entangled quantum state spanning many neurons would—if macroscopic neural entanglement were physically sustainable, which the [decoherence literature](/topics/decoherence-and-macroscopic-superposition/) renders strongly doubtful at brain temperatures—constitute a single non-decomposable physical state with a collective default causal profile, arguably what Saad's Subset Law* maps to unified experience. On this reading entanglement would provide the physical holism while delegation explains how that unified state's causal work gets taken over by experience, and together they might cohere on complementary aspects of the mind-body problem: entanglement addressing why experience is *unified*, delegation addressing how it is *causally efficacious*. This is a coherence proposal rather than an established result—and consistent with the Part II disclaimer above, the coherence of the combination is not itself evidence for either component. It presupposes both that macroscopic neural entanglement is physically sustainable (a premise the decoherence consensus contests, not merely an open question) and that the entangled state's default profile is the right object for the Subset Law to range over, neither of which is settled.
...
Saad does not discuss Many-Worlds interpretation (MWI) in his paper. However, the Map's [rejection of MWI](/tenets/#no-many-worlds) becomes relevant when integrating delegatory dualism with our quantum interactionism.

If MWI is true, every quantum outcome occurs in some branch—there is no selection among possibilities, only branching. The Map's quantum interactionism requires outcomes to be *selected* (not merely branched), so rejection of MWI is necessary for the combined view.

This is a Map-specific integration point, not a requirement of Saad's theory itself. Delegatory dualism as a framework is neutral on quantum interpretation.

## Relation to Site Perspective

Delegatory dualism bears on the Map's core tenets as follows—supporting some directly, and remaining neutral on others:
...
**Bidirectional Interaction tenet**: The Efficacy constraint directly embodies bidirectional interaction. Experiences cause physical effects—pain causes wincing, beliefs cause assertions. The delegation mechanism explains *how* without overdetermination. The Map reads delegation as running in both directions, since consciousness also hands causal work off to trained procedural systems in [skill delegation](/concepts/skill-delegation/) and [habit](/topics/philosophy-of-habit-under-dualism/)—though that parallel is structural rather than evidential, and supplies no further access to the default causal profile.
...
**No Many-Worlds tenet (neutral)**: This is a tenet the subject theory does *not* bear on, listed here for completeness rather than as a point of support. Saad does not discuss Many-Worlds, and delegatory dualism as a framework does not depend on any particular quantum interpretation. The Map's rejection of MWI is relevant only to our quantum integration proposal, not to Saad's theory itself.

Saad's work offers the most internally coherent option for a dualism adopted on independent grounds, rather than independent support for adopting dualism at all—a strengthening conditional on a prior commitment it cannot itself justify, since (as netted out in the Testability section) delegation's advantages hold against rival dualist positions, not against the cheaper physicalist explanations of the same phenomena. The delegation mechanism addresses the exclusion/overdetermination *structure* problem—how mental causation could be logically coherent—though "addresses" is the right verb here rather than "solves," since the proposal trades a problem about redundant causation for one about cross-ontological preemption. The *mechanism* question (how non-physical causes interact with physical systems) remains, and the Map addresses it via quantum interactionism, itself a speculative rather than settled route.

## Further Reading

- [delegatory-causation](/concepts/delegatory-causation/) — The unified account of delegation, preemption, and default causal profile
- [skill-delegation](/concepts/skill-delegation/) — The inverse direction: consciousness handing causal work to trained procedural systems while retaining the capacity to re-engage
- [philosophy-of-habit-under-dualism](/topics/philosophy-of-habit-under-dualism/) — Habit as delegation's most mundane and most material everyday case
- [four-quadrant-dualism-taxonomy](/topics/four-quadrant-dualism-taxonomy/) — Map's ontological-weight taxonomy places delegatory dualism as the cleanest Q1 (min-mind / min-physical) inhabitant
