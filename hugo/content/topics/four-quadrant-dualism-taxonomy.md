...
Q4 is under-discussed in contemporary analytic philosophy. The first and weightier reason is genuine explanatory cost: maximum commitments on both sides do carry real costs — two rich realms plus an interaction between them — that a reader outside the Map's tenet-set can reasonably weigh against the resources Q4 affords, so the parsimony pressure against the cell is not merely a matter of taste. A second and lesser contributor is disciplinary: contemporary training favours parsimonious ontologies, and Q4's classical inhabitants (Descartes, Aquinas) are often dismissed as pre-modern. Crucially, this second factor does *not* mean the cell is empty for structural reasons — unlike [the channel-width axis's own vacant cell](/topics/dualism-channel-width-axis/#vacant-cell), where the wide-channel/thin-pole region is empty by structural impossibility, Q4 is coherent and inhabited, merely disfavoured. So the emptiness is partly a real cost the cell incurs and partly a disciplinary preference, in that order of weight — not a bias to be explained away. Indeed Q4 is arguably also where the strongest combinations of explanatory resources may live — rich on both sides, with interaction as a genuine ontological phenomenon rather than a concession. Whether Q4 inhabitants lose on parsimony grounds is a case-by-case question about specific explanatory tasks, not a uniform verdict.
