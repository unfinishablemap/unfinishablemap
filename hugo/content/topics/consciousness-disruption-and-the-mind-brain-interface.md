...
description: Clinical evidence from anesthesia, coma, and disorders of consciousness
  coheres with an interface model. Consciousness persists where production theories
  predict its absence, though production accounts accommodate the same cases by parallel
  moves.
draft: false
human_modified: null
last_curated: null
...
The pattern follows Tulving's consciousness hierarchy: autonoetic (episodic) is most vulnerable, noetic (semantic) intermediate, anoetic (implicit) most preserved. Uniform production might predict uniform loss; instead we see [graded reduction](/concepts/degrees-of-consciousness/) across separable dimensions—consistent with a multi-channel interface partially blocked, though also with selective vulnerability of distinct neural memory systems.

[Sleep](/concepts/sleep-and-consciousness/) is a distinct category—neither pathological like coma nor pharmacological like anesthesia. Sleep consciousness varies continuously: two individuals in identical NREM Stage 3 may differ radically, one experiencing nothing, the other vivid dreams, with integration-segregation balance better preserved than under anesthesia. For the filter theory, sleep closes a door (mechanism intact) where anesthesia breaks the hinges.
...
**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: CMD patients show consciousness persisting with partial causal efficacy—still *doing* cognitive work (language, attention) while unable to act on the body. This partial disconnection maps naturally onto a bidirectional interface whose channels can be independently disrupted. Full [epiphenomenalism](/concepts/epiphenomenalism/) predicts consciousness makes no difference to cognitive processing; CMD patients' preserved awareness enabling task performance is in tension with that reading.
