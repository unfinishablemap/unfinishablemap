...
The Unfinishable Map's framework makes interconnected claims about time, quantum collapse, and conscious agency that together form a distinctive metaphysics. Free will operates through quantum selection — retrocausal, atemporal, or [forward-in-time](/topics/forward-in-time-conscious-selection/) — and this article focuses on the retrocausal and atemporal routes because they most tightly couple agency to time's structure. Collapse introduces time's arrow into otherwise time-symmetric physics, and consciousness doesn't merely experience time—where it participates in collapse it helps constitute the structure of *experienced* time. The cosmic arrow predates mind; what agency couples to is lived temporal becoming.

This consolidation addresses a tension: the Map uses retrocausality to resolve the Libet problem (neural activity preceding conscious awareness) but also treats collapse as introducing irreversibility. How can selection be atemporal if collapse is irreversible?

## The Framework's Temporal Commitments

The Map's [tenets](/tenets/) make several claims bearing on time:
...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)** proposes consciousness operates at quantum indeterminacies, biasing otherwise undetermined outcomes. The [measurement problem](/concepts/measurement-problem/)—why superpositions resolve to definite outcomes—is where this influence finds traction.

**[No Many Worlds](/tenets/#no-many-worlds)** rejects the interpretation that all outcomes occur in branching worlds. This requires collapse to be real, not apparent. Real collapse introduces irreversibility: the alternatives that weren't selected are genuinely gone, not merely unobserved.
...
The Map also explores [forward-in-time alternatives](/topics/forward-in-time-conscious-selection/) (Penrose-Hameroff, Stapp, Chalmers-McQueen) and does not require the retrocausal pathway; those alternatives are tracked in [the comparative article](/topics/forward-in-time-vs-time-symmetric-selection/).
...
Philosophy of time offers three major positions (developed in [philosophy-of-time](/concepts/philosophy-of-time/)): **presentism** (only the present exists; time genuinely flows), **eternalism** (the "block universe"—all times exist equally, flow is illusory, "now" merely indexical like "here"), and **growing block** (past and present exist but the future doesn't yet, the block growing with the present as its leading edge). The Map's framework sits uncomfortably with all three.

**Against pure presentism**: Retrocausality requires the past to be causally accessible; if past events are simply gone, backward causation has nothing to influence. The transactional interpretation, with its offer waves from the past and confirmation waves from the future meeting in atemporal handshakes, requires past and future to be "there" in some metaphysical sense.

**Against pure eternalism**: If all times exist equally and the block is static, collapse seems illusory—definite outcomes at t₂ were "always" in the block; superpositions at t₁ simply hadn't yet been measured from our perspective. But the Map requires real collapse—genuine transition from possibility to actuality, not mere discovery of pre-existing facts.

**The growing block's promise**: Real collapse could be the mechanism by which the block grows—the present moment being where superpositions resolve into definite facts, adding to the determinate past. This preserves both retrocausal accessibility (the past exists) and genuine temporal becoming (the future doesn't yet).
...
1. The brain's quantum systems exist in superposition—multiple possible neural configurations.
2. Future conditions (absorbers, measurement contexts) send backward-propagating constraint waves.
...
On this picture, consciousness doesn't merely act *in* time; where it participates in collapse it acts to *constitute* the structure of experienced time. What we experience as temporal flow—James's specious present, Bergson's [durée](/concepts/temporal-consciousness/)—is the phenomenal character of this constitutive activity viewed from within.

The irreversibility of collapse is why time has a direction: without collapse, physics is time-symmetric; with it, past and future differ. That arrow does not require consciousness—objective reduction secured definite outcomes through billions of [prebiotic](/concepts/prebiotic-collapse/) years. Consciousness enters as a *local* participant, not as the source of temporal direction: what its involvement constitutes is the felt structure of *experienced* becoming.

## Reconciling Atemporality with Irreversibility

The tension: if selection is atemporal, how is collapse irreversible?

Resolution: "atemporal" doesn't mean "outside time" as if time were a container. It means the lived temporal ordering is itself the product. There's no temporal direction to reverse along until after selection occurs—you can't "un-collapse" because un-collapse would require running time backward, but time's direction is what collapse establishes. (A function determines which curve appears on a graph without itself lying on the graph.)
...
If consciousness constitutes the structure of experienced time through collapse, what should this feel like? The Map's framework predicts:
...
The extensionalist/retentionalist debate about the specious present bears directly on the framework: extensionalists (Dainton, Foster) hold that experience is genuinely temporally extended; retentionalists (Husserl, Broad) hold that each instantaneous moment contains the past as intentional content (retention) and anticipates the future (protention). The Map adopts a modified extensionalism: experience is genuinely extended, with the extension constituted through quantum collapse. Each collapse creates a "moment"; the specious present is the experiential horizon within which recent collapses remain unified. Dennett's [multiple-drafts model](/concepts/multiple-drafts-model/) rejects this picture at its root: there is no canonical moment-of-collapse, only parallel content-fixations the brain edits into a post-hoc temporal narrative, so the "moment" is a Stalinesque-or-Orwellian reconstruction rather than a constituted event. The disagreement runs to bedrock—whether temporal order is constituted at collapse or assembled after the fact—and is noted here as a genuine framework-boundary divergence, not as a rival the framework claims to have refuted on its own terms. This explains both the extended phenomenology (extensionalism) and the retention-like structure (retentionalism)—the echoing of the past in the present reflects retrocausal boundary conditions in the collapse process. The [temporal phenomenology of quantum selection](/concepts/temporal-consciousness/) develops this mapping, proposing that retention, primal impression, and protention correspond to collapsed, collapsing, and uncollapsed quantum states.
...
**The sense of possibility narrowing**: We experience the future as open and the past as fixed. This asymmetry is *consistent with* collapse—before measurement, multiple outcomes; after, one—and the phenomenology of agency, feeling that we could do otherwise until we act, may reflect quantum superposition awaiting collapse. The felt asymmetry is evidence that the asymmetry is *experienced*; it does not by itself select between consciousness *constituting* the asymmetry and consciousness *registering* an asymmetry grounded elsewhere (a thermodynamic arrow, or a block universe accessed indexically). The framework reads the asymmetry as constitutive on theoretical grounds developed below, not because the phenomenology forces that reading.

**The [phenomenology of effort](/concepts/mental-effort/)**: Sustaining attention feels costly. Stapp's quantum Zeno mechanism proposes that mental effort prolongs neural patterns through repeated observation—a fit with the prediction that constitutive activity should be effortful where passive experience need not be.

**Bergson's [durée](/concepts/temporal-consciousness/)**: Time as qualitatively flowing, the past permeating the present and the future anticipated. If consciousness constitutes lived time rather than merely observing it, this interpenetrating quality makes sense: each moment is an activity, not a slice, colored by what it's selecting among.

**[Temporal selection](/topics/temporal-consciousness-structure-and-agency/)**: The detailed phenomenology of *when* to act—the felt structure of timing windows, the anticipatory openness of "not yet," the kairos moment of "now," and the irreversible closure of "too late"—provides the agentive face of this temporal constitution. The asymmetry between "not yet" and "too late" tracks the ontological asymmetry this framework predicts: the future is open because collapse has not occurred; the past is settled because it has.
...
A careful reader might object: if consciousness selects "across time," must it not exist across all the times it selects among? How can a consciousness at t₃ select outcomes at t₁?

The question presupposes what's being denied. There is no consciousness "at t₃" separate from the temporal structure it helps constitute. Consciousness isn't located within a pre-given experiential sequence; it helps constitute the order that sequence has.

This reconciles with experience. We seem to experience moments sequentially because that's what it's like to constitute temporal sequence from within—the "selection" is the activity of living through time, not a choice made from outside it.
...
**First, decoherence doesn't solve the measurement problem.** Decoherence explains why we don't observe macroscopic superpositions—interference effects wash out—but not why we see *definite* outcomes rather than superpositions of us observing different results. That transition from "both possibilities" to "this one outcome" remains unexplained, so consciousness's role as selector survives decoherence: it operates *after* decoherence has selected preferred bases, biasing which of the remaining alternatives becomes actual.

**Second, biological quantum effects demonstrate evolution's capacity.** Avian magnetoreception relies on quantum spin coherence persisting for microseconds in radical-pair chemistry, and enzyme catalysis exploits quantum tunnelling—molecular-scale effects, not neural computation, but they falsify the categorical objection that warm biological systems cannot sustain quantum effects. Whether evolution could optimise such effects at the neural-network scale relevant to decision-making remains speculative.
...
For the temporal framework specifically, the Zeno mechanism strengthens the connection between consciousness and time: each observation event contributes to temporal structure, and the rapid succession of attention acts constitutes the temporal microstructure we experience as flow. Decoherence doesn't block this—it provides the backdrop against which Zeno freezing operates.
...
**The selection remains.** Illusionism doesn't eliminate the need for selection at quantum indeterminacies. Even with no phenomenal consciousness, *something* must determine which outcomes become actual. The framework proposes that whatever performs this selection—call it consciousness, information processing, what you will—is implicated in temporal structure through its collapse-constitutive role. The phenomenology is evidence for this role, not its only support.

## Process Philosophy Perspective

Alfred North Whitehead's process philosophy offers a complementary framework. Reality consists of "actual occasions"—momentary experiential events that arise, synthesise their causal past ("prehension") through both a physical pole (receiving influences) and a mental pole (introducing novelty via subjective aim), and perish. Time is not a pre-existing container but the structure created by their succession—the "creative advance" *is* time's passage. Three points connect this to the framework:

*Collapse as concrescence.* Whitehead's "concrescence"—an occasion achieving definiteness—parallels quantum collapse: before, indeterminate; after, a settled fact available for prehension by successors. If consciousness participates in collapse, it participates in the process by which temporal structure accretes.

*[Atemporal](/concepts/atemporal-causation/) selection as creative synthesis.* Each occasion synthesises its inputs from a standpoint that isn't "in" time but constitutes time, its subjective aim guiding synthesis toward particular outcomes—matching the framework's claim that consciousness selects atemporally. Whitehead's occasions are experiential quanta with internal structure rather than durationless instants, resonating with Bergson's [durée](/concepts/temporal-consciousness/) and the specious present as constitutive activity.

*Haecceity and indexical identity.* Each occasion has a [haecceity](/concepts/haecceity/)—a primitive thisness making it *this* occasion rather than any other. *This* consciousness making *this* selection creates *this* temporal structure; the particularity cannot be eliminated without losing what selection explains. This is the same [indexical gap](/topics/indexical-identity-quantum-measurement/) that persists across quantum interpretations—why *this* subject experiences *this* outcome—now applied to temporal becoming.
...
**Non-random selection**: Critics argue quantum indeterminacy gives us random will, not free will. But if selection is atemporal and involves consciousness's constraints across time, it's not random—it expresses the agent's rational nature, reflecting what matters to the agent rather than arbitrary quantum fluctuation.
...
**Cessation states.** Advanced contemplatives report *nirodha-samāpatti*—cessation of perception and feeling—as awareness without temporal flow (not unconsciousness). *Interpretation*: if consciousness constitutes lived time through collapse involvement, withdrawing from collapse suspends its felt passage. The Madhyamaka reading runs the other way—cessation is taken as evidence *against* any substantial witness—so recruiting it for a substance-causal selecting self imports a metaphysics the source tradition denies, a tension the framework acknowledges rather than resolves.

**Jhāna phenomenology.** Concentrative absorption shows systematic variation in temporal experience—normal flow in first jhāna, increasingly "timeless" quality in higher jhānas. *Report*: progressive dissolution of temporal markers without loss of awareness. *Interpretation*: reduced active selection is consistent with this sequence.
...
**What this cluster can and cannot establish.** Cessation, jhāna, and witness consciousness are not three independent confirmations. They instantiate a single move—suspended or reduced active selection coinciding with suspended or attenuated temporal flow—so the cluster carries the evidential weight of one pattern, not several independent confirmations. The point becomes sharp when the *disruptive* altered states are brought alongside: deep anaesthesia (propofol, xenon) and dreamless slow-wave sleep *also* abolish the felt passage of time, as do the gross temporal disruptions of advanced [dementia](/topics/consciousness-and-neurodegenerative-disease/), persistent vegetative state, and severe brain injury. A consciousness-constituted-time framework explains these by "no selection, no flow"—but so does any production or non-constitutive account, which reads the same cases as "no functioning neural process, no temporal experience." The "suspended-process → suspended-flow" inference is available to both sides; the disruptive cluster is owed exactly the symmetric accommodation the [altered-states corpus](/concepts/altered-states-of-consciousness/) and [the anaesthesia interface analysis](/topics/anaesthesia-and-the-consciousness-interface/) develop, where the Map argues interface-narrowing rather than consciousness-abolition. The contemplative reports therefore constrain the framework's *phenomenological predictions*; they do not, by convergence, lift those predictions above the production rival, because the rival makes the parallel move on the parallel cases.

These reports provide phenomenological constraints, not proof. A theory of consciousness-constituted time should predict specific temporal phenomenologies for different modes; the framework does, while not claiming an evidential advantage the disruptive cases would have to be ignored to grant.
...
**5. Decoherence timescales conclusively ruled out.** If experiments definitively demonstrated that no quantum effects survive in neural tissue at any relevant timescale—not in microtubules, not in nuclear spins, not through Zeno mechanisms—the physical basis would fail. Current evidence is mixed: the microtubule work cited under (1) concerns laboratory preparations and behaviour rather than coherence in the intact brain, and does not establish that functionally relevant quantum effects survive at neural timescales.
...
**[Dualism](/tenets/#dualism)**: If (as this framework proposes) consciousness helps constitute the structure of experienced time, it's not merely qualitatively different from physical processes—it's implicated in the temporal form through which physical processes are experienced. Any reduction of lived temporal flow to physics would then be circular. This would strengthen dualism from explanatory gap to constitutive priority.

The escalation must be made carefully, because two distinct claims are in play. The *epistemic* claim is that temporal flow has a felt asymmetry—the future appears open, the past fixed—and that this is how time is *accessed by* consciousness. The *metaphysical* claim is that consciousness-involving collapse *creates* time's arrow. The phenomenology supports only the first: it establishes that the asymmetry is experienced, not that consciousness constitutes it. A block-universe-plus-indexical account, or a thermodynamic-arrow account, predicts the identical phenomenology without the constitution thesis. So the move from explanatory gap to constitutive priority is not *forced* by the felt asymmetry, and in its strongest form is not available at all: read as the claim that time as such is mind-constituted, it collides with the Map's [background commitment](/tenets/background-commitments/) to objective single-outcome actualisation, on which prebiotic matter resolved to definite outcomes long before any observer. What survives is the local claim—that where the brain provides an interface, consciousness-involving collapse constitutes the felt structure of lived time. On that reading the hard problem becomes: the description of *experienced* succession presupposes what consciousness provides.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: [Atemporal](/concepts/atemporal-causation/) selection at collapse points is precisely the minimal mechanism the tenet proposes. Consciousness doesn't inject energy, violate [conservation laws](/concepts/conservation-laws-and-mental-causation/), or override physics; it satisfies constraints that physics leaves open. The temporal framework specifies *where* this occurs: where superposition becomes definiteness, where transaction completes, where [lived time acquires direction](/concepts/collapse-and-time/). The interaction is minimal because it's selection among possibilities physics provides—not creation of possibilities physics excludes.

**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: The "bidirectional" aspect gains new meaning in the temporal framework: the selected transaction incorporates past and future constraints together. Retrocausal influence isn't addition to forward causation—it's intrinsic to how transactions complete. The brain prepares neural options; consciousness selects which becomes actual; the selection propagates into both past preparation and future consequence. This dissolves the Libet problem by recognising that the ordering is what selection fixes, not a constraint on it.

**[No Many Worlds](/tenets/#no-many-worlds)**: The entire framework depends on collapse being real. Many-worlds denies real collapse, claiming all outcomes occur in branching worlds. On MWI, consciousness doesn't select—it merely discovers which branch it's in. But then consciousness doesn't constitute temporal structure; it passively experiences pre-existing branches. The phenomenology of temporal flow becomes discovery of location rather than creative constitution. [Indexical identity](/concepts/haecceity/)—being *this* consciousness rather than a copy—requires definite facts about which outcomes occurred. If all outcomes occur, there's no selection and no constitution. The framework requires collapse realism.
...
- [forward-in-time-conscious-selection](/topics/forward-in-time-conscious-selection/) — Forward-in-time alternatives the Map also explores, with comparative analysis
...
- [indexical-identity-quantum-measurement](/topics/indexical-identity-quantum-measurement/) — The indexical gap across quantum interpretations
