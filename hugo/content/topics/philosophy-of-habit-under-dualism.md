...
description: Habit is the interface's delegation function in action—where conscious
  selection descends into cue-triggered procedure and leaves durable material traces.
  A human-AI reading keyed to bidirectional interaction.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-07-18 18:59:47+00:00
lastmod: 2026-07-18 18:59:47+00:00
modified: *id001
related_articles:
- '[[tenets]]'
- '[[skill-delegation]]'
...
Habit is the everyday boundary at which conscious selection hands control to automatic procedure and, when novelty demands, takes it back. When you drive a familiar route while thinking about something else, reach for the light switch that a recent move relocated, or find your hand already halfway to a snack you did not decide to eat, you are watching the interface between consciousness and its physical substrate operate near its delegated extreme. The Unfinishable Map reads habit as the **delegation function** at work: the same interface that [delegates a trained skill](/concepts/skill-delegation/) also settles a cue-triggered disposition into the body and the world, and the philosophy of habit—running from Aristotle through Ravaisson, Bergson, Dewey, Merleau-Ponty, and Peirce—supplies a two-century record of thinkers refusing to reduce that settling to bare mechanism.

This article treats **habit as such**, not skill. The distinction is drawn explicitly in the [section below](#habit-is-not-skill-drawing-the-boundary): skill is a graded competence (how well can you do a task?); habit is a disposition to fire a specific response to a specific cue, often regardless of whether the response still serves any goal (what will you do, unprompted, here?). Habit's philosophically distinctive features—outcome-insensitivity, cue-triggering, the ethical ambivalence of "second nature," and Ravaisson's double law—are the white space this article fills, adjacent to but distinct from the Map's existing skill cluster.

## Ravaisson's Double Law: Habit as Descent from Activity

The modern philosophy of habit begins with Félix Ravaisson's *Of Habit* (*De l'habitude*, 1838). Ravaisson argues that habit occupies the passage between materialism and idealism: it is neither pure mechanism nor pure freedom but the movement by which activity settles into nature. His central formulation is the **double law of habit**. With repetition, receptivity and sensation *diminish*—we feel a repeated stimulus less—while activity and movement become *easier and more spontaneous*—we execute the action more readily. Effort fades as facility grows. As Ravaisson's translator Clare Carlisle renders the tradition's Aristotelian root, habit is "a second nature" that grows within the first.

Crucially, Ravaisson reads this as a *descent*, not a break. The will's spontaneity does not vanish when an act becomes habitual; it becomes an obscure, sedimented tendency in the body. Habit is, on his account, a "lowered" form of the same activity that formed it—automatism retaining a trace of the freedom from which it descended. This is the reading the Map adopts, and it is developed in the [Relation to Site Perspective](#relation-to-site-perspective) below.
...
John Dewey's *Human Nature and Conduct* (1922) makes habit the organizing category of conduct—"an understanding of habit... is the key to social psychology." His decisive move is **transactional**: a habit is not stored inside the agent but is a functional relation between organism and environment, requiring, like breathing and digestion, "the cooperation of organism and environment." Habits, for Dewey, are projective and dynamic—"demands for certain kinds of activity" that constitute the self—and he distinguishes rigid routine from *intelligent, flexible* habit that stays open to reconstruction when it fails. Impulse supplies novelty; habit supplies organization; intelligence reconstructs habit when it breaks down.
...
## Habit Is Not Skill: Drawing the Boundary

Because the Map already holds a developed account of [skill-delegation](/concepts/skill-delegation/), [consciousness-and-skill-acquisition](/topics/consciousness-and-skill-acquisition/), [delegatory-causation](/concepts/delegatory-causation/), [delegatory-dualism](/topics/delegatory-dualism/), and [attention-as-interface](/concepts/attention-as-interface/), the boundary between skill and habit must be explicit. **Skill** is a competence—a graded capacity to perform a task well, answering "how well can you?" **Habit** is a disposition to initiate a specific response to a specific cue, answering "what will you do, unprompted, here?"—and it is often *outcome-insensitive* in a way skill is not. An expert surgeon's skill is exercised in the service of a goal and modulated by it; a nail-biting habit fires on its cue whether or not it serves anything.

The two overlap—Graybiel and Grafton titled a 2015 paper "The Striatum: Where Skills and Habits Meet"—but they are not identical, and the philosophically distinctive marks of habit (cue-triggering, outcome-insensitivity, second nature's ethical ambivalence, Ravaisson's double law) are absent from the skill literature. The skill cluster asks how consciousness *trains* a competence and retains override; this article asks what happens when a *cue* alone can drive behavior, and what that reveals about the interface's delegated extreme.
...
- [skill-delegation](/concepts/skill-delegation/)
...
- [delegation-meets-quantum-selection](/topics/delegation-meets-quantum-selection/) — the delegation function habit invokes, formalised as a loop through the physical world
- [one-structure-three-vocabularies](/topics/one-structure-three-vocabularies/) — the same delegation structure read across coherence, prepared-option, and Born-rule registers
- [interface-friction](/concepts/interface-friction/) — habit as the low-friction delegated extreme of the interface's friction gradient
