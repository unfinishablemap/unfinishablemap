...
human_modified: null
last_curated: null
last_deep_review: 2026-04-05 11:32:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
The difficulty: the fixed-domain model needs [psychophysical laws](/concepts/psychophysical-laws/)—fundamental regularities linking physical configurations to conscious experiences—but provides no account of where those laws come from or why they take the form they do.
...
**[Working memory](/concepts/working-memory/) expansion**: Human working memory capacity substantially exceeds that of other great apes (Miller, 1956). Comparative studies show chimpanzees performing differently on memory tasks—excelling at rapid spatial recall but handling fewer simultaneous items in sustained working memory (Inoue & Matsuzawa, 2007). This gap could reflect improved interface capacity. If working memory depends on conscious access, as [Global Workspace Theory](/concepts/global-workspace-theory/) proposes, then working memory expansion is interface expansion.
