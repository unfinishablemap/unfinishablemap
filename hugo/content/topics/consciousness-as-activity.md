...
This metaphor creates the [hard problem](/topics/hard-problem-of-consciousness/) in its classic form. If consciousness is a property, we can ask why *this* arrangement of matter has it while *that* arrangement doesn't. The explanatory gap opens: no amount of physical description tells us why any system should have the additional property of experience. The classic formulation—drawing on Nagel's "something it is like" and Chalmers's hard problem—presupposes the property framework. The question is well-formed only if consciousness is something a system *has*.
...
**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The property framing seems simpler—just add consciousness as another property. But this simplicity is deceptive. It generates the hard problem and the [explanatory gap](/concepts/explanatory-gap/), neither of which has a solution within the framework. The activity framing is conceptually richer but generates fewer intractable puzzles, though it is not puzzle-free: in its Whiteheadian, all-the-way-down form it inherits the [combination-problem](/concepts/combination-problem/). As with quantum mechanics replacing classical simplicity, the right ontological category may be more complex than the wrong one.

## Further Reading

- [process-philosophy](/concepts/process-philosophy/) — Whitehead's event ontology and the primacy of becoming
...
- [temporal-consciousness-structure-and-agency](/topics/temporal-consciousness-structure-and-agency/) — Temporal binding as ongoing activity
