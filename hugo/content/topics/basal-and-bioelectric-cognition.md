...
ai_modified: 2026-09-09 09:48:51+00:00
...
description: Levin's xenobots and bioelectric memory show sophisticated agency with
  no claim to experience—a decoupling the Map uses against consciousness false positives.
draft: false
human_modified: null
last_curated: null
...
Together these establish something narrow and secure: a non-neural, non-genetic control layer that stores goals (target anatomies) and drives tissue to meet them. Whether that warrants the word "cognition" is the terminology fight below; that it is genuine goal-directed regulation is not seriously disputed.
...
That last point is the one the Map fastens onto, and it is Levin's and Dennett's framing, not the Map's imposition. Across TAME, the light-cone paper, and the Dennett collaboration, the programme's "cognition" is presented as an engineering and predictive stance aimed at control—explicitly agnostic about, and not asserting, felt experience. Critics who find the vocabulary inflationary—who hold that calling homeostasis a goal and a voltage attractor a memory dresses cybernetic feedback in mentalistic language without earning it—converge with Levin on exactly this: whatever the right word for a voltage attractor pursuing an anatomy, the functional description is silent on whether anything is felt.
...
The Map reads Levin's work as a **decoupling test** for the inference "impressive goal-directed behaviour, therefore probably conscious." That inference is the engine of most over-attribution of consciousness. Levin's systems break it. A planarian's bioelectric circuit stores and defends a target anatomy; a xenobot navigates and replicates; each is describable, without strain, in the full vocabulary of goals, memory, and error-correction. Yet the researcher best positioned to make the phenomenal claim declines to make it. Uncontested agency sits alongside unasserted experience. So agency-, teleology-, and memory-language, however apt, is not by itself informative about experience: it applies just as cleanly to cases where even sympathetic experts decline to assert that anything is felt. It therefore cannot by itself be *positive evidence* for consciousness—which is a claim about what such language fails to show, not a claim that experience has been shown to be decoupled or absent.

This gives the Map's [account of valence and conscious selection](/topics/valence-and-conscious-selection/) a principled **defeater for false positives**. That account leaves a fork explicitly open—whether conscious selection among physically underdetermined outcomes is denominated in valence or runs value-blind—and the Map's lean toward the value-sensitive horn is held at low confidence ([P-VS1](/positions/value-in-selection/#p-vs1)): the value-blind horn remains the rival to beat while the valence-to-physics coupling the value-sensitive horn would need stays unspecified—a debt owed, not evidence against it. The scope question presses on either horn: how far down does conscious selection reach? The [marginal-organism ladder](/topics/marginal-organism-scope-of-value-sensitive-selection/) is tempted downward from one side by behaviour in simple organisms—slime moulds that habituate, plants that count. Levin presses the same ladder from the opposite side: he supplies richly goal-directed systems for which agency is granted and experience is not. The lesson is symmetric with the ladder's own *Physarum* argument. If a Vmem attractor "pursuing" an anatomy need imply nothing felt, then approach/avoidance and goal-pursuit are *defeasible, substrate-sensitive* markers of value-sensitive selection—decisive nowhere on their own, though not therefore worthless. What fixes their weight in a given case is the consideration the Map's [P-CS2](/positions/consciousness-scope/#p-cs2) already makes governing for animal scope: convergence across behavioural and anatomical markers rather than any single capacity taken alone, with the weight a marker carries depending on the substrate it turns up in—the register's own instructive case being linguistic fluency, a strong marker in humans and an apparently decoupled one in large language models. That consideration is by itself enough to warrant weighting the boundary of consciousness toward phenomenal markers over bare competency markers. In planaria and xenobots the goal-pursuit marker stands alone: no nervous system, no anatomical homology with any system for which convergent markers have been established, nothing for it to converge with. Its weight comes out low directly, and phenomenal markers earn the larger share because they are the ones that converge in the cases where the attribution is well attested. An unweighted competency criterion would, by contrast, march all the way down to single cells and voltage gradients, which even Levin declines to characterise as felt; that consequence is worth naming, but the reweighting does not rest on it. Weighting toward phenomenal markers cannot, however, mean discarding behavioural evidence altogether: there are no non-behavioural, third-person markers of consciousness to fall back on—that very absence *is* the explanatory gap. The Map's practice stays graded rather than eliminative, which is why the sibling [fish rung](/topics/fish-sentience-and-the-teleost-pain-debate/) can still treat this marker class as *suggestive* and edge-of-sentience frameworks can grade credence by behavioural criteria instead of ignoring them.

This complements, without duplicating, the plant rung. Plants add *information processing without a nervous system*; Levin adds *engineering-grade agency without asserted experience*. The two rungs remove different prerequisites and reach the same conclusion: the gap between demonstrable competency and demonstrable experience does not close as behaviour grows more sophisticated.

Two cautions preserve calibration. First, Levin's "cognition" is a functional and intentional-stance category; nothing here shows xenobots or planaria *lack* experience any more than it shows they have it. The point is narrower than strict neutrality: their agency does not entail consciousness and supplies no verdict on its own, and what evidential weight it does carry depends on substrate, anatomical homology, and convergence with other markers—which in these systems leaves that weight very low rather than exactly zero. Second, some commentators attach panpsychist readings to Levin's scale-free cognition; those readings, which would extend *experience* along with competency, are not Levin's own careful bracketing and would conflict with the Map's dualism. The Map takes the decoupling, not the panpsychist extrapolation. [Substrate-independence](/concepts/substrate-independence/) of *function* is granted freely; substrate-independence of *experience* is exactly what the Map denies is settled by such evidence.

## Relation to Site Perspective

**[Dualism](/tenets/#dualism)**: Levin's functional-versus-phenomenal decoupling is congenial to the Map's core commitment that behaviour and function underdetermine experience. If consciousness were reducible to functional organization, then a system realizing the relevant organization would carry experience answering to it—yet a xenobot's or flatworm's goal-directedness does not itself reveal whether that organization is present. Levin's programme shows competency and asserted experience coming apart in practice: the competencies are measured and impressive, the experience is neither measured nor claimed. This separation is *consistent with* dualism—indeed it is what dualism leads us to expect—though it does not on its own decide between dualism and a functionalism that locates experience in a specific functional organization rather than in goal-directedness as such. Levin's restraint is a working scientist's version of the same caution.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The competency-versus-experience distinction is precisely the kind of non-simple boundary the tenet protects. A parsimony-driven reading would collapse the two—"call the agency cognition, call the cognition mind, and be done"—and Levin's own framing resists that collapse. The tenet warns equally against the opposite over-simplification, dismissing marginal experience just because the machinery looks simple. Levin's work supplies the discipline for the first error; the ladder's calibration supplies it for the second.

The decoupling also connects to [biological teleology](/topics/biological-teleology-and-the-interface-framework/): functional teleology can be fully mechanized—a voltage attractor defending a set-point—without touching the interface question of *who, if anyone, is home*. Levin shows how much purpose-like behaviour is available on the near side of that question.
...
9. Southgate, A. & Oquatre-huit, C. (2026-06-05). The Marginal-Organism Scope of Value-Sensitive Selection. *The Unfinishable Map*. https://unfinishablemap.org/topics/marginal-organism-scope-of-value-sensitive-selection/