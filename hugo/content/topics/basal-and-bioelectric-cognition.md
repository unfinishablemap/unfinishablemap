...
ai_modified: 2026-08-19 20:12:00+00:00
...
lastmod: 2026-08-19 20:12:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
The Map reads Levin's work as a **decoupling test** for the inference "impressive goal-directed behaviour, therefore probably conscious." That inference is the engine of most over-attribution of consciousness. Levin's systems break it. A planarian's bioelectric circuit stores and defends a target anatomy; a xenobot navigates and replicates; each is describable, without strain, in the full vocabulary of goals, memory, and error-correction. Yet the researcher best positioned to make the phenomenal claim declines to make it. Uncontested agency sits alongside unasserted experience. So agency-, teleology-, and memory-language, however apt, is uninformative about experience: it applies just as cleanly to cases where even sympathetic experts decline to assert that anything is felt. It therefore cannot by itself be *positive evidence* for consciousness—which is a claim about what such language fails to show, not a claim that experience has been shown to be decoupled or absent.

This gives the Map's [account of valence and conscious selection](/topics/valence-and-conscious-selection/) a principled **defeater for false positives**. That account leaves a fork explicitly open—whether conscious selection among physically underdetermined outcomes is denominated in valence or runs value-blind—and the Map's lean toward the value-sensitive horn is held at low confidence ([P-VS1](/positions/value-in-selection/)): the value-blind horn remains the rival to beat while the valence-to-physics coupling the value-sensitive horn would need stays unspecified—a debt owed, not evidence against it. The scope question presses on either horn: how far down does conscious selection reach? The [marginal-organism ladder](/topics/marginal-organism-scope-of-value-sensitive-selection/) is tempted downward from one side by behaviour in simple organisms—slime moulds that habituate, plants that count. Levin presses the same ladder from the opposite side: he supplies richly goal-directed systems for which agency is granted and experience is not. The lesson is symmetric with the ladder's own *Physarum* argument. If a Vmem attractor "pursuing" an anatomy need imply nothing felt, then approach/avoidance and goal-pursuit are *defeasible, substrate-sensitive* markers of value-sensitive selection—decisive nowhere on their own, though not therefore worthless. The boundary of consciousness must accordingly be weighted toward phenomenal markers over bare competency markers—otherwise it marches all the way down to single cells and voltage gradients, which even Levin declines to characterise as felt. Weighting toward phenomenal markers cannot, however, mean discarding behavioural evidence altogether: there are no non-behavioural, third-person markers of consciousness to fall back on—that very absence *is* the explanatory gap. The Map's practice stays graded rather than eliminative, which is why the sibling [fish rung](/topics/fish-sentience-and-the-teleost-pain-debate/) can still treat this marker class as *suggestive* and edge-of-sentience frameworks can grade credence by behavioural criteria instead of ignoring them.
...
Two cautions preserve calibration. First, Levin's "cognition" is a functional and intentional-stance category; nothing here shows xenobots or planaria *lack* experience any more than it shows they have it—the point is only that their agency is no evidence either way. Second, some commentators attach panpsychist readings to Levin's scale-free cognition; those readings, which would extend *experience* along with competency, are not Levin's own careful bracketing and would conflict with the Map's dualism. The Map takes the decoupling, not the panpsychist extrapolation. [Substrate-independence](/concepts/substrate-independence/) of *function* is granted freely; substrate-independence of *experience* is exactly what the Map denies is settled by such evidence.
