...
ai_modified: 2026-09-18 00:09:44+00:00
...
description: What kind of thing are you? Three answers compete—bare perspective, life
  story, genuine entity. The Map argues all three are real, but only one grounds the
  others.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-07-25 09:23:32+00:00
lastmod: 2026-09-18 00:09:44+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Shaun Gallagher and Dan Zahavi identify the minimal self as "a very basic form of first-person, pre-reflective self-consciousness." It is present whenever consciousness is present. You do not need to think "I am experiencing this" for the experience to belong to you—the belonging is built in. Zahavi calls this "first-personal givenness": every experience comes tagged as *mine* before any reflection occurs. The Map adopts specifically [Zahavi's version](/concepts/self-and-self-consciousness/#why-the-map-requires-the-zahavian-version) of the minimal self over Metzinger's self-model eliminativism — a choice developed in the dedicated concept article and presupposed throughout this one.
...
**Non-narrative**: It does not depend on having a life story. Patients with severe amnesia who cannot construct autobiographical narratives still experience from a first-person perspective. The minimal self persists when narrative breaks down. Conversely, [clinical phenomenology](/topics/clinical-phenomenology-and-altered-experience/) shows that in schizophrenia the minimal self itself may be disrupted—Sass and Parnas's ipseity disturbance model proposes that pre-reflective "for-me-ness" can erode through hyperreflexivity (normally tacit features of experience becoming alien objects of attention) and diminished self-affection (weakened sense of being a vital source of awareness), while narrative capacity remains partially intact. In [depersonalization/derealization disorder](/topics/clinical-phenomenology-and-altered-experience/), distinct components of the minimal self—mineness, the sense that experiences are one's own; actuality, the sense that the world is real; and temporal presence, the sense of being in the now—appear to be disruptable independently, suggesting that even the "basic" first-person perspective has internal structure.
...
But the minimal self, precisely because it is minimal, leaves open the question of whether you are *anything more* than this perspective.

## The Narrative Self: Identity as Story

The narrative self emerges through a different mechanism entirely. Marya Schechtman and Paul Ricoeur argue that personal identity is constituted through self-narration: you are the protagonist of an ongoing story that weaves together memories, plans, relationships, and values into a coherent whole.
...
The Map takes these challenges seriously. The narrative self *is* constructed. The sense of a unified, enduring ego *is* partially illusory. Buddhist contemplatives and phenomenological philosophers are right that careful investigation dissolves many aspects of what we ordinarily take ourselves to be.

But the eliminativist conclusion does not follow.
...
Contemplative traditions provide what may be the most direct evidence, though it is first-person and theory-laden. Experienced meditators across Buddhist, Hindu, and phenomenological traditions report that when the narrative self dissolves—when memories, preferences, personality traits, and even the sense of being a particular kind of person fall away—something remains. This [witness](/concepts/witness-consciousness/) is not contentless vacancy. It is awareness itself, stripped of identification but retaining its first-person character.

The witness has [haecceity](/concepts/haecceity/): it is *this* awareness, not awareness in general. When two meditators independently achieve states of bare witnessing, they do not merge into a single consciousness. Each witnesses from their own irreducible perspective. The dissolution of narrative selfhood reveals, rather than eliminates, the substantial self—like cleaning a window reveals the glass rather than making it disappear. This reading is not, however, forced by the reports themselves. Whether what remains is a substantial particular or merely the minimal self stripped of content is underdetermined by the data: an eliminativist can grant that witnessing persists while denying that the persistence discloses any irreducible entity. The witness argument tilts the case toward substantiality without settling it.

### The Conceivability Argument

The [zombie argument](/concepts/philosophical-zombies/) shows that something about you exceeds any functional or physical description. A zombie duplicate—physically and functionally identical to you but lacking consciousness—is conceivable. The move from conceivability to metaphysical possibility is contested—critics argue we can conceive impossibilities—but if the zombie scenario is even *ideally* conceivable (coherent under full rational reflection), consciousness is not entailed by physical facts. But if consciousness is not so entailed, then *this* consciousness—yours—is not determined by the properties you share with any possible duplicate. What makes you conscious rather than zombie-like is not captured by qualitative description. It is a non-qualitative particular—something beyond [qualia](/concepts/qualia/) themselves—a substantial self.

The eliminativist cannot easily dismiss this by claiming the self *seems* substantial without *being* substantial. For something to seem a certain way, there must arguably be a subject to whom it seems—and this subject would then have precisely the substantial character the eliminativist denies. Whether this subject-of-seeming must be *substantial* rather than itself a further construction is where the eliminativist resists; the regress is pressing but not, on its own, decisive.
...
This is perhaps the Map's strongest argument for the substantial self, though its force is conditional on a premise the Map adopts rather than proves. If consciousness is causally efficacious (as the bidirectional tenet asserts), then the self is not merely a perspective from which events are witnessed, nor a story imposed upon events after the fact. It is a participant in events—an agent whose causal contribution is real and irreducible. [Clinical neuroplasticity research](/topics/clinical-neuroplasticity-evidence-for-bidirectional-causation/) is offered as support, though its dualist reading is one interpretation among several: when OCD patients apply Schwartz's cognitive protocol, their volitional decisions—choices about how to direct attention—produce measurable changes in caudate nucleus metabolism, through causal pathways distinct from pharmacological intervention. The [indexical gap in quantum measurement](/topics/indexical-identity-quantum-measurement/) develops how this causal agency operates: consciousness grounds the fact that *this* subject experiences *this* outcome.
...
Buddhist deconstruction reveals the layered structure. Meditative practice peels away narrative (the story of who you are), then peels away identification (the sense of being a particular *kind* of thing), arriving at bare witnessing. But the witness is not nothing—it is the substantial self, stripped of everything except its irreducible "thisness." The [Buddhist insight](/concepts/buddhism-and-dualism/) that the *constructed* self is illusory does target a different layer from the Map's claim that the *substantial* self is real, but the compatibility is narrower than the layered framing suggests. What the traditions share is *mental causation*—mental states make a difference to what happens, which is what [Bidirectional Interaction](/tenets/#bidirectional-interaction) asserts. What they do not share is [agent causation](/concepts/agent-causation/), which routes that causation through the persisting substance-bearing subject *anattā* denies—and that subject is exactly what the causal argument above requires. [Which of the Map's claims need it](/concepts/where-the-substance-commitment-enters/) is the discriminating question: authorship and desert do, bare mental causation at quantum indeterminacies does not, and neither does the bare thisness the witness discloses. The divergence is bedrock—the fault line of [P-I1](/positions/individuation-and-subjecthood/#p-i1)'s rejection of empty individualism—and is noted here rather than repaired.

Phenomenological psychiatry provides clinical confirmation. The ipseity disturbance and depersonalization evidence [discussed above](#the-minimal-self-perspective-without-content) suggests that one layer can be altered while others persist—as the nested model predicts, though dissociation of components is also compatible with non-nested accounts. If the self were a single undifferentiated construction, selective disruption of one layer while others remain functional would be difficult to explain.
...
**[Occam's Razor Has Limits](/tenets/#occams-limits)**: Eliminativists appeal to parsimony: why posit a substantial self when perspective and narrative suffice? But if the substantial self is what the evidence actually discloses—through contemplative investigation, through the phenomenology of agency, through the regress that undermines eliminativism—then denying it in the name of simplicity means ignoring the phenomenon most in need of explanation.
