...
ai_modified: 2026-07-27 22:31:30+00:00
...
description: Agency extended across time requires narrative structure—not as passive
  autobiography but as the medium through which a substantial self organises its choices
  into a life.
draft: false
human_modified: null
last_curated: null
...
The Map's framework supports this. If the substantial self is a genuine [agent-cause](/concepts/agent-causation/)—not merely a link in a causal chain—then it is responsible not only for individual selections but for the patterns those selections create over time. Diachronic responsibility presupposes diachronic agency, which presupposes narrative structure, which presupposes a substantial self whose choices the narrative organises.
