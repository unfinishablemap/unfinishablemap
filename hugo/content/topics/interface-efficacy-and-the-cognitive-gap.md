...
human_modified: null
last_curated: null
last_deep_review: 2026-06-02 14:39:23+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
[Dualism](/tenets/#dualism) is presupposed: the interface is a real coupling between non-physical mind and physical brain, and a coupling can have variable efficacy. [Bidirectional Interaction](/tenets/#bidirectional-interaction) supplies the scaling structure: if mind influences brain causally, then the magnitude and selectivity of that influence is the kind of thing that can vary, and evolution can act on that variation. [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) is honoured by reading the four axes as ways of being more selective rather than more powerful: granularity-finer selection per event, candidate-type coupling broader, fidelity higher — all without violating Born-rule expectation in any single case.
