...
human_modified: null
last_curated: null
last_deep_review: 2026-01-25 12:00:00+00:00
modified: *id001
related_articles:
...
[Illusionism](/concepts/illusionism/) poses a fundamental objection: if phenomenal consciousness doesn't exist—if qualia are introspective illusions—then the baseline/human distinction cannot involve phenomenal consciousness. Great apes and humans would differ only in information-processing sophistication, not in possession of a qualitatively different kind of inner life.
...
The [Dualism](/tenets/#dualism) tenet gains support if metarepresentation—the cognitive threshold separating ape from human intelligence—requires phenomenal consciousness and cannot be achieved by functional states alone. The [argument-from-reason](/topics/argument-from-reason/) provides the connection: grasping that a conclusion *follows from* premises involves tracking normative relationships that purely physical causation cannot instantiate. If this is correct, the metarepresentational capacity that enables cumulative culture and logical reasoning isn't merely more sophisticated information processing—it involves irreducibly conscious access to the "space of reasons."
