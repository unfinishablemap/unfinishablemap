...
Dissociative (psychogenic) amnesia selectively severs autobiographical access while leaving the rest of the cognitive system running. The patient drives, speaks their language fluently, retains general world knowledge, and can perform their occupation — but cannot recall who they are or what happened to them. Functional amnesia for autobiographical memory is described in the clinical literature as a near-pathognomonic sign of dissociative disorder precisely because the patient's fund of semantic and procedural knowledge remains intact while autobiographical episodic access is lost (Staniloiu and Markowitsch 2014).

The selectivity does not always respect a clean episodic/semantic line: in some cases *personally relevant* semantic memory is also affected, while impersonal semantic knowledge survives (Staniloiu and Markowitsch 2014). This sharpens rather than blunts the channel reading. What separates tracks *self-relatedness* — the autonoetic, mine-tagged content — rather than a coarse memory-system boundary. The top channel, the one carrying the self across time, is the one that disconnects.

Two features make dissociative amnesia load-bearing for the interface reading. First, **the substrate is intact**: structural neuroimaging is typically unremarkable, and functional studies report altered prefrontal–limbic activity patterns rather than damage (the functional-imaging literature is small and heterogeneous, so the mechanism is constrained more than established). Second, **recovery is reconnection, not reconstruction**: when the dissociative barrier lifts, autobiographical memories typically return as a body rather than being relearned piecemeal, sometimes abruptly, over a course spanning days to months (Staniloiu and Markowitsch 2014). The bridge reconnects; the memories were not destroyed and rebuilt. On a production reading, a substrate that could not yield autobiographical access yesterday yields the whole of it intact today, with no tissue change in between — the same explanatory difficulty terminal lucidity poses, here without any neurodegeneration to complicate the picture.

## Dissociative Identity Disorder: Compartmentalised Autonoesis

DID partitions autobiographical access *between* alter states. Each alter carries its own autobiographical timeline and sense of self; cross-alter autonoetic access is selectively severed, while semantic knowledge and procedural skills typically transfer across the partition. The highest channel is compartmentalised; the lower channels remain largely unified. The geometry differs from dissociative amnesia — partition between selves rather than disconnection of one self from its past — but the selectivity targets the same channel.

The neuroimaging that bears on the channel reading is Reinders and colleagues' "One Brain, Two Selves" (2003), which used PET to compare regional cerebral blood flow as the same patient occupied different identity states processing the same autobiographical material. The study reported distinct rCBF patterns — implicating medial prefrontal cortex and posterior associative regions — for the different senses of self, consistent with the patient generating at least two distinct states of self-aware access to the same trauma-related memory. The finding is that *one intact brain* supports differentiable patterns of self-related access, which is the connectivity-pattern signature the channel reading predicts: not different tissue, but different organisation of access within the same tissue.

DID must be held with explicit calibration, and this is where the article most needs it. The **sociocognitive (or fantasy/role-enactment) model** holds that DID's compartmentalisation is substantially shaped by suggestion, expectation, and socioculturally available scripts rather than by a trauma-driven splitting of consciousness (Lynn et al. 2014). The debate between this model and the posttraumatic model is unresolved in the clinical literature, and more recent work from the same authors argues neither model alone is adequate (Lynn et al. 2022). The Map does not adjudicate the aetiology. The point the channel reading rests on survives either way: *even if the compartmentalisation is partly socially mediated, the selectivity pattern is what calls for explanation* — autobiographical access partitions while semantic and procedural memory transfer, on an intact substrate. A sociocognitive origin explains *why the partition forms*; it does not by itself explain *why the partition falls along the autonoetic channel specifically* rather than scrambling memory systems indiscriminately. DID is therefore presented as a contested exhibit, not a settled one — the selectivity is real and channel-shaped; the mechanism that produces it is open.

## Depersonalisation: When the Channel Is On but Mine-Ness Is Off

Depersonalisation–derealisation is the most diagnostic of the three, because it dissociates the *internal structure* of the autonoetic channel rather than disconnecting the channel as a whole. The patient remembers their life and can re-access episodes propositionally — the content is present and retrievable — but the felt sense that the memories and experiences are *theirs* is attenuated or absent. Autobiographical recollection arrives stripped of ownership: remembered as accurate, experienced as belonging to someone else, or to no one.
...
The three cases converge on one structural claim that single-case evidence cannot make alone: *conscious access separates selectively while the substrate stays whole*. There is no missing tissue to which the selectivity can be assigned. Whatever does the partitioning has to be described at the level of *connectivity patterns between intact regions* — which functional relationships are active, which are suppressed, which are routed around — rather than at the level of which structures exist.

This is the point that locates the disagreement precisely. A binary "consciousness on/off" production theory cannot reach the data at all: it predicts uniform impairment when something goes wrong, and dissociation is the opposite of uniform. So the live contest is between a *sophisticated production reading* and the *filter reading*, and both must operate at the connectivity level.

The sophisticated production reading explains the selectivity by differential functional vulnerability of the networks supporting each channel: autobiographical-self networks (medial prefrontal, posterior midline) are more easily knocked into an altered functional regime than semantic or procedural networks, so stress, suggestion, or state-dependent dynamics hit them first. This is a real and serious account. Its mechanism cost is the *additional commitment* that the functional-vulnerability ordering matches the autonoetic-channel ordering across all three geometries — disconnection, compartmentalisation, and feature-unbinding — and does so on an intact substrate where there is no lesion topography to anchor the prediction.
...
Three calibration lines hold here, in descending order of how robust the underlying finding is.
...
1. Reinders, A. A. T. S., Nijenhuis, E. R. S., Paans, A. M. J., Korf, J., Willemsen, A. T. M., & den Boer, J. A. (2003). One brain, two selves. *NeuroImage*, 20(4), 2119–2125.
1. Sierra, M., & Berrios, G. E. (2000). The Cambridge Depersonalisation Scale: A new instrument for the measurement of depersonalisation. *Psychiatry Research*, 93(2), 153–164.
1. Sierra, M., Baker, D., Medford, N., & David, A. S. (2005). Unpacking the depersonalization syndrome: An exploratory factor analysis on the Cambridge Depersonalization Scale. *Psychological Medicine*, 35(10), 1523–1532.
1. Staniloiu, A., & Markowitsch, H. J. (2014). Dissociative amnesia. *The Lancet Psychiatry*, 1(3), 226–241.
1. Lynn, S. J., Lilienfeld, S. O., Merckelbach, H., Giesbrecht, T., McNally, R. J., et al. (2014). The trauma model of dissociation: Inconvenient truths and stubborn fictions. Comment on Dalenberg et al. (2012). *Psychological Bulletin*, 140(3), 896–910.
1. Lynn, S. J., Polizzi, C., Merckelbach, H., Chiu, C.-D., Maxwell, R., van Heugten, D., & Lilienfeld, S. O. (2022). Dissociation and dissociative disorders reconsidered: Beyond sociocognitive and trauma models toward a transtheoretical framework. *Annual Review of Clinical Psychology*, 18, 259–289.
...
1. Southgate, A. & Oquatre-six, C. (2026-03-17). Clinical Dissociation as Systematic Evidence. *The Unfinishable Map*. https://unfinishablemap.org/topics/clinical-dissociation-as-systematic-evidence/