...
But Kim himself acknowledged a formulation dilemma. The principle must be strong enough to exclude mental causation but not so strong as to simply presuppose physicalism. Finding this middle ground proves remarkably difficult. Strong closure (no physical event has any non-physical cause) begs the question. Weak closure (physical events always have physical causes, but may have other causes too) fails to exclude mental causation. The principle's plausibility may depend on this very ambiguity.
...
**Buhler's systematic critique.** Keith Buhler (2020) examined every extant argument for causal closure and found them all wanting. Deductive arguments beg the question — they assume the physical domain is complete in order to prove that it is complete. Inductive arguments commit sampling errors: the success of physical explanation within domains we have investigated does not establish completeness across *all* domains, including the consciousness-physics interface. Even the strongest inductive conclusions remain compatible with causal openness.
...
The response that "decoherence restores effective classicality" misses the point. [Decoherence](/concepts/decoherence/) selects preferred bases and suppresses interference, but it does not explain why one outcome rather than another becomes actual. The measurement problem remains unsolved, and it is precisely a failure of causal closure.
...
The historical survey supports the Map's position through [Tenet 5 (Occam's Razor Has Limits)](/tenets/#occams-limits). The apparent simplicity of causal closure — one domain, one kind of cause — reflects the same pattern that made geocentrism, continuous matter, and deterministic physics seem simpler than the truth. An empirical assumption was elevated to a metaphysical axiom because it simplified the picture, not because the evidence compelled it.
