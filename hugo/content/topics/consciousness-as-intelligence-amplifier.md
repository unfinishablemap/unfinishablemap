...
description: How consciousness transforms baseline cognition into human-level intelligence.
  A collaborative exploration of what phenomenal experience adds beyond neural computation.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-01-27 09:44:28+00:00
modified: *id001
related_articles:
...
- **Procedural [metacognition](/concepts/metacognition/)**: Monitoring uncertainty, seeking information when needed, adjusting behaviour based on confidence
...
The Map's position: consciousness evolved because it confers adaptive advantage. It enables cognitive capacities—logical reasoning, counterfactual thinking, cumulative culture—that unconscious processing cannot achieve. The evolutionary argument supports the [Bidirectional Interaction](/archive/arguments/interactionist-dualism/) tenet.
...
- **Flexibility**: Responding to novel situations not covered by automatic routines (see [free-will](/topics/free-will/))
...
- **[Temporal expansion](/concepts/temporal-consciousness/)**: Connecting present experience to past memories and future possibilities
...
This remains speculative. Functional equivalents of these capacities might be achieved computationally. Or artificial systems might hit a ceiling that only consciousness can breach. The question connects to the [broader problem](/topics/ai-consciousness/) of whether artifacts can be conscious at all.

## Relation to Site Perspective

The Unfinishable Map's [tenets](/tenets/) find strong support in the consciousness-intelligence relationship:
