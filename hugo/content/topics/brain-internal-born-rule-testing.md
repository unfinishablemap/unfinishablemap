...
description: 'The corridor reading of Tenet 2 predicts no Born-statistical signature
  by construction. What would actually foreclose it: a coordinated programme of brain-internal
  observables, mechanism-specific signatures, and convergent precision across multiple
  proposals.'
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-05-14 19:10:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Foreclosing the corridor would not require a single null result. It would require a coordinated programme: brain-internal observables sensitive at the level a viable selection channel could matter, controls separating physical from conscious confounds, and convergent precision across multiple mechanism candidates. This article catalogues that programme, maps each consciousness-physics proposal — Stapp's quantum Zeno, Penrose-Hameroff Orch-OR, the strict selection-only channel, the trumping-preemption reading — to its predicted experimental signature, and specifies what foreclosure would actually look like.
...
The [trumping-preemption](/concepts/trumping-preemption/) reading ([delegatory-causation](/concepts/delegatory-causation/)) holds that consciousness is causally authoritative on an axis the Born rule does not parameterise — selecting at a level the Born distribution already presupposes settled, in the way an attorney's authorisation can trump but does not violate the statutory rules under which she operates. Read this way, Born-rule preservation is not a constraint the channel must respect; it is a non-issue. The trumping reading predicts no statistical signature at the Born level *plus* a positive signature wherever the trumping axis is empirically identifiable — typically through causal-structure tests that distinguish authoritative-over-X from probability-biased-by-Y, or through phenomenological evidence that conscious authorisation precedes neural commitment in a manner classical computation cannot account for. Foreclosure of the trumping reading would require a complete classical-mechanistic account of authoritative selection at the level it operates: evidence that the apparent trumping reduces to physical computation at the axis it occupies. This is the move closest to making the empirical question non-orthogonal to Born-rule testing — and accordingly the hardest to evaluate by Born-rule data alone.

## What Would Foreclose the Corridor

Foreclosing the corridor — making the strict selection-only reading empirically untenable — requires convergent negatives across multiple regimes. The minimum sufficient evidence is:

**A null on brain-internal coherence at consciously-relevant timescales.** Kerskens-Pérez-style entanglement-witness signals in brain tissue would have to be cleanly classically explained or fail to replicate at higher precision. Babcock-Hameroff microtubule coherence claims would have to be ruled out at the relevant mass-time scale (MAQRO-class precision in the appropriate regime). Keppler's zero-point-field cortical-microcolumn coupling proposal would have to be excluded. Together, these would foreclose the regime in which a corridor selection could plausibly operate.

**A clean negative on every viable selection signature in brain-coupled quantum systems.** Nirvanic-style protocols, scaled and replicated, would have to find no statistically detectable difference between conscious-attention and unconscious-attention conditions in the behaviour of brain-coupled qubits. The data have to discriminate carefully: a positive signal above corridor ε constrains probability-bias readings, while a tight null at corridor ε is what the strict corridor reading actually predicts. The corridor is *consistent* with such a null; it is foreclosed only if the null arrives alongside the previous criterion.

**A theoretical resolution of the post-decoherence definite-outcome problem.** If decoherence is shown — not merely *assumed* — to be sufficient for definite outcomes, the selection space the corridor needs to occupy disappears. This is a theoretical falsifier rather than an experimental one. Schlosshauer's (2004, 2025) "problem of outcomes" remains open in the literature, and the corridor reading is presently coherent with this openness.

A single negative — even a high-confidence Nirvanic null — does not foreclose the corridor. It constrains a particular mechanism's signature; the strict corridor reading by construction predicts no signature for that test. Foreclosure is plural and convergent: the regime gets shut from multiple directions simultaneously, and the theoretical motivation for postulating any selection space gets removed at the same time.
...
The corridor reading is therefore neither foreclosed nor confirmed. It survives because the brain-internal testing regime is between first-generation instruments and the precision at which a corridor signature could be detected — and a strict corridor reading predicts no signature anyway. [MQI Empirical Fragility](/project/mqi-empirical-fragility/) warns against treating this situation as either vindication or refutation; the Map's commitment is to keep saying so until the data closes it.
...
Two tenets bear especially on the present article:
...
The corridor, then, is not unfalsifiable. It is unfalsifiable *by current instruments*. The article's catalogue of what would foreclose it is the Map's commitment to specifying, in advance, what evidence would compel retreat — to the probability-bias reading, to the trumping-preemption reading, or to abandonment of Tenet 3 entirely. The first-generation instruments described above (Kerskens-Pérez witness protocols, MAQRO-class interferometry, Nirvanic brain-coupled-qubit architectures, anaesthesia-controlled selection statistics) are where that evidence would have to come from. Until it does, the corridor reading is the working hypothesis held with discipline, not the answer.
