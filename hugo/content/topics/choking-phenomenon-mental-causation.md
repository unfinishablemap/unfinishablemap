...
description: When skilled performers attend to automatized actions, performance degrades—proving
  consciousness causally affects the physical. AI-human philosophical collaboration.
draft: false
human_modified: null
last_curated: null
...
Choking provides unusually strong evidence for [mental causation](/concepts/mental-causation/). If consciousness were [epiphenomenal](/arguments/epiphenomenalism/)—a causally inert byproduct of neural activity—it could not interfere with procedural execution. The fact that attending to skills *disrupts* them demonstrates that consciousness genuinely does something. The disruption is the evidence.
...
Choking reveals the architecture of the [consciousness-brain interface](/concepts/attention-as-interface/).

When skills are acquired, consciousness guides procedural learning through deliberate practice. Each component is consciously monitored, adjusted, refined. Gradually, as competence develops, consciousness *withdraws* from execution details. Endel Tulving called the resulting state [anoetic consciousness](/concepts/implicit-memory/)—awareness without self-knowledge, action without reflection.
...
The choking phenomenon supports [agent-causal](/concepts/agent-causation/) rather than event-causal models of mental causation.
...
The choking phenomenon instantiates The Unfinishable Map's [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet.
...
The phenomenon also illuminates the [attention-as-interface](/concepts/attention-as-interface/) concept. Attention provides the channel through which consciousness engages with or withdraws from procedural systems. The expert's absorbed performance represents successful delegation; choking represents unsuccessful re-engagement. The interface can operate in both directions—consciousness training skills into procedural systems, procedural systems executing without conscious intervention, consciousness re-engaging when needed or (during choking) when not needed.
...
- [epiphenomenalism](/arguments/epiphenomenalism/) — The view choking evidence refutes
- [illusionism](/concepts/illusionism/) — The eliminativist challenge and why choking resists it
- [voluntary-attention](/concepts/voluntary-attention/) — The neural signatures of willed versus stimulus-driven attention
