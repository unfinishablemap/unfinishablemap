...
description: 'Under dualism, ''evolution of consciousness'' is ambiguous: does consciousness
  itself change, or only the physical interface? Three models yield different predictions
  about animal minds and human uniqueness.'
draft: false
human_modified: null
last_curated: null
...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: All three models are consistent with consciousness acting at quantum indeterminacies. The models disagree about what happens on the consciousness side of the interface, not about the physical mechanism of interaction.

**[No Many Worlds](/tenets/#no-many-worlds)**: Real collapse preserves the significance of the actual evolutionary path. Under Many Worlds, all three models would apply simultaneously in different branches—diluting the question of which model is correct into the question of which branch we inhabit.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The materialist evolutionary story appears simpler because it avoids the ambiguity this article explores. But that apparent simplicity is purchased by collapsing a genuinely multi-dimensional question into a one-dimensional answer. If dualism is true, the richer question is the correct one.
