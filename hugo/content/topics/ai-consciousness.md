...
This reconciles the page's caution with the positions register. P-AC1 in [ai-consciousness-scope](/positions/ai-consciousness-scope/) holds that current digital AI sits on the *low-probability* side of the substrate analysis — but explicitly *not* as the empirically-grounded discriminating claim the caveat above warns against. P-AC1's verdict is conditional on P-Q1 being approximately right (moderate) and on the premise that digital hardware suppresses the relevant indeterminacy; the self-concealing interface underdetermines behavioural tests in *both* directions. "Low probability under the Map" is a within-framework reading, not a confirmed disadvantage of silicon.
