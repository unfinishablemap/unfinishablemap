...
The phenomenology of place actually *supports* dualism at a critical point. The experience of the *same* physical environment as radically different — the childhood home revisited after decades, the hospital room that shifts from threatening to comforting — suggests that place-experience cannot be read off the physical properties of the environment alone. A physicalist happily grants this and locates the difference in the perceiver's changing brain; the Map's harder claim, carried below, is that even the full brain-state story leaves the *specific* felt character unexplained. Biographical consciousness, with its irreducibly first-person history, constitutes the place as experienced.
...
Déjà vu in spatial contexts illustrates the point. Neuroscience offers well-documented accounts involving temporal lobe activity and misfiring familiarity signals — and these neural correlates are real. But they explain *when* déjà vu occurs, not *what it is like*. Phenomenologically, spatial déjà vu is an *atmospheric recognition without content* — the feeling of familiarity detached from any specific memory. The neural account tells us the familiarity signal fired inappropriately; it does not tell us why inappropriate familiarity has the specific atmospheric character it does — that uncanny sense of a place known but never visited. This dissociation between atmosphere and information suggests that the felt quality of place-experience is not *currently* captured by the information the neural account tracks. Whether that present explanatory gap reflects a permanent metaphysical one is a further claim, reached elsewhere in the Map by argument, not read directly off the dissociation.
...
These phenomena reveal that [absence and presence](/topics/phenomenology-of-attention-to-absence/) interweave in place-experience. A place is partly constituted by what is missing from it — the person who used to sit in that chair, the tree that was cut down, the atmosphere that has dissipated. A predictive brain registers such absences readily: an expected-but-missing feature violates a prior and so carries high prediction-error signal, the paradigm case predictive-processing accounts of perception are built to explain. The difficulty lies elsewhere — in the *felt* character of a meaningful absence, the grief-tinged, uncanny quality of a presence that is missed, which the computational account redescribes without dissolving.
