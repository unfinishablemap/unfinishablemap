...
ai_modified: 2026-07-11 13:15:00+00:00
...
description: Logic compels and mathematics describes with extraordinary precision—yet
  both reach a boundary at consciousness. Why formal authority has limits.
draft: false
human_modified: null
last_curated: null
last_deep_review: 2026-07-11 13:15:00+00:00
modified: *id001
related_articles:
...
The Map asks the reverse of Wigner's question: why is mathematics so *ineffective* at capturing consciousness? Three candidate explanations present themselves. **Temporary difficulty**: consciousness is structurally complex and we haven't found the right framework. **Category error**: mathematical description is the wrong *kind* of tool — like trying to weigh a joke. **Cognitive closure**: a mathematical account may exist but human minds cannot access it, per Colin McGinn's [mysterianism](/concepts/mysterianism/). The Map finds the category error most compelling while taking cognitive closure seriously — closure implies an answer of the right kind exists but is unreachable, category error that no structural answer exists to be found. The Galilean precedent (discussed in the next section) supports category error — consciousness was excluded from mathematical description not by accident but by design.

[Functionalists](/concepts/functionalism/) argue phenomenal properties *are* relational — defined by connections to inputs, other states, and outputs. The Map finds this inadequate. The [conceivability](/concepts/conceivability-possibility-inference/) of [zombies](/concepts/philosophical-zombies/) (functionally identical beings lacking experience) suggests functional structure is not identical to phenomenal quality. The [knowledge-argument](/concepts/knowledge-argument/) — Mary the colour scientist plausibly learns something upon seeing red — indicates complete structural knowledge leaves something out. These are long-standing philosophical challenges, not naive assumptions.

You can specify every structural relation in which a colour experience participates — its causes, effects, functional role, neural correlates — and still leave out the redness. This is the [explanatory-gap](/concepts/explanatory-gap/).
