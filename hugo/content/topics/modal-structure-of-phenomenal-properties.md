...
ai_modified: 2026-04-11 10:56:00+00:00
...
human_modified: null
last_curated: null
last_deep_review: 2026-04-11 10:56:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
"Pain = C-fibre activation" also seems contingent. But here the explaining-away strategy fails. With water, the appearance of contingency dissolves because we were ignorant of water's hidden nature. Pain has no hidden nature. We know pain through direct [acquaintance](/concepts/phenomenal-acquaintance/) with its phenomenal character. When we conceive of pain without C-fibre activation, we are not confusing pain with something that merely resembles it — we are conceiving of the very thing we know most intimately occurring without its supposed physical identity.

This asymmetry exposes something about phenomenal properties that sets them apart from every physical natural kind. Physical kinds have hidden essences discovered empirically. Phenomenal properties are fully present in experience — their nature is exhausted by how they appear. The painfulness of pain is not a label for some underlying process we might later discover to be identical with C-fibre activation; it is the thing itself, given to us in its entirety through [acquaintance](/concepts/phenomenal-acquaintance/). There is nothing about pain waiting to be discovered by neuroscience that would make its apparent separability from C-fibres dissolve, because there is no gap between how pain appears and what pain is.
...
|----------|-------------|-------------|-------------------|
| [Zombies](/concepts/philosophical-zombies/) | Phenomenal properties possibly absent | Phenomenal properties | All physical properties |
| [Inverted qualia](/concepts/inverted-qualia/) | Phenomenal properties possibly different | Qualitative character | Functional role |
| [Mary's Room](/concepts/knowledge-argument/) | Phenomenal knowledge possibly absent | Epistemic state | Physical knowledge |
| Kripke | Psychophysical identity possibly false | Phenomenal-physical connection | Rigid designation |

These are not four ways of making the same point. They target different aspects of the phenomenal-physical relationship: existence, character, epistemic access, and identity. (The [zombie-master-argument](/concepts/zombie-master-argument/) shows how the conceivability argument subsumes several of these as special cases within a single logical structure.) The fact that phenomenal properties permit detachment along every one of these dimensions — when no physical property permits detachment along *any* of them — constitutes a convergence that demands explanation.
...
- [zombie-master-argument](/concepts/zombie-master-argument/) — How the conceivability argument subsumes multiple modal arguments
