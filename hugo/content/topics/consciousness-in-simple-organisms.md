...
draft: false
embedded_videos:
- embedded: 2026-07-17 08:41:11.527736+00:00
  id: foo_P7eBCHc
...
**The regress, and why it does less work here than it appears to.** Tallis's objection (2011)—that illusions presuppose experience—is the standard reply: for *C. elegans* to be "under the illusion" of consciousness, something in that 302-neuron system would have to experience the seeming-to-be-conscious. But the bare regress assumes the seeming is itself phenomenal, precisely what illusionists deny, and it proves nothing: a representational system need not instantiate what it represents ([functional seeming](/concepts/functional-seeming/) is Frankish's account of how). The substantive pressure sits on the relocation move instead—the illusionist has traded the question of whether the worm experiences anything for the question of whether the worm *represents itself* as experiencing anything, and that trade earns its keep only if the second question is tractable where the first was not. Neither side closes the case against the other inside the rival's framework. What survives independently of the regress is the scaling problem above, which the relocation does not dissolve: a 302-neuron system is no more obviously a candidate for the misrepresentation than for the phenomenality, so the threshold question is inherited rather than answered.
...
Thomas Metzinger's work on "[minimal phenomenal experience](/concepts/minimal-consciousness/)" (MPE) describes states where content drains away while awareness remains—what meditators in various traditions report as "pure consciousness" or "rigpa" in Tibetan Buddhism. In these states, there is experience *of* nothing determinate, yet experience persists.
...
- [bacterial-chemotaxis-and-minimal-biogenic-cognition](/topics/bacterial-chemotaxis-and-minimal-biogenic-cognition/) — The prokaryotic floor one rung below: sensing, memory, and decision in a single cell with no neurons
...
- [degrees-of-consciousness](/concepts/degrees-of-consciousness/) — How consciousness varies in intensity, richness, and complexity across species
...
### Apex Synthesis
- [competency-without-felt-experience](/apex/competency-without-felt-experience/) — The cross-node synthesis this survey feeds: the whole ladder from prokaryotes to engineered cortex, and why cognitive-grade competency and felt experience are separate axes
