...
The bridge forecloses both responses simultaneously. The functionalist must claim that (a) evaluation is a computational role, and (b) demand-character is just the felt quality of that role. But evaluating (a) and (b) themselves depends on phenomenal demand-character — the felt grip that makes these claims seem warranted. The functionalist who evaluates the claim that evaluation is computational uses phenomenal normativity to do so.

The reflexive argument alone shows evaluation presupposes consciousness. The bridge shows it presupposes *demand-character specifically*. A functionalist might respond: "I identify demand-character with a functional property." But to evaluate that identification, you must use the very demand-character whose nature is in question. If demand-character *is* a functional property, the evaluation establishing this is just functional processing — and the claim that it "works" has no normative force beyond the tautology that the process produced itself.

An obvious objection: every position about consciousness is reflexive. If reflexivity undermines the functionalist, why not the dualist? The asymmetry: the dualist's reflexivity is coherent — if consciousness is irreducible, using conscious evaluation to establish this loses nothing. The functionalist's reflexivity is self-undermining — if demand-character is functional, the evaluation supporting this claim has no more authority than any other computational output, including the contradictory one. The dualist's conclusion preserves the method's authority; the functionalist's drains it.
