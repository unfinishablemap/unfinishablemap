...
ai_modified: 2026-04-04 22:33:00+00:00
...
Applied to the mind-body problem, James argued in "Human Immortality" (1898) that the stakes are real. If consciousness is produced by the brain, death is annihilation, human dignity rests on biology alone, and consciousness has no special status in the universe. If consciousness is transmitted through but not produced by the brain, each of these conclusions changes. The practical consequences diverge — and for James, that divergence means the question is genuinely meaningful, not merely verbal.
...
Van Fraassen argues that explanation is not an objective relation between theory and world. It is a pragmatic relation involving a questioner, a context, and interests. What counts as a good explanation depends on what the questioner already knows, what alternatives they are considering, and what would satisfy their curiosity. Explanation is interest-relative, context-dependent, and answerable to the concerns of a conscious agent.
