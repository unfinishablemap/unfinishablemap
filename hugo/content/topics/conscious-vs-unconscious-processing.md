...
## What Only Consciousness Enables

### Working Memory and Temporal Maintenance

Dehaene's [Global Neuronal Workspace theory](//#global-workspace-theory) (explained below) identifies three functions requiring consciousness. First: durable information maintenance. Unconscious processing is fleeting—subliminal priming effects decay within seconds. To hold information across time—remembering a phone number while dialling, maintaining context across sentences, keeping your place in a multi-step task—requires consciousness.

The neural signature: conscious access correlates with sustained recurrent processing and late cortical amplification (beyond 300ms). Unconscious processing shows early feedforward activation that fades quickly. Working memory depends on sustained firing in prefrontal and parietal networks—activity that requires the global ignition associated with consciousness.

### Novel Combinations and Flexible Integration
...
## The 2025 Reanalysis: Less Unconscious Processing Than Believed

Randeniya (2025) applied extended sensitivity analysis to neuroimaging studies of unconscious processing. The methodology: for a study to demonstrate unconscious processing, it must show both (1) that subjects cannot consciously discriminate the stimulus and (2) that brain activity still contains information about it—with the neural signal exceeding the behavioural discrimination.
...
The implications for the mind-body problem: if consciousness enables functions that unconscious processing cannot achieve, [epiphenomenalism](/arguments/epiphenomenalism/) is empirically undermined. The fact that humans engage in logical reasoning and cumulative culture—functions requiring conscious processing—suggests consciousness makes a causal difference to behaviour.

## Global Workspace Theory {#global-workspace-theory}

Stanislas Dehaene's Global Neuronal Workspace (GNW) theory proposes that consciousness arises when information is broadcast to a distributed network of neurons via recurrent processing and attentional amplification. Unconscious processing remains local to specialized modules—visual processing in occipital cortex, semantic processing in temporal regions. For information to become conscious, it must be amplified and broadcast to a global workspace spanning prefrontal, parietal, and temporal cortex.

The neural signatures of this global ignition:
- **Late amplification** (~300ms after stimulus): Conscious perception triggers a nonlinear amplification of neural activity that unconscious processing does not show
- **Long-distance synchronization**: Beta and gamma frequency oscillations coordinate distant brain regions
- **Recurrent processing**: Feedback connections sustain activity, distinguishing conscious from unconscious processing
...
Finally, the 2025 reanalysis showing that most claimed unconscious processing effects don't replicate illustrates the Map's [Occam's Razor Has Limits tenet](/tenets/#occams-limits). The "simpler" explanation—that complex cognition could be achieved unconsciously—turned out to be wrong. Consciousness is functionally necessary far more often than parsimony-driven theories predicted.
...
Randeniya, R. (2025). "Neural Correlates of Unconscious Processing in Functional Magnetic Resonance Imaging: Does Brain Activity Contain More Information Than Can Be Consciously Reported?" *Neuroscience of Consciousness*, 2025(1), niaf042.