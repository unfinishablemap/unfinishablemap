...
This pattern — relocation rather than resolution — characterises every successful reduction. [Reductive explanation](/concepts/reductionism/) maps correspondences between levels. It does not explain the existence of levels, nor why certain arrangements at one level give rise to qualitative characters at another.
...
When a level transition is old enough, familiar enough, and practically useful enough, we stop noticing the explanatory gap. The satisfaction we feel when temperature "just is" molecular motion is the absence of discomfort that comes from having encountered the identity thousands of times, not philosophical understanding. The [habituation void](/voids/disappearance-voids/) applies to entire explanatory frameworks: what was once baffling becomes obvious not because we understood it but because we stopped being bothered by it.
