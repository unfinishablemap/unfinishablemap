...
- /topics/phenomenology-of-collective-intentionality-and-we-consciousness/
concepts:
- '[[combination-problem]]'
- '[[intersubjectivity]]'
- '[[theory-of-mind]]'
...
description: Groups are not conscious, but collective intentionality requires individual
  phenomenal consciousness. The felt shift from I-mode to we-mode experience is real
  and philosophically significant—yet implemented in individual minds, not a group
  substrate.
draft: false
human_modified: null
last_curated: null
...
The Unfinishable Map defends two claims about consciousness and collective phenomena that initially seem to pull in opposite directions. First: groups are not conscious — no jury, market, or scientific community possesses phenomenal experience above the level of its individual members. Second: the most important collective phenomena — shared goals, institutional reality, normative commitment — depend constitutively on the phenomenal consciousness of individual participants. Groups do not think; but what groups achieve requires thinkers.

This combination follows directly from the Map's dualist framework: consciousness interfaces with the physical world through quantum-sensitive neural substrates that individual brains possess and groups do not. Groups lack the architecture for collective experience, yet the distinctive capacities that consciousness confers on individuals — genuine understanding, normative sensitivity, recursive mindreading — are precisely what makes human collective achievement possible. Between these two claims lies a phenomenologically rich territory: the felt shift from I-mode to we-mode experience, where individual consciousness takes on genuinely collective intentional content while remaining individually implemented.
...
The Map finds proposals for group consciousness — from Durkheim's *conscience collective* to Hegel's *Geist* to the suggestion that [IIT's](/topics/consciousness-and-integrated-information/) formalism might assign sufficiently integrated groups high Φ — provocative but unconvincing. IIT's own exclusion postulate in fact cuts against group consciousness: because only local maxima of Φ are conscious, IIT implies that aggregates of already-conscious individuals (interacting people, deliberating juries) are not themselves further conscious, since integration within each brain dominates the looser integration between brains. So loosely coupled groups are poor candidates even on IIT's terms; the Map's objections below are additional.
...
**The interface problem.** The Map's [Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction) tenet holds that consciousness interfaces with the physical world through quantum indeterminacy in neural systems. A group of people has no analogous physical substrate. Communication between people — speech, gesture, writing — is classical, macroscopic, and far too coarse-grained to serve as a quantum consciousness interface. With no candidate interface, the Map's framework predicts that groups are not conscious. This is a model-relative consequence, not an independent impossibility proof: it follows from the Map's specific posit about where consciousness acts, and a different theory of the interface could in principle license a different verdict.
...
When two people carry a table through a doorway, something shifts in how the activity feels from the inside. Each adjusts grip, pace, and angle in response to the other — not merely reacting to physical forces but coordinating around a shared goal that both understand and both know the other understands. Hans Bernhard Schmid calls this "plural pre-reflective self-awareness": just as individual action involves a pre-reflective sense of agency — you do not infer that you are acting but simply experience yourself as the source — joint action involves a pre-reflective sense of shared agency. The "we" is not a conclusion reached through inference but an immediate feature of how the activity is experienced.
...
If groups are not conscious, why does collective phenomena require consciousness at all? Because the most distinctively human forms of collective achievement — shared goals, institutional reality, normative commitment — depend on capacities that only phenomenally conscious individuals possess.
...
Collective intentionality generates normativity. Joint activity creates obligations: to do one's part, to coordinate, to share relevant information. Violating these obligations warrants reactive attitudes — resentment, blame, demands for justification — that presuppose representing the violator as a conscious agent who understood and chose to breach a commitment.

This distinguishes collective intentionality from collective behaviour. Geese flying in V-formation exhibit coordinated behaviour governed by aerodynamic forces. No goose violates an obligation by breaking formation. The coordination is real but normatively empty.

A functionalist might respond that normative responses can be characterised by functional roles without invoking consciousness. The Map's reply: functional accounts capture the *structure* of obligation while losing its *force*. A system producing blame-behaviour without anyone experiencing betrayal has the form of normative life without its substance. The [felt weight of broken commitment](/topics/phenomenology-of-trust/) — the sense that someone who *understood* chose to breach it — distinguishes obligation from mere behavioural expectation.

### The Developmental Evidence

Michael Tomasello traces a developmental sequence. At around nine months, human infants begin joint attention — triadic interactions where child, adult, and object connect through mutual awareness. The phenomenological dimension is often underappreciated: joint attention is not merely looking where someone else looks; it involves experiencing the attended object *as jointly attended*. The "as" marks a phenomenal transformation — the toy that mother and child attend to together is experienced differently from the toy attended to alone, carrying an intersubjective significance that is part of how it appears.

Between one and three years, children develop shared intentionality with complementary roles and norm enforcement. By age three, children tell others how a game "should" be played — representing the activity's normative structure. This progression — which the Map's treatment of [childhood development](/topics/consciousness-interface-development/) examines from the interface perspective — builds from basic shared awareness to full-blown collective intentionality with normative structure.
...
This analysis reveals a structural asymmetry the Map's framework anticipates. At the individual level, consciousness is irreducible, causally efficacious, and interfaces with the physical world through specific neural mechanisms. At the collective level, intelligence is real but group consciousness is absent — which, on the Map's framework, follows from the absence of a physical substrate for consciousness-world interaction. Since the framework's interface premise is what generates this expectation, the asymmetry is best read as an illustration of the framework rather than as independent evidence for it: the null hypothesis that groups simply are not conscious predicts the same observation.

The asymmetry illuminates what consciousness contributes. Collective intelligence systems that lack consciousness (ant colonies, market mechanisms) solve problems through aggregation — combining independent inputs through fixed rules. Systems involving consciousness (scientific communities, deliberative bodies) solve problems through understanding — individuals genuinely grasping each other's reasoning and being changed by it.

An ant colony cannot evaluate whether its pheromone-trail solution is *good* — it cannot step back and consider alternatives, weigh reasons, or recognise a local minimum. A scientific community can, because its individual members possess the phenomenal capacity to grasp propositions as meaningful. Consciousness contributes not more computation but comprehension — the ability to understand rather than merely aggregate. And that comprehension, shared through collective intentionality, builds institutions, traditions, and knowledge that no individual mind could construct alone.
...
The [Bidirectional Interaction](/tenets/#bidirectional-interaction) tenet finds circumstantial support in collective intentionality. The entire institutional structure of human civilisation — laws, economies, governments — exists because conscious beings share intentions and hold each other to commitments. An [epiphenomenalist](/concepts/epiphenomenalism/) can reply that the physical states do the causal work while experience rides along inertly, making the dependence one on correlates rather than on consciousness as such. The Map's reply: this story owes an account of why the correlates track the *content* of understood commitments — why a broken promise, grasped *as* a breach, reliably produces the downstream reactive and institutional consequences — without quietly reintroducing the comprehension it set out to eliminate. The dependence is pervasive enough to be difficult to dismiss as mere correlation, though it falls short of proof.

The [No Many Worlds](/tenets/#no-many-worlds) tenet bears on the stakes of collective intentionality, though here the disagreement sits at the framework boundary rather than being settled inside the Many-Worlds picture. The Map's claim is conditional: *if* normative force depends on a commitment having a single actual outcome — the one branch in which a promise was in fact kept or broken — then universal branching, on which the promise is both kept and broken across equally real branches, dilutes the indexical weight that makes the commitment binding. A Many-Worlds theorist can resist this by denying the antecedent, holding that normativity attaches to branch-relative facts and needs no privileged actual outcome. The Map does not claim to refute that position on its own terms; it notes that the move runs counter to the Map's commitment to indexical identity and is honestly flagged as a boundary disagreement, not a demonstration.
...
- [voids-between-minds](/voids/voids-between-minds/) — Why the gap between individual minds persists even in tightly coupled groups
...
- [ai-moral-agency-and-the-responsibility-gap-under-dualism](/topics/ai-moral-agency-and-the-responsibility-gap-under-dualism/) — The culpability parallel: why, on the Map's reading, a corporation is no more a terminus for blame than an autonomous machine is
