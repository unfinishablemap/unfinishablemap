...
The Map offers candidate underlying principles rather than leaving the legislation point brute. [bi-aspectual-ontology](/concepts/bi-aspectual-ontology/) proposes that structure and actuality are co-fundamental aspects of one reality, so a governing law relating them is a constraint linking two faces of the same underlying nature rather than a relation across an ontological chasm. The interface model anchors this further: psychophysical laws are local prescriptions at sites of neural quantum indeterminacy where the two aspects already share a contact surface. Neither principle eliminates the cost—the relating-law itself remains primitive—but they narrow *where* and *how* cross-domain legislation operates rather than leaving it freestanding.
...
The problem is immediate. Phenomenal redness has an intrinsic qualitative character not exhausted by any behavioural or functional profile. This is the [knowledge argument](/concepts/knowledge-argument/): Mary learns something new when she sees red for the first time, even though she already knew every dispositional fact. If [qualia](/concepts/qualia/) were pure dispositions, there would be nothing left to learn.
...
If consciousness has genuine causal powers, those powers have a dispositional structure: consciousness is *disposed* to bias certain quantum outcomes when triggered by quantum indeterminacies in appropriate neural systems—what the Map calls the [interface](/concepts/brain-interface-boundary/). The manifestation is a shift in which quantum outcome actualises. Reducing consciousness to this disposition alone would collapse into pandispositionalism; the qualitative aspect remains, identical with the dispositional aspect rather than absorbed into it.
