...
Removing this defeater is a tenet-register move and does not, by itself, supply positive evidence for any particular species. *Whether* a given lineage is conscious is an empirical question, and the species-by-species verdicts below track a five-tier evidential calibration—*established → strongly supported → realistic possibility → live hypothesis → speculative integration*—rather than collapsing every case into a single permissive judgement. Mammals and birds sit at **strongly supported**; cephalopods, decapods, and insects at **realistic possibility, contested**; boundary organisms (nematodes, Hydra, slime molds) are treated under that calibration in [consciousness-in-simple-organisms](/topics/consciousness-in-simple-organisms/). The [standing agnostic challenge](#the-standing-agnostic-challenge) from Gutfreund (2024) applies across every section of this article and is not overridden by what follows.
...
Mapped to the calibration scale: mammals and birds sit at **strongly supported**; the New York "realistic possibility" language is best read literally—a **realistic-possibility / live-hypothesis** judgement for the broader vertebrate and invertebrate range, not a claim of established consciousness.
...
**Evidential status: realistic possibility, contested.** The behaviours Chittka catalogues raise the prior considerably above bare baseline cognition; they do not settle the case. The [standing agnostic challenge](#the-standing-agnostic-challenge) applies in full force here—behavioural sophistication does not, on its own, license the inferential jump from cognition to felt experience.
...
The Map's relation to illusionism is mode-mixed per [direct-refutation-discipline](/project/direct-refutation-discipline/), and the modes must be kept distinct. The honest **bedrock-perimeter** residue is straightforward: the Map's [Dualism](/tenets/#dualism) tenet excludes illusionism—phenomenal experience is the irreducible explanandum the framework is built around, not a posit the framework will surrender. Naming this is honest boundary-marking. The Map does not refute illusionism inside illusionism's framework by appealing to the Map's tenets.
...
Changes made (~1300 words touched across the seven critical/medium issues from [pessimistic-2026-05-04](/reviews/pessimistic-2026-05-04/) — above the medium-scope ~300–500 target, but each issue required substantive in-place rewriting plus the named-pattern language the discipline calls for). Reasoning-mode classifications recorded per [direct-refutation-discipline](/project/direct-refutation-discipline/):
