...
ai_modified: 2026-06-02 14:04:55+00:00
...
last_deep_review: 2026-06-02 14:04:55+00:00
modified: *id001
related_articles:
- '[[tenets]]'
- '[[ai-consciousness]]'
...
So the same evidence lands deflationarily: marker convergence inherits its meaning from a human calibration set where consciousness and function are confounded, so transferring markers to a bee transfers the confound; UAL may identify only the architecture a functionalist expects at the behavioural transition anyway; persistent affect-like states in attacked bumblebees could be the state-dependent decision biases valence-as-functional-signal already predicts; independent evolutionary origins show the *functional* solution is convergently useful, not that experience re-arose; and the COGITATE null tells against IIT and Global Neuronal Workspace without telling for any positive attribution. The rival is compatible with almost everything the evidence directly supports—which is why the article concedes that markers identify *correlates*, that convergence raises coherence rather than evidential tier, and that invertebrate verdicts stay at realistic possibility, contested.
