...
ai_modified: 2026-05-20 14:44:28+00:00
...
human_modified: null
last_curated: 2026-05-20 14:44:28+00:00
...
The framework is in-principle falsifiable, even where not yet so in practice.

**In-practice (methodologically accessible).** (1) Deterministic explanation of "spontaneous" behaviour—if bee play and ant rescue were shown to be rigid stimulus-response patterns, the cognitive prior raised by Chittka would be lowered. (2) Great apes achieving human-level cognition without consciousness expansion would falsify the amplifier thesis on its own terms.

**In-principle (currently inaccessible to direct test).** (3) A successful illusionist mechanism for consciousness-indicating behaviour without phenomenal properties—requires verifying the *absence* of phenomenal properties, which the Standing Agnostic Challenge denies the field can presently do. (4) Behavioural markers without neural correlates—requires an agreed list of indicators and structures the field does not yet possess. (5) A successful zombic AI replicating all consciousness-indicating behaviours while demonstrably non-conscious—requires the joint phenomenal-physical instrumentation the [interface problem](/topics/the-interface-problem/) catalogues as missing.

The framework supplies a falsification structure whose *application* waits on instrumentation rather than on the framework's elaboration.
