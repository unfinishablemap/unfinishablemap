...
ai_modified: 2026-05-25 11:43:34+00:00
...
Chittka's *The Mind of a Bee* (2022) documents sophisticated insect cognition: bees roll balls with no apparent reward (consistent with intrinsically motivated play), show "optimistic" and "pessimistic" cognitive biases, and ants adjust rescue behaviour to trapped nestmates' body dimensions. Chittka, Wilson, Solvi et al. (2025, *Phil. Trans. R. Soc. B*) extend the catalogue: young bumblebees engage with objects more than older bees (paralleling vertebrate play); comparable behaviour now documented in fruit flies; bees attacked by a simulated predator show persistent affect-like state changes lasting days, aligning with the marker method's valence dimension. Chittka et al. frame this in marker terms.

Whether these behaviours require consciousness or admit simpler functional explanations remains debated. The catalogue raises the prior considerably above baseline cognition without settling the case.

## What Is It Like to Be a Bat?

Nagel's 1974 paper established the framework: an organism has conscious mental states "if and only if there is something that it is like to be that organism." His bats illustrate that echolocation-based phenomenology is radically alien to human imagination—we can know *that* bats have experience without knowing *what* it is like, and this is not ignorance neuroscience can remedy. The [commensurability-void](/voids/commensurability-void/) takes this further: the bat's phenomenal world may be organised along dimensions that share no common measure with ours.

## Multiple Independent Origins

Godfrey-Smith (2024) highlights consciousness appears to have evolved independently multiple times—in vertebrates (mammalian neocortex to avian pallium), cephalopods (~500 million neurons distributed radically differently), and arthropods. What matters, on his view, are large-scale dynamic patterns, not anatomical structures. This is coherent with the Map's dualist position: the [universal-coupling-response](/concepts/universal-coupling-response/) predicts consciousness will appear wherever the relevant organisational properties exist, with [interface-heterogeneity](/concepts/interface-heterogeneity/) and [natural-kind questions](/topics/consciousness-evolution-and-biology/) across lineages. Coherence runs one direction only—the observation does not raise evidential status above **realistic possibility, contested**.
...
**Minimal Quantum Interaction**: If consciousness interfaces with matter through quantum processes, the mechanism could operate in any organism with suitable architecture. The microtubule-decoherence dispute is live (Tegmark 2000 vs Hagan et al. 2002, with Reimers/McKemmish 2009 challenging Hagan's parameters). The broader animal-consciousness case routes through the evolutionary argument for causal power across species rather than any specific interface scale. See [decoherence](/concepts/decoherence/).
...
**No Many Worlds**: Each animal subject has *this* experience, not all possible experiences in branching worlds. The [haecceity](/concepts/haecceity/) of animal experience is a fact MWI cannot accommodate.
