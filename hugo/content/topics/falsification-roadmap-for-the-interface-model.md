...
*Decisive*: Demonstration that quantum coherence is physically impossible in all biological neural systems, under all conditions, at all timescales relevant to neural processing. If no quantum indeterminacy exists in neural tissue for consciousness to exploit, the tenet fails.

*Strong*: Proof that quantum indeterminacy plays no functional role in neural computation—that classical noise fully accounts for all neural stochasticity. If the brain is effectively classical, there are no indeterminate outcomes for consciousness to bias.
...
| Minimal Quantum Interaction | Mechanism hypothesis | High | Active experimental programmes |
...
The Map should not pretend this asymmetry does not exist. The quantum-level tenets generate genuine experimental predictions. The dualism commitment does not—but neither does any competing theory of consciousness generate decisive predictions about whether experience is reducible. The honest position is: the Map is partially testable, partially a framework choice, and the testable parts are under active investigation.
