...
The first component to disengage is voluntary attention. Sustained focus becomes effortful, then impossible. Thoughts begin to drift without executive direction—the [default-mode-network](/concepts/default-mode-network/) assumes dominance as the executive control network withdraws. The phenomenology is distinctive: you notice thoughts arriving unbidden, following associative rather than logical paths. Consciousness continues here; it has simply lost one of its primary tools.
