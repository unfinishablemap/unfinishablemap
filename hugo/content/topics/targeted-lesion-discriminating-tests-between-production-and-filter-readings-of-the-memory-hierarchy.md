...
The clinical literature contains several near-discriminating cases. None is decisive, but each constrains the design space.
...
These limitations are practical contingencies rather than in-principle barriers, but they bound what the catalogue can presently claim: the existing clinical literature is consistent with both readings and does not yet contain the dissociation pattern that would discriminate them.
...
These three pairings are candidate-rich rather than exhaustive — selected because existing functional-neuroimaging convergence on the autonoetic role of the named regions makes the design tractable and because the relevant perturbation modality has reached the technological maturity to deliver the test in humans.
