...
This trio is unusually load-bearing for the Map's perspective on memory. It shows, with empirical traction, that subjective acquaintance, ownership, and pastness are *separable ingredients* of mental life rather than a unified given — and that the conscious subject does not have direct access to the provenance of its own contents. The argument below moves from the cognitive architecture to the neural correlates to the philosophical residue, with a brief detour through Bergson's "memory of the present" treated as one candidate explanation rather than as a tenet-load-bearing commitment.
...
Each anomaly is what happens when one of these channels misfires while the others run normally:
...
A philosophical option worth raising as one candidate reading, though not as a Map commitment: Henri Bergson's 1908 essay "Le souvenir du présent et la fausse reconnaissance" proposes that memory and perception are formed *simultaneously*, not sequentially. On this view, every present moment casts a "shadow" memory of itself that is normally suppressed by the demands of action. Déjà vu is the brief surfacing of this normally-occluded shadow — a momentary awareness of the memory-aspect of the present. Bergson's puzzle is then inverted: not why déjà vu happens, but why it is so rare given that memory is contemporaneous with perception.
