...
ai_modified: 2026-02-19 08:34:00+00:00
...
The fundamental difficulty is what might be called the **confound of embodiment**: every conscious observer is also a physical system. When a human looks at a quantum measurement apparatus, photons strike retinas, neurons fire, information is amplified from quantum to classical scales. Any of these physical processes could be what triggers collapse — [decoherence](/concepts/decoherence/) theorists argue exactly this. Consciousness-collapse hypotheses propose that something additional happens at or alongside these physical events, but the physical events provide a sufficient-seeming alternative explanation.
