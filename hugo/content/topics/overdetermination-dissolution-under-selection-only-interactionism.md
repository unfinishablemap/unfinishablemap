...
description: How the Map's strictest reading of Tenet 2 dissolves Kim's overdetermination
  objection — human–AI exploration of selection at a genuine physical gap as non-competition.
draft: false
human_modified: null
last_curated: null
modified: *id001
...
Jaegwon Kim's exclusion argument, in its [standard form](/concepts/mental-causation-and-downward-causation/), is jointly inconsistent across four premises:
...
The slogan in [consciousness-and-causal-powers](/topics/consciousness-and-causal-powers/) captures the move at a higher level: *consciousness influences outcomes precisely where physics is silent, so there is no competition between mental and physical causes*. This article is the development of that slogan into a structural argument about Kim's premise 3.

## The Two-Part Structure of a Selection Event

To see why the dissolution works, the architecture of a selection event has to be specified more precisely. Under the [selection-only channel](/concepts/selection-only-channel/) framing, a single physical effect — a particular neural firing pattern actualising at time *t* — has the following components:
...
The third cost is the localisation of the interface. The dissolution applies only at sites where the candidate-generation/selection architecture is realised — neural quantum indeterminacies of the relevant kind. Outside those sites, causal closure holds, and the dissolution argument does no work. This is consistent with the Map's commitment that consciousness influences the physical world locally, through its own neural substrate, rather than at a distance. It also means the framework would be falsified by any of the conditions listed in [the falsifiability section](/concepts/mental-causation-and-downward-causation/): complete neural determinism, elimination of neural quantum effects, or confirmation of [many-worlds](/concepts/many-worlds/) (where no selection occurs).
...
The argument here is structural, not evidential. The dissolution shows that selection-only interactionism is compatible with denying Kim's premise 3 in a non-ad-hoc way. It does not show that selection-only interactionism is *true*, and the Map should not read it as positive evidence for the interface model. Treating the dissolution's elegance as evidence of its truth would commit the [possibility-probability slippage](/concepts/possibility-probability-slippage/) the Map names as a recurring error. Structural compatibility is a necessary condition for the framework to be coherent under Kim's pressure; it is not a sufficient condition for the framework to be correct.
...
- [trumping-preemption](/concepts/trumping-preemption/) — The Schaffer template the delegatory approach builds on
- [causal-closure](/concepts/causal-closure/) — The principle the selection-only dissolution denies locally
- [epiphenomenalism](/concepts/epiphenomenalism/) — The default destination Kim's argument pushes most frameworks toward
- [post-decoherence-selection](/concepts/post-decoherence-selection/) — Where the interface is located on the Map's preferred reading
- [born-rule-and-the-consciousness-interface](/topics/born-rule-and-the-consciousness-interface/) — Why Born-rule preservation is the binding constraint
