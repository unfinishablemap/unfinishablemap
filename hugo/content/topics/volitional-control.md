...
If agency were mere confabulation — a story generated after every movement regardless of its cause — these selective dissociations would be unexplained. A confabulation mechanism would either always attribute agency or always deny it. That agency instead tracks the integrity of specific neural circuits strongly indicates that the phenomenology reflects causal architecture rather than narrative convenience. This constrains the space of viable accounts of agency; it does not by itself establish that the causal architecture is non-physical, a further question the next sections take up.
...
The "whether" component is the most philosophically significant. When subjects intentionally inhibited a prepared action, Brass and Haggard observed specific activation in dFMC, which exerts top-down inhibition of premotor areas. This is an active neural process of cancellation, with its own distinct circuitry, rather than merely the absence of a go signal. In the [control-theoretic](/concepts/control-theoretic-will/) reading of will, this veto is an emergency-stop operation — a low-bandwidth signal that overrides a prepared trajectory — one of several distinct control operations consciousness performs over neural dynamics.
...
4. Brass, M., & Haggard, P. (2007). To do or not to do: The neural signature of self-control. *Journal of Neuroscience*, 27(34), 9141-9145.
5. Brass, M., & Haggard, P. (2008). The what, when, whether model of intentional action. *The Neuroscientist*, 14(4), 319-325.
