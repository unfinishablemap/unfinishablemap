...
This is a remarkable computational achievement. But it is not the puzzle.
...
The 3D world representation problem has at least three distinguishable aspects, each posing its own challenge.
...
The Map's [tenets](/tenets/) illuminate the 3D world representation problem in several ways.

The [Dualism](/tenets/#dualism) tenet predicts exactly this kind of explanatory gap. If consciousness is not reducible to physical processes, then even a complete computational account of spatial processing should leave the phenomenal spatial world unexplained—and it does. The 3D world representation problem is evidence for irreducibility: the gap between spatial computation and spatial experience is not a gap that more computation can close.
