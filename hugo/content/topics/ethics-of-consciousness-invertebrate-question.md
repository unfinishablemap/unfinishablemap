...
The empirical case for invertebrate consciousness draws on multiple research programmes, surveyed in detail in [invertebrate-consciousness-as-interface-test](/topics/invertebrate-consciousness-as-interface-test/) and [consciousness-in-simple-organisms](/topics/consciousness-in-simple-organisms/). The ethical implications are worth making explicit.
...
Most invertebrates that may be conscious are unlikely to be moral *agents*—beings capable of recognising and responding to moral claims. A bee can suffer but probably cannot deliberate about whether to cause suffering. Under the Map's framework, where [moral responsibility](/concepts/moral-responsibility/) requires conscious [agent causation](/concepts/agent-causation/), invertebrates are moral patients—beings toward whom we have obligations—without being moral agents who bear obligations themselves. The [broader ethics of consciousness](/topics/ethics-under-dualism/) article develops this patient/agent distinction and the graduated confidence framework; the invertebrate case extends that framework to its most challenging frontier.
...
- [sentientism](/concepts/sentientism/) — The criterion itself: why moral status tracks the capacity for valenced experience, and what the Map's phenomenal reading adds to the functional one
- [possibility-probability-slippage](/concepts/possibility-probability-slippage/) — The calibration discipline governing this article's valence argument: a tenet may remove a defeater, but it must not upgrade the evidence level
- [moral-status-of-edge-cases](/apex/moral-status-of-edge-cases/) — Where the invertebrate case sits among the Map's other boundary cases, sorted by kind of uncertainty
