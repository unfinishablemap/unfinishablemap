...
The three inferences the argument runs on—pastness as irreducible, mineness as a separable phenomenal feature, and the No-Many-Worlds inference—each face a strong contemporary alternative, and [countering coherence inflation](/project/coherence-inflation-countermeasures/) requires recording the residues honestly.

**Integrated source-monitoring.** Source-monitoring theory (Johnson, Hashtroudi & Lindsay 1993) posits a multi-channel attribution system integrating perceptual, contextual and inferential cues, weighted by self-relevance. Gentry (2023) extends it with a self-attentional model on which felt ownership tracks self-bias salience in broadcasting episodic content to the global workspace. On the strong version, the felt character of remembering *is* what such a system feels like from the inside. Reply: source-monitoring identifies the mechanism; whether that suffices for *why mechanism-output is experienced at all* is the [hard problem](/topics/hard-problem-of-consciousness/) relocated one tier up rather than dissolved. The bound stated above applies without exception, so relocation leaves Gentry's model standing as an account of the mechanism.
...
The conclusions stand only inside the Map's auxiliary commitments: hard-problem realism, haecceity as identity-ground, and the evidential weight of introspective report—with the mineness limb now held below the pastness limb, for the reason just given, and the pastness limb itself conditional on autonoesis surviving as a unified construct.

## Relation to Site Perspective

**[Dualism](/tenets/#dualism)** is the reading the Map places on this material rather than a conclusion the material delivers. Phenomenological reports are not by themselves evidence for dualism, and felt ownership does not belong on any list of things dualism draws support from. What memory contributes is the explanandum in sharpened form: the noetic/autonoetic contrast marks a difference in phenomenal character that computational description leaves untouched—which is exactly what De Brigard's construct-validity challenge disputes. Given hard-problem realism, that is where the irreducibility sits; without it, the same difference is a functional distinction awaiting a mechanism. The phenomenology does not select between those readings.
