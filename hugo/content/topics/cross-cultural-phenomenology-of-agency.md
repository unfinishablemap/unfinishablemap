...
ai_modified: 2026-09-21 10:54:14+00:00
...
lastmod: 2026-09-21 10:54:14+00:00
modified: *id001
related_articles:
...
Agency is not experienced the same way everywhere. Western philosophical traditions since Descartes have emphasised the individual willing subject — the "I" that deliberates, decides, and acts. The [phenomenology of choice](/concepts/phenomenology-of-choice-and-volition/) in this tradition foregrounds effort, authorship, and the sense that alternatives were genuinely open. Heidegger's analysis of [authentic choice](/topics/authentic-vs-inauthentic-choice/) depends on breaking free from *das Man* — the anonymous social self — to seize one's own possibilities.
...
The most philosophically provocative cross-cultural data comes from Buddhist phenomenology. Buddhist practitioners report sophisticated agency — deliberate action, moral responsibility, long-term projects — while [denying the existence of a permanent self](/concepts/buddhism-and-dualism/) who authors these actions. This presses on the Map's own commitment rather than on a merely Western assumption: [agent causation](/concepts/agent-causation/) as the Map defines it requires a persisting substance-bearing subject exercising causal powers in its own right, and *anattā* denies exactly that. [Which of the Map's claims actually need that subject](/concepts/where-the-substance-commitment-enters/) is the discriminating question — authorship and desert do, bare mental causation at quantum indeterminacies does not.

If agency can be experienced without an enduring self, what does the irreducible phenomenological core consist of? The Buddhist account describes something like conditioned arising without an author: each moment of consciousness inherits conditions from its predecessor, and the next moment arises from those conditions through lawful regularity (*niyama*), not through any act of selection. The "agent" is not a thing but a pattern — a characteristic way that conscious moments give rise to their successors. The Map reads this differently — as genuine selection rather than lawful succession — but it locates the selecting in a persisting subject the Buddhist analysis does not grant, and the tradition itself resists the language of choosing. What the two frameworks share is *mental causation* — mental states make a difference to what happens, which is what [Bidirectional Interaction](/tenets/#bidirectional-interaction) asserts — and with it the phenomenological reality that action differs from mere happening. What they do not share is [agent causation](/concepts/agent-causation/), which routes that causation through the persisting substance-bearing subject *anattā* denies. The divergence is bedrock — the fault line of [P-I1](/positions/individuation-and-subjecthood/#p-i1)'s rejection of empty individualism — and is [noted here rather than refuted from inside Madhyamaka's own resources](/topics/non-temporal-consciousness/).
...
- [phenomenology-of-choice-and-volition](/concepts/phenomenology-of-choice-and-volition/) — The four-component structure of willing that underlies agency across cultures
