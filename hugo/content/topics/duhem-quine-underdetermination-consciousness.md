...
1. **Theory-ladenness of neural data.** What counts as a "neural correlate of consciousness" depends on which theory defines the relevant contrast. IIT looks for integrated information in posterior cortex; GWT looks for global broadcast to prefrontal areas. The same brain scan supports different claims depending on which theoretical lens interprets it. This is an instance of the broader [framework dependence](/topics/phenomenology-of-conceptual-frameworks/) that pervades consciousness research—frameworks do not merely organise evidence but determine what counts as evidence.
