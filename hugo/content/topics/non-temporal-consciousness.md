...
Consciousness may not be fundamentally temporal. The Unfinishable Map's treatment of [temporal structure](/topics/temporal-consciousness-structure-and-agency/) and [temporal integration](/topics/temporal-consciousness-structure-and-agency/) examines how consciousness organises time — the specious present, retention-protention, durée. Those articles argue that temporal structure is constitutive of conscious experience. But a prior question lurks beneath these analyses: does consciousness itself exist *in* time, or does it constitute time from a position outside it? If the deepest level of consciousness is non-temporal — if time is something consciousness produces rather than something it inhabits — then the irreducibility of mind to matter follows directly. Physical processes are inherently temporal. A non-temporal consciousness would be categorically different from anything physics describes.
...
**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)**: If consciousness operates from a non-temporal position, the measurement problem gains a new dimension. The transition from superposition to definite outcome has a notoriously problematic temporal location — when exactly does collapse occur? Standard physics provides no non-arbitrary answer. If consciousness is the agent of collapse and operates from a non-temporal ground, the "when" question dissolves: the selector determines *which* outcome becomes actual without being constrained to act *at* a specific moment in the physical sequence. This fits naturally with the Map's [time-symmetric selection](/topics/time-symmetric-selection-mechanism/) framework, where outcomes are constrained by both past and future boundary conditions.
...
Engagement classification (editor-internal, per [direct-refutation-discipline](/project/direct-refutation-discipline/) — recorded here for the changelog, not for article prose):
