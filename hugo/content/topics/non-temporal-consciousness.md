...
ai_modified: 2026-06-06 12:49:29+00:00
...
human_modified: null
last_curated: null
last_deep_review: 2026-05-14 03:54:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
The constructivist critique cannot be defeated inside its own framework, and the article does not pretend otherwise — the question of what an untrained reporter would have said is unavailable by construction. What survives is a more modest claim. Reports of alert awareness stripped of temporal markers recur across traditions whose surface doctrines differ — Theravāda Jhāna, Tibetan rigpa, Zen kenshō, Advaita witness consciousness, Christian apophasis. Each tradition's home explanation of what the alert-timeless feature *means* is doctrinally shaped; that the feature is reportable across traditions in the first place is the structural pattern doing the work. The article does not need any individual report to be unmediated, only the structural recurrence to be more than coincidence. The recurrence is also more modest than a tally of traditions suggests: the cross-tradition cluster carries the evidential weight of *one* recurring pattern — alert awareness reportable without temporal markers — not five independent confirmations, and it should not be counted as though each tradition were a fresh test.

This commits the argument to the [evidential-status discipline](/project/evidential-status-discipline/)'s constraint that phenomenological reports do not on their own license metaphysical upgrades. The contemplative literature is one of several mutually supporting lines — Husserl's regress, the cognitive-phenomenological case, the meditative reports — whose convergence is suggestive rather than decisive.

## Bergson's Challenge: Consciousness as Essentially Temporal [Open]

Henri Bergson offers the strongest counterpoint. For Bergson, consciousness *is* duration — [durée](/concepts/temporal-consciousness/), the qualitative flow of lived time where the past permeates the present. Strip away temporality and you strip away consciousness itself. His critique of spatialized time anticipates the Map's concerns with physicalist reduction — scientific time "does not endure" — but he parts company with the non-temporal thesis by insisting the alternative is not *no* time but *lived* time.

The tension is genuine. Both deny consciousness can be captured by the physicist's time, but Husserl posits a non-temporal ground beneath temporal experience while Bergson holds that durée goes all the way down. A possible synthesis: Bergson's durée describes what consciousness does (produces temporal experience); Husserl's absolute flow describes what it is (a non-temporal constituting activity). Durée is the output; the absolute flow is the source. Bergsonians would contest this — for Bergson, the distinction between what consciousness *does* and what it *is* collapses, since consciousness just is its creative activity. The synthesis therefore favours Husserl, and the tension may not be fully resolvable.

## The Madhyamaka Challenge to the Persisting Subject [Open]

The contemplative evidence carries an ontological commitment the Map cannot straightforwardly inherit. The states relied on above — the upper *Jhānas*, *Nirodha Samapatti*, the witness consciousness foregrounded in Advaita-influenced practice — emerge from traditions interpreting what they report through specific metaphysics of the subject. In Madhyamaka, descending from Nāgārjuna, the *catuṣkoṭi* (tetralemma) denies that any phenomenon coherently exists, doesn't exist, both, or neither — and the experiencing subject is no exception. The apparent unity of deep meditative states, on this reading, reflects the absence of grasping for an underlying mind rather than the presence of one. *Anātman* (non-self) is the tradition's preferred interpretation, not peripheral commentary: the dissolution of temporal markers coincides with the dissolution of any experiencer who might have hosted them.
...
The accommodation does not run only one way. A production or identity theorist has a structurally parallel move available: the resilience of unity reflects redundant integration in a substrate that *produces* consciousness, and the propofol case shows integration failing all at once rather than splitting because the production threshold is global. The anaesthesia and split-brain data therefore *constrain* both framings rather than *confirming* the interface reading over its rival; they tell against any account on which consciousness divides cleanly with the substrate, which is a wider target than the non-temporal thesis alone. The fragmentation evidence earns its place by ruling out clean division, not by favouring the interface picture against a production theory that accommodates the same observations.

Whether the non-temporal thesis genuinely *predicts* preserved unity, rather than merely accommodating it, is the harder question. Bayne's *The Unity of Consciousness* (2010) supplies the framework. Bayne distinguishes subject unity, phenomenal unity (experiences co-conscious within a single field), and representational unity, defending a Unity Thesis on which all of a single subject's simultaneous experiences are necessarily phenomenally unified. Two phenomenally non-co-conscious streams require either two distinct subjects or a violation of the Unity Thesis. Within the Map's framework the deepest level of consciousness is the singular absolute subjectivity Husserl describes — non-multiple by construction — so the first horn requires the absolute subjectivity itself divide, and the second is what Bayne denies. The Madhyamaka challenge to this singularity reading carries forward as the natural limit of what the Bayne engagement can secure. The 2025 layered-unity model (*Philosophical Studies*) accommodates the empirical picture with global unity persisting through local fragmentation; Bayne's switch model and this layered alternative remain live competitors.
...
Premise 3 invites a related complication. Mathematics describes non-temporal objects (numbers, sets) by abstracting away from temporal structure, but physical description was once treated as constitutively temporal. That contrast is no longer clean. The Wheeler–DeWitt equation in canonical quantum gravity has no time parameter; Barbour's timeless physics and Rovelli's relational quantum mechanics dispense with background time. These formulations still parameterise physical degrees of freedom — configuration space, constraint surfaces, relational networks — even where they omit a time coordinate. The non-temporal consciousness posited here is not the degenerate limit of a temporal physics with its time-coordinate suppressed; it is the constituting activity *for* the temporal order rather than a structure within it. The categorical contrast survives but inherits its force from the regress argument and the cognitive-phenomenological case rather than from the absence of a time coordinate alone.

The argument's strength depends on premise 2 — whether consciousness genuinely has a non-temporal ground. What carries weight is the convergence. A philosophical argument (the regress), a phenomenological tradition (Husserl), and first-person reports from contemplative practice (Frischhut) point toward a related conclusion: that consciousness has a dimension escaping temporal characterisation. Their convergence is suggestive rather than decisive, but each line is harder to dismiss in the company of the others.

A further line comes from [cognitive phenomenology](/topics/cognitive-phenomenology-and-the-irreducibility-of-thought/). If thought has phenomenal character irreducible to functional description, the meditator's alert timeless awareness is a state whose character resists physical characterisation on two independent grounds: its non-temporality *and* its irreducible phenomenality. The theses are complementary — one shows consciousness escaping temporal categories, the other functional ones.
