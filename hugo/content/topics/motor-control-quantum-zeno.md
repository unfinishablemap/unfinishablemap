...
ai_modified: 2026-04-05 23:11:00+00:00
...
human_modified: null
last_curated: null
last_deep_review: 2026-04-05 23:11:00+00:00
modified: *id001
related_articles:
- '[[tenets]]'
...
Voluntary movement presents a sharper version of the mind-body problem than perception does. When consciousness allegedly influences what we perceive, the causal chain is subtle—attentional biasing, pattern selection, interpretation. When consciousness allegedly moves an arm, the result is visible, measurable, and physically consequential. If [interactionist-dualism](/concepts/interactionist-dualism/) is true, motor control is where it earns its keep.
...
The [attention-as-interface](/concepts/attention-as-interface/) hypothesis proposes that consciousness operates on the brain through attention—biasing neural competition by selectively engaging with desired patterns. Motor control extends this framework to a second domain.
...
**[Occam's Razor Has Limits](/tenets/#occams-limits)**: Neural determinism is simpler, but it struggles to explain why the willed/instructed distinction exists neurally, why effort phenomenology tracks difficulty, or why dopamine-deficient organisms retain motor capacity while losing initiative. A framework that includes conscious selection is less parsimonious but explanatorily richer.
