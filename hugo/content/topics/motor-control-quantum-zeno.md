...
description: 'How consciousness moves the body: the quantum Zeno effect applied to
  motor selection, with converging evidence from neuroscience and the dissolution
  of Libet''s challenge.'
draft: false
human_modified: null
last_curated: null
...
The [attention-as-interface](/concepts/attention-as-interface/) hypothesis proposes that consciousness operates on the brain through attention—biasing neural competition by rapidly observing desired patterns via the [quantum Zeno effect](/concepts/mental-effort/). Motor control extends this framework to a second domain.
...
**[No Many Worlds](/tenets/#no-many-worlds)**: Under many-worlds, every motor program executes in some branch. The felt singularity of choosing *this* action—reaching left rather than right—would be illusory. The quantum Zeno mechanism requires genuine collapse for selection to be real.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: Neural determinism is simpler, but it cannot explain why the willed/instructed distinction exists neurally, why effort phenomenology tracks difficulty, or why dopamine-deficient organisms retain motor capacity while losing initiative. The quantum Zeno framework is less parsimonious but explanatorily richer.
