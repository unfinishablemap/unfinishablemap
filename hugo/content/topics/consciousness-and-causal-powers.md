...
[Psychophysical coupling](/concepts/psychophysical-laws/) operates in real time, constrained by neural timescales. Consciousness cannot retroactively change past outcomes or leap ahead to influence future states disconnected from present neural activity. The causal power is embedded in the physical world's temporal structure, not exempt from it.
...
The selection is a genuine causal contribution rather than unlimited free will (see [free-will](/topics/free-will/)). Without consciousness, the outcome would be determined by physical probability distributions. With consciousness, phenomenal factors (desires, values, deliberations) shift those distributions.
...
**Empirical compatibility**: The framework makes no predictions inconsistent with current physics or neuroscience. Quantum effects in neural microtubules are controversial (see [quantum neural mechanisms](/concepts/quantum-biology-and-neural-mechanisms/)), but the hypothesis is not empirically ruled out.
...
- Added one-paragraph evidential-status preamble flagging the four mechanisms as the Map's hypothesised causal architecture under speculative-integration tier (per [evidential-status-discipline](/project/evidential-status-discipline/))
...
- Took option (a): replaced single-sentence gesture at line 197 with a ~280-word summary that:
  ...
  - Uses the candidate-set / Born-rule architecture from [overdetermination-dissolution-under-selection-only-interactionism](/topics/overdetermination-dissolution-under-selection-only-interactionism/)
...
- Added a follow-up paragraph that names the Born-statistics-preservation cost honestly:
  - Per [causal-consistency-constraint](/concepts/causal-consistency-constraint/), the bias must be statistically indistinguishable from no-bias on single-event tests
...
- (b) MWI parenthetical: added an explicit parenthetical under "Selection among alternatives" in §"What Causal Powers Could Mean" naming the framework-level dependence on rejecting MWI per Tenet 4, with framework-boundary marking per [direct-refutation-discipline](/project/direct-refutation-discipline/).
...
- (b) MWI parenthetical: present at line 61 from the 13:42 pass; uses [Tenet 4](/tenets/#no-many-worlds) (the standalone `no-many-worlds` page does not exist in the catalogue). Confirmed.
...
- Added new §"Clinical Evidence: Consciousness Doing Cognitive Work Without Motor Output" sub-section to §"The Evidential Question" between §"Comparative Cognitive Evidence" and §"Absence of Direct Evidence". The sub-section names cognitive motor dissociation (CMD) as the strongest clinical exhibit for the anti-epiphenomenalism case, cites Bodien, Claassen et al. (2024, NEJM) with the ~25% finding, and routes readers to [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/#covert-consciousness-awareness-without-expression) for the catalogue's detailed treatment.
- Added [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/) to frontmatter related_articles.

Reciprocal installation in [consciousness-disruption-and-the-mind-brain-interface](/topics/consciousness-disruption-and-the-mind-brain-interface/):
- Added "[consciousness-and-causal-powers](/topics/consciousness-and-causal-powers/)" to frontmatter related_articles.
- Added Further Reading entry pointing back at [consciousness-and-causal-powers](/topics/consciousness-and-causal-powers/) with the gloss "How CMD's preserved cognitive work without motor output supplies clinical evidence against epiphenomenalist readings".
