...
Neurally, Hasenkamp et al. found this shifting phase engaged elements of the executive network, including dorsolateral prefrontal cortex. The [frontal theta signature](/concepts/attention-as-interface/) of willed attention appears.

## Why the Gap Matters

The transition from Phase One to Phase Two contains a philosophical puzzle. During wandering, meta-awareness was absent. Then, without any deliberate act, meta-awareness returned. What bridged the gap?
...
**Effortless returning**: Early in practice, returning attention requires muscular effort — a sense of hauling the mind back. Later, returning becomes gentler, more like releasing a grip than forcing a shift. The [FA-to-OM progression](/concepts/meditation-and-consciousness-modes/) mirrors this: initial effortful selection gives way to a lighter mode of re-engagement.
...
The phrase "returning attention" conceals an ambiguity. What exactly returns? Several things shift simultaneously:

- **Focus**: The perceptual spotlight narrows back to the intended object
...
- **Temporal orientation**: Experience shifts from absorption in content (timeless wandering) to directed engagement (future-oriented attending) — the more profound form of alert atemporality cultivated in sustained practice is treated in [non-temporal-consciousness](/topics/non-temporal-consciousness/), where it bears on whether the deepest level of mind is constitutively temporal at all
...
3. Reorienting of attention (Phase Three)
4. Sustained focus (until the next wandering)
