...
This matters for two reasons. First, phenomenal simultaneity is constructed, not given — the felt present is a product of integration, not a transparent window onto physical simultaneity. Second, recalibration shows the perceptual system prioritises coherent output over veridical timing. That is a functional datum, and a production theorist predicts it too — a brain that builds coherent representations would recalibrate this way. So it is consistent with phenomenal unity being a primitive design constraint on consciousness, but does not by itself establish that reading over the byproduct one; the discriminating work comes from the kind-difference argument below, not the recalibration evidence alone.
...
This is the [combination-problem](/concepts/combination-problem/) in miniature: how do two impoverished experiences combine into one rich experience? Combination produces [qualitative properties](/concepts/qualia/) the components lack.
...
**BP1 progress**: Working memory maintains representations across seconds. Hippocampal replay compresses temporal sequences. [Oscillatory dynamics](/concepts/neural-refresh-rates/) at alpha, theta, and gamma create temporal windows within which events are treated as co-occurring.
...
[Autonoetic consciousness](/concepts/episodic-memory/) reveals temporal binding in its most demanding form. When you remember a childhood event, you are simultaneously present as rememberer (now) and protagonist (then). Two temporal perspectives are unified in a single experience without collapsing into one.

### 4. Cognitive Binding {#cognitive}

Beyond perception, binding operates in thought, reasoning, and language. Understanding "The cat that the dog chased climbed the tree" binds sequentially encountered words into a hierarchical structure — and the "click" when a sentence coheres resembles perceptual binding. See [language-recursion-and-consciousness](/topics/language-recursion-and-consciousness/) and [cognitive-phenomenology](/concepts/cognitive-phenomenology/).
...
The most fundamental variety: all experiences are had by a single subject. Visual perception, auditory sensation, emotional feeling, and cognitive thought do not merely co-occur — they belong to *you*.

**BP1 progress**: Self-referential processing involves midline cortical structures (medial prefrontal cortex, posterior cingulate). The default mode network maintains a sense of self across task states. Proprioceptive integration produces bodily ownership.
...
[Split-brain cases](/topics/split-brain-consciousness/) test this directly, and cut both ways. When the corpus callosum is severed, perceptual binding partially divides. Does the *subject* divide? Nagel's verdict — "too much unity to say 'two', yet too much separation to say 'one'" — is standardly read as evidence subjecthood is *divisible*, hence not the indivisible primitive the deflationist denies. The Map reads the same datum as showing phenomenal unity is more resilient than neural connectivity alone would predict. The case does not settle the dispute; it sharpens it.

## The Shared Structure

The five varieties share a common structure:

1. **Physical processes are distributed** — across brain regions, across time, across representational formats
2. **Neural mechanisms coordinate** them — through synchrony, convergence, oscillatory dynamics
...
The persistence of this gap across all five varieties is suggestive, but the inference needs care. Uniform *current* explanatory failure is equally predicted by two readings: that the gap is principled (the structural reading), and that BP2 is one hard-but-tractable reduction whose completion lies ahead in every domain. The pattern does not, on its own, discriminate between them. The Map weights the structural reading not because the failure-pattern proves it but because of the independent kind-difference argument in §Unity as Primitive below: coordination relates parts externally while unity is what makes something one experience, so the two differ *in kind*, not in degree of explanatory progress. The pattern is the symptom; the kind-difference is the reason — the same epistemic discipline the IIT discussion applies below, granting a correlation while isolating what it cannot settle.

The problem, on the structural reading, is not the details of any particular domain — it is the transition from coordinated plurality to experiential unity as such. Any successful explanation must work across all five varieties: a theory that explains perceptual binding but cannot address temporal or subject binding has explained BP1, not BP2. This is the [type-specificity](/concepts/type-specificity/) demand at the phenomenal-unity grain — each variety presents its own determinate unity-type, and a generic mechanism cannot discharge five distinct demands by addressing whatever they hold in common.

## Dissociations: BP1 Without BP2

Evidence that computational and phenomenal binding come apart strengthens the case that they are different explanatory targets.
...
Quantum entanglement provides something structurally different: on a realist interpretation, genuine holism where the whole is prior to parts. An entangled system has properties neither subsystem possesses individually — irreducible unity at the level of physics itself. (Whether entanglement is metaphysical holism or mere measurement correlation depends on interpretation; the Map adopts the realist reading.) See [quantum-holism-and-phenomenal-unity](/topics/quantum-holism-and-phenomenal-unity/) for detailed treatment.
...
The standard objection is decoherence: warm biological tissue destroys superpositions on femtosecond timescales. An internal tension compounds it. Two claims pull in opposite directions — that *entanglement provides the holism* (requiring a genuinely entangled multi-region state at the moment of collapse) and that minimal interaction only *biases a collapse already occurring* without maintaining coherence. Biasing a single collapse does not deliver the sustained cross-region coherence entanglement-carried binding would need. The honest position is open work, not a solved mechanism: either the binding-relevant entanglement is brief and locally protected — making the [coherence-lifetime question](/topics/quantum-neural-timing-constraints/) the decisive empirical test — or the holism is supplied at the moment of collapse rather than by a maintained entangled state, a possibility the framework gestures at but has not discharged. The [entanglement binding hypothesis](/concepts/entanglement-binding-hypothesis/) develops the empirical side and is held as a live hypothesis, not an established result.

### Unity as Primitive

A third approach: treat phenomenal unity as metaphysically basic rather than derived from non-unified elements. If unity is what makes something an experience rather than a feature added to experience, then BP2 is not solved by finding the right mechanism — it is a feature of what consciousness *is*. Neural binding mechanisms (BP1) condition *which* contents are unified; unity itself is contributed by consciousness. This is the kind-difference the §Shared Structure inference rests on: coordination relates parts externally, unity does not, so the persistent gap is principled rather than a not-yet-completed reduction. See [binding-problem](/concepts/binding-problem/) for extended discussion.
...
**[Bidirectional Interaction](/tenets/#bidirectional-interaction)**: Binding is not passive. [Phenomenal attention](/concepts/attention-as-interface/) — the felt directedness of consciousness, distinct from computational resource allocation — shapes what gets bound. Voluntarily shifting attention between modalities alters which binding configuration consciousness selects. The fact that [effortful attention](/concepts/mental-effort/) shapes which streams unify suggests top-down causation from phenomenal states to neural coordination, connecting to [free will](/topics/free-will/): consciousness actively selects among possible unified experiences rather than passively registering whatever the brain presents.

**[No Many Worlds](/tenets/#no-many-worlds)**: The systematicity of binding — that *this* configuration of contents is unified in *this* way — is something the Map reads as requiring real collapse. In many-worlds, every possible binding occurs in parallel branches, and the fact that I experience *this* configuration receives the standard indexical treatment MWI gives every such fact. The Map rejects that treatment on tenet grounds — indexical identity matters, and a theory on which every binding is equally realised does not, for the Map, answer why *this* one is mine. This is a framework-boundary disagreement, honestly noted as such rather than a refutation of MWI on its own terms: the defender can consistently hold their position, and the Map's reason for declining it is the prior commitment, not an internal contradiction.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: Five varieties of the same gap is a pattern, not five coincidences. The temptation is to assume explaining BP1 in each domain will automatically explain BP2. The systematicity of the failure suggests the gap is principled, not a matter of insufficient progress. Apparent simplicity (just solve coordination) conceals genuine complexity (unity is not coordination).

## What Would Challenge This View?

The treatment here rests on claims that could be undermined:

- **A reductive explanation of any BP2 variety** that made phenomenal unity *intelligible* from the neural mechanism rather than merely correlated with it would weaken the argument from structural persistence. The vitalism analogy — multiple seemingly irreducible phenomena dissolving under a single framework — is the template for such defeat.
- **A computational model predicting conjoint phenomenology** — predicting not just *that* audiovisual stimuli bind but *what the unified percept is like* — would narrow the BP1/BP2 gap.
- **Inverse effectiveness proving purely informational** — if combined-weak vividness were just increased Bayesian confidence — would dissolve the combination-problem parallel.
- **Temporal recalibration symmetrical with unconscious processing** — if subliminal cross-modal stimuli recalibrated identically to conscious perception — would weaken the claim that recalibration reflects a design constraint on *consciousness* specifically.
- **The identity move achieving explanatory adequacy** — "synchrony = unity" defended as strongly as "water = H₂O" — would reclassify the BP2 gap as epistemic rather than ontological.
- **Evidence against quantum holism in the brain** at relevant scales would cut the proposed bridge between physics and phenomenology, though the philosophical argument for unity as primitive would remain.

## Further Reading

- [binding-problem](/concepts/binding-problem/) — Foundational concept: BP1/BP2 distinction, quantum holism
...
- [neural-refresh-rates](/concepts/neural-refresh-rates/) — Oscillatory sampling and the smoothness problem
