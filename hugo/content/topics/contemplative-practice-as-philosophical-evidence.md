...
**Constraint on theory.** The cross-traditional discovery that the narrative self can be experientially deconstructed constrains theories of personal identity. Progressive disclosure of temporal microstructure constrains theories of [temporal-consciousness](/concepts/temporal-consciousness/).
...
Every tradition discovers that the untrained mind is dominated by involuntary thought — Buddhist "monkey mind," Christian *recollectio*, Hindu *vrittis*. The neural correlate is the default mode network (DMN), which shows reduced activity during meditation (Brewer et al. 2011). Involuntary mentation is a structural feature of consciousness that any systematic self-observation reveals.
...
Traditions describe progressions of states with structural similarities despite different terminologies: Buddhist jhāna (eight absorptions), Hindu samādhi (*savitarka* through *nirbīja*), Teresa of Ávila's seven mansions. A 7-Tesla fMRI case study found jhāna states showed disrupted hierarchical brain organisation, increased global connectivity, and increased brain entropy (Demir et al. 2025). The shared structure — progressive absorption, reduced self-reference, altered time perception, boundary dissolution — recurs across traditions with no knowledge of one another's maps.
...
A fourth divergence calibrates how much the convergence argument can carry: [affective-tone-divergence-across-meditative-traditions](/topics/affective-tone-divergence-across-meditative-traditions/) documents that traditions report incompatible *emotional* tones at their depths, bounding any inference from structural convergence to a single shared phenomenology.
...
First, theory-ladenness applies to all philosophical methods. If it disqualifies contemplative methods, it disqualifies the entire philosophical toolkit.
...
**What would weaken these claims:** If apparently independent traditions share a common source (reducing convergence to transmission), or if contemplative reports consistently fail to predict neural signatures.

The separation of structural finding from metaphysical interpretation is itself contested — Mādhyamaka philosophers argue that *anattā* is inseparable from *śūnyatā*, and that extracting structural findings from their framework distorts them.

### Falsifiability

The Map's position could be defeated by: reliable phenomenological prediction from neural data alone (supporting reductive materialism); identical neuroplastic outcomes from willed and passive exposure (supporting epiphenomenalism); a demonstrably narrowing explanatory gap; or a principled non-reductive physicalist account of why particular neural configurations produce particular phenomenal qualities.
...
- [neurophenomenology-and-contemplative-neuroscience](/concepts/neurophenomenology-and-contemplative-neuroscience/) — Neuroplasticity evidence and Varela's methodology
- [contemplative-epistemology](/concepts/contemplative-epistemology/) — Epistemological framework for first-person methods
