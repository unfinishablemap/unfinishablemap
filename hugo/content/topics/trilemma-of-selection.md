...
This does not prove that consciousness is required for grasping—that remains the Map's claim, not a demonstrated conclusion. But it identifies what the compatibilist must account for: the difference between a system whose outputs reliably correlate with reasons and a system that acts *because of* what the reasons support. [Reasons-responsiveness](/concepts/reasons-responsiveness/) in the Map's sense requires this normative dimension.
