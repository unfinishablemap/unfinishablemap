...
**[Bidirectional Interaction (Tenet 3)](/tenets/#bidirectional-interaction)**: The selection model reads akrasia as a case where the conscious controller's selection diverges from the agent's evaluative state—relevant to *what* the interface selects and how faithfully it tracks reasons. Whether that divergence needs a non-physical selector is exactly what akrasia does *not* settle; the phenomenon is neutral between the Map's reading and the naturalistic ones. This bears on [moral responsibility](/concepts/moral-responsibility/) only glancingly: whether akratic acts are free and blameworthy is a further question the Map defers to its dedicated treatment.

**[Occam's Razor Has Limits (Tenet 5)](/tenets/#occams-limits)**: The temptation is to declare one analysis "simplest"—Socratic reduction to ignorance, or Davidson's minimal apparatus. The Map's discipline here is to resist that move: the descriptive facts underdetermine the analysis, and simplicity is an unreliable guide when the phenomenon's very existence is contested. Holding the four positions open, rather than collapsing to the tidiest, is the honest register.

## Further Reading

- [free-will](/topics/free-will/) — The Map's broader treatment of agency and authorship
- [control-theoretic-will](/concepts/control-theoretic-will/) — Consciousness as a low-bandwidth controller that gates, stabilises, and steers
- [valence-and-conscious-selection](/topics/valence-and-conscious-selection/) — Whether value guides selection or is idle to it—the mechanism question akrasia dramatises
- [volitional-control](/topics/volitional-control/) — The first-person structure of willing, vetoing, and selecting among actions
- [moral-responsibility](/concepts/moral-responsibility/) — Whether and how authored action grounds desert
