...
description: If information is physically fundamental, consciousness may sit at the
  centre of physics, not its periphery. An interactionist case.
draft: false
human_modified: null
last_curated: null
...
The physics of information provides the strongest available framework for the Map's [interactionist-dualism](/concepts/interactionist-dualism/).
...
- [it-from-bit-and-participatory-ontology](/topics/it-from-bit-and-participatory-ontology/) — Wheeler's "it from bit" thesis, its descendants, and its critics
