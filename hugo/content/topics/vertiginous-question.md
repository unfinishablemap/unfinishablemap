...
**Ownership-based answers** reverse the order. The [ownership-void](/voids/ownership-void/) shows that the mechanism of appropriation — how experiences become *mine* — is itself structurally opaque. Indexical identity cannot be grounded in ownership when ownership presupposes the very identity in question.
