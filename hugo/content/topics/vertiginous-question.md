...
Any three are mutually consistent, but at least one must be rejected. The Map's commitments — dualism (implying first-person realism), non-solipsism, and no many worlds (one world) — force acceptance of fragmentation: not all facts about conscious experience can be integrated into a single coherent world-description. The indexical void is the formal shadow of this fragmentation. The quadrilemma does not prove the void exists, but it shows that the logical space around first-person facts is constrained in ways that make comfortable resolution unavailable.
