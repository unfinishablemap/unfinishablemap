...
Nearly all anaesthetics disrupt explicit memory formation at sub-anaesthetic doses — patients who remain conscious and responsive still fail to form lasting memories. Midazolam (a benzodiazepine) produces profound amnesia with minimal sedation, isolating the memory-encoding function almost surgically from other components. Noreika et al. (2018) showed words presented during anaesthesia were processed semantically despite no recall — the interface's sensory channels can operate below the threshold of memory consolidation. Dedicated channels for different cognitive functions, not a single on/off switch.
...
Individual variation in anaesthetic sensitivity provides further evidence of interface structure. Redheads carrying MC1R gene variants require approximately 20% more anaesthetic than average; chronic alcohol users develop cross-tolerance; some individuals show paradoxical agitation rather than sedation from benzodiazepines. If consciousness were a uniform product of neural activity, sensitivity should track brain size or metabolic rate, not specific genetic variants affecting particular receptor systems. The observed pattern — sensitivity varying with specific molecular targets — supports the structured interface model: different individuals have different interface configurations.
