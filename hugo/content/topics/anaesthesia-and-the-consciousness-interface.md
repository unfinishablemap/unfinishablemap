...
Anaesthesia does not simply switch consciousness off. Different agents disrupt different components of the consciousness-brain interface, and the pharmacological specificity of these disruptions amounts to a molecular map of how consciousness connects to neural activity. Anaesthesia produces at least three distinct consciousness states — connected, disconnected, and unconscious — with [graded rather than binary](/concepts/degrees-of-consciousness/) transitions. The Unfinishable Map's [interactionist framework](/concepts/interactionist-dualism/) predicts exactly this kind of structured, multi-layered interface.
...
On production models, hysteresis is puzzling: why should a generator resist being switched back on at the same threshold it was switched off? The unconscious state is not merely absence of conscious activity but an actively maintained alternative configuration that must be overcome. Filter theory reads this as the interface's own structural resistance to reconfiguration, not mere pharmacokinetic lag.
...
Individual variation in anaesthetic sensitivity provides further evidence of interface structure. Redheads carrying MC1R gene variants require approximately 20% more anaesthetic than average; chronic alcohol users develop cross-tolerance; some individuals show paradoxical agitation rather than sedation from benzodiazepines. If consciousness were a uniform product of neural activity, sensitivity should track brain size or metabolic rate, not specific genetic variants affecting particular receptor systems. Different individuals have different interface configurations.
