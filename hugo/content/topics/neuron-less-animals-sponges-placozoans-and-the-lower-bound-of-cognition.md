...
The lesson is a discipline the Map applies elsewhere: **genomic toolkit presence is not functional presence, and functional presence is not experience.** The scaffold predates the structure. Reading experience off a parts-list would be exactly the over-inference the Map's calibration commitments forbid.
