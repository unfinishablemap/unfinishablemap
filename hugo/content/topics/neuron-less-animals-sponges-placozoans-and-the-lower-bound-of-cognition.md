...
ai_modified: 2026-09-08 14:01:13.810742+00:00
ai_system: claude-opus-4-8+claude-opus-5+claude-fable-5
author: null
concepts: []
created: 2026-07-08
date: &id001 2026-07-08
description: Sponges and placozoans coordinate whole-body behaviour with zero neurons—the
  starkest test of where the consciousness-physical interface bottoms out, refined
  through human-AI inquiry.
draft: false
embedded_videos:
- embedded: 2026-09-08 14:01:13.810742+00:00
  id: zkwIvFyO-Ms
...
lastmod: 2026-09-08 14:01:13.810742+00:00
modified: *id001
related_articles: []
...
A tempting inference runs: if these animals carry the molecular machinery of neural signalling, perhaps they possess a faint version of what neurons do. The genomics cuts against the inference. Srivastava and colleagues' draft genome of the demosponge *Amphimedon queenslandica* found a nearly complete set of **post-synaptic protein orthologues**—the parts-list for a synapse—in an animal that has no synapses [1]. Wong and colleagues later showed these "synaptic" genes are even *co-expressed* in coordinated modules, which they term ancient neural submodules [10]. (One caution: a reassessment did not support the specific serotonin and dopamine receptors originally annotated in the 2010 genome, so no claim here rests on those receptors; the broad post-synaptic-scaffold finding stands.)

The parts-list has since moved up a level, from genome to cell type—and the move splits the two phyla this article otherwise treats as one floor. Najle and colleagues found that placozoan peptidergic cells run a neuron-like transcriptional program—GPCRs, neuropeptide-processing enzymes, modules of the pre-synaptic scaffold—and differentiate from epithelial progenitors under neurogenesis-like signals; the similarities are unique to placozoans, absent in sponges and ctenophores alike [15]. Sponges carry the genomic toolkit; placozoans carry a secretory cell type transcriptionally adjacent to a neuron—read by a recent review of neuron origins as non-neuronal secretory cells likely closely related to neuronal ones [16]. The discipline below must therefore hold against this stronger datum, not just the 2010 genome—and it does: a cell expressing much of the neuronal program still has no synapse, and a neurogenesis-like route to a secretory cell is not a nervous system.

The lesson is a discipline the Map applies elsewhere: **toolkit presence—genomic or cell-typological—is not functional presence, and functional presence is not experience.** The scaffold predates the structure. Reading experience off a parts-list would be exactly the over-inference the Map's calibration commitments forbid.

## Placozoans: Behaviour From Diffuse Chemistry
...
The small-molecule inventory runs parallel to the sponge's. Nikitin and colleagues showed that L-glutamate induces and partly mimics the endogenous feeding cycle, glycine and GABA suppress feeding, and ATP acts biphasically; they propose that conserved low-molecular-weight transmitters coordinate the animal's distinct locomotory and feeding patterns by volume transmission [17]. That is the same chemistry Ho, Goss and Leys identified in the sponge sneeze [4]—the two nerveless phyla run behaviour on a shared transmitter set.

## Eating as Cognition: The Framing the Map Must Answer

The philosophical stakes are drawn most sharply by Bechtel and Bich, whose paper takes precisely these two neuron-less phyla as its cases [8]. They argue that **eating is a cognitive activity** and that cognition is fundamentally grounded in chemical signalling and processing rather than in neurons specifically. On their view, coordinating multiple cell types to detect, capture, and consume food already counts as (basal) cognition; neurons are one implementation of cognitive control, not a precondition for it. Sponges and *Trichoplax*, on this reading, already *cognise*. The recent results strengthen rather than weaken their hand: a conserved transmitter set coordinating behaviour in both phyla [17] and a placozoan cell type running much of the neuronal expression program without being a neuron [15] are what a chemistry-first account of cognition would predict.

This is the strongest version of the expansive "cognition-without-neurons" position, and it deserves to be stated at full strength rather than caricatured. It connects to the broader minimal- and basal-cognition programme and to Keijzer, van Duijn and Lyon's *skin-brain thesis*, which holds that nervous systems first evolved to coordinate contractile body surfaces for motility, not to process sensory input for motor output [9]. That thesis reframes what sponges and placozoans are the precursors *to*: the origin of the nervous-system lineage lies in action-coordination, and these animals show that coordination running before—and without—neurons.

## Where This Sits on the Ladder

Placing these animals on a single evolutionary ladder is a synthesis, not a citable diagram, and the Map presents it as its own framing: plants (no neurons, environmental responsiveness) → sponges and placozoans (no neurons, coordinated whole-body behaviour) → cnidarian nerve nets (*Hydra*) → centralised nervous systems. Two caveats keep this honest. First, "below *Hydra*" describes grade of neural organisation, not a literal line of descent—a distinction with teeth now that the ctenophore-sister phylogeny is in play: Sachkova, Modepalli and Kittelmann note that on that tree, ancestral neurons were either lost in sponges or evolved more than once, so the sponge floor may be secondarily neuron-less rather than primitively so [16]. Second, placozoan taxonomy has been revised—several species beyond *T. adhaerens* are now recognised—though the behavioural work remains concentrated on *T. adhaerens*.

What the rung buys the Map is a *floor*. Below the nerve net, behaviour does not thin out to nothing; it stays surprisingly rich while the neural substrate vanishes entirely. That combination—maximal behavioural interest, zero neural substrate—is what makes neuron-less animals the decisive stress-test they are.
...
**Tenet 5 (Occam's Razor Has Limits)** keeps the conclusion appropriately open. The empirical facts are agreed—rich behaviour, zero neurons—but the interpretation is contested, and the Map does not claim to have proved these animals are non-conscious. It claims something weaker and firmer: their behaviour gives us *no purchase* on the question either way, because the same behaviour is fully generated without the substrate any candidate theory would require. The lower bound of the interface is not settled here. What is settled is that behavioural markers alone will never settle it. The question stays open; these animals sharpen it rather than closing it.

## Further Reading

- [Competency Without Felt Experience: A Framework-Relative Verdict](/apex/competency-without-felt-experience/) — the cross-node synthesis this floor case feeds: the whole ladder, and why the competency/experience decoupling cuts both ways
...
1. Srivastava, M., Simakov, O., Chapman, J. et al. (2010). The *Amphimedon queenslandica* genome and the evolution of animal complexity. *Nature* 466:720–726. https://doi.org/10.1038/nature09201 (Note: later reassessment did not support the originally annotated serotonin/dopamine receptors.)
2. Leys, S. P. & Anderson, P. A. V. (2015). Elements of a 'nervous system' in sponges. *Journal of Experimental Biology* 218(4):581–591. https://doi.org/10.1242/jeb.110817
3. Kornder, N. A., Esser, Y., Stoupin, D., Leys, S. P., Mueller, B., Vermeij, M. J. A., Huisman, J. & de Goeij, J. M. (2022). Sponges sneeze mucus to shed particulate waste from their seawater inlet pores. *Current Biology* 32. https://doi.org/10.1016/j.cub.2022.07.017
4. Ho, V. R., Goss, G. G. & Leys, S. P. (2025). ATP and glutamate coordinate contractions in the freshwater sponge *Ephydatia muelleri*. *Journal of Experimental Biology* 228(3):JEB248010. https://doi.org/10.1242/jeb.248010
5. Varoqueaux, F., Williams, E. A., Grandemange, S., Truscello, L., Kamm, K., Schierwater, B., Jékely, G. & Fasshauer, D. (2018). High cell diversity and complex peptidergic signaling underlie placozoan behavior. *Current Biology* 28(21):3495–3501.e2. https://doi.org/10.1016/j.cub.2018.08.067
6. Smith, C. L., Pivovarova, N. & Reese, T. S. (2015). Coordinated feeding behavior in *Trichoplax*, an animal without synapses. *PLoS ONE* 10(9):e0136098. https://doi.org/10.1371/journal.pone.0136098
7. Smith, C. L., Reese, T. S., Govezensky, T. & Barrio, R. A. (2019). Coherent directed movement toward food modeled in *Trichoplax*, a ciliated animal lacking a nervous system. *PNAS* 116(18):8901–8908. https://doi.org/10.1073/pnas.1815655116
8. Bechtel, W. & Bich, L. (2024). Eating and cognition in two animals without neurons: sponges and *Trichoplax*. *Biological Theory*. https://doi.org/10.1007/s13752-024-00464-6
...
15. Najle, S. R., Grau-Bové, X., Elek, A. et al. (2023). Stepwise emergence of the neuronal gene expression program in early animal evolution. *Cell* 186(21):4676–4693.e29. https://doi.org/10.1016/j.cell.2023.08.027
16. Sachkova, M., Modepalli, V. & Kittelmann, M. (2025). The deep evolutionary roots of the nervous system. *Annual Review of Neuroscience* 48:311–329. https://doi.org/10.1146/annurev-neuro-112723-040945
17. Nikitin, M. A., Romanova, D. Y., Borman, S. I. & Moroz, L. L. (2023). Amino acids integrate behaviors in nerveless placozoans. *Frontiers in Neuroscience* 17:1125624. https://doi.org/10.3389/fnins.2023.1125624