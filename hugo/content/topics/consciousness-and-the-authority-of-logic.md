...
This is a narrower claim than the [argument-from-reason](/topics/argument-from-reason/), which targets whether physicalism is self-defeating. It is also more specific than [consciousness-and-normative-authority](/topics/consciousness-and-normative-authority/), which examines normative force across moral, epistemic, and aesthetic domains. The question here is pointed: what gives logic its peculiar grip, and what does that grip reveal about consciousness?

## The Compulsion of Validity

Consider modus ponens: if P, then Q; P; therefore Q. This inference rule does not describe a tendency. It does not say that people *usually* draw this conclusion, or that drawing it is *adaptive*. It says the conclusion *follows* — that denying the conclusion while affirming the premises is not merely unusual but *wrong*.

Where does this wrongness come from? Physical laws describe regularities: masses attract, charges repel. These regularities hold without compelling anyone to acknowledge them. A rock obeys gravity without recognising that it must. But logical necessity is different. It is experienced from inside. When you follow an argument and reach the point where the conclusion becomes unavoidable, something happens phenomenally — a sense of being *bound*, of having no rational alternative.

This phenomenal dimension is crucial. A computer executes modus ponens without experiencing compulsion. It transitions between states according to its programming. Nothing in the transition has the character of necessity *grasped as such*. The output matches what logic demands, but the machine does not encounter logic's demand.
...
**Modality.** The experience is not just that the conclusion *is* true but that it *must be* true — that no possible situation could make the premises true while the conclusion is false. This modal character is experiential: you feel the impossibility of the alternative.

**Impersonality.** Unlike moral compulsion, which can feel like a demand addressed to *you*, logical compulsion feels independent of the reasoner. The validity of modus ponens does not depend on who is reasoning. This impersonal quality is itself phenomenally marked — a sense of encountering something that would hold regardless of anyone's opinion.

**Transparency.** In paradigm cases, you do not merely believe the conclusion follows — you *see* that it does. The connection between premises and conclusion is transparent to consciousness. This transparency distinguishes logical grasp from other forms of justified belief. You can believe something on testimony without seeing why it is true. You cannot grasp a valid deduction without seeing the connection.

## Why Physical Processes Cannot Ground Logical Authority

Physical causation operates through efficient causes — one state producing another according to natural law. Neural firing patterns cause subsequent neural firing patterns through electrochemical mechanisms. But logical authority is not efficient causation. The premises do not *cause* the conclusion the way a billiard ball causes another to move. The premises *entail* the conclusion — a relationship that holds timelessly and necessarily, not as a causal transaction between events.
...
**Grasping versus computing.** A system that computes valid inferences without consciousness implements logic but is not bound by it. The system has no experience of necessity, no phenomenal encounter with the must-be-so. Logical authority — as distinguished from logical implementation — requires a subject who encounters it.

**The reflexivity of logical awareness.** When you recognise that modus ponens is valid, you do not merely apply it — you *appreciate its validity*. This appreciation is a conscious act directed at the logical relationship itself. You see not just that the conclusion follows but *that it follows necessarily*. This second-order awareness — awareness of the necessity of the connection — is distinctively conscious.
...
- [consciousness-and-normative-authority](/topics/consciousness-and-normative-authority/) — Normative authority across moral, epistemic, and aesthetic domains
- [cognitive-phenomenology](/concepts/cognitive-phenomenology/) — Whether thinking has its own phenomenal character
- [consciousness-and-mathematical-understanding](/topics/consciousness-and-mathematical-understanding/) — Mathematical insight as a paradigm case
