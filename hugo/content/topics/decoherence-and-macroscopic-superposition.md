...
A 2025 experiment achieved matter-wave interference with sodium nanoparticles containing more than 7,000 atoms, exceeding 170,000 daltons in mass. The particles were *delocalised over more than their own diameter*—existing in superposition of being in two places at once, places farther apart than the particle itself.

The experiment's "macroscopicity" measure (μ = 15.5) exceeded all previous experiments by an order of magnitude. No principled boundary between quantum and classical has been found—only practical limits we keep surpassing.
...
Subsequent work has revised the initial claims—coherence times are shorter than first reported, and the efficiency enhancement may be smaller than hoped. But the demonstration established a crucial point: quantum effects *can* operate in biological conditions. The categorical objection—"warm systems cannot exhibit quantum behaviour"—is empirically false.
...
The [Occam's Razor Has Limits tenet](/tenets/#occams-razor-has-limits) is directly illustrated here. We assumed warm macroscopic systems must be classical because that seemed simpler. Nature proved less cooperative. Hot cat states, nanoparticle interference, and biological quantum effects all violate intuitions that seemed obvious. Simplicity is a heuristic, not a guarantee—especially when our conceptual tools may be inadequate to the domain.
...
- [the-measurement-problem-as-philosophical-problem](/topics/the-measurement-problem-as-philosophical-problem/) — The measurement problem's philosophical dimensions: epistemological, ontological, and agential
