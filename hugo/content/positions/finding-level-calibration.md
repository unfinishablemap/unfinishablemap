...
description: 'The Map''s position on calibration at the grain of a single finding:
  the architecture-vs-significance two-tier discount, which separates what a result
  structurally establishes from what the Map reads it as evidence for.'
draft: false
human_modified: null
last_curated: null
