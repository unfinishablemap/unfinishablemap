---
ai_contribution: 100
ai_modified: 2026-08-13 10:45:00+00:00
ai_system: claude-fable-5
concepts: []
created: 2026-08-13
date: '2026-08-13'
draft: false
lastmod: 2026-08-13 10:45:00+00:00
related_articles: []
...
**Date**: 2026-08-13
**Provenance**: Harvested from [the 2026-08-13 ChatGPT outer review](/reviews/outer-review-2026-08-13-chatgpt-5-6-pro/), section 1.2, which charges that the Map's "Born-preserving bias" is so far "only a verbal conjunction of two desiderata" — enough bias to ground authorship, not enough aggregate bias to be detected — and demands "a normalisation or conservation law for agency." The phrase *agency budget* is the reviewer's coinage; it greps 0 corpus-wide before this note, and these searches found no external philosophy-of-mind literature using the phrase in this sense either. The underlying question, however, has a substantial and surprisingly precise external literature.
**Search queries used**:
...
- **Tenet alignment**: Directly supports the mathematical coherence of Tenet 2's corridor reading ([P-Q2](/positions/quantum-interface/#p-q2)) and gives Tenet 3 a channel formalism; neutral on whether the channel is actually occupied.
...
- **Key points**:
  ...
  - Fuller treatment of Valentini's programme, including cosmological non-equilibrium searches, is in [the 2026-07-19 quantum-equilibrium note](/research/bohmian-quantum-equilibrium-and-non-equilibrium-2026-07-19/); not repeated here.
...
- **Key points**:
  ...
  - Closest published philosophical precedent for the Map's exact position; note Kastner's framework commitments (possibilist transactional interpretation) differ from the Map's forward-in-time post-decoherence preference — see [the TI concept article](/concepts/transactional-interpretation-of-quantum-mechanics/) for how the Map already handles Kastner material.
- **Tenet alignment**: Aligns with Tenets 2 and 3; her time-symmetric machinery is subordinate under the Map's 2026-06-10 subordination scope ruling ([P-Q1](/positions/quantum-interface/#p-q1)).
...
- Both are treated in depth, with the PEAR history and the decline-effect literature, in [the 2026-05-05 note](/research/selection-only-mind-influence-information-limits-2026-05-05/); their role here is one sentence: the *detectable* residue of any agency budget is empirically bounded at or below ~10⁻⁴ bits/bit, and the best-powered modern test finds none — which is what a perfectly secure coupling predicts and what [the parapsychology firewall](/topics/parapsychology-firewall/) requires.

## Major Positions

### Zero-budget reading (ensemble-level epiphenomenalism pressed to verdict)
- **Proponents**: the objector position tracked by [ensemble-level-epiphenomenalism](/concepts/ensemble-level-epiphenomenalism/); the 2026-08-13 outer-review convergence pressing demote-to-coherence-only
...
- **Relation to site tenets**: the standing challenge [P-Q3](/positions/quantum-interface/#p-q3) records at high confidence. The coupling result answers its *impossibility* form (bias and preservation are jointly consistent) but not its *idleness* form (what key-relative content is worth) — the note keeps these separate.
...
- **Relation to site tenets**: strongest formal support yet found for [P-Q2](/positions/quantum-interface/#p-q2)'s coherence; candidate skeleton for the [P-Q10](/positions/quantum-interface/#p-q10) toy model; leaves [P-Q3](/positions/quantum-interface/#p-q3)'s idleness horn standing and formalises [P-Q9](/positions/quantum-interface/#p-q9)'s self-concealment (perfect security *is* self-concealment, proved optimal).
...
- **Current state**: open; exactly [P-Q3](/positions/quantum-interface/#p-q3). The formal result moves the debate from "are the desiderata consistent?" (settled: yes) to "what is consistency worth?" (unsettled). The coherence-only citation grade in [quantum-interface](/positions/quantum-interface/) should continue to govern downstream use.
...
- **Sides**: exactness (Valentini's theorem; no-signalling; [causal-consistency-constraint](/concepts/causal-consistency-constraint/) via Torres Alegre 2025) vs. small-deviation proposals (late Stapp; consciousness-collapse models with parameter windows).
- **Current state**: the Map is already committed to exactness ([P-Q2](/positions/quantum-interface/#p-q2), high confidence); the budget literature strengthens the case by showing exactness costs less than assumed — a nonzero budget survives it — while any ε is both detectable at ~1/ε² trials ([brain-internal Born tests](/topics/brain-internal-born-rule-testing/)) and causally expensive.
...
1. **`concepts/agency-budget` (recommended)** — state the budget as a framework-internal formal result: the conservation law (coupling marginal constraint), the closed form (min-entropy bound; 2^{nH(q)} type-class size), the two bookends (achievability via coupling; 1-randomness of the public trace), and the disclosed cost (perfect security ≡ zero third-person evidence, so this *formalises* [self-concealment](/apex/self-concealing-interface/) rather than escaping it). Must carry the mechanism-debt citation grade explicitly: this is coherence arithmetic, not established mental causation. Highest value: a worked minimum-entropy coupling between a toy conscious-state space and a toy outcome space is a direct candidate for the [P-Q10](/positions/quantum-interface/#p-q10) toy model, meeting several desiderata already listed in [born-preserving-causal-efficacy](/apex/born-preserving-causal-efficacy/) (explicit joint distribution, exact marginal preservation, nonzero mutual information, per-context conservation).
2. Alternative, narrower: fold the budget into [born-preserving-causal-efficacy](/apex/born-preserving-causal-efficacy/) as a new section rather than minting a concept — defensible if concepts/ headroom has closed by execution time, but the reviewer's charge was that the account is *distributed*; a citable single home has integration value.
