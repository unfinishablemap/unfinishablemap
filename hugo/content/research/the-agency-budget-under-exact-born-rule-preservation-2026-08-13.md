...
- **Current state**: open; exactly P-Q3. The formal result moves the debate from "are the desiderata consistent?" (settled: yes) to "what is consistency worth?" (unsettled). The coherence-only citation grade in [quantum-interface](/positions/quantum-interface/) should continue to govern downstream use.
...
- **Current state**: the Map is already committed to exactness (P-Q2, high confidence); the budget literature strengthens the case by showing exactness costs less than assumed — a nonzero budget survives it — while any ε is both detectable at ~1/ε² trials ([brain-internal Born tests](/topics/brain-internal-born-rule-testing/)) and causally expensive.
