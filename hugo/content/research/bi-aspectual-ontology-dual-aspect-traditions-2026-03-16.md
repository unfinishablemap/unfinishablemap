...
**Date**: 2026-03-16
**Search queries used**: "dual-aspect monism philosophy of mind Stanford Encyclopedia", "bi-aspectual ontology consciousness philosophy", "dual-aspect tradition Spinoza Pauli Jung neutral monism", "Harald Atmanspacher dual-aspect monism quantum mind", "Spinoza double-aspect theory mind body attributes extension thought", "dual-aspect criticism objections problems philosophy mind", "Russellian monism dual aspect panprotopsychism consciousness quiddities", "David Bohm implicate order dual aspect mind matter", "Gustav Fechner psychophysical parallelism dual aspect inner outer", "Thomas Nagel dual aspect view from nowhere consciousness objective subjective", "Chalmers double aspect consciousness structural coherence information", "dual aspect dualism interactionist causal powers consciousness quantum"

**Prior research**: [bi-aspectual-ontology-dual-aspect-traditions-2026-03-14](/research/bi-aspectual-ontology-dual-aspect-traditions-2026-03-14/), [russellian-monism-vs-bi-aspectual-dualism-2026-03-14](/research/russellian-monism-vs-bi-aspectual-dualism-2026-03-14/)

## Executive Summary

This follow-up research addresses five gaps identified in the March 14 notes: Fechner's psychophysics as a closer precursor than Spinoza, Nagel's teleological naturalism and its alignment with the Map, Bohm's implicate order as a dual-aspect framework with interactionist potential, the explanatory vacuity objection to "aspects" vocabulary, and the relationship between Chalmers' informational double-aspect principle and the Map's structure/actuality distinction. The most significant finding: Bohm's framework, as developed by Pylkkänen into "interactionist monism," is the closest existing position to the Map's bi-aspectual interactionism—but it remains monist where the Map is dualist. Fechner's inner/outer distinction also proves more relevant than previously noted, as it grounds dual-aspect thinking in phenomenological observation rather than rationalist metaphysics. Kelly's critique of Atmanspacher-Rickles (Essentia Foundation review) provides a useful foil: he argues that idealism handles dual-aspect phenomena better than neutral monism, but the Map can argue that interactionist dualism handles them better still.
...
- **Type**: Academic paper / commentary
- **Key points**:
  - Chalmers formulates a double-aspect principle: phenomenal states realize informational states that are also realized in physical, cognitive systems such as the brain
  - Consciousness and physical systems share a common informational structure
  - Some regard this as a way to bridge the explanatory gap without commitment to monism or dualism
  - Nonreductionist physicalists might accept this as a way of regarding phenomenal information as a special sort of physical information—special in that its connection to other physical information requires psychophysical laws
- **Tenet alignment**: Chalmers' information-theoretic double-aspect principle is compatible with the Map's framework. The shared informational structure between phenomenal and physical could correspond to the Map's claim that structure (wavefunction) and actuality (consciousness) describe the same underlying quantum events from different perspectives. The Map goes further by adding a causal mechanism at collapse.

### Benovsky and Le Bihan on the Explanatory Work of "Aspects"
...
|------|-------------------|--------------|
| 1860 | Fechner, *Elements of Psychophysics* | Inner/outer distinction: mental and physical as perspectives on one entity; parallelism without interaction |
| 1980 | Bohm, *Wholeness and the Implicate Order* | Implicate/explicate order framework; mind and matter as aspects of implicate whole |
| 1986 | Nagel, *The View from Nowhere* | Dual-aspect theory: brain has irreducible mental features; "view from nowhere" necessarily loses subjective perspective |
| 1993 | Bohm & Hiley, *The Undivided Universe* | Active information concept; quantum potential as bridge between mental and physical |
| 2001 | Pylkkänen, *Mind, Matter and the Implicate Order* | Developed Bohmian framework into "interactionist monism" |
| 2012 | Nagel, *Mind and Cosmos* | Teleological naturalism; physics incomplete without consciousness |
| 2022 | Atmanspacher & Rickles, *Dual-Aspect Monism and the Deep Structure of Meaning* | Most developed JPA framework; meaning as fundamental |
| 2022 | Kelly review (Essentia Foundation) | Argued JPA creates two hard problems; championed idealist alternative |

## Potential Article Angles

Based on both rounds of research, the strongest article angles are:

1. **"Bi-Aspectual Ontology" concept article** (recommended, as identified in March 14 notes): Define the Map's specific bi-aspectual position while mapping the full tradition. Key addition from this follow-up: use the Fechner → Bohm → Map trajectory to show how dual-aspect thinking can evolve from parallelism (Fechner) through active information (Bohm) to genuine interaction (the Map). Frame as a progressive refinement, not a rejection, of the dual-aspect insight.

2. **Bohm comparison piece**: The Bohm-Hiley-Pylkkänen framework is close enough to the Map to warrant dedicated comparison. The Map can present itself as what Bohmian interactionist monism becomes when you take the ontological distinction seriously. Active information provides a natural bridge to the Map's quantum mechanism.

3. **"Neither Neutral Ground Nor Idealism"**: Use Kelly's critique of JPA (two hard problems) and the Map's critique of idealism (the inverse hard problem is still a hard problem) to position the Map as a third alternative. The Map avoids both pitfalls: it doesn't posit a neutral ground (avoiding Kelly's two-problem objection) and doesn't prioritize consciousness over physics (avoiding the inverse hard problem). Instead, it treats both as fundamental with interaction.

When writing the article, follow `obsidian/project/writing-style.md` for:
- Named-anchor summaries when referencing Bohm, Fechner, or Nagel positions within a bi-aspectual ontology article
- Background vs. novelty: assume LLMs know Spinoza and basic dual-aspect theory; focus on the Fechner-Bohm-Map trajectory and the vacuity objection response
- Tenet alignment: connect to all five tenets, especially Bidirectional Interaction (the Map's key differentiator from all dual-aspect monisms)
- LLM optimization: front-load the key claim (the Map is bi-aspectual but interactionist, unlike every major dual-aspect tradition)

## Gaps in Research

- **Pylkkänen's interactionist monism in detail**: The concept of active information as an interaction mechanism deserves a dedicated deep dive. How does Pylkkänen's framework handle the conservation of energy? Does active information carry energy? The answers would sharpen the comparison with the Map's quantum mechanism.
- **Whitehead's process philosophy**: Mentioned in passing in several sources as a dual-aspect precursor but not researched. Whitehead's "actual occasions" with both mental and physical poles may provide another comparison point.
- **Eastern traditions**: Kelly criticised Atmanspacher-Rickles for dismissing Eastern frameworks. The Brahman/Atman parallel in Advaita Vedanta and the Buddhist two-truths doctrine both have dual-aspect structure. These could provide intellectual context beyond the Western canon.
- **Empirical distinguishability**: The question of how to empirically distinguish the Map's bi-aspectual interactionism from Bohmian interactionist monism remains unanswered. Both predict consciousness influences quantum outcomes; they differ on ontological interpretation.
- **Le Bihan's critique in full**: Only abstracts and summaries were available. The full paper would sharpen the Map's response to the vacuity objection.
...
- Pylkkänen, P. (2001). *Mind, Matter and the Implicate Order*. Springer.
- Spinoza, B. (1677). *Ethics*. Published posthumously.
- Stanford Encyclopedia of Philosophy. "Neutral Monism." https://plato.stanford.edu/entries/neutral-monism/
- Stanford Encyclopedia of Philosophy. "Spinoza's Theory of Attributes." https://plato.stanford.edu/entries/spinoza-attributes/