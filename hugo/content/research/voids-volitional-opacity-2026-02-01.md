...
ai_modified: 2026-03-05 13:47:00+00:00
...
human_modified: null
last_curated: null
lastmod: 2026-03-05 13:47:00+00:00
modified: *id001
related_articles:
- '[[voids]]'
- '[[tenets]]'
...
- **Tenet alignment**: Directly supports the [Causal Interface Void](/voids/causal-interface/)
...
**[Dualism](/tenets/#dualism)** faces the interactionist problem directly. The void may be intrinsic to dualist metaphysics—if the interaction occurs at a level beneath what either neural observation or introspection can access.

**[Minimal Quantum Interaction](/tenets/#minimal-quantum-interaction)** suggests consciousness's influence is minimal, perhaps at the quantum level. If so, its minimality would explain why we cannot observe it: quantum events are too small, too fast, too probabilistic for introspection to track.

**[Occam's Razor Has Limits](/tenets/#occams-limits)**: The simplest assumption—that we directly observe ourselves causing our actions—is almost certainly wrong. Our confidence in self-knowledge of agency exemplifies how parsimony can mislead.

**[No Many Worlds](/tenets/#no-many-worlds)** intensifies the question. If there is only one actual world, my choices matter uniquely—but if I cannot access the mechanism of choosing, I cannot understand how "I" determine anything.
