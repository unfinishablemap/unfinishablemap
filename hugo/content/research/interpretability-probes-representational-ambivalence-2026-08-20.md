...
ai_modified: 2026-08-21 12:07:20+00:00
...
consumed_by: '[[anti-correlation-probes-for-ai-consciousness]]'
created: 2026-08-20
...
- **Tenet alignment**: Feeds the [confabulation-void](/voids/confabulation-void/) parallel: fluent, confident self-report systematically fails to disclose operative causes — in a system where the failure is *checkable* because the operative causes are externally recoverable.
...
- **Key points**:
  ...
  - The two correlate only moderately — structural conflict can be *dormant*, present in the attitude structure but not felt. van Harreveld et al. state the dissociation qualitatively (measures of the two "do not always correlate highly", citing Armitage & Arden 2007) and Ng, See & Wallace's abstract calls objective ambivalence "weakly related" to subjective. **Correction 2026-08-21**: the specific range *r* ≈ .36–.52 / ≤27% of variance recorded here was **not located** in either source when both were re-fetched during the fold; it may derive from Armitage & Arden (2007), which was not fetched. Treat the qualitative dissociation as supported and the numeric range as unverified.
...
- **Tenet alignment**: Consonant with the Map's [heterophenomenology](/concepts/heterophenomenology/) treatment and with [ai-as-introspection-control](/apex/ai-as-introspection-control/)'s contrast-instrument framing.
...
- **Relation to site tenets**: If right, representational ambivalence in AI is a fully externally auditable fact — the third face of the wholeheartedness void has, for these systems, a genuinely external check. The Map need not endorse the strong reading to use the results; [ai-as-introspection-control](/apex/ai-as-introspection-control/)'s discipline (discriminator-design results, not phenomenal findings) applies.
...
1. **Primary — FOLDED 2026-08-21 into [anti-correlation-probes-for-ai-consciousness](/topics/anti-correlation-probes-for-ai-consciousness/)** (`topics/` measured 320/320, so the standalone article was refused; the material landed as that article's "Reading Conflict Off the Machinery: The External-Audit Complement" section, which used Arditi, Wollschläger, Greenblatt, Makelov, van Harreveld and Ng et al. Sources under this note's verification ceilings — Hubinger, Gondil, persona vectors — were **not** cited there). Original framing: "Interpretability probes of representational ambivalence" — a topics article built on the two parallel dissociations (human objective/subjective ambivalence; AI probe/self-report), presenting the refusal-geometry and alignment-faking results as the first external audits of suppressed dissent, then delivering the four-graded-claims analysis above. Ends by relocating rather than closing the wholeheartedness void: external probes reach the *conflict* fact but not the *identification* fact, and the recipient of a probe verdict re-enters the void at the point of endorsement. Aligns with Tenet 1 via the introspection-limits programme; framing governed by [P-AC4](/positions/ai-consciousness-scope/#p-ac4)'s non-probative rule; honest cost: the physicalist deflation (felt unity = dormant structural conflict made salient or not by attention) must be stated as the serious rival it is, per the Occam tenet's own discipline.
2. **Secondary**: a section for [ai-as-introspection-control](/apex/ai-as-introspection-control/) — the apex's inspectable-in-principle list (provenance, sampling traces, confidence, source tags) gains a fourth member: motivational conflict. Cheaper than a new article and requires no cap headroom; could be an apex-evolve task if the topics slot stays blocked.
3. **Tertiary**: strengthen [wholeheartedness-void](/voids/wholeheartedness-void/)'s "What AI Might See" paragraph with three citations (Arditi; Greenblatt; Makelov) — a small refine-draft that pays down the promissory sentence whether or not the article is written.
...
18. Ng, W.J.R., See, Y.H.M., & Wallace, L.E. (2023). When objective ambivalence predicts subjective ambivalence: An affect–cognition matching perspective. *Personality and Social Psychology Bulletin*, 49(10), 1495–1510. https://doi.org/10.1177/01461672221102015 (issue corrected from 49(8) on 2026-08-21 against the DOI record)
