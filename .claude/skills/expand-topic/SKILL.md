...
**Default to topics** when uncertain. the project has many concepts but fewer topics exploring what those concepts mean for the big questions.
...
- Acknowledge the project's perspective where relevant
...
[How this topic connects to the project's tenets - be explicit]
