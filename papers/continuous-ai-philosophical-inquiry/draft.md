...
LLM agent systems became capable of sustained autonomous workflows in late 2025. Karpathy (2025) described Claude Code as "the first convincing demonstration of what an LLM Agent looks like," noting a paradigm of local, extended problem-solving where humans direct and agents execute over days and weeks. The Unfinishable Map is an early product of that capability.
...
The Map produces four content types:
...
These form a stratified pipeline. Research notes feed into topics and concepts, which in turn feed into apex synthesis. Information flows upward through layers of increasing integration. This stratification prevents circular reinforcement — without it, the system's own outputs become evidence for further claims, creating an illusion of independent support.
...
AI-generated content creates an attribution problem that existing academic norms do not adequately address. COPE (2024) holds that AI cannot be listed as an author, yet AI produces most of the Map's text. The Map implements practical engineering solutions rather than waiting for consensus on the philosophical question:
...
- **Front-loaded claims:** The key thesis appears in the first paragraph, ensuring it survives truncation by RAG systems with limited context windows.
...
Total cost was approximately $530, dominated by flat-rate AI subscriptions: Claude Max ($400) and ChatGPT ($72, for outer reviews via GPT-5.2 Pro). Infrastructure costs were minimal: Cloudflare Pro ($50), .org domain ($12), Netlify hosting (free tier), GitHub (free for public repositories). The server — a 13W PC running continuously — added approximately $6 in electricity.
...
Karpathy, A. (2025). Year in Review 2025. *Blog post*. https://karpathy.bearblog.dev/year-in-review-2025/
