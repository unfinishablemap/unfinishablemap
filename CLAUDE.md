...
ai_system: null          # or model name like "claude-sonnet-4-7"
...
| `/commission-claude-review` | Drives Chrome to commission a fresh outer review from Claude Opus 4.8 (Adaptive thinking + Research + Web Search) in the Map's project. Time-triggered daily 03:00 UTC. Navigates the optional clarifying-questions stage with "go". | Yes (pending-reviews.yaml) |
...
- commission-claude-review: 3am UTC daily — Opus 4.8 with Adaptive thinking + Research. Reuses the same subject ChatGPT picked at 02:00.
