...
| `/commission-claude-review` | Drives Chrome to commission a fresh outer review from Claude Fable 5 (Research + Web Search) in the Map's project. Time-triggered daily 03:00 UTC. Navigates the optional clarifying-questions stage with "go". | Yes (pending-reviews.yaml) |
...
- commission-claude-review: 3am UTC daily — Fable 5 with Research. Reuses the same subject ChatGPT picked at 02:00.
