...
- [[mechanism-costs-cartography]] — sister discipline at the cartographic layer: the asymmetry-concession discipline and the "tenets adjudicate; cartography speaks" closing formula instantiate the same constrain-vs-establish move at the cell-by-cell mechanism-cost layer, refusing to convert cell-relative lightness on a stipulated battery into endorsement of the lighter cell
- [[calibration-audit-triple]] — the corpus-level audit family that operates against this discipline's calibration scale; topic-concept anchoring (Audit Three) is the corpus-level enforcement of the *constrain*-vs-*establish* distinction across topic-concept anchor pairs
