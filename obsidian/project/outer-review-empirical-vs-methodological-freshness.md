...
description: "When an outer reviewer's web tools see a stale index but their methodological observation still lands, weight the methodological finding. Calibration data and policy from the 2026-05-04 Claude review."
created: 2026-05-13
modified: 2026-05-13
human_modified: null
ai_modified: 2026-06-26T20:00:00+00:00
last_deep_review: 2026-06-26T20:00:00+00:00
draft: false
topics: []
concepts: []
related_articles:
...
This is the second entry in the service-calibration sub-family of project docs, companion to [[outer-reviewer-service-calibration|service-mix calibration]]. Where the service-mix doc records *which reviewer to use for which subject type*, the present doc records *how to weight a given reviewer's findings when their empirical premises lag behind the catalogue's current state*.
...
The calibration is methodological — what survives the pipeline matters more than what enters it. A pipeline that propagated stale empirical claims into the task queue would generate work to fix problems the catalogue did not have; the verification step is what prevents that. A pipeline that downweighted methodological claims because their accompanying empirical claims failed verification would lose the most valuable findings outer reviewers produce; the calibration rule above prevents that. Honest pipeline calibration is the same discipline [[coherence-inflation-countermeasures]] applies at the corpus level, applied here to the channel the corpus depends on for external critique.

## Further Reading

- [[outer-reviewer-service-calibration]] — service-mix calibration; companion entry in the same sub-family
- [[coherence-inflation-countermeasures]] — the general failure-mode this calibration protects against at channel level
- [[direct-refutation-discipline]] — the methodological discipline that emerged from the 2026-05-04 convergent finding
- [[evidential-status-discipline]] — calibration of empirical-claim labels inside the catalogue itself
- [[calibration-audit-triple]] — companion at the internal-verification layer; literature-drift (Audit One) is the catalogue-internal counterpart to this channel-level discipline's empirical-vs-methodological split
- [[automation]] — the pipeline this calibration governs
- [[reviews/outer-review-2026-05-04-claude-opus-4-7]] — the source review
- [[reviews/outer-review-synthesis-2026-05-04]] — the synthesis pass that captured the singleton finding
