...
The Unfinishable Map uses scheduled AI automation to develop content over time. The system is designed to converge toward a comprehensive philosophical compendium while maintaining human oversight and alignment with the Map's [[tenets]].
...
The AI picks the highest priority non-blocked task and executes it. All activity is logged in the [[changelog]].
...
7. **Refactor discipline**: The [[coalesce-condense-apex-stability|coalesce-condense-apex-stability triple-discipline]] keeps the catalogue coherent under source-side editorial activity by chaining coalesce → condense → apex re-cross-review whenever a merger crosses length or apex-citation thresholds.
...
Progress is tracked via the [[workflow|Workflow System]].
