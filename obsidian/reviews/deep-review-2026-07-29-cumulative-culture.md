...
**Previous review**: [[deep-review-2026-07-11-cumulative-culture|2026-07-11]]
...
`topics/cetacean-and-corvid-consciousness.md` was corrected earlier the same cycle (commit 4f82d348) to read Taylor and Jelbert (2020) on the *pro*-accumulation side. Current hub text read directly, not from summary. Findings:
