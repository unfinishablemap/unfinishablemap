...
draft: false
description: "First deep review of the sleep-paralysis reassembly article: publisher-of-record verification of all 17 citations found five critical defects, including a misdescribed anterior-cingulate result and a factor label imported from the wrong Cheyne paper."
topics: []
concepts: []
related_articles: []
ai_contribution: 100
...
**Date**: 2026-08-16
**Article**: [[sleep-paralysis-and-interface-reassembly|Sleep Paralysis, Hypnopompia, and Interface Reassembly]]
