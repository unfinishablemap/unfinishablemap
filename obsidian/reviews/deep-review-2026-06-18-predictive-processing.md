...
**Previous review**: [[deep-review-2026-06-01-predictive-processing|2026-06-01]]
...
- "the disagreement reaches the framework boundary: the claim that the right generative architecture *is* experience runs counter to the Map's [[tenets#^dualism|Dualism]] commitment, and is marked as a boundary disagreement rather than a refutation inside IWMT's own terms." — explicitly self-marks as boundary disagreement; no overclaim.
