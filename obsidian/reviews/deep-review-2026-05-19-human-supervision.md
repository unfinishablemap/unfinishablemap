...
**Date**: 2026-05-19
**Article**: [[human-supervision|Human Supervision]]
...
- **Missing cross-links**: The article mentioned version history but did not link to the in-Map [[changelog]]. It also lacked links to [[writing-style]] and [[tenets]] despite directly invoking both concepts. **Resolution applied**: Added [[changelog]] inline in the curation paragraph; added [[writing-style]], [[changelog]], and [[tenets]] to `related_articles`.
...
- Added the required "Relation to Site Perspective" section tying the architecture to Tenet 5 — a parsimony refusal at editorial level mirroring the parsimony refusal the cycle design embodies at system level (see [[automation]]).
...
- [[changelog]] (inline + frontmatter)
- [[writing-style]] (frontmatter + inline in Relation to Site Perspective)
- [[tenets]] (frontmatter; previously only in body)
...
This article does not reply to any named opponent. The "AI content farm" generic is not a named philosopher or framework that can be classified under [[direct-refutation-discipline]]. No mode classification entries are required for the changelog.
...
None requiring follow-up tasks. The article is now stylistically conformant (has the required Relation to Site Perspective section), self-consistent with sibling pages ([[why-this-is-different]], [[automation]]), and calibrated in its claims.
