...
draft: false
description: "First full audit of the positions register (18 live entries across 4 domain files): contradictions, dependency resolution, orphans, and confidence calibration."
topics: []
concepts:
...
- **Illusionism cluster edits (2026-06-09).** The only illusionism reference in the register is a
  *paraphrase* inside P-V1's Asserts ("illusionism predicts the introspection-architecture
  cluster") — not a citation to `concepts/illusionism.md`. The claim it paraphrases is intact and
...
live `project/evidential-status-discipline.md`. (Note: the SKILL doc references it under
