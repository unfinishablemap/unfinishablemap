...
**Date**: 2026-05-17
**Article**: [[writing-style|Writing Style Guide]]
...
The guide *describes* the engagement-mode discipline (it links to [[direct-refutation-discipline]]) but does not itself engage a named opponent in its own prose. The illusionism "Right" example at line 150 is a *style example*, not an in-document argument. No mode-classification work required.
