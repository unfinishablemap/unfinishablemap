...
draft: false
description: "Second-pass deep review: post-review crosslink audit, citation currency re-check on the three provisional entries, and closure of the deferred Dennett-uncited item."
topics: []
concepts: []
related_articles: []
ai_contribution: 100
...
**Previous review**: [[deep-review-2026-08-04-inner-speech-and-anendophasia|2026-08-04]]
...
- The `[[descriptive-experience-sampling]]` clause ("the method's limitation register, including its inability to establish absence at zero, is set out in that article") matches `concepts/descriptive-experience-sampling.md`, whose limitation register carries exactly that "Absence at zero" entry, and whose worked-example section characterises this article's material consistently (Hurlburt's completely/mostly point, the coiners' continuum concession).
