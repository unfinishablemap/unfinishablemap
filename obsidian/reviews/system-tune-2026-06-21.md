...
modified: 2026-06-21
human_modified: null
ai_modified: 2026-06-21T08:20:00+00:00
draft: false
topics: []
concepts: []
related_articles:
...
- **Issue**: `apex/apex-articles.md` escapes the `stem==parent` index guard; at ~166 posts/7d the topic-dedup empties the real-article pool, so the URL-only fallback surfaces the index page. Forks self-correct every time.
