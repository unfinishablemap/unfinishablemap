...
**Previous review**: [[deep-review-2026-05-31-eastern-philosophy-consciousness|2026-05-31]]
...
- **Wrong-author misattribution (FIXED)**: The article cited
  *"Laukkonen, R. E., & Slagter, H. A. (2024). Deconstructing the self and
  ...
  - **Propagation**: This same misattributed tuple appears in
    `concepts/witness-consciousness.md` (L223) and the research note
    `research/meditation-observer-witness-phenomenon-2026-01-18.md` (L289).
...
- Follow-on (queued): propagate the Yang et al. 2025 author-vector correction to
  `concepts/witness-consciousness.md` (L223) and
  `research/meditation-observer-witness-phenomenon-2026-01-18.md` (L289).
