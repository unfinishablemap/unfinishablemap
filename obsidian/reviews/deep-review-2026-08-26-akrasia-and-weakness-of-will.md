...
**Date**: 2026-08-26
**Article**: [[akrasia-and-weakness-of-will|Akrasia and Weakness of Will]]
**Previous review**: [[deep-review-2026-07-09-akrasia-and-weakness-of-will|2026-07-09]] (verification-only, same-session as create)
...
- **New — Hagger, M. S., Chatzisarantis, N. L. D., et al. (2016), "A Multilab Preregistered Replication of the Ego-Depletion Effect", *Perspectives on Psychological Science* 11(4), 546–573, doi:10.1177/1745691616652873** — **real-correct**. Crossref works record: title, container, 2016-07, vol. 11 iss. 4 pp. 546–573, 64 authors led by Hagger and Chatzisarantis. Family resolution: entry written in the same form the corpus already uses in `concepts/mental-effort.md` and `apex/attention-as-causal-bridge.md`, so no new variant was minted.
...
### Cross-links Added
- [[mental-effort]] (the corpus's home for the Hagger 2016 result and the felt-effort/resource dissociation).
...
- New: the ego-depletion caveat is deliberately scoped to *what the capacity consumes*, leaving Holton's structural claim intact. A future review that wants to expand the replication-crisis material should send it to [[mental-effort]], not here — this article is about the philosophy of action, and one calibrating passage is the right dose.
