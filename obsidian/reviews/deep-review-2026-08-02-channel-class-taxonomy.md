...
**Previous review**: [[deep-review-2026-07-11-channel-class-taxonomy|2026-07-11]]

The article re-qualified because an earlier same-day deep-review of
[[selection-only-mind-influence]] upgraded the Stapp `n.d.` citation here to the
...
[[conservation-laws-and-mental-causation]] already carries the correct wording, so this
...
the convention [[selection-only-channel]] derives and which the rest of the corpus uses
...
[[possibility-probability-slippage]], and no class assignment is presented as
...
[[sorkin-delta-brain-internal-analogues]] and [[consciousness-bandwidth-architecture]].
...
- [[selection-only-channel]] gains an additional inbound anchor from the Class-2
...
- **Stapp 2006 page range unconfirmed.** Crossref and OpenAlex both omit pages for
  ...
  `topics/quantum-state-inheritance-in-ai.md` assert `599–616` for this article. The
