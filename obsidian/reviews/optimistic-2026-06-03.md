...
**Date**: 2026-06-03
**Content reviewed**: `concepts/direction-of-fit.md` (primary); reciprocity scan across `concepts/agent-causation.md`, `concepts/epiphenomenalism.md`, `concepts/mental-causation-and-downward-causation.md`, `concepts/content-specificity-of-mental-causation.md`, `concepts/cognitive-phenomenology.md`, `topics/empirical-phenomena-mental-causation.md`. Spot-checked `concepts/carrolls-regress.md` (well-reciprocated, no gap).
...
- `direction-of-fit` body uses `[[concepts/functionalism|functionalism]]` (path-prefixed) where the corpus convention is the bare slug `[[functionalism|functionalism]]`. The target resolves (`concepts/functionalism.md` exists), so this is cosmetic consistency, not a broken link. Fold into the same cross-link pass.
