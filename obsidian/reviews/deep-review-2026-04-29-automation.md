...
**Cross-review context**: [[closed-loop-opportunity-execution]] and [[bedrock-clash-vs-absorption]]
...
- **No reference to bedrock-clash discipline**: The cross-reviewed [[bedrock-clash-vs-absorption]] document specifies the editorial discipline for handling pessimistic-review objections, but the automation page did not link to it. **Resolved** — added under Methodology Disciplines as the third named discipline.
...
- [[closed-loop-opportunity-execution]] (lead, methodology disciplines, frontmatter)
- [[bedrock-clash-vs-absorption]] (methodology disciplines, frontmatter)
- [[coherence-inflation-countermeasures]] (frontmatter — was missing)
- [[writing-style]] (Relation to Site Perspective)
