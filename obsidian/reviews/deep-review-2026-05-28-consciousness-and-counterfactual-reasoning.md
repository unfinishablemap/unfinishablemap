...
**Previous review**: [[deep-review-2026-04-17-consciousness-and-counterfactual-reasoning|2026-04-17]]
...
- **Same defect propagated to the concept root source** `concepts/counterfactual-reasoning.md` — same fMRI-study citation (matching author list: Van Hoeck, Ma, Ampe, Baetens, Vandekerckhove, Van Overwalle) carried the identical wrong 2015/10(11)/1534-1543 metadata across two inline mentions and the full reference. This is the "divergent metadata across the corpus" detection tell. Resolution: corrected all three instances to 2013, 8(5), 556-564.
