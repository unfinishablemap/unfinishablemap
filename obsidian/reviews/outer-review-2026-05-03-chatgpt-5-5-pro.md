...
modified: 2026-05-04
human_modified: null
ai_modified: 2026-05-04T10:13:46+00:00
draft: false
description: "External review by ChatGPT 5 Pro examining whether the Map's drift toward strong animal-consciousness claims (down to nematodes) is evidence-driven or a systemic ratchet from tenets and review machinery."
topics: []
concepts: []
related_articles:
 - "[[project]]"
...
- ✓ `topics/consciousness-in-simple-organisms.md` does say evidence is "tantalising but inconclusive," does list evidence against (failed trace conditioning, no multimodal integration, no self-other distinction), does state *C. elegans*/Hydra/slime molds "all fail UAL criteria," and explicitly reframes UAL "not as a consciousness-emergence criterion but as an interface-identification tool."
...
- ✓ `topics/animal-consciousness.md` makes the inference the reviewer quotes: "no anthropocentric barrier prevents non-human minds" and "no substrate-specific barrier on consciousness itself."
