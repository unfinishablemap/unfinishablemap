...
**Previous review**: [[deep-review-2026-07-08-death-and-consciousness|2026-07-08]]
...
1. **Fabricated verbatim quotation attributed to Parfit (CRITICAL — quote fidelity, fixed).** The
   ...
   **This defect was already diagnosed and fixed elsewhere in the corpus two months ago — and never
   ...
   [[parfit-reductionism]] identified it as a "Fabricated direct quotation," de-quoted it, and
...
2. **Batthyány et al. 2023 is a wrong-author misattribution (CRITICAL — fixed, and propagated).**
   ...
   [[terminal-lucidity-and-filter-transmission-theory]] and in the 2026-03-20 research note. Those
   ...
   files**: [[near-death-experiences]] (body claim + its own reference entry, same wrong page range),
...
| Cite | Level | State |
|---|---|---|
| Teresi et al. 2023 (was "Batthyány et al. 2023") | publisher (Crossref DOI 10.3928/00989134-20221206-03) | **real-wrong-metadata** — wrong first author (Batthyány→Teresi), wrong pages (17-22→18-26); corrected inline + References, propagated to [[near-death-experiences]] |
...
- **Deferred item from 06-05 and 07-08 now CLOSED**: both reviews left open a spot-check of
  [[near-death-experiences]] for the same AWARE II "39% recalled experiences of death" mis-pin.
...
- **New locus found, reported not fixed**: the Batthyány & Greyson "Spontaneous remission of dementia
  ...
  [[filter-theory]], [[consciousness-under-extreme-metabolic-constraint]] and
  [[memory-channel-interface-evidence]], 2021 in
  [[terminal-lucidity-and-filter-transmission-theory]] (which also lists 8(1), 1-8, consistent with a
