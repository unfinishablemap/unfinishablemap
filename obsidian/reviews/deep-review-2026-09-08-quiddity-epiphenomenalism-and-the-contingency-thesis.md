...
**Previous review**: [[deep-review-2026-06-25-quiddity-epiphenomenalism-and-the-contingency-thesis|2026-06-25]] (also 2026-06-09, 2026-05-31)
...
- [[ontic-structural-realism]] — one body link plus one Further Reading bullet, matching how the 2026-09-06 cross-reviews integrated the same article into `russellian-monism` and `bi-aspectual-ontology` (Further Reading bullet only, no frontmatter change).
