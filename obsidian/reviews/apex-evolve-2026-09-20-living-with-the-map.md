...
**Previous review**: [[deep-review-2026-07-25-living-with-the-map|deep-review 2026-07-25]]
...
- **Retributivist desert overstated.** The apex read "the retributivist intuition that
  ...
  "pragmatic" consequences. [[moral-responsibility]] says retribution "becomes
  ...
  [[compatibilist-symmetry-challenge|Compatibilist Symmetry Challenge]] discipline was
...
- **Quantifier upgrade.** "Most action is also spontaneous" — the source says "Selection
  ...
  [[free-will]]. Worse, the source's only "Most" sentence asserts the near-opposite:
...
- **Stranded orphan sentence.** "Each exploratory movement of attention opens further
  ...
  [[free-will]] by a deep review on 2026-02-05, copied here 2026-03-06, and removed from
...
- **Buddhist material credited to an article that does not contain it.** The apex
  attributed *upādāna* / *duḥkha* / Madhyamika to [[nihilism-and-existentialism]].
  ...
  [[moral-implications-of-genuine-agency]], which was not in `apex_sources`. Further, the
...
- **Whitehead sourced to the wrong article.** "subjective aim" and "richest possible
  integration" have zero hits in [[meaning-of-life]] (whose entire Whitehead content is
  one parenthetical). They come from [[subjective-aim]]. Also, the apex called the
...
- [[ethics-under-dualism]] is *categorical* on AI — "lack consciousness" (5×),
  ...
  [[ai-consciousness]] and [[apex/machine-question]], so the apex is right and the link
  was wrong; the inline reference was repointed to [[ai-consciousness]]. Fixing
  `ethics-under-dualism` itself is a separate task worth minting.
- [[moral-implications-of-genuine-agency]] carries the same Madhyamika
...
[[phenomenology-of-choice-and-volition]], now added to `apex_sources`).

**Minor completions:** the owed-bridges list gained its fourth member (moral uncertainty)
from [[moral-architecture-of-consciousness]].
...
1. Mint a task on [[ethics-under-dualism]]: its categorical "AI lacks consciousness" /
   "categorically excluded" claims are disavowed by [[ai-consciousness]] and
   [[apex/machine-question]], which scope the verdict to bidirectional coupling.
2. Mint a task on [[moral-implications-of-genuine-agency]]: *upādāna* and *duḥkha*
