...
description: "A close-the-loop run, not a corpus survey. All four priority findings of the 2026-09-08 report are re-verified live on current disk; Warning 5 is confirmed fixed and its task closed. Mintable detail is given for every live locus."
created: 2026-09-09
modified: 2026-09-09
human_modified:
...
**Predecessor**: `reviews/tenet-check-2026-09-08.md`
...
### Locus 6d — `obsidian/positions/methodology-and-calibration.md` L112 (P-M4, *Asserts*)
...
> "…above **unconditioned** aggregate-statistics tests that the self-concealing interface predicts will read null — while a deviation *conditioned* on intention, task or subject remains live and would test the corridor itself ([[positions/quantum-interface#^mechanism-debt|P-Q3]])."
...
> "once objective reduction secures definiteness, **the measurement problem cannot itself be evidence for conscious selection**—the agency evidence ([[tenets#^bidirectional-interaction|Tenet 3]]) must carry that burden."
...
> "*Definiteness*: [[spontaneous-collapse-theories|objective collapse]] answers 'why one definite outcome?' without invoking any mind, so the measurement problem itself cannot be evidence for conscious selection. *Compatibility*: … the availability of that location is not evidence that consciousness occupies it. *Warrant*: the positive case that consciousness *does* act is carried by the agency arguments under [[tenets#^bidirectional-interaction|Bidirectional Interaction]]—the [[self-stultification|self-stultification of epiphenomenalism]] chief among them…"

**Proposed replacement, L51** (recast the second consideration from support to
permissibility):

> "Why think consciousness is a candidate for this role rather than some as-yet-unknown physical process? Two considerations make it one — neither of them evidence that it occupies the role. First, the [[hard-problem-of-consciousness|hard problem]] (Chalmers 1996) gives reason to think consciousness is real and irreducible to structure … Second, the measurement problem marks the point where structural description reaches its limit, which supplies the *permissibility condition* for a selection role rather than support for it: [[spontaneous-collapse-theories|objective collapse]] answers 'why one definite outcome?' without invoking any mind, so the measurement problem cannot itself be evidence for conscious selection ([[measurement-problem]]; [[tenets/background-commitments|background posit 2]]). Together they make consciousness a *motivated candidate* for the actualising role — the availability of the location, not evidence that consciousness fills it."

**Proposed replacement, L53:**

> "This does not mean consciousness is the *only* possible candidate, and the Map does not claim it is. A critic may argue that actualisation is simply a brute fact requiring no further explanation — that outcomes just happen with their Born-rule probabilities. The Map holds instead that definiteness has an account, but not that consciousness supplies it alone: [[prebiotic-collapse|physical objective reduction]] provides baseline collapse throughout the universe, prebiotically included, and consciousness *modulates* outcomes where a neural interface exists. The warrant for that modulating role is carried by the agency arguments under [[tenets#^bidirectional-interaction|Bidirectional Interaction]] — [[self-stultification|the self-stultification of epiphenomenalism]] chief among them — and not by the measurement problem ([[tenets#^tenet-3-standing|the Tenet 3 standing paragraph]])."
...
> "The [[dualism|positive arguments for dualism]] … **form a cumulative case for irreducibility that each opponent disputes at a different point, not a set of independent proofs converging on a settled conclusion. Tenet 1 records where the Map plants itself in an unsettled dispute; it does not report that dispute as won.**"

**Why it survived.** `tenets.md` **L171** quotes this very article approvingly for
its *scoping* half — "[[zombie-master-argument]] states the resulting discipline
...
settled result ([[tenets#^dualism|Tenet 1]]'s rationale). How much ground each
...
- L40: "…those pathways mark where the [[tenets#^bidirectional-interaction|bidirectional interaction]] between mind and matter **could** operate."
