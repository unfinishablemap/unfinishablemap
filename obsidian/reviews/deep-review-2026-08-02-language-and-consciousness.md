...
**Previous review**: [[deep-review-2026-06-20-language-and-consciousness|2026-06-20]]
**Review number**: 8
...
### Cross-links Added
- [[phenomenal-concepts-strategy]] gains a second in-body link from the new functionalism paragraph, tying the Expressibility section back to the Reference section's dilemma.
- [[functionalism]] link retained and its surrounding claim corrected, so the link no longer points at a page contradicting the sentence containing it.
