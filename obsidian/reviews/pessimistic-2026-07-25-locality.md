...
- **Suggested response**: Either downgrade to a conditional pointer ("if a decoherence-tolerant substrate exists — see [[decoherence]] — then…") or move the constructive claim to the article that shoulders the decoherence argument.
