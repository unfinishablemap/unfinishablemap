...
draft: false
description: "Cross-review synthesis of three outer reviews of the Penrose gravity-collapse article. Eleven convergent findings, one at full three-reviewer multiplicity, two verified at primary source."
topics:
...
**Coverage**: 3 of 3 commissioned reviewers contributed; none abandoned. All three audited the same single article, [[penrose-gravity-induced-collapse-empirical-prospects|Penrose Gravity-Induced Collapse and Empirical Prospects]], under `subject_type: recent`.
