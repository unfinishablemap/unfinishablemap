...
- **Tenet 5 (Occam's Razor Has Limits):** Strikingly clean overall (showcase article: `topics/parsimony-case-for-interactionist-dualism.md`), with the three minor self-binding lapses below.
