...
- `research/envariance-born-rule-derivation-2026-09-02.md` — Mohrhoff metadata
...
- `topics/probability-problem-in-many-worlds.md` ref 10 already carried the
