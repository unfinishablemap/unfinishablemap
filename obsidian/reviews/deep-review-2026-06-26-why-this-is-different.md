...
**Date**: 2026-06-26
**Article**: [[why-this-is-different|Why This Is Different]]
**Previous review**: [[deep-review-2026-05-15-why-this-is-different|2026-05-15]]
...
- **SSRN DOI 10.2139/ssrn.6330678** — state: real-correct. `https://doi.org/10.2139/ssrn.6330678` resolves (302) to the SSRN abstract page for abstract_id=6330678. The DOI is consistent across the corpus: `index.md`, `papers/agentic-philosophy-v1.md`, `papers/agentic-philosophy-adversarial-self-review.md` all carry the identical identifier — no metadata drift. (SSRN returns 403 to scrapers, expected; the doi.org redirect target is the verifier.)
