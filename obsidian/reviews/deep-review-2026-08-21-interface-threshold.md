...
**Previous reviews**: [[deep-review-2026-07-14-interface-threshold|2026-07-14]], [[deep-review-2026-06-02-interface-threshold|2026-06-02]], [[deep-review-2026-05-11c-interface-threshold|2026-05-11]]
...
**1. Internal cross-reference asserted sibling content that is not there.** The closing sentence of "The Cluster Prediction" claimed that "the five-capacity cluster is what [[minds-without-words]] catalogues as the operational marker of the architectural change." Grep on `obsidian/apex/minds-without-words.md`: `five-capacity` 0, `chaining` 0, `meaning-sensitive` 0. The sibling has no five-capacity construct at all; its five-item device is a five-*tier evidential scale*, a near-miss collision on the word "five".
...
- The qualitative-threshold ⊕ continuous-efficacy composition with [[interface-efficacy-and-the-cognitive-gap]], including the three-state subthreshold / at-threshold / above-threshold bullets.
