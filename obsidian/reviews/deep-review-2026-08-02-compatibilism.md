...
**Date**: 2026-08-02
**Article**: [[compatibilism|Compatibilism]]
**Previous review**: [[deep-review-2026-07-13-compatibilism|2026-07-13]] (create-time cross-review + independent publisher-of-record second pass)
...
- **Fischer (semicompatibilism)** — *Mode Three, honestly declared*. The article names it "the
  ...
  correctly **delegated** to [[the-manipulation-argument-and-hard-incompatibilism]] rather than
  re-derived — legitimate for a hub page.
- **Vihvelin (new dispositionalism)** — *Mode Three*, with the in-framework attack routed to
  [[the-consequence-argument-for-incompatibilism]]. See Remaining Items.
