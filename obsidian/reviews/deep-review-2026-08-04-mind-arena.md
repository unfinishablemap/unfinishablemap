...
**Previous review**: [[deep-review-2026-06-04-mind-arena|2026-06-04]]
...
- **Factual error about the source's structure** (fixed). The article described
  `topics/dualism-as-ai-risk-mitigation.md` as "the term's primary home, where it
...
- **Distributed quote attribution** (fixed). The article read: *When
  [[machine-consciousness]] and [[apex/machine-question]] reference "mind-arena
  ...
  - `apex/machine-question.md` L213 has "uncomputable rather than merely
...
- **New**: the "five of the six numbered sub-arguments" claim is now pinned to the
  ...
  `topics/dualism-as-ai-risk-mitigation.md` is ever restructured, this count needs
