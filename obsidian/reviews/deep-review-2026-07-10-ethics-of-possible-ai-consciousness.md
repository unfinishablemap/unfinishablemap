---
title: "Deep Review - The Ethics of Possible AI Consciousness (Butlin-2023 authorship family-resolution + publisher web-verify)"
created: 2026-07-10
modified: 2026-07-10
human_modified: null
...
**Previous review**: [[deep-review-2026-06-20-ethics-of-possible-ai-consciousness|2026-06-20]]
...
- `apex/machine-question.md` L127 — prose "with David Chalmers among its contributors" (of the 2023 report) → relocated to "a 2025 *Trends in Cognitive Sciences* successor—which David Chalmers joined."
- `apex/what-it-might-be-like-to-be-an-ai.md` L154 — prose "(2023, with Chalmers among its contributors)" → "(2023) and its 2025 ... successor (which David Chalmers joined)."
- `concepts/types-of-consciousness.md` L156 — reference "Butlin, P., Long, R., Chalmers, D. et al. (2023)" → real author-list + 2025-version note.
- `concepts/ai-epiphenomenalism.md` L146 — reference "Butlin, P., Long, R., Chalmers, D. et al. (2023)" → real author-list + 2025-version note.
