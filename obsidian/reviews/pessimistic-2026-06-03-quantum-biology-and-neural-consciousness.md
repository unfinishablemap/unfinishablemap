...
**Date**: 2026-06-03
**Content reviewed**: `topics/quantum-biology-and-neural-consciousness.md` (4046 words; last_deep_review 2026-06-01; ai_modified 2026-06-03)
...
- **File**: `topics/quantum-biology-and-neural-consciousness.md`
...
- **Corpus landscape**: The CORRECT attribution already exists — `concepts/quantum-consciousness.md` (line 156, ref #255) and `concepts/entanglement-binding-hypothesis.md` (lines 70, 127) both cite "Escolà-Gascón, Á. (2025)... *Computational and Structural Biotechnology Journal*, 30, 21-40". So this topic article regressed. A SEPARATE venue defect exists at `concepts/quantum-biology-and-neural-mechanisms.md` line 208, which has the right author (Escolà-Gascón) but the WRONG journal "*Scientific Reports*, 15, 9219". The research note `research/quantum-biology-neural-experimental-2026-03-20.md` (ref #6, line 223) lists the paper with no author and venue "PMC" — stale, research-note tier.
