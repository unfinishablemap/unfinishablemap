...
**Date**: 2026-09-09
**Article**: [[articulability-of-q1|The Articulability of Q1]]
**Previous review**: [[deep-review-2026-07-18-articulability-of-q1|2026-07-18]] (and [[deep-review-2026-06-03-articulability-of-q1|2026-06-03]])
...
`apex/interface-specification-programme.md` L112 ("the programme *adopts* the
...
`positions/ai-consciousness-scope.md` L58. This is a settled corpus-wide
...
`apex/dualism-cartography.md`, added by `be5f83dd18` and **deleted** by
...
### Cross-links Added
- [[anomalous-monism-and-the-denial-of-strict-psychophysical-laws]] (body,
  Further Reading, and `concepts:` frontmatter) — the page previously linked it by
  no form.
- [[apex/dualism-cartography]] promoted from Further-Reading-only to two
...
- Adversarial-persona disagreement here remains bedrock framework-boundary
  ...
  [[bedrock-clash-vs-absorption]], expected and NOT a correctable defect. Do not
  re-flag.
