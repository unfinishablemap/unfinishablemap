...
**Previous review**: [[deep-review-2026-07-15-constitutive-exclusion|2026-07-15]] (plus 2026-06-03, 2026-05-19, 2026-03-05b, 2026-03-05)
...
[[wheelers-participatory-universe-and-it-from-bit]], which had its own deep review on 2026-07-29, two weeks *after* this article's last pass — was confirmed and turned out to be the largest finding.
...
[[prebiotic-collapse]] states the opposite in terms:
...
### 4. "Dualism gains additional support" — possibility/probability slippage against live position P-V2
...
This is the tenet-as-evidence-upgrade move that the register books as a defect. [[positions/voids-as-evidence]] carries, status **live**:
...
- [[self-opacity]] (`ed7f535a0e`): "**Dualism** offers a reading of this void rather than receiving support from it. ... the tenets' ability to explain the opacity removes a defeater without adding weight (P-V2). What remains is a framework-level fit—hospitable to dualism rather than a proof of it..."
- [[phenomenology]] (`84fc70e3f8`): "supports all five of the Map's foundational commitments" was replaced with "bears on the Map's five foundational commitments **unevenly**..."
...
**Fixed**: rewritten to "offers a reading of the exclusion rather than receiving support from it," citing P-V2 (bare id, which autolinks) and adding the physicalist's competing prediction.
...
2. **Flat modal in the No Many Worlds paragraph** ("strengthens the exclusion"). Left as-is: the direction there is tenet → exclusion, not exclusion → tenet, so P-V2 does not bite. Recorded so a future pass does not re-open it without a reason.
