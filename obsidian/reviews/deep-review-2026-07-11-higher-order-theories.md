...
**Previous review**: [[deep-review-2026-06-04-higher-order-theories|2026-06-04]]
...
- **Ko & Lau 2012 blindsight paper** — the References carried
  ...
  **Family resolution:** the identical wrong cite propagated to
  `concepts/metacognition.md` (in-text L65 + References), `concepts/introspection.md`
  (References), and the research notes `research/metacognition-consciousness-2026-01-18.md`
...
- **Farrell 2018** — the References carried
  ...
  research note `research/higher-order-theories-consciousness-2026-01-14.md`
