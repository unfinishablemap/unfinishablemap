...
**Previous review**: [[deep-review-2026-05-19-human-supervision|2026-05-19]]
...
- **Missing cross-link to the methodology preprint**: `why-this-is-different.md` now cites the academic write-up of the adversarial self-review architecture ([[agentic-philosophy-adversarial-self-review]], DOI 10.2139/ssrn.6330678). This page — the deepest in-Map treatment of the supervision methodology — did not link to it. **Resolution applied**: added a sentence at the end of "Relation to Site Perspective" pointing to the preprint, and added it to `related_articles`.
...
- [[agentic-philosophy-adversarial-self-review]] (inline in Relation to Site Perspective + frontmatter)
