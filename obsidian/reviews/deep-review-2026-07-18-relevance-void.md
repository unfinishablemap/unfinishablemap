...
**Previous review**: [[deep-review-2026-06-04-relevance-void|2026-06-04]]
...
- **Family resolution**: the same "Hipólito & Hutto" misattribution of this paper existed in two sibling files. Propagated the canonical Andersen/Miller/Vervaeke form to `voids/mattering-void.md` (ref 7) and `research/voids-mattering-void-2026-02-19.md` (ref 10). The "Hipólito" mentions in `topics/predictive-self-binding-and-the-naturalist-challenge.md` and its research note are a *different, legitimate* reference (Hipólito as a 2019 Brains Blog "Self unbound" symposium commentator) — correctly left untouched.
