...
**Previous review**: [[deep-review-2026-05-17-post-decoherence-selection|2026-05-17]] (first full single-doc); [[deep-review-2026-03-29-post-decoherence-selection|2026-03-29]] (first-pass)
...
- **Out-of-scope cluster issue (carried from 2026-05-17, re-confirm)**: the fabricated "Luppi & Adlam, 2012" citation reportedly still appears in [[forward-in-time-conscious-selection]]. Out of scope for this single-file review; a `refine-draft`/deep-review of that topic article should fix it.
