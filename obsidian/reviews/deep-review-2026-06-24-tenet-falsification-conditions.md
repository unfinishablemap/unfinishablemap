...
**Date**: 2026-06-24
**Article**: [[tenet-falsification-conditions|Tenet Falsification Conditions]]
**Previous review**: [[deep-review-2026-05-26-tenet-falsification-conditions|2026-05-26 (Stability Recheck)]]
...
- `concepts/tenet-falsification-conditions.md` (this article) — inline L71 + References L113.
- `topics/falsification-roadmap-for-the-interface-model.md` (sibling) — inline L109 + References L207.
- `research/tenet-falsification-conditions-2026-04-05.md` (origin note) — heading L59, claim L175, References L293.
