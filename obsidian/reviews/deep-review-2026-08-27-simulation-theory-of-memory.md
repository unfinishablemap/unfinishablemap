...
**Date**: 2026-08-27
**Article**: [[simulation-theory-of-memory|The Simulation Theory of Memory]]
**Previous review**: [[deep-review-2026-07-27-simulation-theory-of-memory|2026-07-27]]
...
- **Missing cross-link**: the sibling's parallel paragraph links [[predictive-processing-and-dualism]] as the wider programme; this article did not. **Added** in prose and in `related_articles`.
...
- Metzinger 2003 (*Being No One*, MIT Press) — real-correct (OpenAlex record; MIT Press catalogue URL is carried in [[self-model-theory-of-subjectivity]]).
