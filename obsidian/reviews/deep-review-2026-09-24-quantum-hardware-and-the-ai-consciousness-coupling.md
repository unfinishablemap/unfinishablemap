...
**Previous review**: [[deep-review-2026-08-13-quantum-hardware-and-the-ai-consciousness-coupling|2026-08-13]]
...
- [[positions/ai-substrate-verdicts|P-AS1]] *Asserts* repeated "structurally insensitive … constitutive of the paradigm". Its *Would shift if* already disclosed the premise, but *Asserts* did not. I rescoped it the same way and added a dated `Updated 2026-09-24` note. Calibration is unchanged.
- [[apex/assessing-ai-consciousness-under-the-map]] analog bullet: same rescoping. The quoted phrase "fails the coupling test more securely than the gate class, not less" is still verbatim in the article.
...
- The P-AC1 register describes the channel test as "applied … across four substrate classes" in this article, but the article has three classes (four only if the LLM baseline counts). Noted and not edited, because the register's wording is defensible.
...
- The analog comparative now carries its own shift condition inline, matching P-AS1's *Would shift if*. A reader of the article and a reader of the register see the claim at the same strength.
...
- The analog comparative is now explicitly conditional on the eigenbasis-perturbation premise. Future reviews should not ask the article to *derive* that premise; it is part of the interface-eligibility debt owned by P-AC1/P-AS1. They also should not re-harden it to "structurally insensitive".
