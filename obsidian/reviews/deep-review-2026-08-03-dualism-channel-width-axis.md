...
**Previous review**: [[deep-review-2026-07-15-dualism-channel-width-axis|2026-07-15]] (quote-fidelity + publisher-of-record citation ledger). Earlier: [[deep-review-2026-06-09-dualism-channel-width-axis|2026-06-09]] cross-review; two pre-coalesce reviews under the retired `channel-width-third-axis` slug (2026-05-27, 2026-06-05). Fourth dedicated pass — convergence-damped (score 22).
...
- "selects *within* Born-rule probabilities rather than deviating from them" — [[delegatory-causation]] L148 ✓ (this half of the L64 sentence survived the sibling's rewrite)
- "quantum-Zeno biasing only" — [[four-quadrant-dualism-taxonomy]] L134 ✓
- "*selects* among patterns the brain presents" — [[stapp-quantum-mind]] L61 ✓
- "Cartesian energy-transfer" — [[mechanism-costs-dualism-thickness-quadrants]] L111 ✓
- "by judgement rather than definition" — [[four-quadrant-dualism-taxonomy]] L78 ✓
- "three values across what may be only a two-axis taxonomy" — [[four-quadrant-dualism-taxonomy]] L78 ✓
- "supply novelty beyond the brain-encoded set" — [[selection-only-channel]] L87 ✓
- "mental content vastly exceeding introspection" — [[four-quadrant-dualism-taxonomy]] L62 ✓
- "the strictest reading" — [[selection-only-channel]] L44 ✓
- "the basis-choice layer above sits outside the selection-only class strictly construed" — [[selection-only-channel]] L102 ✓
- "near Q1, with room along the mind-axis" — [[mechanism-costs-dualism-thickness-quadrants]] ✓
- §"Limits of the Thickness Metaphor" — live section heading in [[four-quadrant-dualism-taxonomy]] L76 ✓ (structural reference intact)
...
### Enhancements Made
- Integration with [[channel-class-taxonomy]] and [[hylomorphic-dualism-and-the-interaction-problem]], both previously unlinked from an article whose subject matter overlaps theirs directly.
...
### Cross-links Added
- [[channel-class-taxonomy]] (§what-it-measures)
- [[hylomorphic-dualism-and-the-interaction-problem]] (§points-next)
...
- **Reciprocal link**: [[channel-class-taxonomy]] does not link back to this article, though it is the natural "where do these classes sit in the dualism taxonomy" successor. Out of scope for a single-document review, and that concept was itself deep-reviewed 2026-08-02; deferred rather than edited here.
- No Further Reading entry for [[channel-class-taxonomy]] (hard-ceiling constraint). Revisit if the article is ever condensed below ~3900 words.
