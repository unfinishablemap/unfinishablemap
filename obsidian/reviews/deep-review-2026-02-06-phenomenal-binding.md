...
**Previous review**: [[deep-review-2026-01-24-phenomenal-binding|2026-01-24]]
...
Investigation revealed that `phenomenal-binding.md` was **coalesced into [[binding-problem|The Binding Problem]]** on 2026-01-26. The coalesce operation:
...
### Cross-links Added
- psychophysical-coupling.md → [[binding-problem]]
- baseline-cognition.md → [[binding-problem]] (inline)
- intentionality.md → [[binding-problem]] (frontmatter + inline + Further Reading)
- language-recursion-and-consciousness.md → [[binding-problem]] (inline)
