...
**Previous review**: [[deep-review-2026-04-23-conservation-laws-and-mental-causation|2026-04-23]]
...
- `concepts/conservation-laws-and-mental-causation.md` (target — Pitts, Georgiev, Collins all fixed)
- `concepts/objections-to-interactionism.md` (Pitts → 2020/48(2)/673-707)
- `topics/history-of-the-interaction-problem.md` (Pitts → 2020/48(2)/673-707)
- `topics/mechanism-costs-dualism-thickness-quadrants.md` (Pitts — had the *second* fabricated range 2599-2629 → 2020/48(2)/673-707)
- `topics/causal-closure-debate-historical-survey.md` — different defect: its **Pitts *Erkenntnis* (2022)** entry had wrong pages **1861-1892 → corrected to 1931-1973** (Erkenntnis 87(4), 2022, DOI 10.1007/s10670-020-00284-7, verified PubMed). Its in-text "Pitts (2022)" correctly maps to the Erkenntnis entry, left as-is. Its Cucu & Pitts Mind & Matter 17(1):95-121 entry verified correct.
- `research/conservation-laws-mind-brain-causation-2026-01-23.md` (Pitts, Georgiev, Collins all fixed)
