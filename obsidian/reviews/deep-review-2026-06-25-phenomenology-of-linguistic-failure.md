...
- Calibration clean: the three failure modes (approximation / mismatch / muteness / dissolution) and the recursion-as-datum argument are framed as phenomenological observations bearing on the functional-reduction question, not as smuggled positive proof; honours [[evidential-status-discipline]]. No possibility→probability slippage. The Nagel/Levine deployment supports the hard/easy-problem divide without over-claiming.
