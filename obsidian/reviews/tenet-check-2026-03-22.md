...
Comprehensive scan of all 229 topic files and 219 concept files against the five foundational tenets. The corpus is exceptionally well-aligned. Every article includes explicit "Relation to Site Perspective" sections connecting content to the tenets. Opposing views (materialism, epiphenomenalism, MWI, functionalism, illusionism, Russellian monism) are consistently discussed to argue against them, not endorsed.

One warning-level issue was found where epiphenomenal upload-consciousness is presented as a live open possibility rather than a tenet-excluded position. Two note-level issues involve a broken tenet wikilink anchor and insufficient disambiguation of a framework that conflicts with bidirectional interaction.
...
- **Quote**: "Koch's framework [...] consciousness arises at the moment of superposition *formation*, not at collapse"
...
## Housekeeping (Non-Tenet Issues)

The following files contain stale AI refinement logs (HTML comments marked "remove after human review") or editorial artifacts:

- `language-recursion-and-consciousness.md` — Inline editorial comment visible in body: `[Andy: I've no idea how it came up with this 🤷‍♂️]`
- `personal-identity.md` — Stale AI refinement log in HTML comment (lines ~243–253)
- `trilemma-of-selection.md` — AI refinement log present
- `valence-as-selection-currency.md` — AI refinement log present
- `quantum-biology-and-neural-consciousness.md` — AI refinement log present
- `quantum-measurement-and-subjective-probability.md` — AI refinement log present
- `resolution-bandwidth-interface.md` — AI refinement log present
- `split-brain-consciousness.md` — AI refinement log present

## Files Passing All Checks

All 448 files pass tenet alignment checks except the 3 listed above (1 warning, 2 notes). The remaining 445 files show no errors, warnings, or notes regarding tenet alignment.
