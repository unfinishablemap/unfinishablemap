...
description: "Eleventh deep review (cosmetic-cross-link no-op): verifies three Further Reading link edits since 2026-06-22 resolve; body prose untouched, citations not re-litigated. Confirming, no content edit."
created: 2026-07-17
modified: 2026-07-17
human_modified: null
ai_modified: 2026-07-17T18:20:42+00:00
draft: false
topics: []
concepts: []
related_articles: []
...
**Previous review**: [[deep-review-2026-06-22-knowledge-argument|2026-06-22]] (tenth; verified the Dennett counter-burden paragraph + x-phi prevalence recalibration)
...
- `concepts/kripke-a-posteriori-necessity-argument.md` — **exists** ✓
- `topics/aesthetic-testimony-and-the-acquaintance-principle.md` — **exists** ✓
- Retargeted `phenomenal-concepts-strategy` (`concepts/phenomenal-concepts-strategy.md`) — **exists** ✓; the coalesce correctly repointed the old `phenomenal-concepts-as-materialist-response` link to its merge target. No dangling reference to the archived slug remains in the article (grep count = 0).
