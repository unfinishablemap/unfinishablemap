...
**Previous review**: [[deep-review-2026-07-07-mental-effort|2026-07-07]]
...
**The Tallis quote is fabricated-as-verbatim at 15 further live loci.** Not touched — each needs its own context-sensitive rewording and this is a single-file review. Loci: `concepts/illusionism.md` L89, `concepts/experiential-alignment.md` L151, `concepts/semantic-memory.md` L130, `concepts/neural-correlates-of-consciousness.md` L126, `concepts/psychophysical-laws.md` L213, `concepts/dualism.md` L143, `concepts/sleep-and-consciousness.md` L122, `concepts/phenomenology-of-choice-and-volition.md` L146, `concepts/witness-consciousness.md` L143, `topics/epistemic-advantages-of-dualism.md` L112, `topics/attention-and-the-consciousness-interface.md` L98, `topics/consciousness-in-simple-organisms.md` L191, `topics/meaning-of-life.md` L162, `apex/attention-as-causal-bridge.md` L136, `arguments/many-worlds-argument.md` L156. Three further loci (`concepts/phenomenal-concepts-strategy.md` L149, `concepts/luck-objection.md` L126, `research/illusionism-consciousness-2026-01-14.md` L146) already use the phrase **unquoted** as prose and need no change — these are likely the uncorrupted originals.
