...
The self does not exist first and then remember; it becomes temporally extended *through* remembering. Before memory connects present experience to past there is the [[self-and-self-consciousness|minimal self]]—bare first-person perspective—which memory transforms into a self with a history, a trajectory, a life. The Map's [[temporal-consciousness-structure-and-agency|temporal constitution thesis]] treats this as one of several convergent demonstrations that consciousness actively constitutes temporal structure rather than merely inhabiting it.

**Narrative integration**: Individual memories organise into patterns through recall—themes emerge, turning points crystallise—and the resulting [[narrative-coherence|personal narrative]] is the structure through which the self understands itself as having developed. [[diachronic-agency-and-personal-narrative|Diachronic agency]] depends on it: you sustain projects because memory connects past commitment to present effort.
...
What the case reveals is the *aspiration* built into the memory-self relationship: the self seeks its own past as experience rather than information—it wants to re-live, not just recall. The [[inaccessible-past]] sits at this boundary, and the forward-directed counterpart is [[phenomenology-of-anticipation|anticipation]].
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** finds expression in memory's constitutive role. If consciousness merely *accompanied* neural processes, the self-encounter of remembering would be epiphenomenal. But the self that remembers also *revises*: reinterpreting past events and sustaining commitments that influence future choices.

**[[tenets#^no-many-worlds|No Many Worlds]]** records conditional consistency here rather than support drawn from memory. Nothing in memory phenomenology discriminates a single-world physics from an Everettian one; both ontologies predict identical first-person reports. The Map's indexical objection—that the self claims not "I have *a* past" but "I have *this* past and no other"—bites only once the [[haecceity]] auxiliary is in place, as the section on mineness above concedes. Memory phenomenology is compatible with the tenet; it does not argue for it.
