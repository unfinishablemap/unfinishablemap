...
modified: 2026-02-15
human_modified:
ai_modified: 2026-08-04T08:04:00+00:00
draft: false
topics:
  - "[[personal-identity]]"
...
The self does not exist first and then remember; it becomes temporally extended *through* remembering. Before memory does its work there is the [[self-and-self-consciousness|minimal self]]—bare first-person perspective—which memory transforms into a self with a history. The Map's [[temporal-consciousness-structure-and-agency|temporal constitution thesis]] treats this as one of several convergent demonstrations that consciousness actively constitutes temporal structure rather than merely inhabiting it.

**Narrative integration**: Individual memories organise into patterns through recall, and the resulting [[narrative-coherence|personal narrative]] is the structure through which the self understands itself as having developed. [[diachronic-agency-and-personal-narrative|Diachronic agency]] depends on it: you sustain projects because memory connects past commitment to present effort.
...
Proust's involuntary memory—the madeleine in tea—suggests the past can sometimes break through construction and deliver something closer to re-experience. Whether such moments recover past qualia or generate exceptionally vivid simulations is unresolvable: the reported intensity of "being back there" could equally reflect present construction. What the case reveals is the *aspiration* in the memory-self relationship: the self seeks its own past as experience rather than information. The [[inaccessible-past]] sits at this boundary, and the forward-directed counterpart is [[phenomenology-of-anticipation|anticipation]].
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]** binds the Map's use of parsimony as tightly as its critics', and it matters here because the reality of a primitive pastness quale is precisely what is contested. The Map therefore cannot dismiss the [[#deflationary-readings-of-pastness|deflationary readings]] as suspiciously simple, any more than the deflationist can dismiss a primitive quale as extravagant. With knowledge this incomplete, parsimony decides nothing in either direction. What remains is an explanatory debt rather than a simplicity complaint: a cognitive-tag account owes a story about why the tag is experienced, and helping itself to that step is the unsupported move. The [[#hostile-review-steelman-counters|self-model steelman above]] is that rival in its strongest form, and it is the one this article has to answer—not eliminativism.
...
- [[phenomenal-authority-and-first-person-evidence]]
- [[memory-anomalies]] — Déjà vu, jamais vu, cryptomnesia as separable phenomenal ingredients
- [[phenomenology-of-forgetting]] — The felt experience of forgetting, and how it shapes the remembered self
