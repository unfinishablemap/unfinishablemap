...
description: "Berridge's wanting/liking dissociation refutes a single value-currency in the brain—but does it locate affective value in the mechanism or in the experience? An honest fork, calibrated."
created: 2026-06-05
modified: 2026-08-27
human_modified:
...
The Unfinishable Map lays an *interpretive* question over this settled base, the **value-in-mechanism fork** (defined below): when a reward is good or a pain is bad, does that affective value reside in the neural mechanism itself, or in the conscious experience the mechanism is associated with? The honest answer this article defends: the dissociation **constrains** the space of accounts—it rules out any naive "dopamine = pleasure = value" picture and is strong evidence that motivation and hedonic impact are mechanistically separable—but it does **not** by itself settle the fork. A mechanism-only physicalist reading appears to explain every Berridge finding without remainder. The data sharpen the question; they do not seem to answer it. A shared terminology map (explained below) fixes how Berridge's constructs relate to the utility and reinforcement-learning vocabulary of [[affective-forecasting-gap]], so that "wanting", prediction and conscious pleasure keep one meaning whichever page a reader opens first.

## The Empirical Dissociation

The core finding is a clean double role for reward. Berridge and Robinson (1998) argued that mesolimbic dopamine does not mediate the *hedonic impact* of rewards at all. Instead it mediates **incentive salience**—"wanting," the attribution of motivational value to reward-associated stimuli—which is separable both from pleasure and from reward-prediction learning. The quotation marks Berridge places around "wanting" and "liking" are deliberate: they are labels for *core processes*, bracketing the question of whether either is consciously felt.
...
## The Value-in-Mechanism Fork {#the-fork}
...
This article and [[affective-forecasting-gap]] draw on three vocabularies—Berridge's affective neuroscience, Kahneman's utility taxonomy and reinforcement learning—that a reader can easily run together. The map below is canonical for both pages: each term keeps this meaning wherever the valence cluster uses it.

| Term | Source | What it names | Felt as such? | Place in the two questions |
|---|---|---|---|---|
| Predicted utility | Kahneman & Snell 1992 | A judgement of the experienced utility an outcome will have; the *object* of what [[affective-forecasting-gap]] calls anticipated valence | Only insofar as present anticipatory affect (below) carries it | The fallible forecast a selector might consult |
...
| Learned value (V/Q) | Reinforcement learning; see [[reinforcement-learning-reward-signals-and-machine-valence]] | A cached estimate of expected reward, updated by δ, that a predictor-driven chooser consults | No | The value-blind rival's chooser input |
| Reward-prediction error (δ) | Schultz 2016 | The difference between received and predicted reward, coded by many midbrain dopamine neurons; the teaching signal that updates learned value | Contested—see [[affective-forecasting-gap]] | An update, not what a chooser consults |
...
| Present anticipatory affect | [[affective-forecasting-gap]] | The dread or relish felt *now* while simulating an outcome—anticipated in its object, experienced in its vehicle; an instant utility of its own | Yes | The forecasting article's candidate selection currency; the felt vehicle of predicted utility |
...
The fork engages **Tenet 3 (Bidirectional Interaction)** at the level of mechanism investigation. If consciousness causally influences the physical world, the most plausible place for that influence in the reward domain is **selection**: among the live action-options the mechanism prepares, felt value tips which one becomes actual (see [[valence-and-conscious-selection]] and [[dopamine-and-the-unified-interface]]). On this reading, dopaminergic "wanting" sets up the field of weighted options, and conscious hedonic value does selective work the mechanism alone does not.

This is a tenet-coherent *hypothesis*, not a finding—and it must carry explicit falsification conditions to stay honest. The value-sensitive-selection option predicts that:

- **When wanting and liking conflict, liking (felt quality) should track which outcome is selected.** If choices were instead fully predicted by the wanting/incentive-salience signal with felt liking adding nothing, the value-sensitive reading would be disconfirmed for that case.
...
- [[affective-forecasting-gap]] — The forecasting form of the predicted≠experienced-value structure: anticipated valence diverges from experienced valence. A different cut from wanting/liking—"wanting" is not a forecast of "liking" (Berridge 2023)—reconciled in the shared terminology map above
...
2. Peciña, S., & Berridge, K. C. (2005). Hedonic hot spot in nucleus accumbens shell: where do μ-opioids cause increased hedonic impact of sweetness? *Journal of Neuroscience*, 25(50), 11777–11786. https://doi.org/10.1523/JNEUROSCI.2329-05.2005
