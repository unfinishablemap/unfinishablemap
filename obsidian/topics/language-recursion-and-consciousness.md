...
The [[consciousness-as-amplifier|consciousness-as-amplifier hypothesis]] treats WM expansion as a key mechanism through which consciousness transforms cognition. The [[consciousness-and-intelligence|consciousness threshold]] article argues this expansion marks a phase transition in how consciousness couples with neural architecture. Recursion may be the paradigm case: the expansion from ape to human WM capacity enables recursive linguistic structure that would otherwise exceed cognitive bandwidth.
