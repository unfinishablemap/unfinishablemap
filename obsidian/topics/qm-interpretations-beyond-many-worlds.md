...
Three considerations weigh against Bohmian mechanics from the Map's perspective. First, its determinism conflicts with the phenomenology of effort and choice that the Map takes seriously—under Bohmian mechanics, the felt experience of deliberation is illusory. Second, it requires instantaneous non-local influences to explain entanglement, creating tension with special relativity that collapse interpretations avoid. Third, Bohmians add hidden variables to eliminate the measurement problem, but if consciousness already provides a principled account of measurement, those additional variables are unnecessary—Occam's Razor, which Bohmians typically invoke against collapse, cuts both ways.

## QBism: Agent-Centered but Anti-Realist
