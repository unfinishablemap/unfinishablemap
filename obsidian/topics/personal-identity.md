...
modified: 2026-01-20
human_modified: null
ai_modified: 2026-05-27T00:25:49+00:00
draft: false
topics:
...
Derek Parfit argued that personal identity isn't what matters—psychological connectedness and continuity are, regardless of whether these amount to identity. Imagine teletransportation: your body is scanned, destroyed, and recreated. The resulting person has all your memories. Parfit says "Is that person you?" may have no determinate answer—and it doesn't matter.

On [[parfit-reductionism|Parfit's "reductionist" view]], personal identity consists in nothing over and above bodily and psychological continuity—no soul, no ego, just brain, body, and interrelated mental events. The dedicated [[parfit-reductionism]] article develops the Map's critique: patterns don't make choices (consciousnesses do), zombie conceivability shows identity involves something beyond continuity, and causal history gives content to indexical identity.

## Why the Map Disagrees

The Map cannot accept Parfit's reductionism. The tenets are the Map's foundational starting point, and they orient it toward a stronger view of personal identity—one on which *this* conscious being, not merely the pattern it instantiates, is what matters. That starting point is not by itself a refutation of Parfit; reductionism is a coherent position that an opponent can hold without internal contradiction. The argument that engages Parfit on his own terms—the conceivability and causal-history considerations—comes in [[#arguing-for-haecceity|Arguing for Haecceity]] below. What the tenets supply here is the motivation for undertaking that argument, not its conclusion.
...
This dissolution is what the Map rejects. You find yourself in exactly one outcome—being the one who sees *this* result rather than *that* one seems factual, but many-worlds says it is not. The Map's response is not to answer "which of the many equally-real branches is really me?" on the many-worlds picture, but to deny the picture: there is one actual outcome, not a fan of co-real ones, so the indexical fact is simply the fact about which outcome this perspective undergoes. If instead identity fragments across infinite branches with no fact about which is "really" you, identity becomes incoherent. (The relation between this branching question and the structurally similar fission question is taken up in [[#the-fission-problem-revisited|The Fission Problem Revisited]]; the two get different verdicts because fission is a real division of substrate the perspective cannot survive, whereas branching is a postulated division the Map declines to grant.)
...
1. **The conceivability argument**: A zombie—physically and functionally identical to me but lacking consciousness—is conceivable (Chalmers 1996). If conceivable, then consciousness is not determined by physical/functional properties. On the conceivability argument, this is taken to show that consciousness involves something beyond the qualitative profile captured by physics—though the inference is contested, most notably by the [[phenomenal-concepts-strategy|phenomenal concepts strategy]], on which the conceivability gap reflects how we represent physical facts rather than a gap in the facts themselves. A further step is needed to reach haecceity: if what makes me conscious at all isn't fixed by my qualitative properties, then what makes me *this* conscious being rather than another—equally non-physical—conscious being is also unlikely to be qualitatively determined. This further step is an inference to the best explanation, not an entailment, and it inherits whatever vulnerabilities the conceivability premise carries. So the conceivability argument doesn't prove haecceity on its own; what it does, if it succeeds, is open logical space for non-qualitative individuation by showing that the relevant facts about consciousness already outrun qualitative description.

2. **The causal argument**: If consciousness causally influences physical outcomes (per the Bidirectional Interaction tenet), then *this* consciousness has a unique causal history. The replica's consciousness, even if qualitatively identical, would begin its causal engagement from creation, not from my birth. A clarification is needed to keep this argument from proving too little. Distinct causal history individuates *tokens* trivially—two qualitatively identical billiard balls also have distinct histories, yet we ascribe them no haecceity. So causal history is not offered as what *generates* thisness from nothing; that would collapse into the ordinary numerical non-identity Parfit already grants. The argument is the other way around: *given* that the conceivability consideration (point 1) has opened logical space for a non-qualitative indexical particular, causal history is what gives that particular determinate *content*—a specific lived trajectory of selections and influences that this perspective, and no replica, has undergone. Causal history individuates the already-posited particular; it does not conjure the particular into being.
...
**The error theory worry**: Could the sense of haecceity be a cognitive illusion? The illusionist challenge raises this directly. But if our sense of haecceity is illusory, what is having that illusion? This is the "seeming requires a subject" regress, engaged in full in [[#the-illusionist-challenge|The Illusionist Challenge]] below—including the deflationary reply that the apparent subject is itself represented content, and why the Map takes that reply to relabel the regress rather than halt it. The point relevant here is narrower: the error-theorist who claims our haecceity-sense is mere illusion still owes an account of what undergoes the illusion, and the Map's wager is that the stable terminus carries the very particularity the illusion was supposed to manufacture.
...
On the Map's framework, personal identity involves:

1. **Consciousness persistence**: The continuation of *this* conscious perspective, not merely the continuation of psychological patterns that could in principle be replicated.
...
How does this handle fission? If your brain were split and each hemisphere continued separately, neither resulting person would be you. Your consciousness—the particular conscious perspective that makes you you—cannot split. One or both resulting consciousnesses would be new, not continuations of yours.

This aligns with Parfit's conclusion but for different reasons. Parfit says identity can't "branch"—a logical truth. The Map says your consciousness is a particular that can't divide like physical stuff. The resulting people might have your memories and believe they're you, but the unique conscious perspective that constituted you would have ended.

A critic will press an apparent inconsistency. The [[#the-no-many-worlds-connection|No Many Worlds]] argument above treats "which branch am I in?" as a meaningful, answer-having question, yet here the fission question ("which post-split person is really me?") is dissolved rather than answered. If branching and fission share the same form—one pre-split subject, multiple post-split continuers—why does one get a fact of the matter and the other does not? The two cases are distinguished on principled grounds rather than left to differ by stipulation. In fission, what divides is the *substrate*: the brain is physically bisected, and the question is which (if either) of two new physical-and-psychological continuers inherits the original perspective. The Map's answer is that neither does, because the perspective is a particular that does not survive substrate division—exactly the dissolution Parfit's logic also reaches. In quantum branching, by contrast, the substrate is not divided at all on the Map's reading: there is one physical history, one definite outcome, and one perspective that occupies it. What the Map rejects is the many-worlds *postulate* that the perspective itself multiplies into equally-real copies. The question "which branch am I in?" is meaningful precisely because the Map denies that branching occurs—there is one actual outcome, and the indexical fact is the fact about which outcome this perspective undergoes. So the asymmetry is not arbitrary: fission is a real division that the indexical perspective cannot survive, whereas quantum "branching" is a posited division the Map declines to grant, leaving a single perspective whose location is a genuine fact. The honest residue is that this distinction is a *commitment* of the framework, not a neutral result: a Deutsch-style critic who already accepts branch-multiplication will read the fission verdict as conceding their point and press for the symmetric dissolution of the branching question. The Map's reply is that the two cases differ in whether the division is real or merely postulated, and that it is entitled to deny the postulate—but it does not pretend to have refuted the many-worlds reading on the many-worlds reading's own terms.
...
The illusionist position faces what the Map takes to be a fundamental problem: for something to *seem* a certain way, there must be a subject to whom it seems. Even if my sense of being a continuous self is cognitive construction, *something* is having that sense. The illusionist cannot escape the indexical question by dissolving consciousness—the dissolution must happen *somewhere*, to *someone*. This "seeming requires a subject" regress is the Map's primary reply to both illusionism and anti-haecceitism, so it is worth stating its strongest rebuttal and answering it once, rather than re-asserting the regress wherever the issue recurs.

The deflationary rebuttal (Dennett 1991; Frankish 2016) is that the "subject to whom it seems" is itself represented content—a center of narrative gravity the brain models, not a metaphysically primitive experiencer. On this reading there is no regress to a real terminus: the apparent subject is one more item in the representation, so pointing to "the one for whom it seems" just points back into the model. The Map's response is that this move either stops the regress or it does not. If the represented "subject" is itself only a further seeming, then *that* seeming requires something for which it is a seeming, and the deflationary account has relabelled the regress rather than halted it. If instead the deflationist holds that representational tokening can occur with no subject for whom anything is like anything—representation "all the way down" with no occurrence of experience—then the position has become eliminativism about phenomenal consciousness, not a deflation of the subject, and it inherits eliminativism's burden (engaged in [[illusionism]] and, on the regress specifically, in [[apophatic-cartography]]). The Map does not claim this refutes the deflationary reading on its own terms; the deflationist who is prepared to deny that there is anything it is like to undergo the seeming can hold the line consistently. What the Map claims is narrower: the regress is not answered by *relabelling* the subject as content, and the only stable place to stop it is a commitment—experience occurs, and its occurring is for someone—that illusionism is committed to denying. That is a genuine framework-boundary disagreement, marked as such.

Granting this single engagement, the further point is dialectical rather than metaphysical: the illusionist arguing against personal identity must, in practice, assume their own identity throughout the argument. *This* illusionist expects *you* to follow *their* reasoning. The very act of philosophical argument presupposes the indexical facts it purports to deny—though a deflationist will reply, consistently with the above, that "presupposes" here means "is most naturally described in first-person terms," not "logically requires a primitive subject."

Could the sense of haecceity specifically be a cognitive illusion—perhaps evolution wired us to resist destruction, and the intuition that replicas wouldn't be "us" is merely a survival instinct side-effect? Three considerations are offered against this, with the caveat that none is decisive and an error theorist can resist each: (1) the error theory still requires a subject whose intuitions are being explained (the regress engaged above), so it does not obviously dissolve the particularity it targets; (2) the haecceity intuition discriminates between teletransportation and ordinary death in ways mere survival instinct wouldn't predict—though an eliminativist will reply that this is just a description of how a finely-tuned death-avoidance circuit fires, not evidence of a tracked particular; (3) unlike other self-related intuitions we've revised (that memory is reliable, that preferences are stable), the haecceity intuition persists through reflection. Reflection-stability is suggestive but not probative: a deeply-wired non-referring representation would feel exactly this stable, so persistence-through-reflection is consistent both with tracking something real and with being an evolved fixed point with no metaphysical referent. The most this third consideration earns is that the intuition is not easily corrected away, not that it tracks a particular.
...
Three considerations mitigate this: the decoherence timescale estimates are model-dependent and the relevant calculations may be off by orders of magnitude (see [[quantum-neural-timing-constraints]] for the femtosecond-versus-required-timescale arithmetic and where the estimates are sensitive to assumptions); decoherence doesn't explain why we see definite outcomes; and the [[attention-as-interface|quantum Zeno mechanism]] suggests consciousness operates through rapid observation, not sustained coherence. Even if the quantum mechanism proves untenable, the conceptual point stands: personal identity involves *this* subject having experiences and making choices, regardless of the specific non-physical interface.

## Implications for Survival

What does survival require? As discussed in [[death-and-consciousness]], the Map's framework makes survival after bodily death a coherent possibility—but only if indexical identity is preserved. Resurrection through mere recreation would yield a duplicate, not you.

**Teletransportation**: You die. The replica has your memories but a different consciousness—not yours continued.

**Gradual replacement**: You might survive neuron-by-neuron replacement if it preserves the same consciousness, not merely functional equivalence.
...
These conclusions follow *if* consciousness is non-reducible and indexical identity is real; they are conditional on the framework, not free-standing results.

## The Meaning Connection

Personal identity matters for life's meaning. The [[meaning-of-life|meaning of life]] article argues that meaning is grounded in consciousness—in the intrinsic significance of conscious experience. But whose consciousness?
...
Personal identity exemplifies the Map's framework and connects to all five tenets.

**[[tenets#^dualism|Dualism]]**: If consciousness is irreducible to physical processes, personal identity cannot be purely physical or functional. A zombie duplicate would share all physical and functional properties but lack consciousness—and therefore lack *your* identity. This would show, on the dualist premise, that identity involves something non-physical: *this* conscious perspective.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: the Map's proposed mechanism for consciousness-matter interaction has implications for identity. If *this* consciousness makes *these* quantum selections, the selecting consciousness has a unique causal history. A replica's consciousness would begin a new history from its moment of creation—making it a new agent, not you continued. The [[decoherence|decoherence challenge]] complicates but doesn't eliminate this picture. However, as the [[measurement-problem]] article acknowledges, consciousness-selection within Born probabilities is empirically indistinguishable from random collapse—the quantum mechanism is a philosophical framework, not a testable hypothesis. The identity argument doesn't depend on quantum mechanics specifically: any non-physical causal contribution would individuate consciousness through its unique history.
