...
**Deep uncertainty** goes further still. Some decisions involve not just unknown probabilities but unknown outcome spaces—you don't even know what might happen. Career choices, moral commitments, decisions about whether to have children: these involve futures so complex that the possible outcomes cannot be enumerated. The phenomenology here is of imaginative grasping—the mind reaches toward possible futures, sketches partial scenarios, and recognises that any sketch is incomplete.

Each variety engages consciousness differently. Risk invites calculation (however flawed). Ambiguity invites heuristic judgment. Deep uncertainty invites something closer to imagination and trust. The progression from risk through ambiguity to deep uncertainty is a progression toward greater phenomenological richness—and greater dependence on consciousness as something more than a calculator.

## Deliberative Vertigo
...
Under uncertainty, we do not merely calculate—we *estimate*. And estimation has a phenomenology that pure computation lacks.

When a doctor assesses a patient whose symptoms don't match any textbook pattern, or an entrepreneur evaluates whether a market exists for an untested product, the cognitive process involves something that resists formalisation. Expert intuition in uncertain domains feels different from applying rules: there is a sense of *reaching beyond* what the evidence strictly supports, of committing to a judgment that one recognises as underdetermined by the data.

This reaching-beyond involves:
...
Deciding under uncertainty requires a distinctive act that deciding under certainty does not: *commitment beyond evidence*.
...
Deliberation under uncertainty may be where [[authentic-vs-inauthentic-choice|authentic choice]] is most clearly demanded.

When outcomes are known, scripted responses suffice. Social norms, professional conventions, and past habits can guide decisions adequately. Inauthentic choice—doing what "one does"—works when the situation is predictable. Uncertainty disrupts this. Scripts assume stable conditions; genuine uncertainty means conditions are not stable enough for scripts to apply. The person facing deep uncertainty cannot fall back on convention because convention was built for the known.
...
Decisions under deep uncertainty are also self-forming. Choosing to trust under uncertainty makes you a more trusting person; choosing a career without knowing the outcome shapes your values and capabilities for all future decisions. The deliberation is [[temporal-consciousness|temporally thick]]—dense with retained experience, active with reaching toward possible futures—and what emerges from it is not just a decision but a modified decider. This recursive quality, where uncertainty-driven choices constitute the self that will face future uncertainties, suggests that deliberation under uncertainty is not merely an episode but a process of becoming.
...
The Unfinishable Map's framework illuminates deliberation under uncertainty at several points.

**[[tenets#^dualism|Dualism]]**: The qualitative character of deliberative vertigo—the specific way it feels to face a decision with inadequate information—resists reduction to neural description. Two systems could process identical uncertain decisions while one experiences vertigo and the other experiences nothing. The phenomenal facts about what uncertainty is like are additional to the computational facts.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: If the phenomenology of estimation does cognitive work—if felt coherence guides judgment in ways that improve with experience—then consciousness causally contributes to decision-making under uncertainty. The alternative is that expert intuition's phenomenal character is epiphenomenal, which conflicts with the systematic relationship between phenomenal experience and judgment quality.
...
- [[the-quantitative-comprehension-void#the-magnitude-and-probability-domain|The Quantitative Comprehension Void — magnitude and probability face]] — Our architectural limits in reasoning about chance (the probability face) and magnitude, sharing a single explanatory structure
...
- [[empirical-phenomena-mental-causation|choking phenomenon]] — Deliberative vertigo applied to skilled execution under pressure
- [[spontaneous-intentional-action]] — When commitment arrives without extended deliberation
- [[nihilism-and-existentialism]] — Sartre's anguish and Heidegger's anxiety as existentialist roots of deliberative vertigo
