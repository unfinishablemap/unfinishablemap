...
description: "Perception depends on lawful patterns between movement and sensation. These sensorimotor contingencies map the interface through which consciousness engages the physical world."
created: 2026-02-15
modified: 2026-02-18
human_modified:
...
This article extends the Map's [[embodied-consciousness|general treatment of embodied cognition and the interface]] by examining the specific phenomenological and empirical details that sensorimotor contingency theory provides. Where the general treatment suggests that embodiment reveals the interface rather than eliminating the soul, this article traces *how* the interface might operate at the level of bodily engagement — recognising throughout that the interface reading is a live hypothesis the sensorimotor evidence is compatible with rather than uniquely confirms.
...
Phantom limb pain makes this vivid. After amputation, the body schema retains the lost limb as a felt capacity. The phantom appears, on the phenomenological reading, less like a hallucination in the ordinary sense and more like the body-subject's persistent orientation toward a world it can no longer engage through the missing limb. On the Map's [[filter-theory|filter reading]], this is the sort of pattern one might expect: the interface seems to have a structure that is correlated with but possibly not identical to the body's current physical configuration. A productivist reading accommodates the same data by treating the persistent cortical map as the literal seat of the phantom — and the two framings remain compatible with the basic phenomenon, which constrains accounts that deny the phantom's phenomenal reality but does not by itself establish either rival reading over the other.

## The Plasticity of the Interface

The most striking evidence from sensorimotor research concerns the interface's plasticity. Sensory substitution devices provide the clearest cases.
...
## What Sensorimotor Contingencies Cannot Explain

Sensorimotor contingency theory explains *which* qualities experience has — why vision differs from audition, why red differs from blue — by appeal to differences in contingency structure. What it does not explain is *that* experience has qualitative character at all.

Consider O'Regan and Noë's claim that the redness of red is constituted by mastery of red-related sensorimotor contingencies. Grant the full claim: knowing how red surfaces behave under movement exhausts the qualitative character of seeing red. A computational system that mastered the same contingencies — predicting exactly how red-related stimulation changes with every possible movement — would possess the same mastery. Would it see red?

The sensorimotor contingency theorist faces a dilemma. If mastery is functional and any system with the right functional profile experiences red, then the theory is a version of functionalism and inherits functionalism's [[hard-problem-of-consciousness|hard problem]]: why does this functional organisation produce experience? If mastery requires something beyond function — embodied engagement, lived practice, first-person acquaintance — then the theory implicitly invokes something the functional description does not seem to capture.

Noë's later work leans toward the second horn. In *Out of Our Heads* (2009), he argues that "you are not your brain" and that consciousness depends on the whole embodied organism's engagement with its environment. But this appears to raise rather than answer the question: what is it about embodied engagement that produces experience, when disembodied computation with identical functional structure does not? The enactivist may reply that the question is malformed — that there is no further explanatory work to do once contingency mastery is in place — and the disagreement at this point arguably tracks a framework boundary the empirical data alone does not adjudicate.

The Map's tentative answer is that embodied engagement may provide the interface structure while consciousness is not identical to that structure. Sensorimotor contingencies, on this reading, specify the format of the interface — what information is available, how it transforms with action, what capacities it affords. Consciousness, the Map suggests, engages *through* this format without being reducible to it. This is offered as a live hypothesis the sensorimotor data is compatible with, not as an empirically forced verdict.

The [[capability-division-problem|capability division framework]] is intended to clarify this picture, though the picture itself remains contested. On the Map's reading, sensorimotor contingency mastery — learning and executing the lawful patterns linking movement to sensation — may belong on the brain-side of the division: the body-brain system handles the computational work of tracking how sensory stimulation transforms with action. The phenomenal character that accompanies mastery — that red *looks like something*, that spatial engagement *feels like navigating* — may be a mind-side contribution that the sensorimotor mastery occasions without producing. The division is itself a candidate framework the catalogue is exploring; the sensorimotor data does not by itself force it over rival framings.

## The Interface's Grammar

On the interface reading, sensorimotor contingencies may function as something like the interface's grammar — the structural rules governing how consciousness can engage with the physical world at any given moment. The grammatical metaphor is offered as an interpretive frame, not a claim the contingency data alone establishes.
...
Mastering these contingencies, on this picture, is something like learning the interface's grammar. A child learning to see seems not to be assembling a visual world from raw data so much as mastering the lawful relations between movement and sensation that may constitute visual engagement. A person learning to use a prosthetic limb may be learning a new dialect of the same grammar — different contingencies governing what could be the same fundamental engagement.

The grammatical metaphor offers a way of thinking about what changes and what remains constant across sensory substitution. The grammar changes: tactile-visual substitution imposes different contingencies than natural vision. The speaker — consciousness, on the interface reading — remains. And remarkably, the speaker adapts to the new grammar, achieving functional fluency through practice. The neural-plasticity reading describes the same phenomena without positing a separate speaker, and the empirical data does not decide between these framings.

The metaphor also maps onto the [[capability-division-problem|capability division]]: on the Map's tentative reading, the grammar itself — the lawful structure of sensorimotor contingencies — could be brain-side, maintained by neural and bodily mechanisms, while the meaning expressed through that grammar — the phenomenal content of perception — may be a mind-side contribution. Grammar shapes expression without producing meaning; sensorimotor contingencies, on this reading, would shape experience without producing phenomenal character. This is a hypothesis the metaphor articulates, not a thesis the contingency data confirms.

## The Phantom Limb and Interface Persistence

Phantom limb phenomena deserve closer attention as evidence about the interface's nature.

Ramachandran's mirror box therapy shows that visual feedback can modulate phantom limb experience. When a patient sees their intact hand reflected where the phantom should be, and moves the intact hand, the phantom "unfreezes" — phantom pain decreases, phantom mobility returns. The body schema appears to update through visual-motor contingencies involving a hand that no longer exists.

On a production model of consciousness, phantom limbs may be straightforward neural misfire — the cortical map of the missing limb continues generating signals, and treatment works by providing corrective input to that map. On the interface model, something subtler might be occurring: the interface could retain structure corresponding to the missing limb because the body schema, on this reading, is not a neural map *of* the body but the interface's *grammar for engaging through* the body. Mirror therapy, on the interface reading, might work by providing the interface with sensorimotor contingencies consistent with a functioning limb — restoring grammatical coherence to a disrupted interface. Both readings remain compatible with the clinical findings.

Both readings accommodate the basic phenomenon, but they frame it differently. On the neural misfire account, the phantom is straightforwardly where the cortical map is — and treatment works by correcting that map. On the interface reading, the phantom might be evidence that the interface retains a grammar learned through the limb that persists beyond the limb's physical existence; the interface, on this reading, could have history and habitual orientation not fully determined by current neural configuration. This framing does not generate unique empirical predictions beyond what the cortical account predicts. It offers a philosophical interpretation that connects phantom persistence to the broader question of whether the body schema is identical to neural representation or whether it reflects something irreducible about embodied consciousness — a question the phantom data alone does not adjudicate.
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Sensorimotor contingencies are inherently bidirectional. Perception requires action; action is guided by perception. The perceiver appears to be not a passive recipient but an active explorer. The Map interprets this bidirectionality as possibly reflecting the interface's fundamental character: consciousness may act on the body (directing exploration), and the body constrains consciousness (sensorimotor laws determine what exploration reveals). On the interface reading, the interface mediates ongoing mutual influence rather than transmitting in one direction. The bidirectional structure of sensorimotor contingencies is compatible with this interpretation; it is also compatible with enactivist readings on which the same bidirectionality is the whole story, with no separate consciousness for the body to influence.
...
**[[tenets#^no-many-worlds|No Many Worlds]]**: Sensorimotor engagement seems to achieve definite outcomes. A hand exploring an object follows one trajectory, revealing one texture, one shape — not all possible explorations simultaneously. If the attention that directs sensorimotor exploration operates through quantum selection, collapse rather than branching would on the Map's reading produce the determinate bodily engagement that sensorimotor contingency theory describes. The phenomenological observation does not by itself establish single-world over many-worlds metaphysics; it is named here as the datum the Map's reading takes as more naturally accommodated than its rivals.
...
- [[embodied-consciousness]] — The general treatment of embodied cognition and the interface
- [[embodied-cognition]] — The concept treatment: 4E cognition, Dreyfus model, choking evidence
...
- [[palette-extension-void]] — Why substitution and augmentation reports cannot certify new phenomenal content
