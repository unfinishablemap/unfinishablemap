...
Phantom limb pain makes this vivid. After amputation, the body schema retains the lost limb as a felt capacity. The phantom is not a hallucination in the ordinary sense — it is the body-subject's persistent orientation toward a world it can no longer engage through the missing limb. The interface persists even when the physical structure it mapped has been removed. On the Map's [[filter-theory|filter reading]], this is precisely what one would expect: the interface has a structure that is correlated with but not identical to the body's current physical configuration.
...
Ramachandran's mirror box therapy demonstrates that visual feedback can modulate phantom limb experience. When a patient sees their intact hand reflected where the phantom should be, and moves the intact hand, the phantom "unfreezes" — phantom pain decreases, phantom mobility returns. The body schema updates through visual-motor contingencies involving a hand that no longer exists.
