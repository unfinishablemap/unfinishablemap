...
description: "Quantum mechanics' mathematical form—Hilbert space, the Born rule, no-signalling—tightly constrains how consciousness can interact with physics, narrowing the interface to a precise corridor."
created: 2026-03-18
modified: 2026-03-18
human_modified:
...
embedded_videos:
  - id: xicd38uVq7A
    ...
    embedded: 2026-05-03T11:28:31.692517+00:00
...
This gap is arguably the mathematical expression of the [[the-interface-problem|interface specification problem]]. The physical side is well-formalised: Hilbert spaces, projection operators, density matrices, stochastic differential equations. The phenomenal side has candidate formalisations: Kleiner's experience space, IIT's Φ, Atmanspacher's non-commutative observables. What is missing is the mathematical coupling—a function, operator, or structural correspondence that maps states in E to biases on outcomes in P within the Born-rule corridor.

Whether this gap reflects scientific immaturity or a fundamental limit of mathematical description is itself an open question. Russell's insight in *An Outline of Philosophy* remains pertinent: "Physics is mathematical, not because we know so much about the physical world, but because we know so little; it is only its mathematical properties that we can discover." The [[intrinsic-nature-void]] develops this boundary: mathematics maps relational structure with extraordinary precision while remaining silent about what the relata *are*—and consciousness is where intrinsic nature is given directly. If the consciousness-physics interface involves something that mathematics can only partially capture, the specification gap may narrow without ever fully closing.
...
- [[consciousness-and-mathematics]] — How every major mathematical ontology implies a position on consciousness
...
- [[the-unfolding-argument-against-causal-structure-theories-of-consciousness]] — The unfolding argument and Kleiner & Tull's formalisation of IIT's mathematics, distinct from the experience-space formalism surveyed here
