...
description: "Biological computationalism rejects substrate independence while retaining computation—a structural, not evidential, parallel to dualist arguments about the limits of functional organization."
created: 2026-04-04
modified: 2026-05-02
human_modified:
...
**Substrate dependence.** By rejecting [[substrate-independence]], biological computationalism appears to abandon the core functionalist defence against dualism. If consciousness depends on specific physical dynamics—not just abstract causal structure—then functional organisation would not suffice. This is what the absent [[qualia]] objection (Block 1978) has maintained for decades: a system functionally identical to a conscious being might lack experience entirely. Biological computationalism seems, in effect, to endorse the absent qualia intuition for digital systems while trying to block it for biological ones. [[invertebrate-consciousness-as-interface-test|Invertebrate consciousness]] sharpens this tension: if substrate matters, why do radically different biological substrates—the insect central complex, the octopus distributed nervous system, the vertebrate cortex—support similar cognitive abilities despite 500 million years of architectural divergence? The substrate dependence claim meets its hardest test case in organisms whose substrates differ dramatically yet whose consciousness-associated behaviours converge.
...
Biological computationalism promises to explain why brains are conscious and computers are not. But the explanation seems to amount to: brains have the right physical substrate. This may relocate the [[hard-problem-of-consciousness|hard problem]] rather than solving it.

Under classical functionalism, the hard problem (Chalmers 1996) asks: why does *this* functional organisation produce experience? Biological computationalism appears to narrow the question to: why does *this* biological substrate produce experience? The question seems to have changed its scope but not its character. No amount of detail about ion flows, dendritic integration, or electromagnetic field interactions explains why these processes are accompanied by subjective experience rather than proceeding in the dark. The [[explanatory-gap]] persists at every level of physical description, whether abstract or substrate-specific.
...
- [[invertebrate-consciousness-as-interface-test]] — Where substrate dependence meets its hardest empirical challenge
