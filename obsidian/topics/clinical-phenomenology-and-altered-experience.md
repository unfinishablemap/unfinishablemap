...
Clinical phenomenology challenges even sophisticated identity theory. [[clinical-dissociation-as-systematic-evidence|Dissociative identity disorder]] produces profound experiential fragmentation—distinct personality states with separate experiential streams—without structural brain damage. [[consciousness-disruption-and-the-mind-brain-interface|Cognitive motor dissociation]] reveals preserved awareness in patients whose behavioural output suggests vegetative states, where neural damage would seem to preclude the experiential capacities that neuroimaging reveals. [[pain-consciousness-and-causal-power|Pain asymbolia]] dissociates the sensory and affective dimensions of pain despite intact nociceptive pathways. In each case, the experiential disruption is systematic and selective in ways that resist straightforward neural explanation.

### What Functionalism Predicts

Functionalism identifies consciousness with functional organisation rather than neural substrate. It accommodates more clinical data than identity theory but faces its own difficulties. The felt quality of [[phenomenology-of-agency-vs-passivity|agency versus passivity]]—the difference between "I am doing this" and "this is happening to me"—disrupted in schizophrenia and anarchic hand syndrome, does not obviously reduce to any difference in information processing. The functional profiles of a voluntary and an involuntary action can be similar, yet the experiential character differs fundamentally.

### What Interface Dualism Predicts

The Unfinishable Map's interface model naturally accommodates—and in its stronger form, predicts—that clinical disruptions should reveal selective channel failures: specific components of the mind-brain interface going offline while others continue operating. This is precisely what the clinical evidence consistently shows. The [[neurological-dissociations-as-interface-architecture|dissociation evidence]] maps onto specific interface channels: sensory ascending, motor descending, self-model, affective colouring, temporal integration.
...
The evidential force strengthens dramatically when cases are considered together rather than individually. Each clinical condition, taken alone, might be accommodated by sufficiently flexible materialism. Together, they form a pattern:

- **Ownership disruptions** (schizophrenia, depersonalization, DID) reveal that the sense of "mineness" is a separable component, not intrinsic to neural processing
- **Agency disruptions** (anarchic hand, thought insertion, utilisation behaviour) show that authoring one's actions is a distinct experiential layer
- **Affective disruptions** (pain asymbolia, alexithymia, depersonalization) demonstrate that emotional colouring is an independent channel
- **Temporal disruptions** (depression, mania, certain seizure disorders) reveal that the temporal horizon can expand or collapse independently of cognitive capacity
...
The strongest materialist response is that modular experiential disruptions reflect modular *neural* architecture. This has force but does not fully account for cases where selectivity cuts *across* neural organisation: DID fragments experience without fragmenting neural architecture, pain asymbolia dissociates experiential dimensions that share neural pathways, and cognitive motor dissociation preserves experience that the neural damage profile should have eliminated.
...
**Interpretation underdetermination.** The same data can be interpreted through different lenses. But a methodological asymmetry exists: the materialist must construct post hoc explanations for each new dissociation pattern, while the interface model predicts the pattern of selective channel failures in advance.
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The materialist can always construct an explanation for any individual clinical finding. The question is whether the accumulating pattern is better explained by a framework that predicted this architecture (interface dualism) or by one that must accommodate it post hoc (materialism). Parsimony considerations alone cannot settle this—which is precisely the tenet's point.
...
10. Raballo, A., Henriksen, M. G., Poletti, M., & Parnas, J. (2025). Schizophrenia, Consciousness, and the Self — Twenty Years Later. *Schizophrenia Bulletin*, 51(5), 1187–1192.
