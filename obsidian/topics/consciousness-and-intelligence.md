...
Several arguments support this: John Searle's [[concepts/functionalism#The Chinese Room|Chinese Room]] suggests that processing symbols according to rules doesn't constitute understanding. Human flexibility in novel situations may require [[consciousness-as-amplifier|conscious access]] — the capacity to bring information into awareness for deliberate manipulation. Novel solutions to unprecedented problems may require conscious deliberation — mentally simulating possibilities, comparing alternatives, recognising promising directions.
...
The Map's [[tenets|dualist framework]] offers a cleaner account. If consciousness is not produced by neural activity but interfaces with it — biasing [[tenets#^minimal-quantum-interaction|quantum-level outcomes]] in neural systems — then the threshold marks the point where brains develop architecture sufficient for this interface to operate effectively.

The [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet predicts exactly the pattern the evidence reveals: consciousness causally influences neural outcomes, and the degree of that influence depends on the sophistication of the neural interface. The amplification hypothesis specifies *how*: through flexible deployment, metacognitive monitoring, and counterfactual simulation.

The [[tenets#^occams-limits|Occam's Razor Has Limits]] tenet cautions against dismissing consciousness's role for parsimony. Epiphenomenalism seems simpler — consciousness does nothing, behaviour is fully physical — but this apparent simplicity creates puzzles the amplification evidence resolves.

The threshold also reinforces the Map's rejection of [[concepts/epiphenomenalism|epiphenomenalism]]. If consciousness were causally inert, crossing the threshold would change nothing — there would be no cognitive discontinuity to explain.
...
- [[infant-consciousness]] — The developmental threshold: qualitative transformation from infant to adult consciousness
