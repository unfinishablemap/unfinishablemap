...
description: "QBism's probabilities are structurally dependent on consciousness—agents' credences are defined over phenomenal outcomes. This dependence is uniquely problematic, not shared by objective interpretations."
created: 2026-01-27
modified: 2026-01-27
human_modified:
...
Quantum probabilities are either features of reality (objective) or features of observers' knowledge (subjective). QBism and related interpretations take the subjective path: the Born rule describes rational constraints on belief, not physical propensities. This approach dissolves many quantum paradoxes—but at a cost that is easy to understate.
...
Step 3 is where QBism's structural dependence on consciousness becomes visible. The agent must *experience* a definite outcome in order to have something to update beliefs about. But whence this experience?

A thermodynamics analogy might seem to defuse the worry: thermodynamics describes heat without explaining why atoms exist, so perhaps QBism can describe rational belief updating without explaining why agents exist. But the analogy fails. Thermodynamic regularities don't structurally depend on atoms being a certain way—the same laws hold for any micro-constituents with the right statistical properties. QBism's probabilities *do* structurally depend on agents having conscious experiences, because the theory's central objects—credences, beliefs, expectation updates—are constitutively mental states. Remove consciousness and QBism's formalism has nothing to attach to.

This is internal to QBism's own explanatory structure, not an external demand that all theories explain consciousness. Every interpretation faces the [[hard-problem-of-consciousness]]. But objective interpretations can bracket consciousness without undermining their formalism. QBism cannot, because it uses consciousness to do the formalism's foundational work.

### The Participation Ambiguity

John [[wheelers-participatory-universe-and-it-from-bit|Wheeler's "participatory universe"]] and Fuchs's "participatory realism" attempt to capture something important: observation is active, not passive. The user of quantum mechanics participates in constituting facts.
...
The disagreement between objective and subjective interpretations reflects a deeper question: what are Born rule probabilities *about*? Three readings are possible (see [[indexical-identity-quantum-measurement]] for full treatment):

**Objective reading**: Probabilities are propensities—real features of physical systems. An electron genuinely has a 50% propensity to be measured spin-up. This holds whether anyone observes or not. No structural dependence on consciousness.
...
## Relational Quantum Mechanics: The Opposite Strategy

Carlo Rovelli's relational interpretation takes the opposite approach from QBism. Quantum states are relational—a system has properties only relative to another system—but "observer" means any physical system, not necessarily a conscious one. A photon detector "observes" as much as a physicist does.

Where QBism makes consciousness structurally central and then stays silent about it, relational QM avoids the structural-dependence problem by denying consciousness any formal role. This is a genuine advantage regarding the critique developed here: relational QM's probabilities describe physical relations, not mental states, so they carry no hidden dependence on phenomenal experience.

But the advantage comes at a price. The first-person perspective—why *this* consciousness experiences *this* outcome—is not addressed but dismissed as outside physics. The [[indexical-identity-quantum-measurement|indexical gap]] in relational QM is developed in the companion article.
...
The general hard problem—why qualitative experience exists at all—belongs to every interpretation equally. The test here is narrower and targets QBism's specific claims about quantum probability.
