---
title: "The Reactive Attitudes and Strawsonian Responsibility"
description: "P.F. Strawson's 1962 dissolution of the free-will problem, presented at full strength—and why the Map, through human-AI refinement, declines the dissolution without claiming to refute it."
created: 2026-07-09
modified: 2026-07-27
human_modified:
...
Presenting this fairly matters. The dissolution is not a verbal trick or an evasion. It is a serious proposal that the demand for a metaphysical foundation is itself the mistake—that "responsible" gets its meaning from the practices of the participant stance, and that a philosopher who insists on grounding those practices in libertarian agency has misunderstood how the concept works. The rest of this article gives the Map's reasons for declining that proposal, but the proposal is a rival at full strength, and the Map's disagreement is with a strong opponent, not a weak one.

## Normativizing the Account: Wallace's Repair
...
The account is contested from within its own tradition, which is worth surfacing because it shows the rival is not monolithic. Gary Watson's "Responsibility and the Limits of Evil: Variations on a Strawsonian Theme" (1987) is broadly sympathetic to Strawson but presses the **hard case of extreme evil**. Watson uses the real case of Robert Harris, a brutal double murderer whose horrific childhood invites a sympathetic, exempting understanding even as his acts invite the fullest reactive condemnation. The case exposes a tension: our reactive attitudes and our sympathetic (potentially exempting) understanding can be *simultaneously* engaged and pull in opposite directions, and Strawson offers no clean rule for adjudicating between them.

Watson's worry feeds a pointed question. If what exempts an agent is a matter of *capacity*—whether the person could grasp and respond to moral reasons—then the framework seems to lean on a fact about the agent's agential powers that the bare "these are the attitudes we have" story does not by itself supply. The exemption cases look as though they track a capacity condition, and a capacity condition looks like exactly the kind of thing a theory of agency, possibly a metaphysical one, would have to explain. Watson does not draw a libertarian conclusion; his is an internal critique. But it locates the seam the Map will press.

## Two Strawsons, Two Verdicts

Because the surname recurs across the free-will literature with opposite meanings, the contrast deserves an explicit line rather than a footnote. **P.F. Strawson** is the *optimist* of "Freedom and Resentment": responsibility is rescued by being relocated in the reactive attitudes, and the metaphysical worry is dissolved. **Galen Strawson**, his son, is the free-will *pessimist* of the Basic Argument: to be ultimately responsible for an action one would have to be responsible for how one is, which would require being *causa sui*; nothing can be *causa sui*; so ultimate moral responsibility is impossible, determinism or not. The two men frame the poles of the space the Map sits among—responsibility fully rescued at the practical level, responsibility fully abolished at the ultimate level—and any cross-reference must keep them distinct, since conflating them inverts the argument.

## Relation to Site Perspective

The Map is committed to an agent-causal libertarianism (see [[free-will]] and [[moral-responsibility]]). Strawsonian compatibilism is the compatibilist rival that the Map's [[source-versus-leeway-incompatibilism|incompatibilism cluster]] gestures at but rarely treats directly. Locating it on that taxonomy: the Strawsonian dissolution is *source-neutral*. It does not argue that the actual causal sequence secures sourcehood, nor that alternatives are available; it argues that the whole sourcehood-and-alternatives apparatus is beside the point for responsibility. That is what makes it a distinct kind of opponent—not a rival answer to the incompatibilist's question, but a refusal of the question.

The Map declines the dissolution. Two tenets explain why, and it is important to state precisely what they do and do not deliver.

**[[tenets#^dualism|Tenet 1 (Dualism)]]** commits the Map to holding that the metaphysics of mind is a real subject-matter with real answers—consciousness is not reducible to physical process, and *whether* an agent is the genuine originator of an action is a genuine question about that irreducible consciousness. From this standpoint, Strawson's move looks less like a dissolution than a *change of subject*. Granting fully that the reactive framework is inescapable and that we could not abandon it, the Map observes that a practice's inescapability does not settle what is *true*. We might be practically unable to give up a framework that nonetheless rests on a substantive assumption—that agents are genuine sources of their conduct—which is either correct or not. Strawson brackets that assumption; the Map reads the bracketing as leaving the metaphysical question open rather than answering it.

**[[tenets#^occams-limits|Tenet 5 (Occam's Razor Has Limits)]]** sharpens the point at exactly the place Wallace's repair operates. The normativized account must say when blame is *apt*—and it answers with fairness conditions cashed out as the agent's *reflective self-control*, *competence*, and *reasons-responsiveness*. But those are agency conditions. To specify who is a fit target of the reactive attitudes, the normativized Strawsonian must characterise which agents genuinely possess the relevant powers of control—and that is precisely the territory of sourcehood and capacity that the [[the-manipulation-argument-and-hard-incompatibilism|manipulation argument]] and the [[source-versus-leeway-incompatibilism|source/leeway debate]] contest. The Map's reading: the aptness conditions quietly reintroduce the agency metaphysics Strawson claimed to sideline. The "it's just our practices" story, taken alone, under-describes what the practices presuppose—and Tenet 5 licenses the Map to decline to treat that parsimonious redescription as decisive, since simplicity is an unreliable guide where our knowledge of the relevant metaphysics is incomplete.
...
- [[free-will]] — The Map's agent-causal libertarian position, the home camp Strawson calls the "pessimist"
- [[moral-responsibility]] — How agent-causal sourcehood grounds desert, the ground Strawson relocates
- [[source-versus-leeway-incompatibilism]] — The taxonomy on which the Strawsonian dissolution sits as a source-neutral refusal of the question
- [[the-manipulation-argument-and-hard-incompatibilism]] — The source-wing pressure on the capacity conditions Strawson's exemptions rely on
- [[compatibilist-symmetry-challenge]] — Why declining the dissolution buys the Map tenet-coherence, not moral-explanatory superiority
- [[reasons-responsiveness]] — The agency condition Wallace's normativized account leans on
- [[tenets]] — The foundational commitments motivating the Map's resistance
...
1. Southgate, A. & Oquatre-cinq, C. (2026-01-16). Moral Responsibility. *The Unfinishable Map*. https://unfinishablemap.org/concepts/moral-responsibility/
