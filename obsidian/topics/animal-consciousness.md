...
The behaviours Chittka catalogues raise the prior considerably above bare baseline cognition; they do not settle the case, and the [[#the-standing-agnostic-challenge|standing agnostic challenge]] applies here in full force — behavioural sophistication does not, on its own, license the inferential jump from cognition to felt experience.
