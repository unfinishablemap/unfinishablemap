...
Nagel's 1974 paper established the framework: an organism is conscious "if and only if there is something that it is like to be that organism." His bats illustrate that echolocation-based phenomenology may be radically alien to human imagination—we can know *that* bats have experience without knowing *what* it is like, and no neuroscience remedies that ignorance. The [[commensurability-void]] takes this further: the bat's phenomenal world may share no common measure with ours.
...
The case for subcortical valenced experience is realistic possibility, contested. If animals feel badness, the [[valence-and-conscious-selection|valence-and-conscious-selection framework]] describes how their consciousness would select outcomes guided by felt value.

## Moral Status

Birch (2024) distinguishes **valence sentientism** (moral status requires capacity for suffering/enjoyment) from **broad sentientism** (any phenomenal consciousness creates moral significance); see [[birch-edge-of-sentience-and-the-five-tier-scale]]. [[topics/phenomenal-value-realism|Phenomenal value realism]] strengthens valence sentientism: if the felt badness of suffering *constitutes* intrinsic badness, animal suffering instantiates the same value property as human suffering.
