...
**Evidential status: realistic possibility, contested.** The behaviours Chittka catalogues raise the prior considerably above bare baseline cognition; they do not settle the case. The [[#the-standing-agnostic-challenge|standing agnostic challenge]] applies in full force here—behavioural sophistication does not, on its own, license the inferential jump from cognition to felt experience.
