...
If consciousness has genuine causal powers—if it does more than merely accompany physical processes—then understanding the nature and scope of those powers becomes central to the philosophy of mind. The question is not simply whether consciousness causes anything (addressed in [[mental-causation-and-downward-causation|mental causation]] and [[evolutionary-case-for-mental-causation]]) but what *kind* of causation it exercises and what limits constrain it. The Unfinishable Map holds that consciousness exercises a specific and limited causal influence: the capacity to bias quantum indeterminacies in neural systems toward certain outcomes without violating physical conservation laws—narrower than the unconstrained psychokinesis of science fiction, and bounded in ways this article specifies.

Different answers lead to radically different worldviews. If consciousness has no causal powers ([[concepts/epiphenomenalism]])—the default destination [[the-epiphenomenalist-threat|the epiphenomenalist threat]] shows most frameworks converge on—then everything we do would happen exactly the same way if we were unconscious automata. If consciousness has unlimited causal powers, we enter the territory of magic and pseudoscience. The Map stakes out middle ground: real but circumscribed causal influence, operating within the constraints physics provides.
...
The framing presupposes a non-Everettian interpretation: under [[concepts/many-worlds|Many-Worlds]], all physically permitted outcomes actualise on parallel branches and there is nothing for consciousness to select among. The Map's rejection of MWI is not a free move. MWI claims to be the simplest interpretation of quantum mechanics — the Schrödinger equation taken literally, with no additional collapse postulate — and the Map's framework here pays the rival cost: a non-physical selection mechanism (consciousness as the realiser of one outcome from the post-decoherence mixture) that does the work MWI does without postulating extra branches. Whichever interpretation is right, *something* has to be added: MWI adds branches the Schrödinger equation does not single out for actualisation; the Map adds a selection mechanism. The Map judges the branch-multiplication cost as higher than the selection-mechanism cost — the indexical argument carries that weight, not parsimony (see [[tenets#^no-many-worlds|Tenet 4]] and the [[arguments/many-worlds-argument|Against Many-Worlds]] cumulative case). The §"Ontological restraint" virtue below should be read against this ledger entry, not as if the Map's rejection of MWI came for free.
...
**Organizational influence**: Consciousness might affect how neural components organize without affecting their individual behaviour—consciousness as a high-level property that causally constrains lower levels through organizational feedback. The challenge: specifying how organization contributes novel powers without violating lower-level laws.
...
The Map proposes consciousness interfaces with the physical world specifically at quantum indeterminacies in neural systems. This localizes the causal power: consciousness doesn't directly influence distant objects, other people's brains, or macroscopic events. The interface's locality accounts for an asymmetry: you can decide to raise your arm because the interface is in your own neural activity; you cannot telekinetically move someone else's because there is no interface there. See [[attention-as-interface]] for how attention might implement this coupling, and [[the-interface-problem|the interface location problem]] for why consciousness interfaces where it does.

### The Physical Constraint

Even at the interface, consciousness doesn't violate physics. The [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet specifies that consciousness biases outcomes physics already allows. If quantum mechanics assigns a superposition of neural firing patterns, consciousness influences which actualizes—but only from among physically permitted options.

This preserves [[conservation-laws-and-mental-causation|conservation laws]]. When consciousness selects among energetically equivalent quantum outcomes, no energy is transferred: all possible outcomes already exist in the wavefunction with their associated energies. Consciousness selects a path through possibility space; it doesn't inject resources from outside that space.

### The Probabilistic Constraint

[[quantum-probability-consciousness|Quantum mechanics provides probabilities, not certainties]]. Even if consciousness biases outcomes, it operates within probabilistic bounds. You cannot guarantee an extremely unlikely outcome by wanting it strongly enough. The [[causal-consistency-constraint|causal consistency constraint]] (Torres Alegre 2025) shows those bounds are structurally fixed for any interface theory: under purification, no-signalling forces the Born form. This might explain why voluntary action feels effortful—consciousness is working to shift probabilities in neural systems where countless quantum events create statistical noise.

### The Temporal Constraint

[[psychophysical-laws|Psychophysical coupling]] operates in real time. Consciousness cannot retroactively change past outcomes or influence future states disconnected from present neural activity. The causal power is embedded in the physical world's temporal structure, not exempt from it.
...
When faced with multiple behavioural options—speak or stay silent, approach or avoid—consciousness biases which neural pattern wins out. The alternatives exist as superposed possibilities in quantum brain states; consciousness influences which collapses into actuality. The selection is a genuine causal contribution rather than unlimited free will (see [[topics/free-will]]): without consciousness, outcomes would be determined by physical probability distributions; with consciousness, phenomenal factors (desires, values, deliberations) shift those distributions.

### Sustained Attention

Consciousness can hold neural patterns active through sustained attention. The quantum Zeno effect proposes that repeated "observation" of a neural state prevents it from decohering—like watching a pot that never boils (see [[stapp-quantum-mind]] and [[structure-of-attention]]).

The Zeno proposal faces a serious quantitative gap. Standard decoherence calculations for neural quantum superpositions in warm, wet brain tissue give coherence times of $10^{-13}$ to $10^{-20}$ seconds; the phenomenology of attention runs at 10–30 Hz. The mechanism would need observations at $\geq 10^{13}$ Hz — twelve to sixteen orders of magnitude faster than the attentional phenomenology itself. Closing the gap requires either protected microenvironments extending coherence times (the contested Penrose-Hameroff microtubule conjecture) or an alternative quantum mechanism. The Zeno effect is offered as a worked example; the coherence-time requirement remains a critical vulnerability the framework has not resolved.

Whatever the mechanism, the causal power posited is persistence: consciousness would make certain neural configurations more stable, enabling planning, reasoning, and deliberation. The phenomenology of sustained attention is consistent with this picture but also with rival accounts in which felt effort is captured by mesoscopic neural reverberation, attentional gain modulation, and noradrenergic locus coeruleus modulation of cortical signal-to-noise. Suggestive, not decisive; see [[phenomenology-of-consciousness-doing-work]] for the broader case.

### Phenomenal Biasing

The character of conscious experience—what it feels like—might itself contribute to causal influence. [[pain-consciousness-and-causal-power|Pain]] provides the paradigm case: pain's unpleasantness doesn't merely represent tissue damage but causally motivates avoidance. The clinical condition of [[pain-asymbolia]]—patients detect nociceptive stimuli but lack the felt awfulness—shows intact sensory detection without the extended avoidance behaviour that pain's felt character normally drives.

The dissociation licenses less than first appears. Pain asymbolia *constrains* the simplest representational claim (that felt awfulness just is nociceptive activation) by showing the two come apart, but does not on its own *establish* the Map's reading. A predictive-processing account in which affective valence enters as a separate hierarchical prior over the nociceptive signal predicts the same dissociation. The Map's actual disagreement with predictive processing is not at the dissociation but at the bridge from sub-personal valence-prior to felt awfulness: PP treats that bridge as constituted by computational role; the Map treats felt awfulness as adding causal work the sub-personal prior alone does not perform.

Different phenomenal qualities produce different behavioural responses: sharp pain provokes withdrawal, burning pain motivates cooling, aching pain produces protective immobility. Pain anticipation extends this further—imagined future pain alters present behaviour through phenomenal content alone. The [[valence-and-conscious-selection|selection currency thesis]] develops this into a specific mechanism: valence as the common metric by which consciousness evaluates competing options.

This requires [[psychophysical-laws]] specifying how phenomenal character maps to action tendencies, linking the qualitative nature of [[qualia]] to their causal role. See [[topics/phenomenal-value-realism]] for the ethical implications.
...
A deeper objection sits one register lower than the noradrenergic rival, and the Map cannot pretend it is not there. [[topics/eliminative-materialism|Eliminative materialism]] holds that the entire grammatical scheme on which this article depends — "consciousness selects," "consciousness sustains," "consciousness varies its causal influence" — is folk-psychological reification awaiting redescription. On the eliminativist reading, mature neuroscience will eventually replace these locutions with sub-personal vocabulary (locus-coeruleus modulation, predictive-processing prior weighting, gain-control circuitry) and at that point there is no grammatical subject left for the article's verbs to attach to. The Map's framework is not eliminativism-compatible: it carries a referent for "consciousness" as the bearer of phenomenal properties, and it pays a corresponding cost — a commitment to a category eliminativism would dissolve, whose existence the Map argues for on independent grounds ([[arguments-against-materialism]], [[phenomenal-authority-and-first-person-evidence]]) rather than treats as given by the grammar. The eliminativist redescription is in-principle available; what the Map disputes is not its availability but its adequacy to the explanandum (felt phenomenal valence as the thing being modulated, not just the modulation itself). This is a framework-boundary disagreement, honestly noted as such.
...
If consciousness has no causal powers, libertarian [[topics/free-will]] is impossible. The [[trilemma-of-selection]] makes this explicit: at any indeterminate decision point, the options are determinism, randomness, or mental causation—only genuine causal powers deliver the third. The [[luck-objection]] poses a challenge that cuts against constrained and unconstrained causal powers alike: whatever consciousness does at the indeterminacy gap, the question of what grounds the specific bias remains live. The Map's middle position narrows the territory by anchoring selections in phenomenal contents (values, desires, deliberations) rather than uncaused arbitrary choices, but whether those phenomenal contents themselves need further grounding is left open.
...
Humans possess cognitive capacities (logical reasoning, metacognition, cumulative culture) that great apes with sophisticated unconscious processing lack. If these require conscious processing—and the cognitive-load literature offers contested but suggestive evidence that they do—this would indicate consciousness causally contributes to cognition. The empirical case is more contested than this conveys: dual-process distinctions, debates over whether "unconscious System 1" is conscious-but-inaccessible, and meta-analytic challenges to dual-task interference all complicate the inference. Suggestive rather than dispositive; see [[baseline-cognition]].

### Clinical Evidence: Cognitive Work Without Motor Output

Cognitive motor dissociation (CMD) supplies the strongest clinical exhibit against epiphenomenalism. Patients meeting behavioural criteria for unresponsive wakefulness show, via fMRI or EEG, robust task-locked neural responses to commands like "imagine playing tennis"—they understand language, sustain attention, and form task-relevant patterns while producing no overt behaviour. Bodien, Claassen, et al. (2024, *NEJM*) found CMD in approximately 25% of behaviourally unresponsive patients. The phenomenon is direct evidence that consciousness continues to *do* cognitive work when the motor channel is severed—harder for epiphenomenalist readings to accommodate than interactionist ones. See [[topics/consciousness-disruption-and-the-mind-brain-interface#covert-consciousness-awareness-without-expression|Consciousness Disruption]] for detailed treatment.

### Absence of Direct Evidence

We lack direct empirical evidence that consciousness biases quantum outcomes in brains. The hypothesis is *compatible* with current evidence but not *required* by it. A physicalist can identify mental states with neural states, making mental causation a subset of physical causation: any "selection" among quantum outcomes is itself a physical process. [[brain-internal-born-rule-testing]] catalogues what evidence would close this gap mechanism by mechanism.

The Map's response: identity theories face their own difficulties. If mental states just *are* neural states, the qualitative character of experience has no explanatory role in the causal story—the neural state does all the work, and phenomenal character is epiphenomenal in all but name. The Map's position requires the independent [[dualism]] argument to establish that mental causation cannot be reduced to physical causation. The causal powers framework describes *how* non-physical causation might work if dualism is true; it does not by itself prove dualism.
...
The Popperian and Lakatosian objection that the framework is a *degenerating research programme* — that successive refinements remove ever more of the ways it could be tested — deserves a direct answer rather than the inference from "vanishing per-trial bias" the previous paragraph might invite. The framework does forbid per-trial discrimination by design: this is a structural feature of the strictest Tenet 2 reading combined with the no-signalling constraint, not a refinement introduced to evade falsification. The relevant distinction is between *operationally underdetermined* and *degenerating*: a degenerating programme closes discriminating tests at all levels with each refinement; an operationally-underdetermined-at-one-level programme is open to discrimination at adjacent levels. The Map's framework is the latter — per-trial undiscriminable by construction, ensemble- and correlation-level discriminable in principle, with [[brain-internal-born-rule-testing]] cataloguing which experimental families would close the ensemble gap. The honest concession is that *if* every adjacent-level test returns null at the precision the strongest mechanism candidates require, the framework would inherit the degenerating-programme problem at that point; but the catalogue's discriminating families have not yet been run at brain-internal precision, and the verdict is open rather than already-evaded.
