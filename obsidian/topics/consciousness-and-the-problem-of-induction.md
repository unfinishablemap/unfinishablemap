...
One counterexample class must be met directly rather than left to a footnote. Deep-learning systems generalise from past instances to novel cases at scale—under any behavioural description, that is induction, performed by systems to which the Map attributes no consciousness (the [[anti-correlation-probes-for-ai-consciousness|anti-correlation probes]] exist precisely to keep capability and consciousness apart). The Map concedes the performance in full: machine induction-as-behaviour is real, and its successes require no phenomenal ingredient. The claim defended here is therefore located at *justification*, not performance. The three capacities above are needed not for producing generalisations but for standing in normative relations to them—holding a projection as warranted, assessing its strength, being answerable to the evidence. Whether current or future artificial systems have, or could have, that normative standing is the live question the Map's AI wing treats directly in [[machine-consciousness]] and [[llm-consciousness]]; nothing in this article settles it by definition.
