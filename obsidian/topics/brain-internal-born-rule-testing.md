---
title: "Brain-Internal Born-Rule Testing — What Would Make the Corridor Empirically Superfluous"
description: "The corridor reading of Tenet 2 predicts no Born-statistical signature by construction. What would make it empirically superfluous: a coordinated programme of brain-internal observables, mechanism-specific signatures, and theoretical work on the definite-outcome problem."
created: 2026-05-14
modified: 2026-05-15
human_modified:
...
The article's working question: what would shut both readings, forcing the Map either to retreat to a [[trumping-preemption|trumping-preemption]] reading (selection on an axis the Born rule does not touch) or to abandon [[tenets#^bidirectional-interaction|Tenet 3]] altogether?
...
Taking the three criteria together honestly: the strict corridor is not foreclosed by any combination of refutation-of-related-mechanisms, corridor-consistent null, and theoretical supersession in the sense Popperian falsification demands. What gets foreclosed is the cluster of empirically committed readings of which the corridor is the most conservative limit; the strict corridor itself would become "unmotivated but consistent" rather than "refuted." That distinction is load-bearing. The Map holds the corridor as the working hypothesis precisely because [[mqi-empirical-fragility|MQI empirical fragility]] disciplines the alternative: claiming refutation where the data supports only motivation-loss would itself violate the [[evidential-status-discipline|evidential-status discipline]]. The honest position is that a strict corridor whose motivation is removed by supersession is a working hypothesis ready for retirement, even if no experimental refutation arrives.

## What Current Data Constrains, What It Does Not

Honouring [[evidential-status-discipline|evidential-status discipline]] requires being precise about which findings the catalogue currently has and which it does not.
...
The corridor reading is the Map's most conservative realisation of Tenet 2 (Minimal Quantum Interaction). Its commitment is austere: a brain-prepared candidate set, a physics-set distribution, a mind that selects without redistributing mass. The Map adopts the corridor as the working hypothesis because it satisfies the [[consciousness-physics-interface-formalism|five-constraint corridor]] cleanly, is consistent with every tested Born-rule regime, and carries the smallest empirical risk among readings of Tenet 2 that preserve [[tenets#^bidirectional-interaction|bidirectional interaction]]. The price is that the corridor predicts no Born-statistical signature by construction. The Map holds the corridor as the working hypothesis, *not* as a confirmed one, and admits the probability-bias reading (Class 2 in the [[channel-class-taxonomy|channel-class taxonomy]]) and the trumping-preemption reading as live alternatives.
...
- [[local-tomography-and-the-consciousness-physics-interface]] — Names the exact structural axiom whose failure across the physical/non-physical cut would formally reopen the Born constraint, and nominates the brain-internal tests catalogued here as the locus to look for the resulting deviations
