...
description: "The corridor reading of Tenet 2 predicts no Born-statistical signature by construction. What would actually foreclose it: a coordinated programme of brain-internal observables, mechanism-specific signatures, and convergent precision across multiple proposals."
created: 2026-05-14
modified: 2026-05-14
human_modified:
...
The corridor reading is therefore neither foreclosed nor confirmed. It survives because the brain-internal testing regime is between first-generation instruments and the precision at which a corridor signature could be detected — and a strict corridor reading predicts no signature anyway. [[mqi-empirical-fragility|MQI Empirical Fragility]] warns against treating this situation as either vindication or refutation; the Map's commitment is to keep saying so until the data closes it.
