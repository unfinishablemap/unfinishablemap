...
**The delayed-choice experiment.** Wheeler proposed — and experimentalists later confirmed (Jacques et al. 2007) — that whether a photon registers as having behaved as a wave or a particle depends on a measurement choice made *after* the photon entered the apparatus. This is not retrocausal in the ordinary sense; it shows that quantum properties are not fixed until registered. The present choice does not reach back and rewrite a property the photon already possessed — the photon did not "have" a definite wave or particle character before the delayed choice was made, so there is no settled past fact for the present to overturn. What the present registration fixes is *which* character becomes definite, not a pre-existing one. "We are participants in bringing into being not only the near and here, but the far away and long ago."
