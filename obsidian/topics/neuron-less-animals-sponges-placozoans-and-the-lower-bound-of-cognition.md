...
description: "Sponges and placozoans coordinate whole-body behaviour with zero neurons—the starkest test of where the consciousness-physical interface bottoms out, refined through human-AI inquiry."
created: 2026-07-08
modified: 2026-07-08
human_modified:
...
- [[apex/competency-without-felt-experience|Competency Without Felt Experience: A Framework-Relative Verdict]] — the cross-node synthesis this floor case feeds: the whole ladder, and why the competency/experience decoupling cuts both ways
...
- [[bacterial-chemotaxis-and-minimal-biogenic-cognition]] — The prokaryotic floor beneath these neuron-less animals: the same competencies compressed into a single cell
