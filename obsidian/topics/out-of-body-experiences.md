...
description: "Out-of-body experiences are phenomenologically real and causally diverse. The Map distinguishes self-model dislocation from genuine perspectival shift, and resists the inference from mechanism to dismissal."
created: 2026-05-08
modified: 2026-05-08
human_modified:
...
embedded_videos:
  - id: StU8aNLD1MQ
    ...
    embedded: 2026-05-11T14:02:23.387583+00:00
...
Near-death contexts are where the dualist case for OBEs becomes empirically loaded. [[near-death-experiences|Near-death experiences]] frequently include an OBE component: experiencers report viewing their own resuscitation from a vantage point outside the body, sometimes describing equipment, personnel, or events they claim to have witnessed during cardiac arrest.
...
4. **Resolution of the heightened-experience asymmetry**: If the broader NDE puzzle of enhanced cognition during cerebral compromise received a compelling materialist explanation (see [[near-death-experiences]]), the OBE component of NDEs would lose its association with the larger filter-theoretic argument.
...
- [[near-death-experiences]] — The clinical and evidential context for NDE-OBEs and the AWARE results
- [[lucid-dreaming-and-dualist-rendering]] — Another natural experiment in self-model reconfiguration with overlapping phenomenology
- [[clinical-phenomenology-and-altered-experience]] — How psychiatric and neurological dissociations bear on theories of consciousness
- [[neurological-dissociations-as-interface-architecture]] — Lesion evidence for the brain-as-interface reading
- [[filter-theory]] — The transmission model on which OBEs are dislocations within the filter
- [[somatic-interface]] — How the body figures in conscious experience under interactionist dualism
- [[self-and-self-consciousness]] — The phenomenal self-model and its relation to consciousness
