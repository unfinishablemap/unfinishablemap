...
modified: 2026-04-03
human_modified: null
ai_modified: 2026-04-03T15:38:00+00:00
draft: false
topics:
...
coalesced_from:
  ...
  - "/topics/fragmented-consciousness/"
---
...
Philosopher Thomas Nagel, in his influential 1971 paper "Brain Bisection and the Unity of Consciousness," examined five possible interpretations and rejected all of them. His conclusion: "There is no whole number of 'centres of consciousness' in brain bisection patients: there is too much unity... to say 'two', yet too much separation in the specially contrived laboratory situations to say 'one'."
...
Mashour (2012) reviewed evidence that general anaesthetics do not achieve unconsciousness by suppressing neural activity. The brain remains active under propofol. What changes is integration. Neural spiking fragments into on/off oscillatory states, and phase coupling across cortical areas drops significantly. Consciousness ceases when integration ceases, even though the components remain individually active.
...
For physicalist frameworks like [[integrated-information-theory|Integrated Information Theory]], this is straightforward — consciousness just *is* integrated information, and fragmenting integration eliminates it. The dualist reading is different: integration may be the physical condition that allows consciousness to interact with the brain, without being consciousness itself. Disrupt integration and you disrupt the interface, not the mind.
...
A pattern emerges across all three cases. In each, what demonstrably fragments is a physical system: the corpus callosum's connectivity, cortical phase coupling, or trauma-disrupted memorial systems. Whether consciousness itself fragments is precisely what remains unclear. The behavioural evidence — conflicting responses, loss of cross-hemisphere access, amnesic barriers between alters — establishes that the *expression* of consciousness through the body is disrupted. It does not establish that the [[phenomenal-consciousness|phenomenal]] subject has divided.

The interface argument makes this distinction explicit. Consciousness interacts with the physical world through the brain. When the interface fragments, output fragments. But the signal source need not have divided. A damaged receiver produces garbled or split output without the broadcast signal having changed.
...
If consciousness can exhibit this kind of partial division, what individuates subjects over time? The [[consciousness-and-the-metaphysics-of-individuation|individuation question]] becomes especially acute. Standard answers struggle:
...
What the cases *do* compound is the [[hard-problem-of-consciousness|hard problem]]. Even if we fully mapped the neural patterns, we would not have explained why those patterns are accompanied by experience — or why the phenomenal question (one mind or two?) resists the determinate structure that the neural description exhibits.

### Two Puzzling Features Support the Interface Reading
...
**The threshold character of loss.** When general anaesthesia succeeds, consciousness does not fragment into multiple diminished streams — it disappears. If consciousness were reducible to integrated activity, fragmenting the integration should produce fragmented but still-present experiences. Instead, below a threshold of global integration, experience ceases. This threshold character is what one would expect if integration is a *condition* for consciousness to interact with the brain, rather than the thing that constitutes consciousness.

Neither point is decisive. A physicalist can explain resilience through redundant neural pathways and the all-or-nothing character through threshold effects in information integration. What differs is what each framework most naturally predicts.

## The Illusionist Challenge

[[illusionism|Illusionists]] like Daniel Dennett and Keith Frankish offer a radically different interpretation. Dennett's Multiple Drafts Model (1991) proposes consciousness was never unified in the first place — the brain runs parallel processing streams, and the sense of unity is a retrospective narrative.
...
The split-brain case poses a specific problem for illusionism: Nagel's indeterminacy. Illusionism predicts that once we fully describe the cognitive processes, no residual puzzle remains. But split-brain cases resist this closure: full knowledge of the neural facts leaves the question of how many subjects are having experiences genuinely open.

## Process Philosophy Perspective

Alfred North Whitehead's process philosophy offers a distinctive framework. Rather than substances that persist through time, Whitehead posits "actual occasions" — momentary experiential events that arise, complete themselves through "concrescence," and perish.

On this view, the question "How many minds?" assumes a substance metaphysics that process philosophy rejects. In a normal brain, actual occasions in each hemisphere prehend (incorporate) occasions from the other via corpus callosum transmission, creating densely interconnected series that experience as unified. When severed, the prehensive relations thin dramatically but don't vanish — subcortical pathways and minimal remaining fibers continue to provide some connection.

The 2025 finding that minimal fiber connections preserve full neural synchronization makes sense processually. Actual occasions don't require massive causal throughput to prehend each other — they need only sufficient connection for experiential relevance to transmit.
...
**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: If consciousness interacts with the brain through quantum-level processes that require integrated neural activity, disrupting integration disrupts the interaction site. Anaesthesia may eliminate consciousness's capacity to bias quantum outcomes by fragmenting the coordinated neural substrate through which the biasing occurs. The mind does not fragment; the mechanism for mind-brain coupling does. The persistence of response unity despite perceptual division suggests coordination at a level not fully determined by macro-level neural connectivity.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: The fragmentation evidence actually supports bidirectional interaction. If consciousness were epiphenomenal, then fragmenting the brain should not affect experience at all. The fact that disrupting integration disrupts the *expression* of consciousness is precisely what interactionist dualism predicts: the interaction requires a functioning interface.

**[[tenets#^no-many-worlds|No Many Worlds]]**: If consciousness can divide within one body, does this support subject-multiplication? Two crucial differences from Many Worlds: split-brain division is observable and bounded, and both hemispheres share continuous physical history. The Map's [[personal-identity#Indexical Identity|indexical identity]] view can accommodate partial division within a single causal history more easily than infinite branching.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The physicalist reading — consciousness fragments because it is physical integration — appears simpler. But this simplicity purchases a commitment that consciousness is *nothing more* than integration. The resilience of unity and the all-or-nothing character of anaesthetic loss are then coincidences rather than expected features. The apparently more complex dualist reading (consciousness plus interface) may be the more explanatory account. Split-brain cases exemplify why simplicity is the wrong criterion: the actual situation resists clean description, and the demand for a "whole number" of minds presupposes that consciousness has the kind of structure that admits whole-number answers.

## What Would Challenge This View?

The framework could be challenged by:

1. **Determinate two-mind evidence.** If split-brain patients exhibited completely independent autobiographical memories, conflicting life goals, or genuinely separate sense of identity, this would support "two minds" over "indeterminate unity."

2. **Full illusionist explanation.** If neuroscientists could fully explain reports of feeling like "one person" in terms of cognitive processes without reference to phenomenal experience.

3. **Neural mechanism for determinate unity.** Discovery of a mechanism that definitively either unifies or divides consciousness with no intermediate cases. The 2025 findings push against this.

4. **Fragmented anaesthetic consciousness.** If anaesthesia produced multiple diminished experiential streams rather than all-or-nothing loss, the threshold argument for the interface reading would weaken.

5. **Quantum decoherence ruling out neural coherence.** Definitive proof that no quantum coherence exists in neural tissue at relevant timescales would eliminate quantum-binding explanations for phenomenal unity.
...
- [[entanglement-binding-hypothesis]] — Quantum entanglement as the physical basis for phenomenal binding
...
- [[contemplative-practice-as-philosophical-evidence]] — First-person evidence for consciousness surviving altered states
