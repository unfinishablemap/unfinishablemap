...
2. **Shared causal history:** Both hemispheres in a split-brain patient share continuous physical history and remain in causal contact through subcortical pathways. the project's [[personal-identity#Indexical Identity|indexical identity]] view can accommodate partial division within a single causal history more easily than infinite branching.
