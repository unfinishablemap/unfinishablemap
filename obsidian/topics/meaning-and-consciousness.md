...
**[[tenets#^no-many-worlds|No Many Worlds]]**: Understanding presupposes a unified subject who grasps meaning. The sentence means something *to me*. [[many-worlds|Many-worlds]] would fragment this: different branches contain "copies" grasping different meanings, and no single subject bears the semantic relation. The [[haecceity|haecceitistic]] dimension is crucial—*this* meaning is grasped by *this* mind, and that particularity resists branching.
