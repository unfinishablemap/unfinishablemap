...
Henry Stapp's analysis identifies the gap precisely. Von Neumann's Process 1 — the choice of what to measure — is not specified by any known physical law. Physics tells us what happens *given* a measurement but not why *that* measurement occurs. Stapp calls this "Process 0," the free choice determining Process 1. It constitutes a genuine causal gap in the physical description. [[stapp-quantum-mind|Stapp's quantum Zeno framework]] develops this into a full account: consciousness fills the gap by selecting among quantum-permitted neural outcomes.
...
The response that "decoherence restores effective classicality" misses the point. [[decoherence|Decoherence]] selects preferred bases and suppresses interference, but it does not explain why one outcome rather than another becomes actual. The measurement problem remains unsolved, and it is precisely a failure of causal closure.
...
The historical survey supports the Map's position through [[tenets#^occams-limits|Tenet 5 (Occam's Razor Has Limits)]]. The apparent simplicity of causal closure — one domain, one kind of cause — reflects the same pattern that made geocentrism, continuous matter, and deterministic physics seem simpler than the truth. An empirical assumption was elevated to a metaphysical axiom because it simplified the picture, not because the evidence compelled it.
