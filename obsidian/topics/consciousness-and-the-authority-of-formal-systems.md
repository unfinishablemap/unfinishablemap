...
modified: 2026-02-24
human_modified:
ai_modified: 2026-02-24T05:55:00+00:00
last_deep_review:
draft: false
topics:
  - "[[dualism]]"
...
The presumption is understandable but not self-evidently correct. Mathematics describes *structure* — relations between elements, patterns of transformation, symmetries and invariances. Bertrand Russell noticed this in *The Analysis of Matter* (1927): physics tells us about the structure of matter — causal relations, spatiotemporal arrangements, mathematical regularities — but nothing about what matter is *in itself*. The equations are "abstract, consisting entirely of structure," leaving intrinsic natures unspecified.
...
Wilfrid Sellars distinguished the "space of reasons" from the "space of causes." Logic's authority is especially stubborn against reductive explanation: the claim that modus ponens is culturally constructed is incoherent — any culture that rejected it could not reason at all. The claim that it is an evolutionary adaptation reduces necessity to contingent usefulness. Logic's authority is *presupposed* by any attempt to explain it away. Unlike morality, which can be questioned without using moral reasoning, logical authority cannot be questioned without using logic.

### The Structural Gap

The Map asks the reverse of Wigner's question: why is mathematics so *ineffective* at capturing consciousness? Three candidate explanations present themselves. **Temporary difficulty**: consciousness is structurally complex and we haven't found the right framework. **Category error**: mathematical description is the wrong *kind* of tool — like trying to weigh a joke. **Cognitive closure**: a mathematical account may exist but human minds cannot access it, per Colin McGinn's [[mysterianism]]. The Map finds the category error most compelling while taking cognitive closure seriously.

[[functionalism|Functionalists]] argue phenomenal properties *are* relational — defined by connections to inputs, other states, and outputs. The Map finds this inadequate. The conceivability of [[philosophical-zombies|zombies]] (functionally identical beings lacking experience) suggests functional structure is not identical to phenomenal quality. The [[knowledge-argument]] — Mary the colour scientist plausibly learns something upon seeing red — indicates complete structural knowledge leaves something out. These arguments establish that the non-structural character of consciousness is not naive assumption but long-standing philosophical challenge.
...
- [[consciousness-and-mathematical-creativity]] — Mathematical creation as evidence for consciousness doing causal work
