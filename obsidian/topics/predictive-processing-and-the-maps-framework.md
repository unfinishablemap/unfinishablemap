...
This is the standard [[functionalism|functionalist]] limitation applied to PP's specific case. As critics note, "we seem to experience moderate-sized specimens of dry goods, not probability density distributions." The mathematics of Bayesian inference does not contain the resources to generate [[qualia]]. PP inherits this problem from every computational theory of mind — and the Map argues this inheritance is principled rather than accidental.
...
**Attention is central.** PP places precision weighting — functionally, attention — at the heart of cognition. This supports the Map's claim that [[attention]] is the primary interface between consciousness and the physical world.
...
- [[phenomenology-of-surprise-and-prediction-error]] — What prediction error feels like
