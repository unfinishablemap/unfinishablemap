...
First, the felt texture of belief revision—the resistance, rupture, and reorganisation described here—constitutes phenomenal fact that goes beyond any functional or computational description. A system that performed identical belief-revision operations without these experiences would be doing something different, missing something real. This supports the Map's [[tenets#^dualism|dualism tenet]]: there are facts about what belief revision is like that physical description alone does not capture.
