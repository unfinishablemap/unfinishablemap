...
description: "If consciousness is irreducible to physics, linguistic meaning cannot be exhausted by syntax or function. Dualism reframes semantics, reference, and the limits of expression."
created: 2026-04-04
modified: 2026-04-04
human_modified:
...
The [[philosophical-zombies|zombie argument]] has well-known implications for philosophy of mind. Its implications for philosophy of language are equally significant but less often explored.
...
The philosophy of language under dualism connects to the Map's [[tenets]] at several points.

**[[tenets#^dualism|Dualism]]** is the driving commitment. If consciousness is irreducible, then meaning, reference, and expression cannot be fully accounted for by physicalist philosophy of language. The semantic gap is a direct consequence of the explanatory gap: just as no physical account explains *why* neural states feel a particular way, no functional semantics explains *how* words refer to phenomenal states. The Map holds that this gap is ontological, not merely epistemic.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** appears in the relationship between meaning and consciousness. Consciousness contributes phenomenal content to linguistic meaning—the zombie lacks precisely this contribution. Language in turn shapes conscious experience through categorical perception, verbal overshadowing, and conceptual formatting. The bidirectional flow of meaning between the physical domain of language and the non-physical domain of consciousness is a specific instance of mind-body interaction.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]** applies to physicalist semantics. The apparently simpler view—that meaning is exhaustively functional—fails to account for phenomenal reference, the zombie dissociation, and the systematicity of qualitative judgement. The more complex account, which posits a phenomenal dimension of meaning alongside the functional, better explains the data. As with dualism generally, the simpler theory is not the better theory when the domain exceeds its conceptual resources.
