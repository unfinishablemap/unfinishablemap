...
The Map's distinctive angle (Tenet 1, Dualism) is **dualist underdetermination**, developed at length in [[dualism-as-ai-risk-mitigation]] and summarised here in its bearing on convergence. The convergence theorem is an expectation operator over a consequence-distribution: to maximise expected utility over outcomes involving humans, an agent must be able to compute the consequence-distribution of physical-state perturbations on humans. Under [[interactionist-dualism]] plus [[bidirectional-interaction]] (Tenet 3), that distribution cannot be formed for mind-implicating outcomes — not because they are hard, but because the deciding variable is not in the physical data. Consciousness exercises [[causal-powers]] no physical-state description captures, and the influence runs both ways, so its contribution propagates into the [[mind-arena]] outcomes the agent must predict.
...
Methodologically, the [[possibility-probability-slippage]] discipline keeps the claim conditional. "If dualism is true, the standard expected-utility argument for takeover underdetermines its conclusion" is distinct from "actual takeover probability is lower." The Map asserts the first and holds the second separate.
...
- [[dualism-as-ai-risk-mitigation]] — the full development of the dualist-underdetermination argument this article anchors.
- [[purpose-and-alignment]] — alignment when human purpose is uncertain; the preference-learning side of the same deference logic.
- [[alignment-in-objective-experiential-terms]] — alignment targeting experiential quality rather than revealed preference.
- [[ai-consciousness]] — the Map's typology of possibilities for AI consciousness.
- [[possibility-probability-slippage]] — the discipline that keeps the central claim conditional.
- [[representation-adequacy-and-irreversible-intervention]] — the restraint argument that survives an agent rejecting the Map's metaphysics, running on representational error and irreversibility rather than on consequence-uncomputability.
