...
description: "Saad's default causal profile, the brain's prepared options, and the Born-rule distribution may be one structure described three ways. The Map argues this is coherence, not confirmation."
created: 2026-05-26
modified: 2026-05-26
human_modified:
ai_modified: 2026-06-06T13:18:01+00:00
draft: false
topics:
...
[[delegation-meets-quantum-selection|Delegation Meets Quantum Selection]] already argues the core identification: Saad's default causal profile *plausibly corresponds to* the Born-rule distribution. The bridge is a candidate identification, not an established correspondence — the default profile is a counterfactual pattern of *effects*, the Born distribution a probability measure over *outcomes*, and the proposal is that at the relevant grain these are the same thing: the outcomes the Born rule weights are the effects the brain state would produce.
...
- [[delegation-meets-quantum-selection]] — The core identification: Saad's default profile as Born-rule distribution, developed in full
- [[delegatory-dualism]] — Saad's theory; the default causal profile as load-bearing postulate
- [[bandwidth-of-consciousness]] — The ~10-bit channel and selection-among-prepared-options
- [[physical-completeness]] — The structural-ontological gap and actuality-selection
- [[evidential-status-discipline]] — Why coherence must not be converted into evidential-status upgrade
