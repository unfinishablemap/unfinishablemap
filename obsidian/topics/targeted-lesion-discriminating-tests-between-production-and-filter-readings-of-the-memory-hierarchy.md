---
title: "Targeted-Lesion Discriminating Tests Between Production and Filter Readings of the Memory Hierarchy"
description: "Human+AI design-space inquiry: which focal-lesion or focal-stimulation experiments could discriminate production from filter readings of the autonoetic-noetic-anoetic ordering — and which the existing data cannot deliver."
created: 2026-05-19
modified: 2026-05-19
human_modified:
ai_modified: 2026-07-08T15:37:15+00:00
last_deep_review: 2026-07-08T15:37:15+00:00
draft: false
topics:
...
The [[memory-channel-interface-evidence|memory-vulnerability hierarchy article]] names a discriminating test in passing — "a narrow perturbation that hits an autonoetic-supporting region while sparing its noetic-supporting subregions should, on the production reading, produce a *different* ordering, while the filter reading still predicts the standard one" — and admits the catalogue does not yet have a clean case to point to. This article develops the named-but-undeveloped discriminator into a worked design space, specifying what the test would require, what existing data approximates, where the approximations fall short, and which candidate target-region pairs might one day deliver it. The article is a *design space* rather than an extant experimental programme, and the [[evidential-status-discipline|evidential-status discipline]] requires foregrounding that nothing said here moves the production-vs-filter dispute above [[direct-refutation-discipline|Mode Four empirical underdetermination]] at present. On the evidence currently available, the two readings are empirically equivalent at the memory-hierarchy tier: the dispute is underdetermined by the data, and the tests proposed below are candidate discriminators rather than settled results. The existing literature does not decide between them; it is compatible with both readings.
...
The brainstem-lesion case is rarely available in humans with the needed spatial resolution and is methodologically tangled by sleep-laboratory access issues. It sits in the design space as a target the [[neurological-dissociations-as-interface-architecture|neurological-dissociations]] article catalogues without yet being able to leverage as discriminator.
...
- [[direction-dependent-discriminating-test-design]] — The direction-axis companion to this substrate-state design: a reversible-perturbation test of whether the channel ordering is the same in both directions of travel
...
- [[clinical-dissociation-as-systematic-evidence]] — Dissociative-states evidence that decouples channels without substrate damage; a third structural geometry the discriminating test cannot use but the cross-case argument relies on
- [[disconnection-neuroscience]] — The white-matter and network-connectivity literature whose findings constrain the spatial-selectivity requirement
