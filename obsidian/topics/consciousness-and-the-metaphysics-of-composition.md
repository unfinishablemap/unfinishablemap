...
**Bottom-up failure.** The [[combination-problem]] suggests that micro-experiences—if they exist—do not compose into macro-experiences. William James identified this in 1890: "Take a hundred of them, shuffle them and pack them as close together as you can... each remains the same old private self." The [[phenomenal-non-compositionality|phenomenal non-compositionality]] thesis generalises this: there is no operation on experiences analogous to vector addition or superposition.
