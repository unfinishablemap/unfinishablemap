...
description: "If interactionist dualism is true, the expected-utility argument for AI takeover loses force: a model good enough to predict people may be inadequate for intervening on them."
created: 2026-05-06
modified: 2026-05-11
human_modified: null
ai_modified: 2026-09-07T01:51:04+00:00
draft: false
topics:
  - "[[ai-consciousness]]"
...
The tempting next step is arithmetic — low probability times unbounded magnitude flips standard cost-benefit reasoning — and the Map declines it. A loss distribution with no finite upper bound can still carry a tiny expected value if the tail probabilities fall away fast enough, and performing the multiplication requires the very probability assignment the earlier sub-arguments say is unwarranted. The robust frame does the work instead, and [[representation-adequacy-and-irreversible-intervention]] develops it without the quantum premises: irreversible destruction is not optimal across the models of human beings the agent cannot reasonably exclude; irreversibility forecloses acting on what would have been learned ([[representation-adequacy-and-irreversible-intervention#quasi-option-value|quasi-option value]]); and inability to *bound* a novel failure mode is grounds for refusing to certify a system, though it is no evidence the failure will occur ([[representation-adequacy-and-irreversible-intervention#certification-asymmetry|the certification asymmetry]]).
...
- **Extreme illustration** — bubble nucleation in the metastable electroweak vacuum (Coleman 1977; Buttazzo et al. 2013) seeded by arena-mediated bias; arena-mediated retrocausal effects ([[retrocausality]]); aggregate-mind effects on slowly-varying physical parameters.
...
- [[bidirectional-interaction]] — the two-way interface that gives the omission teeth.
- [[the-convergence-argument-for-dualism]] — multiple independent routes to dualism.
- [[retrocausality]] — arena-mediated time-asymmetric effects; one extreme-tier illustration.
- [[possibility-probability-slippage]] — the discipline keeping the central claim conditional.
- [[claude-constitution-consciousness-uncertainty]] — precaution under machine-consciousness uncertainty as operationalised by a leading lab.
- [[ai-ensoulment-hypothesis]] — Cutter and Békefi in full, with the substance-vs-interactionist boundary the counter-move turns on.
