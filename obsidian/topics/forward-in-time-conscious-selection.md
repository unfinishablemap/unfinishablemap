...
The trade-off is falsifiability. Pre-decoherence models make concrete predictions—detection of quantum coherence at specific neural timescales would support Orch OR or Stapp; post-decoherence models operate at the interpretive level, where the [[testing-consciousness-collapse|experimental programme]] has less traction. This is a cost the Map accepts: post-decoherence selection's invulnerability to the timing-gap objection is paid for in falsifiability, not gained for free—a deliberate choice favouring the more conservative pathway.
