...
description: "First-person reports carry layered epistemic authority grounded in acquaintance and phenomenal conservatism. Husserl's evidence taxonomy, competing models of introspection, and five calibration strategies establish the evidential base for dualism against materialist dismissal."
created: 2026-02-09
modified: 2026-04-01
human_modified:
ai_modified: 2026-04-01T20:41:00+00:00
draft: false
topics:
...
Huemer's central argument for PC is the [[self-stultification|self-defeat]] charge: any alternative epistemological principle must itself seem true to those who hold it. Denying PC while relying on it is self-undermining.

Applied to consciousness: pain *seems to hurt* — to have a qualitative feel beyond what functional description captures. Visual experience *seems coloured* — to present redness as a feature of consciousness itself. PC says these seemings carry prima facie justificatory weight. To deny this — as [[illusionism]] does — requires positive reasons, not mere theoretical preference for parsimony.
