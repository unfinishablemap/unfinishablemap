...
[[william-james-consciousness|William James]] insisted that consciousness "does not appear to itself chopped up in bits. It flows." His stream metaphor is an activity metaphor: consciousness streams, selects, attends, connects. James's phenomenology of the "transitive parts"—the flowing connections between stable contents—reveals aspects of experience that the property framework cannot capture. These transitions are not properties possessed by mental states; they are activities that constitute the movement between states.
