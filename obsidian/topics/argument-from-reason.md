...
modified: 2026-01-24
human_modified:
ai_modified: 2026-06-02T02:25:24+00:00
draft: false
...
The argument from reason does not refute this position by appeal to a tenet; it engages it on its own terms, through the very debate non-reductive physicalism has had to answer internally—Jaegwon Kim's exclusion argument (*Mind in a Physical World*, 1998). Kim's point is that once the mental description supervenes on a physical base that already has, in his phrase, all the credentials to serve as a sufficient cause, the supervenient description does no *additional* causal work; its causal completeness is inherited entirely from the base. Run against the argument from reason, this exposes the cost the "same event under two descriptions" reply must pay. What rational inference requires is not merely that *some* description of the event is rational, but that the content and validity of a thought—the thought *as content*, the conclusion's following *qua* its following from the premises—makes a causal difference to which belief forms. The supervenience picture cannot secure that. Whatever causal purchase the reasons-description has, it has by supervening on a physical base whose own causal story makes no reference to logical entailment; so qua-reasons, the rational relevance of the content adds nothing the physics did not already determine. The epiphenomenalist worry the non-reductive physicalist sought to escape returns—now *earned* by the exclusion argument rather than assumed, as a genuine dilemma the non-reductive physicalist must answer: either content-as-content does causal work the supervenience base does not, abandoning the very non-competition that made the position attractive, or it does not, and the rational relevance the argument from reason needs is exactly what the picture cannot deliver.

This is not a decisive disproof. The non-reductive physicalist has replies—denying Kim's exclusion principle outright, or developing a compatibilist account on which a determinable's content can be causally relevant in its own right (the proportionality line is one such attempt). Where the disagreement bottoms out is a hard question: whether content, *as content*, can be causally relevant under supervenience. That is closer to bedrock than a tenet-appeal makes it look, and the honest verdict is that the argument from reason converts Anscombe's compatibilism into a real dilemma rather than dissolving it—the boundary between the views lies exactly where the causal relevance of rational content is decided.

## Contemporary Formulations: Reppert and Hasker

Victor Reppert's *C.S. Lewis's Dangerous Idea* (2003) provides the most comprehensive contemporary defense. Reppert presents multiple versions targeting different aspects of rationality—intentionality (mental states have *aboutness* that physical states lack), truth (beliefs aim at truth; neural states don't), and logical laws (logical relationships are abstract and acausal). Each converges on the same conclusion: rational inference requires properties that resist physical reduction. Reppert's argument from intentionality connects directly to PIT: if genuine aboutness requires phenomenal character (as [[#consciousness|argued above]]), then the intentionality involved in grasping logical relationships cannot be physically realized.

William Hasker emphasizes the unity required for rational inference. Grasping an argument requires holding multiple propositions in mind simultaneously, seeing how they fit together, recognizing entailment relationships. This requires [[unity-of-consciousness|phenomenal unity]]—integrated conscious awareness that [[binding-problem|distributed neural activity]] cannot explain. Hasker's emergent dualism posits that a unified conscious subject emerges from brain activity but cannot be reduced to it. The Map shares Hasker's conclusion—an irreducible unified subject—while differing on the dependence direction: Hasker's is a from-below view on which the subject is generated by neural activity, whereas the Map's bi-aspectual dualism treats consciousness as co-fundamental rather than emerging *from* the brain.
...
**"This assumes dualism to prove dualism—circular reasoning."** The argument is transcendental, not circular. It shows that physicalism is *self-defeating*: if true, we cannot have rational grounds for believing it. Self-defeat arguments reveal internal inconsistencies, not question-begging. The argument demonstrates that rational inference requires properties physical description cannot capture. The same [[self-stultification]] structure appears in the [[introspection|introspection debate]]: if introspective reports are causally disconnected from experiences, we cannot rationally trust any claims about consciousness—including that introspection is unreliable.
...
The deeper question is whether *any* system—biological or artificial, however capable—can engage in genuinely normative reasoning without phenomenal awareness. The argument from reason doesn't turn on whether AI outputs are impressive; it turns on whether tracking normative relationships *as normative* requires consciousness. This is the distinction between [[rational-normativity#implementing-versus-grasping|implementing a norm and grasping it]]: a system might reliably produce outputs that match valid inferences across every domain, yet the question remains whether it is *constrained by* the fact that conclusions ought to follow from premises, or whether it is merely executing designed-in processes that happen to correlate with logical validity. The distinction identifies what an account owes; it does not by itself settle that consciousness supplies the grasping.
...
- [[phenomenology-of-intellectual-life|phenomenology of intellectual effort]] - The felt character of reasoning: holding premises, tracing implications, grasping why conclusions follow
...
- [[phenomenology-of-intellectual-life]] - The felt character of comprehension, inference, and meaning integration
