...
description: "Attention and motor planning share neural substrates, creating a unified selection interface where consciousness biases which competing options become actual—candidate sites, timing constraints, and testable predictions."
created: 2026-02-01
modified: 2026-02-09
human_modified:
...
The interface hypothesis *is* the specification of how [[tenets#^bidirectional-interaction|bidirectional interaction]] works mechanistically. The unified attention-motor substrate grounds this:
