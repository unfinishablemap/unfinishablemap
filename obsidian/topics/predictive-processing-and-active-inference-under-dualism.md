...
description: "Active inference's mathematical formalism is metaphysically neutral—its architecture of hierarchical selection and precision weighting fits interactionist dualism as naturally as it fits physicalism."
created: 2026-03-19
modified: 2026-03-19
human_modified:
...
The Map finds this unconvincing. Acknowledging two irreducible *descriptions* while insisting on one *ontology* looks less like a completed reduction and more like a promissory note. If the extrinsic and intrinsic information geometries genuinely account for distinct properties — physical and mental — then the position bears a striking resemblance to [[substance-property-dualism|property dualism]] wearing a monist label. The question is whether "mutual reducibility" does real philosophical work or merely names the hope that the two descriptions will someday collapse into one.
...
**The centrality of attention.** Precision weighting places attention at the heart of cognition, supporting the Map's claim that [[attention-as-interface|attention]] is the primary causal interface.
...
The Map argues the limitation is principled, not temporary. Adding more computational sophistication — deeper hierarchies, more refined precision weighting, richer self-models — will not cross the threshold from processing to experiencing. The [[explanatory-gap]] between functional description and phenomenal reality is not a gap in our current knowledge but a feature of the territory.
...
- [[predictive-processing-and-the-maps-framework]] — How PP integrates with the Map's broader framework
