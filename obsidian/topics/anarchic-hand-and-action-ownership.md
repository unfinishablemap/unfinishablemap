...
description: "Anarchic hand splits authorship of action from ownership of a limb—an agency-side dissociation the Map reads as interface, not proof, comparator rival conceded."
created: 2026-07-16
modified: 2026-07-16
human_modified: null
...
This is the pattern already developed for perception in [[split-brain-consciousness|split-brain]]—the interface fragments, not the mind—carried over to *volition*. Anarchic hand is that flagship's agency-side sibling. In split-brain the question is whether divided perceptual report means divided experience; in anarchic hand the perceptual and experiential subject is uncontroversially single, and only a motor channel has gone rogue. Different interface channels, as [[interface-heterogeneity|interface heterogeneity]] holds, can fail independently: ownership can survive the loss of agency, and the unified witness can survive the loss of a limb's obedience.
...
**[[tenets#^dualism|Dualism]]**: The Map treats volition as an interface phenomenon—a hand-off between conscious will and physical execution—that can be locally disrupted without dissolving the unified subject. Anarchic hand is a vivid instance: one channel of that hand-off fails, the movement proceeds without felt authorship, and the experiencer persists as one. This is coherent with dualism without proving it. The comparator account reaches the same clinical facts on physicalist premises, and the Map concedes that account is adequate to the neural data. What the Map denies is that adequacy at the neural level settles the further question of what the experiencer is.
...
- [[witness-consciousness]] — the single experiencer that disowns the movement.
- [[the-observer-witness-in-meditation]] — the unified witnessing subject explored from a different route.
