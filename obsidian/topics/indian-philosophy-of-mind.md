...
last_deep_review: 2026-05-31T23:05:27+00:00
draft: false
topics:
...
This means all cognitive processing—perception, reasoning, memory, emotion—belongs to the material world. *Buddhi* (intellect), *ahamkara* (ego-sense), and *manas* (coordinating mind) are evolutes of unconscious matter, structured by three constituent qualities (*gunas*): *sattva* (clarity and structure), *rajas* (activity and change), and *tamas* (inertia and obstruction). When *sattva* predominates in the intellect, matter becomes transparent enough to "reflect" *purusha*—but this is reflection, not emergence. Consciousness does not arise from material complexity. It was always present; matter merely ceases to obstruct it. This resonates with the [[filter-theory]]—brains transmit consciousness rather than producing it.

*Purusha* itself is pure witnessing: changeless, partless, and—crucially—inactive. The *Samkhya Karika* (Ishvarakrishna, c. 350 CE) states in verse 19 that *purusha* is a non-doer (*akarta*), a witness (*saksin*), and neutral. Verse 21 offers the famous analogy of the blind and the lame: *prakriti* is like someone who can walk but cannot see (active but unconscious), *purusha* like someone who can see but cannot walk (conscious but inactive). Together they accomplish what neither could alone.

### The Interaction Problem

If *purusha* does nothing, how does unconscious matter evolve purposefully? Samkhya's answers are distinctive, though the tradition itself seems to have recognised them as more suggestive than fully worked out. *Purusha* does not act on *prakriti* causally. Its mere *proximity* (*sannidhya*) is said to disturb *prakriti*'s equilibrium, the way a magnet moves iron filings without physical contact (the tradition's own analogy). The analogy may carry less than it appears to: a magnet exerts a perfectly physical force, so the comparison illustrates "influence without contact" without quite explaining "influence without causation." Vacaspati Mishra (c. 980 CE) developed a "reflection theory" (*pratibimba-vada*): consciousness is reflected in *buddhi* without entering it, as a face is reflected in a mirror without becoming the mirror. Whether either image resolves the mechanism, or only relocates it, remains a live question for the school's modern interpreters.

By placing mind within matter, Samkhya appears to sidestep the [[objections-to-interactionism|standard objections to interactionist dualism]]. [[causal-closure|Causal closure]] is preserved on this reading: physical causation handles everything in the material domain, which includes all mental activity, and consciousness illuminates without intervening. The gain may be more apparent than real, however — the interaction problem does not vanish so much as migrate to the *purusha*-*prakriti* relation, where the "proximity" mechanism above leaves it unresolved. Whether trading an interaction problem for a reflection problem counts as progress is itself underdetermined by the texts. For a broader comparative survey, see [[interaction-problem-across-traditions]].

### Plurality and Liberation

Unlike Advaita Vedanta's single universal consciousness, Samkhya holds there are many *purushas*—each individual has a distinct conscious principle. The argument (*Samkhya Karika* 18): different beings have different births, deaths, and experiences; actions are non-simultaneous; these facts require distinct witnesses.

Liberation (*kaivalya*) means isolation—*purusha* recognizing its complete distinction from *prakriti* through discriminative knowledge (*viveka-jnana*). The practice involves progressive negation: "this is not me; it is not mine; I am not this." When discrimination is complete, *prakriti* ceases to perform for that particular *purusha*.

## Nyaya: The Self That Is Not Essentially Conscious

Nyaya's position on consciousness is unlike anything in the Western canon. The self (*atman*) is a non-physical substance—but consciousness is not its essence. It is an *adventitious* quality that arises when the self connects with *manas* (the internal organ) and through *manas* with the sense organs. During dreamless sleep, the self exists without consciousness. Consciousness comes and goes; the self persists.

This makes Nyaya's *atman* closer to an Aristotelian substance that bears properties than to Descartes' *res cogitans*, defined by thinking. The self is not *what thinks* but *the thing that thinks when conditions are met*. According to the *Nyaya Sutra* (Gautama, c. 2nd century CE, 1.1.10), the self is the seat of desire, aversion, effort, pleasure, pain, and knowledge—but none of these is its defining nature.

### Arguments for the Self

The Nyaya school developed rigorous arguments against the Buddhist *anatman* (no-self) doctrine, culminating in Udayana's *Atmatattvaviveka* (c. 10th century):

**The memory argument**: Recollection ("I saw this person last week") requires a single subject persisting across time. One self cannot recollect another self's experiences. If the "I" of today were numerically different from the "I" of yesterday, memory would be impossible.

**Cross-modal synthesis**: Recognizing that the thing seen is the same thing touched requires a single experiencer synthesizing data from different senses. Nyaya argues that a bundle of momentary cognitions (the Buddhist position) cannot explain this convergence without something that unifies them. The Madhyamaka rejoinder is that the arguments overreach: memory and cross-modal synthesis require only *causal continuity* between momentary cognitions (*pratityasamutpada*), not a substantial enduring bearer, and continuity is not identity. The debate remains live—the site's own treatment of *anatman* in [[buddhism-and-dualism]] and [[void-as-ground-of-meaning]] takes the no-self position as a serious rival rather than a defeated one.

**The unity argument**: The fact that a single subject experiences diverse perceptions simultaneously is taken to require a unified, enduring subject. This seems to parallel the [[binding-problem]] in Western philosophy—synchronised neural firing is still firing in separate neurons, and interaction alone does not obviously explain unity. The parallel is imperfect: the binding problem is posed within a broadly physicalist frame Nyaya does not share, so the convergence is one of structure rather than of shared premises.
...
Gangesa also gave the most rigorous treatment of apperception (*anuvyavasaya*): awareness of being aware. He distinguished knowing *that* one cognizes (practically infallible) from knowing *what* one cognizes (fallible). This may anticipate debates about higher-order theories of consciousness in contemporary philosophy of mind, though the parallel should be drawn cautiously: Gangesa's *anuvyavasaya* is a distinct cognition directed at a prior one, which resembles some higher-order accounts but not others, and reading him as a proto-higher-order theorist risks importing a framing he did not share.
...
## Vedanta: Consciousness as Ground

### Advaita Vedanta

Shankara (c. 788–820 CE) takes the most radical position: *Brahman*—non-dual, infinite consciousness—is the sole ultimate reality. The empirical world of plurality is appearance produced by *avidya* (ignorance). Individual identity is superimposition (*adhyasa*): we falsely attribute properties of the body-mind complex to consciousness and properties of consciousness to the body-mind, like mistaking a rope for a snake.

Consciousness (*cit*) is *svaprakasha*—self-luminous. It does not require another awareness to be known. Shankara argues that if a primary cognition required a second apperceptive cognition to be known, the second would require a third, generating an infinite regress. Self-luminosity terminates the regress. This directly contradicts Nyaya's position that consciousness arises through causal contact.

Advaita's three levels of reality structure the relationship between consciousness and the world: *paramarthika satta* (ultimate reality—Brahman alone), *vyavaharika satta* (empirical reality—the intersubjective world, dependently real), and *pratibhasika satta* (apparent reality—individual illusions like dreams). The Map's tenets operate at the *vyavaharika* level—and Advaita agrees that at this level, the mind-matter distinction holds. See [[witness-consciousness]] for the *sakshi* (witness-self) central to this framework.

### Ramanuja's Critique

Ramanuja (traditionally 1017–1137 CE, though modern scholarship—Carman—favours c. 1077–1157) developed Vishishtadvaita ("qualified non-dualism") partly through a devastating critique of Shankara. His seven objections (*sapta-vidha anupapatti*) remain among the most-discussed objections to Advaita:

*Avidya* faces a circularity: if it resides in the individual self, but the individual self is itself a product of *avidya*, neither can ground the other. *Avidya* cannot coexist with *Brahman*, whose nature is pure consciousness—ignorance logically cannot persist in something whose fundamental nature is knowledge. And declaring *avidya* "indeterminable" (*anirvacaniya*)—neither real nor unreal—appears to violate the law of excluded middle.

Ramanuja's alternative: *Brahman* is real and qualified (*saguna*), possessing genuine attributes. Individual selves (*jivas*) and matter (*prakriti*) are eternally real and distinct—they constitute Brahman's *body* (*sharira*) while Brahman is their inner controller (*antaryamin*). Consciousness is always intentional—always *of* something—contra Shankara's non-intentional pure awareness.

This body-soul (*sharira-shariri*) model dissolves the interaction problem constitutively rather than causally: the relationship between Brahman and the world is like the relationship between a soul and its body. No causal bridge is needed because the relation is *internal*, not external.

## The Three-Way Disagreement

The deepest disagreement concerns what consciousness *is*:

| | Samkhya | Nyaya | Advaita Vedanta |
|---|---|---|---|
| **Consciousness** | Passive witness, separate from all activity | Adventitious quality arising from self-*manas* contact | The sole reality, self-luminous |
| **Mind's status** | Material (part of *prakriti*) | Internal organ mediating self and senses | Part of empirical appearance |
| **Interaction** | Proximity, no causal action | Genuine causal chain | No interaction problem (one reality) |
...
Three distinctive contributions are largely absent from Western philosophy of mind:
...
**[[tenets#^dualism|Dualism]]**: All three schools affirm consciousness as irreducible to matter—through independent arguments developed over millennia. This cross-school convergence *within* a single philosophical culture, achieved through sustained mutual criticism, adds evidence distinct from the cross-cultural convergence discussed in [[the-hard-problem-in-non-western-philosophy]]—subject to the common-cause caveat granted in §"The Three-Way Disagreement" above: the convergence strengthens the dualist option without, on its own, establishing it. It adds a further strand to [[dualism]]: internal disagreement about what consciousness *is* coexists with agreement that it is not material.
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Nyaya provides the strongest Indian support, with its explicit causal chain from self through *manas* to sense organs—a form of [[agent-causation]] articulated independently of the Western tradition. Samkhya's passive *purusha* is a genuine tension. The Map sides with Nyaya over Samkhya on this point: consciousness acts, it does not merely witness.

**[[tenets#^no-many-worlds|No Many Worlds]]**: Samkhya's and Nyaya's insistence on multiple distinct selves, each with its own experiential history, supports the Map's concern that indexical identity matters. The question "Why am I *this* purusha and not another?" is meaningful in Samkhya—and the tradition takes it seriously enough to argue for it. This anticipates the structure of the [[vertiginous-question]]: the cognitive boundary where first-person identity resists explanation, formulated independently in an Indian tradition two millennia before Western analytic philosophy posed the same question. The fit is structural rather than exact: Samkhya's plurality is of co-real *simultaneous* selves, whereas the vertiginous question concerns indexical assignment among many minds in one world, and neither is the branch-relative indexing that motivates the [[tenets#^no-many-worlds|No Many Worlds]] rejection of MWI. What carries across is the shared intuition that first-person assignment is a genuine fact in need of explanation.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: Two millennia of rigorous internal debate—Samkhya against Nyaya against Vedanta against Buddhism—produced sophisticated positions that cannot be dismissed as pre-scientific naivety. These schools disagree about nearly everything else (whether consciousness acts, whether it is self-luminous, whether selves are many or one) yet converge on irreducibility. Subject to the same common-cause caveat granted above—and to the deflationary point that none possessed a reducing science (neural correlates, computational models) that would have made a reduction verdict a live option to begin with—the convergence still tells against the easy confidence of materialism: the traditions with the deepest sustained investigation of consciousness consistently found it irreducible, not because they lacked rigour, but because their rigour, on the data before them, pointed elsewhere. The apparent simplicity of materialism looks less compelling in that light, even granting that unanimity among investigators who lacked the reducing apparatus cannot by itself settle the question.
