...
**Falsifiability: Moderate.** The phenomena the model accommodates (willed/instructed signatures, effort-difficulty correlation, neuroplasticity) are equally consistent with classical neuroscience. The model lacks predictions distinguishing Zeno-mediated from classical attention. A discriminating test would require detecting the quantum signature of repeated rapid observations — beyond current technology.
...
A complete comparison must locate these four mechanisms against the most rigorous *external* critic — Włodzisław Duch (trained as a quantum physicist; now a cognitive scientist), whose anti-quantum-mind position challenges the quantum framing as such. Duch (2005, 2019) argues that classical-computational self-reflective dynamical access ("mind as a shadow of neurodynamics") suffices to ground consciousness. His sharper claims — that brain dynamics require *differentiation* across regions and timescales rather than the global synchronisation Penrose-Hameroff-style proposals require, and that decoherence makes sustained quantum effects implausible at biological temperatures, echoing Tegmark 2000 — he makes in popular and online writing, not in the papers cited here. He dismisses substantive quantum-mind proposals as exotic-physics gap-filling — a charge cutting most sharply against Orch OR and least against the discrete-event mechanisms (Stapp, Fisher). Hybrids that already accept objective collapse on physical grounds (CSL-IIT) face a different Duch objection: that consciousness modulation adds no explanatory power that classical attractor dynamics over the same neural states cannot already supply.

The Map's relationship to Duch is *convergent-conclusion-opposite-reasoning*: both are sceptical of substantive quantum-mind proposals at Orch-OR-style scale, but Duch wants *zero* quantum role on classical-sufficiency grounds where the Map wants *minimal-but-real* on bidirectional-interaction grounds — its [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet already favours the *minimal* end of the spectrum. Duch's anti-coherence arguments travel cleanly into the Map; his classical-sufficiency commitment does not, and conflating the two would be a category error. The [[research/wlodzislaw-duch-consciousness-2026-05-02|Duch research dossier]] maps both in detail.
...
- [[testing-consciousness-collapse]] — Distinguishing consciousness-collapse from decoherence, including concrete divergent predictions
