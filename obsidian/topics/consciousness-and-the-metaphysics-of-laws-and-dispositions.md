...
**The governing view** (Dretske, Tooley, Armstrong) treats laws as relations among universals—second-order facts about how properties connect. The law that masses attract is a real relation between *mass* and patterns of acceleration that holds counterfactually. Laws are genuinely prescriptive: they *make* things happen.
...
Humean psychophysical laws are admissible; the problem is that they lack *explanatory depth*. Saying "it is a law that brain state B produces experience E" provides no more than "it regularly happens that B is followed by E." The Humean dualist gets correlation without illumination—the [[hard-problem-of-consciousness|hard problem]] transplanted into the metaphysics of laws. A Humean can reply that physical Humean laws are equally shallow; the dualist's answer is that psychophysical regularities bridge [[emergence|ontologically distinct domains]], making the absence of deeper explanation more troubling.

A deeper concern: [[supervenience|Humean supervenience]] holds that everything supervenes on the mosaic of local particular matters of fact. If consciousness adds something beyond the physical mosaic—as dualism claims—Humean supervenience fails. A committed Humean might accept psychophysical correlations into the best system while denying that phenomenal properties are ontologically additional, which collapses back into physicalism.
...
The difficulty is the *legislation problem*: who or what legislates the psychophysical laws? For physical laws, the governing theorist treats them as brute modal facts. But psychophysical laws connect two ontologically distinct domains, and cross-domain legislation between radically different kinds is widely held to require additional explanatory work.

The Map offers candidate underlying principles rather than leaving the legislation point brute. [[bi-aspectual-ontology]] proposes that structure and actuality are co-fundamental aspects of one reality, so a governing law relating them is a constraint linking two faces of the same underlying nature rather than a relation across an ontological chasm. The interface model anchors this further: psychophysical laws are local prescriptions at sites of neural quantum indeterminacy where the two aspects already share a contact surface. Neither principle eliminates the cost—the relating-law itself remains primitive—but they narrow *where* and *how* cross-domain legislation operates rather than leaving it freestanding.

The governing view supports the Map's bidirectional framework. If laws are genuinely prescriptive, downward psychophysical laws could prescribe that certain conscious states produce certain physical outcomes. This gives [[mental-causation-and-downward-causation|psychophysical causation]] the same metaphysical status as physical causation: both are law-governed.

There is further consequence for the quantum measurement problem. Physics leaves quantum measurement unexplained; a psychophysical governing law could fill that gap as completion of the lawful structure physics itself requires. The Map's selection law framework—consciousness biasing otherwise indeterminate quantum outcomes, developed in [[psychophysical-laws-bridging-mind-and-matter|the psychophysical laws article]]—takes the governing-law form because it requires what governing laws specifically supply: prescriptive modal force determining *which* quantum outcome obtains, applied locally at sites of neural indeterminacy rather than summarised across the mosaic after the fact.

### Dispositional Essentialism and Phenomenal Powers

Dispositional essentialism offers the deepest account of psychophysical laws but at a price. If laws are grounded in essential natures of properties, and phenomenal properties have essential dispositional natures including capacities to influence physical processes, then psychophysical laws express what phenomenal properties inherently *are*. The law connecting conscious intention to quantum selection flows from intention's essential nature rather than being imposed from outside.
...
The problem is immediate. Phenomenal redness has an intrinsic qualitative character not exhausted by any behavioural or functional profile. This is the [[knowledge-argument|knowledge argument]]: Mary learns something new when she sees red for the first time, even though she already knew every dispositional fact. If [[qualia]] were pure dispositions, there would be nothing left to learn.
...
This generates the Russellian gambit: perhaps consciousness *is* the intrinsic categorical nature underlying physical dispositions—qualia are what physical structure looks like from the inside. But this faces the [[combination-problem]]: how do micro-level categorical-phenomenal properties combine into unified macro-consciousness? Cutter (2019), Pautz (2017), and Howell (2014) press the case that Russellian monism is unstable, requires brute linking principles equivalent to dualism's, and risks epiphenomenal quiddities. Mørch (2014, 2018) responds with *power-monist* Russellian monism: quiddities *are* powers, restoring causal relevance. Mørch's view is the closest competitor to the Map's because it pairs the powerful-qualities identity theory with Russellian monism rather than dualism. The Map prefers [[russellian-monism-versus-bi-aspectual-dualism|bi-aspectual dualism]] because power-monist Russellian monism still inherits the combination problem, whereas the bi-aspectual framework posits unified phenomenal subjects from the start and locates causal work at quantum indeterminacies rather than within the constitution of physical properties.
...
A clarification carries forward from the previous section. The zombie-world disanalogy weakens dispositional essentialism's *grounding* claim, but the powerful-qualities identity theory makes a weaker commitment. It does not require phenomenal properties to be fundamental constituents whose essences ground laws. It requires only that, given a property exists, its qualitative and dispositional aspects are identical rather than separately specifiable. That identity claim survives the disanalogy because it is silent on whether phenomenal existence is necessary or contingent. The Map adopts powerful qualities as the property-side commitment and lets the governing-laws view do the cross-domain legislative work essentialism cannot.

On Martin and Heil's view, a property's qualitative nature and its dispositional power are identical—two aspects of one reality, not two separable components. You cannot peel apart the quality from the power; they are one thing under two descriptions.

Applied to consciousness: a phenomenal state's qualitative character and its causal power are aspects of a single property. The redness of red experience is simultaneously a quality and a power (the capacity to bias neural activity toward red-related responses). Mary doesn't learn a new disposition when she sees red—she encounters the qualitative aspect of a property whose dispositional aspect she already knew.
...
But consciousness has a peculiar relationship with its own manifestations. When pain disposes you to withdraw your hand, the relevant phenomenal quality is identical with the causal directedness in a way salt's molecular structure is not identical with its dissolving. The constitutive-connection claim applies to each *component* powerful quality rather than to "pain" as a unitary phenomenon: [[pain-asymbolia]] vindicates this. What we colloquially call "pain" is a *compound* of two distinct powerful qualities—sensory localisation and aversive valence—each carrying its own quality-power identity. Asymbolic patients retain the sensory component and lose the aversive one; the behavioural dissociation tracks loss of *one* compound element, not a peeling-apart of quality from power within either element. So change *a* felt quality and you change *its* specific disposition; the apparent dissociation is between component qualities, not within one. See [[pain-consciousness-and-causal-power]].

Phenomenal dispositions thus have a unique modal character. Physical dispositions point outward—toward effects in other things. Phenomenal dispositions also point inward—toward the subject's own experiential states, motivations, and deliberative processes. Consciousness occupies a distinctive position in the ontology of dispositions: the only case where the qualitative character of a disposition and its causal directedness are accessible from the inside. We know what it is like to be a powerful quality because we *are* powerful qualities.

## Why This Matters for the Mind-Body Problem

Each framework leaves a residual mystery that mirrors what it leaves unexplained for purely physical laws. Humean regularities provide no mechanism. Governing laws face the legislation problem. Dispositional essences raise questions about why properties have the natures they do—and why consciousness exists at all, given the zombie-world disanalogy. Our inability to fully explain why neural configurations produce experiences is less a special indictment of dualism than a general feature of metaphysical inquiry: the difficulty of psychophysical laws is partly inherited from the difficulty of *all* laws.

## Relation to Site Perspective

The Map's [[tenets]] have differential affinities with each combination of laws and properties.

**[[tenets#^dualism|Dualism]]** is best served by the governing-laws view paired with the powerful-qualities identity theory. Humeanism formally accommodates psychophysical regularities, but Humean supervenience would deny that consciousness adds anything beyond the physical mosaic—uncomfortable for dualism unless the Humean restricts supervenience to the physical sub-mosaic, at which point the explanatory shallowness flagged earlier becomes the operative cost. Pure dispositional essentialism founders on the zombie-world disanalogy: phenomenal properties lack the fundamentality required for their essences to ground laws as charge's nature grounds Coulomb's law. Powerful qualities is the property-side ally because it satisfies two dualist constraints simultaneously: preserving the qualitative reality of qualia (which pandispositionalism eliminates) and supplying intrinsic causal power at the property itself (which pure categoricalism leaves to external laws and thereby exposes to the epiphenomenalist threat).

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** receives its strongest support from the governing-laws view paired with powerful qualities. Humeanism can accommodate bidirectional regularities but struggles to ground genuine causation as opposed to constant conjunction. Pure dispositional essentialism would in principle ground mental causation in essential natures, but the disanalogy denies it the necessary fundamentality for consciousness; the governing view supplies the prescriptive modal force, and powerful qualities supplies the property-side anchor where qualitative character is identical with the disposition to manifest.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]** is grounded by exactly the cross-product the body argues for: the governing law supplies the prescriptive force determining *which* quantum outcome obtains, and the powerful-qualities identity theory supplies the local property-side anchor at the interface. Pure dispositional essentialism cannot do this work alone (no internal anchor without fundamentality); Humeanism reduces minimality to "what happens to be the case." This tenet's defensibility is hostage to whether biological architectures can sustain quantum coherence against decoherence (Tegmark 2000)—the dispositional framing here presupposes the Map's response in [[quantum-biology-and-neural-mechanisms]] and [[penrose-gravity-induced-collapse-empirical-prospects]].
