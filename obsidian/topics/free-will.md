...
modified: 2026-01-30
human_modified: null
ai_modified: 2026-01-31T04:12:00+00:00
...
Bergson's [[duration|durée]] offers additional resources: if mental states interpenetrate rather than causing each other like discrete billiard balls, the deterministic model fails at its foundations.
...
The **[[luck-objection|luck objection]]** makes this vivid: if we replay time after an undetermined choice, different outcomes appear across replays. What explains the difference? If nothing about the agent explains it, the choice is mere luck.
...
If selection is genuine, the luck objection fails—the agent explains the difference. The [[agent-causation|agent-causal]] response: the agent's exercise of causal power *is* the explanation. See [[quantum-indeterminacy-free-will]] for comprehensive analysis.
...
[[consciousness-and-creativity|Creativity]] strengthens the case: consciousness doesn't merely select among brain-generated options but *generates* possibilities through imagination, constituting the space of alternatives.
...
A passive recipient of random quantum events couldn't choose to be passive. The very capacity for witness mode shows consciousness does something rather than merely receiving outcomes. See [[meditation-and-consciousness-modes]] for detailed analysis.
...
Willed attention shows frontal theta oscillations and bidirectional frontoparietal coherence—signatures absent in merely instructed behaviour. The phenomenological asymmetry (effortful vs effortless) corresponds to different neural circuits. This supports agent causation: the subjective sense of authorship tracks genuine differences in how the brain organises voluntary versus automatic processing. See [[voluntary-attention]] for detailed analysis.

## Motor Selection

[[motor-selection|Motor control]] shows the same selection architecture as attention: frontal theta, bidirectional coherence, and distinct willed versus instructed signatures. Desmurget's neurosurgical studies separate the phenomenology of deciding from execution machinery—inferior parietal stimulation produces conscious intention *without* movement, while premotor stimulation produces movement *without* awareness. Consciousness operates at the selection level; execution is delegated. Two domains showing identical selection architecture suggest a unified mechanism.

## What Free Will Requires

On the Map's framework, free will requires:

1. **Consciousness as non-physical**: Otherwise it inherits deterministic (or randomly indeterministic) physical laws. The [[tenets#^dualism|Dualism]] tenet provides this.
...
4. **Atemporal operation**: [[retrocausality|Retrocausal]] quantum mechanics explains how consciousness can be the genuine cause despite apparent temporal ordering.

The [[mental-effort|phenomenology of effort]] provides supporting evidence. William James: "the free will question relates solely to the amount of effort of attention." Schwartz's OCD research shows directed mental effort reshapes neural circuitry. Hard tasks feel hard because the phenomenology tracks genuine cognitive load—consciousness doing something rather than merely observing.
...
This isn't a proof. It's a coherent picture that takes both consciousness and physics seriously, preserving what matters about free will (genuine authorship) while respecting what we know about the brain and quantum mechanics. How consciousness biases probabilities may remain mysterious—the [[causal-interface|causal interface void]] explains why this mechanism is systematically invisible from both introspection and neuroscience, a consequence of minimal interaction rather than a gap in the theory. Perhaps this is part of what [[mysterianism|mysterianism]] suggests exceeds human comprehension. But evidence can point toward a truth we can't fully understand.
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Free will requires consciousness to *cause* physical outcomes. The quantum selection mechanism specifies how: consciousness biases which possibilities actualize at quantum indeterminacies.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: Consciousness operates within what physics allows—selecting among quantum possibilities without violating conservation laws or causal closure where it holds.
