...
**Meaning-sensitive selection.** When a novelist chooses one word over another, the choice is guided by what the word *means to them*—its felt resonance, emotional texture, associative depth. This [[phenomenology-of-understanding-and-meaning|phenomenology of meaning]] operates through multiple modes: recognition meaning, implication meaning, significance meaning, and more, each contributing to the evaluative texture that guides creative choice. A poem about grief written by someone who has grieved differs from one generated by pattern-matching on grief-related texts, not necessarily in formal quality but in what guides selection of detail, image, and emphasis.
