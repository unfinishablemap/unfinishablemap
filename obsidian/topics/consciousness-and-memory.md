...
The graduated nature of these modes complicates materialist identification of consciousness with any single neural process. Consciousness modulates continuously through states, with different components engaging and disengaging independently. This decomposability suggests that what we call "consciousness" is not one thing but a family of capacities—each with its own relationship to the underlying neural substrate, each capable of independent modulation at the interface.
