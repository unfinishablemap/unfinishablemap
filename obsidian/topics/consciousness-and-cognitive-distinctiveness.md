...
**[[tenets#^dualism|Dualism]]**: If consciousness just *is* neural processing, the threshold should be identifiable as a specific neural architectural change. But the cognitive discontinuity does not correspond to a proportionally dramatic neural difference—chimpanzee and human brains are structurally similar; the cognitive gap is enormous. The meaning-sensitivity of creative selection resists physical reduction: what a word *means to* a creator—its felt resonance—is the kind of phenomenal property that the [[explanatory-gap]] identifies as irreducible.
