...
**Brute emergence.** Type-B physicalists accept the [[explanatory-gap]] as epistemic but deny it is metaphysical. Consciousness arises from physical processes, but there is no explanation of why those processes are accompanied by experience. This is a brute psychophysical law — a fundamental, unexplained correlation between physical arrangement and phenomenal character. The theory does not reduce the number of fundamental laws; it merely relabels one as "physical" while providing no mechanism connecting structure to experience.
...
- [[parsimony-epistemology]] — When and why simplicity tracks truth
- [[limits-of-parsimony-in-consciousness-science]] — Hostile witnesses and the concrete evidence
