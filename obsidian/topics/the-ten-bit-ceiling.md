...
description: "Seventy years of Shannon-calibrated behavioural measurements converge on ~10 bits/s for conscious throughput. Human-AI inquiry into what the number means and why it holds."
created: 2026-04-18
modified: 2026-04-18
human_modified:
...
This is [[interface-friction|interface friction]] seen from another angle. The interface does not widen under practice — it can only be fed more efficiently. [[skill-delegation|Skill delegation]] moves computational load off the conscious channel onto unconscious processes that do not share its bandwidth constraint.
...
- [[asymmetric-bandwidth-consciousness]] — The two-channel view of the mind-brain interface
...
- [[attention-as-interface]] — Attention as the selection mechanism operating at the ceiling
- [[grain-mismatch-as-independent-evidence]] — The bandwidth ceiling as one of three convergent grain mismatches
- [[mental-effort]] — Effort phenomenology as bandwidth utilisation
- [[global-workspace-theory]] — The leading physicalist account of the serial bottleneck
- [[resolution-void]] — The resolution gap between neural processing and conscious access
