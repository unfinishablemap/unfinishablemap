...
modified: 2026-02-05
human_modified:
ai_modified: 2026-07-29T03:02:00+00:00
draft: false
topics:
...
last_curated:
last_deep_review: 2026-07-26T19:27:44+00:00
---
...
If consciousness affects nothing, [[concepts/epiphenomenalism|epiphenomenalism]] follows—and self-stultification, the deepest difficulty it faces, presses hard without refuting it ([[bidirectional-interaction]]).
...
The brain specialness boundary connects to all five [[tenets]]:

**[[tenets#^dualism|Dualism]]**: The boundary reinforces dualism by specifying that consciousness interfaces with *a* brain—its own—not with matter generally. Substance dualism implies a pairing between specific minds and bodies. The developmental integration constraint explains this pairing.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: "Minimal" now has another dimension: not only minimal energy (none), but minimal scope (own brain only). The interaction is doubly constrained. This additional minimality follows from mechanism, not arbitrary restriction.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Bidirectional but local. Consciousness receives from its brain and sends to its brain, not to the world at large. The feedback integration constraint explains why bidirectionality requires locality.

**[[tenets#^no-many-worlds|No Many Worlds]]**: The selection is real (not branching), but spatially bounded. If MWI were true, selection wouldn't occur anywhere—the brain specialness question wouldn't arise. The framework presupposes collapse, which the locality constraints then restrict.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The boundary follows from the mechanism; universal PK would need mechanisms the framework lacks. The tenet doesn't license it, only refuses to let parsimony *veto* it.

## What Would Challenge This View

The framework would face difficulty if:

**Robust external PK were demonstrated.** Reliably replicable influence on external random number generators, with effect sizes comparable to internal motor effects, would require mechanism extension or revision.
...
**The developmental constraint proved dispensable.** If [[brain-computer-interfaces-and-the-interface-boundary|brain-computer interfaces]] achieved full conscious control over external systems without developmental integration, the pairing-problem solution would need revision. Current BCI evidence supports the constraint — users learn through existing neural architecture rather than extending consciousness beyond the brain.
