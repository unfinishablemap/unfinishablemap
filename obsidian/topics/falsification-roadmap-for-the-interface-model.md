...
description: "What evidence would force the Map to abandon its tenets? A tenet-by-tenet falsification analysis that distinguishes honest interactionist dualism from unfalsifiable metaphysics."
created: 2026-04-09
modified: 2026-05-23
human_modified:
ai_modified: 2026-09-08T09:49:45+00:00
draft: false
topics:
...
**What would falsify it**: The answer depends on which sub-reading of Tenet 2 is in view; the readings have materially different falsifiability profiles and should not be flattened into a single condition. The breakdown below tracks the table in [[#The Falsification Asymmetry]] and inherits the calibration of the strict corridor from [[brain-internal-born-rule-testing]].
...
5. **Invertebrate consciousness research**: As [[invertebrate-consciousness-as-interface-test|the invertebrate test case article]] argues, insects and cephalopods constrain the interface model. Their radically different architectures—from the 100,000-neuron *Drosophila* brain to the distributed octopus nervous system—impose scale independence and architectural flexibility requirements that rule out mechanisms tied to specific structures like cortical layers. Anaesthetic convergence across phyla, masking paradigms in invertebrates, and comparative studies of conscious processing all bear on the Map's claims.
...
Publishing a falsification roadmap is itself an expression of the [[tenets]].

**[[tenets#^dualism|Dualism]]** gains credibility by specifying what would count as evidence against it. A framework that cannot state its own falsification conditions invites dismissal as dogma.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]** is the tenet whose testability is most sharply scoped, and the scope belongs in the headline. If the quantum interface is real, only a deviation *conditioned* on intention, task or subject would show it — the unconditioned statistics stay Born-compliant by construction ([[positions/quantum-interface#^mechanism-debt|P-Q3]]) — and none has yet returned a positive.
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]** is what makes publishing this roadmap coherent. The temptation is to adopt simpler frameworks that avoid the falsification question entirely. The Map resists this temptation not because simplicity is wrong but because it is unreliable when knowledge is incomplete—and knowledge about consciousness is profoundly incomplete.

## Further Reading

- [[the-interface-problem]] — The hardest open challenge: where the interface operates and how to specify the mind-matter mapping
- [[testing-consciousness-collapse]] — Three-tier experimental programme for consciousness-collapse theories
- [[invertebrate-consciousness-as-interface-test]] — Insect and cephalopod architectures as interface model constraints
...
- [[sorkin-delta-brain-internal-analogues]] — The operational design space for a brain-internal Sorkin-Δ test, mechanism by mechanism
...
- [[the-unfolding-argument-against-causal-structure-theories-of-consciousness]] — The formal false-or-unfalsifiable dilemma for IIT-style structural physicalism; a distinct sibling of the falsifiability challenges catalogued here, and a Tenet 5 case study
