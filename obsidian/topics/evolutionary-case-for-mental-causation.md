...
description: "Evolution provides the strongest evidence that consciousness causally contributes to intelligence. If phenomenal experience were epiphenomenal, it could not have been selected."
created: 2026-02-05
modified: 2026-02-05
human_modified: null
...
Research suggests otherwise. Lieberman et al. (2008) found that cognitive load impairing conscious processing impairs logical reasoning, while disruption of unconscious processing does not. If logical reasoning depended only on neural machinery (with consciousness as epiphenomenal byproduct), disrupting the conscious aspect should not specifically impair reasoning.
...
This observation connects the evolutionary argument to the [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet. If consciousness is genuinely causally efficacious, there must be a mechanism by which it influences physical outcomes. Classical physics, with its deterministic causal closure, leaves no room for mental causation that isn't reducible to physical causation. Quantum indeterminacy provides a potential opening: consciousness might bias otherwise undetermined outcomes without injecting energy or violating conservation laws.

The Map does not claim certainty about the mechanism. The evolutionary argument establishes *that* consciousness is causally efficacious; the quantum hypothesis proposes *how* it might be. The argument's force does not depend on accepting any particular mechanism.
...
**[[tenets#^dualism|Dualism]]**: If consciousness has causal effects not reducible to physical causation, then consciousness is not reducible to physics. The evolutionary argument doesn't directly establish this—physical consciousness could still have physical effects—but combined with the [[explanatory-gap|explanatory gap]], it suggests that whatever consciousness is, it has genuine causal power.
