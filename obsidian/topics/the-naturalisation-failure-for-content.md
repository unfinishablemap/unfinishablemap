...
One naturalising family is not caught by this dilemma, because it does not start from covariance at all. [[conceptual-role-semantics|Conceptual role semantics]] constitutes content out of a state's inferential role rather than its world-tracking, and so steps out from under the covariance horns. It is therefore the strongest rival the HPC must answer separately; the [[conceptual-role-semantics|dedicated treatment]] argues that inferential role constitutes content only by presupposing already-contentful norms of correct inference (a regress) or by collapsing into interpretationist deflation (reproducing the covariance dilemma one level up).
...
**Dualism.** If naturalised content theories cannot deliver truth-conditional, intensional content, and content is a real feature of conscious mental life, then the grounds for content lie outside the natural-physical order as currently described. This does not, by itself, establish dualism — it could be that further inquiry will produce a naturalising story that works — but it provides a piece of evidence congruent with the Map's commitment that mind is irreducible. The convergence with the [[hard-problem-of-consciousness|phenomenal hard problem]] and the [[consciousness-and-the-normativity-of-reason|normativity of reason]] strengthens the case: physicalism is not failing once but repeatedly, and at the same kind of joint each time.
