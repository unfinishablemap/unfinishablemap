...
Imagined experience differs from perceived experience along several phenomenal dimensions that resist reduction to differences in signal strength or neural activation level.

**Quasi-perceptual character.** Imagined scenes carry sensory qualities—colour, shape, sound, texture—yet these qualities are diminished, unstable, and indeterminate in ways perception is not. Hume described ideas as "the faint images" of impressions (*Treatise*, I.I.I), but this underplays the structural difference. An imagined face may be vivid yet lack determinate eye colour; an imagined melody can be clear yet occupy no spatial location. Whether imagined content is genuinely indeterminate, or merely reported as such because introspection cannot resolve the detail, is itself contested—the question turns on how far introspective report tracks phenomenal fact. On the reading defended here, the indeterminacy of [[mental-imagery|imagined content]] is more than weaker perception; it appears to be a different *mode* of presentation, with its own phenomenal logic.

**The neutrality character.** Husserl identified imagination's distinctive quality as *Phantasie*—a neutrality modification that neither affirms nor denies the actuality of its objects (*Ideas I*, §111), a characterisation he reworked at length across the phantasy and image-consciousness manuscripts of 1898–1925 (Husserl, 2005). Perception posits its objects as actual; memory posits them as having-been-actual; imagination suspends positing altogether. When you imagine the purple elephant, you simultaneously entertain the perceptual content (purple, elephant, kitchen) and hold it in experiential suspension—neither asserting that it exists nor judging that it does not. There is something it is like to *know, while experiencing it, that you are generating the experience*. This meta-awareness is built into imagination's phenomenal structure, not added by subsequent reflection.

**Voluntary directedness.** Unlike perception, which is given, and unlike memory, which arises unbidden or on cue, imagination responds to intention. You can decide to imagine a blue elephant instead. This voluntary control is imperfect—the imagined content may resist precise specification, drift, or surprise you—but the phenomenology of directing imaginative attention differs from merely observing what arises. The felt effort of imaginative generation—the phenomenal experience of constructing and sustaining a scene—reflects consciousness doing active work rather than passively receiving content.

## Imagination and the Limits of Functionalism

The phenomenology of imagination creates problems for [[concepts/functionalism]]. Functionalist accounts define mental states by their causal roles: imagination is whatever plays the functional role of generating novel representations for planning, creative problem-solving, or counterfactual evaluation. Computational theories of imagery (Kosslyn, 1994) model imagination as the top-down generation of imagery from stored representations, and predictive processing accounts recast it as top-down prediction operating without sensory constraint. These frameworks capture much of imagination's functional structure. What they miss are the phenomenal facts.

Consider the difference between imagining a sunset and imagining a mathematical proof. Both involve generating novel content. Both can serve planning functions. Yet the phenomenal character differs radically—one is saturated with quasi-visual [[qualia]], the other is an instance of [[cognitive-phenomenology]] that may involve no imagery at all. Whether imagination is fundamentally imagistic or fundamentally propositional is a long-running debate the phenomenology alone does not settle; the present argument needs only that *some* imagining is quasi-perceptual and some is not. Aphantasics who cannot voluntarily generate visual imagery can still imagine scenarios, plan, and create—though their imagination seems to have a different phenomenal texture, and how different is hard to establish across minds. If two states serve identical functional roles yet feel different, phenomenal character may not be captured by functional role.

The variation across individuals sharpens this point. Whether "imagination" even names a single kind is itself contested (Kind, 2013), and the imagery it recruits varies enormously between people: roughly 3% of the population are extreme hyperphantasics, whose imagery rivals perceptual experience in vividness, and roughly 1% are extreme aphantasics, who report little or no voluntary imagery and rely instead on abstract knowledge of what they are "imagining". Aphantasia is typically not confined to vision—it often affects imagery across several sense modalities—though visual dreaming is frequently preserved (Zeman, 2024). Both groups can perform core imaginative tasks—planning, creative problem-solving, hypothetical reasoning—but with phenomenally distinct strategies: aphantasics complete classical mental rotation via analytic methods rather than object-based rotation, slower but more accurately (Kay, Keogh & Pearson, 2024). This intra-species divergence is one face of the [[imagery-void]]—the structural impossibility of comparing imagery phenomenology across minds even when linguistic reports converge. The broad functional overlap persists across enormous phenomenal variation. A sophisticated functionalist might respond that these are not truly identical functional roles, since aphantasics show different cognitive profiles (reduced autobiographical memory, different problem-solving strategies). But this response concedes the point in another way: it acknowledges that phenomenal character and cognitive function co-vary, which is precisely what pure functionalism denies by defining mental states solely through abstract causal roles.

## Imagination as Counterfactual Inhabitation

The deepest philosophical significance of imagination lies in its capacity for [[counterfactual-reasoning|counterfactual inhabitation]]—not merely representing that things could be otherwise, but experientially *dwelling* in non-actual scenarios.
...
Walton (1990) argued that fiction-directed emotions are *quasi-emotions*. The feelings themselves are real—his filmgoer confronting the green slime undergoes genuine physiological arousal—but on Walton's account they do not amount to fear, since they issue from beliefs about what is fictionally the case rather than from belief in an actual threat; what is make-believe is that he fears the slime. Even granting this for fiction, it travels poorly to self-generated imagination. Walton's machinery needs a game of make-believe played with an external prop—the film, the novel—to fix what is fictionally true and license the quasi-emotion. When you vividly imagine a feared scenario—a loved one in danger, a public humiliation—there is no prop and no game: consciousness supplies the content, the fictional truths, and the response together. The emotional response arises from consciousness engaging its own constructions with full phenomenal force.

This illuminates the relationship between [[phenomenal-consciousness]] and [[intentionality]]. Consciousness operates on self-generated scenarios with the same seriousness it brings to perceived reality. For the dualist, this suggests that phenomenal consciousness is an independent source of experiential reality—not merely a readout of sensory transduction. The mind generates phenomenal states complete with emotional valence, bodily response, and motivational force, without external prompting. On the reading the Map favours, imagination is one of the clearer signs that consciousness is generative rather than merely receptive—though a materialist will read the same generativity as elaborate self-stimulation of a neural system, and the phenomenology alone does not adjudicate between the two readings.

The affective side of this generativity has its own opacity. Imagined scenarios shift mood, and current mood in turn shapes which scenarios arise and how vivid they feel—mood-congruent retrieval and imagination are well-documented. Yet the [[mood-void|mood]] in which this exchange takes place is not itself a clean object of introspection: its origins, identity, and formative influence on cognition operate largely below the phenomenal surface. Consciousness thus generates imagined content *within* an affective medium it cannot directly witness, and the imagined content reshapes that medium in ways only indirectly tracked.
...
These constraints matter for understanding consciousness. A materialist can explain some of them—moral evaluations are neurally encoded, so the difficulty of imagining moral inversions may reflect deep patterns of neural connectivity. But this response arguably pushes the question back: *why* would neural encodings of moral truth resist voluntary override when neural encodings of physical law do not? The asymmetry seems to track the conceptual distinction between physical possibility and evaluative necessity rather than any obvious difference in neural implementation—though the materialist may reasonably reply that the relevant neural differences are simply not yet mapped. The principled structure of imaginative limits—conforming to conceptual and evaluative categories rather than to neural architecture alone—is at minimum a phenomenon that reductive accounts must explain rather than explain away.

Beyond its structural limits, imagination also confronts a deeper [[creative-aesthetic-void|generative mystery]]. When you imagine a purple elephant, *where does the image come from*? It is not retrieved from memory—you have never perceived a purple elephant. It is not computed from explicit rules—no algorithm you can introspect delivers quasi-perceptual experience. The process by which consciousness assembles novel experiential wholes from stored components is phenomenologically opaque: you experience the result without observing the construction. This mirrors the arrival-side opacity of the [[transit-void|thought stream]]—voluntary imagining and spontaneous thought alike deliver finished content to awareness while concealing the construction process itself. The pattern parallels the [[mysterianism|mysterian]] insight that consciousness may involve processes whose mechanisms lie beyond our cognitive grasp.

## Relation to Site Perspective

Imagination bears on several of the Map's [[tenets]] in distinctive ways.

**Imagination and dualism.** The phenomenal character of imagining—quasi-perceptual, voluntarily directed, inherently self-aware as non-actual—constitutes a mode of consciousness that resists reduction to neural replay or recombination. The indeterminacy of imagined content (a face without determinate eye colour), the neutrality character (knowing it is self-generated while experiencing it), and the radical variation between aphantasia and hyperphantasia all point, on the dualist reading, to phenomenal properties that functional and neural descriptions may fail to capture. The [[explanatory-gap]] between determinate neural states and genuinely indeterminate phenomenal states is especially stark in imagination: neural activations always have specific values, yet an imagined face has no determinate eye colour. A physicalist may respond that the representation simply omits eye-colour information—there is no "indeterminate phenomenal state," just an incomplete neural encoding. But this redescription changes the subject. The phenomenal fact is not that information is absent; it is that there is something it is like to experience a face *as indeterminate*—present yet unresolved. An incomplete file has no character at all; an imagined face with indeterminate eyes has a distinctive phenomenal quality that the incompleteness metaphor cannot capture. The Map's [[tenets#^dualism|Dualism]] tenet finds support in the irreducible phenomenal signature of imagination.

**Imagination and bidirectional interaction.** Voluntary imagination exemplifies [[bidirectional-interaction]]. When you deliberately construct an imagined scenario—rotating mental objects, populating scenes, adjusting details—consciousness directs neural activity rather than merely accompanying it. The [[mental-imagery|motor imagery evidence]]—imagined movements appear to improve physical performance—is *consistent with* a causal pathway from conscious imagination to bodily outcome, though the physicalist can respond that neural rehearsal does the work while consciousness merely accompanies it. The evidence does not adjudicate between these readings. The phenomenology of [[phenomenology-of-agency-vs-passivity|imaginative effort]]—the felt difference between actively constructing a scene and passively receiving one—remains the stronger evidence that imagination involves genuine [[agent-causation|mental causation]].

**Imagination and Occam's Razor.** The phenomenology of imagination is vastly richer than any functional story requires. Planning needs counterfactual representation, not counterfactual *experience*. Creative problem-solving needs novel combinations, not the felt quality of inhabiting possibilities. The sheer phenomenal abundance of imagination—its quasi-perceptual vividness, its emotional reality, its structural constraints—is explanatory surplus from the materialist perspective. The Map's [[tenets#^occams-limits|fifth tenet]] warns against letting simplicity assumptions dismiss this surplus. The richness of imaginative experience may be a clue rather than an anomaly.
...
- [[creative-aesthetic-void]] — The opacity of consciousness's generative processes
...
- [[transit-void]] — The parallel opacity of spontaneous thought's arrival and departure
...
1. Kay, L., Keogh, R., & Pearson, J. (2024). Slower but more accurate mental rotation performance in aphantasia linked to differences in cognitive strategies. *Consciousness and Cognition*, 121, 103694.
...
1. Zeman, A. (2024). Aphantasia and hyperphantasia: exploring imagery vividness extremes. *Trends in Cognitive Sciences*, 28(5), 467–480.
