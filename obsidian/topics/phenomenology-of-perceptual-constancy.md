...
modified: 2026-02-15
human_modified:
ai_modified: 2026-02-15T06:16:00+00:00
draft: false
topics:
...
The Unfinishable Map explores perceptual constancy—the phenomenon whereby objects appear stable in colour, shape, and size despite radical changes in the sensory signals reaching our eyes. A white wall looks white under candlelight, fluorescent tubes, and noon sun, though the wavelengths reflected differ enormously. A dinner plate looks circular whether viewed head-on or at a steep angle. This stability is so fundamental to ordinary experience that it goes unnoticed, yet it conceals one of the deepest puzzles in the philosophy of perception: the constancy we experience cannot be found in the physical signal itself. Something beyond sensory input holds the world steady.

## What Perceptual Constancy Is

Perceptual constancy refers to the tendency of conscious experience to represent objects as possessing stable properties—colour, shape, size, brightness, pitch—even as the proximal sensory stimulation varies dramatically. Psychophysics has catalogued the major forms:

- **Colour constancy.** A banana appears yellow under daylight, incandescent light, and green-tinted shade. The wavelength composition reaching the eye changes by orders of magnitude, yet the experienced colour remains largely the same.
...
Perceptual constancy reveals something important about the structure of [[qualia]]. If qualia were simply identical with sensory transduction states—patterns of cone activation, say—then qualia should vary whenever the proximal stimulus varies. Under candlelight, the yellow-quale should differ from the noon-sun yellow-quale, because the cone activation patterns differ substantially. Yet the experienced quality remains stable.

This means one of two things. Either qualia track something other than proximal sensory states, or qualia are constituted by something that can remain stable across variable physical inputs. Both options resist straightforward physicalist reduction.

The functionalist might respond that qualia are identical with functional roles, and constancy mechanisms ensure those roles stay stable. But this faces the standard [[inverted-qualia]] challenge: two systems could implement identical constancy functions yet differ in what yellow *feels like*. The functional role of "stable colour representation" does not determine its qualitative character. Perceptual constancy sharpens this point—the very mechanism that makes colour experience stable across conditions could operate identically while supporting different phenomenal qualities.
...
The Unfinishable Map's [[tenets]] bear directly on perceptual constancy in several ways.
...
The **minimal quantum interaction** tenet is relevant if the selection among competing perceptual interpretations involves quantum-level biasing. The Map does not claim this is established, but notes that the rapid, sub-millisecond timescale at which constancy computations operate is precisely the regime where quantum effects in neural processing would be most relevant, should such effects exist.
