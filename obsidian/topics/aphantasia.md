---
title: "Aphantasia"
description: "Human+AI exploration of aphantasia—the absence of voluntary mental imagery—as a real, prevalent, and empirically anchored variation within a single species."
created: 2026-05-08
modified: 2026-05-08
human_modified:
...
The post-2010 literature has converged on several signatures that make aphantasia detectable as more than a self-report curiosity.
...
1. Phenomenal imagery does not, in fact, do the cognitive work it appears to do. The imagery is an accompaniment that travels with the work in vivid imagers and is dispensable in aphantasics.
...
Aphantasia engages two of the Map's [[tenets]] directly.

**Dualism.** If two minds, the same biological kind, perform the same cognitive task at the level the standard behavioural science measures, while one experiences phenomenal imagery and the other experiences nothing of the kind, then phenomenal character is not the functional role in disguise. Phenomenology has independent structure from the functional work it accompanies. This is not a knockdown argument for [[tenets#^dualism|Dualism]]—the Map flags the standard functionalist rejoinder that finer-grained individuation might recover function-phenomenology covariance—but the empirical pressure point is real, and it falls in exactly the place dualist frameworks predict it should: at the gap between what consciousness *is like* and what cognition *does*.

**Occam's Razor Has Limits.** The simplest model of imagery—imagery is the substrate of mental simulation, and reports of vividness track its quality—fails empirically across the cohort. Occam's preference for that model would have ruled aphantasia out *a priori*. It took a clinical case (MX) to crack the assumption. Aphantasia is a textbook instance of what [[tenets#^occams-limits|Occam's Razor Has Limits]] tries to flag: simplicity is unreliable when a phenomenon's space of possible structures has been imagined too narrowly.

The Map also speculates—at the level of explicit speculation, not tenet-level commitment—that phenomenal *extras* (content not exhausted by functional role) are candidate sites for [[bidirectional-interaction|consciousness-physical interface]] activity. Aphantasia does not by itself support this speculation; the imagery void's apophatic discipline is the better way in. But the within-species variation aphantasia documents is what makes the speculation not absurd: the data already show that phenomenology and function come apart at the within-species grain.
