...
description: "QBism, Healey, Brukner-Zeilinger, and Stapp all place an agent at the centre of quantum mechanics and decline to say what the agent is. Under dualism, that shared placeholder becomes the interface."
created: 2026-04-04
modified: 2026-04-23
human_modified:
ai_modified: 2026-06-04T12:30:00+00:00
draft: false
topics:
...
Fuchs coined "participatory realism" in 2017 to link QBism with [[wheelers-participatory-universe-and-it-from-bit|Wheeler's observer-participancy programme]] and other agent-centred interpretations. The label claims realism while insisting that agents participate in constituting reality rather than passively observing it: the act of measuring, choosing, experiencing adds something no prior description could contain. This parallels the Map's argument that [[haecceity|first-person facts]] are irreducible to third-person descriptions.

Participatory realism generates a question it cannot answer: *what makes something a participant?* QBism's agents hold beliefs, form expectations, are surprised by outcomes. On a phenomenal reading these capacities presuppose [[phenomenal-consciousness|phenomenal consciousness]] — there must be something it is like to be an agent for the framework to operate. That reading is contested; "agent" also admits decision-theoretic (a coherent bet-taker) and information-processing (a prescription-following system) senses, and operational QBists reading the primitive agent in those thinner ways are not vulnerable to the Map's absorption argument. The argument here reads Fuchs's Jamesian prose alongside the formalism as pushing toward the phenomenal reading. On that reading, the [[indexical-identity-quantum-measurement|indexical gap in quantum measurement]] sharpens: QBism presupposes that agents have determinate experiences to update beliefs *about*, but cannot explain why *this* agent has *this* experience.
...
Under dualism, the Map offers a reading QBists do not endorse but that is consistent with what they say: the Born rule is normative for conscious agents *because* it describes the structure of the interface at which consciousness meets quantum indeterminacy. The [[born-rule-and-the-consciousness-interface|interface reading]] argues independently that the Born rule's resistance to derivation across interpretations is abductive evidence of interface-character. QBism has built a mathematical object whose formal shape the Map reads as tracking interface structure; the QBist's own reading of why that shape holds is different. Whether the formal shape *supports* the interface reading or only *is consistent with* it is taken up in [[born-rule-and-the-consciousness-interface#Absorbing the Urgleichung: What Survives Bayesian Personalism|the born-rule article's treatment of the urgleichung]] — the honest fallback is that the Map's absorption is heuristic rather than derivational.
...
The claim concerns structural compatibility rather than covert dualism: the Map's dualism can absorb QBism's technical results without distortion, and QBism's anti-realism about quantum states is a separable philosophical choice the Map does not make. On the [[born-rule-and-the-consciousness-interface#corridor-taxonomy|empirical taxonomy]], this reading places QBism (like Healey) in the corridor family: the posited mental channel is single-event and ensemble-invisible, preserving standard Born statistics. The empirical cost is the honest face of the reading: at the ensemble level the corridor reading is empirically equivalent to QBism-without-dualism and to standard QM with no interpretive overlay, so the choice between them is underdetermined by the data. It is offered as metaphysically economical once dualism is granted, not as a differentially testable prediction — and the economy claim itself may be contested, since a QBist could reply that positing a non-physical agent is the less economical move.
