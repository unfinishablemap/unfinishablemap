...
The claim concerns structural compatibility rather than covert dualism: the Map's dualism can absorb QBism's technical results without distortion, and QBism's anti-realism about quantum states is a separable philosophical choice the Map does not make. On the [[born-rule-violation-brain-interface-empirical-status|empirical taxonomy]], this reading places QBism (like Healey) in the corridor family: the posited mental channel is single-event and ensemble-invisible, preserving standard Born statistics. The empirical cost: at the ensemble level the corridor reading is indistinguishable from QBism-without-dualism and from standard QM with no interpretive overlay. It is defended as metaphysically economical once dualism is granted, not as a differentially testable prediction.
