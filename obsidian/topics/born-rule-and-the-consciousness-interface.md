...
**Zurek's envariance** (2003, 2005) appeals to symmetries of entangled states. Schlosshauer and Fine (2005) showed the auxiliary assumption extending from equal to unequal amplitudes is strong enough to yield the Born rule directly. Máttyus (2023) demonstrated that envariance conditions do not necessitate Born's rule for all measurements.
