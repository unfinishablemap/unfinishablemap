...
**Trumping dualism (orthogonal to Born).** The [[trumping-preemption|trumping reading]] treats consciousness as authoritative over trajectories the formalism already describes, leaving the Born rule outside the gap analysis ([[delegatory-causation]]). A further position — no consciousness-physics interaction (Everettian, Bohmian, orthodox pragmatism) — rejects the premise, outside the Map's commitments.
