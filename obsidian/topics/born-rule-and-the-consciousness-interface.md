...
Born introduced the probability interpretation in 1926 as a pragmatic guess — what Araújo (2021) calls "wire and bubble gum." A century later, no generally accepted derivation exists. Landsman's 2025 centenary review concludes that "all derivations found in the literature are either circular or unrelated to measurement."

Zhang (2026) identified the structural bottleneck. Analysing five major strategies — Gleason's theorem, Busch's POVM extension, Deutsch-Wallace decision theory, Zurek's envariance, and Finkelstein-Hartle frequentism — he showed every one depends on additivity: the assumption that probabilities of orthogonal outcomes sum. But additivity is itself a probabilistic postulate, underivable from non-contextuality and normalisation alone. Every derivation assumes probability to derive probability. The Born rule's form may be determined by Hilbert-space structure, but the connection between that structure and the probabilities an observer encounters remains an unexplained bridge.
...
**Finkelstein-Hartle frequentism** (1963, 1968) shows frequencies converge to Born-rule probabilities in the infinite-copy limit — a mathematical idealisation requiring someone to count outcomes.
...
In Bohmian mechanics, particles have definite positions guided by a pilot wave. The Born rule becomes a theorem — conditional on the quantum equilibrium hypothesis (QEH), which states that positions are distributed according to |ψ|². Dürr, Goldstein, and Zanghì (1992) argue from typicality, but typicality is measured using |ψ|² itself. Valentini's (1991) dynamical relaxation avoids this circularity by showing systems evolve toward equilibrium, but cannot explain why the universe began near it; no cosmological signatures of primordial non-equilibrium have been observed. Even the framework most hostile to consciousness-collapse cannot justify the Born rule without circularity.

### Objective Collapse: Engineering, Not Derivation

GRW/CSL models modify the Schrödinger equation with spontaneous localisations. The stochastic noise terms are calibrated to a GKSL master equation, simultaneously guaranteeing norm conservation, Born-rule statistics, and no superluminal signalling. This is design, not derivation — the noise parameters are chosen *because* they reproduce the Born rule.

### Retrocausal Frameworks: Definitional Derivation

The transactional interpretation (Cramer 1986; Kastner 2012) derives |ψ|² from "handshakes" between offer and confirmation waves. But the derivation is arithmetically trivial once the confirmation wave is defined as ψ* — the Born rule is relocated to a definition. Kastner's possibilist extension makes the absorber ontologically necessary, resonating with the Map's bidirectional interaction, though TI does not require consciousness.

### Categorical and Gravitational Approaches

Categorical quantum mechanics (Abramsky and Coecke, 2004; Agrawal and Wilson, 2025) proves the Born rule is the *unique* probability assignment consistent with framework axioms — but the framework already contains measurement and probability structure. These are consistency theorems, not explanations of definite outcomes.

The Diósi-Penrose gravitational collapse model explains *when* collapse occurs but not *which* outcome with *which* probability. The Born rule governs outcome selection, and gravity alone does not address this. The Map's suggestion that consciousness modulates outcome selection within Penrose's framework is consistent with this gap.
...
**Why the rule works so precisely.** As Torres Alegre showed, any deviation would break relativistic causality — an interface specification can be exact.

The [[consciousness-and-probability-interpretation|consciousness-probability paradox]] reinforces this: consciousness fails at probabilistic reasoning because it operates through pattern and meaning rather than calculation. If the Born rule is the third-person shadow of a first-person qualitative process, its resistance to derivation from within either domain is a structural consequence.
...
- [[many-worlds-argument|Against Many-Worlds]] — The cumulative case against MWI from indexical identity, probability, and consciousness
