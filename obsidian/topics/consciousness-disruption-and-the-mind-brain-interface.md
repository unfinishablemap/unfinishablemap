...
Analogies have limits. Radios are designed artefacts with known transmission sources; brains are not. The analogy cannot establish that consciousness has an external source—only that the inference from correlation to production is not logically compulsory. The case for a non-productive relationship must come from evidence, not the analogy's suggestiveness.
...
This framework re-describes what we observe: brain dysfunction disrupts consciousness by damaging the interface through which it operates rather than by destroying a source. Loss-of-consciousness states sit within the broader spectrum of [[altered-states-of-consciousness|altered states of consciousness]]. The filter theory treats them as one architecture under different perturbations: psychedelics open the filter wider, anesthesia narrows or blocks it, sleep voluntarily disengages specific channels—the same range of moves a production account makes by reorganising one mechanism.
...
**Higher-order theories** hold that consciousness requires second-order representations about first-order ones. CMD patients appear phenomenally aware but their capacity for higher-order reflection is uncertain: if they are conscious without higher-order states, the theory is wrong; if they have them despite massive neural disruption, the theory must explain how, given damaged prefrontal regions.
...
The pattern follows Tulving's consciousness hierarchy: autonoetic (episodic) is most vulnerable, noetic (semantic) intermediate, anoetic (implicit) most preserved. Uniform production might predict uniform loss; instead we see [[degrees-of-consciousness|graded reduction]] across separable dimensions—consistent with a multi-channel interface partially blocked, though also with selective vulnerability of distinct neural memory systems.

[[sleep-and-consciousness|Sleep]] is a distinct category—neither pathological like coma nor pharmacological like anesthesia. Sleep consciousness varies continuously: two individuals in identical NREM Stage 3 may differ radically, one experiencing nothing, the other vivid dreams, with integration-segregation balance better preserved than under anesthesia. For the filter theory, sleep closes a door (mechanism intact) where anesthesia breaks the hinges.

Under general anesthesia, time does not merely pass quickly—it vanishes entirely. Patients report no sense of duration at all. A six-hour surgery and a six-minute procedure feel identical: nothing. Where does the experiencing subject go when time stops? The filter theory offers an alternative to the materialist answer (temporal processing has ceased): when the brain-interface is disrupted, consciousness loses its temporal anchor within physical time. Upon reconnection, continuity of subject resumes even without continuity of temporal experience. The deeper question—why *this* subject returns rather than a qualitatively identical replacement—is the indexical-identity question that [[identity-across-transformations]] develops at length. The apex synthesis treats the anaesthesia time-gap as a [[haecceity]] exhibit: the recurrence of *this* subject across an experiential discontinuity is suggestive evidence for indexical-identity grounded in more than brain-state-continuity, though compatible with production accounts that take brain-state-continuity as sufficient.
...
Experienced meditators report maintaining [[witness-consciousness|witness awareness]] through sleep onset ("yoga nidra")—the witnessing persists while contents fade. These reports rely on first-person testimony and are hard to verify, though EEG studies of advanced practitioners show distinctive signatures during claimed witness-sleep states. The [[hypnagogic-phenomenology-and-interface-modulation|hypnagogic phenomenology]] of this transition shows a graded loosening of interface constraint—a progressive relaxation where bizarre imagery and loose associations emerge before consciousness narrows into NREM. Practitioners also report cessation states (*nirodha-samapatti*) phenomenologically distinct from anesthesia—profound peace rather than nothing, with controlled entry and exit.
...
**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: The bridge from the reboot evidence to a quantum interface is not licensed by the clinical data alone; it holds only on the prior Map commitment that the consciousness-brain coupling is realised at the quantum scale (developed in [[quantum-measurement-and-consciousness]]). Granting that prior, the coordinated reboot is suggestive: a dedicated reopening mechanism is what one would expect if the brain prepares to *re-establish* an interface rather than to restart a generator. DoC cases then bear on the tenet by constraining the interface's extent—if CMD patients retain consciousness despite widespread cortical damage, the minimal quantum interaction need not be distributed across the whole cortex.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: CMD patients show consciousness persisting with partial causal efficacy—still *doing* cognitive work (language, attention) while unable to act on the body. This partial disconnection maps naturally onto a bidirectional interface whose channels can be independently disrupted. Full [[concepts/epiphenomenalism|epiphenomenalism]] predicts consciousness makes no difference to cognitive processing; CMD patients' preserved awareness enabling task performance is in tension with that reading.
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The 40% misdiagnosis rate for UWS is a cautionary tale for parsimony. The "simpler" assumption—behaviourally unresponsive patients are unconscious—was wrong in a substantial minority of cases. The propofol/ketamine divergence likewise shows the parsimonious behavioural reading failing. Filter and production models each accommodate these data; the lesson is not that parsimony selects the filter reading but that the *simplest* behavioural inference proved unreliable, so simplicity alone cannot adjudicate here.
