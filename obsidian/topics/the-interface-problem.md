...
If consciousness influences the physical world by biasing quantum outcomes in the brain — as The Unfinishable Map's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet holds — two distinct questions must be answered. *Where* in the brain does the interface operate? *How* do conscious states map quantitatively to physical selections? These are the two faces of the interface problem, and together they constitute the most significant open challenge facing the Map's interactionist framework.

The questions are logically independent but evidentially interlocked. The Map can say *that* consciousness acts on matter ([[tenets#^bidirectional-interaction|Bidirectional Interaction]]), *where* (at quantum indeterminacies), and *through what architecture* ([[attention-and-the-consciousness-interface|the attention-motor interface]]). What remains is the precise location and the lawful mapping from phenomenal properties to physical selections — Chalmers' (1996) "t-shirt problem": no psychophysical laws compact enough to fit on a t-shirt. The problem descends from [[history-of-the-interaction-problem|Princess Elisabeth's challenge]] to Descartes.
...
The interface model is one reading of the mind-body relation, not a data-forced result. The same phenomena it organises — the bandwidth constraint, the attention-motor convergence, the developmental trajectory — are compatible with either framing: an identity-theoretic, functionalist, or emergentist account can absorb them without positing a non-physical interface at all. What singles out the interface picture is the Map's prior commitment to [[tenets#^dualism|Dualism]] and [[tenets#^bidirectional-interaction|Bidirectional Interaction]], not a measurement that rival framings cannot match. The evidence is framework-supplied, not framework-neutral; it is coherent with rather than evidenced by the interface reading ([[evidential-status-discipline]]).
...
A more recent proposal suggests cortical microcolumns — ensembles of ~100 neurons — couple resonantly with the quantum electromagnetic zero-point field, forming macroscopic coherence domains where consciousness selects among column-level patterns. The scale matches the [[psychophysical-laws|bandwidth constraint]] and explains why conscious influence feels coarse-grained. But the proposal is less developed than its rivals; zero-point field coupling at cortical scales has no established experimental support, and the decoherence objection is amplified by the larger scale.
...
Eccles proposed that conscious intention modulates quantum tunneling probability at synaptic vesicle release sites: the brain prepares multiple action possibilities; intention biases which release probabilities dominate. Less developed than Stapp's, it faces the [[pairing-problem]] directly — how does an intention "know" which synapses to bias? Stapp's model works through attention, which already targets specific neural systems.

### Three Unspecified Candidates

Three candidates remain qualitative. **[[valence|Valence]] → action selection**: felt pleasure and pain bias approach/avoidance. Pain asymbolia (cognitive recognition without felt badness) *constrains* the simplest representational claim that felt valence just is nociceptive activation, without on its own *establishing* a quantum-selection reading — a predictive-processing affective-prior account predicts the same dissociation (see [[pain-asymbolia]] for the constrain-vs-establish discipline). [[valence-and-conscious-selection|Valence may serve as a selection currency]] for incommensurable outcomes, though whether valence enters selection through any quantum mechanism rather than through conventional neurochemistry remains an open fork. No quantum mechanism proposed. **Qualia → basis selection**: qualitative character might determine which measurement basis applies — speculative. **Phenomenal unity → sustained entanglement**: experiential binding might correspond to sustained coherence; correlation does not establish direction.

## Why Specification Is Hard

Three structural difficulties distinguish this from ordinary scientific puzzles. **The concept gap**: [[psychophysical-laws|selection laws]] would relate phenomenal quantities to physical ones, but phenomenal quantities resist measurement. How much attention is "twice as much"? Psychophysics' scaling methods relate physical inputs to behavioural outputs — the phenomenal middleman is inferred, not measured. **The access problem**: no instrument simultaneously tracks first-person experience and third-person quantum events with the required precision. The [[epistemology-of-mechanism-at-the-consciousness-matter-interface|epistemology of mechanism]] explores methods when direct observation is structurally impossible. **Underdetermination**: if consciousness biases outcomes below current detection, Stapp, Eccles, and combinations are indistinguishable at accessible scales — currently unfalsifiable in practice, awaiting detection-threshold improvements rather than reflecting a structural feature of the framework.
...
The framework is in-principle falsifiable, even where not yet so in practice. If systematic investigation rules out consciousness-relevant quantum effects at all four candidate sites — finding either that decoherence eliminates the relevant indeterminacy or that disrupting candidate substrates does not affect conscious influence — the [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] framework faces serious difficulty. These conditions are not currently testable: the joint phenomenal-physical instrumentation does not yet exist. The route from present state to applicable falsifiers is catalogued in [[falsification-roadmap-for-the-interface-model]] — single-molecule quantum readout, sharper attentional probes, joint phenomenal-physical correlation tools.
...
**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]** requires consciousness to act at quantum indeterminacies. Constrained pluralism narrows this: at indeterminacies *within the attention-motor architecture*, at sites involved in *threshold-crossing events*. The tenet limits where to look, but the subtlety of quantum effects makes detection difficult — trading empirical accessibility for theoretical elegance.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** gains qualified support from dopamine research. The dissociation Cai et al. report — mice whose fast dopamine transients are knocked out still move spontaneously but pursue reward with less vigour, while depletion or receptor blockade does disrupt movement initiation — is a cognitive-functional finding consistent with the framework's distinction between neural computation and conscious selection, without itself establishing that distinction. The broader empirical case for the tenet — placebo's content-specific physiological direction and choking's mode-specific skill disruption — is developed at [[empirical-phenomena-mental-causation]], establishing the explanandum the location/specification programme attempts to mechanise. The tenet also forecloses retreat to epiphenomenalism when specification turns out to be hard: it demands consciousness make a physical difference, which demands the difference be specifiable.

**[[tenets#^dualism|Dualism]]** creates the specification problem: two ontologically distinct domains must be lawfully related. The cost of taking dualism seriously is accepting a mapping burden physicalism avoids. **[[tenets#^no-many-worlds|No Many Worlds]]** is essential because specification only makes sense if there is genuine selection — under MWI all outcomes occur and there is nothing to specify. **[[tenets#^occams-limits|Occam's Razor Has Limits]]** counsels patience: if consciousness genuinely influences matter, the difficulty reflects the problem's depth, not the theory's failure.
...
- [[the-psychophysical-control-law]] — Candidate formal mappings
- [[psychophysical-laws]] — Principles connecting experience to physics
- [[attention-and-the-consciousness-interface]] — Attention-motor convergence
- [[coupling-modes]] — Three modes of consciousness-physics interaction
- [[mental-causation-and-downward-causation|mental causation]] — The broader case
- [[consciousness-interface-development]] — Lifespan trajectory
- [[mind-matter-interface]] — Filter theory and quantum selection unified
- [[dopamine-and-the-unified-interface]] — Salience and threshold modulation
- [[brain-interface-boundary]] — The five criteria
- [[concepts/consciousness-selecting-neural-patterns]] — The selection mechanism
- [[quantum-consciousness]] — Stapp, Orch OR
- [[bandwidth-of-consciousness]] — The ~10 bits/second constraint
- [[decoherence]] — The coherence challenge
- [[pairing-problem]] — Mind-to-body indexing
