...
**BP2 gap**: Synchronized firing is still firing in separate neurons. Even perfect temporal coincidence does not produce ontological unity — correlation is not identity. Why does temporal tagging *feel* unified? The mechanism explains when binding succeeds or fails but not why successful binding produces unified experience rather than correctly labelled parallel streams.
