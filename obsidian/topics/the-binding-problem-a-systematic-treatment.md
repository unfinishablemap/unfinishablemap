...
The distinction matters because BP1 solutions are routinely mistaken for BP2 solutions. Explaining *how* features are coordinated does not explain *why* coordination produces phenomenal unity. This confusion runs through much of the binding literature and obscures what remains genuinely unsolved. See [[binding-problem]] for extended treatment.
...
**BP2 gap**: Cross-modal binding makes the [[explanatory-gap]] maximally stark. Different modalities don't just process in different locations — they use fundamentally different representational formats. The qualitative character of visual experience differs in kind from auditory experience. How does the brain create a single experience encompassing both colour and sound? Convergence zones explain information routing; they do not explain why information from incommensurable modalities produces unified phenomenology. The [[consciousness-and-the-phenomenology-of-place|atmospheric character of places]] presents cross-modal binding at its most integrative: visual, auditory, olfactory, tactile, and evaluative dimensions fuse into a single felt quality that resists decomposition into its sensory sources. The [[three-dimensional-world-representation-problem|3D world representation problem]] applies this challenge specifically to spatial cognition: visual depth, auditory localisation, proprioceptive body position, and vestibular orientation must bind into a single phenomenal spatial arena, not merely coexist as separate spatial maps.
...
**NREM sleep**: During deep sleep, local cortical processing continues — memory consolidation, hippocampal replay, pattern integration. Yet phenomenal unity is absent. [[sleep-and-consciousness|Sleep]] shows that some computational binding proceeds without BP2. However, the picture is more complex than a clean BP1/BP2 split: long-range cortical connectivity is also dramatically disrupted during NREM sleep. The thalamocortical system fragments into isolated islands of activity. So it is not that *all* of BP1 is intact while BP2 alone vanishes — global integration is disrupted too.
...
On this view, neural binding mechanisms (BP1) condition *which* experiential contents are unified — what gets bound together — while unity itself is contributed by consciousness. This explains the persistent BP1/BP2 gap: neuroscience keeps solving coordination problems without touching phenomenal unity because coordination and unity are different in kind. See [[binding-problem]] for extended discussion.

## Relation to Site Perspective

The binding problem — treated systematically as a family rather than a single puzzle — illuminates why the Map's [[tenets]] take the positions they do.

**[[tenets#^dualism|Dualism]]**: The shared structure across all five binding varieties reveals that phenomenal unity is irreducible to physical coordination. The same explanatory gap appears in perception, time, cognition, and subjecthood. No arrangement of separate physical processes — no matter how tightly coordinated — produces genuine experiential unity. This supports the core dualist claim: consciousness involves something beyond the physical.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: If quantum entanglement is the only physics providing genuine holism, the binding problem motivates the tenet directly. Classical physics can coordinate separates; only quantum mechanics can produce genuine wholes. The binding problem's resistance to classical solution is consistent with consciousness operating at the quantum level.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Binding is not passive. Attention shapes what gets bound — you can attend to visual features and ignore auditory input, or vice versa. If consciousness merely reflected neural binding passively, voluntary control of binding would be inexplicable. The fact that [[mental-effort|effortful attention]] shapes which streams unify suggests top-down causation from phenomenal states to neural coordination. This connects to [[topics/free-will|free will]]: if phenomenal binding is partly under voluntary control, consciousness actively selects among possible unified experiences rather than passively registering whatever the brain presents.
