...
The "fixed" in "fixed domain" can look like it forbids the downward causation the [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet requires—a timelessly given signal sounds like the passive radio the [interface section above](#what-dualism-adds-the-interface-story) already disowned. The tension is only apparent. "Fixed" constrains *what* consciousness is—the domain of possible experience does not itself change—not *whether* it acts. A non-changing domain can still bias quantum outcomes in the neural systems coupled to it; the biasing alters physical trajectories without altering the domain of possibilities being drawn upon. The fixity is about the menu, not about whether anything is ordered from it.

The remaining difficulty: the fixed-domain model needs [[psychophysical-laws|psychophysical laws]]—fundamental regularities linking physical configurations to conscious experiences—but provides no account of where those laws come from or why they take the form they do.
...
- [[consciousness-and-cognitive-distinctiveness|consciousness threshold in cognitive evolution]] — The cognitive discontinuity at the threshold
