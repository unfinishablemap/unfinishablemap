...
Staggered dissolution constrains interface architecture without discriminating for it. A unified neural product need not dim uniformly: the rivals the source article itself sets out—graded precision-attenuation down one hierarchy, and cortical territories falling asleep on separate timelines—generate the same staggered order from a single mechanism with no second channel required. What the transition does display is a bandwidth asymmetry, the receiving side (vivid autonomous imagery) opening wider as the transmitting side (voluntary control) narrows, though motor gating accounts for that too. The [[coupling-modes]] framework maps its modes onto the sequence and predicts a distinct phenomenological signature for each; hypnagogia is the natural laboratory for that prediction, which has not been run.

Lacaux et al. (2021) found participants who accumulated at least fifteen seconds in N1 sleep roughly three times as likely to discover a hidden shortcut in an arithmetic task (83% against 30%)—fifteen seconds being the minimum criterion for classifying an N1 episode rather than an administered dose. One unreplicated paradigm, and consistent with partial interface loosening having functional consequences rather than confirming it.

### Meditation: Voluntary Interface Modulation

Where other altered states impose interface changes from outside—pharmacology, sleep pressure, brain injury—[[meditation-and-consciousness-modes|meditation]] demonstrates that consciousness can reconfigure its own interface from within. Focused attention meditation (FA) strengthens the selection mechanism through deliberate, sustained attentional control, producing increased frontal theta, ACC activation, and dorsal attention network engagement. Open monitoring meditation (OM) cultivates the opposite: passive witnessing, with PCC deactivation, alpha increase, and DMN quieting through disengagement rather than active suppression. That consciousness can operate in both modes—active selection and passive witnessing—answers the Advaita challenge of how a selector can also be a non-interfering witness: these are *modes* of interfacing, qualitatively different configurations rather than a single fixed relationship to neural activity.

The voluntariness is the critical datum. If the brain produced consciousness, consciousness reconfiguring its own neural substrate looks circular—the output altering the machinery that generates it. Under filter theory no circularity arises: consciousness operates the interface from the consciousness side, adjusting which channels are engaged and how tightly. Advanced meditators describing "effortless awareness" have trained the interface to a configuration requiring minimal ongoing intervention—[[meditation-and-consciousness-modes#Effortless Awareness After Effortful Training|initial effort trains the brain; later effortlessness reflects a trained brain requiring less correction]]. The resulting state—[[witness-consciousness]]—is awareness observing mental contents without identifying with them. Importantly, claims about meditation producing structural brain changes require qualification: Kral et al. (2022) found no structural changes in a well-controlled 218-participant study, though functional effects—the neural signatures of different attention modes—survive scrutiny. The interface reconfiguration is functional, not anatomical.

Meditative cessation events sharpen the point further. Unlike anaesthesia (externally imposed unconsciousness) or sleep (biologically regulated withdrawal), cessation involves *deliberate* disengagement of consciousness from neural processing—followed by return, often with reports of transformative insight. The meditator who voluntarily reaches cessation and returns is, on the filter reading, stepping away from the interface entirely and stepping back.

That reading now faces a meditation-specific rival, the contemplative sibling of the REBUS engagement above. Laukkonen and Slagter (2021) derive the entire deconstructive arc—conceptual attenuation, reduced reactivity, non-dual awareness, cessation itself—from progressive precision-reduction in a hierarchical generative model, with no interface anywhere in the machinery: focused attention holds precision high on a single object, open monitoring withdraws it from object-level predictions, and the arc ends in a mind that has temporarily stopped predicting, a limit their later work models for *nirodha samāpatti* specifically (Laukkonen et al., 2023). Within that framework the voluntariness carries no circularity—a hierarchy adjusting the gain on its own lower levels is what such architectures are built to do—and cessation-and-return is precision driven toward zero, then the model rebooting with recalibrated priors, which is also its account of the insight reports. The arc's ordering falls out of the hierarchy too, abstract self-related priors attenuating before bare presence, where the interface reading orders the same disassembly by channel; the orderings largely coincide, so no discriminator has yet been derived from them. What the precision story does not supply, by its own mechanistic standard, is why graded withdrawal of prediction should be *felt* as deepening stillness rather than merely registered. That residue is the framework boundary the Map's [[predictive-processing-and-dualism|treatment of predictive processing]] marks in full, refuted in neither direction; the meditation window, taken alone, does not discriminate.
...
The decisive discriminating evidence lies elsewhere: in cases where consciousness *persists or intensifies* during severe neural disruption. Psychedelics expand experience while decreasing cortical activity. Hypnagogic creativity rises, on one unreplicated result, during the transition *away* from full waking function. REM sleep enhances creative problem-solving through a neural configuration that has *withdrawn* executive control. If the brain produces consciousness, then a brain doing less should not produce more. This argument needs one caution: decreased *regional activity* is not the same as less *physical processing*. The psychedelics that lower default-mode activity simultaneously raise between-network connectivity and signal entropy, so the honest reading tracks connectivity, entropy, disinhibition, hierarchical precision, and network reconfiguration alongside raw activity. The enhancement-through-disruption cases carry weight only where these fuller measures—not regional activity alone—fail to keep pace with the richer experience. **Production models** must explain these enhancement-through-disruption cases, along with why identical behavioural outputs mask radically different phenomenologies (propofol vs. ketamine). Each has a piecemeal physicalist explanation—disinhibition, pharmacological specificity, functional separability—and the candidate unifier, the active-inference programme, is engaged at the meditation window above and in full elsewhere.

**Filter theory** provides that unified account. The brain constrains consciousness through multiple semi-independent channels. Different altered states loosen, tighten, or reconfigure different channels. The pattern of what survives and what degrades maps the filter's architecture. Phenomenal presence—the most robust component—corresponds to the receiving side of the interface, which requires only that consciousness have *some* channel through which to manifest. Voluntary attention—the most fragile component—corresponds to the transmitting side, through which consciousness acts back on neural processes. The asymmetry between robust reception and fragile transmission fits an interface model without discriminating for it: global workspace theory makes a conscious-access bottleneck its defining feature, so the bandwidth datum—roughly 10 bits per second of conscious throughput against 10⁹ of aggregate neural processing—is shared rather than discriminating. Near-death experiences may provide a limit case: gamma surges at the point of death (Xu et al., 2023) are measured in a small number of dying patients, and the inference from a gamma surge to *intensified consciousness* is a framework-stage interpretation, not an established reading—the surge is documented, the experiential gloss is contested. If that reading holds, it would be the most extreme instance of enhancement through neural crisis: consciousness intensifying precisely when filtering is maximally disrupted.

The [[interface-specification-programme|Interface Specification Programme]] identifies six converging lines of inquiry into how consciousness meets matter. Altered states contribute a seventh: *empirical interface mapping through natural and pharmacological perturbation*. Each altered state is, in effect, an experiment that selectively disables interface components and observes what remains—the consciousness researcher's equivalent of the neuroscientist's lesion study, but applied to the interface itself rather than to brain tissue.

## Challenges and Limitations

Three challenges to this synthesis deserve honest engagement.

**The disinhibition alternative.** For each altered state, a physicalist can offer a disinhibition account: prefrontal withdrawal releases imagery circuits, pharmacological intervention reconfigures network dynamics, sleep pressure shifts neurochemical balance. These accounts explain much of the phenomenological data without invoking non-physical consciousness. A piecemeal collection of them, each unified by nothing, would leave the cross-state convergence as unexplained coincidence—but as the opening section argued, the convergence itself does not discriminate, because the same unifying move is available to production theorists. The discriminating weight rests on the enhancement-through-disruption cases, not on the count of converging states.
...
**Selection bias in the matrix.** The convergence matrix compares states that the Map's framework predicts should be informative. A critic might argue that the pattern appears because the selected states were chosen to fit the conclusion. The defence is that these are not obscure edge cases—they are the major categories of altered consciousness recognised across neuroscience, pharmacology, and contemplative traditions. The pattern was not constructed from outliers but discovered across the most common and well-studied perturbations of human consciousness.
...
- [[targeted-lesion-discriminating-tests-between-production-and-filter-readings-of-the-memory-hierarchy]] — What a focal perturbation would have to deliver to separate production from filter readings of the memory hierarchy the matrix instantiates at its memory-channel row
...
11. Mashour, G. A., et al. (2021). Recovery of consciousness and cognition after general anesthesia in humans. *eLife*, 10, e59525.
12. Mashour, G. A. (2024). Anesthesia and the neurobiology of consciousness. *Neuron*, 112(10), 1553-1567. https://doi.org/10.1016/j.neuron.2024.03.002
13. Montupil, J., Cardone, P., Staquet, C., et al. (2023). The nature of consciousness in anaesthesia. *BJA Open*, 8, 100224.
14. Mavromatis, A. (1987). *Hypnagogia: The Unique State of Consciousness Between Wakefulness and Sleep*. Routledge.
15. Sarasso, S., et al. (2015). Consciousness and complexity during unresponsiveness induced by propofol, xenon, and ketamine. *Current Biology*, 25(23), 3099-3105.
16. Sepúlveda, P. O., et al. (2019). Neural inertia and differences between loss of and recovery from consciousness during total intravenous anaesthesia: a narrative review. *Anaesthesia*, 74(6), 801-809.
17. Siegel, J. S., et al. (2024). Psilocybin desynchronizes the human brain. *Nature*, 632, 131-138.
18. Tagliazucchi, E., et al. (2016). Increased global functional connectivity correlates with LSD-induced ego dissolution. *Current Biology*, 26(8), 1043-1050.
19. Tollock, M., Leontovich, N., Gonzalez, A., & Parnia, S. (2025). A multi-site prospective study of paradoxical lucidity in moderate to severe dementia. *Innovation in Aging*, 9(Supplement_2), igaf122.2914. https://doi.org/10.1093/geroni/igaf122.2914
20. Xu, G., et al. (2023). Surge of neurophysiological coupling and connectivity of gamma oscillations in the dying human brain. *PNAS*, 120(19), e2216268120.
