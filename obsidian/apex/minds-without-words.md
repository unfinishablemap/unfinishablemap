...
description: "Non-linguistic consciousness from animals to simple organisms. The marker method, standing agnostic challenge, and constrain-vs-establish discipline structure the catalogue's evidential claims."
created: 2026-01-31
modified: 2026-01-31
human_modified: null
...
apex_last_synthesis: 2026-05-19T21:00:00+00:00
...
A bat navigates by echolocation. An octopus solves puzzles with a nervous system distributed across eight arms. A bee rolls a ball for no apparent reward — play behaviour in a creature with a brain the size of a sesame seed. Somewhere beneath all this lies a question we cannot directly answer: is there something it is like to be these creatures? If the Unfinishable Map is right that consciousness is irreducible to physical processes, the question takes on particular force — every organism with genuine phenomenal experience carries the same mystery we find in ourselves.

This piece synthesises the Map's treatment of non-linguistic consciousness. What emerges is a methodological discipline as much as a picture: experience is more fundamental than cognition in the order of explanation, but every species-claim is constrained by the same standing agnostic challenge; convergent evidence raises priors without ever settling the case; and the boundaries of mind resist the neat categories we would like to impose.
...
Thomas Nagel's 1974 framework remains the load-bearing one: an organism has conscious mental states if and only if there is something it is like to be that organism, something it is like *for the organism*. We can know *that* bats have experience without knowing *what* their experience is like. The barrier is structural, not evidential — complete knowledge of bat neurophysiology would not reveal what echolocation feels like from the inside. The [[commensurability-void]] sharpens this further: the bat's phenomenal world may be organised along dimensions sharing no common measure with ours.
...
The scientific landscape reflects this asymmetry. The **Cambridge Declaration (2012)** affirmed consciousness in mammals, birds, and cephalopods; the **New York Declaration on Animal Consciousness (2024)**, launched in April 2024 and signed by hundreds of scientists and philosophers (605 as of August 2026, up from roughly 40 at launch) including Chalmers, Koch, Godfrey-Smith, Chittka, and Seth, extends "at least a realistic possibility" of conscious experience to all vertebrates and many invertebrates, with "strong scientific support" for mammals and birds. The declarations identify *correlates*, not consciousness itself — and the operational counterpart is Andrews, Birch & Sebo's (2025) **marker method**, which grades behavioural and anatomical markers by context-dependent confidence and treats convergence across markers and dimensions as what raises evidential weight, rather than any single finding. The catalogue uses a five-tier evidential scale across its animal-consciousness articles — *established*, *strongly supported*, *realistic possibility*, *live hypothesis*, *speculative integration* — and that scale governs the cases that follow.

## The Standing Agnostic Challenge

Before assembling the positive case, the strongest skeptical counterpoint must be in view. Gutfreund (2024) argues that neuroscience remains fundamentally agnostic about animal phenomenal consciousness: "A perceptual decision without a felt subjective experience is a possibility that is equally consistent with the data." Wandrey & Halina (2025) map the same circularity onto the evolutionary debate — the early-evolution and latecomer camps disagree not primarily about the fossil record but about which markers count as evidence. The 2025 COGITATE Consortium adversarial collaboration sharpens the point: pre-registered head-to-head testing of IIT and Global Neuronal Workspace Theory (n=256, fMRI/MEG/iEEG) challenged core assumptions of both — neither was robustly confirmed even on human subjects.

Dualism removes a defeater — the move "simpler nervous systems are merely unconscious mechanisms; positing experience is unnecessary." It does not, on its own, supply positive evidence. The two questions need to be kept separate: *Is consciousness in nematodes, insects, or cephalopods compatible with the Map's metaphysics?* and *Does the evidence support its actual presence?* The standing agnostic challenge applies to every species-claim that follows.

## Multiple Independent Origins

The [[evolution-of-consciousness|evolution of consciousness]] appears to have happened independently multiple times. Godfrey-Smith's (2024) neural-dynamics-of-subjectivity framework highlights three radically different architectures: vertebrates (mammalian neocortex, cetacean cortex lacking layer IV, avian pallium without cortical layers); cephalopods (~500 million neurons distributed across eight arms with their own processing centres); arthropods (tiny brains potentially meeting the criteria for unlimited associative learning). What matters, on this view, are large-scale dynamic patterns rather than specific anatomical structures.

The pattern coheres with the Map's dualist position: if consciousness *interfaces with* physical systems rather than being *produced by* specific structures, we should expect it to appear wherever the relevant organisational properties exist, regardless of phylogenetic lineage. The [[universal-coupling-response|universal coupling response]] makes this expectation explicit. But the coherence runs one direction only — convergent evolution removes a defeater for cephalopod and arthropod consciousness; it does not, on its own, raise the evidential status of those lineages above *realistic possibility, contested*. [[interface-heterogeneity|Interface heterogeneity]] remains a live possibility: different lineages may couple through different physical mechanisms.

Even within vertebrates, convergence is striking. [[cetacean-and-corvid-consciousness|Cetaceans and corvids]] evolved sophisticated cognition independently from primates — dolphins through modified cortex, corvids through nuclear pallial clusters — yet both display self-recognition, tool use, and prospective cognition. These intermediate cases motivate the Map's interest in *how* the consciousness-matter coupling might scale across lineages, treated below.

### Insect Consciousness: The Expanding Frontier

The marker method's empirical bite is sharpest at the contested invertebrate frontier. Chittka et al. (2025, *Philosophical Transactions B*) catalogue the specific evidence the *Mind of a Bee* (2022) anticipated: young bumblebees engage with objects more frequently than older bees — a pattern that parallels vertebrate play, where age-graded engagement is itself a marker; comparable play-like behaviour has now been documented in fruit flies; bees attacked by a simulated predator show persistent affect-like state changes lasting days, exceeding what stimulus-bound reflex models predict. Each item is incremental — none individually settles the case — and Chittka et al. themselves frame the evidence in marker terms rather than constitutive ones. The catalogue raises the prior considerably above bare baseline cognition; the standing agnostic challenge applies in full force.

## Baseline Cognition: What Neural Processing Achieves Without Consciousness

The [[baseline-cognition|baseline cognition hypothesis]] clarifies what distinguishes human intelligence from that of other sophisticated animals. Great apes are our closest evolutionary relatives — roughly 98-99% identical at single-nucleotide variants across alignable regions, but the telomere-to-telomere ape genomes (Yoo et al. 2025 *Nature*) report that 12.5–27.3% of an ape genome fails to align one-to-one, part of which the authors attribute to alignment limits in repetitive regions. The cognitive-gap argument turns on *substantial similarity with substantial divergence*, not on any single percentage; standard neuroscience attributes the gap to architectural differences (expanded dorsolateral prefrontal cortex, arcuate-fasciculus connectivity, cortical folding) — a physicalist explanation that does not require non-physical causation.
...
**Social cognition**: Great apes pass Level 1 theory-of-mind tests but struggle with Level 3 recursive mindreading ("she thinks I think..."). The nested structure demands simultaneous manipulation of multiple representations.
...
**Cumulative culture**: Gruber et al. (2015) propose that "apes have culture but may not know that they do." [[cumulative-culture|Cumulative culture]] requires metarepresentation — representing the current method as modifiable. Without it, traditions persist within the "zone of latent solutions" but do not systematically accumulate.
...
The Map's preference for the amplification reading is tenet-driven rather than forced by the comparative evidence. A structurally distinct interactionist alternative is worth naming. [[consciousness-as-amplifier|Consciousness as amplifier]] holds that consciousness varies in *grade* across species, scaling with the cognitive capacities it enables — the picture above. [[interface-efficacy-and-the-cognitive-gap|Interface-efficacy scaling]] holds consciousness at full grade across species, with the mind-brain coupling itself varying along bandwidth, fidelity, granularity, and candidate-type axes. Both are tenet-coherent; both fit the comparative data; neither is forced by it. The honest catalogue position is that the human-ape gap *constrains* identity readings of cognition without *establishing* either Map-specific interactionist version.

## Emotional Consciousness: The Felt Quality of Valence

Perhaps nowhere is consciousness more vivid than in emotional experience. The badness of pain and the pleasure of joy possess an intrinsic felt quality that no functional description captures. Barrett and Russell's [[emotion-and-dualism|core affect]] framework suggests this is not intermittent: consciousness carries valence at all times, blending pleasure-displeasure with arousal-deactivation. We are never affectively neutral.

Why does pain feel *bad* rather than merely different? The hedonic account treats valence as an intrinsic qualitative property of experience — the badness is not *about* anything external but a property of the pain itself. The evaluativist account (Carruthers 2018) argues valence represents value in the world. **Pain asymbolia settles this specific dispute**: patients with damage to specific brain regions can represent tissue damage without feeling the badness. They report the pain exists but does not bother them; motivation collapses. The dissociation is between sensory and affective dimensions *within* cortical processing, which is why asymbolia is decisive against the evaluativist reduction. It does *not* settle the separate Panksepp-LeDoux question about subcortical phenomenal consciousness, where asymbolics' intact cortical higher-order representations make the case consistent with LeDoux rather than against him.
...
The felt quality matters causally and morally. Pain asymbolia constrains identity readings of valence rather than establishing that phenomenal properties do real causal work — evidence for [[tenets#^bidirectional-interaction|Bidirectional Interaction]], not a demonstration of it. Morally, a valence-based [[sentientism]] makes the capacity for valenced experience necessary and sufficient for moral status — Birch (2024) defines sentience as that capacity — against a broader criterion counting any phenomenal consciousness morally significant. [[topics/phenomenal-value-realism|Phenomenal value realism]] strengthens the valence-based version: if the felt badness of suffering *constitutes* intrinsic badness, animal suffering instantiates the same value property as human suffering, not merely an analogue. Max Scheler's "Wertnehmung" — value-perception — treats emotional experience as the primary mode through which values are disclosed, an irreplaceable epistemic access that no non-conscious system could replicate.

## Minimal Consciousness: Where Does Experience Begin?

How little neural complexity can support consciousness? Three model organisms illustrate the catalogue's five-tier evidential discipline.

**C. elegans** has exactly 302 neurons — the most thoroughly mapped organism in neuroscience. Evidence for consciousness: habituation, sensitisation, associative learning, an endogenous opioid system, vertebrate-like anaesthetic responses, positive Phi in computational models. Evidence against: failure of trace-conditioning paradigms, exploratory behaviour resembling biased random walks, no demonstrated multimodal integration, no self-other distinction. The dualist framework keeps the question live by removing the defeater "302 neurons cannot suffice in principle"; the empirical record sits at *live hypothesis* sliding toward *speculative integration*.

**Hydra**, with ~900 neurons in a decentralised nerve net, shows habituation and sensitisation but no established associative learning. The architectural challenge to centralisation requirements is theoretically interesting but raises the metaphysical question without supplying positive evidence — *speculative integration*.

**Slime moulds** (*Physarum polycephalum*) possess no neurons at all, yet solve mazes and display habituation. The defensible reading is that they exhibit sophisticated information processing without phenomenal experience — a clear case where cognition and consciousness dissociate. *Speculative integration* with cognition-without-consciousness as the more parsimonious reading.

The **Unlimited Associative Learning (UAL) framework** (Ginsburg & Jablonka 2019) proposes consciousness emerged when learning became *unlimited* — capable of associating compound stimuli across modalities with complex motor combinations. C. elegans, Hydra, and slime moulds all fail UAL criteria. For the Map, UAL is best read as interface-identification rather than emergence verdict: passing keeps the consciousness hypothesis live for a lineage; failing pushes it toward the speculative end. Crucially, the interface reading must not absorb the negative empirical signal — *failing* UAL remains evidentially meaningful, telling us we lack the behavioural signature that most reliably accompanies known instances of consciousness.

The *distribution problem* — why some organisms have consciousness and others not — presses differently on different views. Gradualism faces the hard problem at every scale. Threshold emergence creates arbitrary boundaries. Panpsychist continuity dissolves the problem but faces the [[combination-problem|combination problem]]. **Interface dualism** — the Map's position — suggests the question may be unanswerable because it asks the wrong thing. Consciousness does not emerge from physical systems; it interfaces with them. There may be no principled threshold because consciousness is not a property physical systems generate but a domain physical systems can connect with. Under that reading, failed UAL underdetermines the inference, since a low-efficacy coupled mind and an absent mind leave the same traces; parsimony still favours the simpler "no coupling" reading when the behaviour matches it.

Whitehead's process philosophy offers a complementary framing: experience is fundamental, not emergent. The question for C. elegans is not whether the worm suddenly "has" consciousness but how 302 neurons organise pre-existing experiential elements into whatever unity it achieves. Contemplative traditions reinforce the possibility: Metzinger's work on "minimal phenomenal experience" describes states where content drains while awareness remains, and Buddhist analysis distinguishes *vijñāna* (basic awareness) from *prajñā* (discriminative wisdom). [[witness-consciousness|Witness consciousness]] practices reveal that awareness can persist when specific contents fall away — the witnessing itself, irreducible to any content. The question for C. elegans is not whether it possesses sophisticated prajñā but whether basic vijñāna is present, and complete structural knowledge of 302 neurons does not bridge that gap — this is what [[mysterianism|cognitive closure]] looks like empirically.

## Synthesis: What Non-Linguistic Consciousness Reveals

The individual source articles establish components — animal consciousness as the hard problem applied universally, baseline cognition as what neural systems achieve without consciousness, emotional consciousness as valence requiring phenomenal reality, simple organisms as the boundary question, phenomenal consciousness as the irreducible felt quality. What synthesis adds is a methodological discipline that no single source can voice from inside itself.

**The constrain-vs-establish discipline is the cluster's signature.** No individual finding here *establishes* the Map's interactionist dualism. Pain asymbolia constrains identity readings of valence by settling the hedonic-evaluativist dispute. The marker method grades evidence; convergence does the work. The human-ape gap constrains epiphenomenalism without forcing either amplification or interface-efficacy reading. UAL failure does not establish absence of consciousness; it tells us the most reliable behavioural signature is missing. The Map's evidential standing rests on cumulative convergence across markers, dimensions, and traditions — not on any single argument's defeater status. The discipline matters because the temptation in dualist writing is to inflate each piece of evidence into a knockdown.
...
**The moral stakes are real and asymmetric.** The valence-based criterion — that the capacity for valenced experience qualifies a being for moral consideration — combined with phenomenal value realism gives the New York Declaration's precautionary stance philosophical bite. When uncertainty about consciousness carries moral weight, ignoring it is irresponsible. The asymmetry between animal and AI inference grounds matters here too: we have evolutionary, neural, and behavioural homologies with animals that we do not have with current AI.

**The limits reveal something about our position.** We cannot know what bat echolocation feels like. We cannot determine whether C. elegans experiences anything. Even our access to our own emotions is partial — alexithymia affects ~10% of the population, demonstrating that having an emotion and knowing what emotion one has are separate capacities. Under dualism, this gap bridges ontologically distinct domains. The [[voids|void]] at the boundary of animal minds mirrors the void at the boundary of our own understanding — not merely incomplete knowledge but potentially inaccessible territory.

## Relation to Site Perspective

**[[tenets#^dualism|Dualism]]**: Animal consciousness poses the *same* hard problem as human consciousness. The marker method and the five-tier evidential scale identify *correlates*, consistent with Dualism's commitment that no third-person feature *constitutes* consciousness.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: The type-specific correspondence between consciousness-dependent operations and the human-ape gap argues against epiphenomenalism. Pain asymbolia constrains identity readings of valence rather than establishing that it does causal work. [[delegatory-dualism|Delegatory dualism]] offers a mechanism via [[delegatory-causation|preemption]], avoiding overdetermination. Forcing the case against epiphenomenalism requires the separate [[evolutionary-case-for-mental-causation|argument]] that *consciousness itself* is selectable.
...
- [[animal-consciousness|Animal Consciousness]] — The comprehensive treatment of consciousness across species, from great apes to insects
...
2. Russell, J. A., & Barrett, L. F. (1999). Core affect, prototypical emotional episodes, and other things called emotion: Dissecting the elephant. *Journal of Personality and Social Psychology*, 76(5), 805–819. https://doi.org/10.1037/0022-3514.76.5.805
