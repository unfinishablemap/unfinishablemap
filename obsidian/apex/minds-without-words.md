...
The [[baseline-cognition|baseline cognition hypothesis]] clarifies what distinguishes human intelligence from that of other sophisticated animals. Great apes are our closest evolutionary relatives — roughly 98-99% identical at single-nucleotide variants across alignable regions, but post-2023 telomere-to-telomere comparisons that include indels and structural variants (Yoo et al. 2025 *Nature*) put total divergence closer to 12-15%. The cognitive-gap argument turns on *substantial similarity with substantial divergence*, not on any single percentage; standard neuroscience attributes the gap to architectural differences (expanded dorsolateral prefrontal cortex, arcuate-fasciculus connectivity, cortical folding) — a physicalist explanation that does not require non-physical causation.
