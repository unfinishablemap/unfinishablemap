...
modified: 2026-05-18
human_modified: null
ai_modified: 2026-08-01T14:39:13+00:00
...
apex_last_synthesis: 2026-06-16T19:30:00+00:00
...
That cross-route convergence is what the [[epistemology-of-convergence-arguments#compound-signatures-convergence-without-a-shared-mechanism|epistemology of convergence arguments]] names a *compound signature*: agreement among mechanistically disjoint routes, so the agreement cannot be one upstream cause sampled three times. Pharmacology is one route of that signature, not the whole of it. The sibling routes are structural ([[neurological-dissociations-as-interface-architecture|lesion]], e.g. alien hand syndrome) and *psychogenic*—and the cleanest single exhibit of the psychogenic route is [[conversion-disorder-as-consciousness-side-fault|conversion disorder]], where the affected limb moves normally under anaesthesia or hypnosis (motor capacity demonstrably intact) yet not under awake directed volition. Conversion disorder is mechanistically distinct from the pharmacological route precisely in requiring *neither* drug *nor* lesion, which is what lets it exclude "the perturbation broke the substrate" without either. It is a sibling to pharmacological dissociation in the compound signature, not a pharmacological instance—the three routes earn their evidential bite by sharing no mechanism. The calibration that follows applies to the compound signature as a whole: the convergence earns the *architecture* (the channels are separable) robustly while leaving the *interface reading* of that separability a live hypothesis the routes do not jointly vindicate.
...
The convergence with non-pharmacological evidence multiplies the effect. The [[neurological-dissociations-as-interface-architecture|neurological dissociations]] reach the same channel architecture by structural damage. The [[clinical-dissociation-as-systematic-evidence|clinical dissociations]] reach it by functional disconnection without structural damage. The [[contemplative-pathology-and-interface-malfunction|contemplative pathology]] cluster reaches it by voluntary attentional restructuring pushing the interface beyond its operating parameters. Pharmacology, lesion, functional disconnection, and contemplative practice are four perturbation *classes*, each capable of selectively disrupting the same components in the same agent-specific patterns. The architecture replicates across classes that share no mechanism—the load-bearing independence is *between* classes, since within the functional-disconnection class a single precision-weighting mechanism may be reading one architecture several times (see the clinical-cluster discount above). *That* is the cumulative-convergence move that pharmacological dissociation contributes one quarter of, with the [[altered-states-as-interface-evidence|altered-states apex]] gathering five state-modalities into a complementary matrix at the systems-level rather than the mechanism-level. The [[epistemology-of-convergence-arguments#compound-signatures-convergence-without-a-shared-mechanism|epistemology of convergence arguments]] formalises why mechanistic disjointness is the load-bearing feature: a compound signature pre-empts the common-cause objection only where there is no shared upstream cause to screen off—which holds across classes by construction, but not necessarily within one. The same source also fixes where the signature's reach stops—it earns the architecture but not the architecture's dualist significance—which is the discipline the next section applies in detail.
...
- [[conversion-disorder-as-consciousness-side-fault|Conversion Disorder as the Consciousness-Side-Fault Paradigm]] — The *psychogenic* sibling route in the three-route compound signature; reaches the same separable-channel finding through functional decoupling without drug or lesion, with the under-anaesthesia test as its discriminator
