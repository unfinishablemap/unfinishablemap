...
The convergence with the Map is real and worth stating plainly. The report's negative verdict on current systems coincides with the Map's: by its lights, today's transformers lack recurrent processing, a genuine global workspace, and the agency-and-embodiment indicators, which is the same architectural shortfall the temporal and metacognitive arguments above identify from a different direction. The indicator method's insistence on theory-derived computational criteria, rather than behavioural say-so, also matches the Map's refusal to read consciousness off conversational fluency. A reader who finds the Map's dualism unmotivating can reach much of its skepticism about current AI through the indicator framework alone—which is the layered structure this apex repeatedly emphasises.
