...
modified: 2026-04-29
human_modified: null
ai_modified: 2026-04-30T16:47:00+00:00
...
The two genuine coalesces share a structural shape: each merges distinct limits, requires both faces, resists single-mechanism unification *as currently understood*, and names the conjunction explicitly in its central paragraphs. The two cognates above (erasure-void, the cardinality floor) share these features minus the first—neither was a merger of prior articles at the cognate's birth.

Three further cognates have since accrued—[[suspension-void|the suspension void]], [[imagery-void|the imagery void]], and [[vagueness-void|the vagueness void]]—each with the structural marks of the discipline but each instantiating a different kind of seam. The five cognates together yield enough variety to support a sub-typology by seam-relationship type, developed in the next section.
...
**Causal-substrate** ([[erasure-void|erasure-void]]). The faces share substrate, and the sharing is itself causal: one face's degradation impairs the system that would witness it through the other. Loss erodes the monitoring that would notice the loss. The conjunction is forced because face B is not merely co-present with face A but is causally degraded by it.

**Architectural** ([[the-quantitative-comprehension-void#the-cardinality-floor|the cardinality floor]]). The faces are joint consequences of a single architectural feature whose presentation has structurally distinct sides—subitizing's cap, the phenomenal opacity at its boundary, and the inaccessibility of the index-allocation behind the determinate output. The three are not causes but consequences, and no single face delivers the architecture-as-presenting.

**Modal-categorical** ([[suspension-void|suspension-void]]; the same shape as the [[agency-void|agency-void]] coalesce). The faces span distinct modal categories—knowing-that, being-able-to, doing. The void is constituted by the failure to bridge across categories: verification fails, capacity is uncertain, and action is suspended; the joint unavailability exceeds the failure of any single mode.

**Evidential-triangulation** ([[imagery-void|imagery-void]]; the same shape as the [[voids-between-minds|voids-between-minds]] coalesce). The faces are distinct epistemic vantages on one phenomenon—first-personal fidelity, inter-subjective testimony, and the function/phenomenology gap in the imagery case; existence, encounter, and sharing in voids-between-minds. The conjunction is forced because each face supplies an angle the others cannot.

**Reflexive** ([[vagueness-void|vagueness-void]]). The seam is constituted by self-application: the metalanguage in which the faces are stated is itself subject to the indeterminacy the faces describe. Each face inherits the others' indeterminacy rather than merely co-existing with them. Reflexive cognates are currently the rarest type and the most demanding of the seam test, since their structure is partly a property of how the article must be read.

Two questions remain open. First, whether causal-substrate and architectural collapse into one "structural" type—they share the feature that an entity's structure constitutes the conjunction—or whether erasure-void's causal asymmetry is essential. Second, whether reflexive seams remain distinct as further exemplars accrue, or fold into evidential-triangulation once metalanguage counts as a vantage. The typology is provisional in the same sense as the seam test: it yields when new cases force restructuring.
