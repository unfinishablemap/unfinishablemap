...
Genuine choice requires more than selecting among options—it requires representing those options as genuinely possible alternatives and evaluating what would follow from each. [[counterfactual-reasoning|Counterfactual reasoning]]—the capacity to imagine "what if"—provides the representational substrate through which consciousness engages with alternatives.
...
Free will requires [[mental-causation|mental causation]]—the thesis that mental states cause physical effects. Your decision to raise your arm must cause the arm to rise. If consciousness causes nothing, authorship is illusion.
...
If consciousness selects among outcomes physics leaves undetermined, it causes physical events without competing with physical causes. No overdetermination occurs because physics provides necessary but not sufficient causes. The mechanism is [[tenets#^minimal-quantum-interaction|minimal]]—working with what physics allows rather than overriding it. Consciousness doesn't violate physical laws; it determines outcomes that physics doesn't determine.
...
But the Map offers a more fundamental resolution involving [[time-collapse-and-agency|the relationship between time and collapse]]. Quantum mechanics at the fundamental level is time-symmetric—equations work equally well forward and backward. Retrocausal interpretations (Cramer's transactional interpretation, Aharonov's two-state vector formalism) take this seriously: quantum events involve "handshakes" between past and future that are themselves atemporal.
...
If agent causation delivers genuine authorship, [[moral-responsibility|moral responsibility]] gains metaphysical grounding. Compatibilist desert is pragmatic—holding people responsible has good consequences regardless of metaphysical facts. Agent-causal desert is metaphysical—people really deserve praise and blame because they really originated their actions.
...
**[[tenets#^dualism|Dualism]]**: Agent causation requires consciousness to be ontologically distinct from physical processes. If consciousness were reducible to physics, it would inherit physics' determinism (or random indeterminism). Genuine sourcehood requires something that can contribute what physics doesn't determine. The hard problem—why physical processes feel like anything—is a signpost: it marks where physical explanation ends and a different kind of account begins.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Consciousness causally influences physical outcomes. Your choices cause your actions. Mental effort produces neural change (as Jeffrey Schwartz's neuroplasticity research demonstrates). The quantum selection mechanism specifies how this works without violating physical laws: consciousness selects among outcomes physics leaves undetermined.
