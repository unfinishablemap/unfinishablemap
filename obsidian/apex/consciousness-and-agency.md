...
apex_last_synthesis: 2026-07-09T21:54:18+00:00
...
The [[trilemma-of-selection|trilemma of selection]] frames the challenge exhaustively. Determinism eliminates genuine alternatives (Horn 1). Pure indeterminism gives randomness, not authorship (Horn 2). Only the third option—mental causation—preserves the sourcehood that agency requires.

Two canonical arguments press the incompatibilist case from different directions, and the [[source-versus-leeway-incompatibilism|source-versus-leeway taxonomy]] sorts them. Van Inwagen's [[the-consequence-argument-for-incompatibilism|Consequence Argument]] is a *leeway* argument—if our acts are consequences of the remote past and the laws of nature, we cannot do otherwise under determinism. Pereboom's [[the-manipulation-argument-and-hard-incompatibilism|manipulation argument]] is a *source* argument that never mentions alternatives—an agent whose action traces to factors ultimately beyond his control is no more responsible than one covertly manipulated into it. [[frankfurt-cases-and-the-principle-of-alternate-possibilities|Frankfurt cases]] are the pivot: apparent counterexamples to the demand for alternate possibilities that pushed much of the field from leeway toward source framings. The Map's own commitment sits at *wide* source incompatibilism (Timpe)—sourcehood is fundamental, but genuine open alternatives come along with it—a location adopted on independent grounds, not one the taxonomy proves. The distinction itself carries no commitment to dualism. And source incompatibilism is not by itself libertarian: Pereboom shares the source premise yet judges indeterministic origination mere luck and concludes we have no free will. The Map parts from him only on whether that origination is real.
...
Retribution becomes intelligible: the wrongdoer exercised causal power to harm when they could have caused good. Mitigation has limits: prior causes influenced but didn't determine. Character responsibility becomes intelligible because character is partly self-created, and developing attentional skill is itself an exercise of agency—so agents are responsible not just for individual choices but for cultivating or neglecting the capacity to choose well. That agents can act against their own better judgment—[[akrasia-and-weakness-of-will|weakness of will]]—fits the selector model: the selector has failed to enforce what deliberation endorsed, a lapse in selection rather than evidence against it. The [[moral-implications-of-genuine-agency|full moral implications]] extend beyond desert to obligation, moral luck, and the demands genuine agency places on moral theory.
...
- The incompatibilism landscape — [[source-versus-leeway-incompatibilism|source vs leeway]], the [[the-consequence-argument-for-incompatibilism|Consequence Argument]], the [[the-manipulation-argument-and-hard-incompatibilism|manipulation argument]] and hard incompatibilism, [[frankfurt-cases-and-the-principle-of-alternate-possibilities|Frankfurt cases]], [[event-causal-libertarianism|event-causal libertarianism]], [[reactive-attitudes-and-strawsonian-responsibility|Strawsonian responsibility]], the [[frankfurt-hierarchical-mesh-theory-of-the-will|hierarchical mesh of the will]], and [[akrasia-and-weakness-of-will|weakness of will]] — the argument-and-taxonomy background against which the Map locates its wide-source libertarianism
