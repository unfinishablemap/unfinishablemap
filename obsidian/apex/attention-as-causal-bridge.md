...
apex_last_synthesis: 2026-06-25T01:46:02+00:00
...
The foundation is a dissociation. [[attention-and-the-consciousness-interface|Attention and consciousness come apart]] in ways that standard theories struggle to accommodate. Koch and Tsuchiya's (2007) framework—neuroscience seeking consciousness's material substrate, not a dualist argument—identifies four combinations: attention with consciousness (normal focused awareness), attention without consciousness (blindsight, masked priming), consciousness without attention (peripheral phenomenal overflow), and neither (dreamless sleep).

Most cognitive dissociations are theoretically tame—two brain systems operating independently. This one is different: one side involves the [[hard-problem-of-consciousness|hard problem]]. On Ned Block's contested reading, consciousness without attention means phenomenal experience persisting beyond the reach of cognitive access—his iconic-memory analysis has subjects seeing all letters in a display though they report only 3-4; Cohen and Dennett read the unreported letters as experienced only generically. Nartker, Firestone, Egeth and Phillips (2025, *eLife*) sharpen the dissociation without settling it: inattentionally blind participants can report the location, colour and shape of stimuli they deny noticing—information that stays accessible, which is not yet experience outrunning access. The 2025 adversarial COGITATE study (Cogitate Consortium; Ferrante, Gorska-Klimowska, et al., 2025) found neither Global Workspace Theory nor Integrated Information Theory clearly vindicated by pre-registered empirical tests—a challenge to particular predictions of both frameworks, not a selection of dualism.

The Map's interpretation: consciousness and attention are ontologically distinct. Consciousness is the non-physical subject; attention is the physical mechanism through which that subject engages with neural processes. One spectral finding is consistent with the separability. Wyart and Tallon-Baudry (2008) recorded magnetoencephalographic signals while subjects viewed faint gratings at attended and unattended locations, and found awareness and spatial attention modulating distinct bands within the gamma range: consciously seen stimuli drove mid-frequency gamma (54–64 Hz) over contralateral visual cortex at 240–500 ms post-stimulus, while spatial attention modulated high-frequency gamma (76–90 Hz) whether or not the stimulus was seen. The result is paradigm-specific, establishing a dissociation inside that paradigm rather than fixed operating frequencies for consciousness and attention; whether it generalises across modalities remains open. They can come apart because they are different things that normally work together—like a pianist and a piano.
...
Effort tracks difficulty—a boring task costs more to attend to than a gripping one—and Kahneman's *Attention and Effort* (1973) confirms this objectively: pupil dilation and heart rate rise with mental effort.

For materialists, effort phenomenology poses a puzzle. If the brain is deterministic, why does sustaining attention *feel* like work? The illusionist answer—that the brain models its own processing as effortful—faces a regress: who experiences the model?

One proposed mechanism is [[stapp-quantum-mind|Stapp's quantum Zeno effect]]: rapid, repeated acts of observation hold desired neural patterns stable against decoherence. It faces two obstacles. Neural decoherence timescales may be too fast for Zeno stabilisation to operate (see [[mental-effort|mental effort]]). And nothing in the mechanism fixes whether frequent observation stabilises the attended pattern or accelerates its decay; on the general physics acceleration is the more common outcome, so the stabilising direction assumed here has to be argued for (see [[sign-problem-for-conscious-observation]]). The phenomenology of effort stands as data regardless of mechanism.
...
Recent work complicates the simple "felt effort tracks the work" reading. [[mental-effort|Three converging dissociations]] show the felt sense detaching, in structurally distinct ways, from the operation it ostensibly reports on. Naccache et al. (2005) found a patient whose left anterior cingulate lesion extended into the callosal genu and orbitofrontal cortex, and who performed Stroop conflict trials with normal executive control while reporting no conscious feeling of mental effort and showing none of the skin-conductance coupling controls exhibited as effort rose with conflict. Hagger et al.'s (2016) preregistered 23-laboratory replication of ego-depletion (N=2,141, d=0.04, 95% CI [−0.07, 0.15]) collapsed the strength-resource model the felt-drained sense was supposed to track. Kurzban et al. (2013) and Inzlicht et al. (2021) reframe felt effort as an opportunity-cost computation or adaptive informational signal rather than a fuel-gauge readout. These results *constrain* rather than *establish* the dualist reading—they remove the simplest "felt effort just is what the operation feels like" identity. Naccache and colleagues press further: on their reading the feeling of conscious effort "would be a by-product of executive attention, but would not play a causal role in its deployment". That absent coupling sat alongside intact Stroop control, which tells against the coupling doing the work rather than for it. The honest foothold is narrower: the dissociation held only on simple laboratory tasks, and the authors record executive dysfunction in the same patient on problem-solving and dual-task demands, so the epiphenomenalist generalisation is not earned either. Whether felt effort does genuine causal work is left open, a debt [[tenets#^tenet-3-standing|Tenet 3 records]] rather than discharges. The case remains the real-time-cognition member of the [[phenomenal-output-causal-machinery-dissociation|phenomenal-output / causal-machinery dissociation cluster]], whose weight comes from cumulative convergence rather than any individual case.
...
Cai et al. (2024, *Nature*) dissociated two dopamine signalling modes. Mice whose spike-evoked dopamine transients were abolished by dopamine-neuron-specific RIM knockout—baseline dopamine persisting—moved normally and still learned reward cues, but initiated fewer trials and pursued reward with less vigour. Baseline dopamine remained necessary for movement itself: depletion or receptor blockade produced bradykinesia, and L-DOPA restored movement without restoring the transients. The Map's interface hypothesis proposes a third layer the paper does not test—consciousness biases which salient option crosses threshold once dopamine has weighted the alternatives. The three-layer architecture is consistent with rather than licensed by Cai et al.; it stands or falls with the broader interface argument. Desmurget et al. (2009) found that parietal stimulation produces conscious intention to move—even false belief of having moved—without any muscle activity, while premotor stimulation produces movement without awareness. Intention and execution are thereby neurally separable, though the intervention runs stimulation → conscious intention, and the authors read the result as making intention and awareness "emerging consequences" of parietal activity. The Map's policy-level reading is a further claim the dissociation permits rather than supports. The [[psychophysical-laws|psychophysical laws]] article identifies five candidate coupling mechanisms for this contribution; the three-layer architecture instantiates the first two—attention-bounded selection (attention as observation rate) and policy-level selection (intention as policy choice).

## Does Attention Select at All?

The sharpest challenge to this architecture's vocabulary comes from Fazekas and Nanay (2021): attention is amplification, not selection. On their account, attention's core realiser is the not-stimulus-triggered amplification of presynaptic signals feeding the brain's built-in normalisation computations; selective effects arise downstream, from perceptual machinery that winnows whether or not attention is engaged. Attention raises the gain; the circuitry selects. Read as neuroscience, the Map can accept this wholesale: the three-layer architecture already assigns the winnowing to neural competition and casts the conscious contribution as a bias on which option crosses threshold—gain-shaped, not gate-shaped. The amplification account even specifies the lever: whatever sets the gain sets the bias, and Fazekas and Nanay characterise the gain's source only negatively, as not stimulus-triggered.

Two cautions temper the fit. Amplification is continuous and graded: winner-take-all competition still issues in discrete outcomes, but a smoothly varying gain names no privileged juncture at which quantum-level influence would enter—a specification the [[interface-specification-programme|interface-specification programme]] owes rather than discharges. And whether consciousness contributes to setting the gain is precisely what the precision-weighting reading below—amplification's close kin—denies; Fazekas and Nanay's sub-personal account is silent between the readings. Their challenge renames the Map's mechanism rather than removing it, at the honest price that "selection" names what consciousness does with the amplified field, not what the attentional machinery itself does.

## The Economics of Agency

If consciousness acts through attention, and conscious behavioral throughput is limited to roughly 10 bits per second, then agency is fundamentally an [[attentional-economics|economic problem]]. Every act of attention is simultaneously an act of exclusion; freedom becomes a resource to be allocated rather than a binary capacity.

The economic framing relocates moral responsibility from the moment of decision—where traditional accounts focus—to the earlier cultivation or neglect of attentional capacity. A person who has trained their attention through contemplative practice can sustain selection longer, resist distraction more effectively, and notice options that untrained attention would miss.

The attentional economy has a structural limit beyond bandwidth: *habituation*. Sufficiently familiar experiences—the kitchen you navigate expertly without attending to it—drop out of phenomenal awareness while remaining functionally processed, contracting the scope of conscious influence: what has left awareness can no longer be the target of attentional selection. The meditator practicing "beginner's mind" is learning to *de-habituate*—to restore the familiar to the phenomenal field and expand the options available for attentional investment.

The witness mode—observing without selecting—is a distinct economic regime: contemplatives who enter [[witness-consciousness|witness consciousness]] exercise meta-agency, choosing to refrain from selection.

## Disorders as Component Failures

Clinical evidence shows what happens when specific parts of the interface break: [[attention-and-the-consciousness-interface|ADHD, attention fatigue, depression, and meditation deficits]] each reveal different components of the attention-selection system.

ADHD primarily impairs willed attention while leaving exogenous and instructed attention relatively intact; stimulant medications recalibrate the dopamine-mediated selection threshold without altering phenomenal experience. The person with ADHD is fully conscious but struggles to direct that consciousness—the interface is compromised, not consciousness itself.

Attention fatigue shows the interface has running costs: sustained selection depletes a resource that recovers with rest—particularly sleep—and motivation can temporarily override fatigue, suggesting rationing rather than absolute exhaustion. Computers don't tire from sustained processing; the biological character of depletion suggests dependence on physical mechanisms.

Depression involves characteristic attentional biases—capture by negative information, dwelling on negative memories, poor disengagement from negative stimuli. From the interface perspective, consciousness operates through a biased interface that preferentially selects negative content.

An epistemological difficulty lurks here: from inside an attention disorder we cannot determine whether consciousness is unchanged behind a degraded interface or is itself altered in ways the degraded interface prevents us from recognising. The void is itself informative, marking the boundary where first-person and third-person investigation both reach their limits.

## The Return Cycle

A single attentional event captures the interface in miniature. [[phenomenology-of-returning-attention|When attention wanders and then returns]]—during meditation, reading, any sustained task—three phases unfold:

**Wandering**: meta-awareness is absent, the default mode network active. You don't know your attention has drifted until it already has.

**Noticing**: a sudden, involuntary recognition—"I was distracted." The salience network activates; noticing happens *to* you.

**Returning**: effortful re-engagement as the dorsal attention network reactivates. This phase is something *you do*—selection that costs effort and feels authored.

The three phases exemplify bidirectional interaction within a single event: the brain wanders on its own (bottom-up), recognition occurs at the interface (salience detection), consciousness re-engages through willed selection (top-down). Contemplative training shortens wandering, softens noticing, and eventually makes returning nearly effortless—the interface is plastic.
...
The Map's engagement is not refutation but [[attention-and-the-consciousness-interface|identifying a step the framework has not earned]]. By the mechanistic standard the materialist programme imposes on rival theories, AST owes the bridge from representational content to ontic status. The standard reply—that *recursive* self-modelling makes the difference—names the architectural feature without delivering the bridge: a chess engine running diagnostics on its own search performs recursive self-modelling without generating any apparent phenomenality. Tallis's claim that illusions presuppose experience presses the question in different vocabulary; AST's reply, that the seeming arises because the schema generates phenomenal-property content, just relocates the foundational debt.
...
What AST gets right is that the brain almost certainly constructs models of its own attentional processes. These models explain access consciousness and reportability. The willed-instructed neural distinction adds a constraint the schema framework does not address—the schema tracks attention regardless of initiation source—and [[witness-consciousness|witness consciousness]] poses awareness apparently without attentional engagement, though AST can rejoin that practice may deepen the schema's apparent fundamentality. The phenomenal/access gap remains, and AST's central identification stipulates rather than discharges it.

## How a Sophisticated Rival Reads the Same Evidence

A sophisticated materialist need not dispute any of the evidence above—the dissociations, the COGITATE null, the willed-mode markers, the effort phenomenology, the three-layer architecture, the ~10 bit/s throughput—to read it differently. The most developed evidence-reading rival is the **predictive-processing account** (Hohwy, Clark, Friston), on which attention is the precision-weighting of prediction error: the brain raises the gain on sensory channels it expects to be reliable, and "selection" is what high-precision weighting looks like from the inside. Where the Map sees a non-physical subject biasing which option crosses threshold, predictive processing sees a precision parameter set by the generative model itself.

On this reading the same evidence lands as follows. The four-way attention–consciousness dissociation is precision decoupling from access — high-precision processing without global broadcast (attention without consciousness), and broadcast of low-precision content (consciousness without attention) — no ontological distinctness required. The willed-mode markers (frontal theta, frontoparietal coherence) are the signature of endogenous precision-setting under a high-level prior, not of a non-physical contributor. The three-layer architecture maps onto generative-model hierarchy: premotor competition is the option space, dopamine is the precision/gain term, and "conscious selection" is the settling of the inference. The COGITATE null, on this view, tells against *both* Global Workspace Theory and IIT without telling for the Map — an unsettled contest among materialist theories is not evidence for dualism.

Two places are where the readings might come apart, and neither yet delivers a settled discriminator. First, the effort phenomenology. Predictive processing can model effort as the expected cost of reallocating precision, but it inherits the explanatory debt the article presses against illusionism: a precision parameter being reset is a functional event, and the account does not specify why that event should be *felt* as costly by a subject rather than merely registered. The felt-effort/operation dissociations (Naccache, Hagger, Inzlicht) cut against the simplest dualist identity too, so the residue constrains both readings rather than establishing either. Second, a candidate forward claim, weaker on inspection than it first appears. The proposal is that phenomenal effort scales with the entropy of the option set at threshold-crossing, controlling for stimulus discriminability, on the intuition that precision tracks expected reliability, not option-set cardinality. Active inference predicts much the same correlation. Sandved-Smith et al. (2021) model covert attentional control as policy selection over mental actions, and Parr et al. (2023) formalise mental effort as covert mental action in the very Stroop paradigm the effort argument above leans on, where effort scales with how far a task drives beliefs about policies away from their priors — a quantity that rises as the option set grows more contested. A variable named entropy is not thereby a dualist discriminator: the test bites only if the two accounts predict different functional forms, and none has been derived. The discriminator is provisional, and that is a debt on the interface hypothesis rather than a measurement awaiting a laboratory. The disagreement with the strongest evidence-reading rival is therefore closer to bedrock than the dissociation evidence alone suggests. Naming that rival reading here is the [[evidential-status-discipline|evidential-status discipline]] at work, and the [[common-cause-null|common-cause null]]'s caution against counting one body of evidence as several independent confirmations applies in full.

The rival is admitted above in one register only — as an alternative *reading* of the attention evidence. Precision optimisation has a more ambitious form: active inference and the free-energy principle are not a rival gloss on the evidence but a *total* generative framework that natively models the explananda the interface hypothesis reserves for a non-physical subject — agency, attention, effort and interoceptive selfhood alike (Seth's "beast machine"). That framework-level confrontation is not repeated here. [[predictive-processing-and-dualism|The Map's treatment of predictive processing and dualism]] carries it, steelmanning active inference in its own vocabulary and engaging Laukkonen, Friston and Chandaria's (2025) beautiful-loop theory — active inference advanced as a direct theory of consciousness — as the strongest physicalist rival, and concluding that the residue is a framework boundary rather than a refutation in either direction.
...
A second candid limitation concerns falsifiability. Most of the conditions that would close the interface hypothesis—precision weighting explaining all attention phenomena without remainder, many-worlds confirmed, illusionism vindicated—are *borrowed* risks: they describe scenarios in which some rival theory's vindication would close out the space the interface hypothesis occupies, not forward predictions of the interface model itself. The entropy-of-the-option-set claim discussed above was the one attempt at a model-specific forward prediction, and it does not yet discriminate; the framework owes a prediction its strongest rival cannot match before it can claim falsifiability symmetry. Both dualists and physicalists accept the broader empirical commitments; the disagreement is over what the results mean. The Map's contribution is an interpretation that takes the cumulative pattern seriously as evidence for non-physical causation—a reading that strengthens or weakens with each empirical finding, even if no single finding is decisive.

## Relation to Site Perspective

**[[tenets#^dualism|Dualism]]**: The dissociation between attention and consciousness is consistent with their ontological distinctness—though physicalists can read the same evidence as mapping distinct neural circuits. The Map's reading gains force because one side of the dissociation involves the hard problem: phenomenal experience resists the third-person characterisation that resolves other double dissociations. AST's unearned step from representational content to ontic status leaves that irreducibility standing.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: The attention interface is where the Map locates mind-matter interaction. The quantum Zeno mechanism is one proposed way this might work, though it faces unresolved [[decoherence|decoherence objections]] and owes an argument for its stabilising direction ([[sign-problem-for-conscious-observation]]). Whatever the mechanism, the ~10 bits/second conscious behavioral throughput fits an interface limiting conscious intervention to the smallest influence compatible with genuine causal efficacy. Conservation laws are preserved because the energy for any selected action comes from ordinary metabolic processes. That answers the energy worry, not [[causal-exclusion-argument|Kim's exclusion worry]], which is about causal redundancy given a sufficient physical cause rather than where the joules originate. The Map's reply denies that sufficiency at the quantum joint, where [[causal-closure|closure]] holds only probabilistically—fixing the statistics but not which outcome actualises, so nothing sufficient is there for selection to be redundant to.
...
1. Fazekas, P. & Nanay, B. (2021). Attention is amplification, not selection. *The British Journal for the Philosophy of Science*, 72(1), 299-324. https://doi.org/10.1093/bjps/axy065
