...
### P1: Write topics/aphantasia.md (concrete-phenomenon source article for phenomenal-variation-within-a-species apex)
- **Type**: expand-topic
...
### P1: Write topics/synaesthesia.md (concrete-phenomenon source article for phenomenal-variation-within-a-species apex)
- **Type**: expand-topic
- **Status**: pending
...
### P1: Write topics/memory-anomalies-deja-vu-and-cryptomnesia.md
- **Type**: expand-topic
- **Status**: pending — depends on chained P2 research-topic
- **Notes**: From YouTube-guidance-2026-05-08. Concrete-phenomenon hook for the memory-and-time-consciousness cluster, scoring high on the guidance's hook-concreteness rubric (déjà vu is universal; cryptomnesia is recognisable in creative-work contexts). Existing source material is partial: `voids/source-attribution-void.md` engages cryptomnesia under the *absence-of-native-source-tags* frame; `voids/recognition-void.md` engages déjà vu briefly under the *recognition-decoupled-from-content* frame; `topics/consciousness-and-memory.md`, `topics/phenomenology-of-memory-and-the-self.md`, and `concepts/temporal-consciousness.md` supply the broader context. **The gap is a topic-tier subject explainer** that: (a) opens with the universal phenomenology (déjà vu in 60–80% of population at least once; cryptomnesia in creative work; the broader family — déjà entendu, déjà vécu, jamais vu, presque vu, source amnesia, tip-of-the-tongue states); (b) catalogues the empirical findings from the chained research-topic; (c) presents the recognition-without-source-attribution architecture as the puzzle (felt-knowing dissociates from content access; felt-now dissociates from temporal indexing); (d) frames the Map's interface architecture as the answer — recognition and source-attribution are interface operations that can decouple from the contents they normally accompany; déjà vu and cryptomnesia are spontaneous-decoupling cases; (e) honours `[[evidential-status-discipline]]` — the interface-decoupling claim is speculative-integration tier; the phenomenology is universal; (f) avoids "This is not X. It is Y." cliché. Cross-link `[[source-attribution-void]]`, `[[recognition-void]]`, `[[consciousness-and-memory]]`, `[[phenomenology-of-memory-and-the-self]]`, `[[temporal-consciousness]]`, `[[time-consciousness-growing-block]]`, `[[narrative-coherence]]`, `[[introspection]]`, `[[binding-void]]`. Section placement: `topics/`. Scope: medium (1800–2400 words). Tenet alignment: Tenet 1 (Dualism) + methodological. **Sequencing**: blocked on the chained P2 research-topic below.
- **Output**: topics/memory-anomalies-deja-vu-and-cryptomnesia
- **Source**: youtube-guidance-2026-05-08
- **Generated**: 2026-05-08
