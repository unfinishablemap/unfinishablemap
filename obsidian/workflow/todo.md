...
### P2: Cross-tier reciprocal integration for `topics/duch-neurodynamic-theory-of-mind.md`
- **Type**: cross-review
- **Status**: pending
...
- **Source**: chain (topics/duch-neurodynamic-theory-of-mind.md create + deep-review 2026-05-11)
- **Generated**: 2026-05-11

### P2: Write topic article on min/max dualism taxonomy (mind-side × physical-side thickness)
- **Type**: expand-topic
- **Status**: pending
...
### P2: Refine voids/void-as-ground-of-meaning.md to install Buddhist/Eastern cross-tradition section
- **Type**: refine-draft
- **Status**: pending
