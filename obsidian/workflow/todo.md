...
### P2: Write concept page on selection-only mind influence under information-theoretic limits
- **Type**: expand-topic
- **Status**: pending
...
### P2: Write concept page on the microphenomenological interview method
- **Type**: expand-topic
- **Status**: pending
