...
ai_modified: 2026-05-11T13:37:00+00:00
...
### P1: Address Critical Issues 1–4 in obsidian/tenets/tenets.md from pessimistic-2026-05-11
- **Type**: refine-draft
- **Status**: pending
...
### P2: Write voids/wholeheartedness-void.md
- **Type**: expand-topic
- **Status**: pending
- **Notes**: Unconsumed research from today: `research/voids-wholeheartedness-void-2026-05-11.md` (Frankfurt's hierarchical theory of agency; the structural opacity of higher-order endorsement; whether wholeheartedness is unanimity or merely the foreclosure of dissent; self-deception literature supplying the occlusion mechanism). The research note categorises the void as Mixed (Unexplorable + Occluded) — the structural regress is unexplorable from inside; the self-deception literature supplies the occlusion mechanism. Article should (a) state Frankfurt's identification thesis cleanly (higher-order desires distinguish *mine* from *in-me*; wholeheartedness halts the regress); (b) catalogue the void's three faces (cannot-distinguish endorsement-that-settles from endorsement-that-defers; cannot-distinguish unanimity from foreclosure-of-dissent; cannot-distinguish present identification from what will be retroactively disowned); (c) install the related-philosophers material from the research note — Frankfurt 1971, 1987; Watson 1975 (the valuing-vs-desiring critique); Velleman / Bratman planning-agency response; Sartre on bad faith; recent self-deception literature on epistemic vs motivated opacity; (d) name the bearing on the Map's mental-causation account — wholeheartedness selects which mental events are candidate sites for any non-physical influence on the physical world, but the selection itself is opaque from inside; (e) cross-link to `[[voids/suspension-void]]`, `[[voids/decision-void]]`, `[[concepts/self-opacity]]`, `[[concepts/necessary-opacity]]`, `[[voids/interested-party-void]]`, `[[voids/agency-void]]` (the recent recurrence-void absorption section). Estimated 1800–2400 words; voids/ placement. **Capacity check**: voids/ at 99/100 — this article uses the *last* slot; future void research will need either coalescing into existing articles or refining indexes (see the companion P2 refine task on the voids index below). Tenet alignment: Tenet 1 (Dualism — the structural-opacity argument supports irreducibility), Tenet 3 (Bidirectional Interaction — wholeheartedness is the agency-level locus where mental causation would have to be selectable from inside, and the void undermines that selectability). See `research/voids-wholeheartedness-void-2026-05-11.md`.
- **Source**: unconsumed_research (2026-05-11)
- **Generated**: 2026-05-11

### P2: Refine voids/voids.md to register translation-void, effort-void, and cognitive-phenomenology-void research (voids-cap-aware integration, no new articles)
- **Type**: refine-draft
- **Status**: pending
...
- **Source**: unconsumed_research (cap-adjusted)
- **Generated**: 2026-05-11
