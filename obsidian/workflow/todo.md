...
- **Type**: refine-draft
- **Status**: pending
- **Notes**: From convergent outer reviews (2026-05-11, 2/3 reviewers): [chatgpt-5-5-pro, claude-opus-4-7]. Claude (§4.5) flagged this as "the cleanest internal tension I found"; ChatGPT (§3.5) independently raised the same defect in the Many-Worlds discussion. Tenet 5 (Occam's Razor Has Limits) says parsimony is unreliable when knowledge is incomplete — invoked correctly to disarm parsimony arguments against dualism ("Dismissing dualism because materialism seems 'simpler' assumes we understand enough to judge simplicity"). But the Tenet 4 No-MWI rationale uses precisely a parsimony argument ("vast ontological proliferation"). The Map cannot consistently say *both*. Both reviewers propose the same defensible move: distinguish *indexical* costs of MWI ("why am I this branch?" — not a parsimony objection) from *ontological multiplicity* costs (a parsimony objection). Only the latter is properly subject to Tenet 5's discount; the indexical objection should be primary. Refine `obsidian/tenets/tenets.md` (No Many Worlds section AND Occam's Razor Has Limits section) to (a) explicitly distinguish the two MWI objections, (b) commit to the indexical objection as primary, (c) acknowledge that the ontological-extravagance subsidiary objection is qualified by Tenet 5 and so weaker than presented, (d) cross-link both sections so the distinction is visible. **Quotes**: Claude — "The defensible move is to argue that *indexical* costs of MWI (the inability to answer 'why am I this branch?') are different in kind from *ontological multiplicity* costs, and only the latter is properly a parsimony concern." ChatGPT — "The Many-Worlds article should explicitly rank its objections: indexical identity should be primary; ontological proliferation should be secondary and defeasible." Apply [[direct-refutation-discipline]] — Mode One (in-framework defect) since the tension is internal. Keep mode labels editor-internal. ~300–400 words touched. Tenet alignment: Tenet 4 ↔ Tenet 5 internal consistency. **Sequencing**: this task converges with the existing merged P1 on `/arguments/many-worlds-argument/` (2026-05-10 Claude + Gemini, MMI + Saunders-Wallace + Tappenden + Vaidman + Sebens-Carroll); execute the tenets-page fix here, then ensure the arguments-page refine reflects the same distinction. Both 2026-05-11 reviewers' No-MWI-treated-as-bedrock concern (Claude §3.7, ChatGPT §3.4) is absorbed by the same prior P1 task — no new task needed for that finding; this Occam-asymmetry task is its actionable expression for this cycle.
- **Review files**: `reviews/outer-review-2026-05-11-claude-opus-4-7.md`, `reviews/outer-review-2026-05-11-chatgpt-5-5-pro.md`
...
### P1: Voids catalogue evidential discount — circularity / common-cause-null across taxonomy, surplus, and convergence pages
- **Type**: refine-draft
- **Status**: pending
