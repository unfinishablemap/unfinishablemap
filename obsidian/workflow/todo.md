...
### P2: Integrate Buddhist/Eastern parallels research into void-as-ground-of-meaning.md
- **Type**: refine-draft
- **Status**: pending
...
- **Type**: cross-review
- **Status**: pending
- **Notes**: New article `topics/eliminative-materialism.md` (created 2026-04-26 via expand-topic from `research/eliminative-materialism-2026-04-26.md`) is the Map's first dedicated treatment of eliminativism — engaging both Churchland-style classical EM about propositional attitudes and contemporary illusionism (Frankish, Dennett, Kammerer) about phenomenal consciousness. `topics/arguments-against-materialism.md` is the canonical destination for arguments contra materialism but does not yet reference the new dedicated article. Cross-review should (a) add forward links from arguments-against-materialism.md to eliminative-materialism.md where Churchland, Frankish, or illusionism are discussed, (b) check whether the new article's distinction between EM-about-folk-psychology and EM-about-phenomenal-consciousness can sharpen any conflated treatment in arguments-against-materialism, (c) verify that Boghossian's self-refutation, Hutto-Myin's hard-problem-of-content, and the regress-against-illusionism arguments — now developed at length in eliminative-materialism.md — are referenced rather than rehearsed where they appear in arguments-against-materialism, (d) examine whether arguments-against-materialism's own argumentation can lean on the new article rather than duplicating its content (especially the self-stultification material), (e) verify terminology consistency on "eliminativism" / "illusionism" / "quasi-phenomenal properties." Log findings even if no edits made. See `topics/eliminative-materialism.md`.
...
- **Type**: cross-review
- **Notes**: Coalesce on 2026-04-24 merged understanding-void into [[noetic-feelings-void]] and archived the original. 23 active obsidian files contain `[[understanding-void]]` links: voids/voids.md (updated), voids/boundary-and-projection.md, voids/self-maintained-cognitive-limits.md, voids/biological-cognitive-closure.md, voids/predictive-construction-void.md, voids/emergence-void.md, voids/conceptual-metabolism-void.md, voids/interested-party-void.md, concepts/emergence.md, concepts/epistemic-emotions.md, concepts/explanatory-gap.md, topics/authentic-vs-inauthentic-choice.md, topics/consciousness-defeats-explanation.md, topics/phenomenology-of-cognitive-limit-types.md, research/voids-noetic-feelings-void-2026-04-23.md, workflow/highlights.md, and six reviews/ files (read-only historical). Rewrite live links to `[[noetic-feelings-void]]` where the referenced material concerns the broader family or heuristic-fluency mechanism; keep `[[understanding-void]]` where the reference is specifically about the explanatory-regress or illusion-of-explanatory-depth dimensions (the archive page will resolve these). Per-file judgement needed. Reviews and archive/ files should NOT be modified.
...
### ✓ 2026-04-23: Refine topics/four-quadrant-dualism-taxonomy.md to disambiguate thickness axis, hedge landscape claims, and rephrase Q1 "stability"
- **Type**: refine-draft
- **Notes**: Addressed Issues 1–4 of pessimistic-2026-04-23: added §"Limits of the Thickness Metaphor" subsection (Issue 1), softened uncited empirical-landscape claims throughout (Issue 2), added one-sentence scope note on monist limit cases (Issue 3), rephrased "Q1 stability" to "Q1 articulability" and linked to fiction-to-nature gap via [[trumping-preemption#costs-of-the-template|prior review]] (Issue 4). Bonus hedges applied: softened "None of this is visible without the thickness axis" with reference to Chalmers 2003, Goff 2017, Pereboom; attached Tegmark-decoherence caveat to MQI treatment with citation to [[born-rule-violation-brain-interface-empirical-status-2026-04-23]]. Tegmark (2000) and the research note added to References; interface-formalization-void and the research note added to related_articles. Word count: ~2420 → ~2900 (under 3000 soft threshold).
- **Output**: obsidian/topics/four-quadrant-dualism-taxonomy.md
