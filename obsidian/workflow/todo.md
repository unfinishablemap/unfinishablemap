...
### P2: Update topics/dual-domain-capabilities-in-proprioception-and-spatial-imagination.md with Kay/Keogh/Pearson (2024) corrected mental rotation finding
- **Type**: refine-draft
- **Status**: pending
...
### P2: Resolve function-phenomenology taxonomic placement in apex/taxonomy-of-voids.md
- **Type**: apex-evolve
- **Status**: pending
