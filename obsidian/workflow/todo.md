...
ai_modified: 2026-04-27 14:12:00+00:00
...
### P2: Address pessimistic-2026-04-27c issues in interoceptive-void.md (symmetric-prediction, Damasio dialectic, elasticity vs structural, four-faces heterogeneity)
- **Type**: refine-draft
...
### P2: Write article on Min/Max Dualism Taxonomy (mind-side × physical-side thickness)
- **Type**: expand-topic
- **Notes**: Research completed in `research/min-max-dualism-taxonomy-2026-04-21.md` (2026-04-21) and never synthesised into an article. The note develops a two-axis taxonomy of dualist and dualist-adjacent positions by mind-side ontological thickness (bare experience vs rich subliminal mind) and physical-side ontological thickness (lean physics vs hidden variables / intrinsic natures). The taxonomy is referenced by min-max framing across the apex pragmatist-quantum and falsification-roadmap clusters but the standalone treatment does not exist on the site. Article would (a) define the two axes precisely, (b) catalogue named positions across the four-quadrant grid (Cartesian dualism, property dualism, panpsychism, neutral monism, Russellian monism, the Map's own position), (c) supply the dialectical use the Map needs — show what the Map can borrow from each quadrant without committing to its full programme, (d) connect to the structural-alliance methodology already in the queue (P3 apex), (e) honest limitation: taxonomy can blur live disagreements when categories are drawn too coarsely. Medium scope (2200-2800 words). Target section: topics/ (~231/250) or concepts/ (~230/250) — pick based on whether the framing emphasises position-cataloguing (topics) or apparatus-naming (concepts). Tenet alignment: Dualism (the taxonomy is precisely about dualist position-space), Occam's Razor Has Limits (the taxonomy resists collapse into either monism by showing the structural cost of each move).
- **Source**: unconsumed_research
- **Generated**: 2026-04-27

### P2: Cross-review interoceptive-void.md sister articles for inbound links
- **Type**: cross-review
...
- **Source**: chain (from expand-topic of interoceptive-void.md)
- **Generated**: 2026-04-27

### P2: Address remaining pessimistic-2026-04-27b issues in agency-void.md (compound→conjoin, functional necessity, self-application, intervention layer, frontmatter)
- **Type**: refine-draft
...
### P2: Refine concepts/agent-causation.md to acknowledge the verification-circularity limit
- **Type**: refine-draft
