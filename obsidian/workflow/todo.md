...
### P2: Write topic article on Source-Attribution Divergence
- **Type**: expand-topic
- **Status**: pending
...
- **Source**: optimistic-review (chain from optimistic-2026-05-08, reaffirmed by optimistic-2026-05-09)
...
### P2: Refine concepts/evidential-status-discipline.md to absorb the constrain-vs-establish distinction
- **Type**: refine-draft
- **Status**: pending
...
### P2: Write apex synthesis on the phenomenal-output / causal-machinery dissociation cluster (expanded source roster)
- **Type**: apex-evolve
- **Status**: pending
...
- **Source**: optimistic-review (chain from optimistic-2026-04-29d, reprioritised by optimistic-2026-05-09)
- **Generated**: 2026-04-29 (promoted 2026-05-09)
