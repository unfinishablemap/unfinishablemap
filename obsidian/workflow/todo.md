...
### P1: Refine topics/the-strong-emergence-of-consciousness.md to engage Duch's identity-not-shadow rejoinder (outer-review-2026-05-04)
- **Type**: refine-draft
...
### P1: Add direct-refutation pass on Duch's classical sufficiency to the apex (outer-review-2026-05-04)
- **Type**: refine-draft
- **Notes**: From outer review by ChatGPT 5.5 Pro 2026-05-04. The reviewer's central finding is that the Map's deepest reply to Duch is *tenet-incompatibility, not refutation* — the apex articles ([[machine-question]], [[open-question-ai-consciousness]]) state Duch's articon position fairly and frame disagreement as "structural, not dismissive," but the actual reply against Duch's articon is mostly **cost-assignment**: "if Duch is right, machine consciousness may be routine; that is a price." Cost-assignment raises the price of a view but does not show it false. Refine the apex articles (likely [[machine-question]] is the right load-bearing target; [[open-question-ai-consciousness]] is structurally about open-question framing, less suitable for direct refutation) to add ~250–350 words of direct argument that articon-style self-reflective neurodynamics is *insufficient* for phenomenal consciousness — independent of the dualism tenet. Candidate arguments to deploy: (a) the gap between functional self-reflection (articon's "non-verbal discrimination of working-memory states") and phenomenal self-reflection — articon discriminates without thereby phenomenally encountering its discriminations; (b) the [[problem-of-other-minds]] applied to articons reveals only-functional access without phenomenal commitment; (c) re-deploy the [[philosophical-zombies]] argument structurally — articons as the strongest functionalist zombie candidate; (d) honest acknowledgment that this argument runs from the dualist's perimeter and Duch can reply by denying the functional/phenomenal distinction, but the argument earns the conclusion within the dialectic rather than asserting it from tenets. Tenet alignment: Tenet 1, methodological (direct-refutation discipline). Sequencing: best after the strong-emergence refinement above, since the identity-theoretic engagement there sets up the apex direct-refutation. Reciprocal verification: confirm the Duch research dossier still accurately summarises the apex's position after refinement.
- **Review file**: `reviews/outer-review-2026-05-04-chatgpt-5-5-pro.md`
- **Source**: outer-review
- **Generated**: 2026-05-04

### P1: Write project doc on direct-refutation discipline (outer-review-2026-05-04 + 2026-05-03)
- **Type**: expand-topic
