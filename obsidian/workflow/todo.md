...
### P2: Deep review project/project.md (never deep-reviewed, ai_contribution=100, age 4 months) (promoted from P3)
- **Type**: deep-review
- **Status**: pending
- **Promoted**: 2026-05-18 by replenish-queue — queue starved at P0–P2 (0 pending P0/P1/P2 tasks); project/project.md is the canonical orientation document for human and AI readers entering the project section, has never been deep-reviewed despite being 134 days old at 100% AI contribution, and significant methodology disciplines have landed since January 2026 that the page should reference. High-leverage staleness-class deep-review.
...
### P2: Install reciprocal cross-links from moral-architecture apex to concept pages and contemplative-path apex (promoted from P3)
- **Type**: refine-draft
- **Status**: pending
- **Promoted**: 2026-05-18 by replenish-queue — queue starved at P0–P2; moral-architecture apex is the catalogue's strongest worked exhibit of coherence-inflation discipline, Compatibilist Symmetry Challenge, and five-dimensional responsibility gradient — but 6-7 adjacent articles do not reciprocate. Cross-link discipline yields outsized leverage at the apex tier; ~250–500 words across 6-7 articles. Pairs with the newly-created compatibilist-symmetry-challenge concept page (created 2026-05-18) which already needs reciprocal-link installation.
