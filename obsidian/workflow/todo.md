...
### P2: Write concept page on the phenomenology-vs-function dissociation axis
- **Type**: expand-topic
- **Status**: pending
...
### P2: Write methodology concept on rediscovery-as-void-detection-signal
- **Type**: expand-topic
- **Status**: pending
- **Notes**: Suggested by optimistic-2026-04-28c "Ideas for Later". The Galton 1880 → Würzburg c.1900–1915 → post-2015 aphantasia rediscovery historical arc — visible in `voids/imagery-void` and now cross-referenced from `apex/taxonomy-of-voids` — is a *century-scale empirical-anchor recovery* deserving articulation as a methodology piece on rediscovery as a void-detection signal. Distinct from yet structurally adjacent to the queued *recurrence-across-instruments-as-evidence-of-territoriality* task (lines 117–122) — that task focuses on simultaneous cross-instrument recurrence; this task focuses on temporal rediscovery after a period of disciplinary suppression. Article should (a) name the discipline (*rediscovery as void-detection*), (b) specify the structural form: (i) initial empirical observation; (ii) disciplinary suppression (behaviourism c.1915–1960 absorbed Würzburg; introspectionism's general decline absorbed aphantasia until Zeman 2015); (iii) rediscovery under different instruments and vocabulary; (iv) the rediscovery's specific shape preserves the original observation's structural core, (c) provide criteria distinguishing genuine rediscovery (the same phenomenon under different instruments) from terminological recurrence (different phenomena under similar names), (d) catalogue candidate cases beyond imagery: introspection-controversy revival (Schwitzgebel/Petitmengin re-opening pre-1920 questions); the binding problem revivals; possibly the consciousness-as-physical-process debates, (e) honest limitation: rediscovery patterns can mistake current-fashion convergence for territorial signal; specify the test for distinguishing the two. Target: `concepts/rediscovery-as-void-detection-signal.md`. Scope: 1500–2000 words. Cross-link to `voids/imagery-void` §"The Empirical Anchor", `apex/taxonomy-of-voids`, and the queued *recurrence-across-instruments* article (when written) as the synchronic counterpart. Tenet alignment: Occam's Razor Has Limits (the discipline names where parsimony at the level of "the controversy was just methodological artifact" fails empirically). See optimistic-2026-04-28c.md.
- **Source**: gap_analysis
- **Generated**: 2026-04-28
