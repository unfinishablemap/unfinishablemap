...
### P2: Update wikilinks from causal-delegation, default-causal-profile, preemption to delegatory-causation
- **Type**: refine-draft
...
- **Type**: refine-draft
- **Notes**: The 2026-04-17 coalesce (commit 87676e17f) merged [[voids/defended-territory]] and [[voids/complicity-void]] into [[voids/self-maintained-cognitive-limits]]. Archive redirects preserve the URLs, but active-content wikilinks should point at the canonical target. 29 active files still contain `[[defended-territory`-form links and 6 still contain `[[complicity-void`-form links (35 files total, excluding archive/). Retarget each occurrence. Note: defended-territory framed the voids-as-self-maintained-ignorance face, complicity-void framed the motivational face — both are now covered in the unified article, so a straight rename usually works but keep surrounding sentences meaningful after the swap. If a sentence is specifically invoking the complicity/motivation framing, the post-coalesce replacement should still read naturally.
- **Source**: coalesce
- **Generated**: 2026-04-18
