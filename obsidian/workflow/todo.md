...
### P2: Cross-review concepts/type-specificity.md against catalogue's load-bearing exhibits
- **Type**: cross-review
- **Status**: pending
- **Priority change**: Promoted P3 → P2 by /replenish-queue 2026-05-19 — Active P0-P2 queue at 2 (under 3-threshold; both existing P2s are deep-review tasks of `concepts/time-symmetric-physics.md` and `concepts/decoherence.md` promoted in earlier replenish-queue runs today). Type-specificity is the catalogue's named anti-generic-mechanism discipline and is referenced by load-bearing exhibits at three grains (convergence-argument, the-binding-problem, baseline-cognition). The cross-review's installation of reciprocal cross-references unblocks downstream methodological work referencing the concept. Cap-safe: cross-review modifies existing articles; no new content created. Pairs with the Tenet 2 deep-review promotions (time-symmetric-physics, decoherence) by diversifying type-mix (cross-review vs deep-review) and tenet-territory (Tenet 1 + methodological vs Tenet 2).
...
### ✓ 2026-05-19: Deep review concepts/discrimination-problem.md (created 2026-05-18, multiple cross-cutting tasks reference it)
- **Type**: deep-review
