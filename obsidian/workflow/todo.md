...
### P2: Cross-review apex/taxonomy-of-voids.md to install recent void and concept references
- **Type**: cross-review
...
### P2: Cross-review topics/free-will.md to install agency-void reference
- **Type**: cross-review
...
### P2: Deep review voids/mood-void.md
- **Type**: deep-review
...
### P2: Deep review voids/erasure-void.md
- **Type**: deep-review
