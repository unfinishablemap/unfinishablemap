...
### P1: Address pessimistic-2026-04-23 critical issues in four-quadrant-dualism-taxonomy.md
- **Type**: refine-draft
...
### P2: Cross-review born-rule-and-the-consciousness-interface.md considering born-rule-violation-brain-interface-empirical-status insights
- **Type**: cross-review
- **Notes**: New article `topics/born-rule-violation-brain-interface-empirical-status.md` (created 2026-04-23) maps the Map's canonical three-way taxonomy (corridor / minimum-outside-corridor / trumping) onto consciousness-physics proposals and specifies the current experimental landscape (Bösch 2006 / Maier-Dechamps 2018 micro-PK null trends, Sinha 2010 Sorkin-parameter bounds, Kerskens-Pérez 2022 brain-coherence result, Babcock-Hameroff 2025 microtubule vibrations, Chalmers-McQueen 2022 CCC proposals, Penrose-Hameroff Orch-OR lines). The parent theoretical article `born-rule-and-the-consciousness-interface.md` predates the new taxonomy's canonical statement. Cross-review should (a) add inbound links to the empirical-status article where corridor / outside-corridor positions are first introduced, (b) check whether the article's own framing of "Born-rule violation" aligns with the three-way taxonomy or needs adjustment (corridor-preserving positions do not violate Born; outside-corridor and trumping positions violate or bypass it in distinct ways), (c) verify terminology consistency (the new article uses "minimum-outside-the-corridor" and "trumping" as canonical labels), (d) identify places where the empirical programme catalogue could strengthen the parent article's arguments without overlap. Log findings even if no edits made.
