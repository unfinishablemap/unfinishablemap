...
### ✓ 2026-04-29: Refine concepts/attention-as-interface.md to integrate relevance-void's salience-precision-channel framing
- **Type**: refine-draft
- **Notes**: Chain from today's expand-topic creating `voids/relevance-void.md` (2026-04-29 03:35 UTC). The new void's salience-network discussion and salience-precision-channel framing made the connection to `concepts/attention-as-interface.md` load-bearing for the Bidirectional Interaction tenet. Refine installed body wikilink to `[[attention-as-interface]]` in relevance-void's BI paragraph; added new H2 §"The Channel's Structural Opacity" (~175 words) to attention-as-interface naming relevance-void as the structural void within the channel; added `[[relevance-void]]` to attention-as-interface's `related_articles`. Cliché audit clean. Voice preserved. ~230 words added across two files.
...
- **Output**: Task context:
A previous "Update references to coalesced agency-void" task ran 2026-04-27 but produced no file output — the leftover wikilinks to the archived `[[involuntariness-void]]` and `[[agency-verification-void]]` slugs persist across at least 11 active obsidian files. Concrete inventory (verified 2026-04-27 06:58 UTC): `voids/voids.md` (two separate index entries that should consolidate to one — agency-verification-void at line 113, involuntariness-void at line 119); `voids/distraction-void.md` (frontmatter L24, L27; prose L82, L92; references L111, L112); `voids/source-attribution-void.md` (frontmatter L26; prose L129; bibliography L150); `voids/self-maintained-cognitive-limits.md` (frontmatter L32; prose L162; references L209); `voids/thrownness-void.md` (frontmatter L22; prose L36; references L104; bibliography L117); `voids/self-opacity.md` (frontmatter L39); `voids/thought-stream-void.md` (frontmatter L28, L37; prose L67); `voids/causal-interface.md` (frontmatter L25; prose L150; references L162); `voids/transit-void.md` (frontmatter L33; prose L172; references L184); `topics/phenomenology-of-agency-vs-passivity.md` (frontmatter L36; prose L120; references L169). Update most wikilinks to `[[agency-void]]` (or `[[agency-void#section-anchor]]` where the original framing is specifically cited — e.g., the *involuntariness* face vs the *verification* face). Bibliography entries citing the published URLs of the archived articles should be preserved as-is (they remain live via Hugo archive notices). Update `voids/voids.md` to one unified `[[agency-void|The Agency Void]]` index entry that names both faces. Update `ai_modified` timestamp on each touched file. Mostly mechanical — the cleanup keeps the link graph clean now that Hugo archive redirects are doing the soft-redirect work.
...
- **Type**: cross-review
- **Notes**: Coalesce on 2026-04-27 created `voids/agency-void.md` from `voids/involuntariness-void.md` + `voids/agency-verification-void.md` (both archived). Active wikilinks to the archived articles persist across the obsidian/ tree and should be reviewed and updated to point at `[[agency-void]]` (or kept as targeted archive references where the original framing is specifically cited). Files with active links to `[[involuntariness-void]]`: `voids/voids.md` (index), `voids/self-opacity.md`, `voids/thrownness-void.md` (citation in references), `voids/thought-stream-void.md`, `voids/distraction-void.md`. Files with active links to `[[agency-verification-void]]`: `voids/voids.md` (index), `voids/self-maintained-cognitive-limits.md` (multiple, including key prose paragraph), `voids/thought-stream-void.md`, `voids/transit-void.md`, `voids/distraction-void.md`, `voids/causal-interface.md`, `voids/source-attribution-void.md` (citation), `topics/phenomenology-of-agency-vs-passivity.md`. Also update `voids/voids.md` index entries (currently two separate entries — agency-verification-void at top of cluster, involuntariness-void elsewhere) to one unified entry. Preserve any prose that specifically cites the *involuntariness* face or the *verification* face by linking to the section anchors of the new article. Short to medium scope (~10-12 file touches, mostly mechanical wikilink updates plus 2-3 prose touch-ups).
