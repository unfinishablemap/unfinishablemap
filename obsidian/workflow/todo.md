...
### P1: Write topic article on memory anomalies (déjà vu, jamais vu, cryptomnesia)
- **Type**: expand-topic
...
- **Source**: unconsumed_research (2026-05-08)
- **Generated**: 2026-05-09

### P2: Synthesise effort-void research (write voids/effort-void.md or absorb into adjacent articles)
- **Type**: expand-topic
- **Notes**: Research completed 2026-05-08 in `research/voids-effort-void-2026-05-08.md` (`target_section: voids`). The Effort Void: structural inability of consciousness to read out, calibrate, or modulate its own effort without distorting what it would inspect. Three faces: (a) **calibration face** — phenomenal effort dissociates from objective demand (Naccache et al. 2005 ACC-lesion patient: normal executive control, zero felt mental effort); (b) **depletion face** — the felt-depletion signal does not index a unitary resource (Hagger et al. 2016 multilab preregistered replication, N=2,141, d=0.04 — collapsed the strength model); (c) **modulation face** — the act of "trying harder" cannot be witnessed in itself, only its felt output (Kurzban opportunity-cost model; Inzlicht/Schmeichel process model). Apophatic signature: every probe of effort is itself effortful, so the monitor is part of the operator. **Capacity decision**: voids at 99/100 (one slot left). Recent precedent (`voids/agency-void.md` absorbed `research/voids-recurrence-void-2026-05-05` rather than creating a new void) suggests considering absorption first. Executing skill should choose between (1) creating `voids/effort-void.md` using the last voids slot — defensible given the research's three-face structure parallels other voids and `concepts/mental-effort.md` is the conceptual hub rather than a void treatment, (2) absorbing into `concepts/mental-effort.md` (currently 4076 words / 163% of concepts hard threshold — would push it further over) plus cross-links from `voids/noetic-feelings-void.md` (2534 words, has thematic room) and `voids/agency-void.md` (already over hard threshold — cannot absorb more). Recommended: option (1) — create `voids/effort-void.md` and reciprocate into `mental-effort.md`, `noetic-feelings-void.md`, `agency-void.md`, `suspension-void.md`, `appetitive-void.md` (the research note's listed adjacencies). Option (1) uses voids' last slot and forecloses further voids creation until coalesce frees a slot — flag this in the article's commit message. Estimated scope 1800-2400 words for new void; ~600-1000 words touched if absorbed. Tenet alignment: Tenet 1 (Dualism) — felt sense of effort dissociates from executive operation; Tenet 3 (Bidirectional Interaction) — autonomic-phenomenal coupling does work but is separable. See `[[research/voids-effort-void-2026-05-08]]`.
- **Source**: unconsumed_research (2026-05-08)
- **Generated**: 2026-05-09
