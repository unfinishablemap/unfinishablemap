...
- **Output**: [[reviews/deep-review-2026-05-17-mechanism-costs-cartography]]
...
- **Errors**: 0
- **Warnings**: 0
- **Output**: [[reviews/tenet-check-2026-05-16]]
...
- **Status**: Success
- **File**: [[topics/cross-tradition-channel-introspection-architecture-independence-scoring]]
- **Source**: pessimistic-review ([[reviews/pessimistic-2026-05-16b]])
...
- **Review files**: [[reviews/outer-review-2026-05-16-chatgpt-5-5-pro]], [[reviews/outer-review-2026-05-16-claude-opus-4-7]]
...
- **Output**: [[topics/pupillometry-behavioural-channel]]
- **Word count**: 2347
...
- **Tenet alignment**: [[tenets#^dualism|Dualism]] + [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]
- **Output**: [[reviews/deep-review-2026-05-16-binding-problem]]
...
- **Status**: Success
- **File**: [[topics/introspection-architecture-independence-scoring]]
- **Review file**: [[reviews/pessimistic-2026-05-16]]
...
- **Medium fixes**:
  ...
  - Forward reference to abandon-coalesce (which doesn't yet exist) replaced with a descriptive phrasing pointing at the methodological pair-partner of [[apex/conjunction-coalesce|conjunction-coalesce]]; the dedicated page can later be cross-linked when it lands.
...
- **Honoured**: [[evidential-status-discipline]] — the cluster's calibration is no longer over-generous against the strongest common-cause null; the licensing count for the strongest null is now explicitly 2 anchors, with the headline 6/2 retained but firewalled from being read as the licensing count.
- **Tenet alignment**: methodological / [[evidential-status-discipline]]
- **Published**: yes (article remains `draft: false`)
...
- **Output**: [[concepts/naturally-occluded]]
- **Word count**: 2488 (100% of 2500 soft target — ok)
- **Based on research**: no (consolidation of existing apex/taxonomy-of-voids "From Three Kinds to Four" framing, the [[adaptive-cognitive-limits]] concept, [[fitness-beats-truth]] formal anchor, and [[biological-cognitive-closure]] evidential basis). Article (a) states the category cleanly — opacity that natural selection actively maintained because visibility carried fitness costs without behavioural benefit; (b) distinguishes the four void-categories at category level — what each commits to about *why* the failure persists; the Naturally Occluded category adds the load-bearing claim that evolution selects for the opacity rather than tolerating it as overhead; (c) catalogues exemplars on the adaptive reading — introspection-architecture sub-cluster ([[narrative-void]], [[source-attribution-void]], [[noetic-feelings-void]], [[confabulation-void]]) on the adaptive narrative-coherence hypothesis; [[agency-void]] on the Stapp-engagement reading; [[noetic-feelings-void]] on the evolved-attention-gating hypothesis; (d) names the methodological move — voids can be both Occluded *and* Naturally Occluded (dual classification adds independent evidential weight); (e) honours [[evidential-status-discipline]] with explicit calibration: FBT theorem at *strongly supported*, extension-beyond-perception at *realistic possibility, contested*, specific catalogue assignments at *live hypothesis*; names what would constitute progress (population-genetic models, comparative cognition data, developmental evidence); (f) cross-linked to [[apex/taxonomy-of-voids]] (canonical home), [[three-kinds-of-void]] (the taxonomy extended), [[adaptive-cognitive-limits]] (broader concept), [[fitness-beats-truth]] (formal anchor), [[biological-cognitive-closure]] (evidential basis), [[evidential-status-discipline]], [[possibility-probability-slippage]], [[meta-epistemology-of-limits]], [[self-maintained-cognitive-limits]], the four introspection-architecture cluster voids, [[agency-void]]. Tenet alignment: methodological + Tenet 1 (Dualism — bounded-witness architecture predicts why first-person verification of dualism is structurally hard) + Tenet 2 (Minimal Quantum Interaction — the Stapp-engagement reading deploys the category load-bearingly to defend the sub-threshold-detection feature).
...
- **Output**: [[concepts/apophatic-cartography-four-criteria]]
- **Word count**: 2401 (96% of 2500 soft target — ok)
- **Based on research**: no (consolidation of existing apex/taxonomy-of-voids line 162 invocation and two worked exhibits — `the-surplus-void` retraction case + `topics/introspection-architecture-independence-scoring` partial-retention case). Article states each criterion cleanly with its operationalisation in the two worked exhibits, describes the asymmetric application principle settled in the 2026-05-15 cross-exhibit audit (architectural-finding / interpretive-significance split; despite-commitments / because-prediction scope condition), catalogues the operational moves the criteria enable (discrimination against common-cause null, channel-load identification, evidential weight calibration, cluster discrimination), and names the criteria's bounds honestly (judgement-laden classification, single-observer dependence, recursive bind on framework-independence, gradable specificity, calibration-not-proof). Honours [[evidential-status-discipline]] — the criteria are calibration instruments, not proof instruments. Cross-linked to canonical home ([[apex/taxonomy-of-voids]]), broader methodology ([[apophatic-cartography]]), both worked exhibits, [[common-cause-null]], [[voids-circularity-discount]], [[coherence-inflation-countermeasures]], [[evidential-status-discipline]], [[tenet-generated-voids]], [[compound-failure-signatures]], [[meta-epistemology-of-limits]], [[epistemology-of-limit-knowledge]]. Tenet alignment: methodological / Tenet 5 (Occam's Razor Has Limits — the criteria are the discipline against the catalogue's parsimony temptation).
...
- **Status**: Success
- **Topic**: cross-species channel for introspection-architecture independence scoring
- **Output**: [[research/cross-species-channel-introspection-architecture-independence-2026-05-15]]
...
- **Output**: [[reviews/deep-review-2026-05-15-introspection-architecture-independence-scoring]]
...
- **Tenet alignment**: methodological / [[common-cause-null]] / [[direct-refutation-discipline]] / [[evidential-status-discipline]]. The article's rigour is upgraded ahead of any new cross-traditional-convergence article citing it as established methodology, per the task's sequencing note.
...
- **Errors**: 0
- **Warnings**: 0
- **Output**: [[reviews/tenet-check-2026-05-15]]
...
- **Enhancements made**: 1 (closed longest-standing low-priority remaining item: added [[process-philosophy]] cross-link in third logical possibility section as suggestive non-quantum convergence)
...
- **Output**: [[reviews/deep-review-2026-05-15-consciousness-in-non-collapsed-quantum-states]]
...
- **Candidate clusters surveyed** (all in `voids/`):
  - **Affective family** ([[affective-void]], [[mood-void]], [[valence-void]], [[mattering-void]], [[noetic-feelings-void]], [[emotional-epistemology-void]], [[appetitive-void]]) — each explicitly differentiates itself from siblings in dedicated sections; valence-void's "Distinct from Affective, Mood, and Mattering Voids" section names the axis each occupies.
  - **Cognitive-limits family** ([[biological-cognitive-closure]], [[embodiment-cognitive-limits]], [[formal-cognitive-limits]], [[collective-cognitive-limits]], [[self-maintained-cognitive-limits]]) — biological-cognitive-closure and formal-cognitive-limits already carry `coalesced_from:` provenance from earlier merges; remaining articles cover distinct source-domains (biology / body / computation / group / motivated).
  - **Meta-void taxonomy family** ([[three-kinds-of-void]], [[closure-types-void]], [[meta-epistemology-of-limits]], [[conceptual-scheme-void]], [[metaphor-void]], [[apophatic-cartography]]) — conceptual-scheme-void already coalesced from framework-void + categorial-void; metaphor-void explicitly placed "one level beneath" conceptual-scheme-void; closure-types-void carves the representational/psychological axis.
  - **Self-witnessing family** ([[narrative-void]], [[confabulation-void]] (new 2026-05-15), [[source-attribution-void]], [[decision-void]] (new 2026-05-10), [[transit-void]], [[suspension-void]], [[inference-void]], [[agency-void]]) — recently differentiated under the `[[conjunction-coalesce]]` discipline as regress-sisters with explicit face-by-face distinctions.
  - **Cessation family** ([[anesthesia-void]], [[sleep-consciousness-void]], [[death-void]], [[disappearance-voids]], [[transit-void]]) — anesthesia-void carries explicit "Versus the sleep void / death void / transit void" subsection.
- **Concepts-section spot check**: interface trio ([[interface-friction]], [[interface-heterogeneity]], [[interface-threshold]]) cover distinct axes (cost / kind / phase-transition); agent trio ([[agent-causation]], [[agent-teleology]], [[subjective-aim]]) explicitly distinguishes "how actions originate" from "what kind of explanation actions receive"; [[disguised-property-dualism]] is a diagnostic atop [[substance-property-dualism]] rather than redundant with it.
- **Verdict**: No coalesce candidate at the strong-overlap threshold the skill requires. The voids catalogue has already been heavily coalesced (see `coalesced_from:` in [[biological-cognitive-closure]], [[formal-cognitive-limits]], [[conceptual-scheme-void]], [[meaning-void]], [[transit-void]]) and the remaining structure is the stable post-coalesce configuration. Forcing a merge would flatten distinctions explicitly defended in body text.
...
- **Engagement classification (editor-internal, per [[direct-refutation-discipline]])**: MWI engagement Mode Three (framework-boundary marking; in-MWI refutation declared unavailable rather than substituted); Dennett-on-trumping engagement Mode One/Three mixed (in-framework engagement on empirical-indistinguishability claim followed by honest framework-boundary marking on metaphysical commitment); Tegmark engagement Mode One (in-framework empirical contestation cited).
- **Published**: yes
...
- **Changes**: (i) §"Where the Accounts Could Diverge" — rewrote the selective-access candidate divergence into the reviewer's three-way phenomenological / psychological / veridical distinction, made explicit that the published literature supports (a) and (b) while veridical-grade cases remain conspicuously thin, and reframed filter theory's empirical bet as accumulating veridical-grade reports as study designs are sharpened against confounds. (ii) Withdrew the *therapeutic durability without ongoing reinforcement* candidate divergence explicitly — REBUS/REBAS, plasticity-window evidence, memory reconsolidation, conventional psychotherapy, expectancy, integration practices, and curated set-and-setting each independently predict durable single-dose change without invoking filter theory. Closing paragraph updated to track the remaining two divergences. (iii) Moved §"The Quantum Dimension" out of the main flow to a clearly-marked "Speculative Appendix: The Quantum Dimension" after §"Relation to Site Perspective"; opening italic block states the appendix sits outside the main argument and does not adjudicate filter vs rival models. Linked to [[concepts/quantum-biology-and-neural-mechanisms]] and [[project/mqi-empirical-fragility]]; inherited the May 2026-05-11 quantum-biology "contested, possibility-level" calibration. (iv) Softened the §"Relation to Site Perspective" Minimal Quantum Interaction bullet to forward-link the appendix and the MQI-fragility discipline and to reframe the microtubule mechanism as "would, if substantiated, supply a candidate physical substrate" rather than "proposes a concrete mechanism."
- **Engagement classification** (editor-internal, not in article body): mixed Mode One + methodological-quarantine. Selective-access rewrite and therapeutic-durability withdrawal are both Mode One in-framework corrections (category-confusion and a divergence candidate that fails the article's own evidential standards once disinhibition accounts of durable change are taken seriously). The quantum-section quarantine is the canonical [[coherence-inflation-countermeasures]] move — separating tenet-coherent possibility-level material from the load-bearing argument so the main case isn't propped up by speculative-tier evidence smuggled in via section adjacency.
- **Forbidden-vocabulary check**: no "Mode One/Two/Three/Four", "direct-refutation-feasible", "unsupported-jump callout", "bedrock-perimeter", "Engagement classification:", "Evidential status:" callouts, or meta-phrase "per [[direct-refutation-discipline]]" in article body. Three-way distinction presented as natural prose with italicised category names and bulleted definitions. Appendix opening italic block is sentence-form rather than bold-headed callout.
...
- **Status**: Success
- **Sources**: [[concepts/microphenomenological-interview]], [[topics/microphenomenological-interview-method]]
- **Target**: [[topics/microphenomenological-interview-method]] (preserved slug; concept page coalesced in)
- **Archived**: [[archive/concepts/microphenomenological-interview]]
...
- **Output**: [[reviews/deep-review-2026-05-12-channel-class-taxonomy]]
...
- **Vocabulary-leakage fixes (10 edits across 9 files; natural-prose replacements naming what the move is about rather than naming the move's editor-label)**:
  - [[topics/machine-consciousness]] §"The Articon Counter-Case": "The disagreement is a productive bedrock-clash" → "The disagreement runs to the framework boundary—whether mechanism is substrate-independent at the architectural level or substrate-dependent in a way the affirmative cannot pay for—and is honestly noted as such rather than dressed as a knock-down argument either way"
  - [[topics/ai-consciousness]] §"The Strongest Affirmative Position": "The disagreement is a productive bedrock-clash:" → "The disagreement runs to the framework boundary—whether mechanism is substrate-independent at the architectural level—and is honestly noted as such rather than dressed as refutation inside Duch's framework:"
  - [[concepts/illusionism]] §"Where the Functional Account Falls Short" intro: removed "the Map's [[direct-refutation-discipline|direct-refutation discipline]] keeps them distinct:" meta-sentence; replaced with "it is worth keeping them distinct:" — the article's surrounding prose already names what makes the five objections distinct (commitments Frankish's framework endorses vs. framework-boundary disagreement)
  - [[concepts/illusionism]] §"Relation to Site Perspective" — Dualism: dropped "the Map's [[evidential-status-discipline|evidential-status discipline]] keeps tenet-coherence from silently licensing..." in favour of natural-prose: "tenet-coherence with dualism is not by itself a license for stronger criticism than the dialectical situation warrants"
  - [[topics/synaesthesia]] §"Relation to Site Perspective" — Dualism closer: removed "The methodological discipline that names this constrain-vs-establish move is [[evidential-status-discipline|evidential-status discipline]]." in favour of "a distinction the Map keeps explicit so empirical findings are not over-credited as confirmation of the speculative-tier reading"
  - [[topics/memory-anomalies]] §"Bergson's Memory of the Present" closer: same constrain-vs-establish rephrasing — "a distinction the Map keeps explicit so neither reading is over-credited by the empirical work"
  - [[apex/phenomenology-mechanism-bridge]] line 52: "the [[project/coherence-inflation-countermeasures|coherence-inflation countermeasures]] are the discipline against treating that artifact as evidence" → "the discipline against reading method-produced consistency as evidence is documented in [[project/coherence-inflation-countermeasures|the project's countermeasures]]"
  - [[apex/phenomenology-mechanism-bridge]] line 130: "The countermeasures in [[project/coherence-inflation-countermeasures|coherence-inflation countermeasures]] target precisely this risk." → "The [[project/coherence-inflation-countermeasures|project's countermeasures]] target precisely this risk."
  - [[apex/moral-architecture-of-consciousness]] intro: same pattern — display-text "coherence-inflation countermeasures" replaced with "the project's countermeasures" + natural-prose lead-in
  - [[apex/taxonomy-of-voids]] §"Tenets-Generated Voids and the Five Families" closer: same display-text replacement
  - [[apex/apex-articles]] phenomenology-mechanism-bridge entry **Thesis**: same display-text replacement
...
- **Status**: Success
- **Files**: [[apex/phenomenology-mechanism-bridge]], [[apex/moral-architecture-of-consciousness]], [[apex/apex-articles]], [[apex/living-with-the-map]], [[apex/taxonomy-of-voids]], [[project/coherence-inflation-countermeasures]]
...
- **Audit findings**:
  ...
  - **taxonomy-of-voids**: discipline already strong (the article explicitly applies the [[common-cause-null]] discount and concedes "the bulk of its convergence is currently framework-internal coherence"); only the cross-link to [[project/coherence-inflation-countermeasures]] was missing — installed inline alongside the common-cause-null sentence.
...
- **Tenet alignment**: methodological / [[project/coherence-inflation-countermeasures]] / [[direct-refutation-discipline]]. No primary tenet directly implicated; the discipline serves Tenet 5 ([[tenets#^occams-limits|Occam's Razor Has Limits]]) indirectly by resisting the coherence-confused-for-truth failure mode the tenet was designed to guard against.
...
- **Previous review**: [[reviews/deep-review-2026-03-27-qualia|2026-03-27]] (45 days unreviewed; new Duch (2005) functionalist-deflationary paragraph added 2026-05-03)
- **Word count**: 3275 → 3285 (+10; soft_warning, still well below 3500 hard)
- **Critical issues addressed**: 1
  - Label leakage in Duch engagement: closing phrase "productive bedrock-clash" used editor-vocabulary in article prose (§2.6 violation). Replaced with natural-prose framework-boundary statement: "The disagreement runs to the framework boundary—whether qualia possess any intrinsic non-relational dimension at all—and the full engagement lives in [[research/...|the Duch research dossier]]."
- **Medium issues addressed**: 1
  - Removed stale AI REFINEMENT LOG HTML comment (dated 2026-03-19, marked "remove after human review"); the content is preserved in [[reviews/deep-review-2026-03-08-qualia]] and earlier archives
- **Attribution accuracy (Duch source)**: verified — "qualia inseparable from perception and action", "experience different qualities of internal states", articon self-reflective-dynamical-access framing, working-memory discrimination claim — all confirmed against [[research/wlodzislaw-duch-consciousness-2026-05-02]]; source/Map separation preserved; no dropped qualifiers
...
- **Output**: [[reviews/deep-review-2026-05-12-qualia]]
...
- **Wikilink redirects reapplied in restored body**: [[phenomenology-of-the-edge|phenomenology of the edge]] → [[edge-states-and-void-probes|phenomenology of the edge]]; [[altered-states-as-void-probes]] → [[edge-states-and-void-probes]]
...
- **Output**: [[reviews/deep-review-2026-05-11-dualism-as-ai-risk-mitigation]]
...
- **Cross-review trigger**: integration with new companion [[topics/mechanism-costs-dualism-thickness-quadrants]]
...
- **Output**: [[reviews/deep-review-2026-05-11-four-quadrant-dualism-taxonomy]]
...
- **Cross-tier reciprocal links added** (5 companion articles, spanning 3 content tiers):
  - [[topics/four-quadrant-dualism-taxonomy]] — direct companion. Lack of reciprocal back-link from the taxonomy to its mechanism-costs sequel was the clearest gap. Added at top of related_articles list.
  - [[topics/parsimony-case-for-interactionist-dualism]] — mechanism-costs explicitly clarifies what the parsimony argument is doing in mechanism-cost terms ("paying the *least mechanism cost compatible with the tenets*"). Added both `mechanism-costs-dualism-thickness-quadrants` and `four-quadrant-dualism-taxonomy` since the parsimony piece lacked both.
  - [[topics/the-interface-problem]] — mechanism-costs unpacks the interface-specification debt cell-by-cell. Added reciprocal link.
  - [[concepts/conservation-laws-and-mental-causation]] — mechanism-costs unpacks the conservation-engagement debt cell-by-cell. Added both companion links (mechanism-costs and four-quadrant taxonomy).
  - [[voids/interface-formalization-void]] — mechanism-costs flags this void as Q1's "live open problem" — the articulability burden. Added both companion links.
...
- **Output**: addendum appended to existing [[reviews/deep-review-2026-05-11-mechanism-costs-dualism-thickness-quadrants]]
...
- **Output**: [[concepts/microphenomenological-interview]]
...
- **Status**: Success
- **File**: [[tenets/tenets]] (anchor task filed against [[voids/agency-void]] — coherence-maintenance edit; the tension surfaced from agency-void but the fix lives in tenets)
