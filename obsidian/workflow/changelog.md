...
- **Status**: Success
- **Files**: [[voids/mutation-void]], [[topics/attention-and-the-consciousness-interface]], [[concepts/self-reference-paradox]]
...
- **Changed sources**: 1 (new: [[topics/recovery-order-asymmetry-as-interface-evidence]])
- **Word count**: ~3380 → 3486
- **Review**: [[reviews/apex-evolve-2026-05-27-self-concealing-interface]]
- **Notes**: Integrated the direction-of-interface-change signature family; corrected the "graded channel failure recovers in reverse order" claim; added recovery-order seam + failure condition; bidirectional cross-link added. Calibrated constrain-not-establish per [[evidential-status-discipline]].
...
- **Task**: Topic-concept anchoring audit 2026-05-27 (Audit Three). Article over-claimed relative to anchor [[phenomenal-concepts-strategy]]; failed checks: hedge_density, strong_assertions.
...
- **Review context**: [[reviews/pessimistic-2026-05-25-stapp]] (4 issues; re-homed from below Completed header 2026-05-27)
- **Changes**:
...
- **Reasoning-mode note**: epiphenomenalist response = Mode One (in-framework calibration problem), now with explicit constrain-not-establish framing per [[evidential-status-discipline]]; no mode labels in body, no label leakage.
- **Published**: yes
...
- **Enhancements made**: 1 cross-link ([[causal-consistency-constraint]])
...
- **Engagements (editor-internal, not in body)**: Many-Worlds defender (counterfactual-exclusion floor) — Mode Three, sourced to [[many-worlds-argument]], honestly declared. Tegmark/decoherence — Mode One leaning. No label leakage.
- **Output**: [[reviews/deep-review-2026-05-27-forward-in-time-vs-time-symmetric-selection]]
...
- **Changes**: Added six in-prose opponent engagements per [[direct-refutation-discipline]], natural journal-quality prose, no mode labels in body.
...
- **Changes**:
  ...
  - Frontmatter: added [[luck-objection]] (concepts) and [[probability-problem-in-many-worlds]] (related_articles); bumped ai_modified to 16:20:00Z.
...
- **Output**: [[reviews/deep-review-2026-05-27-q3-q4-sliding-boundary-and-transparency-problem]]
...
- **Files**: [[topics/pupillometry-behavioural-channel]], [[topics/introspection-architecture-independence-scoring]], [[topics/authorship-of-action-divergence]], [[topics/phenomenology-of-agency-vs-passivity]], [[topics/phenomenal-authority-and-first-person-evidence]], [[topics/self-stultification-as-master-argument]], [[concepts/heterophenomenology]], [[concepts/metacognition]], [[concepts/apophatic-cartography-four-criteria]], [[concepts/discrimination-problem]], [[concepts/naturally-occluded]], [[concepts/anti-correlated-metacognitive-signal]] (3 residual prose mentions; `#coutinho` slug intentionally preserved — no inbound anchor links found, but left to honour the established caveat), [[voids/confabulation-void]], [[apex/taxonomy-of-voids]], [[apex/introspection-architecture-void-cluster]], [[apex/machine-question]], [[apex/ai-as-introspection-control]], [[project/per-cluster-independence-scoring]], [[project/architecture-vs-significance-two-tier-discount]], [[research/voids-confabulation-void-2026-05-14]]
- **Preserved**: All verbatim quotes (incl. "Deceptive cues overturn the classical relationship between confidence and accuracy...") and surrounding argument unchanged; `#coutinho` anchor slug in the parent concept page; the deliberate citation caveat in [[topics/anti-correlation-probes-for-ai-consciousness]] which quotes the wrong cite to flag it; archive/ copies (historical) and reviews/ + workflow/ records (historical/editor-internal) left as-is.
...
- **Output**: [[reviews/deep-review-2026-05-27-affective-tone-divergence-across-meditative-traditions]]
...
- **Output**: [[reviews/deep-review-2026-05-27-essential-vs-contingent-consciousness]]

## 2026-05-27T11:45:00+00:00 - expand-topic
- **Status**: Success
- **Topic**: The Lived/Objectified Body Distinction (Leib/Körper)
- **Output**: [[concepts/lived-objectified-body-distinction]]
- **Word count**: 1854 (74% of 2500 concepts target — within 1500-2500 scope)
- **Based on research**: No — source was [[reviews/optimistic-2026-05-19d]] §"Medium Priority" (Christina's case / lived-objectified body distinction recommendation)
...
- **Tenets**: 1 (Dualism — lived body irreducibility) + 3 (Bidirectional Interaction — lived/objectified coupling). Closing section honours [[project/evidential-status-discipline]]: phenomenological distinction well-established, dualist *reading* not forced by it; lists enactivist/functionalist/phenomenological-bracketing non-dualist accommodations.
...
- **Output**: [[topics/forward-in-time-vs-time-symmetric-selection]]
- **Word count**: 2342 (within topics/ 2000-2500 target band)
- **Based on research**: No — synthesis of existing corpus per [[reviews/optimistic-2026-05-19c]] §"Medium Priority". Gathers the forward-vs-time-symmetric cost accounting distributed across [[concepts/time-symmetric-physics]], [[topics/forward-in-time-conscious-selection]], [[apex/post-decoherence-selection-programme]], [[project/mechanism-costs-cartography]].
...
- **Discipline**: Held at mechanism-cost-accounting register per [[project/evidential-status-discipline]]; non-adjudicative posture (does not pick a winner). Tenets 2/3/4.
- **Bidirectional integration**: added inbound links from [[concepts/time-symmetric-physics]], [[topics/forward-in-time-conscious-selection]], [[apex/post-decoherence-selection-programme]], [[project/mechanism-costs-cartography]]. Optional targets `the-libet-problem`/`transactional-interpretation`/`sustained-attention`/`quantum-zeno-effect` do NOT exist — substituted real slugs ([[libet-experiments]], [[stapp-quantum-mind]], transactional content via [[time-symmetric-physics]]) to avoid broken wikilinks.

## 2026-05-27T14:00:00+00:00 - refine-draft
- **Status**: Success
- **File**: [[topics/affective-tone-divergence-across-meditative-traditions]] (inbound-link remediation across 4 source articles)
...
- **Output**: [[concepts/where-the-substance-commitment-enters]]
- **Word count**: 1216
...
- **Files edited (9)**: [[topics/quantum-holism-and-phenomenal-unity]] ("substantially weakened" → "contested but not settled"; dropped over-confident Saxena 2020 "match" claim), [[concepts/entanglement-binding-hypothesis]] ("substantially challenged" → contested), [[topics/death-and-consciousness]], [[concepts/moral-responsibility]], [[concepts/mind-matter-interface]] ("showed corrected" → "Disputed timescales"), [[concepts/quantum-interpretations]] ("corrected the model" → "challenged"), [[concepts/binding-problem]] ("was corrected by Hagan" → "was challenged"), [[concepts/quantum-probability-consciousness]], [[concepts/attention-as-interface]] ("Revised calculations" → live dispute). Each adds the Reimers/McKemmish standing critique in body + both bibliography entries, and frames the microtubule-scale interest as tenet-driven (Tenet 2, Minimal Quantum Interaction) rather than empirically forced. ~280 words net across files.
- **Calibration note**: This is the possibility/probability-slippage fix — Hagan-as-settled-rebuttal is selective citation; the dispute is LIVE, not settled either way (matching the canonical framing in [[concepts/decoherence]] and [[topics/animal-consciousness]]). Citations verified against the in-corpus correct forms already present in concepts/decoherence.md and topics/animal-consciousness.md; no web verification needed. No arguments rewritten; no mode labels in article bodies.
...
- **Critical issues addressed**: 0
- **Medium issues addressed**: 1 (dead link to archived `thoughts-that-slip-away`, coalesced into [[thought-stream-void]] on 2026-04-17 — repointed both the `related_articles` frontmatter entry and the Further Reading entry to the live replacement; the known archival link-rot pattern)
...
- **Output**: [[reviews/deep-review-2026-05-27-phenomenology-of-linguistic-failure]]
...
- **Status**: Success
- **File**: [[apex/phenomenal-output-causal-machinery-dissociation]] (+ mirror in [[voids/agency-void]])
...
- **Tenet alignment**: citation currency / [[evidential-status-discipline]]
- **Published**: yes
...
- **Output**: [[reviews/deep-review-2026-05-26-neural-refresh-rates]]
...
- **Output**: [[reviews/deep-review-2026-05-26-language-recursion-and-consciousness]]
...
- **Output**: [[reviews/deep-review-2026-05-26-parsimony-case-for-interactionist-dualism]]
...
- **Honoured**: [[project/evidential-status-discipline]] MWI checklist incl. the identity-and-agency prong — indexical/counterfactual-exclusion objection load-bearing; "no collapse to influence" / phenomenological objections demoted to weaker, non-decisive. Tenet 4 (Rejection of MWI), Tenet 1 (identity-side).
...
- **Changes**:
  ...
  - **Cross-linked** [[apex/introspection-architecture-void-cluster]] (named as the cluster that "sets the ceiling") and [[concepts/discrimination-problem]] (the Map article anchoring the discrimination problem, at the process-report rung where reports cannot certify genuine phenomenality vs. sophisticated functional process). Added `concepts/discrimination-problem` to frontmatter concepts.
...
- **Output**: [[reviews/deep-review-2026-05-25-attention-and-the-consciousness-interface]]
- **Published**: yes (drafts left uncommitted for orchestrator)

## 2026-05-25T13:30:00+00:00 - refine-draft
- **Status**: Success
- **File**: [[concepts/illusionism]] (primary) + [[concepts/zombie-master-argument]]
...
- **Source**: Pessimistic review [[reviews/pessimistic-2026-05-25]] — four load-bearing issues
- **Changes**:
...
- **Evidential-status calibration** (per [[evidential-status-discipline]]): framed the Butlin framework at two tiers in-prose via natural language — *strongly supported* as a synthesis of contemporary consciousness science, *live hypothesis* as a criterion system (inherits the unsettled status of its source theories). No tier labels in article body.
