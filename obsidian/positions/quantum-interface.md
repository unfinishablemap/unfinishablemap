...
- **Status**: live
- **Calibration** ([[methodology-and-calibration#^calibration-schema|multi-axis]]): credence moderate · external-evidence grade D · structural centrality moderate · model maturity programme · empirical discriminability indirect · framework-internal only: yes
...
- **Depends on**: Tenet 2; [[concepts/causal-consistency-constraint]]; the no-signalling argument (Torres Alegre 2025)
