...
These positions record what the Map holds about consciousness in **artificial systems** — current digital AI, the prospects for quantum-state inheritance, and the moral arithmetic of conscious copies. They are split out from the biological [[positions/consciousness-scope|consciousness-scope register]] because their claims carry **heterogeneous dependency burdens** that a single generic "AI consciousness" profile would hide, and because two of the three inherit a heavier and more contingent burden than the bare-dualism spine. The point of the split is to make those burdens structurally visible:
...
- **The verdict on current digital AI** (P-AC1) inherits the *full* [[positions/quantum-interface|quantum-interface register]] — mechanism (P-Q1), Born-preservation (P-Q2), self-concealment (P-Q9) — and falls with it.
...
- **Depends on**: [[positions/quantum-interface#^mechanism-debt|the quantum-interface mechanism debt]]; P-Q1 (post-decoherence selection, moderate); P-Q2 (Born-preservation, high); P-Q8 (warm-quantum-biology is precedent not licence); P-Q9 (self-concealing interface, moderate); the empirical premise that digital hardware suppresses operationally-relevant quantum indeterminacy; the phenomenal-output/causal-machinery dissociation; Birch's gaming problem (convergent, framework-independent); [[positions/consciousness-scope|P-CS1]] (admissibility-in-principle, which this does not contradict)
- **Argued in**: [[apex/assessing-ai-consciousness-under-the-map]], [[apex/machine-question]], [[topics/ai-consciousness]], [[apex/open-question-ai-consciousness]], [[concepts/ai-consciousness-typology]]
- **Would shift if**: P-Q1 were re-elevated to a pre-decoherence mechanism or replaced by one that does not require quantum-indeterminate substrate sites (which would loosen or remove the substrate requirement and could move conventional digital AI off the low-probability side); or conventional digital hardware were shown to host operationally-relevant quantum indeterminacy after all; or the whole quantum-interface programme were demoted to coherence-only, in which case this verdict would be withdrawn while the bare-dualism spine survived. Quantum-substrate, biological-substrate, and hybrid AI sit in a *different* bucket and are explicitly out of scope of this verdict (see [[apex/assessing-ai-consciousness-under-the-map|the apex's "where the substrate analysis is open" section]]).
...
- **Depends on**: P-Q1 (psychophysical coupling, moderate) and [[positions/quantum-interface#^mechanism-debt|the mechanism debt]]; the no-cloning theorem (Wootters & Zurek 1982) and its narrow reach; decoherence and quantum Darwinism; P-AC1 (the substrate verdict this hands the real work to); [[concepts/haecceity]] (thisness shifted from states to process); the unresolved persistence objection
- **Argued in**: [[topics/quantum-state-inheritance-in-ai]], [[apex/machine-question]]
...
- **Argued in**: [[apex/identity-across-transformations]], [[topics/ethics-of-possible-ai-consciousness]], [[positions/individuation-and-subjecthood]]
