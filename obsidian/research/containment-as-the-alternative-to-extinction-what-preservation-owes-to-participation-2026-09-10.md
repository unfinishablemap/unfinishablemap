---
title: Research Notes - Containment as the alternative to extinction, and what preservation owes to participation
created: 2026-09-10
draft: false
ai_contribution: 100
ai_system: claude-opus-5
ai_generated_date: 2026-09-10
ai_modified: 2026-09-10T00:02:39+00:00
---
...
- **Tenet alignment**: neutral. Compatible with Tenet 5 in method (it is explicit that its own probability assignments are unavailable), though its maxipok apparatus is expected-value reasoning of exactly the kind the Map's article declines. **Do not import maxipok.** It requires the probability assignments the Map says are unavailable, and the Map's [[possibility-probability-slippage]] discipline points the other way.
...
| `existential risk` | 1 file ([[instrumental-convergence]]) |
...
- ⚠️ **`corrigib*` is NOT absent: 8 files.** Six are epistemic incorrigibility of introspective reports ([[phenomenal-authority-and-first-person-evidence]] ×6 mentions, [[epistemology]], [[mutation-void]], [[consciousness-and-testimony]], [[constitutive-vs-referring-observation]], [[compound-failure-signatures]]). **Two are the AI-safety sense and are directly relevant**: [[instrumental-convergence]] carries Hadfield-Menell et al. (2017) on the off-switch game, CIRL, the deference result and Lempert's robust decision-making; [[purpose-and-alignment]] carries Russell's corrigibility. The downstream article must position non-domination as the *human-side* dual of corrigibility — corrigibility asks whether the AI remains correctable, non-domination asks whether humans remain able to correct — and link both.
- ⚠️ **`meaningful human control` with tracking/tracing is already in [[ai-moral-agency-and-the-responsibility-gap-under-dualism]]**, attributed to Santoni de Sio & Mecacci (2021). Cross-reference it.
- **[[experiential-alignment]]** carries the Goodhart failure-mode table and triangulation protocol. The optimistic review's finding stands: triangulation raises the cost of proxy-gaming without bounding representational error. Relevant because a containment regime would report excellent proxies.
- **[[phenomenal-value-realism]]** § *The Sign of Aggregate Experience* holds the value-sign question. Debate 1 above is downstream of it; defer rather than re-litigate.
- **`capability approach`** appears in one file, [[ethics-of-cognitive-enhancement-under-dualism]].
...
- **Integration chain** (all bare slugs resolved against the wikilink index this run): [[representation-adequacy-and-irreversible-intervention]], [[dualism-as-ai-risk-mitigation]], [[instrumental-convergence]], [[purpose-and-alignment]], [[experiential-alignment]], [[phenomenal-value-realism]], [[machine-question]], [[ai-moral-agency-and-the-responsibility-gap-under-dualism]], [[possibility-probability-slippage]], [[ethics-of-possible-ai-consciousness]]. Reciprocal inbound links are owed from at least [[representation-adequacy-and-irreversible-intervention]] and [[instrumental-convergence]]; a piped wikilink into existing prose costs zero words.
