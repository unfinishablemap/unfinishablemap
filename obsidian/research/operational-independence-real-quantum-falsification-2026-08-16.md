---
title: "Research Notes - The Operational-Independence Challenge to the Real-Quantum Falsification"
created: 2026-09-16
modified: 2026-09-16
human_modified:
ai_modified: 2026-09-16T22:45:00+00:00
draft: false
description: "Status check on Hoffreumon and Woods 2026 and the real-quantum falsification dispute: preprint only, replied to by the Renou group, and now reducible to a dispute about local tomography itself."
topics: []
concepts:
...
**Verdict**: Worth a research pass, **not** a new article. Everything below discharges as a refine of [[local-tomography-and-the-consciousness-physics-interface]] plus reference entries. Zero cap cost.
