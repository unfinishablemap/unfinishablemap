...
- Rationale paragraph: softened "strong evidence against epiphenomenalism" → "counts as evidence against epiphenomenalism" + "on its face". Added an explicit framing sentence stating that BI is held as *a metaphysical commitment supported by self-stultification and indirect evidence, not as a directly introspectible datum*. Added inline cross-link to [[agency-void#The Verification Circularity]] as the place where the structural reason is catalogued. Closed with: "The tenet is a starting point that shapes inquiry, not a conclusion derived from introspective evidence."
...
- "Why this is the deepest difficulty..." paragraph: retained the Map's reading that report-accuracy without causal traffic from the phenomenal facts is the deepest problem epiphenomenalism faces. Added the epiphenomenalist's strongest reply (phenomenal-state ↔ neural-state correlation can underwrite report-accuracy without phenomenal causation). Stated the conditionality explicitly: whether self-stultification bites depends on the causal-theory-of-knowledge premise. Cross-linked to [[agency-void#The Self-Stultification Symmetry]] where De Brigard (2014) is treated symmetrically. Made explicit that BI is held because the alternative leaves report-reliability on a contested premise — *not because* self-stultification refutes epiphenomenalism inside the epiphenomenalist's framework. Closed with explicit bedrock-marking: "The disagreement runs closer to bedrock than the standard self-stultification framing suggests."
- Frontmatter: added [[agency-void]] to related_articles (reciprocal link — agency-void.md already links to ^bidirectional-interaction); updated ai_modified to 2026-05-11T10:36:00+00:00.
