...
description: "Cognitive limits are doubly informative: their shape reveals mental architecture, and the void catalogue's structure forms an abductive case—calibrated, under the common-cause null, as coherence of the Map's self-image, not framework-independent confirmation of dualism."
created: 2026-01-16
modified: 2026-04-28
human_modified: null
...
Limits may be not merely informative but *preconditions for meaning itself* ([[void-as-ground-of-meaning]]). They operate collectively as well as individually: paradigms and cultures develop emergent blind spots no individual mind would face alone ([[collective-cognitive-limits]]).
