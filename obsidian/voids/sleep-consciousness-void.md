...
The sleep consciousness void combines features of all [[three-kinds-of-void|three void categories]]:

**Unexplored.** Dreams may access territories normally closed to waking—creative solutions that emerge from relaxed logical constraints, emotional processing that waking inhibition blocks. [[dream-consciousness#The Phenomenal Mode Tracking Pattern|Dream problem-solving research]] suggests that creative breakthroughs specifically require dreaming consciousness, not merely offline neural computation. Deep sleep's neuroscience remains incomplete.
...
The [[concepts/materialism|physicalist]] might deflate this analysis: the differences between waking, dreaming, and dreamless sleep are simply differences between neural configurations. When prefrontal cortex is active, we reason critically; when it's deactivated, we don't; when large-scale cortical activity diminishes, consciousness ceases.
...
The Map's [[tenets#^no-many-worlds|No Many Worlds]] tenet makes this question substantial. [[many-worlds#MWI's Branch-Relative Indexicality Reply|Branch-relative indexicality (Saunders/Wallace)]] preserves a per-branch sleeper-identity, but MWI's decision-theoretic Born-rule recovery requires a cross-branch personal-identity relation that does *not* dissolve into branch-local bookkeeping. The Map's single-history metaphysics rejects that cross-branch relation outright: *this* person, falling asleep, either persists or does not, on a one-branch-only reading.

## Relation to Site Perspective

**[[tenets#^dualism|Dualism]]** is most directly implicated. The radical differences between conscious modes—waking, dreaming, dreamless sleep—suggest consciousness has richness and plurality not capturable in functional terms. The Vedantic position—awareness is continuous but veiled—aligns with dualism: if consciousness is fundamental rather than reducible to brain states, it could persist even when neural activity shifts dramatically. The void itself may be evidence that consciousness has properties physical description cannot capture.
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]** applies directly. The parsimonious view treats waking consciousness as baseline, dreams as degraded versions, and dreamless sleep as consciousness switched off. Gelernter's observation challenges the first assumption; Vedantic analysis, contemplative reports, and phenomenological research challenge the second. The simple answer may be wrong at every stage.

**[[tenets#^no-many-worlds|No Many Worlds]]** makes the identity question substantial. The Map's one-branch-only reading of indexicality—stronger than [[many-worlds#MWI's Branch-Relative Indexicality Reply|MWI's branch-relative reply]]—means persistence of the self through sleep is a genuine question rather than an artefact of which branch's observer is doing the asking.
...
- [[contentless-awareness-evidence]] — What could count as evidence that a witness persists through dreamless sleep
