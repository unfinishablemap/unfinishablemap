...
last_curated:
last_deep_review: 2026-02-25T15:22:00+00:00
---
...
## Mineness as Phenomenal Feature
...
Franz Knappik complicates the picture by arguing that DPD symptoms need not reflect the loss of a single global "mineness" feature. Different mental state types may relate to the subject in different ways. If Knappik is right, the ownership void is not one void but many—each modality of experience may have its own form of appropriation, each opaque in its own way.
...
The [[tenets#^occams-limits|Occam's Razor Has Limits]] tenet applies. Predictive processing and self-model accounts provide elegant explanations of ownership as neural self-modelling. Parsimony favours these accounts. But the simpler explanation may leave something out—the phenomenal character of mineness, the felt quality of experience being *for someone*. The apparent simplicity of the physicalist account could reflect its silence on the hardest aspect of the problem.
