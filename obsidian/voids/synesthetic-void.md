...
ai_modified: 2026-06-17T03:58:18+00:00
---
...
A Dennett-style heterophenomenologist will object that this whole line of argument rests on taking synesthetes' first-person reports as direct evidence about phenomenal states rather than as data about what synesthetes are inclined to say. The argument here proceeds on the realist reading, but the Map flags that step as a substantive choice rather than a neutral starting point. A second hedge from the same direction: van Leeuwen et al.'s "mediated through semantics" finding (developed below) suggests that the synesthete's processing pipeline is *not* identical to the non-synesthete's at the deeper grain that representationalists track—so the "identical representations" claim relies on fixing the level of representation at the surface stimulus.
...
If E-space is vast, human consciousness occupies a small region of it. Two caveats keep the use honest. Lacalli's E-space is an explicitly non-dualist theoretical mapping ("there is no implied dualism"), and it charts possible qualia in relation to neural selector circuits rather than a measured space that synesthetes have been independently located in. So synesthesia does not by itself open inaccessible E-space dimensions; reading synesthesia through E-space is an interpretive overlay, not a measurement. What synesthesia does is sit compatibly with, and become suggestive under the Map's reading of, unexploited dimensions—even within the space accessible to human neural architecture, most people navigate only a fraction. With that framing in place, the synesthetic void sits in our immediate neighbourhood rather than at the far edge of experiential possibility—between minds that share a species.
...
The synesthetic void exhibits an apparent asymmetry. Synesthetes appear better positioned to imagine non-synesthetic experience: their phenomenal life contains a non-synesthetic substrate to which the extra qualia are added, while non-synesthetes have no analogous handhold for the synesthetic side. The asymmetric reading is the natural one, though synesthetes' subtractive access to a counterfactual non-synesthetic baseline is itself uncertain—imagining one's own phenomenal life minus a layer is not obviously easier than imagining someone else's plus a layer. The asymmetry is real to the extent that subtractive imagination is, in fact, easier than additive imagination, and the Map treats this as the stronger reading without claiming it as settled.
...
**[[tenets#^dualism|Dualism]]** gains explanatory leverage from the synesthetic void. Physicalism has more than one resource here, and the strong version of the opponent should be stated before the Map's reply. A physicalist can explain synesthetic qualia through cross-activation (V4 driven by the grapheme-form area), through disinhibited feedback that releases normally-suppressed cross-modal channels, through semantic or top-down mediation in which conceptual processing shapes the percept, through representational sub-individuation in which the synesthetic colour is part of a richer or higher-order content rather than something "extra," or through illusionist and metacognitive deflation in which the extra-qualia report is a structured misrepresentation of internal processing rather than a primitive qualitative property. The Map's claim is not that physicalism has no account; it is that the extra qualia problem (Wager) and the extraordinary feature (MacPherson) resist the reductions on offer. Synesthetic qualia exhibit properties—dual occupancy of spatial locations, phenomenal character without representational difference—that functional and representational theories struggle to accommodate. This mirrors the [[knowledge-argument]]: just as Mary learns something new upon seeing red despite complete physical knowledge, no amount of neurological description conveys what it is like to experience a synesthetic colour. Under property dualism, the additional qualia are ontologically independent properties that covary with neural architecture but are not exhausted by it. An eliminative materialist (in the Churchland tradition) will read the same data through cross-activation alone—synesthetic colour reflects V4 activation triggered by the grapheme-form area, with nothing extra requiring explanation; the Map's reading rests on commitments developed across the broader Map rather than on synesthesia in isolation.
