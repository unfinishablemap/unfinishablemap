...
related_articles:
  ...
  - "[[research/voids-insight-void-2026-05-14]]"
  - "[[research/voids-encoding-void-2026-05-12]]"
  - "[[research/voids-participation-void-2026-02-17]]"
  - "[[research/voids-suggestion-void-2026-08-06]]"
  - "[[research/voids-olfactory-void-2026-08-13]]"
  - "[[research/voids-report-latency-void-2026-08-16]]"
  - "[[research/voids-summary-statistics-void-2026-08-18]]"
  - "[[research/voids-notation-void-2026-08-19]]"
  - "[[research/voids-self-signature-void-2026-08-20]]"
  - "[[research/voids-reafference-void-2026-08-22]]"
...
- [[what-voids-reveal|What Cognitive Voids Reveal]] — How limits illuminate cognitive architecture, and why the convergence of the catalogue and the capacity to conceive of voids are no longer offered as abductive support for the Map's tenet-package: under the [[common-cause-null|common-cause null]] the pattern is a coherence exhibit—the Map's carving of the voids and its tenets hang together—with no confirming force against a framework carving them differently
...
- [[creative-aesthetic-void|The Creative-Aesthetic Void]] — Three failures—generating novel phenomenal content, articulating received aesthetic content, observing the generative process—whose pattern reveals the architecture of mind (coalesced from imagination-and-creativity-void + aesthetic-void)
...
- [[transit-void|The Transit Void]] — Why consciousness cannot witness its own crossings: neither the onset of a mental act, the transition between states, the moment attention is captured, nor the arrival and departure of thoughts (coalesced with distraction-void and thought-stream-void)
...
- [[mine-ness|The Ownership Void / Mine-ness]] — Why we cannot introspect how experiences become ours (coalesced 2026-08-06)
...
- [[fusion-void|The Fusion Void]] — Why the combination step behind every unified percept is closed to the mind that receives its output: the component estimates, the reliability weights, and the prior common-cause verdict are all consumed in producing the percept. A rare void whose own boundary is a measured quantity — mandatory fusion within a sense, component access preserved between senses (created 2026-09-04)
- [[perceptual-reality-monitoring-void|The Perceptual Reality-Monitoring Void]] — Why the real-time operation assigning sensory content to *real* or *imagined* is inspectable only by its verdict; three faces (Perky crossover / confidence-decoupling / pathological equivalence) converge on a felt-real signal that is a separable constructed layer rather than a read of reality. The moment-by-moment operational face of [[predictive-construction-void|predictive construction]] and the online sister of [[source-attribution-void|source-attribution]], with further relations to [[imagery-void|the imagery void]] (Perky-threshold extension of the fidelity face), [[noetic-feelings-void|the noetic feelings void]] (felt-real as a family member), and [[simulation-detection-void|simulation detection]] (the same operation at macro timescale) (created 2026-05-18)
- [[modality-void|The Modality Void]] — Why consciousness cannot read its own modality structure: three faces (counting / attribution / boundary) conjoined by the claim that modality arrives as the *format* of an experience rather than as a checkable datum. No first-personal count of the senses (Macpherson 2011), a channel tag that is wrong every day and carries full felt evidence when it is (oral referral, the thermal grill, McGurk), and no inward route to which sense a rerouted channel joins (Hurley & Noë; rewired ferrets). The channel-tag member of the family holding [[source-attribution-void|source-attribution]] (origin tag) and [[perceptual-reality-monitoring-void|reality monitoring]] (reality tag) (created 2026-09-06)
...
- [[edge-states-and-void-probes|Altered States as Void Probes]] — Whether altered states reveal cognitive limits or simulate transcendence
...
- [[acquaintance-void#where-concepts-stop-reaching|The Acquaintance Void — where concepts stop reaching]] — Why concepts classify and so lose the particularity acquaintance holds: fineness of grain, phenomenal overflow, prereflective bodily awareness
...
- [[inaccessible-past#The Historical Scale|The Inaccessible Past — Historical Scale]] — Whether consciousness itself has changed over historical time
...
The voids catalogue stands at 101 articles against a 115-article cap (gate function, 2026-09-05; the cap was raised 100→115 on 2026-09-01, reopening standalone headroom for the first time since June — before that raise the catalogue sat within one article of cap, and spending that last slot was an operator decision rather than an automation one). That cap is an administrative constraint and cannot add evidential weight to the convergence-as-evidence move; at most it keeps index-inflation from being mistaken for growing evidence. Cap-pressure forces *absorption* over *proliferation*: newly surveyed voids fold into existing articles as additional faces, not fresh entries, so a rising count is not rising support. Whatever weight the catalogue carries—bounded by the [[common-cause-null|common-cause null]]—tracks the underlying structural pattern, not an index's growth rate.

Nineteen voids surveyed since 2026-02 have research notes; all but the two marked *Published* lack standalone articles. They are **not active siblings** of the catalogue's standalone voids; each carries a status label so its relation to the live catalogue is unambiguous. **Absorbed** — the surveyed material has been merged into its primary host article(s), where its evidence now lives; no standalone article will be created, and any secondary fold still pending is named in the entry. **Folded** — the void is designated to fold into named host article(s) and currently survives as a research note plus host forward-pointers, with full incorporation pending a later host refine. **Surveyed** — a research note exists, but whether the material folds or takes a standalone slot is an open operator decision, so no host yet carries it. Absorbed and Folded are deliberate outcomes of the absorption-over-proliferation discipline, not gaps awaiting their own article; Surveyed marks the one decision that discipline leaves to the operator. (Two further statuses, defined in the maintenance note above, describe *standalone* catalogue articles: **cognate** — conjoint shape at creation; **coalesced** — merged from prior articles.)

- **[[research/voids-translation-void-2026-05-09|The Translation Void]]** — *Absorbed* (2026-06-01, commit `bb4bd3923`) into [[language-thought-boundary]] and [[metaphor-void]]. Three-face structural opacity around the *operation* of converting content between representational formats. Phenomenal-to-linguistic (Ji et al. 2024 give an information-theoretic compression bound: trajectories specifying billions of neurons collapse into a handful of working-memory slots). Cross-lexical (Lomas's corpus of 1,400+ documented untranslatable terms reveals language-specific carvings that feel transparent from the source-language stance). Analogical-domain (Hofstadter-Gentner: analogy as the unconscious core of cognition, with felt-rightness as output and selection criteria as opaque). The seam is generic cross-format mapping; the void sits in the same family as [[inference-void|the inference void]] and [[transit-void|the transit void]] — operation-voids where consciousness has the endpoints but not the passage. Folds into [[language-thought-boundary|the language-thought boundary]] (phenomenal-to-linguistic and cross-lexical faces) and [[metaphor-void|the metaphor void]] (analogical-domain face).
- **[[research/voids-effort-void-2026-05-08|The Effort Void]]** — *Absorbed* (2026-06-01) into [[agency-void|the agency void]]'s verification face as "Effort as the action-side gate," where the Naccache (2005), Hagger et al. (2016), and Kurzban/Westbrook-Braver evidence now lives in full. Three faces of mental effort's opacity to itself (calibration, depletion, modulation): the felt sense of effort is a separable, sub-personally generated signal, not a readout of the work it accompanies — the action-side analogue of [[noetic-feelings-void|the noetic feelings void]].
- **[[research/voids-cognitive-phenomenology-void-2026-05-01|The Cognitive Phenomenology Void]]** — *Absorbed* (2026-06-01). Whether thinking-as-such has a proprietary phenomenal kind distinct from sensory imagery, inner speech, and affect — a void about the *ontology* of the phenomenal rather than its accessibility, anchored historically by the unresolved Würzburg-Titchener imageless-thought controversy (c. 1900–1915). The empirical-architectural/aphantasia face into [[imagery-void|the imagery void]]'s function-phenomenology face (Lennon's no-sensory-reduction-base evidence); the cog-phenom ↔ metacognitive-feelings adjoining seam into [[noetic-feelings-void|the noetic feelings void]] (Arango-Muñoz 2019); the standalone topic treatment lives at [[cognitive-phenomenology-and-the-irreducibility-of-thought]], which carries the liberal/conservative dispute and Fürst's "regimented by the view initially held" diagnosis in full.
- **[[research/voids-insight-void-2026-05-14|The Insight Void]]** — *Folded.* Three-face structural opacity around the *restructuring operation* of impasse-breaking: consciousness witnesses stuck-state and aha-state but never the operation bridging them. Restructuring (Knoblich-Ohlsson 1999's representational-change theory: constraint relaxation and chunk decomposition are sub-personal, with Knoblich-Ohlsson-Raney 2001 eye-tracking showing fixation patterns shift toward the answer before subjective report). Antecedent-blindness (Jung-Beeman et al. 2004: an alpha-band "brain-blink" suppresses sensory monitoring ~1.5s before the right-temporal gamma burst that marks the aha at ~300ms; Salvi et al. 2019 show gamma tACS over right temporal lobe causally increases aha rates). Calibration (Danek-Wiley 2017 document false insights as confidently and pleasurably as true ones, indistinguishable from inside; Topolinski-Reber 2010 ground felt-rightness in fluency rather than correctness; Laukkonen et al. 2020's "dark side of Eureka" shows artificially-induced aha moments make unrelated facts feel true). The seam is generic restructuring under impasse; the void joins the operation-void family alongside [[transit-void|transit]], [[inference-void|inference]], and [[decision-void]]. Folds into [[noetic-feelings-void|the noetic feelings void]] (calibration face: the Eureka heuristic extends the existing fluency-gating analysis) and [[decision-void|the decision void]] (sister-regress at the structurally analogous impasse→restructuring closure).
- **[[research/voids-encoding-void-2026-05-12|The Encoding Void]]** — *Absorbed* (2026-06-01, commit `7801c0184`) into [[narrative-void]] (which gained a full "The Pre-Selected Material" section) and [[source-attribution-void]]. Three-face structural opacity around the *operation* by which the present becomes the recallable past — the prospective complement to [[inaccessible-past|the inaccessible past]]'s retrospective treatment. Selection (Yang et al. 2024 in *Science*: hippocampal sharp-wave ripples tag specific waking experiences during reward consummation by replaying their population activity, and later sleep SWRs preferentially replay the tagged sequences — a millisecond-scale sub-personal selection of which experiences undergo consolidation; Lindsey & Litwin-Kumar 2024 add recall-gated consolidation: synaptic updates stabilise depending on consistency with prior knowledge the encoder cannot consciously evaluate at encoding time). Boundary (Kurby-Zacks 2008 Event Segmentation Theory and Radvansky-Zacks 2017: at event boundaries, working memory undergoes a "flushing" operation that discards prior-event information — the doorway effect — and Ongchoco & Xu 2024 show flushing occurs *despite active maintenance*, ruling out trivial inattention). Consolidation (Stickgold 2005: sleep-dependent consolidation occurs "automatically, outside of awareness and without intent"; the Henke-lab subliminal-encoding line — Reber et al. 2012; Pacozzi, Knüsel, Ruch & Henke 2022 — documents episodic traces forming *without* conscious encoding, consolidating along trajectories *opposite* to the conscious case, with traces strengthening from 3min to 10h when sleep intervenes). Folds into [[narrative-void|the narrative void]] (encoding-as-storytelling: which fragments survive to become narratively integrable is sub-personally selected, not authored) and [[source-attribution-void|the source-attribution void]] (architectural-layer upstream: the encoding side never writes the source tag that retrieval-time inference later attempts to recover).
- **[[research/voids-participation-void-2026-02-17|The Participation Void]]** — *Folded.* Structural gap between *enacting* consciousness and *representing* it: some dimensions of experience may exist only as enacted and vanish the moment participation ceases. Heidegger's ready-to-hand vs. present-at-hand: the hammer disappears into hammering and is *transformed* by reflective inspection into an object of contemplation that is no longer the thing engaged. Merleau-Ponty's motor intentionality: "between the movement of the body and the world, no form of representation is established" — pre-reflective engagement is ontologically prior to and different from reflective observation. Polanyi's "we know more than we can tell": tacit operations move from clues to indicated wholes by integration that resists propositional articulation without distortion. Ryle's know-how/know-that distinction and the intellectualist-legend regress; Dreyfus's absorbed coping as non-representational responsiveness; Brentano's paradox of introspection — verbal re-representation of non-verbal experience produces false outcomes. The void is *ontological* rather than merely epistemological: participation is not a content waiting to be observed but a mode of being whose objectification *converts* it. Folds into [[agency-void|the agency void]] (motor-intentionality face: the absorbed agent is causally enmeshed with the world through non-representational responsiveness, sharpening the verification-face refusal to be inspected) and [[wholeheartedness-void|the wholeheartedness void]] (engaged-identification face: unreserved participatory engagement that the standing-condition examination would convert into a represented standing-condition rather than reveal in its enacted form).
- **[[research/voids-suggestion-void-2026-08-06|The Suggestion Void]]** — *Surveyed.* Whether a percept, affect, or incapacity was installed by another mind's words is unmonitorable from inside: suggestion re-tunes experience selectively, blunts the very agency gauge that would register it, and contaminates the instrument studying it. Disposition open — standalone, or fold into [[source-attribution-void]] and [[agency-void]].
- **[[research/voids-olfactory-void-2026-08-13|The Olfactory Void]]** — *Absorbed* (2026-08-20) into [[erasure-void]] (absence face), [[language-thought-boundary]] (naming face) and [[imagery-void]] (imagery face). Congenital anosmics grow up unaware anything is missing, and the "universal" inability to name odours proved partly cultural — the catalogue's best-documented calibration case of an unexplorable limit deflating under better sampling.
- **[[research/voids-report-latency-void-2026-08-16|The Report-Latency Void]]** — *Absorbed* (2026-08-17) into [[affective-forecasting-gap]] ("Before Distortion"), with pointers in [[anesthesia-void]], [[sleep-consciousness-void]] and [[erasure-void]]. Every edge-state report opens only after the state ends; one anaesthesia population yields 4.6%, 1:800 or 1:19,600 awareness depending solely on probe latency — all-or-nothing episode loss, not distortion.
- **[[research/voids-summary-statistics-void-2026-08-18|The Summary-Statistics Void]]** — *Absorbed* (2026-08-18) into [[plenitude-void]] as a fourth position in the richness dispute; secondary fold into [[resolution-void]] pending. Consciousness cannot read the representational format of its own percepts: ensemble coding pools the periphery into summary statistics that render as detail, with no marker that pooling occurred.
- **[[research/voids-notation-void-2026-08-19|The Notation Void]]** — *Surveyed.* External notation — numerals, diagrams, formal symbolism — relocates the boundary of the thinkable, and consciousness cannot audit which of its limits are notation-bound (historical / operative / horizon faces). Cross-cutting rather than local, it resists folding; the note names it a candidate for the final slot, an operator decision.
- **[[research/voids-self-signature-void-2026-08-20|The Self-Signature Void]]** — *Absorbed* (2026-08-21) into [[self-opacity]] ("The Signature Face") and [[voids-between-minds]]. A mind cannot perceive the signature of its own outputs — accent, voice, prose fingerprint, bias tilt — because a signature is relational and the self is its own calibration zero: an inversion of privileged access, shared by language models.
- **[[research/voids-reafference-void-2026-08-22|The Reafference Void]]** — *Absorbed* (2026-08-24) into [[predictive-construction-void]] as its fifth mechanism, "The subtraction barrier"; an [[agency-void]] cross-reference deferred on length. Self-caused sensory input is discounted before it reaches awareness, so consciousness receives the verdict, never the comparison — and the felt sense of authorship is downstream of the subtraction.
- **[[research/voids-distributional-void-2026-08-24|The Distributional Void]]** — *Absorbed* (2026-08-24) into [[non-human-minds-as-void-explorers]] ("The Generation Problem"), [[collective-cognitive-limits]] and [[apex/taxonomy-of-voids]]'s method-generated class. Model-mediated inquiry narrows what gets thought — outputs concentrate, assisted writers converge, errors correlate across models — a void whose boundary moves inward with use, consisting of what was never generated.
- **[[research/voids-impairment-void-2026-08-26|The Impairment Void]]** — *Absorbed* (2026-08-27) into [[disappearance-voids]] ("The Gauge That Comes Loose"), correcting its uncited claim that self-assessment fails before performance under sleep deprivation; the acute-state limb for [[anti-correlated-metacognitive-signal]] is pending. Coarse impairment detection mostly works; the residue is a gauge that plateaus, inverts, or is deleted by training.
- **[[research/voids-similarity-void-2026-08-27|The Similarity Void]]** — *Absorbed* (2026-09-01) into [[epistemological-limits-occams-razor]] (Goodman, grue, Quine) and [[non-human-minds-as-void-explorers]] (Hebart et al. 2020); and 2026-09-17 into [[conceptual-scheme-void]] (Goodman, Tversky: the respects face) and, light-touch, [[noetic-feelings-void]] (felt resemblance as a verdict signal). Resemblance arrives as given while the respects and weights that produced it stay sub-personal — recoverable third-personally, not generatable first-personally.
- **[[research/voids-fusion-void-2026-09-02|The Fusion Void]]** — *Published* (2026-09-04) as [[fusion-void]]. Consciousness receives precision-weighted fused percepts — never the component estimates, the reliability weights, or the prior common-cause verdict that licensed fusing at all. Within-modality fusion is mandatory and discards the components (Hillis et al. 2002); the McGurk verdict varies 0–100% across stable individuals (Mallick et al. 2015). A rare void whose own boundary is psychophysically *measured*.
- **[[research/voids-palette-extension-void-2026-09-04|The Palette Extension Void]]** — *Published* (2026-09-04) as [[palette-extension-void]]. The catalogue's existing palette material ([[acquaintance-void]], [[synesthetic-void]]) asks whether a novel phenomenal quality is *conceivable*; this asks whether an *installed* one could be certified as new. The capacity face is deflating fast — Mancuso et al. 2009 added a cone dimension to adult primates against the critical-period prediction, and Fong et al. 2025 produced a percept ("olo") with unequivocally out-of-gamut coordinates. The verification face is untouched: every route from an installed channel back to a novelty claim runs through discrimination or report, both rendered in the prior palette, and Fong's five subjects volunteered "teal" and "green, a little blue" for the out-of-gamut stimulus. Barbur's deflationary reading is the simpler hypothesis *and* unfalsifiable by any available instrument — an unusually clean instance of [[epistemological-limits-occams-razor|parsimony selecting rather than tracking]]. Deflation itself is not new here (olfactory absence, and the [[disappearance-voids|fatigue void]]'s narrowed unexplorable face, precede it); the unfamiliar part is the shape — a limit separating into two questions with opposite fates, which argues that voids can sometimes require *splitting* rather than retiring.
- **[[research/voids-modality-void-2026-09-05|The Modality Void]]** — *Published* (2026-09-06) as [[modality-void]]. Consciousness cannot read its own modality structure: not how many senses it has (the phenomenal-character criterion collapses into the representational one — Macpherson 2011), not which sense delivered a content (retronasal smell experienced as taste in the mouth, Spence 2016; interlaced innocuous warm and cool bars delivered as burning pain, Craig & Bushnell 1994; a McGurk syllable arriving "as a case of hearing" with evidence equal to veridical hearing, Fréchette 2023), and not which sense a rerouted channel belongs to (Hurley & Noë's dominance versus deference; rewired ferrets, von Melchner, Pallas & Sur 2000). A channel-tag void, and a first-person limit third-person science can recover.
