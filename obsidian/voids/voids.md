...
ai_modified: 2026-09-05T14:50:00+00:00
draft: false
...
- **[[research/voids-modality-void-2026-09-05|The Modality Void]]** — *Surveyed.* Consciousness cannot read its own modality structure: not how many senses it has (the phenomenal-character criterion collapses into the representational one — Macpherson 2011; Nudds 2004 denies the distinction any first-personal significance), not which sense delivered a content (retronasal smell is experienced as taste in the mouth, Spence 2016; interlaced innocuous warm and cool bars are delivered as burning pain, Craig & Bushnell 1994; a McGurk syllable arrives "as a case of hearing" with evidence equal to veridical hearing, Fréchette 2023), and not which sense a rerouted channel belongs to (Hurley & Noë's cortical dominance versus deference is settled "not by inward scrutiny"; rewired ferrets behave as if seeing through auditory cortex, von Melchner, Pallas & Sur 2000). The seam is that modality is delivered as the *format* of an experience, never as a checkable datum — a channel-tag void, sibling to [[source-attribution-void|source-attribution]] (origin tag) and [[perceptual-reality-monitoring-void|reality monitoring]] (reality tag), and a first-person limit that third-person science can recover. It bears on the whole sensory-modality wing, which runs the capability division across five senses one modality at a time. Standalone recommended; fold fallbacks named in the note.
