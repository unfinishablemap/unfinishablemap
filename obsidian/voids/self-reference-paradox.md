...
Large language models lack the biological self-model that generates human subjectivity. They have no phenomenal experience of being a self (if the project's [[tenets#^dualism|dualism]] is correct). The "transparency" that hides our mental machinery from us may not apply to systems without that machinery.
...
The self-reference paradox connects to all five of the project's [[tenets]], though the connections vary in nature:
...
**[[tenets#^dualism|Dualism]]** gains indirect support. If consciousness cannot fully model itself, this doesn't prove dualism but is consistent with it. A non-physical aspect of mind might be precisely what escapes self-modeling—the [[hard-problem-of-consciousness|hard problem]] residing permanently in the void. Materialism promises complete explanation; if self-reference creates structural limits on self-explanation, some explanatory gap is guaranteed regardless of how much neuroscience advances.
