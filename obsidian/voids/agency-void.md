...
**Emotional valence and desire.** Cognitive reframing alters interpretation, but raw affective tone arrives involuntarily—mapped by the [[affective-void]]. Even what we desire is not chosen but given (the [[appetitive-void]]). Schopenhauer took this seriously: the will is "blind, irrational striving" that operates through us rather than for us.

**Ownership.** As the [[ownership-void]] documents, experience arrives already tagged as *mine*. You cannot disown a headache. The mineness is built in prior to any choice—what Zahavi calls "pre-reflective self-awareness."
...
**Structural opacity.** Metzinger (2003) argues the phenomenal self-model is "transparent"—we cannot introspect the mechanisms generating experience. If you cannot see the control surface, you cannot operate it. This connects to [[self-opacity|volitional opacity]]: the mechanisms of consciousness are hidden from the consciousness they produce.
...
**Suffering and ownership.** The involuntariness becomes acutely visible in pain—the realisation that you cannot stop hurting, cannot exit the experience. Yet the experience is irrevocably mine: you cannot disown a migraine. The [[ownership-void]] explores this from the direction of appropriation; here it appears from the direction of consent. You did not agree to own this experience, yet it is inescapably yours.
...
- [[disappearance-voids]] — When peak experience eliminates reflective access
...
4. Laukkonen, R.E., et al. (2023). "Cessations of Consciousness in Meditation: Advancing a Scientific Understanding of Nirodha Samapatti." *Progress in Brain Research*, 280.
...
7. Montupil, J., et al. (2023). "The Nature of Consciousness in Anaesthesia." *BJA Open*, 8, 100224.
8. Schopenhauer, A. (1818/1966). *The World as Will and Representation*. Dover Publications.
9. Schurger, A., Sitt, J.D., & Dehaene, S. (2012). "An Accumulator Model for Spontaneous Neural Activity Prior to Self-Initiated Movement." *PNAS*, 109(42), E2904–E2913.
...
11. Velmans, M. (2020). "The Causal Efficacy of Consciousness." *Entropy*, 22(8), 823.
12. Wegner, D.M. (2002). *The Illusion of Conscious Will*. MIT Press.
13. Zahavi, D. (2005/2014). *Subjectivity and Selfhood: Investigating the First-Person Perspective*. MIT Press.
