...
[[decision-void|The decision void]] targets a within-agency case—the deliberation→commitment crossing—on its own three-face conjunction (closure, latency, reconstruction). Agency-void catalogues limits on agency *in general*; decision-void targets the opacity at the moment possibilities collapse into a single choice.
...
**Ownership.** Experience arrives already tagged as *mine* ([[ownership-void]]); contemplative-clinical work shows practitioners can attenuate this tag on nociceptive signal only gradually and incompletely.
...
The clinical sister case is the [[erasure-void]]: in anosognosia, the neural infrastructure for self-monitoring shares fate with what it would monitor. The structural sister is the [[suspension-void]]: withholding judgment, like causing action, is a faculty whose only investigator is itself. When opposing positions both fail verification for structural reasons, the failure inheres in the question's architecture.

### Reflexive Self-Stultification

The same structure catches this article's argument: the claim "consciousness cannot verify its own causation" is itself a verification claim made by consciousness. The Map accepts this as part of the void's signature—the meta-claim is third-person-supportable, its evidence the cross-study circularity pattern rather than introspection (cf. [[meta-epistemology-of-limits]]). A critic will call reflexive application incoherent; the disagreement is bedrock ([[self-maintained-cognitive-limits|self-maintained cognitive limits]]).
...
**Interface constraint (conjectural).** The causal interface may run only outward—consciousness acting on quantum states in neural tissue without those acting back as a controllable substrate for the conscious states themselves. No mechanism for this asymmetry has been specified; the Map flags it as a candidate for whatever [[causal-interface|causal interface]] account emerges.
...
**The vanishing target.** When you try to catch yourself causing something, the observation becomes the object; the causal act recedes behind it—the [[tacit-integration-void|tacit-integration]] structure applied to causal self-inspection. Catching one's own *deciding* is the closure face of [[decision-void|the decision void]]: a sealed event admitting no slow-motion view.
