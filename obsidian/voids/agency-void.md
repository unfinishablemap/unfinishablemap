...
This two-face structure is the cleanest case of the editorial discipline articulated in [[conjunction-coalesce|the conjunction-coalesce]]: a merger that keeps the seam visible because the seam itself is the analytical claim. The agency void is not two adjacent limits awkwardly housed together but a single void whose informativeness lies in the conjunction—and the synthesising apex piece treats it as the exemplar.
...
**Sensory content and qualia.** Open your eyes and vision arrives. A loud sound intrudes regardless of preference. You cannot choose what red looks like or what pain feels like; the qualitative character of experience is fixed by mechanisms opaque to introspection.

**Emotional valence and desire.** Raw affective tone arrives involuntarily ([[affective-void]]); even what we desire is given, not chosen ([[appetitive-void]]). Schopenhauer's *will* is the historical anchor: the basal striving from which the deliberating subject crystallises, not a faculty that subject controls.
...
Set aside *how much* consciousness controls and ask the prior question: does it control *anything*? Two senses of *verify* must be separated. *First-person verification*—consciousness checking its own causal powers from inside—is structurally circular: every check is performed by the faculty under investigation, and every check is itself an inference whose grounding is the same opacity catalogued by the [[inference-void]]. *Third-person verification* (TMS, anaesthesia titration, anarchic-hand cases) faces the *inverse access problem*: it correlates brain activity with reported experience and behaviour without isolating the contribution of phenomenal consciousness as such. A thermometer can be checked against another thermometer; consciousness checking its own causal powers has no external reference point.

### The Self-Stultification Symmetry

Both sides of the agency debate face the same barrier.

**[[epiphenomenalism|Epiphenomenalism]] cannot verify itself.** If consciousness is causally inert, the belief "consciousness is causally inert" was not caused by consciousness either. De Brigard (2014) presses this through a causal theory of knowledge on which epiphenomenalism severs the connection between experience and beliefs about experience. The causal theory is contested, so the Map's use is conditional: *if* knowledge of one's own experience requires some causal traffic from experience to belief, epiphenomenalism cannot meet the condition.
...
**Timing.** Libet (1983) found the readiness potential precedes conscious awareness of deciding by ~350ms. Schurger, Sitt, and Dehaene (2012) reinterpreted this as spontaneous neural noise crossing a threshold—rescuing consciousness from being *disproved* as a cause without establishing it *as* a cause.
...
**Intervention.** Causal-dissociation experiments do the work pure observation cannot. TMS to the supplementary motor area can induce movement urges and override intended actions; propofol titration dissociates phenomenal access from motor responsiveness; anarchic-hand cases naturally separate the two. Haggard et al. (2002) show *intentional binding*—temporal compression between voluntary action and effect—dissociable from objective causation. These probe whether disrupting neural correlates of conscious access also disrupts motor causation, but inherit the *inverse access problem*. Intervention sharpens the verification void rather than closing it.

## The Sovereignty Paradox

If consciousness is non-physical and causally efficacious, why can it not influence its own states more directly? The causal arrow appears asymmetric: consciousness can bias physical processes but cannot directly govern its own phenomenal character. Two structural conjectures and one contingent rival:
...
**Structural opacity.** Metzinger (2003) argues the phenomenal self-model is "transparent"—we cannot introspect the mechanisms generating experience. If you cannot see the control surface, you cannot operate it. This connects to [[self-opacity|volitional opacity]].

**Functional necessity (the contingent rival).** Organisms that could voluntarily shut off pain or freely alter emotional valence would plausibly be selected against (Damasio 1994). On this story the asymmetry is *contingent*—an engineered consciousness could in principle have the missing self-control. Functional necessity locates the asymmetry in selection pressure rather than consciousness-physics architecture. The Map's bet is that residual asymmetry remains even after the contingent story does its work—particularly the verification void, which no selection-pressure account dissolves.
...
**The vanishing target.** When you try to catch yourself causing something, the observation becomes the object. You observe yourself observing, and the causal act recedes behind the observation. This is the [[tacit-integration-void|tacit-integration]] structure applied to causal self-inspection: the doing bears on outcomes by *not* being focal, and looking directly at the doing collapses what it carries.

**The meditation edge.** Contemplative approaches to cessation involve a paradox of effortful effortlessness. Nirodha comes not from intensified control but from relinquishing the attempt while maintaining precise conditions. Thompson (2014) documents how waking, dreaming, and deep sleep reveal different relationships between consciousness and voluntary control—the boundary is state-dependent, not fixed.
