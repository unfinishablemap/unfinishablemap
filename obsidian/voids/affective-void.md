...
**Psychedelic and mystical experiences approach boundaries.** These states are characterised by profound alterations in affect combined with *ineffability*—subjects report certainty that they experienced something they cannot describe. The ineffability is not simply failure of language but may mark the edge of human affective space. The "something more" feeling that dissolves when articulated may be contact with affects our normal conceptual apparatus cannot hold.
