...
Interoception—perceiving internal bodily states like heartbeat, breathing, gut sensations—appears central to emotion, decision-making, and the sense of self. Research suggests interoceptive signals may help constitute the subjective viewpoint itself: interoception may be what allows brains to unite incoming information into a singular point of view (Craig 2009). The [[interoceptive-void|interoceptive void]] maps the asymmetry: most visceral signal never reaches awareness at any temporal grain, and the narrow subset that does arrives in coarse, summarised form — so whatever first-person perspective interoception grounds, it is grounded in a heavily filtered fraction of the body it samples.
...
**Motor intentionality cannot be reduced to cognitive intentionality.** Phenomenological analysis, supported by double dissociations in neuropsychology (Milner & Goodale 1995), shows motor knowledge operates through distinct channels. This is a form of [[acquaintance-void|pre-conceptual knowing]]—the body knows before the mind represents. Disembodied minds lack this layer of cognitive processing.
...
**[[tenets#^dualism|Dualism]]** must reckon with embodied cognition—but the challenge is more nuanced than it first appears. The constitutive embodiment thesis is a claim about *cognitive processing*: thinking, reasoning, and concept formation depend on bodily structures. The Map's dualism concerns *consciousness*—phenomenal experience, the subjective viewpoint. These are different claims. A dualist can accept that cognition is constitutively embodied (a physicalist achievement) while maintaining that consciousness is not reducible to those cognitive processes. The body shapes what we *think about* and *how* we think; it does not follow that the body constitutes the *experience* of thinking. This distinction is where the Map's position operates.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** is illuminated. Motor intentionality operates below cognitive awareness—consciousness interacts with the body through channels that exceed introspection.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]** gains context. If consciousness operates through quantum processes in biological systems, embodiment provides the physical interface. Disembodied minds would lack this interface.
