...
[[illusionism|Illusionists]] argue there is no substantial self to observe—only representations representing representations. The regression of attention is simply the brain's self-modeling processes iterating, physical computations without any irreducible observer.
