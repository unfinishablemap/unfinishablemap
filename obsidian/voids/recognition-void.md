...
modified: 2026-03-22
human_modified:
ai_modified: 2026-04-23T20:18:00+00:00
...
This void has two faces. The first is **mechanism opacity**: you cannot introspect on how recognition works, only receive its products — a specific instance of the broader [[self-opacity|introspective opacity]] that characterises all cognitive processes. The second is **inventory blindness**: you cannot take stock of what your recognition capacities fail to reach — absent capabilities produce no signal.
...
Most voids on the Map produce characteristic phenomenology at their edges. The [[scale-void|scale void]] produces vertigo. The [[self-opacity|self-reference paradox]] produces the strange-loop sensation. The [[phenomenology-of-the-edge|edge phenomenology]] article catalogues these signatures.
