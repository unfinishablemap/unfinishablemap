...
*Boundary marking.* The void is approached by [[apophatic-cartography|mapping the structure of failure]] — where collapse begins, what remains stable on either side — rather than by penetrating it.
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]** is the most directly engaged tenet. The void is a precise case where simplification by analytical decomposition *destroys* the phenomenon being analysed — a counterexample to the assumption that simplicity-via-decomposition is always epistemically conservative.

**[[tenets#^dualism|Dualism]]** is engaged substantively. If consciousness reduced to neural information processing, the from-to relation would be specifiable as a pattern of activation. Polanyi's argument cuts the other way: the relation is constitutive and resists specification. This does not prove dualism, but it preserves the structural pressure that motivates it.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** finds an unusual case. The felt sense functions causally — guiding articulation, action, decision — without being decomposable into representations. Gendlin's *felt shift* has effects in the world but cannot be inspected as the kind of thing that has causes: consciousness exerting causal influence without becoming an object available to causal explanation.
