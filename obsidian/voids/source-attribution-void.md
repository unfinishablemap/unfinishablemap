...
modified: 2026-04-21
human_modified:
ai_modified: 2026-04-21T17:55:00+00:00
draft: false
topics:
  - "[[philosophy-of-mind]]"
  - "[[consciousness]]"
...
Consciousness encounters its own contents already detached from their origin. A thought arrives and feels like *mine*; a belief feels reasoned-into; an intuition feels evident—yet nothing in the content itself specifies where it came from. The Unfinishable Map names the source-attribution void for the structural inability of consciousness to determine, from inside, whether a given mental content was self-generated, implanted by suggestion, primed by recent context, retrieved from forgotten exposure, or confabulated post-hoc to rationalise an outcome. Mental content lacks native origin tags. What introspection delivers is reconstruction, not readout.

This void is distinct from neighbouring limits. The [[self-opacity]] void concerns mechanism-blindness in general—the inaccessibility of the machinery producing thought. The [[thought-stream-void]] concerns the arising and vanishing of mental content. The [[narrative-void]] concerns the construction of coherent self-stories from fragmentary experience. The source-attribution void sits at a sharper point: even when machinery and arising are granted, the *origin tag* for any given thought is not the kind of thing introspection delivers. Origin is inferred from surface features—vividness, fluency, narrative fit with self-image—and the inference is reliably wrong in characteristic conditions.
...
The [[tenets#^dualism|Dualism]] tenet is engaged sharply by this void. If consciousness is a fundamental, non-physical aspect of reality, it is metaphysically peculiar that it should lack knowledge of what is its own—that the most basic property a fundamental subject might be expected to have, knowledge of which contents originate with itself, is precisely the property the evidence falsifies. The Map reads this as a deflationary constraint on phenomenal authority. Dualism entails only that there is something it is like; it does not entail rich introspective access. The [[phenomenal-authority-and-first-person-evidence|phenomenal authority]] first-person testimony has on *what* is experienced does not extend to *where* the experience came from. These are different epistemic capacities, and the void marks the boundary.

### Bidirectional Interaction

The [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet is engaged from a different angle. If consciousness causally influences physical processes—if mind-side origination is a real category in the Map's ontology—then the absence of a native phenomenal tag for "this thought was originated by me, mind-side" is a notable lacuna. It is the place one might expect the interface to leave a marker, if architectural markers of the interface were available. The void coheres with the [[interface-formalization-void]]: the interface does not present its own operations to the consciousness it serves. Mind-side origination may be real and still phenomenally unmarked.

### Occam's Razor Has Limits

The [[tenets#^occams-limits|Occam's Razor Has Limits]] tenet is engaged structurally. The simplest model—"I know my own thoughts because they are mine"—is precisely the one the evidence falsifies. Source attribution is irreducibly inferential, probabilistic, and prone to characteristic collapses. No compression to direct readout survives the data. Parsimony that would identify thought-origin with phenomenal felt-origin loses the entire attribution phenomenon.
...
2. **First-person testimony has bounded weight on origin questions** even when it has full weight on phenomenal content. Knowing what you experience and knowing where the experience came from are different epistemic capacities with different supports.
3. **The void may be self-maintained.** If every thought arrived with full provenance—implanted by suggestion at 14:32, primed by the headline read at 14:28, retrieved from a forgotten textbook page—the narrative integration that constitutes the felt-self might be impossible. In the [[self-maintained-cognitive-limits]] sense, the void may be protected because exposing it would destabilise the system it serves.
