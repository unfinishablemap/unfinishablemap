...
The void is neutral between physicalism and dualism as an explanation: every cited finding is fully accounted for by reconstructive-cognition physicalism, and a dualist reading adds no empirical purchase. The Map's commitment to the [[tenets#^dualism|Dualism]] tenet is defended on broader grounds articulated elsewhere on the site. What the void offers here is compatibility, not evidence. The specific way it is compatible is a deflationary constraint on phenomenal authority: dualism entails only that there is something it is like; it does not entail rich introspective access. The [[phenomenal-authority-and-first-person-evidence|phenomenal authority]] first-person testimony has on *what* is experienced does not extend to *where* the experience came from. These are different epistemic capacities, and the void marks the boundary. A Map that uses this void to support dualism would be inverting the relation—the evidence constrains what dualism may claim, not what dualism may be inferred from.

### Bidirectional Interaction

The [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet is engaged from a different angle. If consciousness causally influences physical processes—if mind-side origination is a real category in the Map's ontology—then one might naively expect a native phenomenal tag for "this thought was originated by me, mind-side." The evidence finds no such tag. This passage is coherence-with-the-tenet, not evidential support for it: if the interface leaves no phenomenal markers—as the Map elsewhere argues is likely, and as the [[interface-formalization-void]] independently holds—the absence of a felt tag for mind-side origination is expected, not informative. A critic is right to note that a markerless interface is, from the subject's side, observationally indistinguishable from no interface; any evidential case for bidirectional interaction therefore has to be made elsewhere, through statistical or behavioural traces rather than phenomenal ones.
