...
The void sits adjacent to the [[decision-void]] in the agency family. Where the decision-void concerns the *crossing* from deliberation to commitment, the wholeheartedness-void concerns the *standing condition* of being identified-with — and both share architecture with the [[suspension-void]] and the [[agency-void]]: the faculty under investigation is the only available investigator. The void engages [[tenets#^bidirectional-interaction|Bidirectional Interaction]] obliquely (the standing-identification state as a candidate site for the persistent shape of any non-physical influence on action) and [[tenets#^occams-limits|Occam's Razor Has Limits]] directly: decision-theoretic parsimony absorbs identification into "stable preferences that move action," and Watson (on the regress), Velleman (on disownability), and Bratman (on planning-theoretic identification) each press, in distinct argumentative registers, that what the operationalisation captures is not what the original theory was reaching for.
