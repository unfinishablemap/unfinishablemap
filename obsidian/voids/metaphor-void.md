...
Blumenberg's later work on *Unbegrifflichkeit* (nonconceptuality) argued that metaphorics are "an authentic way of grasping connections"—not a placeholder for future concepts but a permanent cognitive mode. This reframes the metaphor void. If some cognitive domains are genuinely nonconceptual, the dependence on metaphor is not a local failure of vocabulary but a structural feature of the domain itself. The gap that absolute metaphors fill may correspond to territory that literal language is constitutively unable to reach.
