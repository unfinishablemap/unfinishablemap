...
[[quantum-darwinism-and-consciousness|The quantum Darwinism article]] names the defeater honestly: the Map's proposal faces serious difficulty if the improper/proper distinction were shown to be physically empty—for instance by a no-go theorem that decoherence alone necessarily produces definite outcomes. The foundations literature lets that defeater be stated more precisely, and the precision strengthens rather than softens it.
...
- [[testing-consciousness-collapse]] — the objective-collapse route of the trilemma
- [[many-worlds-argument]] — the Everett route of the trilemma
