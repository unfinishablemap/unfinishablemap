---
title: "Improper vs. Proper Mixtures"
description: "What separates improper from proper mixtures, why decoherence leaves the outcome open, and how much weight the contested distinction can honestly carry."
created: 2026-09-03
modified: 2026-09-03
human_modified:
ai_modified: 2026-09-17T01:52:48+00:00
draft: false
topics:
...
last_curated:
last_deep_review: 2026-09-03T02:58:47+00:00
---
...
The neutral core is uncontroversial: nobody disputes that the two *global* descriptions—an entangled pure state versus a genuine ensemble of definite states—are formally different, and that the identity holds only at the level of the subsystem's reduced density matrix. What is contested is whether that difference carries ontological weight for the subsystem. The Unfinishable Map's post-decoherence framework rests on the reading that it does: because [[decoherence]] produces improper mixtures, the formalism licenses no conclusion that one outcome already obtains, and the resulting outcome gap is where the Map proposes consciousness acts ([[post-decoherence-selection]]). That reading is a contested interpretive commitment, not a result of the formalism—whether the distinction matters at all depends on what one takes a quantum state to be. The distinction is stated neutrally first; d'Espagnat's argument, its [[#detectability|empirical detectability]] (assessed below), and the [[#trilemma|four genuine defeater routes]] (also below) follow.

## Two Preparations, One Density Matrix

Prepare an ensemble by flipping a fair coin and sending each system into one of two orthogonal states accordingly. Each member is definitely in one state; the fifty-fifty statistics express ignorance. That is a proper mixture—in Schlosshauer's 2004 terminology, "an 'ignorance-interpretable,' or 'proper' ensemble."

Now let a system become entangled with its environment and describe the system alone by tracing the environment out. The reduced density matrix can be numerically identical to the coin-flip ensemble's, yet no member of this ensemble is in a definite state the tracing merely hides: the complete description is the entangled global state, and that state assigns the subsystem no definite value at all. Decoherence produces exactly these improper mixtures: as Schlosshauer's 2004 review puts it, after decoherence "the resulting reduced density matrix would represent an improper mixture, with no outcome having been singled out."
...
Two calibrations follow. First, the argument is not a formal theorem, and presenting it as one overstates it—d'Espagnat himself did not. Second, his own metaphysics ("veiled reality," open realism) is adjacent to, not identical with, the Map's interactionism; the Map inherits his distinction, not his conclusions.
...
The Map's [[project/evidential-status-discipline|evidential-status discipline]] requires any page making a quantum-interpretive move to state plainly whether the distinction it leans on is empirically detectable—locally, or at all.

**Locally, in the irreversible macroscopic regime: no.** An improper and a proper mixture sharing a reduced density matrix are indistinguishable by any measurement on the system alone, and once decoherence is effectively irreversible, embedded observers with finite resources get identical predictions from both descriptions. Nothing in the Map's framework closes this gap—the FAPP gap is the gap the framework occupies ([[forward-in-time-conscious-selection]]).
...
The most philosophically serious version of the rejoinder does not deny the distinction; it removes the need for conversion. Wallace's Everettian defence of FAPP reasoning holds that the branching structure decoherence defines is emergent yet real, in the way higher-level ontology is real elsewhere in science, and that nothing needs to turn the improper mixture into one definite outcome because every element is actualised in some branch. The Map's answer to Wallace runs through [[tenets#^no-many-worlds|Tenet 4]] and the indexical-identity case argued at [[many-worlds-argument|The Map's Case for One-World Actuality]]—not through denying the operational equivalence he starts from.
...
1. **Empirically confirmed objective collapse.** New non-unitary dynamics could produce proper mixtures physically. This route is real, testable and already being narrowed: the Gran Sasso underground search for the spontaneous radiation such dynamics predict rules out the natural parameter-free version of the Diósi–Penrose model (Donadi et al. 2020). The Map tracks the wider programme in [[testing-consciousness-collapse]]; confirmation of such dynamics would fix the baseline the Map's [[prebiotic-collapse|prebiotic resolution]] already assumes; only a regime leaving no neural slack would remove the locus where consciousness is proposed to act.
2. **Everett.** Accept that no single outcome is selected. Tenet 4 territory, adjudicated at [[many-worlds-argument]]—a full interpretive commitment, not a deflation of one distinction.
...
The [[tenets#^occams-limits|Occam's Razor Has Limits]] tenet frames the whole dispute. "Do not draw distinctions without observable differences" is a parsimony maxim, and this is a boundary case where its reliability depends on prior commitments about what quantum states are. That the two flagship deflationists deflate in opposite directions is evidence that "the simpler reading" is not even uniquely defined here.

## Further Reading

- [[post-decoherence-selection]] — the concept that rests on this distinction
- [[quantum-darwinism-and-consciousness]] — the defeater restated here
- [[forward-in-time-conscious-selection]] — the FAPP-invisibility framing
- [[post-decoherence-selection-programme]] — apex synthesis
- [[decoherence]] and [[measurement-problem]]
- [[testing-consciousness-collapse]] — the objective-collapse defeater route
- [[many-worlds-argument]] — the Everett defeater route
- [[born-rule-and-the-consciousness-interface]] — selection within Born statistics
- [[envariance]] — Zurek's entanglement-symmetry derivation of the Born measure, which fixes the form of the probabilities while leaving single-outcome actuality open
