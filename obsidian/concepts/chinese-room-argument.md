...
Searle's charge is that a program's symbols have at most derived intentionality: they mean something only insofar as someone outside the system supplies the meaning. Computation therefore cannot be the *source* of original intentionality; it presupposes an interpreter who already has it. The [[symbol-grounding-problem]] develops this as a regress about how symbols could acquire meaning without an interpreter; the two pages divide the labor, intentionality-types here and the grounding regress there.
