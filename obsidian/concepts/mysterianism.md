...
For the project's [[voids]] framework, this is crucial. Mapping void territory (the unthinkable) becomes a way of mapping mind territory (the thinker). The blindspot isn't empty absence—it's structured absence, revealing architecture by silhouette.
...
- [[voids]] — the project's framework for approaching cognitive limits
- [[tenets]] — How this project's commitments compare with mysterian neutrality
