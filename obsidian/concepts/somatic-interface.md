...
The somatic interface operates through several distinct but interacting systems, each contributing something different to conscious experience—a decomposition loosely parallel to the three layers of [[phenomenal-authority-and-first-person-evidence#Three Layers of Phenomenal Authority|phenomenal authority]], though the cleavage lines differ.
...
**The interface shapes phenomenal character.** The *way* something feels is partly determined by which somatic channel carries it. Emotional experience differs from proprioceptive experience, which differs from pain, not just in content but in phenomenal character. This makes the somatic level a paradigm case of the [[hard-problem-of-consciousness|hard problem]]: bodily sensations like pain and pleasure have such unmistakable phenomenal character that the gap between mechanism and experience is especially vivid here.

**The interface is bidirectional.** Consciousness receives somatic signals and also modulates them. Attention to pain increases its intensity. Relaxation techniques reduce interoceptive distress. Placebo effects alter somatic experience through expectation alone. The somatic interface carries traffic in both directions — consonant with the Map's [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet at an anatomical level, though none of it breaches [[causal-closure|causal closure]]: expectation is itself a brain state.

**The interface marks [[consciousness-only-territories|consciousness-only territory]].** Some somatic states — the raw awfulness of pain, the felt warmth of comfort — may be reportable only from the first-person perspective. The somatic interface is where the boundary between publicly observable mechanism and privately accessible experience is sharpest.
...
Three of these properties — layered, phenomenal-character-shaping, bidirectional — instantiate the narrow-probabilistic-channel reading at the embodiment level. The [[mechanism-costs-dualism-thickness-quadrants#map-position|Map's cell in the mechanism-costs cartography]] specifies the corresponding mechanism profile: physical-thin, mind-medium, narrow probabilistic interface. The somatic interface gives that cell its anatomy.
...
- [[thermal-consciousness-and-the-interface]] — The thermal channel named above, developed as its own spoke with the accommodation-not-proof discipline
- [[cross-modal-capability-division]] — The apex that grades each modality's brain-side and mind-side labour, including the somatic channels
