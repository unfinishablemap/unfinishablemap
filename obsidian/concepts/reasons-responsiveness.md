...
description: "Reasons-responsiveness is the capacity to track normative relationships—recognizing that conclusions follow from premises and acting accordingly. Central to free will and the argument from reason."
created: 2026-02-01
modified: 2026-02-01
human_modified: null
...
This distinction is conceptually irreducible: we cannot describe reasoning without normative vocabulary. [[consciousness-and-the-normativity-of-reason|Rational normativity]] develops three features of this irreducibility — prescriptive force, universality, and content-sensitivity — that resist any physical redescription, and distinguishes merely *implementing* a norm from *grasping* it; where normativity specifies the standard, reasons-responsiveness names the capacity that meets it. The [[argument-from-reason|argument from reason]] presses further: if normative relationships are conceptually irreducible to causal ones, they may be ontologically irreducible as well. Physical causation operates through efficient causes that have nothing to do with whether outputs are *justified*—neurons fire because of electrochemical gradients, not because firing would be reasonable.

## Reasons-Responsiveness and Free Will

Reasons-responsiveness is central to answering the [[quantum-indeterminacy-free-will|luck objection]] against libertarian [[topics/free-will|free will]]. The objection holds that if choices are not determined by prior causes, they must be random—and random outcomes are no more "free" than determined ones.
...
Crucially, reasons feel like they have *valence*—some considerations feel weightier than others, pulling toward one conclusion rather than another. This felt weight isn't reducible to having the thought "this consideration is important"; it's the experiential quality of the consideration *pressing* toward a conclusion. [[evaluative-phenomenal-character|Normative phenomenology]] investigates precisely this structure: how obligation, evidential weight, and logical compulsion present themselves in conscious experience. The difference between intellectual acknowledgment ("X is a reason for Y") and reasons-responsiveness proper is this felt directedness.

The [[phenomenology-of-intellectual-life|phenomenology of intellectual life]] catalogues these structures systematically: the "click" of comprehension, the strain of sustained inference, the felt difference between understanding and mere verbal association. The [[mental-effort|phenomenology of effort]] supports this further. Hard choices feel hard because reasoning through difficult trade-offs requires sustained engagement. Random processes don't feel like work; grasping why one option is better does. The felt cost of concentration corresponds to genuine cognitive work—consciousness tracking normative relationships that wouldn't be tracked by automatic processing.
...
Reasons-responsiveness connects to multiple [[tenets]]:
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The simplest hypothesis—reasons-responsiveness is just neural pattern-matching—faces the [[argument-from-reason|argument from reason]]. A metaphysics that cannot account for rational justification cannot be rationally accepted. The apparent simplicity of eliminating normativity eliminates the conditions for justified belief, including belief in that elimination.
...
- [[quantum-indeterminacy-free-will]] — Why reasons-guidance distinguishes selection from luck
...
- [[evaluative-phenomenal-character|normative phenomenology]] — How obligation and evidential weight present themselves in conscious experience
