...
last_curated: null
last_deep_review: 2026-07-09T09:04:20+00:00
---
...
The model is intentionally agnostic about consciousness's ultimate nature—whether Mind at Large (Huxley), a fundamental aspect of reality, or something else. The functional claim is what matters: consciousness doesn't require this brain for its existence, even if it requires this brain for its current manifestation.
...
Stapp's [[quantum-consciousness#Quantum Zeno Effect (Stapp)|quantum Zeno mechanism]] proposes the details: attention corresponds to repeated quantum observations that hold neural patterns in place. The mechanism faces a significant timescale gap—Zeno freezing requires femtosecond-rate observations while attention operates on ~100ms timescales—making it better understood as a promising placeholder than a fully worked-out mechanism. Stapp's approach is the most physically committed member of a wider [[pragmatist-quantum-foundations-and-the-agent|pragmatist family]] (QBism, Healey, Brukner-Zeilinger) that independently converges on agent-centrality at measurement, supplying structural support for locating Layer 2 at collapse. The [[concepts/consciousness-selecting-neural-patterns|detailed selection mechanism article]] covers candidate sites, constraints, and the timescale problem.
...
If consciousness selects quantum outcomes but isn't independent of brains, the framework collapses into quantum emergentism. The hard problem returns in full force—you need an emergence story that decades of effort have failed to produce. And the mechanism becomes circular: consciousness emerges from quantum processes and then selects among them, making the selector part of the system it's supposed to select within.

### Without Layer 2 (Filter Only)

If consciousness exists independently but cannot act on the brain, the framework becomes epiphenomenal. The Map's [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet requires causal influence. Pure filter theory cannot explain why directed attention reshapes brains (Schwartz's OCD work), why deliberation feels effortful, or why consciousness seems to make a difference to behaviour.

### What the Combination Provides

Layer 1 addresses *where consciousness comes from* (not the brain—correlation doesn't entail production). Layer 2 addresses *how consciousness acts* (quantum selection—mental causation without violating physical law). Neither layer alone avoids both the hard problem and epiphenomenalism. Both layers are needed because they solve different problems.

## What Each Layer Explains

### Filter Theory Handles:

**Correlation without production**: The brain is an interface—its configuration determines what aspects of consciousness manifest. Correlation doesn't require identity.

**Anomalous phenomenology**: Under psychedelics, default-mode network activity decreases while subjects report vivid phenomenology. Filter theory predicts this: reduced filtering allows more consciousness through. NDEs and covert consciousness similarly fit the filter prediction, though production theory can also account for these through neural disinhibition and preserved processing respectively. The evidence is suggestive rather than decisive—see [[filter-theory]] for detailed treatment.

**The hard problem reframe**: Filter theory doesn't solve why experience exists—but it doesn't create the problem either. Production models must explain how neural activity generates qualia; filter theory can remain agnostic about consciousness's ultimate nature.

### Quantum Selection Handles:

**Causal efficacy**: Consciousness operates at quantum indeterminacies—completing what physics leaves open rather than overriding what physics determines. The [[mathematical-structure-of-the-consciousness-physics-interface|mathematical structure of the interface]] constrains this selection to a narrow corridor: consciousness must preserve Born-rule statistics at the ensemble level, respect the Hilbert-space inner product, and introduce no higher-order interference. How narrow that corridor is becomes a locating coordinate in its own right—the [[dualism-channel-width-axis|channel-width axis]] develops interface narrowness as a third axis for dualist positions. The [[consciousness-physics-interface-formalism]] defines the formal components any such interaction requires—a physical state space P, an experiential state space E, and a coupling map C: E × P → P—along with five non-negotiable constraints C must satisfy. Selection is genuine but mathematically bounded.
...
**Free will**: Quantum indeterminacy provides openness; consciousness provides determination. Whether non-physical determination constitutes genuine freedom remains debated—see [[topics/free-will]].

**The attention-effort match**: On the quantum Zeno mechanism, sustained attention requires repeated mental observations. The phenomenology of effort reflects genuine work being done.
...
**Why are some brain processes accessible and others not?** The interface has structure. Consciousness shapes what reaches the [[attention-as-interface|attention]] system; it can only select among options that reach awareness. Unconscious processing doesn't present alternatives to select among.

## Testability

The model is underdetermined by current evidence—consistent with it but not yet decisively favoured over alternatives. The hard problem remains unsolved (supporting Layer 1); decoherence doesn't close quantum collapse (leaving room for Layer 2). But psychedelic and NDE phenomenology equally fit production-theory disinhibition accounts, and Schwartz's OCD results are explainable through standard neuroplasticity.

Specific findings could undermine either layer: a physical explanation for qualia would make Layer 1 unnecessary; proof that decoherence eliminates all room for non-physical selection would defeat Layer 2; confirmation of MWI would make genuine selection illusory (see [[concepts/many-worlds]]). The framework is better described as underdetermined than unfalsifiable—this underdetermination is shared by all consciousness theories.

## The Decoherence Challenge

A critical objection to Layer 2: [[decoherence]] destroys quantum coherence in warm biological systems within femtoseconds. Three considerations mitigate this.
...
**Decoherence doesn't solve collapse**: Decoherence selects preferred bases without explaining why we see *definite* outcomes. As the [[measurement-problem]] article details, something must still determine which possibility becomes actual. The role for consciousness at collapse remains open.
...
**"Two metaphors stapled together"**: All consciousness frameworks are metaphorical—"production" no less than "filtering." What matters is complementary explanatory work. Without Layer 1, the hard problem returns; without Layer 2, consciousness becomes epiphenomenal. The layers address different questions and their combination explains bidirectional causation in ways neither manages alone.

**"What is the 'source' exactly?"**: The model is intentionally agnostic about consciousness's ultimate nature. We don't need to know what radio waves *are* to understand that radios receive rather than generate them. The functional claim carries explanatory weight independent of deeper metaphysical questions.
...
**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: Layer 2 specifies where the interaction occurs—quantum indeterminacies—and how—selection without energy injection. The [[mathematical-structure-of-the-consciousness-physics-interface|mathematical corridor]] (Born-rule preservation, inner product uniqueness, no higher-order interference) makes "minimal" precise: consciousness cannot alter ensemble statistics or reshape state space geometry.
...
- [[amplification-mechanisms-consciousness-physics]] — Six proposed mechanisms for scaling quantum selection to macroscopic effects
...
- [[pragmatist-quantum-foundations-and-the-agent]] — Why QBism, Healey, Brukner-Zeilinger, and Stapp converge on agent-centrality at measurement
