...
modified: 2026-01-25
human_modified: null
ai_modified: 2026-08-08T12:09:47+00:00
...
Block argues the two can dissociate. [[blindsight]] patients may have degraded access without phenomenology; Sperling's iconic memory experiments suggest phenomenology exceeding access capacity, though this interpretation remains contested. If dissociations are real, functional explanations explain access but not phenomenology. [[dualist-perception|Perception and conscious experience]] treats these cases in detail, adding inattentional blindness and subliminal perception. The [[consciousness-epistemology-extended-cognition|extended cognition debate]] draws out a further consequence of the distinction: A-consciousness plausibly extends into notebooks and tools via functional parity, while P-consciousness does not. That asymmetry is argued in the linked article, not established here; taken as given, it is coherent with dualism rather than evidence for it.

## The Hard Problem {#hard-problem}

David Chalmers's "hard problem" centers on P-consciousness: why is information processing accompanied by experience? Even solving all "easy problems" (explaining cognitive functions) leaves this unanswered.

The hard problem has two aspects: the *existence question* (why does processing give rise to phenomenology at all, rather than being "dark inside" like a [[philosophical-zombies|philosophical zombie]]?) and the *character question* (why does this brain state feel like *this* rather than *that*?). We can identify [[neural-correlates-of-consciousness|neural correlates]] of experience but cannot explain why those correlations hold.

### Zombies and the Conceivability Argument

The [[philosophical-zombies|zombie argument]] exploits P-consciousness's resistance to functional explanation. If a being physically identical to you but lacking phenomenal consciousness is conceivable, then P-consciousness isn't entailed by physical facts. Chalmers argues conceivability indicates metaphysical possibility, so materialism is false. Critics challenge whether zombies are genuinely conceivable or whether conceivability implies possibility, but the argument's force comes from phenomenology's apparent logical independence from function.

### The Knowledge Argument

Frank Jackson's [[knowledge-argument|Mary's Room]] similarly targets P-consciousness. Mary knows all physical facts about color vision but has never seen color. When she sees red, she learns something new—what it's like. If phenomenal facts exceed physical facts, P-consciousness isn't reducible to the physical.
...
The [[phenomenal-concepts-strategy|phenomenal concept strategy]] (PCS) is the most sophisticated physicalist response. Rather than denying the [[explanatory-gap|explanatory gap]], PCS locates it in our *concepts* rather than reality. Phenomenal concepts—deployed when introspecting experience—have special features making them *seem* conceptually independent from physical concepts, creating the *appearance* of an ontological gap even if consciousness is physical.

The analogy: "heat" and "molecular motion" seem independent before thermodynamics, but the gap was epistemic, not ontological. PCS claims phenomenal and physical concepts similarly pick out the same properties via different modes of presentation. Major versions include Loar's direct recognitional account, Papineau's quotational account, and Balog's constitutional account.

### Chalmers's Master Argument

Chalmers presents a dilemma. Let C be the special features of phenomenal concepts. Either physical duplicates lacking C are conceivable—in which case C itself isn't physically explicable and PCS relocates the hard problem—or they aren't conceivable, meaning [[philosophical-zombies|zombies]] would have C too and the strategy can't explain why we find P-consciousness puzzling. Either way, PCS fails. The explanatory gap's persistence despite sophisticated conceptual responses suggests something about P-consciousness itself resists physical explanation.

## Illusionism: Denying P-Consciousness {#illusionism}

[[illusionism]] (Dennett, Frankish) holds that we merely *represent* ourselves as having irreducible experiential qualities. Frankish restricts the denial to phenomenal consciousness *as traditionally conceived*—experience bearing intrinsic, ineffable what-it-is-like properties—not consciousness in every functional sense; the position runs from a hard end at which phenomenal properties simply do not exist to a subtle end at which the brain models something real but schematically. The "illusion problem" (why we represent ourselves as having qualia) replaces the hard problem.

The obvious reply is a regress: if it *seems* you have qualia, something must be doing the seeming. Taken bare it proves nothing, and the Map does not run it as though it did—it assumes the seeming is itself phenomenal, which illusionists deny, and a representational system need not instantiate what it represents. The pressure is rather that relocating the question gains only if "why does damage *seem* to hurt?" is tractable where "why does damage hurt?" was not, which is asserted rather than shown. That [[pain-consciousness-and-causal-power|pain *hurts*]] is the datum any such account still owes an explanation of.
...
The reply is that the claim "phenomenal character is constitutive of conscious mental states" is a claim about *kind*, not uniform intensity. P-consciousness is a scalar feature: it admits of degrees of vividness, determinacy, and integration (see [[degrees-of-consciousness]]) without ceasing to be the kind of thing it is. Every instance above zero instantiates the kind; variation in degree is compatible with structural necessity. The exemplar treatment of this constitutive-vs-scalar distinction is in [[self-and-self-consciousness#Constitutive as Kind, Not as Degree|self-and-self-consciousness]], applied to first-personal givenness against parallel clinical-variation objections, and the same move applies here.
...
The [[tenets#^bidirectional-interaction|Bidirectional Interaction tenet]] holds that P-consciousness is causally efficacious. That we report on phenomenal properties suggests information about consciousness flows into the physical domain. [[concepts/epiphenomenalism]] faces self-stultification: if phenomenal properties don't affect behavior, beliefs about them are causally disconnected from the properties themselves, undermining those very beliefs.

The [[argument-from-reason]] provides independent support. C. S. Lewis gave the argument its best-known modern statement in *Miracles* (1947), whose third chapter he substantially rewrote for the 1960 edition after Anscombe's critique; the Map's reading of it is that only conscious awareness can grasp reasons *as* reasons. Unconscious systems might implement reliable truth-tracking, but genuine rational inference—appreciating *why* conclusions follow—requires phenomenal awareness. P-consciousness is not merely real but causally efficacious in reasoning.

This connects to [[topics/free-will]] and [[agent-causation]]: if phenomenal consciousness influences physical outcomes, we are genuine agents, not spectators. The [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction tenet]] specifies one possible interface where consciousness might influence quantum indeterminacies without violating conservation laws.

### Access/Phenomenal Distinction and Dualism

Acknowledging [[access-consciousness]] *strengthens* dualism: physicalism can explain A-consciousness through neural architecture, and the explanatory gap persists after access is fully explained. That residual gap is where dualism finds strongest support.

### No Many Worlds

The [[tenets#^no-many-worlds|No Many Worlds tenet]] connects to P-consciousness through indexical identity. Many-worlds would split "I" into multiple instances, but P-consciousness is irreducibly first-personal—there is something it is like *for me* to experience this moment. P-consciousness's unity supports real collapse over decoherence-only interpretations.

### Objectivity and Subjectivity

Thomas Nagel's analysis in [[objectivity-and-consciousness]] illuminates why P-consciousness resists physical explanation. Objective knowledge abstracts from particular viewpoints, but P-consciousness *is* a viewpoint. The "view from nowhere" cannot capture the "view from somewhere" that constitutes consciousness. This suggests the explanatory gap reflects genuine ontological distinction between objective physical properties and subjective phenomenal properties.
...
- [[topics/free-will]] - P-consciousness and genuine agency
