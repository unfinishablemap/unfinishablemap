...
If consciousness can bias quantum outcomes in the brain—as the project's [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet holds—an obvious question arises: why only in brains? Why can't minds move objects, bias random number generators, or influence distant events?
...
- [[voluntary-attention]] - Willed attention as the project of conscious control
