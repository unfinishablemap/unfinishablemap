...
**Placebo neuroplasticity**: Seymour and Mathers (2024) propose a Neuroplasticity Placebo Theory, on which placebo response is mediated by neuroplastic change in fronto-limbic circuits, synthesising the reproducible dopamine, monoamine and opioid changes reported across Parkinson's disease, mood disorders and pain states. Two limits on what this strand can carry should be stated plainly. Their paper is a theoretical synthesis presenting no new data, so it enters here as a proposed mechanism rather than an independent measurement. And its thesis runs toward a *common* fronto-limbic denominator across conditions rather than toward condition-specific neural signatures—so it supports the claim that belief states with propositional content have identifiable neural consequences, not the stronger claim that their meaning selects among those consequences. That stronger [[content-specificity-of-mental-causation|content-specific]] pattern is argued below on separate grounds.
...
Together with Minimal Quantum Interaction, this tenet commits the Map to [[interactionist-dualism]]—the position that mind and body are distinct yet causally connected, with the connection occurring at quantum indeterminacies in neural systems. It also grounds the Map's approach to [[topics/free-will|free will]]: if consciousness selects among quantum-indeterminate neural outcomes, human decisions need not be fully determined by prior physical causes.
...
- [[dualism-as-ai-risk-mitigation]] — Why the two-way interface is essential rather than incidental to the dualist contribution to AI risk arguments
