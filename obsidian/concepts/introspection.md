...
This maps onto the [[the-subject-object-distinction-as-philosophical-discovery|subject-object distinction]]: the subject has privileged access to phenomenal content while the causal processes producing it remain on the object-side, accessible only through third-person methods. Russell's distinction between knowledge by acquaintance and description captures the same asymmetry: critics show we lack descriptive access to process while leaving acquaintance with content intact. See [[phenomenological-evidence]] for when such acquaintance constitutes genuine evidence.

Metzinger's [[phenomenal-transparency-opacity-spectrum|transparency-opacity spectrum]] provides the mechanism. Perceptual representations are normally *transparent*: you see the apple, not your visual cortex's model of it. The processing stages that construct experience operate below introspective access—process opacity is a structural feature, not a failure of attention, since the representational medium conceals itself. Phenomenal *content*, by contrast, is what transparently-presented representations deliver: the experienced quality itself. The critics demonstrate that processing is invisible; they do not show the delivered content is unreliable. [[self-opacity|Introspective opacity]]—explored as a void in the Map—names this structural limit. The [[meaning-void|meaning void]] applies it to reference and felt comprehension: we know *what* our thoughts are about but not *how* they achieve their aboutness.

This distinction is crucial for the [[hard-problem-of-consciousness|hard problem]]. [[cognitive-science-of-dualism|Cognitive science itself]] depends on it: every neural correlate study trusts the subject's first-person report as testimony *about* experience, not merely as behavioural output. Arguments for dualism don't depend on introspecting cognitive processes—they depend on recognizing that experience has a qualitative character differing from its neural correlates. [[qualia|Qualia]] are what experience *is*, not what causes experience. The [[consciousness-and-language-interface|consciousness-language interface]] complicates this: introspection is often linguistically mediated, and linguistic encoding loses content from the original phenomenal state.

Choice blindness concerns decision justification, not current phenomenal awareness. The subject misremembers which face they chose and confabulates reasons for a choice they didn't make. But at any moment, they still have visual experience—experience whose existence doesn't depend on accurately reporting its causal history. The pupillometric channel-level finding noted above locates the dissociation on the process side, where verbal access fails.

### Phenomenal Overflow: Evidence for the Distinction

Ned Block's phenomenal overflow research supports the process/content distinction. Using Sperling's (1960) partial-report apparatus—a briefly-presented grid of twelve letters—subjects report seeing all twelve clearly but can identify only three or four. Block reads this as phenomenal content exceeding cognitive access—precisely what the distinction predicts. The fineness of grain argument converges: you see *that* shade of blue, not just "blue." See [[acquaintance-void|the acquaintance void]] for how concepts may structurally limit access to phenomenal content.
...
Even granting this limitation, the finding suggests introspection resembles other trained observations. An untrained person cannot reliably identify bird species from song; an ornithologist can. We don't conclude bird song is unreliable data—observation requires trained attention.
...
The [[metacognition|metacognition literature]] illuminates introspection's nature. The *capacity* to introspect (metacognitive skill) differs from the *content* introspected (phenomenal consciousness). Evidence suggests these are dissociable.

This capacity sits above what the Map calls the [[metacognition#the-metarepresentation-threshold|metarepresentation threshold]] — the boundary between procedural metacognition (responding to uncertainty without representing it as a mental state) and declarative metarepresentation (treating one's own cognitive states as objects of thought). Introspection in the philosophically loaded sense requires the declarative side: the subject must hold a state *and* a representation of it as the subject's own. Procedural monitoring can adjust behaviour without yielding any report. This limits which species and systems can be *subjects* of introspective evidence, even where lower-order monitoring is preserved.

### The Dissociation Evidence

On the standard reading the Map adopts, [[blindsight]] patients retain residual visual discrimination in their "blind" field while phenomenal experience there is minimal or absent—a dissociation in which processing and access survive without (or nearly without) the "what it's like" of seeing. Conversely, "blind insight" reveals metacognitive discrimination without conscious awareness—subjects show confidence calibration for information unavailable to conscious report. Introspection is a cognitive tool operating on conscious content, not a direct readout.
...
The [[self-opacity|phenomenology of error recognition]] reveals another structural limit: *being wrong about our introspective reports feels exactly like being right*. [[phenomenal-transparency-opacity-spectrum|Phenomenal transparency]] explains why: the representational medium is invisible, so distortions within it produce no distinctive signal. There is no quale for introspective error. This creates a bootstrap problem: introspection is the tool we use to check itself, but if the tool is producing errors, it cannot detect them.

The [[noetic-feelings-void]] deepens this: the felt signals gating metacognition—feelings of knowing, rightness, familiarity, confidence—are themselves outputs of heuristic machinery (cue-familiarity, accessibility, generation fluency) consciousness cannot inspect. The signals that would warn us introspection has misfired arrive as verdicts, not as machinery.

This refines the training argument. Contemplative traditions don't merely develop *better introspection*—they develop *awareness of introspective limitations*. The expert differs from the novice not only in accuracy but in calibrated uncertainty—knowing what they cannot reliably access.
...
The objection that introspection "modifies its target" supports the [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet. If attention affects experience, consciousness has causal efficacy—the "contamination" worry becomes evidence for what the tenet claims. The [[mutation-void]] develops this insight into a taxonomy of specific transformation types: performative, temporal, attentional, emotional, dream, and meditative mutations each demonstrate that introspective modification is not a single uniform phenomenon but a family of distinct instabilities.

The [[tenets#^no-many-worlds|No Many Worlds]] tenet bears on introspective data more weakly than it first appears. Introspective reports uniformly describe singular, determinate experiences. This is consistent with consciousness involving collapse to definite outcomes—but it does not discriminate between collapse and Many-Worlds, since the latter predicts exactly the same single-outcome reports from each branch-occupant. Introspective uniformity confirms determinate experience without adjudicating *why* experience is determinate; the case against MWI rests on indexical-identity grounds, not phenomenological ones.
...
- [[process-content-distinction]] — The Nisbett-Wilson asymmetric-reliability finding as calibration craft: content reports earn higher evidential weight than process reports, neither exempt from error
- [[phenomenal-transparency-opacity-spectrum]] — Why experience presents as direct contact with reality, and when representations become visible as representations
...
- [[microphenomenological-interview-method]] — Petitmengin's disciplined interview procedure and the epilepsy prodrome case
...
- [[constitutive-vs-referring-observation]] — Why theory-ladenness sufficient against folk theories cannot dispose of bare phenomenal existence
...
- [[apex/taxonomy-of-voids|Taxonomy of Voids]] — Apex synthesis: introspection as the operation around which the self-knowledge cluster is organised
- [[source-attribution-void]] — Why choice blindness and confabulation are structural features of origin-tagless mental content, not noisy exceptions
- [[noetic-feelings-void]] — Feelings of knowing, rightness, and familiarity, and why their heuristic machinery is recursively opaque
- [[imagery-void]] — Aphantasia/hyperphantasia divergence as intra-species phenomenal incommensurability; the function-phenomenology wedge
