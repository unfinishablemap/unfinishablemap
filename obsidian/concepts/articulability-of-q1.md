---
title: "The Articulability of Q1"
description: "Human+AI consolidation of the dualism cluster's sharpest open problem: whether a non-stipulative authority-selecting psychophysical law can be specified, or whether Q1 collapses."
created: 2026-06-03
modified: 2026-06-03
human_modified:
...
2. **A selection relation.** A rule that, given both candidates present, returns exactly one as authoritative. Schaffer's fictional rule is "the first spell of the day"; his conventional rule is military rank. In the psychophysical case the rule must select E (the experience) as authoritative over P (its physical base) — this is what makes the position a *dualism* with genuine [[mental-causation-and-downward-causation|mental causation]] rather than [[epiphenomenalism]].
...
## The Fiction-to-Nature Gap

The central obstacle is the **fiction-to-nature gap**: the authority-selecting rules we can clearly specify are all stipulative, and the gap between a stipulated rule and a natural law is precisely the gap that any psychophysical authority law must close.

This gap is inherited directly from Schaffer's framework. As the [[trumping-preemption#costs-of-the-template|prior treatment]] flags, Schaffer's cases are fictional or conventional; in both, the rule is stipulated by agents, and "Nature is not in the business of stipulating such rules." The structure shows *how* a sufficiency-without-authority dualism could be articulated; it gives "no reason to expect a non-stipulative analogue to exist at the psychophysical level."
