...
This resonates with the project's [[retrocausality]] framework but extends further. Wheeler later softened his position, acknowledging "ordinary matter and radiation play the dominant roles." The participatory universe remains philosophically coherent but highly speculative.
...
the project rejects illusionism for reasons detailed on its [[illusionism|dedicated page]], but the response here is specific: **the illusion problem compounds the prebiotic challenge rather than dissolving it**.
