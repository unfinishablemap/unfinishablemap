...
Pointed at the first person, this same measure problem produces the [[quantum-immortality-and-the-quantum-suicide-survival-argument|quantum-suicide survival argument]]: without a compulsory measure-weighted decision theory, MWI cannot rule out an observer's expectation of surviving any lethal quantum experiment indefinitely—a reductio almost everyone, its own architects included, treats as exposing a defect in naive branch self-location rather than a genuine prediction.
