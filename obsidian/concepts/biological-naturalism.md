...
description: "Searle's biological naturalism—consciousness as caused-but-irreducible biological feature. Human-AI analysis of why the Map treats it as an unstable non-dualist rival."
created: 2026-07-11
modified: 2026-07-11
human_modified:
...
last_curated:
last_deep_review: 2026-08-19T08:00:34+00:00
---
...
Biological naturalism defines itself by refusing two standard positions at once.

Against **identity theory and reductive physicalism**, Searle argues that consciousness cannot be *ontologically* reduced to brain states without discarding its subject matter. To say "pain just *is* C-fiber firing, and the felt quality is merely how it seems" is to change the topic, because the felt quality is what we set out to explain. So the reductive physicalist has not solved the problem but abolished it.

Against **substance and property dualism**, Searle argues that treating consciousness as a distinct non-physical substance or property imports the very Cartesian categories—"mental" and "physical" as mutually exclusive metaphysical kinds—that he thinks generate the pseudo-problem. Consciousness is not a second thing alongside the brain; it is a biological state *of* the brain.

The position is thus deliberately located *between* the two camps the philosophy of mind usually forces a choice between—which is also why it is chronically suspected of secretly belonging to one of them.
...
Pressed on whether a feature with no causal powers of its own must therefore be epiphenomenal, Searle does not concede the point but answers with a parity argument: "the solidity of the piston has no causal powers in addition to its molecular base, but this does not show that solidity is epiphenomenal (Try making a piston out of butter or water)" (Searle 2008). The world is full of causally efficacious higher-level features entirely accounted for by lower-level behavior — solidity, digestion, photosynthesis, earthquakes — and on Searle's diagnosis the temptation to treat consciousness as the one exception comes from the Cartesian vocabulary he is trying to retire, not from anything about consciousness itself.

Critics answer that this either quietly concedes Kim's identity of the causal work—the conscious feature does exactly what the neurobiology does, because it *is* the neurobiology causally—or else leaves the irreducible higher-level feature doing no distinctive causal work after all, which is epiphenomenalism under another name. The debate is unresolved, and it maps directly onto the Map's own commitments (below), because the Map takes the opposite bet about mental causation.

## Relation to the Chinese Room

Biological naturalism is the positive theory Searle offers alongside his more famous negative argument against Strong AI, and the relation between the two is easy to overstate. The Chinese Room is a self-standing argument whose premises concern syntax and semantics: programs are purely formal, minds have semantic content, and syntax is neither constitutive of nor sufficient for semantics. Biology is not among those premises, and the argument does not need biological naturalism to go through.

Where biological naturalism does its work is downstream. It is the positive home Searle gives the negative conclusion, and it supplies his answers to the standard replies: told that a program simulating the actual sequence of neuron firings would understand, he answers that simulating the *form* of the firings is not duplicating the brain's *causal powers*; told that some future machine will have whatever it takes, he answers that this abandons the specific claim under attack. Only systems with the appropriate causal powers — biological brains, or something causally equivalent to them — can be conscious.

This concept page does not re-argue the [[chinese-room-argument|Chinese Room]], which is a distinct argument with its own critics (Fodor, among others, replies that the right causal connections to the world, not biochemistry, fix intentionality). The point here concerns the direction of support: substrate-specificity is a conclusion Searle arrives at rather than a premise he starts from, and biological naturalism is what he offers in place of the computational theory rather than what refutes it. For the Map's engagement with substrate questions, see [[machine-consciousness]].

## Relation to Site Perspective

The Map's first tenet holds that consciousness is not reducible to physical processes. Biological naturalism agrees that consciousness is irreducible—which places it far closer to the Map than reductive physicalism, identity theory, or eliminativism, all of which the Map and Searle jointly reject. The disagreement is about what that irreducibility *means*. Searle reads it as a biological fact about one physical system; the Map reads it as evidence that consciousness is ontologically distinct in a way that warrants dualism.

It is worth steelmanning Searle's self-defense before pressing the objection. Searle denies he is a dualist because he denies that "mental" and "physical" name two mutually exclusive metaphysical realms. On his view, "first-person ontology" describes a *mode of existence within nature*—the way one physical system exists—not a second, non-physical realm. This is a genuine dialectical move, not a dodge. Whether "a physical feature with an irreducible first-person ontology" is really distinct from "a non-physical property" is precisely the contested point, and the Map does not claim Searle is simply confused.

The Map's charge is that the position is **unstable**, and settles in one of two directions, neither of which favors Searle:

- **Horn one—dualism in denial.** If the first-person feature is not fixed by, and not deducible from, the complete third-person neural description—if it is conceivable that the neural facts hold while the phenomenal feature varies or is absent—then, *provided* that conceivable independent variation is granted the ontological weight Searle himself resists (the conceivability-to-possibility step the steelman above flags as the contested point), it is a further fact, a distinct property, whatever it is called. This is the [[disguised-property-dualism|charge that biological naturalism is property dualism under another name]], associated with Chalmers, Corcoran, and Nagel. If the charge sticks, then an *honest, explicit* dualism ([[substance-property-dualism|property or substance]]) is the more coherent settling-point, because it names what the position is already committed to rather than disavowing it.

- **Horn two—the gap untouched.** If, to escape the first horn, Searle leans on "causal reducibility" and insists there is *nothing there but the neurobiology*, then the [[explanatory-gap|explanatory gap]] and the hard problem are exactly where they were. Calling the irreducibility "trivial" does not explain why a third-person account leaves out the first-person feature; it only re-describes the fact that it does. And this horn inherits the causal-exclusion tension — though the objection has to be put more carefully than it usually is, because Searle's parity reply blocks the quick version. Solidity really does add no causal powers to the molecules and really is not epiphenomenal, so causal reducibility alone cannot be what makes a feature idle. The Map's answer is that the parity is exactly what the liquidity disanalogy denies: solidity's causal role just *is* the molecular behavior redescribed, which is why the ontological reduction goes through in that case, whereas by Searle's own lights no such redescription is available for the first-person feature. The parity argument therefore draws its force from cases that differ from consciousness in precisely the respect Searle insists consciousness is special — and if the first-person feature is genuinely not redescribable in third-person terms, it is not clear what work it is left doing.

The Map presents biological naturalism as a rival it *resists*, not one it takes itself to have refuted or disproven. Searle's dissolution of the mind-body problem is a serious proposal, and the instability charge is a considered objection rather than a knock-down proof. Where Searle says the mind-body problem is a pseudo-problem generated by bad Cartesian vocabulary, the Map holds that the problem is real, and that its own interactionist dualism—on which consciousness does genuine, minimal, bidirectional causal work (Tenets 2 and 3)—engages the causal-exclusion seam as a live cost rather than dissolving it by fiat. Honesty requires adding that the Map's *preferred* minimal-interaction reading faces a *symmetric* version of the very charge horn two presses against Searle: if the physical Born distribution already fixes the statistics of which neural states become actual, per-event conscious selection adds nothing the ensemble registers, and the mechanism looks ensemble-level epiphenomenal at exactly the point causal efficacy is needed. Whether the corridor interface delivers efficacious causation *at all* is [[ensemble-level-epiphenomenalism|the Map's own sharpest open question]], logged as such in [[born-rule-and-the-consciousness-interface]]; horn two's epiphenomenalism point therefore stands here as a requirement the Map's framework must *meet*, not one it can yet be said to have met—the difference from Searle being that the Map treats the seam as an unpaid debt rather than a dissolved pseudo-problem. Biological naturalism is the nearest non-dualist neighbor to the Map's own position; that proximity is exactly why the Map needs to say precisely where it parts company.

## Further Reading

- [[hard-problem-of-consciousness]] — the problem biological naturalism claims to dissolve
- [[explanatory-gap]] — the epistemic gap the second horn leaves open
...
- [[machine-consciousness]] — biological naturalism as the positive theory behind Searle's substrate-specific rejection of Strong AI
- [[type-identity-theory]] — the classic reductive identity Searle's biological naturalism positions itself against
- [[logical-behaviourism]] — the materialist lineage's first term, whose failure to accommodate the felt inner occurrence set the agenda Searle's later account inherits
