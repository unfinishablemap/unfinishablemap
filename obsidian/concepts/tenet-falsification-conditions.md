---
title: "Tenet Falsification Conditions"
description: "What it would take to abandon the Map's foundational commitments—a concept page mapping falsification types, structural challenges, and the honest asymmetries across the five tenets."
created: 2026-04-15
modified: 2026-04-15
human_modified:
...
**Decisive falsification** applies where a single experimental result could force abandonment. The quantum-level tenets come closest to this standard, though Tenet 2 reaches it only in part: its readings have materially different falsifiability profiles and should not be flattened into a single condition. Its mechanism-committed readings do carry sharp falsifiers, but a coherence result is not the shared floor beneath them all. Proof that quantum coherence cannot be sustained in biological neural tissue defeats the readings that require sustained coherence while leaving outcome indeterminacy untouched—and outcome indeterminacy is what the selection-only readings exploit. [[tenets#^minimal-quantum-interaction|The tenet page]] is explicit on the point: decoherence suppresses superposition and fixes a preferred basis without settling why one outcome rather than another becomes actual, and post-decoherence selection is constructed to operate after coherence is gone. A condition reaching every reading would have to remove the indeterminacy itself—a demonstration that no quantum indeterminacy is ever amplified to make a difference to a neural outcome, leaving nothing for selection to bias. That is a harder claim than the coherence one, concerning amplification chains across scales rather than coherence lifetimes, and no single experiment supplies it; the shared floor is real but sits nearer the cumulative end of the spectrum than the decisive one. Past it the readings separate, and the Map's own default reading is not decisively falsifiable; [[#minimal-quantum-interaction|the entry below]] sets out the split. If macroscopic quantum interference between branches were demonstrated (Deutsch's 1985 Wigner's friend variant), the No Many Worlds tenet would be under severe pressure.
...
**Structural unfalsifiability** applies to claims that are not scientific hypotheses but epistemological or methodological positions. The Occam's Razor Has Limits tenet is meta-scientific: it makes claims about the reliability of a methodological principle, not about the physical world. It can be supported or undermined by historical evidence about when parsimony has tracked truth, but no experiment could refute it.

## The Consciousness Falsification Problem
...
## Falsifiability Spectrum Across the Tenets

Each tenet sits at a different point on the falsifiability spectrum. The following summarises the type of evidence that would bear on each; the [[falsification-roadmap-for-the-interface-model|falsification roadmap]] develops the experimental details.
...
The Map's [[tenets]] are chosen starting points, not proven conclusions. Specifying their falsification conditions is an exercise in intellectual honesty that the tenets themselves demand. Tenet 5 (Occam's Razor Has Limits) explicitly warns against mistaking methodological simplicity for truth—and the same epistemic humility applies to the Map's own commitments. If the Map cannot specify what would change its mind, it has no right to criticise physicalism for the same failure.

The falsification conditions also reveal the Map's distinctive structure. Unlike purely metaphysical positions (which may lack any falsification conditions) or purely scientific hypotheses (which should have decisive ones), the Map occupies middle ground: a philosophical framework with empirically tractable components. This is a strength. The quantum-level tenets anchor the framework to experimental reality while the broader commitments provide the philosophical architecture that gives those experiments their significance.
