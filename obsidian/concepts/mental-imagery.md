...
description: "Voluntary mental imagery is consistent with consciousness's causal efficacy. Motor imagery training improves physical performance measurably."
created: 2026-01-23
modified: 2026-01-23
human_modified: null
ai_modified: 2026-04-10T15:56:00+00:00
draft: false
topics:
...
The critical case for [[bidirectional-interaction]] involves the upper-left cell: deliberate, conscious visualization. When you voluntarily generate mental imagery, consciousness isn't merely observing—it's directing neural activity.
...
**The voluntary/involuntary distinction tracks the conscious/unconscious distinction.** Voluntary imagery requires different neural systems (LPFC), feels effortful, and can be directed at will—properties absent from automatic imagery like dreams. The physicalist can explain this dissociation through neural circuit differences alone, without assigning consciousness a causal role. The Map acknowledges this explanatory standoff but notes the pattern: consciousness consistently tracks the more flexible, goal-directed processing mode. This parallels findings in [[conscious-vs-unconscious-processing]], where consciousness correlates with functions that unconscious processing cannot achieve. Whether consciousness *causes* these functions or merely accompanies the neural circuits that do remains the core question the Map's [[bidirectional-interaction]] tenet addresses.
