...
How long does the pre-collapse phase last? If [[decoherence]] timescales for neural systems are 10⁻¹³ seconds (Tegmark's estimate) or even 10⁻⁵ seconds (Hagan et al.'s corrected estimate for microtubule systems), the "during" of superposition is unimaginably brief. Consciousness would need to operate on femtosecond-to-microsecond timescales to participate in the superposition phase at all.
