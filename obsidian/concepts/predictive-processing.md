...
description: "The brain as prediction engine: hierarchical Bayesian inference, perception as controlled hallucination, and why this framework doesn't solve the hard problem."
created: 2026-01-14
modified: 2026-01-20
human_modified: null
ai_modified: 2026-09-24T10:47:14+00:00
draft: false
topics:
...
Hohwy and Seth (2020) propose using PP not to solve the [[hard-problem-of-consciousness|hard problem]] directly but to identify neural correlates of consciousness systematically.
...
PP offers a sophisticated [[concepts/functionalism|functionalist]] account. But like other functionalist theories, it faces the standard objection: why should any computational process, however complex, be accompanied by phenomenal experience? (See [[cognitive-science-of-dualism]] for how this limitation extends across cognitive science generally: the field's formalisms describe what the brain *computes* while remaining silent on what it *experiences*.)
...
Like [[global-workspace-theory|Global Workspace Theory]], PP at best explains access consciousness—how information becomes globally available for reasoning and action—while leaving phenomenal consciousness untouched.

## The Illusionist Challenge

PP has strong affinities with [[illusionism]]—the view that phenomenal consciousness is itself a kind of illusion. If perception is "controlled hallucination," perhaps the phenomenal character of experience is just another hallucination. Several responses challenge this move:
...
- [[witness-consciousness]]
- [[decoherence]]
- [[meditation-and-consciousness-modes]] — Training attention and precision
