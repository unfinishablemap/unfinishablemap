...
PP relates to the project's [[tenets]] in several ways:
...
**[[tenets#^bidirectional|Bidirectional Interaction]]**: Active inference—organisms acting to change sensory input—resonates with bidirectional interaction. Consciousness doesn't passively receive but actively shapes reality. the project's claim that consciousness selects among quantum outcomes could be a deeper-level instance of active inference.
...
**[[attention|Attention]]**: PP heavily invokes attention through precision weighting. the project's articles on attention and Stapp's quantum Zeno mechanism connect naturally. Sustained attention may be how consciousness influences which predictions become conscious.

**The functionalist limitation**: PP describes important cognitive mechanisms while leaving open whether consciousness requires non-physical explanation. the project agrees PP captures much about cognition while maintaining the [[explanatory-gap]] remains unbridged.
