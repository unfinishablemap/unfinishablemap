...
The [[filter-theory|filter/transmission model]]—developed by Bergson, William James, and Huxley, and systematised by Kelly et al. in *Irreducible Mind* (2007)—proposes that the brain constrains rather than generates consciousness. On this view, memories are not stored in neurons but accessed through them. As the filtering apparatus collapses near death, consciousness briefly regains access to capacities the diseased brain had been blocking.

The operative words, as Kelly et al. emphasise, are "filter, transmit, permit, channel, select, extract, limit, regulate, condition, modify—not produce, generate or create." Terminal lucidity fits this framework: the filter breaks down, and what it had been constraining temporarily returns.
