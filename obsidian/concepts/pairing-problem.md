...
The Map's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] framework provides a natural response to the pairing problem: consciousness is spatially located where it causally interfaces with the brain.
...
[[illusionism|Illusionists]] like Daniel Dennett and Keith Frankish argue the pairing problem is ill-posed because there are no souls or irreducible minds to pair. Consciousness, on their view, is a functional property of certain physical systems—specifically, systems that model themselves as having unified inner lives. The appearance of a "pairing" between mind and body is just what it's like to be a self-modeling system.
...
The illusionist can deny that "from the inside" designates anything real—but this amounts to denying that consciousness exists, which the Map's [[tenets#^dualism|Dualism tenet]] rejects. The pairing problem persists for anyone who accepts that phenomenal consciousness is genuine.
...
The [[objections-to-interactionism]] article provides comprehensive treatment of the pairing problem alongside five other objections. This article provides the detailed philosophical analysis; that article provides the comparative overview showing how the pairing problem fits within the broader challenge to interactionism.
...
- [[decoherence]] - The quantum biology challenge to the Map's framework
