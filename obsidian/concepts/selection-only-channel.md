...
Whether this ceiling is currently measurable is open; operationalising it is a target of the [[interface-specification-programme]]. Whether the ceiling is *real* — whether mind in fact has no inputs not realised in the candidate set — is a structural commitment of the channel class, not an empirical claim derivable from it.
