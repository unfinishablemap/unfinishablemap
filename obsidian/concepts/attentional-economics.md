...
description: "Agency is the allocation of attention over time. Within the Map's framework, attention training is metaphysically agency-enhancing: freedom scales with skill."
created: 2026-01-31
modified: 2026-08-19
human_modified:
...
This connects to distal intentions, [[prospective-memory|prospective memory]], and [[counterfactual-reasoning|counterfactual reasoning]]. When you decide Monday to exercise Friday, agency doesn't wait until Friday morning. It operates through the attentional work of the intervening days: rehearsing the intention, noticing cues, sustaining the commitment against competing priorities. The Map's framework suggests this attentional work is where conscious influence actually occurs.

## Why Attention Specifically?

The [[attention-as-interface]] article develops why attention—rather than emotion, memory, or imagination—serves as consciousness's interface with matter. The economic framing adds another dimension: attention is the *bottleneck resource* that determines what consciousness can influence.
...
[[meditation-and-consciousness-modes|Contemplative practices]] train different attentional capacities:
...
**[[tenets#^dualism|Dualism]]**: Attentional economics presupposes consciousness is distinct from the attentional mechanisms it operates through. The scarce resource being allocated is *conscious attention*—something irreducible to neural processing.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: The framework specifies *how* consciousness influences matter: through the allocation of attention, which stabilises certain neural patterns over others. Attention is the currency of mental causation.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: The bandwidth constraint (~10 bits/second) reflects the minimality. Consciousness doesn't override brain processing; it selects among results through a narrow channel.

**[[tenets#^no-many-worlds|No Many Worlds]]**: Attentional economics requires genuine selection. If all patterns actualised in parallel branches, there would be nothing for attention to allocate—no scarcity, no opportunity costs, no investment returns.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The framework adds complexity (quantum mechanisms, bandwidth constraints, economic structure) but explains what simpler accounts cannot: why attention feels effortful, why training produces neuroplastic change, why sustained focus differs from brief notice.
