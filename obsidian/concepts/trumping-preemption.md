...
Trumping preemption is Jonathan Schaffer's name for a fourth species of redundant causation, introduced in his 2000 paper of the same title (*Journal of Philosophy* 97: 165–181). Two causally complete processes both run through to the same effect, but a higher-order rule — a law, hierarchy, or priority convention — selects one of them as the authoritative cause. No physical "cutting" intervenes on the other process; it completes in full. The structure thereby separates two things that are usually fused in discussions of causation: *counterfactual sufficiency* (whether the process would have produced the effect on its own) and *causal authority* (whether it is the cause). The Map treats this separation as philosophically load-bearing because it supplies a structural template for how a non-physical experience could be the cause of a physical effect without producing any observable violation of [[causal-closure]].
