...
If agent causation is real, we should find its clearest expression in cases where consciousness initiates action without external prompting. [[attention-as-interface|Voluntary attention]]—choosing where to direct awareness—provides exactly this paradigm case. Recent neuroscience distinguishes "willed attention" (internally chosen) from "instructed attention" (externally cued), finding distinct neural signatures for genuine decision-making.
...
The third finding parallels the [[libet-experiments|Libet experiments]]: if neural states predict choices before awareness, where is the agent?
...
The [[motor-selection|motor selection]] evidence extends agent causation beyond attention to motor control—and the parallel is striking. Motor control shows the same neural signatures of willed action:
...
Agent causation as traditionally conceived focuses on selection: the agent chooses among options. But recent work on [[consciousness-and-creativity|consciousness and creativity]] reveals a deeper contribution—agents don't merely select from pre-existing menus but actively generate the options themselves.
...
Agent causation is the philosophical tradition to which this project belongs. The [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet—that consciousness causally influences the physical world—is a claim of agent causation: the conscious subject, as substance, causes physical events.
...
- [[many-worlds]] — Why the project rejects the many-worlds interpretation (and why it matters for agent causation)
