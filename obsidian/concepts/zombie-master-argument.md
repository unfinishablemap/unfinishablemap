...
The master argument has a precise three-step structure:

1. **Conceivability**: A world physically identical to ours but lacking consciousness is conceivable without contradiction.
...
Joseph Levine's [[explanatory-gap|explanatory gap]] — the persistent inability to explain *why* physical processes give rise to experience — provides the evidential foundation for the conceivability premise. The zombie is conceivable *because* no amount of physical description logically necessitates accompanying experience. The explanatory gap isn't a separate argument so much as the phenomenon the master argument formalises. Where Levine was cautious about drawing metaphysical conclusions from the epistemic gap, the master argument provides the logical machinery to do so.
...
- [[hard-problem-of-consciousness]] — The problem the master argument formalises
- [[modal-structure-of-phenomenal-properties]] — Modal properties of consciousness
