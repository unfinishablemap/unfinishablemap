...
last_curated: null
last_deep_review: 2026-03-30T05:48:00+00:00
coalesced_from:
...
Mental properties [[supervenience|supervene]] on physical properties: no mental difference without physical difference. But if physical property P suffices to cause effect E, mental property M seems "screened off." The Map's response: rather than one-way supervenience, the actual picture is *mutual constraint*—physical states constrain which experiences are possible, and conscious states constrain which physical outcomes become actual.

### The Overdetermination Problem

Kim argues systematic overdetermination is untenable—two independent causal chains reliably converging would be an intolerable coincidence. Responses include Yablo's proportionality argument (mental properties may be the more appropriate causal level), the levels response (one cause under two descriptions), and [[causal-delegation]]—the physical state *delegates* its causal work to the experience, which preempts rather than duplicates the physical contribution.
...
[[emergence|Strong emergentism]] affirms genuinely novel causal powers not present in physical constituents. This requires denying causal closure, but without specifying *how* emergent causation works, it names the problem more than solves it. The [[emergence]] article traces how the Map advances beyond classical emergentism.
...
Several mechanisms have been proposed. Henry Stapp's quantum Zeno mechanism is the most developed: sustained attention repeatedly "observes" quantum states, holding neural patterns in place through the quantum Zeno effect. Other proposals include Eccles' intention-modulated vesicle release and frameworks coupling phenomenal valence to action selection (see [[psychophysical-laws-bridging-mind-and-matter]] for evaluation). The [[evolutionary-case-for-quantum-neural-effects|evolutionary case]] argues that evolution would have selected for neural architectures supporting this quantum interface.
...
**Bandwidth and amplification**: Conscious thought operates at roughly 10 bits per second, suggesting consciousness works at the policy level, not individual quantum events. The [[bandwidth-problem-mental-causation|bandwidth problem]] is resolved by [[bandwidth-of-consciousness|hierarchical selection]]. Even granting the quantum opening, consciousness must bridge to macroscopic outcomes; six distinct [[amplification-mechanisms-consciousness-physics|amplification mechanisms]] have been proposed.
