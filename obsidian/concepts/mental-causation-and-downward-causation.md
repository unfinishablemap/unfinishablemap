...
description: "How mental states cause physical effects despite Kim's exclusion argument. Downward causation acts at quantum indeterminacies collapse readings leave open."
created: 2026-01-15
modified: 2026-05-05
human_modified: null
...
last_curated: null
last_deep_review: 2026-07-25T16:37:29+00:00
coalesced_from:
...
Downward causation (a term introduced by Donald Campbell in 1974) occurs when properties at one level of organisation causally affect lower-level processes—gene networks controlling protein synthesis, economic pressures affecting choices, and most contentiously the mind affecting the body. [[emergence|Strong emergence]] implies it: novel higher-level causal powers must influence lower levels. [[supervenience|Supervenience]] creates the tension—if higher-level properties supervene on lower-level ones, the lower level seems to do all the causal work.
...
Kim concludes that mental properties—and all higher-level properties—are causally excluded by their physical realisers: either consciousness causes nothing ([[concepts/epiphenomenalism]]) or it just *is* its physical realiser ([[reductionism|reductionism]]). See [[reductionism#Kim's Exclusion Challenge]] for the fuller argument, and [[causal-exclusion-argument]] for the canonical statement of the inconsistent set, the supervenience machinery, and the full responses literature (Bennett, List & Menzies, Block's drainage worry).
...
[[emergence|Strong emergentism]] affirms genuinely novel causal powers absent from physical constituents. This requires denying causal closure, but without specifying *how* emergent causation works it names the problem more than solves it; see [[emergence]] for how the Map advances beyond classical emergentism.

### Delegatory Dualism

Bradford Saad's [[delegatory-dualism|delegatory dualism]] (2025) holds that experiences *[[delegatory-causation|preempt]]* physical causes rather than overdetermining alongside them. A physical brain state has a "default causal profile"—the effects it *would* produce absent any experience—and when an experience arises whose profile matches that default, the experience takes over. The structural template is Jonathan Schaffer's [[trumping-preemption|trumping preemption]] (2000), which decouples *causal authority* from *counterfactual sufficiency*: both processes remain sufficient, but a higher-order law selects one as authoritative while the other is *sidelined*. Saad's distinction between *universal* and *[[observational-closure|observational]]* closure parallels the Map's framework: mental causation can be genuine without producing detectable anomalies. The [[delegation-meets-quantum-selection|delegation-selection bridge]] argues the default causal profile just *is* the Born-rule distribution, making delegation the structure and quantum selection the mechanism of a single causal event. See [[delegatory-causation]] for the full mechanism.
...
**Bandwidth and amplification**: Conscious thought operates at roughly 10 bits per second, suggesting consciousness works at the policy level, not on individual quantum events. The [[consciousness-bandwidth-architecture|bandwidth problem]] is resolved by [[bandwidth-of-consciousness|hierarchical selection]]; the strict per-event ceiling—log₂(N) bits per selection over a brain-prepared candidate set, tightened under Born-rule preservation—is derived in [[selection-only-mind-influence]]. Even granting the quantum opening, consciousness must still bridge to macroscopic outcomes; six [[amplification-mechanisms-consciousness-physics|amplification mechanisms]] have been proposed.
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: This tenet's affirmation that consciousness causally influences physical outcomes *just is* downward causation for mental properties (developed in [[bidirectional-interaction]]). Against [[concepts/epiphenomenalism|epiphenomenalism]]: if consciousness causes nothing, our reports and beliefs about experience are causally disconnected from actual experiences, and we lose epistemic access to our own minds.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: Provides the mechanism. Consciousness acts where physics is incomplete—at quantum indeterminacies, through biasing probabilities—respecting the spirit of causal closure while denying its letter.
