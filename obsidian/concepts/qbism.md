...
Fuchs explicitly positioned QBism as furthering Wheeler's [[wheelers-participatory-universe-and-it-from-bit|participatory universe]] program and its [[wheelers-participatory-universe-and-it-from-bit|"it from bit"]] thesis, coining the term "participatory realism" in 2017 to mark the connection. He has also been explicit that QBism's philosophical roots lie in classical American [[pragmatism]]: in the preface to the collected correspondence in which QBism took shape, he calls William James "the veritable mascot of this volume" (Fuchs 2014). QBism is one member of a broader [[pragmatist-quantum-foundations-and-the-agent|pragmatist family in quantum foundations]] (alongside Healey, Brukner-Zeilinger, and Stapp), where its Jamesian genealogy and the [[the-agent-shaped-hole|agent-shaped hole]] it leaves are treated in dedicated detail.
...
[[relational-quantum-mechanics|RQM]] shares QBism's perspectivalism—facts are relative to observers. But RQM treats *any* physical system as a potential observer, explicitly eliminating consciousness's special status. QBism, by contrast, centres agents with experiences, even while refusing to explain what makes them experiencers.
...
QBism's relationship to the Map's [[tenets]] is complex:

**[[tenets#^dualism|Dualism]]:** QBism is officially neutral on mind-body metaphysics—it's an interpretation of quantum mechanics, not a philosophy of mind. But its agent-centrality sits uneasily with physicalism. If agents with experiences are primitive and unexplained, QBism implicitly concedes that physics alone doesn't account for what matters most: the subjects doing the physics. This creates space for dualism even if QBism doesn't endorse it.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]:** QBism denies that consciousness causes collapse because it denies objective collapse. But it grants consciousness an irreducible epistemic role: experience is what makes quantum states meaningful, since they encode expectations *for* experience. This is weaker than the Map's claim that consciousness causally influences physical outcomes, but it acknowledges consciousness's centrality rather than eliminating it.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]:** Since QBism denies objective quantum states, there's nothing for consciousness to "interact with" at the quantum level. The tenet presupposes quantum realism that QBism rejects. However, QBism's emphasis on the agent's perspective can be reframed: whatever happens at measurement, it happens *for* an experiencing subject. The Map suggests this "for" requires explanation QBism doesn't provide.

**[[tenets#^no-many-worlds|No Many Worlds]]:** QBism agrees—it explicitly rejects MWI. There is one world in which agents hold beliefs and have experiences, not a branching multiverse of equally real outcomes. And like all interpretations, QBism relocates the Born rule — treating it as a normative coherence constraint on subjective credences — without deriving it from non-probabilistic premises, as the [[born-rule-and-the-consciousness-interface|interpretation-invariance analysis]] confirms.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]:** QBism might seem parsimonious: no objective collapse, no branching worlds, just agents and their beliefs. But this parsimony is achieved by taking agents as primitive. The Map's tenet reminds us that apparent simplicity may hide unexplained complexity. QBism's "simple" ontology includes experiential subjects without explaining them—hardly a reduction in mystery.
...
- [[pragmatist-quantum-foundations-and-the-agent]] — QBism's Jamesian genealogy and the agent-shaped hole, situated within the broader pragmatist family (Healey, Brukner-Zeilinger, Stapp) and reread under dualism
- [[the-agent-shaped-hole]] — The cross-framework diagnostic itself: theories that place an agent at the centre while declining to say what the agent is
...
- [[vertiginous-question]] — The cognitive boundary where first-person identity resists explanation; QBism presupposes what this void questions
