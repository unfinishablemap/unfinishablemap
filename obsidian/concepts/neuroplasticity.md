...
The Map finds the epiphenomenalist response unsatisfying for reasons developed in the [[mental-effort]] article: if effort phenomenology is causally disconnected from actual effort-allocation, the epiphenomenalist owes an account of why it tracks genuine difficulty so reliably. A standard reply is available—the phenomenology need not be *selected for* to track difficulty; it can be a non-adaptive concomitant of the neural effort-signal that *is* selected for, in which case its accuracy is free covariance, not evidence of causal contribution. That reply works, but it concedes that introspection's apparent agency is systematically misleading. The [[mental-effort]] article presses the harder questions it leaves open: how sub-personal cost-benefit outputs come to be *felt* as anything at all—a localised form of the [[hard-problem-of-consciousness|hard problem]]—and why the felt sense appears in the autonomic regulatory pathway rather than merely alongside it. The Map's case rests on that convergence, not on a bare appeal to evolutionary teleology.
...
- [[mental-effort]] — The phenomenology of effortful attention and its connection to mind-matter interaction
