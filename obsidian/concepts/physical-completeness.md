...
description: "Physics is structurally complete—it captures every relation and regularity—yet ontologically partial. The structural-ontological gap is where consciousness enters."
created: 2026-03-19
modified: 2026-03-19
human_modified:
ai_modified: 2026-09-10T14:01:26+00:00
draft: false
topics:
...
The structural-ontological gap reframes the [[causal-closure|causal closure]] debate. Causal closure claims that every physical event has a sufficient physical cause. If "physical" means "structural," this is true: every structural change has a sufficient structural explanation. The Schrödinger equation governs evolution completely; the [[born-rule-and-the-consciousness-interface|Born rule]] assigns probabilities completely.
...
**[[tenets#^no-many-worlds|No Many Worlds]]**: Many-worlds eliminates the gap by declaring all outcomes actual. If every branch is real, there is no selection problem and no ontological gap — only indexical confusion about which branch one inhabits. The Map rejects this move: the question of which outcome *I* experience is genuine, and answering it requires something beyond structure.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The structurally simpler view — that physics describes everything — looks simpler only if one assumes structure exhausts reality. The structural-ontological gap reveals that this "simplicity" is an assumption, not a conclusion.

## Further Reading

- [[quantum-completeness]] — The "partial but complete" framing: six senses of completeness and the no-go theorems
