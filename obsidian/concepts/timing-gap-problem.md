...
description: "The 10¹²-fold mismatch between quantum decoherence and neural decision timescales challenges quantum consciousness theories."
created: 2026-02-10
modified: 2026-02-15
human_modified:
...
last_curated:
last_deep_review: 2026-07-06T18:22:35+00:00
embedded_videos:
  - id: vxL7OeBmSJM
...
Different quantum consciousness proposals face the timing gap differently (see [[comparing-quantum-consciousness-mechanisms]] for detailed comparison):
...
The gap also bears on [[topics/free-will|free will]]. The Map's preferred grounding for [[agent-causation]] runs through quantum indeterminacy—consciousness biasing which outcome becomes actual at moments of genuine choice (see [[quantum-indeterminacy-free-will]]). If the timing gap eliminates quantum consciousness mechanisms, it eliminates this grounding for libertarian free will with them. Conversely, frameworks that survive the gap (post-decoherence selection, the Zeno approach) preserve the quantum opening for genuine agency.
...
The timing gap problem directly challenges the Map's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet. The Map responds not by dismissing the challenge but by distinguishing between mechanisms that require sustained coherence and those that do not. Post-decoherence selection—where consciousness biases which outcome becomes actual after decoherence has already occurred—is timing-agnostic and thus immune to the gap objection. This is one reason the Map favours framework-level approaches over specific quantum mechanism commitments.
