...
NCC strongly supports physical→mental causation. Top-down effects—attention modulating sensory processing, intention affecting motor preparation—admit of both physicalist and interactionist readings. Covert consciousness findings are suggestive: if consciousness can persist when NCCs for behavioral output are disrupted, this suggests consciousness *interfaces* with neural activity rather than being generated by it, supporting [[tenets#^bidirectional-interaction|Bidirectional Interaction]]. NCC research also bears on [[free-will]]: if consciousness genuinely selects among superposed neural states (rather than merely accompanying predetermined outcomes), NCC identifies where such selection occurs—though the research itself cannot distinguish genuine agent causation from sophisticated [[conscious-vs-unconscious-processing|unconscious processing]].
