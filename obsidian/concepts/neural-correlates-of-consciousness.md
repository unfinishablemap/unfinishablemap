...
If the posterior cortical hot zone is where conscious content emerges, this region might be where consciousness "reads" physical information. If consciousness also influences the brain (as the site's [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet holds), the interface might be where it "writes" back.
