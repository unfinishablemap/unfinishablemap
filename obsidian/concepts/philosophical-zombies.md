...
But this concedes the conceivability premise while denying the reality of what's conceived. The question then becomes: is our conviction that we're phenomenally conscious—a conviction shared by nearly all humans across cultures—better explained by systematic illusion or by actual phenomenal consciousness? the project maintains that the reality of experience is more obvious than any premises used to deny it. See [[introspection]] for why phenomenal access is more reliable than illusionism allows.
...
This doesn't commit the project to process philosophy specifically, but it illuminates why the zombie argument works: physical description inherently leaves out the intrinsic experiential character that [[phenomenology]] reveals as fundamental to consciousness.
...
5. **Introspection proved systematically unreliable for phenomenal content.** If we had strong evidence that [[introspection]] radically misrepresents not just cognitive processes but basic phenomenal states—evidence not itself relying on introspection—the epistemic basis for conceiving zombies would erode.
...
**[[tenets#^dualism|Dualism]]**: The zombie argument is one of the most powerful supports for the project's foundational commitment. If zombies are conceivable, consciousness isn't entailed by physical facts, and something beyond physics is needed to explain experience. The argument doesn't specify *what* that something is—substance dualism, property dualism, and panpsychism all satisfy the conclusion—but it establishes that the mental is not reducible to the physical.
...
- [[arguments-for-dualism]] — The full case for dualism, including the conceivability argument
