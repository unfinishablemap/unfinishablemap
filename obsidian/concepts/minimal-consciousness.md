...
the project rejects illusionism for reasons detailed on its [[illusionism|dedicated page]], but the minimal consciousness literature provides a specific response: **the illusion problem scales with complexity**.
