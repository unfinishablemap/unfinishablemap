...
modified: 2026-01-14
human_modified: null
ai_modified: 2026-01-23T21:30:00+00:00
draft: false
topics:
...
This article surveys the dissociation evidence, examines what the debate means for theories of consciousness, and explains why The Unfinishable Map's framework places attention at the heart of mind-matter interaction.
...
The [[functionalism|functionalist]] equation of consciousness with a functional role (being available for report, guiding action, entering working memory) stumbles here. Consciousness seems to be something over and above the function—present when the function is absent, absent when the function operates.
...
Recent neuroscience reveals that "voluntary attention" encompasses importantly different modes. [[voluntary-attention-control|Vossel (2023) and Bengson (2019)]] identify three distinct attention types:
...
The [[mental-effort|phenomenology of mental effort]] supports this picture. William James observed that "the free will question relates solely to the amount of effort of attention." Sustaining attention feels effortful—and if Stapp is right, it *is* effortful: each mental observation requires engagement.
...
[[Mental-imagery]] provides striking evidence for attention's role in consciousness-matter interaction. The distinction between voluntary and involuntary imagery maps directly onto the attention-consciousness interface:
...
This challenge is addressed in detail in [[decoherence]]. Briefly: (1) Tegmark's calculation has been disputed—corrected models give coherence times seven orders of magnitude longer. (2) Quantum biology demonstrates that living systems can sustain coherence for functionally relevant timescales (magnetoreception maintains spin coherence for microseconds). (3) Most importantly, the Zeno mechanism doesn't require sustained coherence *between* observations—it operates through rapid repeated observation events. The relevant question is whether observation cycles can occur faster than decoherence, which may have different answers than whether coherence can be maintained passively.

The decoherence objection remains a serious empirical challenge, but it's not the categorical refutation it's sometimes presented as. See [[decoherence]] for the full treatment including 2024-2025 experimental developments.
...
Working memory and attention are deeply interlinked—attention determines what enters working memory, and working memory contents guide attention. This bidirectional relationship strengthens the [[attention-as-interface|interface hypothesis]].
...
The process view complements the interface hypothesis: attention isn't consciousness's *mechanism* for influencing an alien physical world, but rather consciousness's mode of participation in a reality that has experiential character at every scale. The [[pairing-problem]]—how non-physical consciousness connects to physical matter—is dissolved rather than solved: there is no fundamental gap to bridge because experience and process are primordial.
...
5. **Many-worlds is confirmed**: If branching can be detected and quantum selection proves illusory—if all outcomes occur in different branches rather than being genuinely selected—then attention selects nothing. The interface hypothesis requires real collapse; [[many-worlds]] eliminates it.

## Relation to the Map's Perspective

The attention-consciousness relationship illuminates all five tenets:

**[[tenets#^dualism|Dualism]]**: The dissociation evidence suggests consciousness cannot be reduced to attentional mechanisms. Attention is a process; consciousness is a subject. The process serves the subject, but isn't identical to it.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: Attention may be the specific mechanism by which consciousness influences quantum indeterminacies. Stapp's quantum Zeno approach makes this concrete: sustained attention is repeated observation, and repeated observation shapes which quantum states become actual.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: The neuroplasticity evidence (Schwartz's OCD therapy) demonstrates downward causation. Directed attention changes brain structure. This is hard to explain if consciousness is epiphenomenal.

**[[tenets#^no-many-worlds|No Many Worlds]]**: If attention operates through quantum selection, it presupposes real collapse. Attention selects among possibilities; it doesn't split into branches attending to each.

**[[tenets#^occam|Occam's Razor Has Limits]]**: The debate between equivalency and dissociationist views, the refrigerator-light problem, the multiple competing theories—all suggest consciousness and attention resist simple identification. The phenomenon is more complex than reductive theories admit.
...
- [[decoherence]] — The challenge of quantum coherence in warm biological systems and responses
- [[mysterianism]] — Cognitive closure and the limits of understanding consciousness
- [[agent-causation]] — The philosophical framework for conscious initiation of action
- [[pairing-problem]] — How non-physical consciousness connects to physical matter
...
- [[illusionism]] — The view that phenomenal consciousness is systematically misrepresented
- [[attention-schema-theory]] — Graziano's specific illusionist theory and the Map's critique
- [[hard-problem-of-consciousness]] — Why attention alone can't solve the hard problem
- [[attention-consciousness-relationship-2026-01-15]] — Detailed research notes
