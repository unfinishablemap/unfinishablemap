...
The relationship between doubt and [[phenomenology-of-error-recognition|error recognition]] is complex. Error-blindness—the inability to perceive current errors—means that doubt is our primary warning system. We cannot feel that we are wrong, but we can feel that we might be wrong. Doubt is metacognitive monitoring detecting instability in the belief system.
...
- [[phenomenology-of-error-recognition]] — Why error has no distinctive feeling
