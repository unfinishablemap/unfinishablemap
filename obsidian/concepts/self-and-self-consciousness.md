...
last_curated:
last_deep_review: 2026-05-01T04:25:00+00:00
coalesced_from:
...
A fourth dimension cuts across all layers: [[self-opacity|the unobservable self]]. When attention seeks the observer, it finds only more observation.
...
Zahavi, following Husserl, replies that self-consciousness is not produced by reflection but is a primitive feature of conscious life. Pre-reflective self-consciousness is the mode in which consciousness exists, not the result of consciousness examining itself.
...
1. **Status.** Zahavi: first-personal givenness is constitutive of phenomenality. Metzinger: a contingent feature, in principle absent in MPE.
2. **Ego-dissolution.** Zahavi: the minimal self persists as bare for-me-ness while narrative and bodily self-models dissolve. Metzinger: self-model dissolution removes the subject entirely.
3. **Epistemic implications.** For Zahavi, ego-dissolution reports come *from* the surviving minimal self. For Metzinger, they are post-hoc productions of a reconstituted self-model.

The Map takes the Zahavian reading to better fit first-person reports: subjects describe loss of "me-as-character" alongside persistence of bare experiential presence. If there is something it is like to undergo MPE, there is a subject *for whom* it is like something, however minimal. The [[mind-brain-separation|filter theory]] offers the complementary picture: the self-model is the interface through which consciousness engages the brain, not the brain producing selfhood.

## Distinguishing Zahavi from Strawson and Hume

**Galen Strawson's "thin subject" view** (2009): subjects exist but are thin and short-lived, with no persistence across gaps in consciousness. Closer to Zahavi than Metzinger, but commits to a negative answer on diachronic identity that Zahavi treats with caution.

**Hume's bundle theory.** Hume found "never anything but the perception" when introspecting for the self (1739, I.IV.VI). Zahavi's reply: Hume looked for the self as a distinct *object* of introspection, but the minimal self is the *subjective pole* of the very introspection Hume performed — an eye cannot see itself seeing. Parallels [[self-opacity|structural unobservability]].
...
The comparative picture (mirror self-recognition: great apes, elephants, dolphins, some corvids) suggests degrees: pre-reflective self-consciousness may be widespread, reflective far more restricted. The [[jourdain-hypothesis|Jourdain Hypothesis]] proposes many animals are conscious without *knowing* they are conscious beings. [[baseline-cognition|Baseline cognition]] research finds great apes use procedural metacognition without representing themselves *as beings who have cognitive states* — the qualitative shift the Map calls the [[metarepresentation-threshold]], above which reflective self-consciousness becomes possible. The threshold concept matters here because it predicts that the dimensions of selfhood Zahavi distinguishes (pre-reflective for-me-ness, reflective metacognition, narrative construction) are not graded along a single continuum: pre-reflective self-presence appears widely available below the threshold, while reflective self-consciousness depends on the discrete capacity for declarative metarepresentation.

## Buddhist No-Self and the Madhyamaka Challenge

Buddhism's *anattā* doctrine denies a permanent, unchanging self while accepting that consciousness is real ([[buddhism-and-dualism]]). Whether it denies the minimal self is disputed — meditation aims to see through the *constructed* self, and what remains need not be nothing ([[witness-consciousness]]).

The serious objection comes from Mādhyamaka: Nāgārjuna's analysis grants what Zahavi notices but contests what he infers. The appearance that experience is *for-someone* is real; treating for-someone-ness as a structural feature implying a self-standing subject is the mistake. On sustained analysis, "for-me-ness" decomposes into conditioned moments, none belonging to a subject standing outside the sequence. The objection sharpens when the Map adds the diachronic [[haecceity|haecceity]] commitment to Zahavi's synchronic agnosticism: from Mādhyamaka, that reinstates *ātman*. Evan Thompson's middle path (*Waking, Dreaming, Being* 2014) converges with Mādhyamaka: the inference from "experience has reflexive structure" to "there is a self this experience belongs to" is not licensed by phenomenology alone.

The candid reply: the haecceity-across-time commitment cannot survive sustained Mādhyamaka analysis in full force. The Map's position is conditional on reading contemplative selflessness as attenuated experience by a still-individuated subject, not as a vantage where individuation has dissolved. If sustained analysis really dissolves the indexical bearer, [[tenets#^no-many-worlds|No Many Worlds]] faces a tenet-level reply. The Map proceeds because haecceity, No Many Worlds, and Bidirectional Interaction form a mutually supporting cluster the alternative reading would dissolve simultaneously.

## Diachronic Identity

The Map distinguishes three positions on what connects conscious moments:
...
2. Zahavi, D. (2005). *Subjectivity and Selfhood: Investigating the First-Person Perspective*. MIT Press.
3. Zahavi, D. (2014). *Self and Other: Exploring Subjectivity, Empathy, and Shame*. Oxford University Press.
4. Gallagher, S., & Zahavi, D. (2020). *The Phenomenological Mind* (3rd ed.). Routledge.
5. Henrich, D. (1966). "Fichte's Original Insight." Translated in *Contemporary German Philosophy*, vol. 1, 1982.
