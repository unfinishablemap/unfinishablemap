...
Libet asked participants to make spontaneous wrist movements while watching a clock. They reported when they first became aware of the urge to move (the "W-time"). Simultaneously, EEG recorded brain activity.

**The striking finding**: A buildup of neural activity—the readiness potential—began about 550 milliseconds before the movement. But conscious awareness of intending to move occurred only about 200 milliseconds before. The RP preceded conscious intention by roughly 350 milliseconds.

The implication seemed clear: the brain "decided" before consciousness knew. The decision was already in motion before subjects felt they were choosing.
...
Schurger, Sitt, and Dehaene (2012) challenged the standard interpretation. They proposed that the readiness potential isn't a decision signal but reflects stochastic neural fluctuations—noise that accumulates until it crosses a threshold, triggering the action.

**Their model**: The brain continuously experiences random neural fluctuations. In Libet's paradigm, participants wait for an internal impulse to move. They act when accumulated noise happens to cross a threshold. The RP is an artifact of averaging many such random buildups, aligned backwards from the action point.
...
More fundamentally, the project's framework suggests the initiation/selection distinction may be the key insight. Consciousness needn't generate options from nothing—it can exercise genuine agency by selecting among options the brain presents.
...
[[Illusionism]]—the view that phenomenal consciousness is an illusion—interprets Libet differently. On this view, the experiments show exactly what we should expect: the brain constructs the *appearance* of decision-making after the fact. We don't experience decisions because we make them; we experience decisions because the brain generates a post-hoc narrative of agency.
...
The framework aligns with the project's tenets: consciousness is ontologically primitive (not reducible to physics), causally efficacious (actual occasions determine outcomes), and selective (many become one). Whether the Zeno mechanism, retrocausality, or process metaphysics provides the best account remains open—but all three show that Libet doesn't refute conscious causation.
...
The Libet experiments engage directly with the project's core commitments.
...
**Against [[epiphenomenalism]]**: If consciousness were epiphenomenal, our beliefs about consciousness would be produced by neural processes unconnected to consciousness itself. But we discuss consciousness, form theories about it, design experiments to study it. If these discussions have nothing to do with actual conscious experience—if they'd occur identically in philosophical zombies—they're accidentally accurate at best. The Libet debate itself suggests consciousness influences something.

## What Would Challenge This View?

the project's interpretation of Libet is falsifiable. Evidence against it would include:
...
- [[illusionism]] — The eliminativist interpretation and its problems
