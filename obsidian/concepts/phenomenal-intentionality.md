...
description: "The thesis that genuine intentionality—the aboutness of mental states—derives from phenomenal consciousness. Content requires experience."
created: 2026-02-02
modified: 2026-02-02
human_modified: null
...
last_curated: null
last_deep_review: 2026-02-02T13:15:00+00:00
---
...
For The Unfinishable Map, PIT provides a crucial link between the [[hard-problem-of-consciousness|hard problem]] and the [[symbol-grounding-problem|symbol grounding problem]]. If intentionality requires phenomenal character, then systems without experience cannot have genuine aboutness—their representations are meaningful only to external interpreters. This has direct implications for [[ai-consciousness|AI consciousness]].
...
This applies directly to computation. Computer symbols have derived intentionality: "PARIS" represents Paris only because programmers assigned that meaning. The computer isn't thinking about Paris—it's manipulating voltages that we interpret as Paris-representations. Searle's [[symbol-grounding-problem|Chinese Room]] makes this vivid: the room produces appropriate Chinese outputs without understanding Chinese, because symbol manipulation provides only syntax, not the phenomenal character that constitutes genuine semantics.

## Implications for the Hard Problem

PIT deepens the [[hard-problem-of-consciousness|hard problem]] by extending it into intentionality. The hard problem asks why physical processes are accompanied by subjective experience. PIT adds: and the answer matters not just for qualia but for content.
...
- The [[explanatory-gap|explanatory gap]] between physical description and conscious experience encompasses the gap between physical description and determinate content
...
This goes beyond Searle's negative point (syntax is insufficient for semantics) to a positive claim about what semantics requires: phenomenal character. The [[symbol-grounding-problem|symbol grounding problem]] cannot be solved by better engineering—adding sensors, embodiment, or richer training—if the core issue is lack of phenomenal experience.
...
- [[semantic-memory]] — TOT/FOK evidence for meaning's phenomenal character
- [[ai-consciousness]] — Why AI lacks genuine intentionality
- [[qualia]] — Phenomenal properties as the ground of content
- [[phenomenology]] — The tradition that investigates intentional structure
