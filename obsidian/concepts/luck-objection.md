...
last_curated: null
last_deep_review: 2026-06-23T00:12:57+00:00
---
...
Kane's 2024 *Complex Tapestry of Free Will* now explicitly incorporates [[agent-causation|agent-causal]] elements, arguing that free action requires agents "exercising teleological guidance control." This convergence suggests the event-causal/agent-causal divide may be less fundamental than thought. See [[quantum-indeterminacy-free-will]] for integration with the quantum Zeno mechanism.
...
[[agent-causation|Agent-causal]] libertarians (Chisholm, O'Connor, Lowe) argue the agent *does* explain the difference between possible worlds. Agent causation is a primitive relation—not reducible to prior events—that grounds genuine authorship. The agent's exercise of causal power *is* the explanation.
...
The luck objection directly challenges the Map's [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet. If consciousness's influence is random rather than guided, it provides no more freedom than determinism.

**Dualism**: The [[tenets#^dualism|Dualism]] tenet grounds the response. If consciousness is nothing but physical processes, "consciousness selects" collapses into "physics determines"—no selector distinct from what's being selected. The irreducibility of consciousness makes selection possible.
...
- [[compatibilist-symmetry-challenge]] — Named anti-slippage discipline at the moral-responsibility tier: surviving the luck objection does not establish that libertarian agency is required for moral phenomena
