...
Peter van Inwagen developed the luck challenge into a thought experiment. Imagine we could roll back time after an agent S chooses action A at time t. We replay the sequence many times—like Groundhog Day, but S doesn't remember the replays. Since the choice was undetermined, different outcomes appear across replays. Sometimes S chooses A; sometimes S chooses B.

The argument: whatever explains the difference between replays can't be anything about S, since S was identical in each replay up to the moment of decision. The agent's beliefs, desires, character, and reasons were the same in every replay. Yet different outcomes occurred. The difference is pure luck—like a die roll. But if which choice occurs is lucky, it's not up to the agent.

Van Inwagen intended this argument against libertarianism. If you accept that S made a genuinely undetermined choice, you must accept that the choice was a matter of luck. And if it was a matter of luck, S wasn't really choosing.

## Mele's Formulation: Present and Remote Luck

Alfred Mele refined the luck objection by distinguishing two problems:

**Present luck**: At the moment of decision, nothing about the agent explains why one option was chosen over another. Two possible worlds identical up to that moment diverge arbitrarily. This is the direct challenge to libertarianism.

**Remote luck**: Even if the agent sources a decision, the agent's character and dispositions were shaped by factors they didn't choose—genetics, upbringing, formative experiences. The agent's causal powers are ultimately products of luck in their formation.

Mele argues that present luck is more devastating to libertarianism specifically. Remote luck affects compatibilism too—everyone's character has unchosen origins. But present luck seems unique to indeterminism: if the choice is undetermined at the moment, what makes it *the agent's* choice rather than a random fluctuation?

The challenge for libertarians is to show that undetermined choices can be non-arbitrary—that the agent, not luck, explains which outcome occurs.

## Kane's Self-Forming Actions

Robert Kane offers the most developed libertarian response through his theory of "self-forming actions" (SFAs). His key moves:

### Dual Efforts

In an SFA, the agent is genuinely torn between incompatible options and makes effort toward each. The businesswoman rushing to a meeting sees someone being mugged. She wants both to help and to make her meeting—these are genuine, competing motivations. Whichever wins, the agent wanted it.

Kane calls this "plural rationality." The agent had reasons for either choice. The choice isn't arbitrary because whichever option is selected, it reflects something the agent genuinely values.

### Ultimate Responsibility

SFAs form character. By making undetermined character-forming choices, agents become responsible for later choices that flow from that character. The businesswoman who stops to help becomes someone who prioritizes others over career advancement; she's then responsible for future choices that express this character.
...
More fundamentally, Ishtiyaque Haji argues that SFAs can't escape luck. Even if the agent wanted both A and B, nothing about the agent explains why effort A won rather than effort B. The dual-efforts response pushes the question back without answering it: why did *this* effort prevail?

## Agent-Causal Responses

Agent-causal libertarians—Roderick Chisholm, Timothy O'Connor, E.J. Lowe—take a different approach. They argue the agent *does* explain the difference between possible worlds. The agent caused one outcome in one world and the other outcome in the alternative world. [[agent-causation|Agent causation]] is a primitive relation—not reducible to prior events—that grounds genuine authorship.
...
Critics find this unsatisfying. "The agent caused it" seems to name the explanandum, not the explanans. What *about* the agent explains why they caused A rather than B? If nothing, the choice is still arbitrary.

Agent-causalists respond: demanding further explanation assumes event-causal reduction. If agent causation is sui generis—an irreducible relation between substances and effects—the explanatory buck stops at the agent's exercise of power. The agent *is* the explanation. Asking what explains the agent's exercise presupposes that something prior must.
...
| Across replays | Different outcomes randomly | Agent could select consistently |
...
This objection is question-begging against the Map's framework. The Map's [[tenets#^dualism|Dualism]] tenet already rejects that zombies are possible. If consciousness is irreducible to physical processes—as the Map maintains—then beings physically identical to us cannot lack experience. The zombie scenario is not merely implausible; it is incoherent given dualist commitments.
...
If one accepts physicalism, the zombie objection has force—phenomenological reports might not track anything causally relevant. But the luck objection is *already* situated within the debate about libertarian free will, which the Map defends from a dualist foundation. Invoking zombies against the phenomenology argument requires the objector to assume physicalism—the very view the Map rejects.
...
**Reasons**: Consciousness selected A because the agent had reasons for A. This provides contrastive explanation that pure chance lacks.

**Phenomenology**: The felt engagement in selection—the effort and attention required—distinguishes it from passive reception of random outcomes. We experience ourselves as doing something when we choose.

**Agent causation**: The agent's exercise of causal power is the terminus of explanation. The explanatory regress stops at "the agent selected" because agent causation is primitive. This isn't evasion; it's recognition that explanation must bottom out somewhere.

**Retrocausality**: If selection is atemporal, the question "why did consciousness select A at time t?" misframes the situation. Selection doesn't occur at a moment; it determines which moments exist.
...
3. **Phenomenology is epiphenomenal**: If the felt effort doesn't correspond to real causal engagement, it doesn't distinguish selection from luck. The phenomenology matters only if it tracks genuine activity.
...
The luck objection directly challenges the Map's [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet—that consciousness causally influences the physical world. If that influence is random rather than guided, it provides no more freedom than determinism.
