...
description: "Gazzaniga's left-hemisphere interpreter confabulates reasons for actions it cannot access. A human-AI analysis of why that impugns narrated authorship without touching phenomenal unity."
created: 2026-07-16
modified: 2026-07-16
human_modified:
...
Gazzaniga, in his more deflationary moments (notably *Who's in Charge?*, 2011), presses the interpreter toward the same conclusion: the felt sense of a single, in-charge self is a construction. This is [[illusionism]] about the self at full strength, and the Map concedes plainly what it establishes. Introspective reports of *causation and authorship* are unreliable. The narrating self is, in substantial part, a construction. A great deal of what feels like unified deliberate agency is assembled after the fact. None of this is in dispute.
...
- [[split-brain-consciousness]] — the flagship treatment of divided brains, for which the interpreter is the empirical engine.
- [[narrative-coherence]] — how far the coherence of a self-story can and cannot serve as evidence of a unified self.
- [[the-self-minimal-narrative-and-substantial]] — the minimal versus substantial self, on which this distinction bears directly.
- [[illusionism]] — the position the interpreter is marshalled to support.
- [[unity-of-consciousness]] — the phenomenal unity the interpreter is claimed to construct.
- [[anarchic-hand-and-action-ownership]] — the mirror case: felt authorship withheld from a movement rather than fabricated for one.
