...
Two nearby uses of "relocation" in the Map's vocabulary should be kept apart from this one. [[constitution-vs-causal-work]] relocates a *dispute*: it shows that a disagreement between readings lives one level below the evidence both accept, and it insists that "Relocating the dispute to the bridge is a claim about *where* the disagreement lives, not a claim that the Map's side of the bridge is correct." [[emergence-as-universal-hard-problem]] generalises relocation to every reduction in science, a stronger thesis whose costs are discussed [below](#proves-too-much). The relocation objection proper is narrower than either: it concerns identity or constitution claims about phenomenal consciousness.

## The Map's Reading {#map-reading}

[[first-order-representationalism]] states the Map's version in canonical form: "fixing the functional or representational facts leaves the phenomenal fact untouched." On the Map's reading, the objection works because phenomenal concepts pick out their referent directly, not through a causal or functional role. "Heat" is plausibly exhausted by a role (whatever causes these sensations and expands mercury), so once molecular motion is shown to fill the role, nothing is left over to explain. "Pain as felt" is not obviously exhausted by any role, so filling the role leaves a remainder. [[tenets#^dualism|Tenet 1]] is the Map's commitment that the remainder is real.
...
|---|---|---|
| [[recurrent-processing-theory\|Recurrent processing]] | Localised re-entrant signalling at Stage 3 | "why does re-entrant signalling feel like anything?" The Stage 2 to Stage 3 boundary is where felt quality "is declared to have arrived" |
| [[attended-intermediate-representations-theory\|AIR]] | Attended, gamma-synchronised intermediate representations | The attention gate is "a re-description of the conditions under which experience shows up, not an account of why it is felt" |
| [[self-model-theory-of-subjectivity\|Self-model theory]] | A transparent self-model | Transparency explains the sense of *being* someone, but "the hard problem is re-sited inside the self-model rather than removed" |
| [[higher-order-theories\|Higher-order theories]] | A higher-order thought about a state with mental qualities | Rosenthal's mental-qualities reply "relocates the transition into felt experience rather than explaining it"; the page also finds the relocation going "one level up" if the higher-order seeming is itself felt |
| [[first-order-representationalism\|First-order representationalism]] | Representational content | "why does representing-thus feel like anything?"; the four inversion replies show the move "in miniature" |
| [[attention-schema-theory\|Attention schema theory]] | The brain's model of its own attention | Shifting the explanandum to the *appearance* of experience "renames the problem rather than solving it" |
| [[neural-correlates-of-consciousness\|NCC research]] | The minimal neural correlate | Correlation is not identity; an illusionist reading of the data either leaves the seeming phenomenal, "relocating rather than eliminating consciousness", or owes an account of non-phenomenal seeming |
...
**[[tenets#^dualism|Dualism]]** is the premise the objection relies on. The objection's step 3 has ontological weight only if phenomenal concepts pick out something the functional description leaves out, and Tenet 1 is the Map's commitment that they do. The objection explains why rival theories have not displaced that commitment; it does not independently establish it.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]** explains why the rivals' economy does not settle the matter. An identity theory is simpler: one kind of thing instead of two. The reply that the relocated question needs no answer turns that simplicity into a verdict. Tenet 5 holds that where knowledge of consciousness is this incomplete, parsimony is not strong enough to decide which questions are real. Tenet 5 also constrains the Map, since its warrant for the remainder is non-empirical, as the multiple drafts page concedes.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** and **[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]** enter only where the correlate is re-read as an interface. Against identity theories, Tenet 1 alone does the resisting. Once the Map proposes its own interface, the objection applies to it, as [the two-edged form](#two-edged) records. The objection does not protect the interface commitments, where the Map's empirical exposure lies.
