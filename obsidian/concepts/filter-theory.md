...
The difference appears metaphysical rather than empirical. Yet filter theory organizes expectations differently: disrupting the brain could sometimes *enhance* experience (when constraints loosen), whereas *naive* unified-switch production models predict only degradation or alteration. The asymmetry is scoped to that naive target: sophisticated production accommodates coherent—even enhanced—phenomenal outcomes via redistributed processing, a concession the closing section develops in full. Even against the naive target it is suggestive but not decisive—filter theory lacks independent criteria specifying *which* disruptions should enhance versus degrade experience, making the "prediction" partly post hoc. The [[#evidence-supporting-filter-theory|evidence section below]] examines where this distinction matters.

Filter theory denies that correlation establishes identity, using the radio analogy: damaging a radio's circuitry produces specific reception deficits—static on certain frequencies, loss of bass, complete silence—but this doesn't prove the radio *produces* the broadcast rather than *receiving* it.
...
The [[minimal-consciousness]] literature raises a sharp question: where does the filter begin? *C. elegans* (302 neurons) displays learning behaviors yet may lack the structural complexity for consciousness to interface effectively. The slime mold *Physarum polycephalum* solves mazes without any neurons, suggesting [[baseline-cognition|baseline cognition]]—sophisticated information processing without conscious contribution—can fully dissociate from consciousness. This connects to [[brain-interface-boundary]]: not just *any* complex system serves as a consciousness interface. The brain's specific properties—representational structure, attention mechanisms, and a contested sensitivity to quantum-scale events (whether warm, wet neural tissue can sustain the requisite quantum coherence against rapid decoherence is disputed; the defense lives at [[brain-interface-boundary]])—make it suitable.
...
- [[identity-across-transformations]] — Apex synthesis: identity persistence through anesthesia and death
...
- [[altered-states-as-interface-evidence|Altered States as Systematic Interface Evidence]] — Apex synthesis: six altered states converging on multi-channel interface architecture
...
- [[bandwidth-of-consciousness]] — The ~10 bits/s conscious throughput ceiling as a signature of filtering
...
- [[consciousness-epistemology-extended-cognition]] — Filter theory and extended cognition: tools expand the filter's resources while consciousness resists extension
