...
The radical option splits into two strands. *Classical eliminativism* (Paul and Patricia Churchland) targets folk-psychological concepts—beliefs, desires, intentions—as theoretical posits like "phlogiston" or "caloric" that a mature neuroscience will eliminate rather than reduce. *Illusionism* (Frankish, Dennett) targets [[qualia]] specifically, claiming introspection systematically misrepresents physical-functional states as having phenomenal character. The two strands can be held independently.
...
The problem: eliminativism seems to deny the obvious. There is [[phenomenology|something it is like]] to read these words. Eliminativists respond that functional states can be acknowledged without the folk psychological framework of "experiences" and "qualia"—but this response merely pushes back the question: what explains the differential processing that constitutes the illusion of rich qualitative character? The position risks self-undermining in a way similar to [[concepts/epiphenomenalism]].

See [[eliminative-materialism]] for detailed treatment of both strands and the Map's nuanced response.

### Illusionism

[[illusionism|Illusionism]] holds that consciousness exists but not as we conceive it. Dennett and Frankish argue we have a systematic illusion of rich [[qualia|qualitative experience]]—what exists is just information processing that represents itself as having qualitative properties.

The problem: illusionism trades the hard problem for the "illusion problem"—explaining why we so powerfully believe we're phenomenally conscious when we're not. All illusions presuppose experience; being under an illusion about qualia still involves *something it is like* to have that illusion. The problem reappears at each level of analysis. Moreover, illusionism [[illusionism#Structural Convergence with Epiphenomenalism|converges structurally with epiphenomenalism]]—both render phenomenal properties causally idle, inheriting the same self-stultification problem.

See [[illusionism]] for detailed treatment.
...
For a comprehensive treatment of these arguments, including [[kripke-a-posteriori-necessity-argument|Kripke's modal argument]], Nagel's subjectivity argument, and the convergence argument showing how independent lines of reasoning reinforce each other, see [[dualism]]. For the focused case from the hard problem, zombies, epiphenomenalism, and quantum indeterminacy, see [[arguments/materialism-argument|Against Materialism]].
...
We can conceive of [[philosophical-zombies]]—beings physically identical to us but without consciousness. If such beings are genuinely conceivable, they're metaphysically possible. And if possible, consciousness is not entailed by physical facts—materialism is false.

Physicalists dispute conceivability or the conceivability-possibility link, but neither response has proven convincing. The burden is on materialists to show why physical duplicates must have identical experiences—and they haven't. See [[philosophical-zombies]] for detailed treatment.

### The Self-Stultification Problem

The [[argument-from-reason]]: if physicalism is true, it cannot be *rationally believed*. Rational inference requires tracking normative relationships—recognizing that conclusions *follow from* premises. But physical causation operates via efficient causes that make no reference to these norms.
...
[[mysterianism|Mysterianism]] (Colin McGinn) argues that consciousness may have a naturalistic explanation—but one human minds are cognitively closed to understanding. The solution may exist; we simply cannot reach it.

This undercuts the "future science" appeal: if McGinn is right, no amount of progress will close the gap. The Map's position differs—rather than treating the hard problem as unsolvable mystery, we take it as evidence that the materialist framework is wrong. See [[mysterianism]] for detailed treatment.

### Alternative Frameworks

Process philosophy (Whitehead), [[panpsychism]], and [[idealism]] each challenge the materialism/dualism binary in different ways. For a systematic comparison of these [[analytic-idealism-and-mind-centric-metaphysics|mind-centric alternatives]]—idealism, panpsychism, cosmopsychism, dual-aspect monism, and the Map's dualism—see the comparative survey. These frameworks illustrate that rejecting materialism doesn't force Cartesian substance dualism—other options exist. The Map takes no position on these alternatives; what matters is the core claim: consciousness is not reducible to or derivable from the physical as materialism conceives it.
...
- [[idealism]] — Idealism's challenge to both materialism and dualism
- [[analytic-idealism-and-mind-centric-metaphysics]] — Comparative survey of mind-centric alternatives to materialism
...
- [[eliminative-materialism]] — Two strands of the radical materialist alternative
...
- [[concepts/many-worlds]] — Why MWI doesn't rescue materialism from the hard problem
