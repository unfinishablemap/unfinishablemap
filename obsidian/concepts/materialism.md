...
Process philosophy (Whitehead), [[panpsychism]], [[idealism]], and [[analytic-idealism]] each challenge the materialism/dualism binary in different ways. These frameworks illustrate that rejecting materialism doesn't force Cartesian substance dualism—other options exist. The Map takes no position on these alternatives; what matters is the core claim: consciousness is not reducible to or derivable from the physical as materialism conceives it.
