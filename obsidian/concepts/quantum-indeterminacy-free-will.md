...
Classical physics confronted free will with a simple exclusion: if the universe is deterministic, your choices are consequences of prior states you didn't choose. You couldn't have done otherwise in any sense that matters.

Quantum mechanics breaks determinism. Before measurement, particles exist in superposition—multiple possibilities coexisting without definite values. Measurement collapses superposition to definite outcomes, but which outcome occurs is not determined by prior physical states. The equations specify probabilities, not certainties.
...
Two major libertarian strategies address the dilemma:

**Event-causal libertarianism** (Kane, Balaguer, Ekstrom): mental events cause actions through nondeterministic processes. Kane locates indeterminacy in the *effort of will* during genuinely conflicted decisions. His 2024 *Complex Tapestry of Free Will* incorporates agent-causal elements, arguing that free action requires agents "exercising teleological guidance control"—representing convergence between the two positions.

**Agent-causal libertarianism** (the Map's framework): the agent as persisting substance directly causes actions. Chisholm distinguished *transeunt* causation (event→event) from *immanent* causation (agent→event). Lowe argued all causation is fundamentally substance causation, with event causation being derivative shorthand. See [[agent-causation]] for the full account.

Quantum indeterminacy provides the opening; the agent provides the selection. The explanatory buck stops at the agent's exercise of causal power, which is [[reasons-responsiveness|reasons-responsive]] rather than arbitrary.

## The Luck Objection: The Central Challenge

Alfred Mele and Peter van Inwagen formulated the central challenge to quantum free will. Van Inwagen's "rollback argument":
...
Mele sharpened this into **present luck** (nothing about the agent explains why one option was chosen over another) and **remote luck** (character was shaped by unchosen factors). Remote luck affects compatibilists equally. Present luck is the specifically libertarian problem: if nothing about the agent differs across possible worlds, what makes the outcome the agent's rather than a random fluctuation?
...
Standard quantum indeterminism is genuinely random—outcomes occur without explanation. If consciousness is a genuine causal factor (as the Map holds), it could *select* outcomes rather than merely witnessing them.

[[contextual-selection-in-quantum-foundations|Quantum contextuality]] (the Kochen-Specker theorem) adds structural depth: no assignment of definite values to all observables can be context-independent. The brain's physical configuration defines what options exist; consciousness biases which option actualizes. Selection is structurally richer than "choose A or B": attention participates in setting the measurement context itself.
...
If choices were random fluctuations, there would be no phenomenology of effort. Lucky events don't feel like achievements; selections do. This phenomenological evidence is not independently decisive—physicalists argue felt effort could be constructed post-hoc—but the Map treats phenomenology as evidentially relevant because dualism takes conscious experience seriously as a guide to causal structure.

### Reasons-Guided Selection

Selection tracks reasons—goals, values, considerations that matter. This [[reasons-responsiveness]] distinguishes agent selection from randomness. Why A rather than B? Because the agent had reasons for A. The reasons didn't *determine* the outcome—alternatives remained genuinely possible—but they *guided* it, making selection contrastively explicable in a way randomness isn't.

### Where Explanation Terminates

Critics press: what explains why consciousness selected A rather than B? The [[agent-causation|agent-causal]] response: the agent's exercise of causal power is itself the explanation. Explanation must terminate somewhere. "The agent selected for reasons" is a legitimate terminus—more satisfying than "it randomly happened."
...
The main philosophical objection to mental causation is [[causal-closure|causal closure]]: every physical event has a sufficient physical cause. If true, mental causes are either redundant or epiphenomenal.

Quantum indeterminacy provides the response. At measurement events, physics specifies necessary but not sufficient causes—which outcome occurs is genuinely undetermined. [[causal-closure|Causal closure fails precisely where consciousness acts]].
...
The Map's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet formalizes this: consciousness biases indeterminate quantum outcomes without injecting energy or violating [[conservation-laws-and-mental-causation|conservation laws]].
...
[[illusionism]] holds that phenomenal consciousness is an illusion—the feeling of choosing is constructed post-hoc with no genuine selection. The Map's response: illusionism is self-undermining. If reasoning is wholly constructed by neural processes unconnected to real reasoning, the decision to adopt illusionism was itself not genuinely reasoned to.

The phenomenology of effort distinguishes selection from passive reception. Hard choices feel hard; deliberation differs from reflex—phenomenologically, neurally, and behaviourally. The [[agent-causation#The Choking Phenomenon as Evidence|choking phenomenon]] provides non-verbal evidence: skilled performance degrades when attention is deployed, regardless of how we theorize about phenomenology.
...
**First**, decoherence doesn't solve the measurement problem. Something must still select which outcome becomes actual. The role for consciousness at selection remains open.

**Second**, a Zeno-like mechanism wouldn't require sustained coherence *between* observations—only rapid repeated observation events. Short coherence times may not matter, though this remains speculative.

**Third**, quantum biology has revealed coherence effects in warm biological systems. Photosynthesis exploits quantum coherence; avian magnetoreception depends on electron spin coherence lasting microseconds; the 2024 epothilone B study found results consistent with Orch OR predictions. The categorical objection—that biology cannot use quantum mechanics—is empirically refuted. See [[decoherence]] for details.

## What Would Challenge This Framework?

The framework is falsifiable. Findings that would undermine it:

- **Decisive neural determinism**: If all decisions could be predicted from prior brain states at timescales ruling out quantum effects. Current neuroscience falls well short of this.
- **Ruling out brain quantum effects**: If quantum coherence were proven physically impossible in neural tissue—not just challenging but excluded. Current research leaves this open.
- **Dissociation of effort and selection**: If mental effort showed no correlation with choice outcomes.
- **Solving the hard problem materialistically**: A compelling physicalist account of subjective experience would weaken the motivation for dualism and thus for consciousness as a separate causal factor.
- **Many-worlds confirmation**: No collapse means no role for consciousness in outcome selection.
- **Selection indistinguishable from randomness**: If choices showed no correlation with reasons, values, or phenomenal effort, the selection model collapses into the luck objection.

## The Picture That Emerges

Indeterminacy combined with consciousness as selector provides what libertarian free will requires: **alternative possibilities** (multiple outcomes genuinely possible until selection), **sourcehood** (consciousness selects among what physics leaves undetermined), **reasons-responsiveness** (selection tracks what matters to the agent), and **phenomenological authentication** (felt effort corresponds to genuine causal engagement).

The brain prepares superposed neural patterns. Physics determines that measurement will collapse the superposition but doesn't determine which outcome. Consciousness selects—not randomly, but based on reasons, with felt effort that marks genuine engagement.

This isn't proof—it's coherent integration of quantum mechanics, consciousness, and agency, finding in the intersection of the hard problem and genuine indeterminacy the space for libertarian free will.
...
- [[mental-causation-and-downward-causation|downward causation]] — How mental states influence physical outcomes
- [[contextual-selection-in-quantum-foundations]] — Why quantum selection is context-dependent, not item-picking
