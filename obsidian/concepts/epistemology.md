...
But epistemic humility has limits of its own. The Map does not treat all positions as equally uncertain. Some claims — that consciousness exists, that it has qualitative character, that it is not identical to any third-person description — are warranted by direct [[phenomenal-acquaintance|acquaintance]]. Epistemological modesty about mechanisms does not require agnosticism about phenomena. The challenge is calibrating confidence correctly, and the calibration is finer than a single level of certainty. The *existence* of experience — that there is something it is like to be the subject at all — carries the strongest warrant acquaintance can supply. The detailed *character* of experience carries a more calibrated, fallible warrant: [[introspection]] is demonstrably unreliable about fine-grained phenomenal content (change blindness, confabulated detail), so confidence here must be hedged even though the bare fact of qualitative character is secure. The full posture, then, is: most certain that experience exists and has some qualitative character, calibrated about its detailed character, modest about the mechanisms connecting it to the physical world, and sceptical about arguments that rely on unexamined epistemic assumptions.
