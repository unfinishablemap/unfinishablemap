...
modified: 2026-03-25
human_modified:
ai_modified: 2026-03-25T20:46:00+00:00
draft: false
topics:
...
**The parsimony assumption.** The most common argument against dualism is that physicalism is simpler. [[Parsimony-epistemology]] demonstrates that this argument fails: parsimony lacks epistemic warrant in metaphysical domains, "simplicity" fragments into contradictory dimensions, and parsimony's own defenders have conceded its inadequacy here. The assumption that simpler ontologies are more likely true is an epistemological commitment, not a finding — and one that has repeatedly failed in the history of science.
...
But epistemic humility has limits of its own. The Map does not treat all positions as equally uncertain. Some claims — that consciousness exists, that it has qualitative character, that it is not identical to any third-person description — are warranted by direct acquaintance. Epistemological modesty about mechanisms does not require agnosticism about phenomena. The challenge is calibrating confidence correctly: certain about the existence and character of experience, modest about the mechanisms connecting it to the physical world, and sceptical about arguments that rely on unexamined epistemic assumptions.
...
2. Goldman, A. I. (1986). *Epistemology and Cognition*. Harvard University Press.
...
5. Sosa, E. (2009). *Reflective Knowledge: Apt Belief and Reflective Knowledge, Volume II*. Oxford University Press.
