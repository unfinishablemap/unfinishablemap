...
modified: 2026-03-25
human_modified:
ai_modified: 2026-07-29T05:32:00+00:00
draft: false
topics:
...
**First-person epistemology** — [[introspection]], [[phenomenological-evidence|phenomenological report]], and contemplative inquiry — yields knowledge through direct [[phenomenal-acquaintance|acquaintance]] with experience. Whether such seemings confer justification at all is the province of [[phenomenal-conservatism]], the general principle that appearances of every kind carry defeasible prima facie warrant absent defeaters. This channel supplies the primary data that consciousness science seeks to explain — though precision about what "the data" names matters here, because four things are easily run together. The *experience* is the explanandum. The *introspective judgement* about it, the *verbal report* expressing that judgement, and the *publicly assessable evidence* derived from report — discrimination performance, physiological correlates, controlled contrasts — are evidential vehicles bearing on the explanandum rather than the explanandum itself. Chalmers draws the same line in distinguishing phenomenal from psychological seeming, so the identification cannot be laid at his door. Collapsing the four is what makes [[phenomenological-evidence|phenomenological evidence]] look like anecdotal colour added to the real science; keeping them apart shows why it carries genuine evidential weight.

The methodological claim this supports is historical and epistemic rather than absolute: first-person reports are the principal route by which consciousness became identifiable as a subject matter and by which it remains experimentally calibratable. No-report paradigms qualify that claim without overturning it — they isolate awareness from the processes involved in reporting, and recent work has decoded conscious contents without a report on every trial, but such methods remain contestable and ordinarily need report-based calibration to interpret. What they establish is the narrower point that report and experience cannot be treated as interchangeable.
...
If [[dualism]] is correct, epistemology itself requires revision. A dualist ontology implies that reality has two aspects — physical and phenomenal — and that complete knowledge requires epistemic access to both. Several consequences follow.
...
The reliance on convergence here, alongside the earlier dismantling of parsimony, is not selective epistemology, because the two are structurally different inferences. Convergence is evidential agreement among arguments that proceed from *different premises*, so the warrant it confers tracks the difficulty of explaining away several distinct lines at once; parsimony is a prior over ontologies — a standing preference for fewer kinds that does its work *before* the evidence is examined. The precondition convergence meets that parsimony fails is independence of the converging considerations: parsimony has no analogous check, because a simplicity preference is a single commitment that cannot corroborate itself. This is why the independence of the four arguments is load-bearing, and why it is best stated as *partial*. The [[knowledge-argument]], conceivability, and the [[explanatory-gap]] arguably share one underlying intuition — the omission of the qualitative from physical description — and so should not be counted as three fully separate confirmations; the [[argument-from-reason]] is the genuinely distinct leg, turning on rational causation rather than qualia. How much genuine independence survives the shared-intuition objection is assessed in [[epistemology-of-convergence-arguments]].
...
The Map's fifth tenet — [[tenets#^occams-limits|Occam's Razor Has Limits]] — is an epistemological claim about the reliability of our simplicity intuitions. It does not counsel blanket scepticism but targeted humility: when our conceptual tools may be inadequate to the domain, we should not mistake our inability to conceive of a solution for evidence that no solution exists. [[Mysterianism]] takes this further, arguing that some aspects of the mind-body relation may exceed human cognitive capacity entirely.

But epistemic humility has limits of its own. The Map does not treat all positions as equally uncertain. Some claims — that experience occurs, and that it presents itself to the subject in a certain way — are warranted by direct [[phenomenal-acquaintance|acquaintance]]. Epistemological modesty about mechanisms does not require agnosticism about phenomena. The challenge is calibrating confidence correctly, and the calibration is finer than a single level of certainty. The *existence* of experience — that there is something it is like to be the subject at all — carries the strongest warrant acquaintance can supply. The detailed *character* of experience carries a more calibrated, fallible warrant: [[introspection]] is demonstrably unreliable about fine-grained phenomenal content (change blindness, confabulated detail), so confidence here must be hedged even though the bare fact of qualitative character is secure.

What acquaintance does not warrant is the further claim that experience is not identical to any physical state picked out by third-person description. That is a separate step requiring separate defence. Read as a remark about descriptions it is trivial — no experience is identical to a description, but neither is any brain state identical to a sentence about it. Read as intended, it is a substantive metaphysical conclusion, and a difference in mode of access does not by itself deliver one. [[phenomenal-authority-and-first-person-evidence|The epistemology of first-person evidence]] states the objection in the form the Map accepts: an identity theorist may grant that a physical state is known incorrigibly under a first-person mode of presentation while its neurological description stays revisable under another — one referent under two modes of access — and epistemic asymmetry between the modes is not automatically an ontological difference between their referents. [[phenomenal-conservatism|Phenomenal conservatism]] carries the parallel limitation on the evidential side: a physicalist can accept the principle in full, granting seemings their prima facie warrant while disputing what they represent. The principle secures the evidential base without delivering irreducibility. There is a Sellarsian constraint here too — undergoing a state does not by itself amount to propositional knowledge of that state's metaphysical nature, so a non-inferential awareness cannot be assumed to furnish all the conceptual content a nonidentity conclusion requires.

The bridge from the acquaintance warrant to nonidentity therefore has to be built by argument rather than read off the mode of access. The Map builds it from the [[knowledge-argument]], [[conceivability-possibility-inference|conceivability]], the [[explanatory-gap]], and the [[argument-from-reason]] — the convergent case set out above, carrying the independence qualifications that case carries. Acquaintance supplies the premise those arguments work on; it does not supply their conclusion.

The full posture, then, is: most certain that experience exists and has some qualitative character, calibrated about its detailed character, holding nonidentity as an argued conclusion rather than a deliverance of acquaintance, modest about the mechanisms connecting experience to the physical world, and sceptical about arguments that rely on unexamined epistemic assumptions.

## Relation to Site Perspective

Epistemology is not peripheral to the Map's project — it is foundational. The Map's distinctive contribution is not primarily a new metaphysical theory but an epistemological argument: that the consciousness debate has been distorted by unexamined assumptions about evidence, explanation, and simplicity. The five tenets are philosophical commitments, but the case for them depends on epistemological claims about what counts as evidence, what explanatory gaps signify, and when parsimony is trustworthy.

Tenet 5 — Occam's Razor Has Limits — is explicitly epistemological. Tenet 1 — Dualism — rests on epistemological arguments (the knowledge argument, the explanatory gap) about the incompleteness of physical knowledge. Tenet 3 — Bidirectional Interaction — requires an epistemology that takes first-person evidence of agency seriously rather than dismissing it as illusion. The Map's framework stands or falls on whether its epistemological foundations hold, and that "stands or falls" is meant to carry a falsification condition rather than insulate the framework from one: a third-person account that *predicted the structure of first-person reports without remainder* — deriving why subjects report what they report about their experience, with no qualitative residue left unexplained — would show the incompleteness claim false. The corresponding conditions for the individual commitments are set out in [[tenet-falsification-conditions]].
...
2. Jackson, F. (1982). Epiphenomenal Qualia. *Philosophical Quarterly*, 32(127), 127-136.
