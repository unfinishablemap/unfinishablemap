...
description: "Fundamental principles specifying how conscious states influence which physical outcomes become actual. The downward direction of psychophysical laws."
created: 2026-02-02
modified: 2026-02-02
human_modified:
...
**[[tenets#^dualism|Dualism]]** requires that mental and physical are distinct variables—otherwise there's nothing for a selection law to relate. The selection law specifies the lawful connection between distinct domains.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]** most directly requires selection laws. Supervenience laws alone don't suffice—consciousness must causally influence outcomes, and selection laws specify how.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]** constrains which selection laws are admissible. Consciousness biases quantum outcomes without violating conservation. The ~10 bits/second bandwidth further constrains the channel.
...
- [[epistemology-of-mechanism-at-the-consciousness-matter-interface]] — Epistemic methods for investigating the interface when mechanism cannot be directly observed
