...
Drawing from the project's framework, neurophenomenology, and well-being research, eight dimensions of experience emerge as candidates for alignment targets:
...
Experiential alignment follows directly from the project's foundational commitments.
...
**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: If consciousness causally influences the physical world, agency is not just phenomenal appearance but real efficacy. Alignment should preserve genuine agency, not agency illusions. This is why the agency dimension cannot be collapsed into preference satisfaction—genuine causal efficacy matters independent of felt satisfaction.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: The preferentist approach is simpler—learn from choices, maximize satisfaction. But this simplicity masks genuine complexity. Experiential quality is multidimensional, partially opaque, and resistant to single-metric optimization. Parsimony should not override what the phenomenon demands.
