...
If consciousness can't emerge from the non-conscious, panpsychists conclude it must be present all the way down. The fundamental constituents of reality—quarks, electrons, whatever physics finds at bottom—have both physical properties (mass, charge, spin) and experiential properties.

This is elegant: it solves the hard problem by denying consciousness emerges at all—it was always there—respects physics by not contradicting anything about matter's behavior, and is parsimonious in a sense: one kind of stuff rather than physicalism's unexplained emergence.

Panpsychism also bears on the [[prebiotic-collapse|prebiotic collapse problem]]: if consciousness participates in quantum measurement, what collapsed wavefunctions before any biological minds existed? Panpsychism alone carries no collapse dynamics, so it answers this only when joined to a consciousness-collapse thesis; on that combined view proto-conscious properties present from the universe's beginning could do the collapsing. The [[evolution-of-consciousness|evolutionary emergence of complex minds]] then didn't create consciousness from nothing; it organised pre-existing experiential properties into subjects.

### Whitehead and the Process Tradition

Before contemporary panpsychism, Alfred North Whitehead's [[process-philosophy]] treated experience as fundamental. In *Process and Reality* (1929) he proposed that reality consists of "actual occasions"—momentary experiential events that perish and give rise to successors—and that even the simplest physical process involves "prehension," a primitive form of experience by which occasions take account of their predecessors.

Whitehead's influence runs through contemporary panpsychism: his rejection of "vacuous actuality" anticipates Strawson's argument that non-experiential matter is incoherent, his "actual occasions" prefigure micro-experiences, and the combination problem is implicit in his account of how occasions "synthesize" into complex organisms.

The process tradition suggests panpsychism needn't treat micro-experiences as static properties; they might be dynamic events. This reframes the combination problem: not "how do things combine?" but "how do experiential *processes* flow into unified streams?" Phenomenal unity becomes an achievement—something each occasion accomplishes through creative synthesis—a distinctive response differing from both panpsychism's aggregation model and dualism's separate-substance model. The Map develops this event-based reading in its [[process-and-consciousness]] synthesis.

### Russellian Panpsychism and Its Variants

[[russellian-monism|Russellian panpsychism]] provides the most developed framework for contemporary panpsychism. Russell and Eddington observed that physics describes only the *relational* properties of matter—what things do—leaving intrinsic nature unspecified. This is the [[intrinsic-nature-void]]: physics tells us what mass and charge *do* but not what they *are*. The hidden intrinsic properties are called *quiddities*.
...
But panpsychism faces its own challenge: if electrons have micro-experiences, how do they combine into unified human consciousness? This is the [[combination-problem|combination problem]]. William James pressed it as the central obstacle to the mind-dust theory in 1890: each conscious state seems "shut in its own skin"—my experience can't merge with yours to form a third. Why should electron-experiences combine into brain-experiences?

The combination problem has several variants:

**Subject-summing**: How do many micro-subjects become one macro-subject? My consciousness isn't billions of tiny consciousnesses contributing their bits; it's unified—a specific instance of [[composition-and-consciousness|phenomenal non-compositionality]], since consciousness cannot be assembled from parts, physical or experiential.
...
**The evolutionary distribution question**: If all matter has experiential properties, why does consciousness track neural complexity and behavioural flexibility? The panpsychist answer: what we recognise as "consciousness" is organised, integrated experience. Evolution didn't create experience—it created the integrating structures that amplify and unify pre-existing experiential properties into the [[unity-of-consciousness|phenomenal unity]] we associate with minds (see [[evolution-of-consciousness#The Emergence Question|the emergence question]]).

**Empirical boundary cases**: Research on [[minimal-consciousness|minimal consciousness]] in simple organisms tests panpsychist continuity (see [[consciousness-in-simple-organisms]]):
...
- **Hydra** (900-neuron decentralised nerve net): Multiple non-overlapping networks control separate behaviors without central processing—suggesting, for panpsychism, experience as distributed as the nervous system (micro-experiences without phenomenal unity), or that combination requires a centralisation Hydra lacks.
...
The 2024 New York Declaration on Animal Consciousness affirms "at least a realistic possibility" of conscious experience in many invertebrates—cephalopod mollusks, decapod crustaceans, and insects—but not in the minimal organisms above (nematodes, Hydra, slime molds), so it is weaker evidence for panpsychist continuity than for bees or octopuses. The verdict is consistent with panpsychism, but equally compatible with emergentist and functionalist frameworks that set a low threshold, and it concerns a far higher rung than the micro-experience panpsychism attributes to electrons. Panpsychists need not specify a threshold: there is only a gradient of experiential integration.

Panpsychists have responses. Strawson argues experiential-from-experiential emergence is less mysterious than experiential-from-non-experiential emergence. Cosmopsychists (the later Goff) invert the problem: perhaps the universe is the one fundamental conscious subject and individual minds are *grounded in* it—derived by decomposition or subsumption rather than summed up from micro-subjects (see [[cosmopsychism]]).
...
Constitutive micropsychism—micro-subjects summing into a macro-subject—is only one panpsychist family, and the combination problem bites it hardest. Cosmopsychism starts instead from a conscious whole; continuism, non-combinatory and monadic views deny that macro-experience is built from micro-subjects at all; panprotopsychism and emergent panpsychism weaken the base commitment in different directions. The classic problem therefore indicts constitutive micropsychism, not panpsychism as such (see [[panpsychisms-combination-problem]] for the subtype-by-subtype treatment). Two current objections press the live programme rather than its easiest historical form. Keith Frankish argues that panpsychism "depsychologizes" consciousness and consigns it to a scientific and ethical limbo, with illusionism the more honest response to the same starting point (Frankish 2021). Umut Baysan challenges the widely claimed advantage that Russellian panpsychism uniquely secures mental causation, arguing the supposed explanation either misses the phenomenon at issue or is matched by rival views with fewer costs (Baysan 2024).

## The Map's Alternative: Interactionist Dualism

The Map agrees with panpsychism's diagnosis (emergence from non-conscious matter is unintelligible) but treats it differently: rather than consciousness being what matter is "from the inside," it is *distinct from* matter yet *interacts with* it.

The [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet holds that consciousness causally influences physical outcomes; the [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet proposes this happens at the quantum level, biasing otherwise indeterminate outcomes.

This trades *constitutive* combination for the interaction problem. Matter has no micro-experiences to combine—though the Map still owes an interface-unity account: why one subject's coupling to billions of distributed quantum loci yields a single field rather than many. That residue sits near bedrock, symmetric to panpsychism's phenomenal-bonding primitive, but it is the interaction problem in new form, not constitutive combination in disguise, since there are no micro-subjects to sum (see [[combination-problem#The Unity of the Interface|the unity of the interface]]). The [[universal-coupling-response]] specifies which physical systems consciousness couples with: all those meeting adequate architectural conditions, without arbitrary thresholds or unexplained selectivity. The Map's [[bi-aspectual-ontology]] develops this: reality has two irreducible aspects (structure and actuality) interacting at quantum indeterminacies rather than being identical.
...
For the Map's framework, IIT is instructive but incomplete. It takes consciousness seriously as fundamental (aligning with Dualism) but identifies it with physical structure rather than treating it as causally efficacious over and above physics (conflicting with Bidirectional Interaction): if consciousness *is* integrated information, it doesn't *do* anything separate from the physical. For the Map's full critique, see [[consciousness-and-integrated-information|Consciousness and Integrated Information]].

## Can Panpsychism Be Tested?

Panpsychism is difficult to test directly, though not uniquely so—every fundamental position on consciousness faces the challenge that experience is accessible only from the first person. Several approaches still offer partial testability.

**Weak falsifiability**: Panpsychism would be refuted if consciousness demonstrably emerged from wholly non-conscious matter—but that is precisely what panpsychists deny is possible; the hard problem is the argument against it.

**Stronger testability via IIT**: IIT generates specific predictions. If we could precisely measure Φ in various systems, we could test its panpsychist implications—systems with zero Φ should have no experience. Current measurement limits make this hard, but in principle the theory is empirical.

**Behavioral markers**: The UAL (Unlimited Associative Learning) framework offers behavioral tests for consciousness attribution. If panpsychism predicts consciousness wherever there's integration, but UAL markers appear only in certain organisms, we face a tension. The evidence here is weaker than sometimes stated: some simplified *models* of the C. elegans network have been assigned positive integrated-information-related measures—an autoregressive proxy Φ_AR, not the canonical IIT 4.0 Φ, which has never been computed for the worm (Antonopoulos, Fokas & Bountis 2015)—yet the animal fails UAL criteria. This does not establish that C. elegans is conscious under IIT. Either panpsychism is wrong about C. elegans, or UAL is wrong about consciousness markers—or consciousness admits of degrees with UAL detecting only "higher" forms.

**The cognitive closure challenge**: [[mysterianism|Mysterians]] argue we may lack the equipment to resolve these questions. If the combination problem is permanently beyond human understanding (as McGinn suggests about the mind-body problem generally), panpsychism's truth or falsity might be beyond our reach—not meaningless, just potentially unanswerable by minds like ours.
