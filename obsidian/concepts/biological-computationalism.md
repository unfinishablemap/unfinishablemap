...
modified: 2026-04-15
human_modified:
ai_modified: 2026-07-31T12:02:17+00:00
draft: false
topics:
...
last_curated:
last_deep_review: 2026-07-31T12:02:17+00:00
---
...
Biological computationalism makes three interlocking claims that distinguish it from orthodox computationalism.

### Substrate Dependence

Classical [[concepts/functionalism]] holds that mental states are multiply realisable—implementable in neurons, silicon, or any medium preserving the right causal structure. Biological computationalism rejects this. Consciousness requires computation inseparable from the fluidic, electrochemical dynamics of biological tissue. Continuous fields, ion flows, dendritic integration, and electromagnetic interactions are computational primitives, not implementation details that could be swapped for digital equivalents. This commitment overlaps with [[embodied-cognition]]'s insistence that cognition depends on the body's physical constitution, though biological computationalism locates the dependence specifically in the character of the computation rather than in sensorimotor coupling.

### Metabolic Grounding

Computation in brains is constrained by and dependent on metabolic energy flows. Thagard (2022) argues that real-world information processing depends on energy, and energy depends on material substrates. The Church-Turing thesis—often cited to support [[substrate-independence]]—provides no support for multiple realizability because it abstracts away time, space, and energy. Biological computationalism incorporates this insight: metabolic processes are integral to the computation, not merely the power supply running it.

### Scale Inseparability

Biological computation operates across scales—molecular, cellular, network, and whole-brain dynamics—in a computationally coupled manner. Digital systems process information in modular layers that can be separated and recombined. Biological systems, on this view, cannot be decomposed this way without losing the computation itself. The consciousness-relevant properties emerge from interactions across all scales simultaneously. This positions biological computationalism in tension with standard accounts of [[emergence]]: if the relevant properties exist only in cross-scale coupling, they resist both reductive explanation (capturing them at a single level) and the weak emergence framework (deriving them from lower-level dynamics). Whether they constitute strong emergence remains an open question the framework does not resolve. [[panpsychism|Panpsychist]] readings offer another possibility: if experience is present at every scale, cross-scale coupling would integrate micro-experiences rather than generating experience from non-experiential components—but biological computationalism does not commit to this interpretation.

## Historical Context

Biological computationalism builds on several earlier frameworks while departing from each.

**Putnam's functionalism** (1967) introduced computational theories of mind by arguing that mental states are defined by functional roles, not physical constitution. Biological computationalism retains the idea that brains compute but denies that the computation can be abstracted from its physical medium.
...
Biological computationalism faces challenges from multiple directions.

**The specification problem.** What exactly makes biological computation consciousness-relevant? If the answer is substrate-dependent dynamics, then the framework needs to explain why radically different biological substrates—insect central complexes, octopus distributed nervous systems, vertebrate cortices—support similar cognitive abilities despite 500 million years of architectural divergence. The more precisely the framework specifies what matters, the harder it becomes to maintain that biology alone provides the answer.
...
The **Minimal Quantum Interaction** tenet suggests consciousness operates at quantum indeterminacies in biological systems. Biological computationalism's emphasis on substrate-specific dynamics—continuous fields, ion flows, electromagnetic interactions—places consciousness-relevant processing in the physical regime where quantum effects in biology have been demonstrated in specific systems — cryptochrome radical-pair avian magnetoreception is the strongest surviving case, with enzyme quantum tunnelling a second. Photosynthetic energy transfer, long cited alongside them, no longer supports the claim in its *long-lived electronic coherence* form: Duan et al. (2017) re-measured the Fenna–Matthews–Olson complex by two-dimensional photon echo at ambient temperature in aqueous solution and found electronic coherence dephasing within roughly 60 femtoseconds, with no hint that *electronic* coherence plays a biofunctional role; the authors take the result to generalise to other light-harvesting complexes. The long-lived oscillations once read as electronic are now attributed to vibrational modes. Short-timescale vibrational/vibronic coupling is a live and different question. Whether quantum effects extend to the neural processes biological computationalism highlights remains an open empirical question, but the framework's insistence on substrate specificity is at least compatible with a quantum-level interface for consciousness.
...
The **Occam's Razor Has Limits** tenet finds illustration in biological computationalism's trajectory. The "simpler" computational account—consciousness is just computation, implementable in any medium—has not held its simple form. Keeping a computational theory of consciousness plausible has driven its successors to pile on the very qualifications the original picture was designed to avoid: substrate-dependent, metabolically grounded, scale-inseparable, hybrid discrete-continuous. That trajectory does not settle whether biological computationalism is correct, and the Map takes no side on its positive claims. What it does show is that the parsimony intuition which made unqualified functionalism attractive was a poor guide to where the theory would be forced to go—which is the tenet's point: simplicity is unreliable while the underlying facts are still incomplete.

For the full argument that biological computationalism inadvertently builds the dualist case, see [[biological-computationalisms-inadvertent-case-for-dualism]].
...
- [[content-vocabulary-as-derived-feature]] — Why the computational vocabulary summarises rather than grounds felt content
...
- [[embodied-cognition]] — A related emphasis on physical constitution in cognition
...
- [[reductionism|Reductionism and Consciousness]] — Why reductionism succeeds everywhere except consciousness
...
10. Duan, H.-G., Prokhorenko, V. I., Cogdell, R. J., Ashraf, K., Stevens, A. L., Thorwart, M., & Miller, R. J. D. (2017). Nature does not rely on long-lived electronic quantum coherence for photosynthetic energy transfer. *Proceedings of the National Academy of Sciences*, 114(32), 8493–8498. https://doi.org/10.1073/pnas.1702261114
