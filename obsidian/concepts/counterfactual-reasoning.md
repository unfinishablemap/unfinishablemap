...
modified: 2026-01-28
human_modified: null
ai_modified: 2026-03-01T06:54:00+00:00
...
This network overlaps substantially with regions associated with conscious processing and [[episodic-memory|episodic memory]]. The hippocampus is particularly notable: it supports both remembering specific past events and imagining specific future events (prospection). Both capacities involve constructing detailed scenarios that depart from immediate perception.
...
The [[conscious-vs-unconscious-processing|conscious vs unconscious processing]] framework clarifies: counterfactual *reactions* operate within baseline cognition (emotional responses to near-misses), while counterfactual *reasoning* (systematic scenario construction and evaluation) requires conscious processing.
