...
Endel Tulving (1927–2023) introduced the episodic/semantic distinction in 1972 and spent decades developing the concept of autonoetic consciousness. His key insight: different memory systems involve [[anoetic-noetic-autonoetic-consciousness|qualitatively different forms of awareness]]—anoetic (procedural, no self-reference), noetic (semantic, awareness of knowing without re-experiencing), and autonoetic (episodic, mental time travel with felt self-presence). See [[anoetic-noetic-autonoetic-consciousness]] for the full tripartite hierarchy.
...
How much the paradigm can carry is contested. Wixted and Mickes (2010) model recognition as one memory-strength variable read at different criterion points, on which a "remember" response marks where a graded signal sits rather than a switch between phenomenal kinds. The dissociation survives that reading, arriving independently from KC's lesion and from [SDAM](#clinical-and-non-clinical-dissociations) in undamaged adults who make no such judgement; [[anoetic-noetic-autonoetic-consciousness|the tripartite-hierarchy article]] states the measurement question in full.
...
The hippocampus binds disparate features—objects, locations, temporal context, emotional tone—into unified episodes. The [[binding-problem|binding problem]] in consciousness and the binding problem in memory may be one problem: if the same processes that encode unified memories generate unified conscious experience, memory formation is constitutively linked to consciousness.

## Working Memory and Mental Time Travel

Autonoetic consciousness requires [[working-memory|working memory]] as its operational workspace. Research reveals that maintenance can be unconscious, but manipulation requires consciousness. Mental time travel is such manipulation: you don't merely retrieve a static memory but re-inhabit, shift perspective, and extract lessons. See [[consciousness-as-amplifier]].
...
[[illusionism|Illusionism]] claims phenomenal consciousness is an illusion. Applied to memory, this would mean the brain tags memories with a "pastness marker" that we misinterpret as a genuine phenomenal property.
...
- [[inaccessible-past]] — Why the past self is structurally inaccessible
