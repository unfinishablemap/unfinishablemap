...
description: "Human+AI study of Śāntideva's Bodhicaryāvatāra 8.101-102: how ownerless suffering grounds impartial benevolence, and why granting a momentary locus blocks it."
created: 2026-09-07
modified: 2026-09-08
human_modified:
...
The second translation is the more useful here because it renders the denial in the Map's own vocabulary with no gloss required: "The one *for whom* there is suffering does not exist" denies exactly the mattering-recipient that the second premise of the [[consciousness-value-connection|value chain]] asks for.
...
Grant the momentary locus and 101's two clauses come apart. "The person who experiences suffering does not exist" stays true on the Map's reading, since the Map asserts no *ātman* and its Dualism tenet requires irreducibility rather than permanence ([[buddhism-and-dualism]]). But "no sufferings belong to anyone" becomes false, because a momentary locus is a someone at the moment of the suffering, and the suffering is its. The prudential asymmetry of 8.97 and 8.99 is not thereby restored: a momentary locus has no future toward which to be partial, so the foot-and-hand analogy still bites against *diachronic* self-concern. What the Map's reply removes is the tradition's stated bridge from ownerlessness to impartiality, which would then need a different argument — the similarity argument of 8.94–96, or an appeal to what all loci have in common, the route the Map's own [[sentientism]] takes.

That is why the sibling article's "close to terminological" verdict needs scoping rather than reversing. At the momentary grain, "this feeling-moment is bad" and "this feeling-moment is bad for its locus" may well be one fact under two descriptions — on the pattern [[positions/value-in-selection|P-VS3]] sets for felt badness and badness, which is the identity that entry actually asserts. The two are interchangeable for the *valuation* — neither makes the moment worse — but not for the *ontology*, since the second entails a bearer and the first does not, and Śāntideva's premise quantifies over bearers rather than over badness. That is how a distinction idle within a metaphysics can be decisive within an argument ranging over what the metaphysics posits.
...
What would move this article: Goodman 2009 chapters 6, 8 and 11, if they already distinguish ownerlessness from unrankedness; Williams 1998 or 2000, which would replace a reported objection with a formulation; Siderits's *Moonpaths* chapter, the best available answer to the Parity Reply; or a reading of 101 on which "the one for whom there is suffering does not exist" denies the momentary locus and not merely the person — the reading Chadha's eliminativism and Metzinger's [[self-model-theory-of-subjectivity|self-model theory]] make live, and which [[no-self-objection-to-phenomenal-value#rivals|the sibling]] treats as the objection's strongest form.

## Relation to Site Perspective

**[[tenets#^occams-limits|Occam's Razor Has Limits]]** governs this article in both directions, which is unusual. Against the Map: the ownerless reading is the more parsimonious one — drop bearers, keep suffering — and the Map declines to let that count in its own favour, as the tenet requires where knowledge is incomplete. For the Map: the Parity Reply's second half shows what parsimony pressed consistently costs the reductionist, since a deflation reaching persons reaches the suffering too. Neither side may stop deflating where it suits them.

**[[tenets#^dualism|Dualism]]** supplies the momentary locus the finding turns on, along with its price. The locus is the subject-side of experience rather than a self-model or a substance, which is what lets it survive the analysis of the person; what the tenet cannot supply is an account of how a moment comes to be someone's, and the [[mine-ness#the-ownership-void|ownership void]] records that the mechanism is not introspectable. The Map therefore asserts a bearer where Śāntideva's argument needs none, on a commitment rather than a finding — which is why the finding above corrects a verdict and does not defeat the argument.

**[[tenets#^no-many-worlds|No Many Worlds]]** is deliberately not drawn on. The persisting subject that tenet needs would settle the diachronic half of this dispute at once, and the [[no-self-objection-to-phenomenal-value#maps-reply|sibling article]] keeps the value chain insulated from it so that an account of why suffering is bad does not fall with an account of why this branch is actual. The same isolation holds here.

## Further Reading

- [[no-self-objection-to-phenomenal-value]] — the abstract objection, and the reply this article scopes
- [[consciousness-value-connection]] — the value chain whose second premise this argument denies
- [[buddhism-and-dualism]] — the metaphysical half of the Map's Buddhist engagement
- [[ethics-under-dualism]] — the Map's normative commitments
- [[parfit-reductionism]] — the secular parallel Goodman and Siderits both invoke
- [[eastern-philosophy-consciousness]] — Chadha's eliminativism in wider Indian context
- [[evaluative-phenomenal-character]] — why a pain's badness is in the pain
