...
modified: 2026-06-17
human_modified: null
ai_modified: 2026-06-17T22:09:24+00:00
draft: false
topics:
...
last_curated: null
last_deep_review: 2026-06-17T22:09:24+00:00
coalesced_from:
...
But phenomenal consciousness resists functionalisation. The functional role of pain—detecting damage, motivating avoidance—can be specified completely without mentioning *how pain feels*. A system could perform all pain-functions without hurting. [[pain-consciousness-and-causal-power|Pain asymbolia]] points to this empirically: patients with the condition detect tissue damage and describe pain's location and intensity, yet report no suffering, and they fail to guard injured limbs or seek treatment with normal urgency. The dissociation reveals that [[pain-consciousness-and-causal-power|phenomenal awfulness is a distinct contributor to motivation]], not reducible to the information-processing role. The functional role is filled; the phenomenal character is absent.
...
Now apply the test to consciousness: does learning that neural correlate N accompanies experience E make the experience *intelligible*? Does knowing every detail of visual cortex activity explain *why* red looks the way it does? The answer is no—and not for lack of data. The [[minimal-consciousness|complete connectome of C. elegans]]—every neuron, every synapse, every gap junction mapped—still cannot tell us whether the 302-neuron worm experiences anything. Complete physical knowledge fails the transparency test.
...
If consciousness has causal powers but physics is closed, either consciousness reduces to physics or consciousness is [[epiphenomenalism|epiphenomenal]]—causally inert.
...
12. Milinkovic, M. & Aru, J. (2026). Biological computationalism and the substrate-dependence of consciousness. (See [[biological-computationalism]] for discussion.)
