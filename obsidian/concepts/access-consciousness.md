...
- Information in [[working-memory|working memory]] available for executive processes
...
**For consciousness science**: [[Global-workspace-theory|Global Workspace Theory]] explains when information becomes A-conscious (global broadcast) but says nothing about why this broadcast feels like anything. Dehaene and Changeux's Global Neuronal Workspace (GNW) identifies neural mechanisms for access—prefrontal-parietal ignition—without addressing P-consciousness. The theory succeeds at what it attempts (access) while leaving the [[hard-problem-of-consciousness|hard problem]] untouched.

**For dualism**: Acknowledging A-consciousness *strengthens* rather than weakens the dualist position. Physicalism can plausibly explain access-mechanisms through neural architecture and information integration. What remains inexplicable is why globally broadcast information feels like anything. The [[explanatory-gap|explanatory gap]] persists even after we understand access.

**For AI consciousness**: Systems might be A-conscious (information poised for reasoning, report, action control) without being P-conscious (having phenomenal experience). The [[substrate-independence-critique|substrate critique]] applies: if consciousness involves irreducible phenomenal properties, functional similarity (matching access architecture) doesn't guarantee phenomenology. See [[ai-consciousness]].
...
Block's [[phenomenal-overflow|overflow argument]] holds that phenomenal consciousness has richer content than access consciousness—we experience more than we can report or think about. Evidence from iconic memory experiments suggests subjects phenomenally experience more letters than they can subsequently report, implying P-consciousness exceeds A-consciousness in capacity.

If overflow is real, it has significant implications: phenomenal richness exceeds what [[global-workspace-theory|Global Workspace]] mechanisms make accessible, and P-consciousness cannot reduce to A-consciousness if P has higher capacity than A.
...
This debate connects to [[cognitive-phenomenology]]—whether thinking itself has experiential character. If pure thoughts are A-conscious without P-consciousness, the dissociation holds in this direction too.

## Access Consciousness and Functionalism {#functionalism}

[[Functionalism]] defines mental states by their causal-functional roles: what causes them, what they cause, how they relate to other mental states. Access consciousness fits naturally into functionalist frameworks—it's defined by its functional role (availability for reasoning, report, action).
...
[[Attention]] is intimately connected to access consciousness, though the exact relationship is debated.
...
- [[Voluntary-attention|Voluntary attention]] enables deliberate control over what becomes accessible
...
If [[tenets#^bidirectional|consciousness causally influences the brain]], it must work through some mechanism. Access consciousness is plausibly part of that mechanism.
...
Access mechanisms are the "downstream" neural processes that amplify initial quantum-level interventions. Consciousness doesn't need to control the entire global workspace—only the quantum indeterminacies that determine what gets selected for broadcast. [[Stapp-quantum-mind|Stapp's quantum Zeno mechanism]] proposes that attention operates at quantum collapse events in neural firing. Once a pattern is selected, classical neural dynamics handle the global broadcast (A-consciousness).

This preserves minimalism: consciousness intervenes at quantum indeterminacies, and the access-machinery amplifies that selection into macro-scale functional availability. The energy-conservation objection dissolves because no energy is injected—consciousness selects among possibilities that physics leaves undetermined. This proposal remains speculative, though it provides a coherent framework for how minimal interaction could have macro-scale effects. See [[causal-closure#stapps-quantum-response]] and [[conservation-laws-and-mind]].
...
1. **[[Global-workspace-theory|Global Workspace Theory]]**: Consciousness is global broadcast enabling access
2. **[[Integrated-information-theory|Integrated Information Theory]]**: Consciousness is integrated information (Φ)

GWT successfully explains A-consciousness but leaves P-consciousness unexplained. IIT attempts to address P-consciousness but faces its own difficulties (panpsychism implications, implausible predictions about cerebellum). The 2025 [[global-workspace-theory#the-cogitate-experiment|COGITATE adversarial collaboration]] found that neither theory fully captured the phenomena—both made incorrect predictions.

The situation illustrates [[tenets#^occams-limits|the limits of Occam's Razor]]. Physicalist theories are simpler (one substance) but struggle with consciousness. Dualism is more complex (two substances) but handles both access (functional) and phenomenology (irreducible). When simpler theories persistently fail to explain the target phenomenon, simplicity stops being a reliable guide. The A-consciousness / P-consciousness distinction shows *what* physicalism can explain (access) and *what* it cannot (phenomenology), clarifying why dualism remains necessary despite being ontologically more complex.

## Illusionist Challenge

[[Illusionism]] argues that phenomenal consciousness is an illusion—we're mistaken in thinking there's "something it's like" beyond functional access. On this view, A-consciousness is all there is; the appearance of P-consciousness as something additional is a cognitive error.
...
See [[qualia]] for the positive case that phenomenal properties are real, and [[philosophical-zombies]] for why conceivability arguments support this.
