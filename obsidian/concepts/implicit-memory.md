...
description: "Knowledge expressed in action without conscious recollection. Choking under pressure reveals how phenomenal attention—not just neural competition—disrupts procedural execution."
created: 2026-01-17
modified: 2026-01-17
human_modified: null
...
**Autonoetic consciousness** ("self-knowing") accompanies [[episodic-memory|episodic memory]]. You don't merely know facts about your past; you mentally travel back and re-experience events, phenomenally present as both current rememberer and past protagonist.
...
Body memory reveals *where* the interface operates, not that consciousness is identical to the body. The expert's embodied skill represents successful [[skill-delegation|delegation]]: consciousness has calibrated the procedural system and now need not intervene. But the retention of override capacity—shown precisely by choking when attention re-engages—reveals the interface remains operative.
