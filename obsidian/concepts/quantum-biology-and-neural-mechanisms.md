...
The Beck-Eccles model proposes quantum tunneling triggers neurotransmitter vesicle release. Georgiev (2018) upgraded the model: Davydov solitons twist SNARE protein α-helices, triggering vesicle release via quantum tunneling. Consciousness could bias tunneling probabilities, influencing which synapses fire—directly supporting [[interactionist-dualism|Bidirectional Interaction]].
...
The [[binding-problem|binding problem]] asks how distributed brain processes combine into unified consciousness. Redness in one region, shape in another, semantic knowledge in a third—yet experience is of one unified object.
