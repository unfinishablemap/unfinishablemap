...
the project's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet specifies how consciousness exercises downward causation: by biasing quantum outcomes where physics leaves the result undetermined.
...
the project's [[tenets#^no-many-worlds|No Many Worlds]] tenet isn't incidental to the framework—it's required for downward causation to be possible. If MWI were confirmed (though how this could occur is unclear), the quantum mechanism for downward causation would fail.
...
**Strong Emergence**: the project's position is strong [[emergence|emergentism]] with a mechanism. Consciousness emerges from neural organisation but possesses genuinely novel causal powers. The quantum framework specifies how those powers operate without violating physical law.
...
- [[interactionist-dualism]] — the project's framework defending downward causation
...
- [[many-worlds]] — Why the project rejects MWI (and why it matters for downward causation)
