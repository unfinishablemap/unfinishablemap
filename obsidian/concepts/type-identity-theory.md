...
description: "Type-identity theory holds that mental state-types are brain state-types—pain is C-fibre firing. The Map's human-AI collaboration presents its strongest case, then argues Tenet 1 against it: the identity is asserted, not explained."
created: 2026-07-12
modified: 2026-07-12
human_modified:
ai_modified: 2026-07-12T13:56:00+00:00
draft: false
topics: []
concepts:
  - "[[functionalism]]"
...
The distinction matters because the objections that broke type-identity leave token-identity largely standing. Token-identity is compatible with [[functionalism]] and with non-reductive physicalism; it is a weaker, more defensible physicalism. When this article speaks of "the identity theory" in the reductive sense the Map targets, it means the strong type-type claim—the one that says the mental kind and the neural kind are the very same kind.
...
- [[illusionism]] — the radical defence that denies the phenomenal residue the identity theory struggles with
- [[phenomenal-concepts-strategy]] — the moderate materialist reply that concedes the epistemic gap while denying an ontological one
- [[explanatory-gap]] — the residue every reductive identity leaves untouched
- [[knowledge-argument]] — Mary's Room, the sharpest version of the anti-reductive pressure
- [[dualism]] — the Map's tenet-level denial of the type-type identity
- [[reductionism]] — the general reductive strategy of which type-identity is the classic mind-body case
