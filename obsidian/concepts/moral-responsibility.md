...
last_curated: null
last_deep_review: 2026-07-30T13:33:37+00:00
---
...
2. **Phenomenology tracks causation**: The felt difficulty of choosing well corresponds to genuine causal engagement with alternatives — the [[volitional-control|empirical and phenomenological case for volitional control]] (clinical dissociations, the "whether"-decision circuitry, intentional binding) is the empirical ground on which agent-causal control, and so desert, stands
...
**[[mental-effort|Phenomenology of effort]]**: The felt difficulty of doing right corresponds to genuine exercise of causal power against countervailing forces. If choices were merely determined, effort phenomenology would be epiphenomenal decoration.
...
**[[tenets#^no-many-worlds|No Many Worlds]]**: The objection here is about desert. The tenet does personhood-and-responsibility work, not merely quantum-interpretation work: the Map holds that praise and blame presuppose alternatives genuinely rejected, not merely routed to other branches. An Everettian can grant the agent a branch-local history of having chosen—even [[haecceity|indexically]] owned memories of it—while every rejected option is actualised by a counterpart elsewhere. The judgment that this dissolves desert rests not on desert-relevant facts alone but on a global-exclusion condition, a [[tenets/background-commitments|posit the Map adopts]], asserted rather than derived from the desert case. The objection is not that Many-Worlds fails the phenomenology, which it does not.
...
[[illusionism|Illusionism]] threatens agent-causal desert: if phenomenal consciousness is illusion, the phenomenological evidence grounding desert collapses. See [[illusionism]] for the full challenge and the Map's response.
...
[[witness-consciousness|Contemplative traditions]] complicate illusionism: experienced meditators report directly observing effort, not inferring it. Dismissing their reports requires explaining why this domain is uniquely unreliable when contemplative [[introspection]] appears reliable about other mental states.
...
**"Agent causation is mysterious."** If we accept irreducible consciousness (as the [[hard-problem-of-consciousness|hard problem]] suggests), agent causation is no additional mystery—it's consciousness doing something rather than nothing.
...
- [[frankfurt-hierarchical-mesh-theory-of-the-will]] — The 1971 paper's positive account: identification with an effective higher-order desire, the person/wanton distinction, and why the mesh brackets sourcehood
