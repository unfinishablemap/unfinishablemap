...
**Conclusion**: Answering the indexical question requires the *global* uniqueness of the subject that [[tenets#^no-many-worlds|Tenet 4]] commits the Map to—a framework-boundary commitment, developed below, not a claim that Everett has nothing to say.
