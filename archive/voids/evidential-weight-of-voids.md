...
description: "Human-AI exploration of whether the pattern of cognitive voids—their clustering around consciousness—constitutes a distinct abductive argument for dualism."
created: 2026-02-24
modified: 2026-02-24
human_modified:
...
The Map's [[tenet-generated-voids|tenets generate characteristic voids]]—and these predicted voids appear in the catalogue.

Dualism predicts a nature void: if consciousness is non-physical, its intrinsic nature should resist physical description. The [[intrinsic-nature-void|intrinsic nature void]] confirms this. Bidirectional interaction predicts a mechanism void: if consciousness causally influences the brain through quantum indeterminacy, the mechanism should be hidden from introspection and difficult to detect empirically. Introspective opacity and the detection gap confirm this. The rejection of many worlds predicts indexical mysteries: why *this* outcome, why *this* observer? The self-reference paradox and the unobservable self confirm this.
...
The Map's commitment to [[tenets#^dualism|dualism]] finds support not only in the traditional arguments—conceivability, knowledge, explanatory gap—but in the meta-pattern those arguments produce when viewed together. The Map's commitment to [[tenets#^occams-limits|the limits of Occam's Razor]] is directly implicated: the simpler ontology (physicalism) systematically fails at a specific interface, and this systematic failure is itself evidence that the territory is more complex than the simple explanation allows.

The argument also connects to the Map's intellectual honesty about its own limitations. The [[tenet-generated-voids|voids that the tenets themselves generate]] show that no framework escapes cognitive limits. The evidential weight argument does not claim that dualism solves the hard problem—it claims that dualism better predicts the *shape* of the failure. The voids remain. What shifts is their interpretation: from embarrassments to evidence.
