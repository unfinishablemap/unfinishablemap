---
title: "The Distraction Void"
description: "Human+AI exploration of the gap between attentional capture and noticing one has been captured—a transit consciousness never witnesses, only reconstructs after the fact."
created: 2026-04-23
modified: 2026-04-23
human_modified:
...
Neural timing, contemplative reports, classical introspection, and existential phenomenology all converge on the same structural feature: distraction is retrospective. The moment at which the object of awareness changes against the subject's pre-existing intent is never itself an object of awareness. One can report *that* one was distracted and *that* one is now attending. The edge between the two is absent from first-person record.

## The Precise Structure of the Gap
