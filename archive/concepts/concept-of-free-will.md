...
The philosophical landscape divides into three families:

**Hard determinism** holds that every event, including every human choice, follows necessarily from prior causes and physical laws. Free will is an illusion — the felt sense of choosing is epiphenomenal decoration on a causal chain stretching back to initial conditions. Sam Harris and some neuroscientists defend this view, often citing [[libet-experiments|Libet's experiments]] showing neural activity preceding conscious awareness of deciding.

**Compatibilism** redefines free will as acting from one's own rational processes without external coercion. On this view, "could have done otherwise" means only that one *would* have chosen differently given different desires — not that the outcome was genuinely open. Fischer's reasons-responsiveness and Frankfurt's mesh theories are sophisticated versions. The Map finds compatibilism insufficient: it redescribes the phenomenology of choice rather than explaining it. If the outcome was always fixed, why does choosing *feel* like determining an open question?

**Libertarian free will** holds that genuine alternatives exist and the agent determines which becomes actual. This is the Map's position, specifically in its *agent-causal* form: the agent as persisting conscious substance directly causes choices, irreducible to any prior event sequence. Chisholm distinguished *transeunt* causation (event causing event) from *immanent* causation (agent causing event). When you decide to raise your hand, *you* cause the raising — the explanatory buck stops at the agent's exercise of causal power.
...
Crucially, the agent selects based on [[reasons-responsiveness|reasons]] — considerations that favour one option over another. This makes selection contrastively explicable: why A rather than B? Because the agent had reasons for A. Reasons don't *determine* the outcome — genuine alternatives remain — but they *guide* it, distinguishing agent-causal selection from arbitrary luck.
...
If consciousness causes choices, how does it interface with the brain? The Map's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet proposes that consciousness operates where physics leaves outcomes undetermined — biasing quantum indeterminacies without injecting energy or violating conservation laws. See [[quantum-indeterminacy-free-will]] for the proposed mechanism.

The brain prepares multiple possible action patterns. Consciousness selects which becomes actual — operating as a [[control-theoretic-will|low-bandwidth control signal]] that gates, stabilises, and steers neural dynamics rather than computing outcomes from scratch. This selection reflects the agent's reasons and values — it is neither determined (physics didn't fix the outcome) nor arbitrary (the agent selected for reasons). The [[causal-closure|causal closure]] of physics fails precisely at quantum indeterminacies, providing room for [[mental-causation-and-downward-causation|mental causation]] without violating any established physical law.
...
The Map does not commit to any single mechanism. Quantum indeterminacy, [[retrocausality|retrocausal]] influence, and unknown physics all remain candidates. What matters philosophically is that consciousness *can* influence physical outcomes — that there is room in physics for mental causation.
...
Free will engages all five [[tenets]]:

**[[tenets#^dualism|Dualism]]**: Genuine authorship requires consciousness to be something beyond physical processes — capable of contributing what deterministic (or randomly indeterministic) physics cannot.

**[[tenets#^bidirectional-interaction|Bidirectional Interaction]]**: Free will *is* bidirectional interaction applied to choice. Consciousness must cause physical outcomes, not merely accompany them.

**[[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]**: The mechanism operates within what physics allows — selecting among possibilities without overriding conservation laws.

**[[tenets#^no-many-worlds|No Many Worlds]]**: Selection requires real collapse. If all possibilities actualize in branching worlds, consciousness selects nothing — it merely finds itself in one branch. The phenomenology of choice involves *determining* an outcome, not *discovering* which branch one inhabits.

**[[tenets#^occams-limits|Occam's Razor Has Limits]]**: Determinism seems simpler but fails to explain the phenomenology of effort, the neural distinctiveness of willed action, and the self-stultification of epiphenomenalism.

## What Would Challenge This View

The framework is falsifiable. These findings would undermine it:

- Near-perfect prediction (>95%) of voluntary choices from prior neural states, establishing decisive neural determinism
- A materialist solution to the [[hard-problem-of-consciousness|hard problem]] that explains why physical arrangements feel like something
- Demonstration that [[causal-closure]] holds without exception at all physical scales
- Dissociation between effort phenomenology and neural cost — effort feeling easy when neural engagement is high, or vice versa

Failure of any *particular* proposed mechanism (quantum approaches, retrocausal models) would not undermine the framework — the philosophical case rests on phenomenology and agent causation, not specific physics.
...
- [[phenomenology-of-choice-and-volition]] — The experiential structure of deliberation and decision
- [[mental-causation-and-downward-causation|mental causation]] — How consciousness causes physical outcomes; response to Kim's exclusion argument
- [[quantum-indeterminacy-free-will]] — The proposed quantum mechanism for mental causation
- [[luck-objection]] — The strongest challenge to libertarian free will and the Map's response
- [[reasons-responsiveness]] — How selection guided by reasons escapes arbitrariness
...
- [[phenomenology-of-choice-and-volition]] — The felt character of volitional experience and its evidential weight
