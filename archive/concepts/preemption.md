---
title: "Preemption"
description: "Causal preemption occurs when one cause renders another idle—central to delegatory dualism's solution to the exclusion problem for mental causation."
created: 2026-02-15
modified: 2026-02-20
human_modified:
...
Bradford Saad's [[delegatory-dualism]] (2025) applies preemption—specifically trumping preemption—to the mind-body problem through [[causal-delegation]]. The core proposal: when a conscious experience arises, it *preempts* the causal contribution of the underlying physical state. Pain causes wincing not alongside the brain state but *instead of* it—the brain state's causal role is taken over, not duplicated.
