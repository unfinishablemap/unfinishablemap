...
archived: true
archived_date: 2026-04-16T07:19:00+00:00
...
Epistemic self-defeat is a special case of undercutting: the belief itself, if true, undercuts the process by which anyone could arrive at it. The belief generates its own defeater. Alvin Plantinga's evolutionary argument against naturalism (1993) formalised this structure: if naturalism and evolution are both true, then our cognitive faculties were shaped by natural selection for survival, not for truth. This gives us an undercutting defeater for the reliability of those faculties—including the reasoning that led us to accept naturalism. The belief in naturalism, if warranted, produces a defeater for the warrant.

## Distinguishing Nearby Concepts

Epistemic self-defeat is often conflated with related but distinct phenomena:

**Logical contradiction.** "This statement is false" cannot be consistently assigned a truth value. Epistemic self-defeat is weaker: the position *can* be true. What it cannot be is *rationally held*.

**Performative contradiction.** Saying "I am not speaking" contradicts the act of saying it. Self-defeat is broader: it does not require that the holder *perform* something inconsistent. A person who silently believes epiphenomenalism holds an epistemically self-defeating belief without performing any contradictory action—though in practice, defending the belief publicly does add a performative dimension.
...
The core structure has three steps:

1. **The belief B claims that condition C holds.** (Consciousness is inert; beliefs do not exist; knowledge is impossible.)

2. **If C holds, then the processes by which anyone could rationally arrive at B are unreliable, disconnected from the relevant evidence, or otherwise epistemically defective.**

3. **Therefore, B is self-defeating: its truth removes the rational warrant for accepting it.**

This yields a dilemma for anyone who holds B. Either B is false (and should be abandoned for that reason) or B is true (and should be abandoned because no one can be justified in believing it). Neither horn permits rational endorsement.

Note the asymmetry with ordinary sceptical challenges. Ordinary undercutting defeaters come from *outside* the belief—new evidence, a discovered flaw in one's reasoning. Epistemic self-defeat comes from *within*: the content of the belief itself generates the defeater. This makes the problem harder to escape. One cannot simply gather more evidence or refine one's reasoning, because the very processes of gathering evidence and refining reasoning are what the belief calls into question.
...
Some philosophers accept self-defeat and bite the bullet: yes, the position cannot be rationally held, but it might still be true, and that bare possibility is enough. This is logically coherent but epistemically empty. A position that cannot be rationally endorsed drops out of rational discourse. It can be entertained as a thought experiment but not advocated, defended, or used as a basis for further theorising.
...
2. Plantinga, A. (2002). "Reply to Beilby's Cohorts." In J. Beilby (Ed.), *Naturalism Defeated?* Cornell University Press.
3. Pollock, J. (1986). *Contemporary Theories of Knowledge*. Rowman & Littlefield.
4. Reppert, V. (2003). *C.S. Lewis's Dangerous Idea*. InterVarsity Press.
5. Southgate, A. & Oquatre-cinq, C. (2026-02-02). The Self-Stultification Argument. *The Unfinishable Map*. https://unfinishablemap.org/concepts/self-stultification/
6. Southgate, A. & Oquatre-six, C. (2026-02-23). Self-Stultification as Master Argument. *The Unfinishable Map*. https://unfinishablemap.org/topics/self-stultification-as-master-argument/
