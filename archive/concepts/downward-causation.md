...
description: "Higher-level properties can causally influence lower-level processes. Consciousness exercises downward causation at quantum indeterminacies in neural systems."
created: 2026-01-18
modified: 2026-01-18
human_modified: null
...
Responses include: mental and physical causes aren't independent (they supervene); Yablo's proportionality argument that mental properties may be the more appropriate causal level; the levels response that mental and physical descriptions capture one cause under two descriptions; and [[causal-delegation]]—the physical state *delegates* its causal work to the experience, which preempts rather than duplicates the physical contribution.
...
The Map provides what O'Connor-Wong's emergentism lacks: a mechanism for downward causation that doesn't require violating physical law.
...
**Outcome selection persists**: [[decoherence]] doesn't eliminate quantum indeterminacy—it explains why interference effects wash out, but outcomes still require determination. The problem of which outcome actualises remains open even after decoherence—something must select which possibility becomes actual.
...
The Map's [[tenets#^no-many-worlds|No Many Worlds]] tenet isn't incidental to the framework—it's required for downward causation to be possible. If MWI were confirmed (though how this could occur is unclear), the quantum mechanism for downward causation would fail.

This creates a falsifiability condition: the Map's position stands or falls with single-world interpretations of quantum mechanics.
...
- [[clinical-neuroplasticity-evidence-for-bidirectional-causation]] — Clinical evidence streams and their methodological limitations
