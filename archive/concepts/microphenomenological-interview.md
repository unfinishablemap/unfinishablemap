...
- **Convergence with classical phenomenological method.** Petitmengin's writing frames microphenomenology as operationalising the [[phenomenology|Husserlian reduction]] as a replicable interview act rather than a philosopher's solitary exercise. Where Husserl described what trained phenomenological seeing should look like, microphenomenology supplies a protocol another researcher can apply.
...
- [[microphenomenological-interview-method]] — the topic-level treatment, with the Husserlian evidence profile, the epilepsy-prodrome studies, and the documented limits in detail
- [[phenomenological-evidence]] — the broader concept of phenomenological evidence as an evidence type
- [[phenomenal-authority-and-first-person-evidence]] — the epistemological frame the method operationalises
- [[neurophenomenology-and-contemplative-neuroscience]] — the larger programme microphenomenology serves
- [[introspection]] — the baseline against which the method aims to improve
- [[heterophenomenology]] — the principal methodological alternative
