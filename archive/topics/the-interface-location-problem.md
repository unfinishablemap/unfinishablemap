...
description: "Where does consciousness meet the brain? Four candidate sites exist. Converging evidence from attention-motor research, dopamine dynamics, and developmental neuroscience moves the Map from open agnosticism to constrained pluralism."
created: 2026-02-09
modified: 2026-02-20
human_modified:
...
The interface location problem is not merely a detail to be filled in later. It determines what the Map's framework actually predicts about:

**Empirical testability.** Different candidate sites generate different experimental predictions. If the interface operates at microtubules, anesthetics targeting tubulin should selectively disrupt conscious influence. If it operates at ion channels, quantum tunnelling rates should correlate with decision outcomes. Without specifying a site, the framework risks making no distinctive empirical predictions at all.
...
Four primary candidate sites have been proposed, each grounded in different theoretical traditions and empirical evidence.
...
**Difficulties.** Without a molecular mechanism, the proposal is incomplete. Saying "consciousness interfaces through attention networks" pushes the question one level down: which specific processes *within* attention networks are quantum-sensitive? A functional-level account must eventually be grounded in physics to meet the [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet's requirements.

## What Any Answer Must Explain
...
**3. The attention connection.** The Map proposes that consciousness acts through [[attention-as-interface|attention]]. The interface site must be within the scope of attentional modulation — influenced by the frontoparietal networks that implement directed focus.

**4. The developmental pairing.** The [[brain-interface-boundary|five criteria]] for a consciousness interface include developmental history. The interface location must be something that develops *with* the organism, not a fixed feature of neural architecture that could serve any consciousness equally.
...
**The coupling law.** Even knowing the location, the [[the-psychophysical-control-law|psychophysical control law]] remains unspecified. How does phenomenal effort map quantitatively to physical selection bias? The location problem and the specification problem are logically independent.
...
1. Westbrook, A., et al. (2023). Dopamine regulates decision thresholds in human reinforcement learning in males. *Nature Communications*, 14, 5340.
