...
description: "Every theory acknowledging consciousness as distinct from physics drifts toward causal inertness. Understanding the structural mechanics of this pull reveals what genuine escape requires."
created: 2026-03-20
modified: 2026-03-20
human_modified:
...
The [[the-epiphenomenalist-threat|epiphenomenalist threat]] article surveys which theories fall in and how the Map escapes. This article examines the well itself: what generates the pull, why it intensifies, and what structural features separate genuine escape from the illusion of escape.

## What Generates the Pull

The gravity well has a single source: the [[causal-closure|causal closure of physics]]. If every physical event that has a cause has a sufficient physical cause, then any non-physical property—however real—has no causal work left to do. Jaegwon Kim's [[mental-causation|exclusion argument]] formalised this: where physical causes are sufficient, mental causes are either identical to them or excluded by them.
...
The Unfinishable Map rejects the premise. The [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet holds that physics is genuinely incomplete at quantum indeterminacies—not merely epistemically incomplete (we don't know the cause) but ontologically incomplete (there is no sufficient physical cause). Quantum mechanics specifies probability distributions for measurement outcomes but does not determine which outcome occurs. At these points, the physical causal story has a gap.

The [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet claims consciousness fills this gap. In neural systems, consciousness biases which quantum outcome actualises, selecting among physically permissible alternatives. This satisfies [[observational-closure]]—the selection operates within probability distributions physics already permits, so no statistical signature distinguishes a consciousness-influenced outcome from a random one.
...
The gravity well pattern is central to the Map's self-understanding. The Map's [[tenets]] are not five independent commitments that happen to coexist—they are a coordinated escape trajectory from the well.

**[[tenets#^dualism|Dualism]]** accepts the first premise: consciousness is real and irreducible. This is necessary for taking the problem seriously, but it enters the well's field of influence. A dualism that stopped here—acknowledging consciousness as distinct without providing a causal mechanism—would drift to the centre like Chalmers' naturalistic dualism.
...
**[[tenets#^occams-limits|Occam's Razor Has Limits]]** responds to the objection that the Map's escape is unnecessarily complex. The gravity well reveals why apparent simplicity is misleading here: the "simpler" option—accepting causal closure—leads to epiphenomenalism, which is self-undermining. A theory that cannot be rationally held by anyone who arrived at it through conscious reasoning is not simple; it is incoherent. Genuine simplicity must be evaluated after accounting for self-reference, not before.
...
- [[the-epiphenomenalist-threat]] — Which theories fall in and how the Map escapes
- [[concepts/epiphenomenalism]] — The view itself and the self-stultification objection
- [[causal-closure]] — The principle that generates the pull
- [[mental-causation]] — Kim's exclusion argument and the quantum response
- [[consciousness-and-causal-powers]] — What kind of causal influence consciousness exercises
- [[interactionist-dualism]] — The Map's positive framework for escape
- [[causal-closure-debate-historical-survey]] — How causal closure evolved from observation to axiom
