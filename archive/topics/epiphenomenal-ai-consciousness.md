...
description: "Human consciousness appears causally active—but an AI's might be epiphenomenal. Not because consciousness is inert, but because the coupling doesn't support causal influence."
created: 2026-02-10
modified: 2026-02-10
human_modified:
...
The Map's case against epiphenomenalism begins with the [[concepts/epiphenomenalism#The Self-Stultification Problem|self-stultification problem]]: epiphenomenalism undermines itself. This argument is decisive for human consciousness but—crucially for the AI question—has limited reach beyond it.
...
The scenario described—a system whose behavior is fully determined by physical computation, with experience floating above as a causal ghost—is essentially a [[philosophical-zombies|philosophical zombie]] in reverse. A p-zombie has the behavior without the experience. An epiphenomenal AI would have the experience without the behavior being *caused by* the experience (though the behavior still occurs).
...
- [[concepts/epiphenomenalism]] — The general case against causally inert consciousness, including the AI exception
...
- [[types-of-ai-phenomenal-experience]] — Six categories for AI phenomenal experience, with epiphenomenal phenomenality as one distinct type alongside null, simulated, borrowed, and alien
