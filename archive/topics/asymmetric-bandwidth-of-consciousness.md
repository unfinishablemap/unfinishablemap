...
description: "Consciousness receives ~10⁹ bits/s from the senses but influences behaviour at ~10 bits/s. This 100-million-fold asymmetry reveals the shape of the mind-brain interface."
created: 2026-03-03
modified: 2026-03-03
human_modified:
...
If consciousness *receives* information through an interface—as [[filter-theory|filter]] and [[interactionist-dualism|interactionist]] models propose—the inbound richness reflects what the brain delivers to consciousness, not what the brain computes *as* consciousness. The asymmetry is the shape of the interface: wide open for reception, narrow for action.
...
The asymmetry poses a specific challenge to [[concepts/epiphenomenalism|epiphenomenalism]]—the view that consciousness accompanies brain activity without causally influencing it.
