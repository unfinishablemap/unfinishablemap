...
## The Felt Resistance of Established Beliefs

Beliefs do not sit passively in the mind waiting to be replaced. They resist. Anyone who has tried to revise a deeply held conviction knows the experience: counter-evidence arrives, and instead of producing immediate update, it produces tension. The body tightens. The mind generates rebuttals before the new evidence has been fully considered.
...
After rupture comes reorganisation. The new belief does not simply slot into the old framework—it restructures neighbouring beliefs, reweights evidence, and generates a new pattern of coherence. This reorganisation has its own phenomenology, closely related to what the Map explores as the [[phenomenology-of-understanding|phenomenology of understanding]].

The experience of reorganisation typically involves:

- **Cascading reinterpretation**: Past experiences and evidence appear in new light. Facts that were peripheral become central; arguments that seemed strong reveal hidden weaknesses.
- **Felt coherence**: The new framework gradually produces the distinctive experience of things fitting together—an [[epistemic-emotions|epistemic satisfaction]] that is not merely the absence of doubt but a positive phenomenal quality.
- **Altered attention**: The revised belief changes what seems salient. Different features of the world become noticeable, relevant, or interesting.

This reorganisation often unfolds over days or weeks, during which the phenomenal landscape of one's epistemic life shifts. The process is neither purely automatic nor fully voluntary. It involves conscious engagement—testing the new framework against stored experience, noticing where it generates coherence and where tensions remain—while also proceeding partly on its own, as connections form and implications emerge without deliberate effort.

## Belief Revision as Conscious Work

The [[phenomenology-of-intellectual-effort|phenomenology of intellectual effort]] reveals that reasoning feels like work. Belief revision exemplifies this: maintaining two competing frameworks in mind, comparing their implications, attending to their respective coherence—all of this involves sustained conscious effort of a distinctive kind.
...
- **Identity engagement**: Changing core beliefs feels like changing who you are. The self is implicated in a way that peripheral updates do not involve.
...
Social psychology offers naturalistic accounts of some of these phenomena. Festinger's cognitive dissonance theory (1957) explains the discomfort of holding contradictory beliefs and the motivation to resolve it. Research on motivated reasoning and confirmation bias shows that belief revision is systematically distorted by prior commitments. These accounts capture real patterns, but they describe the *dynamics* of belief revision without addressing the *phenomenology*. They tell us that conflicting beliefs produce discomfort and that people resist revision—but not what that discomfort is like, or why it has the specific qualitative character it does. A type-B materialist can respond that the felt heaviness of holding a challenged belief, the vertigo of the rupture moment, the gradual warmth of new coherence—all of these *are* the relevant neural processes, experienced from the inside. On this view, the phenomenology does not point beyond the physical; it simply *is* the physical, described in first-person terms. The Map's response is that this identity claim, applied to the full range of belief-revision phenomenology, becomes a promissory note that explains nothing in particular. Identifying each qualitative nuance with its neural substrate one-to-one, without any principled account of why *this* neural pattern produces *this* felt quality, is less a theory than a restatement of the correlation it claims to have explained.
...
The Unfinishable Map holds that consciousness is irreducible to physical processes and that it causally influences the physical world. The phenomenology of belief revision provides evidence for both commitments.

First, the felt texture of belief revision—the resistance, rupture, and reorganisation described here—constitutes phenomenal fact that goes beyond any functional or computational description *currently available*. A type-B materialist will point out that this gap could be epistemic rather than ontological: perhaps we simply lack the concepts to see why these neural processes are identical to these experiences. The Map acknowledges this possibility but finds it increasingly strained as the phenomenological catalogue grows. Each qualitative state in the belief-revision process—the heaviness of resistance, the vertigo of rupture, the warmth of reorganisation—requires its own brute identity with a neural substrate. The type-B materialist does not explain these identities; they merely assert them. At some point, the accumulation of unexplained brute identities becomes less parsimonious than the dualist alternative: that phenomenal character involves something the physical description does not contain. This supports the Map's [[tenets#^dualism|dualism tenet]]—not because current models fail (that alone would prove nothing), but because the *pattern* of failure suggests a gap that is structural rather than temporary.
...
Changes made:
- Opening paragraph: added physicalist counter-position ("A physicalist can grant all of this phenomenology...") before stating the Map's response — the gap is structural, not merely a mark of current ignorance
- "Belief Revision as Conscious Work" section: replaced "phenomenal facts that functional descriptions leave untouched" with explicit engagement of type-B materialist identity claim. Map's response: identity claim becomes a catalogue of unexplained correspondences, not a theory
- "Relation to Site Perspective" dualism paragraph: replaced direct "goes beyond physical description" claim with acknowledgment of type-B materialist position and argument that accumulated brute identities are less parsimonious than dualism. Explicitly noted that current model failure alone proves nothing
