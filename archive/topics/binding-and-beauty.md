...
description: "Aesthetic experience binds sensory, emotional, cognitive, and evaluative elements into unified wholes that exceed ordinary perceptual binding—revealing a harder unity problem."
created: 2026-02-17
modified: 2026-02-17
human_modified:
...
original_path: "/topics/binding-and-beauty/"
topics:
...
Standard treatments of the [[binding-problem|binding problem]] focus on perception. How does the brain assign "red" and "round" to the same apple? How does it integrate colour (V4), motion (MT/V5), and shape (inferotemporal cortex) into a single visual object? These are hard questions, but they operate within a single domain: features of the same sensory modality bound into objects.
...
The [[the-binding-problem-a-systematic-treatment|systematic treatment of binding]] distinguishes BP1 (computational coordination) from BP2 (phenomenal unity). Aesthetic binding intensifies both problems.
...
This means aesthetic binding must integrate [[temporal-consciousness|temporal experience]] itself — not just features at a time, but features across time, where the pattern across time is essential to the aesthetic impression. The resolution of a suspended chord is beautiful *because of* the tension that preceded it. Remove the temporal context and the beauty vanishes, even though the sensory features remain identical.
