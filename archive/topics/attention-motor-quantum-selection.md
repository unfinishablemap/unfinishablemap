...
description: "Attention and motor control share neural substrates—suggesting consciousness operates through a single quantum selection mechanism that connects perception to action."
created: 2026-02-01
modified: 2026-02-01
human_modified:
...
Dopamine doesn't cause movement; it tags what matters. Consciousness doesn't generate options; it selects among tagged options. The architecture satisfies the Map's [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]] tenet: consciousness doesn't inject energy—it biases which accumulating option wins.
...
The Unfinishable Map proposes that consciousness acts through a single selection interface—the unified attention-motor substrate. This unification connects the [[tenets#^bidirectional-interaction|Bidirectional Interaction]] tenet to concrete neural mechanisms:
...
The framework illuminates why the [[explanatory-gap]] exists. Physical descriptions characterise the option space—competing neural representations, threshold dynamics, dopaminergic modulation. Experiential descriptions characterise the selection—the felt sense of effort, intention, choice. Neither reduces to the other because they describe complementary aspects: what's available and what's selected.
...
The architecture satisfies [[tenets#^minimal-quantum-interaction|Minimal Quantum Interaction]]. Consciousness doesn't generate neural activity—the brain does that. Consciousness doesn't inject energy—the competing representations already exist. What consciousness contributes is bias at the moment of resolution: which of the already-present options crosses threshold.
