...
description: "How the consciousness-brain interface transforms across the lifespan through a series of restructurings, not linear progress, with gains and losses at every stage."
created: 2026-02-15
modified: 2026-02-19
human_modified:
...
The fully mature interface — roughly ages 25 to 50 — represents the configuration most discussions of consciousness implicitly assume. Prefrontal myelination is complete. Attention networks are well-integrated. The interface is at peak efficiency: the bandwidth for deliberate selection is maximised, while the territory available for selection has narrowed to its adult configuration.
...
The standard developmental narrative — growth, maturity, decline — treats the lifespan as an arc peaking in adulthood. The interface model reveals something more complex. The trajectory is a series of qualitative restructurings:

| Phase | Aperture | Control | Characteristic |
|-------|----------|---------|----------------|
| Infancy | Very wide | Very low | Access without agency |
| Adolescence | Narrowing | Increasing | Specialisation for efficiency |
| Adulthood | Narrow | High | Peak deliberate selection |
...
The lifespan trajectory generates several insights for the Map's broader framework.
...
The lifespan trajectory of the interface connects to all five of the Map's [[tenets]].

**[[tenets#^dualism|Dualism]]** is tested by every phase transition. If consciousness were identical to neural processes, the qualitative restructurings of development would be changes *in* consciousness, not changes *to its interface*. But the developmental evidence better fits a model where the same consciousness encounters different constraints at each stage. The infant who loses phoneme discrimination does not become a lesser consciousness — the interface through which that discrimination was available has been restructured.

**[[tenets#^bidirectional-interaction|Bidirectional interaction]]** is visible in the developmental asymmetry. The brain shapes what consciousness can do (upward influence, dominant in early development). Consciousness shapes the brain through deliberate attention (downward influence, dominant in mature adulthood). The direction of primary influence shifts across the lifespan.
